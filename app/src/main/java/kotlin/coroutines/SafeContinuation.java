...
public final class SafeContinuation<T> implements Continuation<T>, CoroutineStackFrame {
    ...
    public final Object getOrThrow() throws Throwable {
        ...
        if (obj == CoroutineSingletons.UNDECIDED) {
            if (C0189xc40028dd.m89m(RESULT, this, CoroutineSingletons.UNDECIDED, IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
    ...
    public void resumeWith(Object result) {
        while (true) {
            Object obj = this.result;
            if (obj == CoroutineSingletons.UNDECIDED) {
                if (C0189xc40028dd.m89m(RESULT, this, CoroutineSingletons.UNDECIDED, result)) {
                    return;
                }
            } else {
                ...
                if (C0189xc40028dd.m89m(RESULT, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), CoroutineSingletons.RESUMED)) {
