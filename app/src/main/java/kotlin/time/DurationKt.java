...
public final class DurationKt {
    ...
    public static final long durationOf(long j, int i) {
        return Duration.m46291constructorimpl((j << 1) + ((long) i));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m46291constructorimpl((j << 1) + 1);
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m46291constructorimpl(j << 1);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM46382getZEROUwyO8pc = Duration.INSTANCE.m46382getZEROUwyO8pc();
        ...
        if (cCharAt4 == 'P') {
            ...
            while (i3 < length) {
                if (str.charAt(i3) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar != DurationUnit.SECONDS || iIndexOf$default <= 0) {
                        jM46382getZEROUwyO8pc = Duration.m46320plusLRDsOJo(jM46382getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    } else {
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring2 = strSubstring.substring(0, iIndexOf$default);
                        Intrinsics.checkNotNullExpressionValue(strSubstring2, "substring(...)");
                        long jM46320plusLRDsOJo = Duration.m46320plusLRDsOJo(jM46382getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring3 = strSubstring.substring(iIndexOf$default);
                        Intrinsics.checkNotNullExpressionValue(strSubstring3, "substring(...)");
                        jM46382getZEROUwyO8pc = Duration.m46320plusLRDsOJo(jM46320plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, iMax, true)) {
                jM46382getZEROUwyO8pc = Duration.INSTANCE.m46380getINFINITEUwyO8pc();
            } else {
                boolean z5 = !z2;
                ...
                while (length2 < i) {
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM46320plusLRDsOJo2 = Duration.m46320plusLRDsOJo(jM46382getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM46382getZEROUwyO8pc = Duration.m46320plusLRDsOJo(jM46320plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM46382getZEROUwyO8pc = Duration.m46320plusLRDsOJo(jM46382getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
        ...
        return z3 ? Duration.m46335unaryMinusUwyO8pc(jM46382getZEROUwyO8pc) : jM46382getZEROUwyO8pc;
    }
    ...
    private static final long m46387timeskIfJnKk(double d, long j) {
        return Duration.m46321timesUwyO8pc(j, d);
    }

    /* JADX INFO: renamed from: times-mvk6XK0, reason: not valid java name */
    private static final long m46388timesmvk6XK0(int i, long j) {
        return Duration.m46322timesUwyO8pc(j, i);
    }
    ...
    public static final long toDuration(long j, DurationUnit unit) {
        ...
        return ((-jConvertDurationUnitOverflow) > j || j > jConvertDurationUnitOverflow) ? durationOfMillis(RangesKt.coerceIn(DurationUnitKt.convertDurationUnit(j, unit, DurationUnit.MILLISECONDS), -4611686018427387903L, MAX_MILLIS)) : durationOfNanos(DurationUnitKt.convertDurationUnitOverflow(j, unit, DurationUnit.NANOSECONDS));
    }
}
