...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public final long m46392adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m46404constructorimpl(LongSaturatedMathKt.m46390saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }

    /* JADX INFO: renamed from: differenceBetween-fRLX17w, reason: not valid java name */
    public final long m46393differenceBetweenfRLX17w(long one, long another) {
    ...
    public final long m46394elapsedFrom6eNON_k(long timeMark) {
        return LongSaturatedMathKt.saturatingDiff(read(), timeMark, DurationUnit.NANOSECONDS);
    }

    @Override // kotlin.time.TimeSource.WithComparableMarks, kotlin.time.TimeSource
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m46401boximpl(m46395markNowz9LOYto());
    }
    ...
    public long m46395markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m46404constructorimpl(read());
    }
