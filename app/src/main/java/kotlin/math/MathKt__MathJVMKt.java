...
public class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    private static final double m43516ln(double d) {
        return Math.log(d);
    }

    /* JADX INFO: renamed from: ln */
    private static final float m43517ln(float f) {
