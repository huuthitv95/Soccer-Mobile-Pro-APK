...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    static {
        ...
        for (Object obj : listListOf) {
            ...
            arrayList.add(TuplesKt.m43482to((Class) obj, Integer.valueOf(i)));
            i = i2;
        }
        ...
        for (String str : collectionValues) {
            ...
            Pair pairM43482to = TuplesKt.m43482to(sb.toString(), str + ".Companion");
            map3.put(pairM43482to.getFirst(), pairM43482to.getSecond());
        }
