...
public final class HexExtensionsKt {
    ...
    private static final int checkFormatLength(long j) {
        ...
        throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m45166toStringimpl(ULong.m45120constructorimpl(j))));
    }
    ...
    public static final String toHexString(byte b, HexFormat format) {
        ...
        char[] cArr = {str.charAt((b >> 4) & 15), str.charAt(b & Ascii.f22499SI)};
