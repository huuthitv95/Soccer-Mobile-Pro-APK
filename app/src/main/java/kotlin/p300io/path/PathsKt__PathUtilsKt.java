...
public class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesView(Path path, LinkOption... options) {
        ...
        FileAttributeView fileAttributeView = Files.getFileAttributeView(path, h$a$$ExternalSyntheticApiModelOutline0.m$1(), (LinkOption[]) Arrays.copyOf(options, options.length));
        if (fileAttributeView != null) {
            return (V) h$a$$ExternalSyntheticApiModelOutline0.m43368m((Object) fileAttributeView);
        }
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
        PathsKt.fileAttributeViewNotAvailable(path, h$a$$ExternalSyntheticApiModelOutline0.m$1());
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesViewOrNull(Path path, LinkOption... options) {
        ...
        Intrinsics.checkNotNullParameter(options, "options");
        Intrinsics.reifiedOperationMarker(4, ExifInterface.GPS_MEASUREMENT_INTERRUPTED);
        return (V) Files.getFileAttributeView(path, h$a$$ExternalSyntheticApiModelOutline0.m$1(), (LinkOption[]) Arrays.copyOf(options, options.length));
    }
    ...
    private static final void forEachDirectoryEntry(Path path, String glob, Function1<? super Path, Unit> action) throws IOException {
        ...
        try {
            DirectoryStream directoryStreamM43332m = h$a$$ExternalSyntheticApiModelOutline0.m43332m((Object) directoryStreamNewDirectoryStream);
            Intrinsics.checkNotNull(directoryStreamM43332m);
            Iterator it = directoryStreamM43332m.iterator();
            while (it.hasNext()) {
    ...
    public static final List<Path> listDirectoryEntries(Path path, String glob) throws IOException {
        ...
        try {
            DirectoryStream directoryStreamM43332m = h$a$$ExternalSyntheticApiModelOutline0.m43332m((Object) directoryStreamNewDirectoryStream);
            Intrinsics.checkNotNull(directoryStreamM43332m);
            List<Path> list = CollectionsKt.toList(directoryStreamM43332m);
            CloseableKt.closeFinally(directoryStreamNewDirectoryStream, null);
            return list;
        } catch (Throwable th) {
            try {
    ...
    private static final /* synthetic */ <A extends BasicFileAttributes> A readAttributes(Path path, LinkOption... options) throws IOException {
        ...
        BasicFileAttributes attributes = Files.readAttributes(path, (Class<BasicFileAttributes>) d$$ExternalSyntheticApiModelOutline0.m$1(), (LinkOption[]) Arrays.copyOf(options, options.length));
        Intrinsics.checkNotNullExpressionValue(attributes, "readAttributes(...)");
        return (A) h$a$$ExternalSyntheticApiModelOutline0.m43366m((Object) attributes);
    }
    ...
    private static final <T> T useDirectoryEntries(Path path, String glob, Function1<? super Sequence<? extends Path>, ? extends T> block) throws IOException {
        ...
        try {
            DirectoryStream directoryStreamM43332m = h$a$$ExternalSyntheticApiModelOutline0.m43332m((Object) directoryStreamNewDirectoryStream);
            Intrinsics.checkNotNull(directoryStreamM43332m);
            T tInvoke = block.invoke(CollectionsKt.asSequence(directoryStreamM43332m));
            if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 1, 0)) {
                CloseableKt.closeFinally(directoryStreamNewDirectoryStream, null);
            } else if (directoryStreamNewDirectoryStream != null) {
                directoryStreamNewDirectoryStream.close();
    ...
    static /* synthetic */ Object useDirectoryEntries$default(Path path, String glob, Function1 block, int i, Object obj) throws IOException {
        ...
        try {
            DirectoryStream directoryStreamM43332m = h$a$$ExternalSyntheticApiModelOutline0.m43332m((Object) directoryStreamNewDirectoryStream);
            Intrinsics.checkNotNull(directoryStreamM43332m);
            Object objInvoke = block.invoke(CollectionsKt.asSequence(directoryStreamM43332m));
            if (PlatformImplementationsKt.apiVersionIsAtLeast(1, 1, 0)) {
                CloseableKt.closeFinally(directoryStreamNewDirectoryStream, null);
            } else if (directoryStreamNewDirectoryStream != null) {
                directoryStreamNewDirectoryStream.close();
