...
class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
    ...
    public static final Path copyToRecursively(final Path path, final Path target, final Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> onError, boolean z, final Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> copyAction) throws FileSystemException {
        ...
        if (!Files.exists(path, (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))) {
            h$a$$ExternalSyntheticApiModelOutline0.m44705m$2();
            throw h$a$$ExternalSyntheticApiModelOutline0.m43345m(path.toString(), target.toString(), "The source file doesn't exist.");
        }
        ...
        if (Files.exists(path, (LinkOption[]) Arrays.copyOf(new LinkOption[0], 0)) && (z || !Files.isSymbolicLink(path))) {
            ...
            if (!z2 || !Files.isSameFile(path, target)) {
                ...
                if (zStartsWith) {
                    h$a$$ExternalSyntheticApiModelOutline0.m43380m();
                    throw h$a$$ExternalSyntheticApiModelOutline0.m43339m(path.toString(), target.toString(), "Recursively copying a directory into its subdirectory is prohibited.");
                }
            }
        }
        final Path pathNormalize = target.normalize();
        final ArrayList arrayList = new ArrayList();
        PathsKt.visitFileTree$default(path, 0, z, new Function1() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticLambda25
    ...
    public static final Path copyToRecursively(Path path, Path target, Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> onError, final boolean z, boolean z2) {
        ...
        Intrinsics.checkNotNullParameter(target, "target");
        Intrinsics.checkNotNullParameter(onError, "onError");
        return z2 ? PathsKt.copyToRecursively(path, target, onError, z, (Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult>) new Function3() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticLambda24
    ...
    public static final FileVisitResult copyToRecursively$copy$PathsKt__PathRecursiveFunctionsKt(ArrayList<Path> arrayList, Function3<? super CopyActionContext, ? super Path, ? super Path, ? extends CopyActionResult> function3, Path path, Path path2, Path path3, Function3<? super Path, ? super Path, ? super Exception, ? extends OnErrorResult> function4, Path path4, BasicFileAttributes basicFileAttributes) {
        try {
            if (!arrayList.isEmpty()) {
                ...
                checkNotSameAs$PathsKt__PathRecursiveFunctionsKt(path4, d$$ExternalSyntheticApiModelOutline0.m2295m(objLast));
            }
    ...
    public static /* synthetic */ Path copyToRecursively$default(Path path, Path path2, Function3 function3, final boolean z, Function3 function4, int i, Object obj) {
        if ((i & 2) != 0) {
            function3 = new Function3() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt.copyToRecursively.3
                ...
                public /* bridge */ /* synthetic */ Object invoke(Object obj2, Object obj3, Object obj4) {
                    return invoke(d$$ExternalSyntheticApiModelOutline0.m2295m(obj2), d$$ExternalSyntheticApiModelOutline0.m2295m(obj3), (Exception) obj4);
                }
        ...
        if ((i & 8) != 0) {
            function4 = new Function3() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticLambda23
                @Override // kotlin.jvm.functions.Function3
    ...
    public static final Unit copyToRecursively$lambda$6$PathsKt__PathRecursiveFunctionsKt(final ArrayList arrayList, final Function3 function3, final Path path, final Path path2, final Path path3, final Function3 function4, FileVisitorBuilder visitFileTree) {
        ...
        visitFileTree.onPreVisitDirectory(new Function2() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticLambda26
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return PathsKt__PathRecursiveFunctionsKt.m43513x672c94f7(arrayList, function3, path, path2, path3, function4, (Path) obj, (BasicFileAttributes) obj2);
            }
        });
        ...
        visitFileTree.onPostVisitDirectory(new Function2() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$$ExternalSyntheticLambda27
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                return PathsKt__PathRecursiveFunctionsKt.m43514xce0554b8(arrayList, function4, path, path2, path3, (Path) obj, (IOException) obj2);
            }
        });
    ...
    public static final FileVisitResult m43513x672c94f7(ArrayList arrayList, Function3 function3, Path path, Path path2, Path path3, Function3 function4, Path directory, BasicFileAttributes attributes) {
    ...
    public static final FileVisitResult m43514xce0554b8(ArrayList arrayList, Function3 function3, Path path, Path path2, Path path3, Path directory, IOException iOException) {
        Intrinsics.checkNotNullParameter(directory, "directory");
    ...
    public static final void deleteRecursively(Path path) throws IOException {
        ...
        FileSystemException fileSystemExceptionM43338m = h$a$$ExternalSyntheticApiModelOutline0.m43338m("Failed to delete one or more files. See suppressed exceptions for details.");
        Iterator<T> it = listDeleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt.iterator();
        while (it.hasNext()) {
            ExceptionsKt.addSuppressed(fileSystemExceptionM43338m, (Exception) it.next());
        }
        throw fileSystemExceptionM43338m;
    }
    ...
    private static final List<Exception> deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(Path path) throws IOException {
        ...
        if (parent != null) {
            ...
            if (directoryStreamNewDirectoryStream != null) {
                ...
                try {
                    DirectoryStream directoryStreamM43332m = h$a$$ExternalSyntheticApiModelOutline0.m43332m((Object) directoryStream);
                    if (h$a$$ExternalSyntheticApiModelOutline0.m43385m((Object) directoryStreamM43332m)) {
                        exceptionsCollector.setPath(parent);
                        SecureDirectoryStream secureDirectoryStreamM43363m = h$a$$ExternalSyntheticApiModelOutline0.m43363m((Object) directoryStreamM43332m);
                        Path fileName = path.getFileName();
                        Intrinsics.checkNotNullExpressionValue(fileName, "getFileName(...)");
                        handleEntry$PathsKt__PathRecursiveFunctionsKt(secureDirectoryStreamM43363m, fileName, null, exceptionsCollector);
                    } else {
                        z = true;
                    }
    ...
    private static final void enterDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, ExceptionsCollector exceptionsCollector) {
        ...
        if (secureDirectoryStreamNewDirectoryStream != null) {
            ...
            try {
                SecureDirectoryStream secureDirectoryStreamM43363m = h$a$$ExternalSyntheticApiModelOutline0.m43363m((Object) secureDirectoryStream2);
                Iterator it = secureDirectoryStreamM43363m.iterator();
                Intrinsics.checkNotNullExpressionValue(it, "iterator(...)");
                while (it.hasNext()) {
                    Path fileName = d$$ExternalSyntheticApiModelOutline0.m2295m(it.next()).getFileName();
                    Intrinsics.checkNotNullExpressionValue(fileName, "getFileName(...)");
                    handleEntry$PathsKt__PathRecursiveFunctionsKt(secureDirectoryStreamM43363m, fileName, exceptionsCollector.getPath(), exceptionsCollector);
                }
                Unit unit = Unit.INSTANCE;
    ...
    private static final void insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(Path path, ExceptionsCollector exceptionsCollector) {
        ...
        if (directoryStreamNewDirectoryStream != null) {
            DirectoryStream directoryStream = directoryStreamNewDirectoryStream;
            try {
                Iterator it = h$a$$ExternalSyntheticApiModelOutline0.m43332m((Object) directoryStream).iterator();
                Intrinsics.checkNotNullExpressionValue(it, "iterator(...)");
                while (it.hasNext()) {
                    Path pathM2295m = d$$ExternalSyntheticApiModelOutline0.m2295m(it.next());
                    Intrinsics.checkNotNull(pathM2295m);
                    insecureHandleEntry$PathsKt__PathRecursiveFunctionsKt(pathM2295m, path, exceptionsCollector);
                }
                Unit unit = Unit.INSTANCE;
                CloseableKt.closeFinally(directoryStream, null);
            } catch (Throwable th) {
    ...
    private static final boolean isDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, LinkOption... linkOptionArr) {
        Boolean boolValueOf;
        try {
            boolValueOf = Boolean.valueOf(h$a$$ExternalSyntheticApiModelOutline0.m43365m((Object) secureDirectoryStream.getFileAttributeView(path, h$a$$ExternalSyntheticApiModelOutline0.m43323m(), (LinkOption[]) Arrays.copyOf(linkOptionArr, linkOptionArr.length))).readAttributes().isDirectory());
        } catch (NoSuchFileException unused) {
            boolValueOf = null;
        }
        if (boolValueOf != null) {
