...
public final class PolymorphicModuleBuilder<Base> {
    ...
    public final <T extends Base> void subclass(KClass<T> subclass, KSerializer<T> serializer) {
        ...
        this.subclasses.add(TuplesKt.m43482to(subclass, serializer));
    }
    ...
    public final void m46550default(Function1<? super String, ? extends DeserializationStrategy<? extends Base>> defaultSerializerProvider) {
