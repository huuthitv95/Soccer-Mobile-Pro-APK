...
public final class JsonLiteral extends JsonPrimitive {
    ...
    public int hashCode() {
        return (UByte$$ExternalSyntheticBackport0.m43487m(getIsString()) * 31) + getContent().hashCode();
    }
}
