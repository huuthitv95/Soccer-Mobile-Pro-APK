...
public final class JsonElementKt {
    ...
    public static final JsonPrimitive m46546JsonPrimitive7apg3OU(byte b) {
        return m46547JsonPrimitiveVKZWuLQ(ULong.m45120constructorimpl(((long) b) & 255));
    }

    @ExperimentalSerializationApi
    /* JADX INFO: renamed from: JsonPrimitive-xj2QHRw, reason: not valid java name */
    public static final JsonPrimitive m46549JsonPrimitivexj2QHRw(short s) {
        return m46547JsonPrimitiveVKZWuLQ(ULong.m45120constructorimpl(((long) s) & 65535));
    }

    @ExperimentalSerializationApi
    /* JADX INFO: renamed from: JsonPrimitive-WZ4Q5Ns, reason: not valid java name */
    public static final JsonPrimitive m46548JsonPrimitiveWZ4Q5Ns(int i) {
        return m46547JsonPrimitiveVKZWuLQ(ULong.m45120constructorimpl(((long) i) & 4294967295L));
    }

    @ExperimentalSerializationApi
    /* JADX INFO: renamed from: JsonPrimitive-VKZWuLQ, reason: not valid java name */
    public static final JsonPrimitive m46547JsonPrimitiveVKZWuLQ(long j) {
        return JsonUnquotedLiteral(UByte$$ExternalSyntheticBackport0.m43492m(j, 10));
    }
