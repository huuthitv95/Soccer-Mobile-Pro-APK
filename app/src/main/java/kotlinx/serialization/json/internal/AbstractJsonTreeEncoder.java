...
abstract class AbstractJsonTreeEncoder extends NamedValueEncoder implements JsonEncoder {
    ...
    private final C153701 inlineUnsignedNumberEncoder(final String tag) {
        return new AbstractEncoder() { // from class: kotlinx.serialization.json.internal.AbstractJsonTreeEncoder.inlineUnsignedNumberEncoder.1
            ...
            public void encodeInt(int value) {
                putUnquotedString(UByte$$ExternalSyntheticBackport0.m43490m(UInt.m45041constructorimpl(value), 10));
            }

            @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
            public void encodeLong(long value) {
                putUnquotedString(UByte$$ExternalSyntheticBackport0.m43492m(ULong.m45120constructorimpl(value), 10));
            }

            @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
            public void encodeByte(byte value) {
                putUnquotedString(UByte.m45008toStringimpl(UByte.m44964constructorimpl(value)));
            }

            @Override // kotlinx.serialization.encoding.AbstractEncoder, kotlinx.serialization.encoding.Encoder
            public void encodeShort(short value) {
                putUnquotedString(UShort.m45271toStringimpl(UShort.m45227constructorimpl(value)));
            }
        };
    }
    ...
    private final C153691 inlineUnquotedLiteralEncoder(final String tag, final SerialDescriptor inlineDescriptor) {
