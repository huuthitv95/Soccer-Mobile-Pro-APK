...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4<T> implements Flow<T> {
    ...
    @DebugMetadata(m43503c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4", m43504f = "Builders.kt", m43505i = {0}, m43506l = {114}, m43507m = "collect", m43508n = {"$this$asFlow_u24lambda_u245"}, m43509s = {"L$0"})
    public static final class C152161 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C152161(Continuation continuation) {
            super(continuation);
        }
    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Iterator it;
        if (continuation instanceof C152161) {
            c152161 = (C152161) continuation;
            if ((c152161.label & Integer.MIN_VALUE) != 0) {
                c152161.label -= Integer.MIN_VALUE;
            } else {
                c152161 = new C152161(continuation);
            }
        } else {
            c152161 = new C152161(continuation);
        }
        Object obj = c152161.result;
        ...
        if (i == 0) {
            ...
            it = (Iterator) c152161.L$1;
            FlowCollector flowCollector3 = (FlowCollector) c152161.L$0;
            ResultKt.throwOnFailure(obj);
            flowCollector2 = flowCollector3;
        }
        while (it.hasNext()) {
            Object next = it.next();
            c152161.L$0 = flowCollector2;
            c152161.L$1 = it;
            c152161.label = 1;
            if (flowCollector2.emit(next, c152161) == coroutine_suspended) {
