...
@DebugMetadata(m43503c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", m43504f = "Delay.kt", m43505i = {}, m43506l = {273}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    static final class C152371<T> implements FlowCollector {
        final /* synthetic */ ProducerScope<Object> $$this$produce;

        C152371(ProducerScope<Object> producerScope) {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            C152371 c152371 = new C152371(producerScope);
            this.label = 1;
            if (flow.collect(c152371, this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
