...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    @DebugMetadata(m43503c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt", m43504f = "Errors.kt", m43505i = {0}, m43506l = {152}, m43507m = "catchImpl", m43508n = {"fromDownstream"}, m43509s = {"L$0"})
    static final class C152441<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C152441(Continuation<? super C152441> continuation) {
            super(continuation);
        }
    ...
    /* JADX INFO: compiled from: Errors.kt */
    @Metadata(m43474d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0003\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@"}, m43475d2 = {"<anonymous>", "", "T", "it", ""}, m43476k = 3, m43477mv = {1, 9, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$1", m43504f = "Errors.kt", m43505i = {}, m43506l = {}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    static final class C152461 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;

        C152461(Continuation<? super C152461> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C152461(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C152461) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX INFO: compiled from: Errors.kt */
    @Metadata(m43474d1 = {"\u0000\u0018\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\n\u0002\u0010\t\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H\u008a@"}, m43475d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/flow/FlowCollector;", "cause", "", "attempt", ""}, m43476k = 3, m43477mv = {1, 9, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$3", m43504f = "Errors.kt", m43505i = {}, m43506l = {91}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    static final class C152473<T> extends SuspendLambda implements Function4<FlowCollector<? super T>, Throwable, Long, Continuation<? super Boolean>, Object> {
        ...
        C152473(long j, Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2, Continuation<? super C152473> continuation) {
        ...
        public final Object invoke(FlowCollector<? super T> flowCollector, Throwable th, long j, Continuation<? super Boolean> continuation) {
            C152473 c152473 = new C152473(this.$retries, this.$predicate, continuation);
            c152473.L$0 = th;
            c152473.J$0 = j;
            return c152473.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Flow<T> retry(Flow<? extends T> flow, long j, Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2) {
        ...
        return FlowKt.retryWhen(flow, new C152473(j, function2, null));
    }
    ...
    public static final <T> Object catchImpl(Flow<? extends T> flow, FlowCollector<? super T> flowCollector, Continuation<? super Throwable> continuation) throws Throwable {
        ...
        if (continuation instanceof C152441) {
            c152441 = (C152441) continuation;
            if ((c152441.label & Integer.MIN_VALUE) != 0) {
                c152441.label -= Integer.MIN_VALUE;
            } else {
                c152441 = new C152441(continuation);
            }
        } else {
            c152441 = new C152441(continuation);
        }
        Object obj = c152441.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c152441.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            try {
                FlowCollector<? super Object> c152452 = new C152452<>(flowCollector, objectRef2);
                c152441.L$0 = objectRef2;
                c152441.label = 1;
                if (flow.collect(c152452, c152441) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                return null;
            } catch (Throwable th) {
            ...
            objectRef = (Ref.ObjectRef) c152441.L$0;
            try {
                ResultKt.throwOnFailure(obj);
                return null;
            } catch (Throwable th2) {
        ...
        if (isSameExceptionAs$FlowKt__ErrorsKt(th, th3) || isCancellationCause$FlowKt__ErrorsKt(th, c152441.getContext())) {
            throw th;
        }
        if (th3 == null) {
            return th;
    ...
    /* JADX INFO: compiled from: Errors.kt */
    @Metadata(m43474d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@¢\u0006\u0004\b\u0004\u0010\u0005"}, m43475d2 = {"<anonymous>", "", "T", "it", "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, m43476k = 3, m43477mv = {1, 9, 0}, m43479xi = 48)
    static final class C152452<T> implements FlowCollector {
        final /* synthetic */ FlowCollector<T> $collector;
        final /* synthetic */ Ref.ObjectRef<Throwable> $fromDownstream;

        /* JADX WARN: Multi-variable type inference failed */
        C152452(FlowCollector<? super T> flowCollector, Ref.ObjectRef<Throwable> objectRef) {
        ...
        public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
            ...
            if (i != 0) {
                ...
                c152452 = (C152452) flowKt__ErrorsKt$catchImpl$2$emit$1.L$0;
                try {
                    ResultKt.throwOnFailure(obj);
                ...
                L19:
                    ...
                    kotlinx.coroutines.flow.FlowKt__ErrorsKt$catchImpl$2 r5 = (kotlinx.coroutines.flow.FlowKt__ErrorsKt.C152452) r5
                ...
                L4d:
                    ...
                    throw r6
                */
                throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__ErrorsKt.C152452.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
            }
        }
        ...
        public static final <T> Flow<T> m46479catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
