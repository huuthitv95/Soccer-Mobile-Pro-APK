...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3<T> implements Flow<T> {
    ...
    @DebugMetadata(m43503c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3", m43504f = "Builders.kt", m43505i = {0}, m43506l = {114}, m43507m = "collect", m43508n = {"$this$asFlow_u24lambda_u243"}, m43509s = {"L$0"})
    public static final class C152151 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C152151(Continuation continuation) {
            super(continuation);
        }
    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Iterator<T> it;
        if (continuation instanceof C152151) {
            c152151 = (C152151) continuation;
            if ((c152151.label & Integer.MIN_VALUE) != 0) {
                c152151.label -= Integer.MIN_VALUE;
            } else {
                c152151 = new C152151(continuation);
            }
        } else {
            c152151 = new C152151(continuation);
        }
        Object obj = c152151.result;
        ...
        if (i == 0) {
            ...
            it = (Iterator) c152151.L$1;
            FlowCollector flowCollector3 = (FlowCollector) c152151.L$0;
            ResultKt.throwOnFailure(obj);
            flowCollector2 = flowCollector3;
        }
        while (it.hasNext()) {
            T next = it.next();
            c152151.L$0 = flowCollector2;
            c152151.L$1 = it;
            c152151.label = 1;
            if (flowCollector2.emit(next, c152151) == coroutine_suspended) {
