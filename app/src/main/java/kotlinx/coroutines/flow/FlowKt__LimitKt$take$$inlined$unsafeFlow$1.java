...
public final class FlowKt__LimitKt$take$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(m43503c = "kotlinx.coroutines.flow.FlowKt__LimitKt$take$$inlined$unsafeFlow$1", m43504f = "Limit.kt", m43505i = {0}, m43506l = {115}, m43507m = "collect", m43508n = {"ownershipMarker"}, m43509s = {"L$0"})
    public static final class C152501 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        public C152501(Continuation continuation) {
            super(continuation);
        }
    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object obj;
        if (continuation instanceof C152501) {
            c152501 = (C152501) continuation;
            if ((c152501.label & Integer.MIN_VALUE) != 0) {
                c152501.label -= Integer.MIN_VALUE;
            } else {
                c152501 = new C152501(continuation);
            }
        } else {
            c152501 = new C152501(continuation);
        }
        Object obj2 = c152501.result;
        ...
        if (i == 0) {
            ...
            try {
                ...
                c152501.L$0 = obj3;
                c152501.label = 1;
                if (flow.collect(flowKt__LimitKt$take$2$1, c152501) == coroutine_suspended) {
