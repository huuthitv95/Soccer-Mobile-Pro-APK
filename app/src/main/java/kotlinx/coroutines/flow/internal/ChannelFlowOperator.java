...
public abstract class ChannelFlowOperator<S, T> extends ChannelFlow<T> {
    ...
    public final Object collectWithContextUndispatched(FlowCollector<? super T> flowCollector, CoroutineContext coroutineContext, Continuation<? super Unit> continuation) {
        return ChannelFlowKt.withContextUndispatched$default(coroutineContext, ChannelFlowKt.withUndispatchedContextCollector(flowCollector, continuation.get$context()), null, new C153212(this, null), continuation, 4, null);
    }

    /* JADX INFO: renamed from: kotlinx.coroutines.flow.internal.ChannelFlowOperator$collectWithContextUndispatched$2 */
    /* JADX INFO: compiled from: ChannelFlow.kt */
    @Metadata(m43474d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u00032\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u0002H\u00030\u0005H\u008a@"}, m43475d2 = {"<anonymous>", "", ExifInterface.LATITUDE_SOUTH, "T", "it", "Lkotlinx/coroutines/flow/FlowCollector;"}, m43476k = 3, m43477mv = {1, 9, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "kotlinx.coroutines.flow.internal.ChannelFlowOperator$collectWithContextUndispatched$2", m43504f = "ChannelFlow.kt", m43505i = {}, m43506l = {148}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    static final class C153212 extends SuspendLambda implements Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> {
        /* synthetic */ Object L$0;
        int label;
        final /* synthetic */ ChannelFlowOperator<S, T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C153212(ChannelFlowOperator<S, T> channelFlowOperator, Continuation<? super C153212> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C153212 c153212 = new C153212(this.this$0, continuation);
            c153212.L$0 = obj;
            return c153212;
        }
        ...
        public final Object invoke(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
            return ((C153212) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }
