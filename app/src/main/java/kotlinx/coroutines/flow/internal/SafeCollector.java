...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public Object invokeSuspend(Object result) {
        Throwable thM44949exceptionOrNullimpl = Result.m44949exceptionOrNullimpl(result);
        if (thM44949exceptionOrNullimpl != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(thM44949exceptionOrNullimpl, getContext());
        }
        Continuation<? super Unit> continuation = this.completion_;
