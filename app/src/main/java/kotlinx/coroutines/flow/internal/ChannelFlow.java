...
public abstract class ChannelFlow<T> implements FusibleFlow<T> {
  ...
  0x0023: PHI (r4v9 int) = (r4v2 int), (r4v2 int), (r4v7 int) binds: [B:15:0x0021, B:20:0x0029, B:36:0x004f] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    @DebugMetadata(m43503c = "kotlinx.coroutines.flow.internal.ChannelFlow$collect$2", m43504f = "ChannelFlow.kt", m43505i = {}, m43506l = {Sdk.SDKError.Reason.JSON_ENCODE_ERROR_VALUE}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    static final class C153192 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C153192(FlowCollector<? super T> flowCollector, ChannelFlow<T> channelFlow, Continuation<? super C153192> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C153192 c153192 = new C153192(this.$collector, this.this$0, continuation);
            c153192.L$0 = obj;
            return c153192;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C153192) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static /* synthetic */ <T> Object collect$suspendImpl(ChannelFlow<T> channelFlow, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C153192(flowCollector, channelFlow, null), continuation);
