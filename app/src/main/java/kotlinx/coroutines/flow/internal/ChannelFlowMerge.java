...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    protected Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        Object objCollect = this.flow.collect(new C153202((Job) continuation.getContext().get(Job.INSTANCE), SemaphoreKt.Semaphore$default(this.concurrency, 0, 2, null), producerScope, new SendingCollector(producerScope)), continuation);
        return objCollect == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCollect : Unit.INSTANCE;
    }

    /* JADX INFO: renamed from: kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2 */
    /* JADX INFO: compiled from: Merge.kt */
    @Metadata(m43474d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0004H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, m43475d2 = {"<anonymous>", "", "T", "inner", "Lkotlinx/coroutines/flow/Flow;", "emit", "(Lkotlinx/coroutines/flow/Flow;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, m43476k = 3, m43477mv = {1, 9, 0}, m43479xi = 48)
    static final class C153202<T> implements FlowCollector {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C153202(Job job, Semaphore semaphore, ProducerScope<? super T> producerScope, SendingCollector<T> sendingCollector) {
            this.$job = job;
        ...
        public final Object emit(Flow<? extends T> flow, Continuation<? super Unit> continuation) throws Throwable {
            ...
            if (i == 0) {
                ...
                c153202 = (C153202) channelFlowMerge$collectTo$2$emit$1.L$0;
                ResultKt.throwOnFailure(obj);
            }
            BuildersKt__Builders_commonKt.launch$default(c153202.$scope, null, null, new AnonymousClass1(flow, c153202.$collector, c153202.$semaphore, null), 3, null);
        ...
        @DebugMetadata(m43503c = "kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2$1", m43504f = "Merge.kt", m43505i = {}, m43506l = {65}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
