...
public final class StateFlowKt {
    ...
    public static final <T> T updateAndGet(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        RunnableC0005e runnableC0005e;
        T tInvoke;
        do {
            runnableC0005e = (Object) mutableStateFlow.getValue();
            tInvoke = function1.invoke(runnableC0005e);
        } while (!mutableStateFlow.compareAndSet(runnableC0005e, tInvoke));
        return tInvoke;
    }
    ...
    public static final <T> void update(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        ...
        do {
            runnableC0005e = (Object) mutableStateFlow.getValue();
        } while (!mutableStateFlow.compareAndSet(runnableC0005e, function1.invoke(runnableC0005e)));
    }
