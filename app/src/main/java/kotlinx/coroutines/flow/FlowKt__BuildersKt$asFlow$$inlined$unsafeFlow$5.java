...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5<T> implements Flow<T> {
    ...
    @DebugMetadata(m43503c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5", m43504f = "Builders.kt", m43505i = {0}, m43506l = {114}, m43507m = "collect", m43508n = {"$this$asFlow_u24lambda_u247"}, m43509s = {"L$0"})
    public static final class C152171 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C152171(Continuation continuation) {
            super(continuation);
        }
    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Iterator<T> it;
        if (continuation instanceof C152171) {
            c152171 = (C152171) continuation;
            if ((c152171.label & Integer.MIN_VALUE) != 0) {
                c152171.label -= Integer.MIN_VALUE;
            } else {
                c152171 = new C152171(continuation);
            }
        } else {
            c152171 = new C152171(continuation);
        }
        Object obj = c152171.result;
        ...
        if (i == 0) {
            ...
            it = (Iterator) c152171.L$1;
            FlowCollector flowCollector3 = (FlowCollector) c152171.L$0;
            ResultKt.throwOnFailure(obj);
            flowCollector2 = flowCollector3;
        }
        while (it.hasNext()) {
            T next = it.next();
            c152171.L$0 = flowCollector2;
            c152171.L$1 = it;
            c152171.label = 1;
            if (flowCollector2.emit(next, c152171) == coroutine_suspended) {
