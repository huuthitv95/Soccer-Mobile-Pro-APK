...
public final class FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m43503c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2", m43504f = "Reduce.kt", m43505i = {0, 0}, m43506l = {TsExtractor.TS_STREAM_TYPE_DTS_UHD}, m43507m = "emit", m43508n = {"this", "it"}, m43509s = {"L$0", "L$1"})
    public static final class C152661 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C152661(Continuation continuation) {
            super(continuation);
        }
    ...
    public Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C152661) {
            c152661 = (C152661) continuation;
            if ((c152661.label & Integer.MIN_VALUE) != 0) {
                c152661.label -= Integer.MIN_VALUE;
            } else {
                c152661 = new C152661(continuation);
            }
        } else {
            c152661 = new C152661(continuation);
        }
        Object objInvoke = c152661.result;
        ...
        if (i == 0) {
            ...
            c152661.L$1 = t;
            c152661.label = 1;
            objInvoke = function2.invoke(t, c152661);
            ...
            t = (T) c152661.L$1;
            flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2 = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2) c152661.L$0;
            ResultKt.throwOnFailure(objInvoke);
        }
