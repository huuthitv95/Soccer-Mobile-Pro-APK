...
final /* synthetic */ class FlowKt__CollectionKt {
    ...
    @DebugMetadata(m43503c = "kotlinx.coroutines.flow.FlowKt__CollectionKt", m43504f = "Collection.kt", m43505i = {0}, m43506l = {22}, m43507m = "toCollection", m43508n = {"destination"}, m43509s = {"L$0"})
    static final class C152261<T, C extends Collection<? super T>> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C152261(Continuation<? super C152261> continuation) {
            super(continuation);
        }
    ...
    public static final <T, C extends Collection<? super T>> Object toCollection(Flow<? extends T> flow, final C c, Continuation<? super C> continuation) throws Throwable {
        C152261 c152261;
        if (continuation instanceof C152261) {
            c152261 = (C152261) continuation;
            if ((c152261.label & Integer.MIN_VALUE) != 0) {
                c152261.label -= Integer.MIN_VALUE;
            } else {
                c152261 = new C152261(continuation);
            }
        } else {
            c152261 = new C152261(continuation);
        }
        Object obj = c152261.result;
        ...
        if (i != 0) {
            ...
            Collection collection = (Collection) c152261.L$0;
        ...
        c152261.L$0 = c;
        c152261.label = 1;
        return flow.collect(flowCollector, c152261) == coroutine_suspended ? coroutine_suspended : c;
    }
}
