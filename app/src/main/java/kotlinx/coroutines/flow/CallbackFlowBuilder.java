...
final class CallbackFlowBuilder<T> extends ChannelFlowBuilder<T> {
    ...
    @DebugMetadata(m43503c = "kotlinx.coroutines.flow.CallbackFlowBuilder", m43504f = "Builders.kt", m43505i = {0}, m43506l = {330}, m43507m = "collectTo", m43508n = {"scope"}, m43509s = {"L$0"})
    static final class C152101 extends ContinuationImpl {
        Object L$0;
        int label;
        ...
        C152101(CallbackFlowBuilder<T> callbackFlowBuilder, Continuation<? super C152101> continuation) {
            super(continuation);
    ...
    protected Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) throws Throwable {
        C152101 c152101;
        if (continuation instanceof C152101) {
            c152101 = (C152101) continuation;
            if ((c152101.label & Integer.MIN_VALUE) != 0) {
                c152101.label -= Integer.MIN_VALUE;
            } else {
                c152101 = new C152101(this, continuation);
            }
        } else {
            c152101 = new C152101(this, continuation);
        }
        Object obj = c152101.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c152101.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            c152101.L$0 = producerScope;
            c152101.label = 1;
            if (super.collectTo(producerScope, c152101) == coroutine_suspended) {
            ...
            producerScope = (ProducerScope) c152101.L$0;
            ResultKt.throwOnFailure(obj);
        }
