...
final class SubscribedSharedFlow<T> implements SharedFlow<T> {
    ...
    @DebugMetadata(m43503c = "kotlinx.coroutines.flow.SubscribedSharedFlow", m43504f = "Share.kt", m43505i = {}, m43506l = {405}, m43507m = "collect", m43508n = {}, m43509s = {})
    static final class C153181 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;
        final /* synthetic */ SubscribedSharedFlow<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C153181(SubscribedSharedFlow<T> subscribedSharedFlow, Continuation<? super C153181> continuation) {
            super(continuation);
    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<?> continuation) throws Throwable {
        C153181 c153181;
        if (continuation instanceof C153181) {
            c153181 = (C153181) continuation;
            if ((c153181.label & Integer.MIN_VALUE) != 0) {
                c153181.label -= Integer.MIN_VALUE;
            } else {
                c153181 = new C153181(this, continuation);
            }
        } else {
            c153181 = new C153181(this, continuation);
        }
        Object obj = c153181.result;
        ...
        if (i == 0) {
            ...
            c153181.label = 1;
            if (sharedFlow.collect(subscribedFlowCollector, c153181) == coroutine_suspended) {
