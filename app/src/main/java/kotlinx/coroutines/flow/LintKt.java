...
public final class LintKt {
    ...
    private static final <T> Flow<T> m46480catch(SharedFlow<? extends T> sharedFlow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        ...
        return FlowKt.m46468catch(sharedFlow, function3);
    }

    /* JADX INFO: renamed from: kotlinx.coroutines.flow.LintKt$retry$1 */
    /* JADX INFO: compiled from: Lint.kt */
    @Metadata(m43474d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0003\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@"}, m43475d2 = {"<anonymous>", "", "T", "it", ""}, m43476k = 3, m43477mv = {1, 9, 0}, m43479xi = 176)
    @DebugMetadata(m43503c = "kotlinx.coroutines.flow.LintKt$retry$1", m43504f = "Lint.kt", m43505i = {}, m43506l = {}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    public static final class C153111 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;

        public C153111(Continuation<? super C153111> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C153111(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C153111) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
