...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame, Waiter {
    ...
    private final DisposableHandle installParentHandle() {
        ...
        C0189xc40028dd.m89m(_parentHandle$volatile$FU, this, null, disposableHandleInvokeOnCompletion$default);
                ...
                if (obj instanceof CancelHandler ? true : obj instanceof Segment) {
                    ...
                    if (obj instanceof CompletedContinuation) {
                        ...
                        if (completedContinuation.getCancelled()) {
                            ...
                            if (C0189xc40028dd.m89m(_state$volatile$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, null, cancelHandler, null, null, null, 29, null))) {
                                return;
                            }
                        }
                    } else {
                        ...
                        Intrinsics.checkNotNull(handler, "null cannot be cast to non-null type kotlinx.coroutines.CancelHandler");
                        if (C0189xc40028dd.m89m(_state$volatile$FU, this, obj, new CompletedContinuation(obj, (CancelHandler) handler, null, null, null, 28, null))) {
                            return;
                        }
                    }
                }
            } else if (C0189xc40028dd.m89m(_state$volatile$FU, this, obj, handler)) {
                return;
            }
        }
    }
    ...
    private final void resumeImpl(Object proposedUpdate, int resumeMode, Function1<? super Throwable, Unit> onCancellation) {
        ...
        while (true) {
            ...
            if (!(obj instanceof NotCompleted)) {
                ...
                alreadyResumedError(obj2);
                throw new KotlinNothingValueException();
            }
            Object obj3 = proposedUpdate;
            int i = resumeMode;
            Function1<? super Throwable, Unit> function2 = onCancellation;
            if (C0189xc40028dd.m89m(_state$volatile$FU, this, obj, resumedState((NotCompleted) obj, obj3, i, function2, null))) {
    ...
    private final Symbol tryResumeImpl(Object proposedUpdate, Object idempotent, Function1<? super Throwable, Unit> onCancellation) {
        ...
        while (true) {
            ...
            if (!(obj instanceof NotCompleted)) {
                ...
                if ((obj instanceof CompletedContinuation) && obj3 != null) {
                    ...
                    if (completedContinuation.idempotentResume == obj3) {
                        if (!DebugKt.getASSERTIONS_ENABLED() || Intrinsics.areEqual(completedContinuation.result, obj2)) {
            ...
            Function1<? super Throwable, Unit> function1 = onCancellation;
            if (C0189xc40028dd.m89m(_state$volatile$FU, this, obj, resumedState((NotCompleted) obj, obj4, this.resumeMode, function1, obj5))) {
                detachChildIfNonResuable();
                return CancellableContinuationImplKt.RESUME_TOKEN;
            }
            proposedUpdate = obj4;
    ...
    public boolean cancel(Throwable cause) {
        ...
        } while (!C0189xc40028dd.m89m(_state$volatile$FU, this, obj, new CancelledContinuation(this, cause, (obj instanceof CancelHandler) || (obj instanceof Segment))));
    ...
    public void cancelCompletedResult$kotlinx_coroutines_core(Object takenState, Throwable cause) {
        ...
        while (true) {
            ...
            if (obj instanceof CompletedContinuation) {
                ...
                Throwable th2 = cause;
                th = th2;
                if (C0189xc40028dd.m89m(_state$volatile$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, null, null, null, null, th2, 15, null))) {
                    completedContinuation.invokeHandlers(this, th);
                    return;
                }
            } else {
                th = cause;
                if (C0189xc40028dd.m89m(_state$volatile$FU, this, obj, new CompletedContinuation(obj, null, null, null, th, 14, null))) {
                    return;
                }
            }
            cause = th;
