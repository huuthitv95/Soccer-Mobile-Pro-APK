...
public final class SemaphoreKt {
    ...
    @DebugMetadata(m43503c = "kotlinx.coroutines.sync.SemaphoreKt", m43504f = "Semaphore.kt", m43505i = {0, 0}, m43506l = {81}, m43507m = "withPermit", m43508n = {"$this$withPermit", "action"}, m43509s = {"L$0", "L$1"})
    static final class C153431<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        C153431(Continuation<? super C153431> continuation) {
            super(continuation);
        }
    ...
    public static final <T> Object withPermit(Semaphore semaphore, Function0<? extends T> function0, Continuation<? super T> continuation) throws Throwable {
        C153431 c153431;
        if (continuation instanceof C153431) {
            c153431 = (C153431) continuation;
            if ((c153431.label & Integer.MIN_VALUE) != 0) {
                c153431.label -= Integer.MIN_VALUE;
            } else {
                c153431 = new C153431(continuation);
            }
        } else {
            c153431 = new C153431(continuation);
        }
        Object obj = c153431.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c153431.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            c153431.L$0 = semaphore;
            c153431.L$1 = function0;
            c153431.label = 1;
            if (semaphore.acquire(c153431) == coroutine_suspended) {
            ...
            function0 = (Function0) c153431.L$1;
            semaphore = (Semaphore) c153431.L$0;
            ResultKt.throwOnFailure(obj);
        }
        try {
