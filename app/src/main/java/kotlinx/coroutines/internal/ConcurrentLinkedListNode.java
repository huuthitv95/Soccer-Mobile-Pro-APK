...
public abstract class ConcurrentLinkedListNode<N extends ConcurrentLinkedListNode<N>> {
    ...
    public final boolean trySetNext(N value) {
        return C0189xc40028dd.m89m(_next$volatile$FU, this, null, value);
    }
    ...
    public final boolean markAsClosed() {
        return C0189xc40028dd.m89m(_next$volatile$FU, this, null, ConcurrentLinkedListKt.CLOSED);
    }
    ...
    public final void remove() {
        ...
        while (true) {
            ...
            } while (!C0189xc40028dd.m89m(atomicReferenceFieldUpdater, aliveSegmentRight, obj, ((ConcurrentLinkedListNode) obj) == null ? null : aliveSegmentLeft));
