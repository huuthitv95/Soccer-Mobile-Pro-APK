...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM44946constructorimpl = Result.m44946constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m44949exceptionOrNullimpl(objM44946constructorimpl) == null) {
            obj2 = objM44946constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM44946constructorimpl2 = Result.m44946constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM44946constructorimpl2 = Result.m44946constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m44949exceptionOrNullimpl(objM44946constructorimpl2) == null) {
            obj = objM44946constructorimpl2;
        }
        ...
        if (cause != null && Intrinsics.areEqual(cause.getClass(), e.getClass())) {
            ...
            for (StackTraceElement stackTraceElement : stackTrace) {
                if (isArtificial(stackTraceElement)) {
                    return TuplesKt.m43482to(cause, stackTrace);
                }
            }
            return TuplesKt.m43482to(e, new StackTraceElement[0]);
        }
        return TuplesKt.m43482to(e, new StackTraceElement[0]);
    }
