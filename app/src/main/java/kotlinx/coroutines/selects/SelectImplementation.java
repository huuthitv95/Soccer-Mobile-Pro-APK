...
public class SelectImplementation<R> extends CancelHandler implements SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    @DebugMetadata(m43503c = "kotlinx.coroutines.selects.SelectImplementation", m43504f = "Select.kt", m43505i = {0}, m43506l = {438, 441}, m43507m = "doSelectSuspend", m43508n = {"this"}, m43509s = {"L$0"})
    static final class C153361 extends ContinuationImpl {
        Object L$0;
        int label;
        ...
        C153361(SelectImplementation<R> selectImplementation, Continuation<? super C153361> continuation) {
            super(continuation);
    ...
    /* JADX INFO: compiled from: Select.kt */
    @Metadata(m43476k = 3, m43477mv = {1, 9, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "kotlinx.coroutines.selects.SelectImplementation", m43504f = "Select.kt", m43505i = {}, m43506l = {IronSourceError.ERROR_NT_INSTANCE_INIT_EXCEPTION}, m43507m = "processResultAndInvokeBlockRecoveringException", m43508n = {}, m43509s = {})
    static final class C153371 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;
        final /* synthetic */ SelectImplementation<R> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C153371(SelectImplementation<R> selectImplementation, Continuation<? super C153371> continuation) {
            super(continuation);
            this.this$0 = selectImplementation;
        }
    ...
    public final Object doSelectSuspend(Continuation<? super R> continuation) throws Throwable {
        ...
        if (continuation instanceof C153361) {
            c153361 = (C153361) continuation;
            if ((c153361.label & Integer.MIN_VALUE) != 0) {
                c153361.label -= Integer.MIN_VALUE;
            } else {
                c153361 = new C153361(this, continuation);
            }
        } else {
            c153361 = new C153361(this, continuation);
        }
        Object obj = c153361.result;
        ...
        if (i == 0) {
            ...
            c153361.L$0 = this;
            c153361.label = 1;
            if (waitUntilSelected(c153361) != coroutine_suspended) {
        ...
        SelectImplementation selectImplementation2 = (SelectImplementation) c153361.L$0;
        ResultKt.throwOnFailure(obj);
        selectImplementation = selectImplementation2;
        c153361.L$0 = null;
        c153361.label = 2;
        Object objComplete = selectImplementation.complete(c153361);
        ...
        while (true) {
            ...
            if (!(obj instanceof CancellableContinuation)) {
                ...
                if (Intrinsics.areEqual(obj, SelectKt.STATE_REG)) {
                    if (C0189xc40028dd.m89m(state$volatile$FU, this, obj, CollectionsKt.listOf(clauseObject))) {
                        return 1;
                    }
                } else {
                    ...
                    if (C0189xc40028dd.m89m(state$volatile$FU, this, obj, CollectionsKt.plus((Collection<? extends Object>) obj, clauseObject))) {
                        return 1;
                    }
                }
            } else {
                ...
                if (clauseDataFindClause == null) {
                    ...
                    if (C0189xc40028dd.m89m(state$volatile$FU, this, obj, clauseDataFindClause)) {
                        this.internalResult = internalResult;
    ...
    public final Object processResultAndInvokeBlockRecoveringException(SelectImplementation<R>.ClauseData clauseData, Object obj, Continuation<? super R> continuation) throws Throwable {
        C153371 c153371;
        if (continuation instanceof C153371) {
            c153371 = (C153371) continuation;
            if ((c153371.label & Integer.MIN_VALUE) != 0) {
                c153371.label -= Integer.MIN_VALUE;
            } else {
                c153371 = new C153371(this, continuation);
            }
        } else {
            c153371 = new C153371(this, continuation);
        }
        Object obj2 = c153371.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c153371.label;
        try {
            if (i != 0) {
            ...
            c153371.label = 1;
            Object objInvokeBlock = clauseData.invokeBlock(objProcessResult, c153371);
            return objInvokeBlock == coroutine_suspended ? coroutine_suspended : objInvokeBlock;
        } catch (Throwable th) {
            if (DebugKt.getRECOVER_STACK_TRACES() && (c153371 instanceof CoroutineStackFrame)) {
                throw StackTraceRecoveryKt.recoverFromStackFrame(th, c153371);
            }
            throw th;
        }
    }
    ...
    public void invoke2(Throwable cause) {
        ...
        } while (!C0189xc40028dd.m89m(atomicReferenceFieldUpdater, this, obj, SelectKt.STATE_CANCELLED));
        List<SelectImplementation<R>.ClauseData> list = this.clauses;
        if (list == null) {
            return;
        }
    ...
    public final Object waitUntilSelected(Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (obj == SelectKt.STATE_REG) {
                if (C0189xc40028dd.m89m(state$volatile$FU, this, obj, cancellableContinuationImpl2)) {
                    cancellableContinuationImpl2.invokeOnCancellation(this);
                    break;
                }
            } else if (obj instanceof List) {
                if (C0189xc40028dd.m89m(state$volatile$FU, this, obj, SelectKt.STATE_REG)) {
