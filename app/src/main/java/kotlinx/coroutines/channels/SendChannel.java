...
public interface SendChannel<E> {
    ...
    Object mo46439trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m46459isSuccessimpl(objMo46439trySendJP2dKIU)) {
                return true;
            }
            Throwable thM46453exceptionOrNullimpl = ChannelResult.m46453exceptionOrNullimpl(objMo46439trySendJP2dKIU);
