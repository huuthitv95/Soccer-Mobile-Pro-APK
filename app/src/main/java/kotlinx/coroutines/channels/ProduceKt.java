...
public final class ProduceKt {
    ...
    @DebugMetadata(m43503c = "kotlinx.coroutines.channels.ProduceKt", m43504f = "Produce.kt", m43505i = {0, 0}, m43506l = {150}, m43507m = "awaitClose", m43508n = {"$this$awaitClose", "block"}, m43509s = {"L$0", "L$1"})
    static final class C151961 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        C151961(Continuation<? super C151961> continuation) {
            super(continuation);
        }
    ...
    public static final Object awaitClose(ProducerScope<?> producerScope, Function0<Unit> function0, Continuation<? super Unit> continuation) throws Throwable {
        C151961 c151961;
        if (continuation instanceof C151961) {
            c151961 = (C151961) continuation;
            if ((c151961.label & Integer.MIN_VALUE) != 0) {
                c151961.label -= Integer.MIN_VALUE;
            } else {
                c151961 = new C151961(continuation);
            }
        } else {
            c151961 = new C151961(continuation);
        }
        Object obj = c151961.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c151961.label;
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                if (c151961.getContext().get(Job.INSTANCE) != producerScope) {
                    throw new IllegalStateException("awaitClose() can only be invoked from the producer context".toString());
                }
                c151961.L$0 = producerScope;
                c151961.L$1 = function0;
                c151961.label = 1;
                CancellableContinuationImpl cancellableContinuationImpl = new CancellableContinuationImpl(IntrinsicsKt.intercepted(c151961), 1);
                ...
                if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    DebugProbesKt.probeCoroutineSuspended(c151961);
                }
                ...
                function0 = (Function0) c151961.L$1;
                ResultKt.throwOnFailure(obj);
            }
            function0.invoke();
            return Unit.INSTANCE;
