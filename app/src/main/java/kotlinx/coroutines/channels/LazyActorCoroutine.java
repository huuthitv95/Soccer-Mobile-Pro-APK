...
final class LazyActorCoroutine<E> extends ActorCoroutine<E> {
    ...
    public Object mo46439trySendJP2dKIU(E element) {
        start();
        return super.mo46439trySendJP2dKIU(element);
    }
