...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM46467trySendImplMj0NB7M = conflatedBufferedChannel.m46467trySendImplMj0NB7M(e, true);
        if (objM46467trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m46453exceptionOrNullimpl(objM46467trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM46467trySendImplMj0NB7M = conflatedBufferedChannel.m46467trySendImplMj0NB7M(e, true);
        if (!(objM46467trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo46439trySendJP2dKIU(E element) {
        return m46467trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m46467trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m46465trySendDropLatestMj0NB7M(element, isSendOp) : m46466trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m46465trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo46439trySendJP2dKIU = super.mo46439trySendJP2dKIU(element);
        if (ChannelResult.m46459isSuccessimpl(objMo46439trySendJP2dKIU) || ChannelResult.m46457isClosedimpl(objMo46439trySendJP2dKIU)) {
    ...
    private final Object m46466trySendDropOldestJP2dKIU(E element) {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo46439trySendJP2dKIU = mo46439trySendJP2dKIU(element);
        if (!(objMo46439trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo46439trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m46453exceptionOrNullimpl(objMo46439trySendJP2dKIU);
