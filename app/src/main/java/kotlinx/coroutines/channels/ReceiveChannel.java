...
public interface ReceiveChannel<E> {
    ...
    @DebugMetadata(m43503c = "kotlinx.coroutines.channels.ReceiveChannel$DefaultImpls", m43504f = "Channel.kt", m43505i = {}, m43506l = {380}, m43507m = "receiveOrNull", m43508n = {}, m43509s = {})
    static final class C151981<E> extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;

        C151981(Continuation<? super C151981> continuation) {
            super(continuation);
        }
    ...
    Object mo46443receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo46444tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo46444tryReceivePtdJZtk = receiveChannel.mo46444tryReceivePtdJZtk();
            if (ChannelResult.m46459isSuccessimpl(objMo46444tryReceivePtdJZtk)) {
                return (E) ChannelResult.m46455getOrThrowimpl(objMo46444tryReceivePtdJZtk);
            }
            Throwable thM46453exceptionOrNullimpl = ChannelResult.m46453exceptionOrNullimpl(objMo46444tryReceivePtdJZtk);
            if (thM46453exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM46453exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            C151981 c151981;
            Object objMo46443receiveCatchingJP2dKIU;
            if (continuation instanceof C151981) {
                c151981 = (C151981) continuation;
                if ((c151981.label & Integer.MIN_VALUE) != 0) {
                    c151981.label -= Integer.MIN_VALUE;
                } else {
                    c151981 = new C151981(continuation);
                }
            } else {
                c151981 = new C151981(continuation);
            }
            Object obj = c151981.result;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = c151981.label;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                c151981.label = 1;
                objMo46443receiveCatchingJP2dKIU = receiveChannel.mo46443receiveCatchingJP2dKIU(c151981);
                if (objMo46443receiveCatchingJP2dKIU == coroutine_suspended) {
                ...
                ResultKt.throwOnFailure(obj);
                objMo46443receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
            }
            return ChannelResult.m46454getOrNullimpl(objMo46443receiveCatchingJP2dKIU);
        }
