...
@Metadata(m43474d1 = {"\u0000*\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u001a,\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00032\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00010\u0006H\u0082@¢\u0006\u0002\u0010\u0007\u001a,\u0010\b\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00032\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00010\u0006H\u0082@¢\u0006\u0002\u0010\u0007\u001a4\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u00010\n2\u0006\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u00032\b\b\u0002\u0010\u000b\u001a\u00020\f2\b\b\u0002\u0010\r\u001a\u00020\u000eH\u0007¨\u0006\u000f"}, m43475d2 = {"fixedDelayTicker", "", "delayMillis", "", "initialDelayMillis", "channel", "Lkotlinx/coroutines/channels/SendChannel;", "(JJLkotlinx/coroutines/channels/SendChannel;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "fixedPeriodTicker", "ticker", "Lkotlinx/coroutines/channels/ReceiveChannel;", "context", "Lkotlin/coroutines/CoroutineContext;", C11744X3.a.f26183t, "Lkotlinx/coroutines/channels/TickerMode;", "kotlinx-coroutines-core"}, m43476k = 2, m43477mv = {1, 9, 0}, m43479xi = 48)
public final class TickerChannelsKt {
    ...
    @DebugMetadata(m43503c = "kotlinx.coroutines.channels.TickerChannelsKt", m43504f = "TickerChannels.kt", m43505i = {0, 0, 1, 1, 2, 2}, m43506l = {102, 104, 105}, m43507m = "fixedDelayTicker", m43508n = {"channel", "delayMillis", "channel", "delayMillis", "channel", "delayMillis"}, m43509s = {"L$0", "J$0", "L$0", "J$0", "L$0", "J$0"})
    static final class C151991 extends ContinuationImpl {
        long J$0;
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C151991(Continuation<? super C151991> continuation) {
            super(continuation);
        }
    ...
    /* JADX INFO: compiled from: TickerChannels.kt */
    @Metadata(m43476k = 3, m43477mv = {1, 9, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "kotlinx.coroutines.channels.TickerChannelsKt", m43504f = "TickerChannels.kt", m43505i = {0, 0, 0, 1, 1, 1, 2, 2, 2, 3, 3, 3}, m43506l = {80, 84, PDF417Common.MAX_ROWS_IN_BARCODE, 92}, m43507m = "fixedPeriodTicker", m43508n = {"channel", "delayMillis", "deadline", "channel", "deadline", "delayNs", "channel", "deadline", "delayNs", "channel", "deadline", "delayNs"}, m43509s = {"L$0", "J$0", "J$1", "L$0", "J$0", "J$1", "L$0", "J$0", "J$1", "L$0", "J$0", "J$1"})
    static final class C152001 extends ContinuationImpl {
        long J$0;
        long J$1;
        Object L$0;
        int label;
        ...
        C152001(Continuation<? super C152001> continuation) {
            super(continuation);
        }
    ...
    public static final ReceiveChannel<Unit> ticker(long j, long j2, CoroutineContext coroutineContext, TickerMode tickerMode) {
        ...
        return ProduceKt.produce(GlobalScope.INSTANCE, Dispatchers.getUnconfined().plus(coroutineContext), 0, new C152013(tickerMode, j, j2, null));
    }
    ...
    @DebugMetadata(m43503c = "kotlinx.coroutines.channels.TickerChannelsKt$ticker$3", m43504f = "TickerChannels.kt", m43505i = {}, m43506l = {68, 69}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    static final class C152013 extends SuspendLambda implements Function2<ProducerScope<? super Unit>, Continuation<? super Unit>, Object> {
        ...
        C152013(TickerMode tickerMode, long j, long j2, Continuation<? super C152013> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C152013 c152013 = new C152013(this.$mode, this.$delayMillis, this.$initialDelayMillis, continuation);
            c152013.L$0 = obj;
            return c152013;
        }
        ...
        public final Object invoke(ProducerScope<? super Unit> producerScope, Continuation<? super Unit> continuation) {
            return ((C152013) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r11) throws java.lang.Throwable {
            ...
            L1a:
                ...
                int[] r4 = kotlinx.coroutines.channels.TickerChannelsKt.C152013.WhenMappings.$EnumSwitchMapping$0
                int r1 = r1.ordinal()
                r1 = r4[r1]
                if (r1 == r3) goto L44
                if (r1 == r2) goto L30
            ...
            L5a:
                ...
                return r11
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.TickerChannelsKt.C152013.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    */
    public static final java.lang.Object fixedDelayTicker(long r6, long r8, kotlinx.coroutines.channels.SendChannel<? super kotlin.Unit> r10, kotlin.coroutines.Continuation<? super kotlin.Unit> r11) throws java.lang.Throwable {
        /*
            boolean r0 = r11 instanceof kotlinx.coroutines.channels.TickerChannelsKt.C151991
            if (r0 == 0) goto L14
            r0 = r11
            kotlinx.coroutines.channels.TickerChannelsKt$fixedDelayTicker$1 r0 = (kotlinx.coroutines.channels.TickerChannelsKt.C151991) r0
            int r1 = r0.label
