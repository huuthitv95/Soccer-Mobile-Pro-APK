...
public final class InterruptibleKt {
    ...
    /* JADX INFO: compiled from: Interruptible.kt */
    @Metadata(m43474d1 = {"\u0000\b\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001*\u00020\u0002H\u008a@"}, m43475d2 = {"<anonymous>", "T", "Lkotlinx/coroutines/CoroutineScope;"}, m43476k = 3, m43477mv = {1, 9, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "kotlinx.coroutines.InterruptibleKt$runInterruptible$2", m43504f = "Interruptible.kt", m43505i = {}, m43506l = {}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    static final class C151382<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C151382(Function0<? extends T> function0, Continuation<? super C151382> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C151382 c151382 = new C151382(this.$block, continuation);
            c151382.L$0 = obj;
            return c151382;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super T> continuation) {
            return ((C151382) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object runInterruptible(CoroutineContext coroutineContext, Function0<? extends T> function0, Continuation<? super T> continuation) {
        return BuildersKt.withContext(coroutineContext, new C151382(function0, null), continuation);
    }
