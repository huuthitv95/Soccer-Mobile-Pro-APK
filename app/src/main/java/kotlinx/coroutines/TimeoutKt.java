...
public final class TimeoutKt {
    ...
    @DebugMetadata(m43503c = "kotlinx.coroutines.TimeoutKt", m43504f = "Timeout.kt", m43505i = {0, 0, 0}, m43506l = {101}, m43507m = "withTimeoutOrNull", m43508n = {"block", "coroutine", "timeMillis"}, m43509s = {"L$0", "L$1", "J$0"})
    static final class C151411<T> extends ContinuationImpl {
        long J$0;
        Object L$0;
        Object L$1;
        int label;
        ...
        C151411(Continuation<? super C151411> continuation) {
            super(continuation);
        }
    ...
    public static final TimeoutCancellationException TimeoutCancellationException(long j, Delay delay, Job job) {
        String strM46429timeoutMessageLRDsOJo;
        ...
        if (delayWithTimeoutDiagnostics != null) {
            ...
            strM46429timeoutMessageLRDsOJo = delayWithTimeoutDiagnostics.m46429timeoutMessageLRDsOJo(DurationKt.toDuration(j, DurationUnit.MILLISECONDS));
            if (strM46429timeoutMessageLRDsOJo == null) {
                strM46429timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
            }
        } else {
            strM46429timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
        }
        return new TimeoutCancellationException(strM46429timeoutMessageLRDsOJo, job);
    }
    ...
    public static final <T> Object m46436withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m46428toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final <T> Object withTimeoutOrNull(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) throws Throwable {
        ...
        if (continuation instanceof C151411) {
            c151411 = (C151411) continuation;
            if ((c151411.label & Integer.MIN_VALUE) != 0) {
                c151411.label -= Integer.MIN_VALUE;
            } else {
                c151411 = new C151411(continuation);
            }
        } else {
            c151411 = new C151411(continuation);
        }
        Object obj = c151411.result;
        ...
        if (i == 0) {
            ...
            try {
                c151411.L$0 = function2;
                c151411.L$1 = objectRef2;
                c151411.J$0 = j;
                c151411.label = 1;
                ?? r4 = (T) new TimeoutCoroutine(j, c151411);
                objectRef2.element = r4;
                Object obj2 = setupTimeout(r4, function2);
                if (obj2 == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    DebugProbesKt.probeCoroutineSuspended(c151411);
                }
            ...
            long j2 = c151411.J$0;
            objectRef = (Ref.ObjectRef) c151411.L$1;
            try {
                ResultKt.throwOnFailure(obj);
                return obj;
    ...
    public static final <T> Object m46437withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m46428toDelayMillisLRDsOJo(j), function2, continuation);
    }
}
