...
public final class Response implements Closeable, AutoCloseable {
    ...
    public final CacheControl m46669deprecated_cacheControl() {
        return cacheControl();
    }
