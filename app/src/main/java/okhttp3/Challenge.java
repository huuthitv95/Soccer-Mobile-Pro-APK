...
public final class Challenge {
    ...
    public final Map<String, String> m46573deprecated_authParams() {
        return this.authParams;
    }
    ...
    public final String m46575deprecated_realm() {
        return realm();
    }
    ...
    public final Charset m46574deprecated_charset() {
        return charset();
    }
