...
public class AppLinkNavigation {
    ...
    public enum NavigationResult {
        FAILED(C11744X3.i.f26392t, false),
    ...
    public NavigationResult navigate(Context context) {
        ...
        do {
            ...
            intent.putExtra(com.facebook.bolts.AppLinks.KEY_NAME_APPLINK_DATA, bundleBuildAppLinkDataForNavigation);
        ...
        if (intent != null) {
            ...
            if (webUrl != null) {
                try {
                    intent = new Intent("android.intent.action.VIEW", webUrl.buildUpon().appendQueryParameter(com.facebook.bolts.AppLinks.KEY_NAME_APPLINK_DATA, getJSONForBundle(bundleBuildAppLinkDataForNavigation).toString()).build());
