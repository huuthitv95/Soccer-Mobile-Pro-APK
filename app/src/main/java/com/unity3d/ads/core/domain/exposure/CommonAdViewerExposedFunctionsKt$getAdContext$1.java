...
final class CommonAdViewerExposedFunctionsKt$getAdContext$1 implements ExposedFunction {
    ...
    public final Object invoke2(Object[] objArr, Continuation<Object> continuation) throws Throwable {
        ...
        if (isOMActivated.invoke()) {
            map2.put(HandleInvocationsFromAdViewer.KEY_OMID, MapsKt.mapOf(TuplesKt.m43482to(HandleInvocationsFromAdViewer.KEY_OMJS_SESSION, UnityAdsConstants.OpenMeasurement.OM_JS_URL_SESSION), TuplesKt.m43482to(HandleInvocationsFromAdViewer.KEY_OMJS_SERVICE, UnityAdsConstants.OpenMeasurement.OM_JS_URL_SERVICE)));
        }
        ...
        map2.put("impressionOpportunityId", string);
