...
public final class AndroidAttribution {
    ...
    private final MeasurementManager getMeasurementManager() {
        return AdFilters$$ExternalSyntheticApiModelOutline0.m708m(this.measurementManager.getValue());
    }
    ...
    public final Object isAvailable(Continuation<? super Boolean> continuation) throws Throwable {
        ...
        if (Device.getApiLevel() >= 33 && SdkExtensions.getExtensionVersion(1000000) >= 4 && getMeasurementManager() != null && AdServicesState.isAdServicesStateEnabled()) {
            ...
            if (measurementManager != null) {
                measurementManager.getMeasurementApiStatus(ExecutorsKt.asExecutor(this.dispatchers.getDefault()), HalfKt$$ExternalSyntheticApiModelOutline0.m157m((Object) new OutcomeReceiver<Integer, Exception>() { // from class: com.unity3d.ads.core.domain.attribution.AndroidAttribution$isAvailable$2$1
                    public void onError(Exception error) {
                        Intrinsics.checkNotNullParameter(error, "error");
                        Continuation<Boolean> continuation2 = safeContinuation2;
                        Result.Companion companion = Result.INSTANCE;
                        continuation2.resumeWith(Result.m44946constructorimpl(false));
                    }

                    public void onResult(int status) {
                        Continuation<Boolean> continuation2 = safeContinuation2;
                        Result.Companion companion = Result.INSTANCE;
                        continuation2.resumeWith(Result.m44946constructorimpl(Boolean.valueOf(status == 1)));
                    }
            ...
            if (unit == null) {
                Result.Companion companion = Result.INSTANCE;
                safeContinuation2.resumeWith(Result.m44946constructorimpl(Boxing.boxBoolean(false)));
            }
    ...
    public final Object registerClick(String str, AdObject adObject, Continuation<? super Boolean> continuation) throws Throwable {
        ...
        MeasurementManager measurementManager = getMeasurementManager();
        if (measurementManager != null) {
            measurementManager.registerSource(getUri(str, adObject), value, ExecutorsKt.asExecutor(this.dispatchers.getDefault()), HalfKt$$ExternalSyntheticApiModelOutline0.m157m((Object) new OutcomeReceiver<Object, Exception>() { // from class: com.unity3d.ads.core.domain.attribution.AndroidAttribution$registerClick$2$1
                public void onError(Exception error) {
                    Intrinsics.checkNotNullParameter(error, "error");
                    Continuation<Boolean> continuation2 = safeContinuation2;
                    Result.Companion companion = Result.INSTANCE;
                ...
                public void onResult(Object p0) {
                    ...
                    Continuation<Boolean> continuation2 = safeContinuation2;
                    Result.Companion companion = Result.INSTANCE;
                    continuation2.resumeWith(Result.m44946constructorimpl(true));
                }
            }));
            unit = Unit.INSTANCE;
        } else {
    ...
    public final Object registerView(String str, AdObject adObject, Continuation<? super Boolean> continuation) throws Throwable {
        ...
        Unit unit = null;
        if (measurementManager != null) {
            measurementManager.registerSource(getUri(str, adObject), null, ExecutorsKt.asExecutor(this.dispatchers.getDefault()), HalfKt$$ExternalSyntheticApiModelOutline0.m157m((Object) new OutcomeReceiver<Object, Exception>() { // from class: com.unity3d.ads.core.domain.attribution.AndroidAttribution$registerView$2$1
                public void onError(Exception error) {
                    Intrinsics.checkNotNullParameter(error, "error");
                    Continuation<Boolean> continuation2 = safeContinuation2;
                    Result.Companion companion = Result.INSTANCE;
