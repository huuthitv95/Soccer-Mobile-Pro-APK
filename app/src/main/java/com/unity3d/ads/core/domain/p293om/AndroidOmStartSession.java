...
public final class AndroidOmStartSession extends AndroidOmInteraction {
    ...
    @DebugMetadata(m43503c = "com.unity3d.ads.core.domain.om.AndroidOmStartSession", m43504f = "AndroidOmStartSession.kt", m43505i = {0, 0}, m43506l = {18}, m43507m = "invoke", m43508n = {"this", "adObject"}, m43509s = {"L$0", "L$1"})
    static final class C146171 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        C146171(Continuation<? super C146171> continuation) {
            super(continuation);
        }
    ...
    @Override // com.unity3d.ads.core.domain.p293om.OmInteraction
    public Object invoke(AdObject adObject, JSONObject jSONObject, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C146171) {
            c146171 = (C146171) continuation;
            if ((c146171.label & Integer.MIN_VALUE) != 0) {
                c146171.label -= Integer.MIN_VALUE;
            } else {
                c146171 = new C146171(continuation);
            }
        } else {
            c146171 = new C146171(continuation);
        }
        Object objStartSession = c146171.result;
        ...
        if (i == 0) {
            ...
            c146171.L$0 = this;
            c146171.L$1 = adObject;
            c146171.label = 1;
            objStartSession = openMeasurementRepository.startSession(opportunityId, webview, oMidOptions, c146171);
            ...
            adObject = (AdObject) c146171.L$1;
            androidOmStartSession = (AndroidOmStartSession) c146171.L$0;
            ResultKt.throwOnFailure(objStartSession);
        }
