...
@Metadata(m43474d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\u001a\u0018\u0010\u0000\u001a\u0010\u0012\u0004\u0012\u00020\u0002\u0012\u0006\u0012\u0004\u0018\u00010\u00030\u0001*\u00020\u0004¨\u0006\u0005"}, m43475d2 = {"toBuiltInMap", "", "", "", "Lorg/json/JSONObject;", "unity-ads_defaultRelease"}, m43476k = 2, m43477mv = {1, 8, 0}, m43479xi = 48)
    ...
    public static final Map<String, Object> toBuiltInMap(JSONObject jSONObject) {
        ...
        for (Object obj : sequenceAsSequence) {
            ...
            if (objOpt != null) {
                ...
                if (Intrinsics.areEqual(String.valueOf(objOpt), AdError.UNDEFINED_DOMAIN) || Intrinsics.areEqual(String.valueOf(objOpt), AbstractJsonLexerKt.NULL)) {
                    objOpt = null;
                }
            } else {
                objOpt = null;
