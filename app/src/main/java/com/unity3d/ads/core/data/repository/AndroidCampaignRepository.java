...
import gatewayprotocol.p299v1.CampaignStateKt;
...
public final class AndroidCampaignRepository implements CampaignRepository {
    ...
    public void setCampaign(ByteString opportunityId, CampaignStateOuterClass.Campaign campaign) {
        ...
        do {
            value = mutableStateFlow.getValue();
        } while (!mutableStateFlow.compareAndSet(value, MapsKt.plus(value, TuplesKt.m43482to(opportunityId.toStringUtf8(), campaign))));
    }
