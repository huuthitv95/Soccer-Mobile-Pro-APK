...
@Metadata(m43474d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006R\u0017\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\t0\b¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u000b¨\u0006\f"}, m43475d2 = {"Lcom/unity3d/ads/core/data/repository/FocusRepository;", "", "getLifecycleFlow", "Lcom/unity3d/ads/core/domain/AndroidGetLifecycleFlow;", "defaultDispatcher", "Lkotlinx/coroutines/CoroutineDispatcher;", "(Lcom/unity3d/ads/core/domain/AndroidGetLifecycleFlow;Lkotlinx/coroutines/CoroutineDispatcher;)V", "focusState", "Lkotlinx/coroutines/flow/SharedFlow;", "Lcom/unity3d/ads/core/data/repository/FocusState;", "getFocusState", "()Lkotlinx/coroutines/flow/SharedFlow;", "unity-ads_defaultRelease"}, m43476k = 1, m43477mv = {1, 8, 0}, m43479xi = 48)
    ...
    public FocusRepository(AndroidGetLifecycleFlow getLifecycleFlow, CoroutineDispatcher defaultDispatcher) {
        ...
        try {
            ...
            final Flow<LifecycleEvent> flow = new Flow<LifecycleEvent>() { // from class: com.unity3d.ads.core.data.repository.FocusRepository$special$$inlined$filter$1
                ...
                /* JADX INFO: renamed from: com.unity3d.ads.core.data.repository.FocusRepository$special$$inlined$filter$1$2 */
                ...
                public static final class C144742<T> implements FlowCollector {
                    ...
                    @DebugMetadata(m43503c = "com.unity3d.ads.core.data.repository.FocusRepository$special$$inlined$filter$1$2", m43504f = "FocusRepository.kt", m43505i = {}, m43506l = {Sdk.SDKError.Reason.STALE_CACHED_RESPONSE_VALUE}, m43507m = "emit", m43508n = {}, m43509s = {})
                    public static final class AnonymousClass1 extends ContinuationImpl {
                        ...
                        public final Object invokeSuspend(Object obj) {
                            ...
                            return C144742.this.emit(null, this);
                        }
                    }

                    public C144742(FlowCollector flowCollector) {
                ...
                public Object collect(FlowCollector<? super LifecycleEvent> flowCollector, Continuation continuation) {
                    Object objCollect = flowInvoke.collect(new C144742(flowCollector), continuation);
            ...
            mutableSharedFlowMutableSharedFlow$default = FlowKt.shareIn(new Flow<FocusState>() { // from class: com.unity3d.ads.core.data.repository.FocusRepository$special$$inlined$map$1
                ...
                /* JADX INFO: renamed from: com.unity3d.ads.core.data.repository.FocusRepository$special$$inlined$map$1$2 */
                /* JADX INFO: compiled from: Emitters.kt */
                ...
                public static final class C144752<T> implements FlowCollector {
                    final /* synthetic */ FlowCollector $this_unsafeFlow;
                    ...
                    /* JADX INFO: compiled from: Emitters.kt */
                    @Metadata(m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
                    @DebugMetadata(m43503c = "com.unity3d.ads.core.data.repository.FocusRepository$special$$inlined$map$1$2", m43504f = "FocusRepository.kt", m43505i = {}, m43506l = {Sdk.SDKError.Reason.STALE_CACHED_RESPONSE_VALUE}, m43507m = "emit", m43508n = {}, m43509s = {})
                    public static final class AnonymousClass1 extends ContinuationImpl {
                        Object L$0;
                        int label;
                        /* synthetic */ Object result;
                        ...
                        public final Object invokeSuspend(Object obj) {
                            this.result = obj;
                            this.label |= Integer.MIN_VALUE;
                            return C144752.this.emit(null, this);
                        }
                    }

                    public C144752(FlowCollector flowCollector) {
                        this.$this_unsafeFlow = flowCollector;
                    }
                ...
                public Object collect(FlowCollector<? super FocusState> flowCollector, Continuation continuation) {
                    Object objCollect = flow.collect(new C144752(flowCollector), continuation);
                    return objCollect == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCollect : Unit.INSTANCE;
                }
