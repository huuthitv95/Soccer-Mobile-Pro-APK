...
public final class AndroidDeviceInfoRepository implements DeviceInfoRepository {
    ...
    @DebugMetadata(m43503c = "com.unity3d.ads.core.data.repository.AndroidDeviceInfoRepository", m43504f = "AndroidDeviceInfoRepository.kt", m43505i = {}, m43506l = {38}, m43507m = "getAuidByteString", m43508n = {}, m43509s = {})
    static final class C144581 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;

        C144581(Continuation<? super C144581> continuation) {
            super(continuation);
        }
    ...
    public Object getAuidByteString(Continuation<? super ByteString> continuation) throws Throwable {
        C144581 c144581;
        if (continuation instanceof C144581) {
            c144581 = (C144581) continuation;
            if ((c144581.label & Integer.MIN_VALUE) != 0) {
                c144581.label -= Integer.MIN_VALUE;
            } else {
                c144581 = new C144581(continuation);
            }
        } else {
            c144581 = new C144581(continuation);
        }
        Object auidString = c144581.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c144581.label;
        if (i == 0) {
            ResultKt.throwOnFailure(auidString);
            c144581.label = 1;
            auidString = getAuidString(c144581);
