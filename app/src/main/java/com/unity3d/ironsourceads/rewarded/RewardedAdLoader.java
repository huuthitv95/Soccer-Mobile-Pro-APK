...
import com.ironsource.C11601Od;
...
public final class RewardedAdLoader {
    ...
    private static final Executor f41437a = C11613P7.f25510a.m27223d();
    ...
    /* JADX INFO: renamed from: a */
    public static final void m43187a(InterfaceC12604xb loadTask) {
    ...
    public static final void loadAd(RewardedAdRequest adRequest, RewardedAdLoaderListener listener) {
        ...
        INSTANCE.internalLoadAd$mediationsdk_release(f41437a, new C11601Od(adRequest, listener, C12170ec.f30306e.m31374a(IronSource.EnumC12328a.REWARDED_VIDEO), null, 8, null));
    }
    ...
    public final void internalLoadAd$mediationsdk_release(Executor executor, InterfaceC11347Ab loadTaskProvider) {
        ...
        executor.execute(new Runnable() { // from class: com.unity3d.ironsourceads.rewarded.RewardedAdLoader$$ExternalSyntheticLambda0
            ...
            public final void run() {
                RewardedAdLoader.m43187a(interfaceC12604xbMo25303a);
            }
        });
    }
}
