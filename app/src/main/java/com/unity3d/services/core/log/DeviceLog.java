...
public class DeviceLog {
    ...
    static /* synthetic */ class C148541 {
        ...
        static {
            ...
            try {
                f41829xf32d8d1[UnityAdsLogLevel.DEBUG.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f41829xf32d8d1[UnityAdsLogLevel.WARNING.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f41829xf32d8d1[UnityAdsLogLevel.ERROR.ordinal()] = 4;
    ...
    private static void write(UnityAdsLogLevel unityAdsLogLevel, String str) {
        boolean z;
        int i = C148541.f41829xf32d8d1[unityAdsLogLevel.ordinal()];
        if (i == 1) {
            z = LOG_INFO;
        } else if (i == 2) {
            z = LOG_DEBUG;
    ...
    private static void writeToLog(DeviceLogEntry deviceLogEntry) {
        ...
        try {
            ...
            Log.e(C11540L6.f24919H1, "Writing to log failed!", e);
            method = null;
        }
        if (method != null) {
            try {
                ...
                Log.e(C11540L6.f24919H1, "Writing to log failed!", e2);
            }
        }
    }
}
