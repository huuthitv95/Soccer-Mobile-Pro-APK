...
public final /* data */ class HttpResponse {
    ...
    public int hashCode() {
        return (((((((((((this.body.hashCode() * 31) + this.statusCode) * 31) + this.headers.hashCode()) * 31) + this.urlString.hashCode()) * 31) + this.protocol.hashCode()) * 31) + this.client.hashCode()) * 31) + UByte$$ExternalSyntheticBackport0.m43485m(this.contentSize);
    }
