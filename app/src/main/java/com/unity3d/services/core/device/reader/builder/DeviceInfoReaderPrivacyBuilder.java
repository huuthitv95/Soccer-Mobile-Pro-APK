...
public class DeviceInfoReaderPrivacyBuilder extends DeviceInfoReaderBuilder {
    ...
    private JsonFlattenerRules getPrivacyRequestStorageRules() {
        return new JsonFlattenerRules(Arrays.asList(ShareConstants.WEB_DIALOG_PARAM_PRIVACY, GDPR.GDPR_STANDARD, "unity", "pipl"), Collections.singletonList("value"), Arrays.asList("ts", "exclude", C11744X3.a.f26183t));
    }
