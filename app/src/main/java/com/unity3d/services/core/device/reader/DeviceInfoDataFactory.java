...
public class DeviceInfoDataFactory {
    ...
    public IDeviceInfoDataContainer getDeviceInfoData(InitRequestType initRequestType) {
        int i = C148371.f41827x5633d9cb[initRequestType.ordinal()];
        if (i == 1) {
