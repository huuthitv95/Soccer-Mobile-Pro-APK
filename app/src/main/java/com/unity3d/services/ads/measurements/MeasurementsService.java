...
public final class MeasurementsService {
    ...
    public final void checkAvailability() {
        ...
        if (this.measurementManager == null) {
            ...
            this.measurementManager.getMeasurementApiStatus(ExecutorsKt.asExecutor(this.dispatchers.getDefault()), HalfKt$$ExternalSyntheticApiModelOutline0.m157m((Object) new MeasurementsStatusReceiver(this.eventSender)));
        } else {
    ...
    public final void registerClick(String url, InputEvent inputEvent) {
        ...
        if (measurementManager != null) {
            measurementManager.registerSource(Uri.parse(url), inputEvent, ExecutorsKt.asExecutor(this.dispatchers.getDefault()), HalfKt$$ExternalSyntheticApiModelOutline0.m157m((Object) new MeasurementsReceiver(this.eventSender, MeasurementsEvents.CLICK_SUCCESSFUL, MeasurementsEvents.CLICK_ERROR)));
        }
    }
    ...
    public final void registerTrigger(String url) {
        ...
        MeasurementManager measurementManager = this.measurementManager;
        if (measurementManager != null) {
            measurementManager.registerTrigger(Uri.parse(url), ExecutorsKt.asExecutor(this.dispatchers.getDefault()), HalfKt$$ExternalSyntheticApiModelOutline0.m157m((Object) new MeasurementsReceiver(this.eventSender, MeasurementsEvents.TRIGGER_SUCCESSFUL, MeasurementsEvents.TRIGGER_ERROR)));
        }
    }
    ...
    public final void registerView(String url) {
        ...
        MeasurementManager measurementManager = this.measurementManager;
        if (measurementManager != null) {
            measurementManager.registerSource(Uri.parse(url), null, ExecutorsKt.asExecutor(this.dispatchers.getDefault()), HalfKt$$ExternalSyntheticApiModelOutline0.m157m((Object) new MeasurementsReceiver(this.eventSender, MeasurementsEvents.VIEW_SUCCESSFUL, MeasurementsEvents.VIEW_ERROR)));
        }
    }
}
