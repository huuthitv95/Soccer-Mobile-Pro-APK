...
public final class OfferwallAdapterBridge {
    ...
    /* JADX INFO: renamed from: com.unity3d.services.ads.offerwall.OfferwallAdapterBridge$showAd$1 */
    /* JADX INFO: compiled from: OfferwallAdapterBridge.kt */
    @Metadata(m43474d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m43475d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "com.unity3d.services.ads.offerwall.OfferwallAdapterBridge$showAd$1", m43504f = "OfferwallAdapterBridge.kt", m43505i = {}, m43506l = {56}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    static final class C147601 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ String $placementName;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C147601(String str, Continuation<? super C147601> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return OfferwallAdapterBridge.this.new C147601(this.$placementName, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C147601) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
            ...
            switch (name.hashCode()) {
                ...
                case 2137477050:
                    if (name.equals("onRequestFailure")) {
                        ...
                        DeviceLog.error("Placement request failed: " + placementName5 + " - errorCode: " + ((Integer) obj6.getClass().getField(TTEDPEventConstants.EDP_EVENT_PROPERTY_PAY_CODE).get(obj6)) + ", errorMessage: " + ((String) obj6.getClass().getField("message").get(obj6)));
    ...
    public final boolean isAdReady(String placementName) {
        ...
        Method declaredMethod = (placement == null || (cls = placement.getClass()) == null) ? null : cls.getDeclaredMethod("isContentReady", null);
    ...
    public final void loadAd(String placementName) throws IllegalAccessException, InvocationTargetException {
        ...
        Method declaredMethod = (placement == null || (cls = placement.getClass()) == null) ? null : cls.getDeclaredMethod("requestContent", null);
    ...
    public final void showAd(String placementName) throws IllegalAccessException, InvocationTargetException {
        ...
        Method declaredMethod = (obj == null || (cls2 = obj.getClass()) == null) ? null : cls2.getDeclaredMethod("isContentAvailable", null);
        Boolean bool = (Boolean) (declaredMethod != null ? declaredMethod.invoke(obj, null) : null);
        if (bool != null ? bool.booleanValue() : false) {
            Method declaredMethod2 = (obj == null || (cls = obj.getClass()) == null) ? null : cls.getDeclaredMethod("showContent", null);
            if (declaredMethod2 != null) {
                declaredMethod2.invoke(obj, null);
            }
        } else {
            BuildersKt__Builders_commonKt.launch$default(this.scope, null, null, new C147601(placementName, null), 3, null);
        }
