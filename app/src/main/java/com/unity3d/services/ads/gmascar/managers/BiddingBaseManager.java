...
public abstract class BiddingBaseManager implements IBiddingManager {
    ...
    /* JADX INFO: renamed from: lambda$fetchSignals$1$com-unity3d-services-ads-gmascar-managers-BiddingBaseManager */
    /* synthetic */ void m43449xbd500567() {
    ...
    /* JADX INFO: renamed from: lambda$onUnityAdsTokenReady$0$com-unity3d-services-ads-gmascar-managers-BiddingBaseManager */
    /* synthetic */ void m43450x87509455(String str) {
        this.unityAdsTokenListener.onUnityAdsTokenReady(str);
    }

    /* JADX INFO: renamed from: lambda$uploadSignals$2$com-unity3d-services-ads-gmascar-managers-BiddingBaseManager */
    /* synthetic */ void m43451xb93d3227(BiddingSignals biddingSignals) {
        try {
    ...
    public void uploadSignals() {
        ...
        if (biddingSignals == null || biddingSignals.isEmpty()) {
            ...
            new Thread(new Runnable() { // from class: com.unity3d.services.ads.gmascar.managers.BiddingBaseManager$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m43451xb93d3227(biddingSignals);
                }
            }).start();
        }
    }
