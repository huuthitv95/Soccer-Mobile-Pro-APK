...
public class WebPlayerView extends WebView {
    ...
    private class WebPlayerChromeClient extends WebChromeClient {
        ...
        public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
            Boolean boolValueOf = WebPlayerView.this.shouldCallSuper("onConsoleMessage") ? Boolean.valueOf(super.onConsoleMessage(consoleMessage)) : false;
        ...
        public boolean onCreateWindow(WebView webView, boolean z, boolean z2, Message message) {
            Boolean boolValueOf = WebPlayerView.this.shouldCallSuper("onCreateWindow") ? Boolean.valueOf(super.onCreateWindow(webView, z, z2, message)) : false;
        ...
        public boolean onJsAlert(WebView webView, String str, String str2, JsResult jsResult) {
            Boolean boolValueOf = WebPlayerView.this.shouldCallSuper("onJsAlert") ? Boolean.valueOf(super.onJsAlert(webView, str, str2, jsResult)) : false;
        ...
        public boolean onJsConfirm(WebView webView, String str, String str2, JsResult jsResult) {
            Boolean boolValueOf = WebPlayerView.this.shouldCallSuper("onJsConfirm") ? Boolean.valueOf(super.onJsConfirm(webView, str, str2, jsResult)) : false;
        ...
        public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> valueCallback, WebChromeClient.FileChooserParams fileChooserParams) {
            Boolean boolValueOf = WebPlayerView.this.shouldCallSuper("onShowFileChooser") ? Boolean.valueOf(super.onShowFileChooser(webView, valueCallback, fileChooserParams)) : false;
    ...
    private class WebPlayerClient extends WebViewClient {
        ...
        public boolean shouldOverrideKeyEvent(WebView webView, KeyEvent keyEvent) {
            Boolean boolValueOf = WebPlayerView.this.shouldCallSuper("shouldOverrideKeyEvent") ? Boolean.valueOf(super.shouldOverrideKeyEvent(webView, keyEvent)) : false;
        ...
        public boolean shouldOverrideUrlLoading(WebView webView, WebResourceRequest webResourceRequest) {
            Boolean boolValueOf = WebPlayerView.this.shouldCallSuper("shouldOverrideUrlLoading") ? Boolean.valueOf(super.shouldOverrideUrlLoading(webView, webResourceRequest)) : false;
        ...
        public boolean shouldOverrideUrlLoading(WebView webView, String str) {
            Boolean boolValueOf = WebPlayerView.this.shouldCallSuper("shouldOverrideUrlLoading") ? Boolean.valueOf(super.shouldOverrideUrlLoading(webView, str)) : false;
            if (WebPlayerView.this.shouldSendEvent("shouldOverrideUrlLoading")) {
