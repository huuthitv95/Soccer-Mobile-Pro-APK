...
public abstract class SignalsCollectorBase implements ISignalsCollector {
    ...
    /* JADX INFO: renamed from: com.unity3d.scar.adapter.common.signals.SignalsCollectorBase$1 */
    ...
    public String getAdKey(UnityAdFormat unityAdFormat) {
        int i = C146971.$SwitchMap$com$unity3d$scar$adapter$common$scarads$UnityAdFormat[unityAdFormat.ordinal()];
        if (i == 1) {
