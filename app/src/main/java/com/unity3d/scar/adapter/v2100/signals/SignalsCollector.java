...
public class SignalsCollector extends SignalsCollectorBase implements ISignalsCollector {
    ...
    /* JADX INFO: renamed from: com.unity3d.scar.adapter.v2100.signals.SignalsCollector$1 */
    static /* synthetic */ class C147081 {
    ...
    public AdFormat getAdFormat(UnityAdFormat unityAdFormat) {
        int i = C147081.$SwitchMap$com$unity3d$scar$adapter$common$scarads$UnityAdFormat[unityAdFormat.ordinal()];
        if (i == 1) {
            return AdFormat.BANNER;
        }
        if (i != 2) {
            return i != 3 ? AdFormat.UNKNOWN : AdFormat.REWARDED;
        }
