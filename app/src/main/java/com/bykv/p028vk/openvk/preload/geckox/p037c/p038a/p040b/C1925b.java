...
/* JADX INFO: renamed from: com.bykv.vk.openvk.preload.geckox.c.a.b.b */
/* JADX INFO: compiled from: CheckPatchSingleFileMD5Interceptor.java */
/* JADX INFO: loaded from: classes3.dex */
public class C1925b extends AbstractC1886d<Pair<InterfaceC1913a, UpdatePackage>, Pair<InterfaceC1913a, UpdatePackage>> {
    ...
    private static Object a2(InterfaceC1882b<Pair<InterfaceC1913a, UpdatePackage>> interfaceC1882b, Pair<InterfaceC1913a, UpdatePackage> pair) throws Throwable {
        GeckoLogger.m6040d("gecko-debug-tag", "start check patch single file, channel:", ((UpdatePackage) pair.second).getChannel());
        InterfaceC1913a interfaceC1913a = (InterfaceC1913a) pair.first;
        interfaceC1913a.mo5976b(0L);
        UpdatePackage updatePackage = (UpdatePackage) pair.second;
        try {
            C1967d.m6081a(new C1917a(interfaceC1913a), updatePackage.getPatch().getMd5());
            return interfaceC1882b.mo5836a(pair);
        } catch (Throwable th) {
            throw new C1912b("check patch single file failed, channel:" + updatePackage.getChannel() + ", pkg id:" + updatePackage.getPatch().getId() + ", caused by:" + th.getMessage(), th);
        }
    }
