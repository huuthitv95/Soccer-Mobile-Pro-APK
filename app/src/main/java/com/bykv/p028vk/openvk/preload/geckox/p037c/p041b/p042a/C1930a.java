...
/* JADX INFO: renamed from: com.bykv.vk.openvk.preload.geckox.c.b.a.a */
/* JADX INFO: compiled from: CheckFullZipMD5Interceptor.java */
/* JADX INFO: loaded from: classes3.dex */
public class C1930a extends AbstractC1886d<Pair<InterfaceC1913a, UpdatePackage>, Pair<InterfaceC1913a, UpdatePackage>> {
    ...
    private static Object a2(InterfaceC1882b<Pair<InterfaceC1913a, UpdatePackage>> interfaceC1882b, Pair<InterfaceC1913a, UpdatePackage> pair) throws Throwable {
        GeckoLogger.m6040d("gecko-debug-tag", "start check full zip file, channel:", ((UpdatePackage) pair.second).getChannel());
        ...
        try {
            ...
            throw new C1912b("check full zip file failed, channel:" + updatePackage.getChannel() + ", pkg id:" + updatePackage.getFullPackage().getId() + ", caused by:" + th.getMessage(), th);
        }
    }
