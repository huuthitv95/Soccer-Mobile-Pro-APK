...
/* JADX INFO: renamed from: com.bykv.vk.openvk.preload.geckox.c.b.b.b */
/* JADX INFO: compiled from: CheckPatchZipMD5Interceptor.java */
/* JADX INFO: loaded from: classes3.dex */
public class C1935b extends AbstractC1886d<Pair<InterfaceC1913a, UpdatePackage>, Pair<InterfaceC1913a, UpdatePackage>> {
    ...
    private static Object a2(InterfaceC1882b<Pair<InterfaceC1913a, UpdatePackage>> interfaceC1882b, Pair<InterfaceC1913a, UpdatePackage> pair) throws Throwable {
        GeckoLogger.m6040d("gecko-debug-tag", "start check patch zip file, channel:", ((UpdatePackage) pair.second).getChannel());
        ...
        try {
            ...
            throw new C1912b("check patch zip file failed, channel:" + updatePackage.getChannel() + ", pkg id:" + updatePackage.getPatch().getId() + ", caused by:" + th.getMessage(), th);
        }
    }
