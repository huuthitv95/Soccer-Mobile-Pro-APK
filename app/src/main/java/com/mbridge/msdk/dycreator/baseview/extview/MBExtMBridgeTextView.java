...
public class MBExtMBridgeTextView extends MBridgeTextView implements InterBase {
    ...
    private Map<String, String> f35117b;

    /* JADX INFO: renamed from: c */
    private Map<String, Boolean> f35118c;

    /* JADX INFO: renamed from: d */
    private String f35119d;

    /* JADX INFO: renamed from: com.mbridge.msdk.dycreator.baseview.extview.MBExtMBridgeTextView$1 */
    static /* synthetic */ class C129411 {
        ...
        static {
            ...
            try {
                f35120a[EnumC12973c.text.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f35120a[EnumC12973c.ellipsize.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f35120a[EnumC12973c.singleLine.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f35120a[EnumC12973c.lines.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f35120a[EnumC12973c.drawableLeft.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f35120a[EnumC12973c.drawablePadding.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f35120a[EnumC12973c.fadingEdge.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f35120a[EnumC12973c.scrollHorizontally.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f35120a[EnumC12973c.textColor.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f35120a[EnumC12973c.textSize.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f35120a[EnumC12973c.visibility.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f35120a[EnumC12973c.background.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f35120a[EnumC12973c.textStyle.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f35120a[EnumC12973c.style.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f35120a[EnumC12973c.contentDescription.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f35120a[EnumC12973c.tag.ordinal()] = 17;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f35120a[EnumC12973c.gravity.ordinal()] = 18;
            } catch (NoSuchFieldError unused18) {
            }
            try {
                f35120a[EnumC12973c.padding.ordinal()] = 19;
            } catch (NoSuchFieldError unused19) {
            }
            try {
                f35120a[EnumC12973c.paddingTop.ordinal()] = 20;
            } catch (NoSuchFieldError unused20) {
            }
            try {
                f35120a[EnumC12973c.paddingBottom.ordinal()] = 21;
            } catch (NoSuchFieldError unused21) {
            }
            try {
                f35120a[EnumC12973c.paddingLeft.ordinal()] = 22;
            } catch (NoSuchFieldError unused22) {
            }
            try {
                f35120a[EnumC12973c.paddingRight.ordinal()] = 23;
            } catch (NoSuchFieldError unused23) {
            }
            try {
                f35120a[EnumC12973c.paddingStart.ordinal()] = 24;
            } catch (NoSuchFieldError unused24) {
            }
            try {
                f35120a[EnumC12973c.paddingEnd.ordinal()] = 25;
            } catch (NoSuchFieldError unused25) {
            }
            try {
                f35120a[EnumC12973c.maxLength.ordinal()] = 26;
            } catch (NoSuchFieldError unused26) {
            }
            try {
                f35120a[EnumC12973c.layout_width.ordinal()] = 27;
            } catch (NoSuchFieldError unused27) {
            }
            try {
                f35120a[EnumC12973c.layout_height.ordinal()] = 28;
    ...
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (enumC12973c != null) {
                int i2 = C129411.f35120a[enumC12973c.ordinal()];
                if (i2 == 27) {
    ...
    public String getActionDes() {
        Map<String, String> map = this.f35117b;
        return (map == null || !map.containsKey("mbridgeAction")) ? "" : this.f35117b.get("mbridgeAction");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getBindDataDes() {
        Map<String, String> map = this.f35117b;
        return (map == null || !map.containsKey("mbridgeData")) ? "" : this.f35117b.get("mbridgeData");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getEffectDes() {
        Map<String, String> map = this.f35117b;
        return (map == null || !map.containsKey("mbridgeEffect")) ? "" : this.f35117b.get("mbridgeEffect");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getReportDes() {
        Map<String, String> map = this.f35117b;
        return (map == null || !map.containsKey("mbridgeReport")) ? "" : this.f35117b.get("mbridgeReport");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getStrategyDes() {
        Map<String, String> map = this.f35117b;
        return (map == null || !map.containsKey("mbridgeStrategy")) ? "" : this.f35117b.get("mbridgeStrategy");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.cusview.MBridgeTextView, android.widget.TextView, android.view.View
    protected void onAttachedToWindow() {
        super.onAttachedToWindow();
        Map<String, Boolean> map = this.f35118c;
        if (map != null && map.containsKey("mbridgeAttached") && this.f35118c.get("mbridgeAttached").booleanValue()) {
            new C13150l.b("mbridgeAttached").m37405a().m37402b(this.f35119d);
        }
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f35118c;
        if (map != null && map.containsKey("mbridgeDetached") && this.f35118c.get("mbridgeDetached").booleanValue()) {
            new C13150l.b("mbridgeDetached").m37405a().m37402b(this.f35119d);
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (enumC12973c != null) {
                ...
                switch (C129411.f35120a[enumC12973c.ordinal()]) {
                    case 1:
                        String attributeValue = attributeSet.getAttributeValue(i);
                    ...
                    case 25:
                        ...
                        break;
                    case 26:
                        setFilters(new InputFilter[]{new InputFilter.LengthFilter(C12972b.m36361a().m36362a(attributeSet.getAttributeValue(i)))});
                        break;
                }
            }
        }
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f35118c = C12980c.m36403a(str);
        if (campaignEx != null) {
            this.f35119d = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public MBExtMBridgeTextView(Context context, AttributeSet attributeSet) {
        ...
        this.f35119d = "";
        try {
            this.f35117b = C12980c.m36402a(context, attributeSet);
            setAttributeSet(attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            C12980c.m36404a(this.f35117b, this);
        } catch (Exception e) {
            C13219q0.m37816b("MBExtMBridgeTextView", e.getMessage());
        }
    }
