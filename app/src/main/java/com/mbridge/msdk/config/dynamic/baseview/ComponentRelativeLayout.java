...
public class ComponentRelativeLayout extends RelativeLayout implements InterfaceC12875a {
    ...
    public /* synthetic */ void m35904a(View view) {
    ...
    protected void onAttachedToWindow() {
        ...
        try {
            ...
            C13219q0.m37816b("MBRelativeLayout", "onAttachedToWindow异常: " + e.getMessage());
        }
    }
    ...
    public void setXmlData(Map<String, Object> map) {
        ...
        try {
            ...
            C13219q0.m37816b("MBRelativeLayout", "setXmlData异常: " + e.getMessage());
        }
    }
