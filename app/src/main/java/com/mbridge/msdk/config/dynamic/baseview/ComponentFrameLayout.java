...
public class ComponentFrameLayout extends FrameLayout implements InterfaceC12875a {
    ...
    public /* synthetic */ void m35896a(View view) {
    ...
    protected void onAttachedToWindow() {
        ...
        try {
            ...
            C13219q0.m37816b("MBFrameLayout", "onAttachedToWindow异常: " + e.getMessage());
        }
    }
    ...
    public void setXmlData(Map<String, Object> map) {
        ...
        try {
            ...
            C13219q0.m37816b("MBFrameLayout", "setXmlData异常: " + e.getMessage());
        }
    }
