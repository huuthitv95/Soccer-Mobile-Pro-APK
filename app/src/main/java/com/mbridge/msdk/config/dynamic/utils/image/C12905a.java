...
/* JADX INFO: renamed from: com.mbridge.msdk.config.dynamic.utils.image.a */
/* JADX INFO: compiled from: FastBlur.java */
/* JADX INFO: loaded from: classes5.dex */
public class C12905a {
    /* JADX INFO: renamed from: a */
    public static Bitmap m36166a(Bitmap bitmap, int i, boolean z) {
        int i2;
        int i3 = i;
        ...
        while (i51 < width) {
            ...
            int i63 = 0;
            while (i52 <= i3) {
                int iMax = Math.max(0, i54) + i53;
                int[] iArr16 = iArr7[i52 + i];
                iArr16[0] = iArr2[iMax];
                iArr16[1] = iArr3[iMax];
                iArr16[2] = iArr15[iMax];
                int iAbs2 = i14 - Math.abs(i52);
                i56 += iArr2[iMax] * iAbs2;
                i55 += iArr3[iMax] * iAbs2;
                i63 += iArr15[iMax] * iAbs2;
                if (i52 > 0) {
                    i60 += iArr16[0];
                    i61 += iArr16[1];
                    i62 += iArr16[2];
    ...
    /* JADX INFO: renamed from: a */
    public static Bitmap m36165a(Bitmap bitmap, int i) {
        if (i <= 0) {
            i = 10;
        }
        return m36166a(Bitmap.createScaledBitmap(bitmap, bitmap.getWidth() / i, bitmap.getHeight() / i, false), 8, true);
    }
}
