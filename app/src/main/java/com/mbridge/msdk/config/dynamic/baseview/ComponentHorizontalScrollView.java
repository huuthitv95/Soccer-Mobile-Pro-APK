...
public class ComponentHorizontalScrollView extends HorizontalScrollView implements InterfaceC12875a {
    ...
    public /* synthetic */ void m35898a(View view) {
    ...
    protected void onAttachedToWindow() {
        ...
        try {
            ...
            C13219q0.m37816b("MBHorizontalScrollView", "onAttachedToWindow异常: " + e.getMessage());
        }
    }
    ...
    public void setXmlData(Map<String, Object> map) {
        ...
        try {
            ...
            C13219q0.m37816b("MBHorizontalScrollView", "setXmlData异常: " + e.getMessage());
        }
    }
