...
public class ComponentScrollView extends ScrollView implements InterfaceC12875a {
    ...
    public /* synthetic */ void m35905a(View view) {
    ...
    protected void onAttachedToWindow() {
        ...
        try {
            ...
            C13219q0.m37816b("MBScrollView", "onAttachedToWindow异常: " + e.getMessage());
        }
    }
    ...
    public void setXmlData(Map<String, Object> map) {
        ...
        try {
            ...
            C13219q0.m37816b("MBScrollView", "setXmlData异常: " + e.getMessage());
        }
    }
