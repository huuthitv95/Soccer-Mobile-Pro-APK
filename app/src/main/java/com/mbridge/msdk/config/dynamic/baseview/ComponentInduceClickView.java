...
public class ComponentInduceClickView extends FrameLayout implements InterfaceC12875a {
    ...
    public /* synthetic */ void m35900a(View view) {
    ...
    protected void onAttachedToWindow() {
        ...
        try {
            ...
            C13219q0.m37816b("MBInduceClickView", "onAttachedToWindow异常: " + e.getMessage());
        }
    }
    ...
    public void setXmlData(Map<String, Object> map) {
        ...
        try {
            ...
            C13219q0.m37816b("MBInduceClickView", "setXmlData异常: " + e.getMessage());
        }
    }
