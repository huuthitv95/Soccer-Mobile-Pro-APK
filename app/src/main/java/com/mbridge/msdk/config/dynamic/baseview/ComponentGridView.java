...
public class ComponentGridView extends GridView implements InterfaceC12875a {
    ...
    public /* synthetic */ void m35897a(View view) {
    ...
    protected void onAttachedToWindow() {
        ...
        try {
            ...
            C13219q0.m37816b("MBGridView", "onAttachedToWindow异常: " + e.getMessage());
        }
    }
    ...
    public void setXmlData(Map<String, Object> map) {
        ...
        try {
            ...
            C13219q0.m37816b("MBGridView", "setXmlData异常: " + e.getMessage());
        }
    }
