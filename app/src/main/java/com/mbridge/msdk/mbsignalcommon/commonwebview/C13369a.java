...
/* JADX INFO: renamed from: com.mbridge.msdk.mbsignalcommon.commonwebview.a */
/* JADX INFO: compiled from: CommonWebChromeClient.java */
/* JADX INFO: loaded from: classes6.dex */
public class C13369a extends WebChromeClient {

    /* JADX INFO: renamed from: a */
    private CopyOnWriteArrayList<WebChromeClient> f37104a = new CopyOnWriteArrayList<>();

    /* JADX INFO: renamed from: a */
    public void m38658a(WebChromeClient webChromeClient) {
        this.f37104a.add(webChromeClient);
    }

    /* JADX INFO: renamed from: b */
    public void m38659b(WebChromeClient webChromeClient) {
        this.f37104a.remove(webChromeClient);
    }
    ...
    public void onCloseWindow(WebView webView) {
        Iterator<WebChromeClient> it = this.f37104a.iterator();
        while (it.hasNext()) {
    ...
    public void onPermissionRequest(PermissionRequest permissionRequest) {
        try {
            ...
            C13219q0.m37816b("CommonWebChromeClient", e.getMessage());
        }
    }
