...
/* JADX INFO: renamed from: com.mbridge.msdk.util.a */
/* JADX INFO: compiled from: AllTypeErrorMsgToCodeUtils.java */
/* JADX INFO: loaded from: classes7.dex */
public class C13883a {
    /* JADX INFO: renamed from: a */
    public static int m41419a(int i, String str) {
        int i2;
        try {
    ...
    public static int m41420b(int i, String str) {
        return i + 900;
    }
}
