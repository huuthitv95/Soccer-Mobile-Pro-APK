...
public class BidNewInterstitialStrategy implements IBidVideoAdStrategy {
    ...
    private void checkAndCreateController() {
        ...
        if (this.isSetListenerController) {
            ...
            if (c13613a2 != null) {
                c13613a2.m39237a(new C13437a(this.listener, this.unitId, true));
            }
    ...
    public void loadFormSelfFilling() {
        checkAndCreateController();
        if (this.controller != null) {
            this.controller.m39241a(false, C13156d.m37475b().m37479a(1, MBSupportMuteAdType.INTERSTITIAL_VIDEO, this.unitId, true, 1));
        }
    }
    ...
    public void loadFromBid(String str) {
        checkAndCreateController();
        if (this.controller != null) {
            this.controller.m39242a(true, str, C13156d.m37475b().m37479a(1, MBSupportMuteAdType.INTERSTITIAL_VIDEO, this.unitId, true, 2));
        }
    }
    ...
    public void setInterstitialVideoListener(NewInterstitialListener newInterstitialListener) {
        ...
        this.controller.m39237a(new C13437a(newInterstitialListener, this.unitId, true));
        this.isSetListenerController = false;
    }
    ...
    public void showFromBid() {
        checkAndCreateController();
        if (this.controller != null) {
            C13157e c13157eM37479a = C13156d.m37475b().m37479a(1, MBSupportMuteAdType.INTERSTITIAL_VIDEO, this.unitId, false, -1);
