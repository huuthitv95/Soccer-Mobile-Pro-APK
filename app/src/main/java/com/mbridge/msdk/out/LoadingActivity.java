...
public class LoadingActivity extends Activity {
    ...
    private InterfaceC13101c cipl = new InterfaceC13101c() { // from class: com.mbridge.msdk.out.LoadingActivity.2
    ...
    private View initView() {
        if (this.rlayout_main == null) {
            ...
            int iM37876a = C13229v0.m37876a(this, 15.0f);
            this.rlayout.setPadding(iM37876a, iM37876a, iM37876a, iM37876a);
            this.rlayout.setBackgroundResource(getResources().getIdentifier("mbridge_native_bg_loading_camera", "drawable", getPackageName()));
            this.rlayout.addView(new TextView(this), new RelativeLayout.LayoutParams(C13229v0.m37876a(this, 140.0f), C13229v0.m37876a(this, 31.5f)));
            MBImageView mBImageView = new MBImageView(this);
            this.img_icon = mBImageView;
            mBImageView.setId(C13229v0.m37900b());
            this.img_icon.setTag(this.icon_url);
            if (!TextUtils.isEmpty(this.icon_url)) {
                C13100b.m37152a(getApplicationContext()).m37155a(this.icon_url, this.cipl);
            }
            int iM37876a2 = C13229v0.m37876a(this, 64.0f);
