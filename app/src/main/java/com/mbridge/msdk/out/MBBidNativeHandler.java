...
import com.mbridge.msdk.mbnative.demand.AbstractC13337a;
...
public class MBBidNativeHandler extends AbstractC13337a implements BaseExtraInterfaceForHandler {
    ...
    private void loadMB(String str) {
        C13339a c13339a;
        if (TextUtils.isEmpty(str) && (c13339a = this.adListener) != null) {
            c13339a.onAdLoadError("bidToken can not be null, bid first");
            return;
        }
        ...
        if (list != null && list.size() > 0) {
            try {
                ...
                C13219q0.m37820d("com.mbridge.msdk", "MBSDK set template error");
            }
        }
        try {
            ...
            this.nativeProvider.m38580a(str);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
