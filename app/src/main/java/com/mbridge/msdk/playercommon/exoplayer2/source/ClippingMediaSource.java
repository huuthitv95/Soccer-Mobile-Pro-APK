...
public final class ClippingMediaSource extends CompositeMediaSource<Void> {
    ...
    private static final class ClippingTimeline extends ForwardingTimeline {
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            return period.set(period.f37397id, period.uid, 0, j != -9223372036854775807L ? j - positionInWindowUs : -9223372036854775807L, positionInWindowUs);
        }
        ...
        public Timeline.Window getWindow(int i, Timeline.Window window, boolean z, long j) {
            ...
            long jUsToMs = C13474C.usToMs(this.startUs);
    ...
    public long getMediaTimeForChildMediaTime(Void r7, long j) {
        ...
        long j2 = this.endUs;
        return j2 != Long.MIN_VALUE ? Math.min(C13474C.usToMs(j2) - jUsToMs, jMax) : jMax;
    }
