...
final class SampleMetadataQueue {
    ...
    public synchronized int advanceTo(long j, boolean z, boolean z2) throws Throwable {
        try {
            try {
    ...
    public synchronized long discardTo(long j, boolean z, boolean z2) throws Throwable {
        Throwable th;
        try {
            try {
                int i = this.length;
