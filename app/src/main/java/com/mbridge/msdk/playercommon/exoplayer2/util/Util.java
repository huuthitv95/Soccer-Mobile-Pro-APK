...
public final class Util {
    ...
    public static int getDefaultBufferSize(int i) {
        ...
        if (i == 1) {
            return C13474C.DEFAULT_AUDIO_BUFFER_SIZE;
        }
        if (i == 2) {
            return 13107200;
        }
    ...
    public static UUID getDrmUuid(String str) {
        ...
        switch (lowerInvariant) {
            case "playready":
                return C13474C.PLAYREADY_UUID;
            case "widevine":
                return C13474C.WIDEVINE_UUID;
            case "clearkey":
                return C13474C.CLEARKEY_UUID;
            default:
                try {
    ...
    public static Point getPhysicalDisplaySize(Context context, Display display) {
        ...
        if (SDK_INT < 25 && display.getDisplayId() == 0) {
            ...
            } else if ("philips".equals(toLowerInvariant(str2))) {
                String str3 = MODEL;
    ...
    /* JADX WARN: Code duplicated, block: B:25:0x004f A[RETURN] */
