    ...
    private void writeBuffer(ByteBuffer byteBuffer, long j) throws AudioSink.WriteException {
        ...
        if (byteBuffer.hasRemaining()) {
            ...
            if (Util.SDK_INT < 21) {
                ...
                defaultAudioSink = this;
                iWriteNonBlockingV21 = defaultAudioSink.writeNonBlockingWithAvSyncV21(this.audioTrack, byteBuffer, iRemaining2, j);
            } else {
                defaultAudioSink = this;
        ...
        if (this.isInputPcm) {
            ...
            switch (outputChannelCount) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    i12 = C13474C.CHANNEL_OUT_7POINT1_SURROUND;
                    break;
                default:
            ...
            if (i8 <= 23 || !"foster".equals(Util.DEVICE) || !"NVIDIA".equals(Util.MANUFACTURER)) {
                ...
                if (outputChannelCount != 7) {
                    ...
                    i7 = C13474C.CHANNEL_OUT_7POINT1_SURROUND;
                }
            }
        ...
        if (this.inputBuffer != null) {
            ...
            if (this.startMediaTimeState == 0) {
                ...
                if (this.startMediaTimeState == 1 && Math.abs(jInputFramesToDurationUs - j) > 200000) {
                    Log.e(TAG, "Discontinuity detected [expected " + jInputFramesToDurationUs + ", got " + j + C11744X3.j.f26440e);
