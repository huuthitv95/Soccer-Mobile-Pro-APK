...
public final class DeferredMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    public final MediaSource.MediaPeriodId f37413id;
    ...
    public void createPeriod() {
        MediaPeriod mediaPeriodCreatePeriod = this.mediaSource.createPeriod(this.f37413id, this.allocator);
    ...
    public void maybeThrowPrepareError() throws IOException {
        try {
            ...
            prepareErrorListener.onPrepareError(this.f37413id, e);
        }
    }
