...
public final class WebvttCue extends Cue {
    ...
    /* JADX INFO: renamed from: com.mbridge.msdk.playercommon.exoplayer2.text.webvtt.WebvttCue$1 */
    static /* synthetic */ class C135801 {
    ...
    public static class Builder {
        ...
        private Builder derivePositionAnchorFromAlignment() {
            ...
            int i = C135801.$SwitchMap$android$text$Layout$Alignment[alignment.ordinal()];
            if (i == 1) {
