...
public class EventLogger implements AnalyticsListener {
    ...
    private String getEventString(AnalyticsListener.EventTime eventTime, String str) {
        return str + " [" + getEventTimeString(eventTime) + C11744X3.j.f26440e;
    }

    private String getEventString(AnalyticsListener.EventTime eventTime, String str, String str2) {
        return str + " [" + getEventTimeString(eventTime) + ", " + str2 + C11744X3.j.f26440e;
    }
    ...
    public void onAudioUnderrun(AnalyticsListener.EventTime eventTime, int i, long j, long j2) {
        loge(eventTime, "audioTrackUnderrun", i + ", " + j + ", " + j2 + C11744X3.j.f26440e, null);
    }
    ...
    public void onTimelineChanged(AnalyticsListener.EventTime eventTime, int i) {
        ...
        for (int i3 = 0; i3 < Math.min(windowCount, 3); i3++) {
            ...
            logd("  window [" + getTimeString(this.window.getDurationMs()) + ", " + this.window.isSeekable + ", " + this.window.isDynamic + C11744X3.j.f26440e);
        }
        if (windowCount > 3) {
            logd("  ...");
        }
        ...
        while (true) {
            ...
            if (trackGroups.length > 0) {
                ...
                while (i2 < trackGroups.length) {
                    ...
                    String str2 = str;
                    logd("    Group:" + i2 + ", adaptive_supported=" + getAdaptiveSupportString(trackGroup.length, currentMappedTrackInfo.getAdaptiveSupport(i, i2, false)) + " [");
                    int i3 = 0;
