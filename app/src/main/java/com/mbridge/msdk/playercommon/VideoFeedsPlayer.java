...
public class VideoFeedsPlayer implements Player.EventListener {
    ...
    private Runnable playProgressRunnable = new Runnable() { // from class: com.mbridge.msdk.playercommon.VideoFeedsPlayer.2
        ...
        public void run() {
            ...
            try {
                ...
                C13219q0.m37818c(VideoFeedsPlayer.TAG, "currentPosition:" + iRound + " mCurrentPosition:" + VideoFeedsPlayer.this.mCurrentPosition);
                ...
                C13219q0.m37816b(VideoFeedsPlayer.TAG, e.getMessage());
            }
        }
    };
                    ...
                    public void run() {
                        ...
                        if (VideoFeedsPlayer.this.mInnerVFPLisener != null) {
                            try {
                                ...
                                C13219q0.m37816b(VideoFeedsPlayer.TAG, e2.getMessage());
                            }
                        }
                    }
                });
    ...
    private void postOnPlayErrorOnMainThread(final String str) {
        try {
            ...
            C13148j.m37378a(94, this.mPlayUrl, str);
        } catch (Exception e) {
            C13219q0.m37816b(TAG, e.getMessage());
        }
    }
            ...
            public void run() {
                try {
                    if (!VideoFeedsPlayer.this.mHasPrepare || VideoFeedsPlayer.this.mIsBuffering) {
                        C13219q0.m37816b(VideoFeedsPlayer.TAG, "缓冲超时");
    ...
    public boolean initPlayer(Context context, View view, String str, VideoPlayerStatusListener videoPlayerStatusListener) {
        try {
            if (view == null) {
                C13219q0.m37818c(TAG, "loadingView is NULL");
    ...
    public void justSeekTo(int i) {
        try {
            ...
            C13219q0.m37813a(TAG, "seekTo return mHasPrepare false");
        } catch (Exception e) {
            C13219q0.m37816b(TAG, e.getMessage());
        }
    }
    ...
    public boolean onError(int i, String str) {
        try {
            ...
            hideLoading();
            if (!this.mIsFrontDesk && "MIX 3".equalsIgnoreCase(C13211m0.m37762o()) && C13211m0.m37771t().equalsIgnoreCase("Xiaomi")) {
                return true;
            }
            ...
            if (z) {
                ...
                if (simpleExoPlayer != null) {
                    ...
                    if (!this.isStart) {
                        ...
                        C13219q0.m37818c(TAG, "onPlayStarted()，getCurrentPosition:" + this.exoPlayer.getCurrentPosition());
                        this.isStart = true;
                    }
                }
                postOnBufferinEndOnMainThread();
                startPlayProgressTimer();
                C13219q0.m37818c(TAG, "onPrepare mCurrentPosition:" + this.mCurrentPosition + " onPrepare mHasPrepare：" + this.mHasPrepare);
            }
        } catch (Throwable th) {
            C13219q0.m37816b(TAG, th.getMessage());
        }
    ...
    public void pause() {
        try {
            if (this.mHasPrepare && this.exoPlayer != null && exoPlayerIsPlaying()) {
                C13219q0.m37818c(TAG, "pause isPalying:" + exoPlayerIsPlaying() + " mIsPlaying:" + this.mIsPlaying);
                hideLoading();
    ...
    public void play(String str, int i) {
        try {
            synchronized (this.mLock) {
                C13219q0.m37816b(TAG, "Start Play currentionPosition:" + this.mCurrentPosition);
                if (i > 0) {
                    this.mCurrentPosition = i;
                }
    ...
    public void setDataSource() {
        try {
            C13219q0.m37818c(TAG, "setDataSource");
            if (this.exoPlayer != null) {
    ...
    public void start(int i) {
        try {
            ...
            if (i > 0) {
                ...
                play();
                this.mIsPlaying = true;
                C13219q0.m37818c(TAG, "=========start 指定进度");
            }
        } catch (Exception e) {
            C13219q0.m37816b(TAG, e.getMessage());
        }
    ...
    public void start(boolean z) {
        try {
            if (!this.mHasPrepare) {
                C13219q0.m37818c(TAG, "!mHasPrepare");
                return;
            }
