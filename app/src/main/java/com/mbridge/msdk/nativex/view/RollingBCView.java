...
public class RollingBCView extends ViewPager {
    ...
    public void setData(List<Frame> list, Context context, String str, MBNativeRollView.InterfaceC13425a interfaceC13425a) {
        ...
        if (interfaceC13425a != null) {
            rollingAdapter.setMvinterface(interfaceC13425a);
        }
