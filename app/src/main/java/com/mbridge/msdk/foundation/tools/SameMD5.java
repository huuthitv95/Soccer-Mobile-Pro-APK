...
public class SameMD5 implements NoProGuard {
    ...
    public static byte[] getQftJSMD5Bytes(String str) throws UnsupportedEncodingException {
        ...
        byte[] bytes = str.getBytes(C9415C.UTF16LE_NAME);
        C13219q0.m37818c("----", "b = " + ByteArrayToHexString(bytes));
        ...
        C13219q0.m37818c("----", "source = " + ByteArrayToHexString(bArr));
        return bArr;
    }
