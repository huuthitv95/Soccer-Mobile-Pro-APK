...
/* JADX INFO: renamed from: com.mbridge.msdk.foundation.tools.a0 */
/* JADX INFO: compiled from: FastBlurUtil.java */
/* JADX INFO: loaded from: classes6.dex */
public class C13181a0 {
    /* JADX INFO: renamed from: a */
    public static Bitmap m37595a(Bitmap bitmap, int i, boolean z) {
        int i2;
        int i3 = i;
    ...
    /* JADX INFO: renamed from: a */
    public static Bitmap m37594a(Bitmap bitmap, int i) {
        if (i <= 0) {
            i = 10;
        }
        return m37595a(Bitmap.createScaledBitmap(bitmap, bitmap.getWidth() / i, bitmap.getHeight() / i, false), 8, true);
    }
}
