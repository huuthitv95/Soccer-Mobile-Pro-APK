...
/* JADX INFO: renamed from: com.mbridge.msdk.foundation.db.g */
/* JADX INFO: compiled from: CommonSDKDBHelper.java */
/* JADX INFO: loaded from: classes6.dex */
public class C13017g extends AbstractC13016f {

    /* JADX INFO: renamed from: b */
    private static C13017g f35582b;

    private C13017g(Context context) {
        super(context);
    }

    /* JADX INFO: renamed from: a */
    public static synchronized C13017g m36693a(Context context) {
        if (f35582b == null) {
            f35582b = new C13017g(context.getApplicationContext());
        }
        return f35582b;
    }

    /* JADX INFO: renamed from: c */
    private void m36695c(SQLiteDatabase sQLiteDatabase) {
        try {
            ...
            if (MBridgeConstans.DEBUG) {
                C13219q0.m37816b("CommonSDKDBHelper", e.getLocalizedMessage());
            }
        }
    }

    @Override // com.mbridge.msdk.foundation.p289db.AbstractC13016f
    /* JADX INFO: renamed from: b */
    protected int mo36689b() {
        return 88;
    }

    @Override // com.mbridge.msdk.foundation.p289db.AbstractC13016f
    /* JADX INFO: renamed from: b */
    protected void mo36690b(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        if (C13886d.m41426a(sQLiteDatabase)) {
            m36695c(sQLiteDatabase);
            m36694b(sQLiteDatabase);
        }
    }

    /* JADX INFO: renamed from: b */
    private void m36694b(SQLiteDatabase sQLiteDatabase) {
        try {
    ...
    @Override // com.mbridge.msdk.foundation.p289db.AbstractC13016f
    /* JADX INFO: renamed from: a */
    protected String mo36686a() {
        return "mbridge.msdk.db";
    }

    @Override // com.mbridge.msdk.foundation.p289db.AbstractC13016f
    /* JADX INFO: renamed from: a */
    protected void mo36687a(SQLiteDatabase sQLiteDatabase) {
        if (C13886d.m41426a(sQLiteDatabase)) {
            m36694b(sQLiteDatabase);
        }
    }
    ...
    @Override // com.mbridge.msdk.foundation.p289db.AbstractC13016f
    /* JADX INFO: renamed from: a */
    protected void mo36688a(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        if (C13886d.m41426a(sQLiteDatabase)) {
            m36695c(sQLiteDatabase);
            m36694b(sQLiteDatabase);
        }
