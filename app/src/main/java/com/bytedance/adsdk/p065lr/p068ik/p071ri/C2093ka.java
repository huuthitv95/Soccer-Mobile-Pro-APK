...
/* JADX INFO: renamed from: com.bytedance.adsdk.lr.ik.ri.ka */
/* JADX INFO: loaded from: classes3.dex */
public class C2093ka extends bgr<Integer, Integer> {
    public C2093ka(List<C2167ri<Integer>> list) {
        super(list);
    }
    ...
    public AbstractC2139ri<Integer, Integer> mo6903ri() {
        return new C2132di(this.f5035ri);
    }
