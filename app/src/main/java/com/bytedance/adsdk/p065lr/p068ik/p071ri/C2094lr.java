...
/* JADX INFO: renamed from: com.bytedance.adsdk.lr.ik.ri.lr */
/* JADX INFO: loaded from: classes3.dex */
public class C2094lr extends bgr<Float, Float> {
    public C2094lr(List<C2167ri<Float>> list) {
        super(list);
    }
    ...
    public AbstractC2139ri<Float, Float> mo6903ri() {
        return new C2135ka(this.f5035ri);
    }
