...
public class xha {
    ...
    private static Object m7265ri(double d, Number number) {
    ...
    /* JADX INFO: renamed from: ri */
    private static Object m7266ri(float f, Number number) {
        if ((number instanceof Integer) || (number instanceof Short) || (number instanceof Byte)) {
    ...
    /* JADX INFO: renamed from: ri */
    private static Object m7267ri(int i, Number number) {
        if ((number instanceof Integer) || (number instanceof Short) || (number instanceof Byte)) {
    ...
    /* JADX INFO: renamed from: ri */
    private static Object m7268ri(long j, Number number) {
        if ((number instanceof Integer) || (number instanceof Short) || (number instanceof Byte)) {
    ...
    /* JADX INFO: renamed from: ri */
    public static Object m7269ri(Number number, Number number2) {
        if ((number instanceof Integer) || (number instanceof Short) || (number instanceof Byte)) {
            return m7267ri(number.intValue(), number2);
        }
        if (number instanceof Long) {
            return m7268ri(number.longValue(), number2);
        }
        if (number instanceof Float) {
            return m7266ri(number.floatValue(), number2);
        }
        if (number instanceof Double) {
            return m7265ri(number.doubleValue(), number2);
        }
        throw new UnsupportedOperationException(number.getClass().getName() + "This type of addition operation is not supported");
    }
}
