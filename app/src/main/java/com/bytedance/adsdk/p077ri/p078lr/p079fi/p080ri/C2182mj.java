...
/* JADX INFO: renamed from: com.bytedance.adsdk.ri.lr.fi.ri.mj */
/* JADX INFO: loaded from: classes3.dex */
public class C2182mj {
    /* JADX INFO: renamed from: ri */
    private static Object m7255ri(double d, Number number) {
    ...
    /* JADX INFO: renamed from: ri */
    private static Object m7256ri(float f, Number number) {
        if ((number instanceof Integer) || (number instanceof Short) || (number instanceof Byte)) {
    ...
    /* JADX INFO: renamed from: ri */
    private static Object m7257ri(int i, Number number) {
        if ((number instanceof Integer) || (number instanceof Short) || (number instanceof Byte)) {
    ...
    /* JADX INFO: renamed from: ri */
    private static Object m7258ri(long j, Number number) {
        if ((number instanceof Integer) || (number instanceof Short) || (number instanceof Byte)) {
    ...
    /* JADX INFO: renamed from: ri */
    public static Object m7259ri(Number number, Number number2) {
        if ((number instanceof Integer) || (number instanceof Short) || (number instanceof Byte)) {
            return m7257ri(number.intValue(), number2);
        }
        if (number instanceof Long) {
            return m7258ri(number.longValue(), number2);
        }
        if (number instanceof Float) {
            return m7256ri(number.floatValue(), number2);
        }
        if (number instanceof Double) {
            return m7255ri(number.doubleValue(), number2);
        }
        throw new UnsupportedOperationException(number.getClass().getName() + "This type of addition operation is not supported");
    }
}
