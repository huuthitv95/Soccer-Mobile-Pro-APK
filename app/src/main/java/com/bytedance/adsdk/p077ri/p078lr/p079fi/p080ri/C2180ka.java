...
/* JADX INFO: renamed from: com.bytedance.adsdk.ri.lr.fi.ri.ka */
/* JADX INFO: loaded from: classes3.dex */
public class C2180ka {
    /* JADX INFO: renamed from: ri */
    private static Object m7245ri(double d, Number number) {
    ...
    /* JADX INFO: renamed from: ri */
    private static Object m7246ri(float f, Number number) {
        if ((number instanceof Integer) || (number instanceof Short) || (number instanceof Byte)) {
    ...
    /* JADX INFO: renamed from: ri */
    private static Object m7247ri(int i, Number number) {
        if ((number instanceof Integer) || (number instanceof Short) || (number instanceof Byte)) {
    ...
    /* JADX INFO: renamed from: ri */
    private static Object m7248ri(long j, Number number) {
        if ((number instanceof Integer) || (number instanceof Short) || (number instanceof Byte)) {
    ...
    /* JADX INFO: renamed from: ri */
    public static Object m7249ri(Object obj, Number number) {
        if ((obj instanceof Integer) || (obj instanceof Short) || (obj instanceof Byte)) {
            return m7247ri(((Number) obj).intValue(), number);
        }
        if (obj instanceof Long) {
            return m7248ri(((Long) obj).longValue(), number);
        }
        if (obj instanceof Float) {
            return m7246ri(((Float) obj).floatValue(), number);
        }
        if (obj instanceof Double) {
            return m7245ri(((Double) obj).doubleValue(), number);
        }
        if (!(obj instanceof String)) {
            throw new UnsupportedOperationException(obj.getClass().getName() + "This type of addition operation is not supported");
        }
        try {
            return m7246ri(Float.parseFloat((String) obj), number);
