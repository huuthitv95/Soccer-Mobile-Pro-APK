...
public abstract class PAGRewardedAd implements PAGClientBidding, PangleAd {
    ...
    public static void loadAd(String str, PAGRewardedRequest pAGRewardedRequest, PAGRewardedAdLoadListener pAGRewardedAdLoadListener) {
        ISDKTypeFactory iSDKTypeFactoryM11289ri = C2933di.m11289ri(pAGRewardedAdLoadListener);
        if (iSDKTypeFactoryM11289ri != null) {
            iSDKTypeFactoryM11289ri.createADTypeLoaderFactory(str).createRewardAdLoader().loadAd(str, pAGRewardedRequest, pAGRewardedAdLoadListener);
        }
    }
