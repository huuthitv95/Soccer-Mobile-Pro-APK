...
/* JADX INFO: renamed from: com.bytedance.sdk.openadsdk.core.jbs.mj */
/* JADX INFO: loaded from: classes3.dex */
public class C3235mj extends C3221ri {
    public C3235mj(Context context, com.bytedance.sdk.openadsdk.core.model.wjv wjvVar, String str, int i) {
    ...
    protected C3277co mo13525ri(float f, float f2, float f3, float f4, SparseArray<AbstractViewOnClickListenerC3218ik.ri> sparseArray, long j, long j2, View view, String str, float f5, int i, float f6, int i2, JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        this.tan = 0;
        return new C3277co.ri().m14046di(f).m14048fi(f2).m14052ka(fM16589lr).m14050ik(fM16589lr2).m14056lr(j3).m14061ri(j4).m14065ri(iArrM16626ri).m14058lr(C3583qd.m16585ik(view)).m14053ka(this.f10684su).m14049fi(this.igq).m14047di(this.f10686zf).m14055lr(C3304qt.m14669lr().m14700ri() ? 1 : 2).m14062ri(sparseArray).m14063ri(str).m14059ri(f5).m14051ik(i).m14054lr(f6).m14060ri(i2).m14064ri(jSONObject).m14057lr(jSONObject2).m14066ri();
    }

    /* JADX INFO: renamed from: ri */
    public void m13684ri(com.bytedance.sdk.openadsdk.core.model.slm slmVar) {
