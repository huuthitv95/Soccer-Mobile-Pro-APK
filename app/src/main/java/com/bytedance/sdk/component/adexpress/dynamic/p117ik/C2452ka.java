...
/* JADX INFO: renamed from: com.bytedance.sdk.component.adexpress.dynamic.ik.ka */
/* JADX INFO: loaded from: classes3.dex */
public class C2452ka extends C2444bu<xha> {
    public C2452ka(Context context, AbstractC2412fi abstractC2412fi, com.bytedance.sdk.component.adexpress.dynamic.p119ka.xha xhaVar) {
        super(context, abstractC2412fi, xhaVar);
        m8446ri(xhaVar);
    }

    /* JADX INFO: renamed from: ri */
    private void m8446ri(com.bytedance.sdk.component.adexpress.dynamic.p119ka.xha xhaVar) {
        this.f6595ri = new xha(this.f6594lr);
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-1, -2);
        layoutParams.gravity = 81;
        layoutParams.bottomMargin = (int) com.bytedance.sdk.component.adexpress.p124ka.xha.m8833ri(this.f6594lr, xhaVar.m8700fe());
        this.f6595ri.setLayoutParams(layoutParams);
        this.f6595ri.setSlideText(this.f6593ka.whw());
        if (this.f6595ri instanceof xha) {
            ((xha) this.f6595ri).setButtonText(this.f6593ka.m8717qt());
        }
    }
