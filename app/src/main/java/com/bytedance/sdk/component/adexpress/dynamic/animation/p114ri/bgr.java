...
public class bgr extends AbstractC2393ka {
    public bgr(View view, C2477ri c2477ri) {
        super(view, c2477ri);
    }
    ...
    List<ObjectAnimator> mo8287ri() {
        ObjectAnimator duration = ObjectAnimator.ofFloat(this.f6411ik, Key.ROTATION, 0.0f, this.f6413lr.m8663fi(), 0.0f, this.f6413lr.m8663fi(), 0.0f).setDuration((int) (this.f6413lr.m8682qt() * 1000.0d));
