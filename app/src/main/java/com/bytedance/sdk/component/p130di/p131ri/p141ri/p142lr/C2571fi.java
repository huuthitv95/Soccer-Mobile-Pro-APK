...
/* JADX INFO: renamed from: com.bytedance.sdk.component.di.ri.ri.lr.fi */
/* JADX INFO: loaded from: classes3.dex */
public class C2571fi extends AbstractC2573ka<InterfaceC2552ri> {
    public C2571fi(C2551ri c2551ri, Queue<String> queue) {
        super(c2551ri, queue, "HighAd");
    }
}
