...
public final class Demographic$$serializer implements GeneratedSerializer<Demographic> {
    ...
    static {
        ...
        pluginGeneratedSerialDescriptor.addElement(InneractiveMediationDefs.KEY_GENDER, true);
    ...
    public Demographic deserialize(Decoder decoder) {
        ...
        return new Demographic(i, (Integer) objDecodeNullableSerializableElement, (Integer) objDecodeNullableSerializableElement2, null);
    }
