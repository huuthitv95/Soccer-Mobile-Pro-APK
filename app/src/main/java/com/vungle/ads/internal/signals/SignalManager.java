...
public final class SignalManager {
    ...
    public SignalManager(final Context context) {
        ...
        UnclosedAdDetector unclosedAdDetector = new UnclosedAdDetector(context, this.currentSession.getSessionId(), m44820_init_$lambda0(lazy), m44821_init_$lambda1(LazyKt.lazy(LazyThreadSafetyMode.SYNCHRONIZED, (Function0) new Function0<PathProvider>() { // from class: com.vungle.ads.internal.signals.SignalManager$special$$inlined$inject$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        Logger.INSTANCE.m43472w(TAG, new Function0<String>() { // from class: com.vungle.ads.internal.signals.SignalManager.1
            {
                super(0);
            }
            ...
            public final String invoke() {
                ...
                KSerializer<Object> kSerializerSerializer = SerializersKt.serializer(json.getSerializersModule(), Reflection.typeOf(List.class, KTypeProjection.INSTANCE.invariant(Reflection.typeOf(UnclosedAd.class))));
                Intrinsics.checkNotNull(kSerializerSerializer, "null cannot be cast to non-null type kotlinx.serialization.KSerializer<T of kotlinx.serialization.internal.Platform_commonKt.cast>");
                sb.append(json.encodeToString(kSerializerSerializer, unclosedAd));
                return sb.toString();
            }
        });
        try {
            ...
            Logger.INSTANCE.m43468e(TAG, "Failed to collect device signals: " + e.getLocalizedMessage());
        }
    }

    /* JADX INFO: renamed from: _init_$lambda-0, reason: not valid java name */
    private static final Executors m44820_init_$lambda0(Lazy<? extends Executors> lazy) {
        return lazy.getValue();
    }

    /* JADX INFO: renamed from: _init_$lambda-1, reason: not valid java name */
    private static final PathProvider m44821_init_$lambda1(Lazy<PathProvider> lazy) {
        return lazy.getValue();
    }
    ...
    private final void registerNotifications() {
        ActivityManager.INSTANCE.addLifecycleListener(new ActivityManager.LifeCycleCallback() { // from class: com.vungle.ads.internal.signals.SignalManager.registerNotifications.1
            ...
            public void onBackground() {
                Logger.INSTANCE.m43467d(SignalManager.TAG, "SignalManager#onBackground()");
            ...
            public void onForeground() {
                Logger.INSTANCE.m43467d(SignalManager.TAG, "SignalManager#onForeground()");
