...
public final class CommonRequestBody$$serializer implements GeneratedSerializer<CommonRequestBody> {
    ...
    static {
        ...
        pluginGeneratedSerialDescriptor.addElement(C11744X3.i.f26328G, false);
