...
public final class AdPayload$CSBResponse$$serializer implements GeneratedSerializer<AdPayload.CSBResponse> {
    ...
    public AdPayload.CSBResponse deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            objDecodeNullableSerializableElement = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 0, DoubleSerializer.INSTANCE, null);
            ...
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    objDecodeNullableSerializableElement4 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 0, DoubleSerializer.INSTANCE, objDecodeNullableSerializableElement4);
                    i2 |= 1;
        ...
        return new AdPayload.CSBResponse(i, (Double) objDecodeNullableSerializableElement, (List) objDecodeNullableSerializableElement2, (List) objDecodeNullableSerializableElement3, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, AdPayload.CSBResponse value) {
        ...
        AdPayload.CSBResponse.write$Self(value, compositeEncoderBeginStructure, descriptor2);
