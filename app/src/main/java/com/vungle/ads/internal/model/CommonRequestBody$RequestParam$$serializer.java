...
public final class CommonRequestBody$RequestParam$$serializer implements GeneratedSerializer<CommonRequestBody.RequestParam> {
    ...
    public CommonRequestBody.RequestParam deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            objDecodeNullableSerializableElement3 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 1, CommonRequestBody$AdSizeParam$$serializer.INSTANCE, null);
            ...
            objDecodeNullableSerializableElement6 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 4, StringSerializer.INSTANCE, null);
            ...
            objDecodeNullableSerializableElement2 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 6, CommonRequestBody$CSBParam$$serializer.INSTANCE, null);
            i = 127;
        } else {
            boolean z = true;
            int i3 = 0;
            ...
            while (z) {
                ...
                switch (iDecodeElementIndex) {
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        objDecodeNullableSerializableElement10 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 1, CommonRequestBody$AdSizeParam$$serializer.INSTANCE, objDecodeNullableSerializableElement10);
                        i3 |= 2;
                        i2 = 6;
                        break;
                    case 2:
                        objDecodeNullableSerializableElement11 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 2, LongSerializer.INSTANCE, objDecodeNullableSerializableElement11);
                        i3 |= 4;
                        break;
                    case 3:
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        objDecodeNullableSerializableElement9 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, i2, CommonRequestBody$CSBParam$$serializer.INSTANCE, objDecodeNullableSerializableElement9);
                        i3 |= 64;
                        break;
                    default:
        ...
        return new CommonRequestBody.RequestParam(i, (List) objDecodeNullableSerializableElement, (CommonRequestBody.AdSizeParam) objDecodeNullableSerializableElement3, (Long) objDecodeNullableSerializableElement4, (String) objDecodeNullableSerializableElement5, (String) objDecodeNullableSerializableElement6, (String) objDecodeNullableSerializableElement7, (CommonRequestBody.CSBParam) objDecodeNullableSerializableElement2, (SerializationConstructorMarker) null);
    }
