...
public final class AdPayload$PlacementAdUnit$$serializer implements GeneratedSerializer<AdPayload.PlacementAdUnit> {
    ...
    public AdPayload.PlacementAdUnit deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            objDecodeNullableSerializableElement3 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 2, AdPayload$CSBResponse$$serializer.INSTANCE, null);
            i = 7;
        } else {
            boolean z = true;
            int i2 = 0;
            ...
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    objDecodeNullableSerializableElement5 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 1, AdPayload$AdUnit$$serializer.INSTANCE, objDecodeNullableSerializableElement5);
                    i2 |= 2;
                } else {
                    if (iDecodeElementIndex != 2) {
                        throw new UnknownFieldException(iDecodeElementIndex);
                    }
                    objDecodeNullableSerializableElement6 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 2, AdPayload$CSBResponse$$serializer.INSTANCE, objDecodeNullableSerializableElement6);
                    i2 |= 4;
                }
            }
        ...
        return new AdPayload.PlacementAdUnit(i, (String) objDecodeNullableSerializableElement, (AdPayload.AdUnit) objDecodeNullableSerializableElement2, (AdPayload.CSBResponse) objDecodeNullableSerializableElement3, (SerializationConstructorMarker) null);
    }
