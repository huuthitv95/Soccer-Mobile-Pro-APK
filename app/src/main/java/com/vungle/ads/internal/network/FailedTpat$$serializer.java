...
public final class FailedTpat$$serializer implements GeneratedSerializer<FailedTpat> {
    ...
    public FailedTpat deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            objDecodeNullableSerializableElement = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 1, new LinkedHashMapSerializer(StringSerializer.INSTANCE, StringSerializer.INSTANCE), null);
        ...
        return new FailedTpat(i, (HttpMethod) objDecodeSerializableElement, (Map) objDecodeNullableSerializableElement, (String) objDecodeNullableSerializableElement2, i3, i2, (String) objDecodeNullableSerializableElement3, (SerializationConstructorMarker) null);
    }
