...
public final class AdPayload$CacheableReplacement$$serializer implements GeneratedSerializer<AdPayload.CacheableReplacement> {
    ...
    public AdPayload.CacheableReplacement deserialize(Decoder decoder) {
        ...
        return new AdPayload.CacheableReplacement(i, (String) objDecodeNullableSerializableElement, (String) objDecodeNullableSerializableElement2, (Integer) objDecodeNullableSerializableElement3, (SerializationConstructorMarker) null);
    }
