...
class DeviceInfo {
    ...
    private String getFacebookAttributionId(Context context) {
        ...
        try {
            ...
            if (apkContentsSigners == null || apkContentsSigners.length != 1 || !OFFICIAL_FACEBOOK_SIGNATURE.equals(apkContentsSigners[0].toCharsString()) || (cursorQuery = context.getContentResolver().query(Uri.parse("content://com.facebook.katana.provider.AttributionIdProvider"), new String[]{C12460ra.f31825b}, null, null, null)) == null) {
                return null;
            }
            ...
            String string = cursorQuery.getString(cursorQuery.getColumnIndex(C12460ra.f31825b));
            cursorQuery.close();
            return string;
        } catch (Exception unused) {
        }
