...
public class PackageBuilder {
    ...
    public static class ActivityStateCopy {
        ...
        public ActivityStateCopy(ActivityState activityState) {
            ...
            this.f297a = activityState.eventCount;
            this.f298b = activityState.sessionCount;
            this.f299c = activityState.subsessionCount;
            this.f300d = activityState.timeSpent;
            this.f301e = activityState.sessionLength;
            this.f302f = activityState.uuid;
            this.f303g = activityState.pushToken;
        }
    }
    ...
    private Map<String, String> getAdRevenueParameters(AdjustAdRevenue adjustAdRevenue) {
        ...
        addString(map, "android_uuid", this.activityStateCopy.f302f);
        ...
        addString(map, "push_token", this.activityStateCopy.f303g);
        ...
        addLong(map, "session_count", this.activityStateCopy.f298b);
        addDuration(map, "session_length", this.activityStateCopy.f301e);
        addLong(map, "subsession_count", this.activityStateCopy.f299c);
        addDuration(map, "time_spent", this.activityStateCopy.f300d);
    ...
    private Map<String, String> getMeasurementConsentParameters(boolean z) {
        ...
        addString(map, "measurement", z ? C12364a.f31324j : "disable");
        this.deviceInfo.reloadPlayIds(this.adjustConfig);
        addString(map, "android_uuid", this.activityStateCopy.f302f);
        addString(map, "gps_adid", this.deviceInfo.playAdId);
        addLong(map, "gps_adid_attempt", this.deviceInfo.playAdIdAttempt);
    ...
    private Map<String, String> getThirdPartySharingParameters(AdjustThirdPartySharing adjustThirdPartySharing) {
        ...
        if (bool != null) {
            addString(map, "sharing", bool.booleanValue() ? C12364a.f31324j : "disable");
        }
    ...
    private void injectFeatureFlagsWithParameters(Map<String, String> map) {
        ...
        int i = this.firstSessionDelayManager.f287c;
        if (i == 2 || i == 0) {
            return;
        }
    ...
    public ActivityPackage buildAttributionPackage(String str) {
        ...
        defaultActivityPackage.setPath(C11761Y3.f26572c);
        defaultActivityPackage.setSuffix("");
    ...
    public Map<String, String> getEventParameters(AdjustEvent adjustEvent) {
        ...
        addLong(map, "event_count", this.activityStateCopy.f297a);
        ...
        addString(map, TTContentsEventConstants.Params.EVENT_PROPERTY_ORDER_ID, adjustEvent.orderId);
