...
class BillingClientImpl extends BillingClient {
    ...
    /* JADX WARN: Code duplicated, block: B:158:0x03f9  */
    /* JADX WARN: Code duplicated, block: B:159:0x0401  */
    /* JADX WARN: Code duplicated, block: B:161:0x040f  */
    /* JADX WARN: Code duplicated, block: B:174:0x0440  */
    /* JADX WARN: Code duplicated, block: B:176:0x0444 A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:178:0x0449  */
    /* JADX WARN: Code duplicated, block: B:180:0x044d  */
    ...
    public final BillingResult launchBillingFlow(Activity activity, final BillingFlowParams billingFlowParams) {
        ...
        String str11 = "proxyPackageVersion";
        ...
        SkuDetails skuDetails = (SkuDetails) com.google.android.gms.internal.play_billing.zzan.zza(arrayListZzf, null);
        BillingFlowParams.ProductDetailsParams productDetailsParams = (BillingFlowParams.ProductDetailsParams) com.google.android.gms.internal.play_billing.zzan.zza(listZzg, null);
        if (skuDetails != null) {
        ...
        if (billingClientImpl.zzl) {
            ...
            String str13 = billingClientImpl.zzb;
            final Bundle bundle = new Bundle();
            ...
            if (arrayListZzf.isEmpty()) {
                ...
                for (int i4 = 0; i4 < listZzg.size(); i4++) {
                    BillingFlowParams.ProductDetailsParams productDetailsParams2 = (BillingFlowParams.ProductDetailsParams) listZzg.get(i4);
                ...
                boolean z8 = false;
                boolean z9 = false;
                for (SkuDetails skuDetails2 : arrayListZzf) {
            ...
            if (skuDetails == null || TextUtils.isEmpty(skuDetails.zzd())) {
                ...
                if (intent == null) {
                    ...
                    if (!TextUtils.isEmpty(intent.getStringExtra("PROXY_PACKAGE"))) {
                        ...
                        try {
                            str9 = str4;
                            try {
                                bundle.putString(str9, billingClientImpl.zze.getPackageManager().getPackageInfo(stringExtra, 0).versionName);
                ...
                if (!billingClientImpl.zzt && !listZzg.isEmpty()) {
                    ...
                    futureZzao = billingClientImpl.zzao(new Callable() { // from class: com.android.billingclient.api.zzas
                        @Override // java.util.concurrent.Callable
                        public final Object call() {
                            return this.zza.zzc(i3, str15, str16, billingFlowParams, bundle);
                        }
                ...
                futureZzao = billingClientImpl.zzao(new Callable() { // from class: com.android.billingclient.api.zzas
                    @Override // java.util.concurrent.Callable
                    public final Object call() {
                        return this.zza.zzc(i3, str17, str18, billingFlowParams, bundle);
                    }
                }, 5000L, null, billingClientImpl.zzc);
                i = 78;
            } else {
            ...
            if (intent == null) {
                ...
                if (!TextUtils.isEmpty(intent.getStringExtra("PROXY_PACKAGE"))) {
                    ...
                    str9 = str4;
                    bundle.putString(str9, billingClientImpl.zze.getPackageManager().getPackageInfo(stringExtra2, 0).versionName);
                }
            }
            ...
            futureZzao = billingClientImpl.zzao(new Callable() { // from class: com.android.billingclient.api.zzas
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    return this.zza.zzc(i3, str19, str110, billingFlowParams, bundle);
                }
            }, 5000L, null, billingClientImpl.zzc);
            i = 78;
        } else {
            str = "BUY_INTENT";
            final String str20 = productId;
            final String str21 = productType;
            str2 = "BillingClient";
            futureZzao = billingClientImpl.zzao(new Callable() { // from class: com.android.billingclient.api.zzr
                @Override // java.util.concurrent.Callable
                public final Object call() {
                    return this.zza.zzd(str20, str21);
                }
            }, 5000L, null, billingClientImpl.zzc);
            i = 80;
        }
