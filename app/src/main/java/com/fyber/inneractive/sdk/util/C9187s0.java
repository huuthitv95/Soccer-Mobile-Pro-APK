...
public final class C9187s0 {
    ...
    */
    public final void m22014a(java.io.StringWriter r11, java.lang.String r12, int r13) throws java.io.IOException {
        /*
            r10 = this;
            r0 = 0
        ...
        L65:
            ...
            goto L75
        L6b:
            com.fyber.inneractive.sdk.util.r0 r2 = r10.f21484a
            java.util.HashMap r2 = r2.f21479a
        ...
        L95:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fyber.inneractive.sdk.util.C9187s0.m22014a(java.io.StringWriter, java.lang.String, int):void");
    }

    /* JADX INFO: renamed from: a */
    public final void m22015a(String[][] strArr) {
        char c = 0;
        int i = 0;
        while (i < strArr.length) {
            ...
            C9184r0 c9184r0 = this.f21484a;
            c9184r0.f21479a.put(str, Integer.valueOf(i2));
            C9193u0 c9193u0 = c9184r0.f21480b;
            C9190t0[] c9190t0Arr = c9193u0.f21494a;
            int i3 = i2 & Integer.MAX_VALUE;
            int length = i3 % c9190t0Arr.length;
            C9190t0 c9190t0 = c9190t0Arr[length];
            while (true) {
                if (c9190t0 == null) {
                    if (c9193u0.f21495b >= c9193u0.f21496c) {
                        C9190t0[] c9190t0Arr2 = c9193u0.f21494a;
                        int length2 = c9190t0Arr2.length;
                        int i4 = (length2 * 2) + 1;
                        C9190t0[] c9190t0Arr3 = new C9190t0[i4];
                        c9193u0.f21496c = (int) (i4 * 0.75f);
                        c9193u0.f21494a = c9190t0Arr3;
                        while (true) {
                            int i5 = length2 - 1;
                            if (length2 <= 0) {
                                break;
                            }
                            C9190t0 c9190t1 = c9190t0Arr2[i5];
                            while (c9190t1 != null) {
                                C9190t0 c9190t2 = c9190t1.f21492c;
                                int i6 = (c9190t1.f21490a & Integer.MAX_VALUE) % i4;
                                c9190t1.f21492c = c9190t0Arr3[i6];
                                c9190t0Arr3[i6] = c9190t1;
                                c9190t1 = c9190t2;
                                z = z;
                            }
                            length2 = i5;
                        }
                        c9190t0Arr = c9193u0.f21494a;
                        length = i3 % c9190t0Arr.length;
                    }
                    c9190t0Arr[length] = new C9190t0(i2, str, c9190t0Arr[length]);
                    c9193u0.f21495b++;
                    break;
                }
                if (c9190t0.f21490a == i2) {
                    c9190t0.f21491b = str;
                    break;
                }
                c9190t0 = c9190t0.f21492c;
            }
            i++;
            c = 0;
        }
