...
public final class JavaType {
    ...
    static {
        ...
        DOUBLE = new JavaType("DOUBLE", 4, Double.TYPE, Double.class, Double.valueOf(FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE));
        ...
        BYTE_STRING = new JavaType("BYTE_STRING", 7, AbstractC9011s.class, AbstractC9011s.class, AbstractC9011s.f21106b);
