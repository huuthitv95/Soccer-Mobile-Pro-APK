...
/* JADX INFO: renamed from: com.fyber.inneractive.sdk.flow.endcard.loaders.fmp.b */
/* JADX INFO: loaded from: classes4.dex */
public final class C8104b implements InterfaceC8374f0 {

    /* JADX INFO: renamed from: a */
    public final C8110p f18030a;

    /* JADX INFO: renamed from: b */
    public final C8109o f18031b;

    /* JADX INFO: renamed from: c */
    public final InterfaceC8106a f18032c;

    /* JADX INFO: renamed from: d */
    public final String f18033d;

    public C8104b(C8109o c8109o, InterfaceC8106a interfaceC8106a, String str) {
        this.f18031b = c8109o;
        this.f18030a = (C8110p) c8109o.m20510f();
        this.f18032c = interfaceC8106a;
        this.f18033d = str;
    }
    ...
    public final void mo20331a(Object obj, Exception exc, boolean z) {
        ...
        if (str != null && exc == null) {
            IAlog.m21947c("%s loaded FMP End-Card icon %s", "IconCallback", this.f18033d);
            C8110p c8110p = this.f18030a;
            c8110p.f18043k = str;
            c8110p.m20535b(this.f18032c);
            return;
        }
        if (TextUtils.isEmpty(this.f18030a.f18043k)) {
            C8109o c8109o = this.f18031b;
            IAlog.m21945a("%s sending FMP_COMPANION_FAILED_LOADING event", "IconCallback");
