...
public final class Challenge {
    ...
    public final Map<String, String> m43843deprecated_authParams() {
        return this.authParams;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = C11341A5.f23801N, imports = {}))
    /* JADX INFO: renamed from: -deprecated_charset, reason: not valid java name */
    public final Charset m43844deprecated_charset() {
        return charset();
    }
    ...
    public final String m43845deprecated_realm() {
        return realm();
    }
    ...
    public final Charset charset() {
        String str = this.authParams.get(C11341A5.f23801N);
        if (str != null) {
            try {
    ...
    public final Challenge withCharset(Charset charset) {
        ...
        mutableMap.put(C11341A5.f23801N, strName);
