...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m43848deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m43850deprecated_tlsVersions() {
        return tlsVersions();
    }
