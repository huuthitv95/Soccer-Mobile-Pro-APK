...
public final class Response implements Closeable, AutoCloseable {
    ...
    public final CacheControl m43939deprecated_cacheControl() {
        return cacheControl();
    }
