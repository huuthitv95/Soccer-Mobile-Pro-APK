...
public final class ByteString {
    ...
    public static final int codePointIndexToCharIndex(byte[] bArr, int i) {
        ...
        while (i3 < length) {
            ...
            if (b2 >= 0) {
                ...
                int i11 = (b2 << Ascii.f22492FF) ^ ((b5 ^ (-123008)) ^ (b4 << 6));
                if (i11 < 2048) {
                    if (i5 == i) {
                        break;
                    }
                ...
                int i13 = (b2 << Ascii.DC2) ^ (((b8 ^ 3678080) ^ (b7 << 6)) ^ (b6 << Ascii.f22492FF));
                if (i13 > 1114111) {
                    if (i5 == i) {
                        break;
                    }
    ...
    public static final String commonHex(com.applovin.shadow.okio.ByteString byteString) {
        ...
        for (byte b : byteString.getData()) {
            ...
            i += 2;
            cArr[i2] = getHEX_DIGIT_CHARS()[b & Ascii.f22499SI];
        }
