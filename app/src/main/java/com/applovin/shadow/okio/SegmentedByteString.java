...
public final class SegmentedByteString {
    ...
    public static final String toHexString(byte b) {
        return StringsKt.concatToString(new char[]{com.applovin.shadow.okio.internal.ByteString.getHEX_DIGIT_CHARS()[(b >> 4) & 15], com.applovin.shadow.okio.internal.ByteString.getHEX_DIGIT_CHARS()[b & Ascii.f22499SI]});
    }
