...
public class BundleUtils {
    ...
    public static void put(String str, Object obj, Bundle bundle) {
        if (obj == null) {
            C1768p.m5167h("AppLovinSdk", "Skipped insertion into Bundle because value is null.");
            return;
        }
        if (obj instanceof String) {
        ...
        C1768p.m5167h("AppLovinSdk", "Skipped insertion of " + obj + " into Bundle");
    }
    ...
    public static JSONObject toJSONObject(Bundle bundle) {
        ...
        try {
            ...
            C1768p.m5164c("AppLovinSdk", "Failed to convert Bundle to JSONObject", e);
        }
        return jSONObject;
    }
