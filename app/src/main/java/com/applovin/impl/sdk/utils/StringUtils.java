...
public class StringUtils {
    ...
    private static final char[] f3264a = "0123456789abcdef".toCharArray();

    /* JADX INFO: renamed from: com.applovin.impl.sdk.utils.StringUtils$a */
    class C1771a implements Comparator {
        C1771a() {
        }
    ...
    /* JADX INFO: renamed from: a */
    private static String m5203a(String str, Integer num) {
    ...
    public static String appendQueryParameters(String str, Map<String, String> map, boolean z) {
        ...
        if (z) {
            TreeMap treeMap = new TreeMap(new C1771a());
            treeMap.putAll(map);
            map = treeMap;
        }
        Uri.Builder builderBuildUpon = Uri.parse(str).buildUpon();
