...
public final class AdSessionContext {
    ...
    public static AdSessionContext createHtmlAdSessionContext(Partner partner, WebView webView, String str, String str2) {
        ...
        if (str2 != null) {
            C11316g.m25160a(str2, 256, "CustomReferenceData is greater than 256 characters");
        }
    ...
    public static AdSessionContext createNativeAdSessionContext(Partner partner, String str, List<VerificationScriptResource> list, String str2, String str3, UniversalAdId universalAdId) {
        C11316g.m25159a(partner, "Partner is null");
        C11316g.m25159a((Object) str, "OM SDK JS script content is null");
        C11316g.m25159a(list, "VerificationScriptResources is null");
        if (str3 != null) {
            C11316g.m25160a(str3, 256, "CustomReferenceData is greater than 256 characters");
        }
