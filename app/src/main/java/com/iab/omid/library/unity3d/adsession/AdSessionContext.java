...
public final class AdSessionContext {
    ...
    public static AdSessionContext createHtmlAdSessionContext(Partner partner, WebView webView, String str, String str2) {
        C11253g.m24859a(partner, "Partner is null");
        C11253g.m24859a(webView, "WebView is null");
        if (str2 != null) {
            C11253g.m24860a(str2, 256, "CustomReferenceData is greater than 256 characters");
        }
    ...
    public static AdSessionContext createNativeAdSessionContext(Partner partner, String str, List<VerificationScriptResource> list, String str2, String str3) {
        C11253g.m24859a(partner, "Partner is null");
        C11253g.m24859a((Object) str, "OM SDK JS script content is null");
        C11253g.m24859a(list, "VerificationScriptResources is null");
        if (str3 != null) {
            C11253g.m24860a(str3, 256, "CustomReferenceData is greater than 256 characters");
        }
