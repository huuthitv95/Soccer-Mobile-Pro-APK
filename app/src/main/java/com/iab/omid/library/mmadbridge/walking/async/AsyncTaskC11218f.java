...
/* JADX INFO: renamed from: com.iab.omid.library.mmadbridge.walking.async.f */
/* JADX INFO: loaded from: classes6.dex */
public class AsyncTaskC11218f extends AbstractAsyncTaskC11213a {
    public AsyncTaskC11218f(AbstractAsyncTaskC11214b.b bVar, HashSet<String> hashSet, JSONObject jSONObject, long j) {
        super(bVar, hashSet, jSONObject, j);
    }

    /* JADX INFO: renamed from: b */
    private void m24688b(String str) {
        ...
        if (c11185cM24487c != null) {
            for (C11175a c11175a : c11185cM24487c.m24490b()) {
                if (this.f23465c.contains(c11175a.getAdSessionId())) {
                    c11175a.getAdSessionStatePublisher().m24570b(str, this.f23467e);
                }
            }
        }
    }
    ...
    public String doInBackground(Object... objArr) {
        if (C11202c.m24608h(this.f23466d, this.f23469b.mo24681a())) {
            return null;
        }
        this.f23469b.mo24682a(this.f23466d);
