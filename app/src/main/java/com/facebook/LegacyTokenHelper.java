...
public final class LegacyTokenHelper {
    ...
    private final void deserializeKey(String key, Bundle bundle) throws JSONException {
        String str;
        String string = this.cache.getString(key, JsonUtils.EMPTY_JSON);
        if (string == null) {
        ...
        if (Intrinsics.areEqual(string2, "long")) {
