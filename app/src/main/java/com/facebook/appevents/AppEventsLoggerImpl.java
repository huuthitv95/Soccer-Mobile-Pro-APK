    ...
    public static final class Companion {
        ...
        public final void initializeTimersIfNeeded() {
            synchronized (AppEventsLoggerImpl.access$getStaticLock$cp()) {
                ...
                RunnableC7549x4b070522 runnableC7549x4b070522 = new Runnable() { // from class: com.facebook.appevents.AppEventsLoggerImpl$Companion$initializeTimersIfNeeded$attributionRecheckRunnable$1
                ...
                scheduledThreadPoolExecutorAccess$getBackgroundExecutor$cp.scheduleAtFixedRate(runnableC7549x4b070522, 0L, 86400, TimeUnit.SECONDS);
            }
        }
