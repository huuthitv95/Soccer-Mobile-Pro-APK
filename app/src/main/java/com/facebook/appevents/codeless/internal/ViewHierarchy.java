...
public final class ViewHierarchy {
    ...
    /* JADX WARN: Code duplicated, block: B:41:0x0101 A[EDGE_INSN: B:41:0x0101->B:42:0x0102 BREAK  A[LOOP:0: B:31:0x00d0->B:37:0x00ef]] */
    @JvmStatic
                ...
                if (!(view instanceof Spinner)) {
                    ...
                    if (!(view instanceof DatePicker)) {
                        if (!(view instanceof TimePicker)) {
                            ...
                            charSequenceValueOf = String.format("%02d:%02d", Arrays.copyOf(new Object[]{currentHour, currentMinute}, 2));
