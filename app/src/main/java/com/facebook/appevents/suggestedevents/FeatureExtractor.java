...
public final class FeatureExtractor {
    ...
    public static final void initialize(File file) {
        ...
        try {
            try {
                ...
                languageInfo = MapsKt.mapOf(TuplesKt.m43482to(ViewHierarchyConstants.ENGLISH, "1"), TuplesKt.m43482to(ViewHierarchyConstants.GERMAN, "2"), TuplesKt.m43482to(ViewHierarchyConstants.SPANISH, ExifInterface.GPS_MEASUREMENT_3D), TuplesKt.m43482to(ViewHierarchyConstants.JAPANESE, "4"));
                eventInfo = MapsKt.mapOf(TuplesKt.m43482to(ViewHierarchyConstants.VIEW_CONTENT, "0"), TuplesKt.m43482to(ViewHierarchyConstants.SEARCH, "1"), TuplesKt.m43482to(ViewHierarchyConstants.ADD_TO_CART, "2"), TuplesKt.m43482to(ViewHierarchyConstants.ADD_TO_WISHLIST, ExifInterface.GPS_MEASUREMENT_3D), TuplesKt.m43482to(ViewHierarchyConstants.INITIATE_CHECKOUT, "4"), TuplesKt.m43482to(ViewHierarchyConstants.ADD_PAYMENT_INFO, CampaignEx.CLICKMODE_ON), TuplesKt.m43482to(ViewHierarchyConstants.PURCHASE, "6"), TuplesKt.m43482to(ViewHierarchyConstants.LEAD, C11366Bc.f23952e), TuplesKt.m43482to(ViewHierarchyConstants.COMPLETE_REGISTRATION, "8"));
                textTypeInfo = MapsKt.mapOf(TuplesKt.m43482to(ViewHierarchyConstants.BUTTON_TEXT, "1"), TuplesKt.m43482to(ViewHierarchyConstants.PAGE_TITLE, "2"), TuplesKt.m43482to(ViewHierarchyConstants.RESOLVED_DOCUMENT_LINK, ExifInterface.GPS_MEASUREMENT_3D), TuplesKt.m43482to(ViewHierarchyConstants.BUTTON_ID, "4"));
                initialized = true;
            } catch (Throwable th) {
                CrashShieldHandler.handleThrowable(th, FeatureExtractor.class);
            }
    ...
    private final float[] parseFeatures(JSONObject node) {
        ...
        try {
            ...
            if (matchIndicators(new String[]{"$", "amount", "price", C11744X3.i.f26376l}, strArr)) {
                fArr[0] = fArr[0] + 1.0f;
            }
