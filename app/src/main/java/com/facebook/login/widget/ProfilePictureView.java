...
public class ProfilePictureView extends FrameLayout {
    ...
    private int getPresetSizeInPixels(boolean z) {
        ...
        try {
            ...
            if (i2 == -4) {
                i = C7682R.dimen.com_facebook_profilepictureview_preset_size_large;
            } else if (i2 == -3) {
                i = C7682R.dimen.com_facebook_profilepictureview_preset_size_normal;
            } else if (i2 == -2) {
                i = C7682R.dimen.com_facebook_profilepictureview_preset_size_small;
            } else {
                if (i2 != -1 || !z) {
                    return 0;
                }
    ...
    private void parseAttributes(AttributeSet attributeSet) {
        ...
        try {
            TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C7682R.styleable.com_facebook_profile_picture_view);
            setPresetSize(typedArrayObtainStyledAttributes.getInt(C7682R.styleable.com_facebook_profile_picture_view_com_facebook_preset_size, -1));
            this.isCropped = typedArrayObtainStyledAttributes.getBoolean(C7682R.styleable.com_facebook_profile_picture_view_com_facebook_is_cropped, true);
    ...
    private void setBlankProfilePicture() {
        ...
        try {
            ...
            if (this.customizedDefaultProfilePicture == null) {
                setImageBitmap(BitmapFactory.decodeResource(getResources(), isCropped() ? C7682R.drawable.com_facebook_profile_picture_blank_square : C7682R.drawable.com_facebook_profile_picture_blank_portrait));
            } else {
