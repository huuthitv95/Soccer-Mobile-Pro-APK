...
public class DaemonRequest {
        ...
        return CompletableFuture.supplyAsync(new Supplier<GraphResponse>() { // from class: com.facebook.gamingservices.cloudgaming.DaemonRequest.2
            ...
            public GraphResponse get() {
                ...
                try {
                    ...
                    cc$$ExternalSyntheticApiModelOutline0.m$3();
                    CompletableFuture completableFutureM17128m = cc$$ExternalSyntheticApiModelOutline0.m17128m();
                    DaemonRequest.this.mRequestStore.put(string, completableFutureM17128m);
                    ...
                    return (GraphResponse) completableFutureM17128m.get();
    ...
    private GraphResponse executeAndWait(int i) throws ExecutionException, InterruptedException, TimeoutException {
        return (GraphResponse) createRequest().get(i, TimeUnit.SECONDS);
    }
