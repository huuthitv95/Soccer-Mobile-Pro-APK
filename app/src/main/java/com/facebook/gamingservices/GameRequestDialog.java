...
public class GameRequestDialog extends FacebookDialogBase<GameRequestContent, Result> {
    ...
    public static final class Result {
        ...
        List<String> f17376to;

        private Result(Bundle bundle) {
            this.requestId = bundle.getString("request");
            this.f17376to = new ArrayList();
            while (bundle.containsKey(String.format(ShareConstants.WEB_DIALOG_RESULT_PARAM_TO_ARRAY_MEMBER, Integer.valueOf(this.f17376to.size())))) {
                List<String> list = this.f17376to;
        ...
        private Result(GraphResponse graphResponse) {
            try {
                ...
                for (int i = 0; i < jSONArray.length(); i++) {
                    this.f17376to.add(jSONArray.getString(i));
                }
