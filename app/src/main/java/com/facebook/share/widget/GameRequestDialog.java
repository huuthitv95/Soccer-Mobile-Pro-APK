...
public class GameRequestDialog extends FacebookDialogBase<GameRequestContent, Result> {
    ...
    public static final class Result {
        ...
        List<String> f17389to;

        private Result(Bundle bundle) {
            this.requestId = bundle.getString("request");
            this.f17389to = new ArrayList();
            while (bundle.containsKey(String.format(ShareConstants.WEB_DIALOG_RESULT_PARAM_TO_ARRAY_MEMBER, Integer.valueOf(this.f17389to.size())))) {
                List<String> list = this.f17389to;
