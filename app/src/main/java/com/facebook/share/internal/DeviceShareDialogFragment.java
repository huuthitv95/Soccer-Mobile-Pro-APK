...
public class DeviceShareDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        this.dialog = new Dialog(getActivity(), C7589R.style.com_facebook_auth_dialog);
        View viewInflate = getActivity().getLayoutInflater().inflate(C7589R.layout.com_facebook_device_auth_dialog_fragment, (ViewGroup) null);
        this.progressBar = (ProgressBar) viewInflate.findViewById(C7589R.id.progress_bar);
        this.confirmationCode = (TextView) viewInflate.findViewById(C7589R.id.confirmation_code);
        ((Button) viewInflate.findViewById(C7589R.id.cancel_button)).setOnClickListener(new View.OnClickListener() { // from class: com.facebook.share.internal.DeviceShareDialogFragment.1
        ...
        ((TextView) viewInflate.findViewById(C7589R.id.com_facebook_device_auth_instructions)).setText(Html.fromHtml(getString(C7589R.string.com_facebook_device_auth_instructions)));
