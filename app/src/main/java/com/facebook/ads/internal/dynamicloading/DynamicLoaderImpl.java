...
import com.facebook.ads.redexgen.core.AbstractC5972Ra;
import com.facebook.ads.redexgen.core.AbstractC6317XG;
import com.facebook.ads.redexgen.core.C5974Rc;
import com.facebook.ads.redexgen.core.C5975Rd;
import com.facebook.ads.redexgen.core.C5976Re;
import com.facebook.ads.redexgen.core.C5977Rf;
import com.facebook.ads.redexgen.core.C5979Rh;
import com.facebook.ads.redexgen.core.C5985Rn;
import com.facebook.ads.redexgen.core.C5987Rp;
import com.facebook.ads.redexgen.core.C5989Rr;
import com.facebook.ads.redexgen.core.C5990Rs;
import com.facebook.ads.redexgen.core.C5997Rz;
import com.facebook.ads.redexgen.core.C6000S2;
import com.facebook.ads.redexgen.core.C6001S3;
import com.facebook.ads.redexgen.core.C6002S4;
import com.facebook.ads.redexgen.core.C6003S5;
import com.facebook.ads.redexgen.core.C6004S6;
import com.facebook.ads.redexgen.core.C6008SA;
import com.facebook.ads.redexgen.core.C6009SB;
import com.facebook.ads.redexgen.core.C6010SC;
import com.facebook.ads.redexgen.core.C6011SD;
import com.facebook.ads.redexgen.core.C6015SH;
import com.facebook.ads.redexgen.core.C6120Tz;
import com.facebook.ads.redexgen.core.C6122U2;
import com.facebook.ads.redexgen.core.C6140UK;
import com.facebook.ads.redexgen.core.C6185V3;
import com.facebook.ads.redexgen.core.C6186V4;
import com.facebook.ads.redexgen.core.C6219Vb;
import com.facebook.ads.redexgen.core.C6220Vc;
import com.facebook.ads.redexgen.core.C6221Vd;
import com.facebook.ads.redexgen.core.C6230Vn;
import com.facebook.ads.redexgen.core.C6241Vz;
import com.facebook.ads.redexgen.core.C6931hB;
import com.facebook.ads.redexgen.core.C6932hC;
import com.facebook.ads.redexgen.core.C6949hT;
import com.facebook.ads.redexgen.core.InterfaceC6218Va;
...
public class DynamicLoaderImpl implements DynamicLoader, RemoteRenderingApi {
    ...
    public static final InitApi A06 = new C5989Rr();
    ...
    public AdOptionsViewApi createAdOptionsView(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView.Orientation orientation, int i, AdOptionsView adOptionsView) {
        return new C6949hT(context, nativeAdBase, nativeAdLayout, orientation, i, adOptionsView);
    }
    ...
    public AdOptionsViewApi createAdOptionsView(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView adOptionsView) {
        return new C6949hT(context, nativeAdBase, nativeAdLayout, adOptionsView);
    }
    ...
    public AdSizeApi createAdSizeApi(int i) {
        return new C6120Tz(this, AbstractC6317XG.A02(i));
    }

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public AdViewApi createAdViewApi(Context context, String str, AdSize adSize, AdViewParentApi adViewParentApi, AdView adView) {
        return (AdViewApi) AbstractC5972Ra.A00(new C5975Rd(context, str, adSize, adViewParentApi, adView), AdViewApi.class);
    }
    ...
    public AdViewApi createAdViewApi(Context context, String str, String str2, AdViewParentApi adViewParentApi, AdView adView) throws Exception {
        try {
            return (AdViewApi) AbstractC5972Ra.A00(new C5975Rd(context, str, str2, adViewParentApi, adView), AdViewApi.class);
        } catch (C6230Vn e) {
    ...
    public AudienceNetworkActivityApi createAudienceNetworkActivity(AudienceNetworkActivity audienceNetworkActivity, AudienceNetworkActivityApi audienceNetworkActivityApi) {
        return new C5977Rf(audienceNetworkActivity, audienceNetworkActivityApi, new C5976Re(audienceNetworkActivity, audienceNetworkActivityApi));
    }
    ...
    public InterstitialAdApi createInterstitialAd(Context context, String str, InterstitialAd interstitialAd) {
        return (InterstitialAdApi) AbstractC5972Ra.A00(new C5990Rs(context, str, interstitialAd), InterstitialAdApi.class);
    }
    ...
    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public C6000S2 createNativeAdApi(NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        return new C6000S2(nativeAd, nativeAdBaseApi);
    }

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public C6000S2 createNativeAdApi(NativeAdBase nativeAdBase, NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        return new C6000S2(nativeAdBase, nativeAd, nativeAdBaseApi);
    }

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public NativeAdBaseApi createNativeAdBaseApi(Context context, String str) {
        return new C6140UK(context, str, (InterfaceC6218Va) C6140UK.A0K(), false);
    }

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public NativeAdBaseApi createNativeAdBaseApi(NativeAdBaseApi nativeAdBaseApi) {
        return new C6140UK((C6140UK) nativeAdBaseApi);
    }

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public NativeAdBase createNativeAdBaseFromBidPayload(Context context, String str, String str2) throws Exception {
        try {
            return C6140UK.A0A(context, str, str2);
        } catch (C6230Vn e) {
            throw new Exception(e.A01());
        }
    }
    ...
    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public C6220Vc createNativeAdRatingApi(JSONObject jSONObject) {
        return C6220Vc.A00(jSONObject);
    }
    ...
    public NativeAdScrollViewApi createNativeAdScrollViewApi(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, NativeAdScrollView.AdViewProvider adViewProvider, int i, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i2) {
        return new C6001S3(nativeAdScrollView, context, nativeAdsManager, adViewProvider, i, type, nativeAdViewAttributes, i2);
    }
    ...
    public RewardedInterstitialAdApi createRewardedInterstitialAd(Context context, String str, RewardedInterstitialAd rewardedInterstitialAd) {
        return (RewardedInterstitialAdApi) AbstractC5972Ra.A00(new C6011SD(context, str, rewardedInterstitialAd), RewardedInterstitialAdApi.class);
    }

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public RewardedVideoAdApi createRewardedVideoAd(Context context, String str, RewardedVideoAd rewardedVideoAd) {
        return (RewardedVideoAdApi) AbstractC5972Ra.A00(new C6015SH(context, str, rewardedVideoAd), RewardedVideoAdApi.class);
    }

    public static C5985Rn getBidderTokenProviderApi() {
        if (A04 == null) {
            A04 = new C5985Rn();
        }
        return A04;
    ...
    public void maybeInitInternally(Context context) {
        C6122U2.A0A(C5987Rp.A09(context));
    }
}
