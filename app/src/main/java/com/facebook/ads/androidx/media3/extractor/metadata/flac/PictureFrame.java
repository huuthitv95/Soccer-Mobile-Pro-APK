...
import com.facebook.ads.redexgen.core.AbstractC7109k9;
import com.facebook.ads.redexgen.core.C45944v;
import com.facebook.ads.redexgen.core.C5386I2;
...
public final class PictureFrame implements Metadata.Entry {
     ...
     */
    public static PictureFrame A00(C45944v c45944v) {
        int iA0C = c45944v.A0C();
        String strA0X = c45944v.A0X(c45944v.A0C(), AbstractC7109k9.A01);
        String strA0W = c45944v.A0W(c45944v.A0C());
        int iA0C2 = c45944v.A0C();
        int iA0C3 = c45944v.A0C();
        int iA0C4 = c45944v.A0C();
        int iA0C5 = c45944v.A0C();
        int iA0C6 = c45944v.A0C();
        byte[] bArr = new byte[iA0C6];
        c45944v.A0k(bArr, 0, iA0C6);
    ...
    public static void A02() {
        A08 = new byte[]{76, SignedBytes.MAX_POWER_OF_TWO, 4, 5, 19, 3, Ascii.DC2, 9, Ascii.DLE, Ascii.DC4, 9, Ascii.f22499SI, Ascii.f22500SO, 93, Base64.padSymbol, 4, Ascii.f22500SO, Ascii.f22491EM, Ascii.CAN, Ascii.f22502US, 8, 87, 77, 0, 4, 0, 8, 57, Ascii.DC4, Ascii.f22494GS, 8, 80};
    }
    ...
    public PictureFrame(Parcel parcel) {
        ...
        this.A06 = (String) AbstractC46115C.A0f(parcel.readString());
        this.A05 = (String) AbstractC46115C.A0f(parcel.readString());
        this.A04 = parcel.readInt();
        this.A02 = parcel.readInt();
        this.A01 = parcel.readInt();
        this.A00 = parcel.readInt();
        this.A07 = (byte[]) AbstractC46115C.A0f(parcel.createByteArray());
    }
