...
import com.facebook.ads.redexgen.core.C5403IJ;
...
public final class TextInformationFrame extends Id3Frame {
    ...
    public TextInformationFrame(Parcel parcel) {
        this((String) AbstractC45353y.A01(parcel.readString()), parcel.readString(), MetaExoPlayerCustomizedCollections.A02((String[]) AbstractC45353y.A01(parcel.createStringArray())));
    }

    public /* synthetic */ TextInformationFrame(Parcel parcel, C5403IJ c5403ij) {
        this(parcel);
    }
    ...
    public TextInformationFrame(String str, String str2, List<String> values) {
        super(str);
        AbstractC45353y.A07(!values.isEmpty());
        this.A00 = str2;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null) {
            ...
            if (cls == cls2) {
                ...
                if (AbstractC46115C.A1E(super.A00, ((Id3Frame) textInformationFrame).A00)) {
                    boolean zA1E = AbstractC46115C.A1E(this.A00, textInformationFrame.A00);
                    if (A04[5].length() == 10) {
                        throw new RuntimeException();
                    }
                    A04[7] = "aAA9QqK2VvJ";
