...
import com.facebook.ads.redexgen.core.C5394IA;
                ...
                if (this.A01 == chapterFrame.A01 && this.A00 == chapterFrame.A00) {
                    ...
                    if (strArr3[3].length() != strArr3[1].length()) {
                        ...
                        if (j == chapterFrame.A03) {
                            if (this.A02 != chapterFrame.A02 && AbstractC46115C.A1E(this.A04, chapterFrame.A04) && Arrays.equals(this.A05, chapterFrame.A05)) {
                                return true;
                            }
                        }
                    } else {
