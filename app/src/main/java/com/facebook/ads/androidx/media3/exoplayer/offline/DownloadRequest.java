...
import com.facebook.ads.redexgen.core.C5022C7;
...
public final class DownloadRequest implements Parcelable {
    ...
    public static void A01() {
        A07 = new byte[]{-37, 36, 54, 52, 53, 48, 46, 4, 34, 36, 41, 38, Ascii.f22492FF, 38, 58, -31, 46, 54, 52, 53, -31, 35, 38, -31, 47, 54, 45, 45, -31, 39, 48, 51, -31, 53, 58, 49, 38, -5, -31};
    }
    ...
    public DownloadRequest(Parcel parcel) {
        ...
        this.A00 = Uri.parse((String) AbstractC46115C.A0f(parcel.readString()));
    ...
    public DownloadRequest(String str, Uri uri, String str2, List<StreamKey> list, byte[] bArr, String str3, byte[] bArr2) {
        byte[] bArrCopyOf;
        byte[] bArrCopyOf2;
        int iA0B = AbstractC46115C.A0B(uri, str2);
        if (iA0B == 0 || iA0B == 2 || iA0B == 1) {
            AbstractC45353y.A09(str3 == null, A00(1, 38, 126) + iA0B);
        }
        this.A02 = str;
        this.A00 = uri;
        this.A03 = str2;
        ...
        if (bArr2 != null) {
            ...
            bArrCopyOf2 = AbstractC46115C.A07;
        }
        this.A05 = bArrCopyOf2;
    }

    public /* synthetic */ DownloadRequest(String str, Uri uri, String str2, List list, byte[] bArr, String str3, byte[] bArr2, C5022C7 c5022c7) {
        this(str, uri, str2, list, bArr, str3, bArr2);
    }

    public final DownloadRequest A02(DownloadRequest downloadRequest) {
        List listEmptyList;
        AbstractC45353y.A07(this.A02.equals(downloadRequest.A02));
    ...
    public final boolean equals(Object obj) {
        ...
        return this.A02.equals(downloadRequest.A02) && this.A00.equals(downloadRequest.A00) && AbstractC46115C.A1E(this.A03, downloadRequest.A03) && this.A04.equals(downloadRequest.A04) && Arrays.equals(this.A06, downloadRequest.A06) && AbstractC46115C.A1E(this.A01, downloadRequest.A01) && Arrays.equals(this.A05, downloadRequest.A05);
    }
