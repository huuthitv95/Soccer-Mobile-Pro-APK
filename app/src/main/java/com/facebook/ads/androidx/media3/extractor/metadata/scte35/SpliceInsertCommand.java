...
import com.facebook.ads.redexgen.core.C5415IW;
import com.facebook.ads.redexgen.core.C5416IX;
...
public final class SpliceInsertCommand extends SpliceCommand {
    ...
    public static final Parcelable.Creator<SpliceInsertCommand> CREATOR = new C5415IW();
     ...
     */
    public SpliceInsertCommand(long j, boolean z, boolean z2, boolean z3, boolean z4, long j2, long j3, List<C5416IX> list, boolean z5, long j4, int i, int i2, int i3) {
        this.A06 = j;
        this.A0B = z;
        this.A09 = z2;
        this.A0A = z3;
    ...
    public SpliceInsertCommand(Parcel parcel) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            arrayList.add(C5416IX.A00(parcel));
        }
    ...
    public /* synthetic */ SpliceInsertCommand(Parcel parcel, C5415IW c5415iw) {
        this(parcel);
    }

    public static SpliceInsertCommand A00(C45944v c45944v, long j, C460253 c460253) {
        long jA0Q = c45944v.A0Q();
        boolean z = (c45944v.A0I() & 128) != 0;
        boolean z2 = false;
        ...
        if (!z) {
            ...
            if (outOfNetworkIndicator && !z3) {
                jA00 = TimeSignalCommand.A00(c45944v, j);
            }
            if (!outOfNetworkIndicator) {
                int componentCount = c45944v.A0I();
                listEmptyList = new ArrayList(componentCount);
                for (int i = 0; i < componentCount; i++) {
                    int componentTag = c45944v.A0I();
                    long jA01 = -9223372036854775807L;
                    if (!z3) {
                        jA01 = TimeSignalCommand.A00(c45944v, j);
                    }
                    listEmptyList.add(new C5416IX(componentTag, jA01, c460253.A06(jA01), null));
                }
            }
            if (autoReturn) {
                long jA0I = c45944v.A0I();
                z4 = (jA0I & 128) != 0;
                jA0Q2 = (1000 * (((jA0I & 1) << 32) | c45944v.A0Q())) / 90;
            }
            iA0M = c45944v.A0M();
            iA0I = c45944v.A0I();
            iA0I2 = c45944v.A0I();
        }
        return new SpliceInsertCommand(jA0Q, z, z2, outOfNetworkIndicator, z3, jA00, c460253.A06(jA00), listEmptyList, z4, jA0Q2, iA0M, iA0I, iA0I2);
    }
