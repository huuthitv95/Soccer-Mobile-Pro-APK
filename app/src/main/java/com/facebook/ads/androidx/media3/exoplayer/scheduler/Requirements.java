...
import com.facebook.ads.redexgen.core.C5038CO;
...
public final class Requirements implements Parcelable {
    ...
    private int A00(Context context) {
        ...
        ConnectivityManager connectivityManager = (ConnectivityManager) AbstractC45353y.A01(context.getSystemService(A01(77, 12, 28)));
    ...
    private boolean A04(Context context) {
        PowerManager powerManager = (PowerManager) AbstractC45353y.A01(context.getSystemService(A01(89, 5, 31)));
        if (AbstractC46115C.A02 >= 23) {
            return powerManager.isDeviceIdleMode();
        }
        if (AbstractC46115C.A02 >= 20) {
