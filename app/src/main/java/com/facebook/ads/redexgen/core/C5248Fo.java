...
public final class C5248Fo {
    ...
    public Handler A04;
    public Pair<Long, C7472qI> A05;
    public Pair<Surface, C45984z> A06;
    public CopyOnWriteArrayList<InterfaceC45544H> A08;
    public boolean A0A;
    public boolean A0B;
    public final C435610 A0C;
    public final C5267G7 A0D;
    public final boolean A0G;
    public final ArrayDeque<Long> A0F = new ArrayDeque<>();
    public final ArrayDeque<Pair<Long, C7472qI>> A0E = new ArrayDeque<>();
    public int A00 = -1;
    public boolean A09 = true;
    public long A02 = -9223372036854775807L;
    public C7425pW A07 = C7425pW.A06;
    ...
    public static void A02() {
        A0H = new byte[]{48, Base64.padSymbol, Base64.padSymbol, 62, 38, 124, 55, 35, 48, 60, 52, 124, 53, 35, 62, 33, 106, 123, 108, 104, 125, 108, 46, 36, Base64.padSymbol, 59, 32, 44, 46, 63, 2, 37, 59, 62, 63, Ascii.CAN, 62, 57, 45, 42, 40, 46, 43, 41, 56, Ascii.f22493FS, 41, 34, 40, 37, 34, 43, 5, 34, 60, 57, 56, 10, 62, 45, 33, 41, Ascii.f22499SI, 35, 57, 34, 56, 95, 72, 65, 72, 76, 94, 72, 107, 124, 119, 125, 124, 107, 86, 108, 109, 105, 108, 109, 95, 107, 120, 116, 124, 123, 109, 124, 65, 102, 120, 125, 124, 78, 122, 105, 101, 109, 65, 102, 110, 103, 89, 79, 94, 101, 95, 94, 90, 95, 94, 121, 95, 88, 76, 75, 73, 79, 99, 68, 76, 69};
    }
    ...
    public C5248Fo(C5267G7 c5267g7, C435610 c435610, boolean z) {
        this.A0D = c5267g7;
        this.A0C = c435610;
        this.A0G = z;
    }
    ...
    public static boolean A04(long j) {
        if (MetaExoPlayerUpgradeConfig.A03(EnumC7071jX.A1w)) {
            return j > ServiceProvider.SCAR_SIGNALS_FETCH_TIMEOUT;
        }
        int releaseLowerThresholdUs = MetaExoPlayerUpgradeConfig.A00(EnumC7072jY.A08);
        int releaseUpperThresholdUs = MetaExoPlayerUpgradeConfig.A00(EnumC7072jY.A07);
    ...
    public final MediaFormat A06(MediaFormat mediaFormat) {
        if (AbstractC46115C.A02 >= 29 && this.A0C.A0q.getApplicationContext().getApplicationInfo().targetSdkVersion >= 29) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x010e, code lost:
        ...
        r30.A0C.A0S(r24, r2, (com.facebook.ads.redexgen.core.C7472qI) r30.A05.second, null);
     */
    ...
    */
    public final void A0B(long r31, long r33) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C5248Fo.A0B(long, long):void");
    }

    public final void A0C(Surface surface, C45984z c45984z) {
        if (this.A06 != null && ((Surface) this.A06.first).equals(surface) && ((C45984z) this.A06.second).equals(c45984z)) {
            return;
        }
        this.A06 = Pair.create(surface, c45984z);
        if (A0G()) {
            AbstractC45353y.A01(null);
            new C459950(surface, c45984z.A03(), c45984z.A02());
            throw new NullPointerException(A01(108, 20, 7));
        }
    }

    /* JADX WARN: Type inference failed for: r1v0, types: [com.facebook.ads.redexgen.X.4I] */
    public final void A0D(C7472qI c7472qI) {
        AbstractC45353y.A01(null);
        final int i = c7472qI.A0L;
        final int i2 = c7472qI.A0A;
            ...
            public final C45564J A01() {
                return new Object(this.A02, this.A01, this.A00, this.A03) { // from class: com.facebook.ads.redexgen.X.4J
                    ...
                    public static void A01() {
                        A04 = new byte[]{75, 72, 76, 74, 75, 87, 3, 80, 88, 86, 87, 3, 69, 72, 3, 83, 82, 86, 76, 87, 76, 89, 72, Ascii.f22499SI, 3, 69, 88, 87, 3, 76, 86, Ascii.f22494GS, 3, -1, -15, -20, -4, -16, -88, -11, -3, -5, -4, -88, -22, -19, -88, -8, -9, -5, -15, -4, -15, -2, -19, -76, -88, -22, -3, -4, -88, -15, -5, -62, -88};
                    }

                    {
                        AbstractC45353y.A09(i > 0, A00(33, 32, 18) + i);
                        AbstractC45353y.A09(i > 0, A00(0, 33, 109) + i);
                        this.A02 = i;
                        this.A01 = i;
                        this.A00 = f;
                        this.A03 = j;
    ...
    public final void A0E(String str) {
        this.A00 = AbstractC46115C.A09(this.A0C.A0q, str, false);
    }

    public final void A0F(List<InterfaceC45544H> list) {
        if (this.A08 == null) {
    ...
    public final boolean A0H() {
        return this.A06 == null || !((C45984z) this.A06.second).equals(C45984z.A03);
    }
    ...
    public final boolean A0J(C7472qI c7472qI, long j) throws C4904AD {
        AbstractC45353y.A08(!A0G());
        if (!this.A09) {
            return false;
        }
        if (this.A08 == null) {
        ...
        this.A04 = AbstractC46115C.A0Y();
        this.A0C.A26(c7472qI.A0N);
        try {
            if (!C435610.A0h() && c7472qI.A0F != 0) {
                CopyOnWriteArrayList<InterfaceC45544H> copyOnWriteArrayList = this.A08;
                C5247Fn.A00(c7472qI.A0F);
            ...
            new ExecutorC48609N(handler);
            new C7274n4(this);
            throw new NullPointerException(A01(16, 6, 36));
        } catch (Exception e) {
            throw this.A0C.A1S(e, c7472qI, 7000);
        }
    }

    public final boolean A0K(C7472qI c7472qI, long j, boolean z) {
        AbstractC45353y.A02(null);
