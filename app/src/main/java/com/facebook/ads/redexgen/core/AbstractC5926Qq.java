...
import com.facebook.ads.redexgen.core.AbstractC5956RK;
import java.util.Arrays;
import java.util.List;

/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.Qq */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public abstract class AbstractC5926Qq<VH extends AbstractC5956RK> {
    ...
    public final C5927Qr A01 = new C5927Qr();
    ...
    public final VH A0E(ViewGroup viewGroup, int i) {
        AbstractC5820P4.A01(A08(0, 13, 100));
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Qq != com.facebook.ads.internal.androidx.support.v7.widget.RecyclerView$Adapter<VH extends com.facebook.ads.redexgen.X.RK> */
    public final void A0H(AbstractC5928Qs abstractC5928Qs) {
        this.A01.registerObserver(abstractC5928Qs);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Qq != com.facebook.ads.internal.androidx.support.v7.widget.RecyclerView$Adapter<VH extends com.facebook.ads.redexgen.X.RK> */
    public final void A0I(AbstractC5928Qs abstractC5928Qs) {
        this.A01.unregisterObserver(abstractC5928Qs);
    }
    ...
    public final void A0J(VH vh, int i) {
        ...
        vh.A0a(1, 519);
        AbstractC5820P4.A01(A08(13, 13, 51));
        A0A(vh, i, vh.A0R());
        vh.A0T();
        ViewGroup.LayoutParams layoutParams = vh.A0H.getLayoutParams();
        if (layoutParams instanceof C5939R3) {
            ((C5939R3) layoutParams).A01 = true;
        }
        AbstractC5820P4.A00();
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Qq != com.facebook.ads.internal.androidx.support.v7.widget.RecyclerView$Adapter<VH extends com.facebook.ads.redexgen.X.RK> */
    public void A0L(C47457M c47457m) {
    }
