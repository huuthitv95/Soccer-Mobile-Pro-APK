...
public final class C7481qT implements InterfaceC442224 {
    ...
    public static final String A0G = AbstractC46115C.A0h(0);
    public static final String A0B = AbstractC46115C.A0h(1);
    public static final String A0H = AbstractC46115C.A0h(2);
    public static final String A0F = AbstractC46115C.A0h(3);
    public static final String A0C = AbstractC46115C.A0h(4);
    public static final String A0A = AbstractC46115C.A0h(5);
    public static final String A0D = AbstractC46115C.A0h(6);
    public static final String A0E = AbstractC46115C.A0h(7);
    public static final InterfaceC442123<C7481qT> A09 = new InterfaceC442123() { // from class: com.facebook.ads.redexgen.X.qU
        @Override // com.facebook.ads.redexgen.core.InterfaceC442123
        public final InterfaceC442224 A6f(Bundle bundle) {
            return C7481qT.A00(bundle);
        }
    };
     ...
     */
    public static C7481qT A00(Bundle bundle) {
        ...
        return new C7481qT(j, i, i2, intArray, uriArr, longArray, j2, z);
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 15 out of bounds for length 15
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:38)
     */
    public final C7481qT A06(int i) {
        int[] iArrA02 = A02(this.A05, i);
        long[] jArrA03 = A03(this.A06, i);
        return new C7481qT(this.A03, i, this.A01, iArrA02, (Uri[]) Arrays.copyOf(this.A07, i), jArrA03, this.A02, this.A04);
    }

    public C7481qT(long j) {
        this(j, -1, -1, new int[0], new Uri[0], new long[0], 0L, false);
    }

    public C7481qT(long j, int i, int i2, int[] iArr, Uri[] uriArr, long[] jArr, long j2, boolean z) {
        AbstractC45353y.A07(iArr.length == uriArr.length);
        this.A03 = j;
        this.A00 = i;
        this.A01 = i2;
        this.A05 = iArr;
    ...
    public final boolean equals(Object obj) {
        ...
        C7481qT c7481qT = (C7481qT) obj;
        if (this.A03 == c7481qT.A03 && this.A00 == c7481qT.A00 && this.A01 == c7481qT.A01 && Arrays.equals(this.A07, c7481qT.A07) && Arrays.equals(this.A05, c7481qT.A05) && Arrays.equals(this.A06, c7481qT.A06)) {
            long j = this.A02;
            ...
            if (j == c7481qT.A02 && this.A04 == c7481qT.A04) {
                return true;
            }
        }
        return false;
