...
public final class C4955B2<T> extends AbstractC7474qK<T> implements Serializable {
    ...
    public final AbstractC7474qK<? super T> A00;
    ...
    public static void A01() {
        A01 = new byte[]{-30, 38, Ascii.f22491EM, 42, Ascii.f22491EM, 38, 39, Ascii.f22491EM, -36, -35};
    }
    ...
    public C4955B2(AbstractC7474qK<? super T> forwardOrder) {
        this.A00 = (AbstractC7474qK) AbstractC7142ki.A04(forwardOrder);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.B2 != com.google.common.collect.ReverseOrdering<T> */
    @Override // com.facebook.ads.redexgen.core.AbstractC7474qK
    public final <S extends T> AbstractC7474qK<S> A06() {
        return this.A00;
    }
    ...
    public final boolean equals(@CheckForNull Object object) {
        if (object != this) {
            if (object instanceof C4955B2) {
                return this.A00.equals(((C4955B2) object).A00);
            }
            return false;
        }
        String[] strArr = A02;
