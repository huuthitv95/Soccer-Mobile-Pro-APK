...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.Ud */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public class ViewOnClickListenerC6159Ud implements View.OnClickListener, View.OnLongClickListener, View.OnTouchListener, InterfaceC6063T4 {
    ...
    public static void A02() {
        A02 = new byte[]{101, SignedBytes.MAX_POWER_OF_TWO, 4, 71, 69, 74, 74, 75, 80, 4, 70, 65, 4, 71, 72, 77, 71, 79, 65, SignedBytes.MAX_POWER_OF_TWO, 4, 70, 65, 66, 75, 86, 65, 4, 77, 80, 4, 77, 87, 4, 82, 77, 65, 83, 65, SignedBytes.MAX_POWER_OF_TWO, 10, 42, 5, 0, 10, 2, Ascii.SUB, 73, 1, 8, Ascii.f22491EM, Ascii.f22491EM, Ascii.f22492FF, 7, Ascii.f22492FF, Ascii.f22490CR, 73, Ascii.f22494GS, 6, 6, 73, Ascii.f22499SI, 8, Ascii.SUB, Ascii.f22494GS, 71, Ascii.f22490CR, 9, 10, 62, 47, 34, 46, 37, 40, 46, 5, 46, 63, 60, 36, 57, 32, Ascii.CAN, 57, 118, 34, 57, 35, 53, 62, 118, 50, 55, 34, 55, 118, 36, 51, 53, 57, 36, 50, 51, 50, 122, 118, 38, 58, 51, 55, 37, 51, 118, 51, 56, 37, 35, 36, 51, 118, 34, 57, 35, 53, 62, 118, 51, 32, 51, 56, 34, 37, 118, 36, 51, 55, 53, 62, 118, 34, 62, 51, 118, 55, 50, 118, 0, 63, 51, 33, 118, 52, 47, 118, 36, 51, 34, 35, 36, 56, 63, 56, 49, 118, 48, 55, 58, 37, 51, 118, 63, 48, 118, 47, 57, 35, 118, 63, 56, 34, 51, 36, 53, 51, 38, 34, 118, 34, 62, 51, 118, 51, 32, 51, 56, 34, 120, Ascii.f22490CR, Ascii.f22503VT, Ascii.DLE, 120, 98, 127};
    }
    ...
    public ViewOnClickListenerC6159Ud(C6140UK c6140uk, C6902gi c6902gi) {
        this.A01 = c6140uk;
        this.A00 = c6902gi;
    }

    public /* synthetic */ ViewOnClickListenerC6159Ud(C6140UK c6140uk, C6902gi c6902gi, C6239Vx c6239Vx) {
        this(c6140uk, c6902gi);
    }

    private Map<String, String> A01() {
        Map<String, String> mapA05 = new C6558b9().A03(this.A01.A0U).A02(this.A01.A0j).A05();
    ...
    public final void A04() {
        if (this.A01.A08 != null) {
            ((C6931hB) this.A01.A08.getNativeAdLayoutApi()).A04(new C6458ZX(this.A01.A0g));
        }
    }
    ...
    public final void onClick(View view) {
        ...
        try {
            ...
            int minimumElapsedTime = C6171Up.A0K(this.A01.A0g);
