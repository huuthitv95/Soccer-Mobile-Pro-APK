...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.UZ */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C6155UZ {
    ...
    public C6155UZ(File file) {
        this.A00 = file;
    }

    public static C6155UZ A00(String str, Context context) throws IOException {
        File filesDir = new File(context.getFilesDir(), A01(64, 9, 96));
        A03(filesDir);
        File fbsdklogDir = new File(filesDir, str);
        A03(fbsdklogDir);
        return new C6155UZ(fbsdklogDir);
    }
    ...
    public static void A03(File file) throws IOException {
        if (file.exists() || file.mkdir()) {
            if (file.isDirectory()) {
                ...
                throw new C6156Ua(String.format(Locale.US, A01(0, 33, 62), file.getCanonicalPath()));
            }
        }
        throw new C6156Ua(String.format(Locale.US, A01(33, 31, 59), file.getCanonicalPath()));
    }

    public final C6155UZ A04(String str) throws IOException {
        File file = new File(this.A00, str);
        A03(file);
        return new C6155UZ(file);
    }
