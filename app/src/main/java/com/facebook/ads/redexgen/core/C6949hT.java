...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.hT */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C6949hT extends C5984Rm implements AdOptionsViewApi, InterfaceC6507aK {
    ...
    static {
        A08();
        A0D = (int) (AbstractC6334XX.A02 * 23.0f);
        A0E = (int) (AbstractC6334XX.A02 * 4.0f);
    }

    public C6949hT(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView.Orientation orientation, int i, AdOptionsView adOptionsView) {
        this.A05 = false;
        this.A04 = false;
        this.A03 = false;
        ...
        this.A0A = C6140UK.A0L(nativeAdBase.getInternalNativeAd());
        this.A0A.A1c(nativeAdLayout);
        this.A0A.A1e(this);
        C7094ju c7094juA12 = this.A0A.A12();
        if (c7094juA12 != null && c7094juA12.A0R() && !c7094juA12.A0P()) {
            this.A07.setVisibility(8);
            return;
        }
        EnumC6339Xc.A04(this.A08, EnumC6339Xc.A0C);
        if (A0C()) {
            A05();
            return;
        }
    ...
    public C6949hT(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView adOptionsView) {
        this(context, nativeAdBase, nativeAdLayout, AdOptionsView.Orientation.HORIZONTAL, 23, adOptionsView);
    }

    private ImageView A00(EnumC6385YM enumC6385YM) {
    ...
    public static EnumC6385YM A01(AbstractC7077jd abstractC7077jd) {
        if (AbstractC6508aL.A00(abstractC7077jd) == EnumC6512aP.A02) {
            return EnumC6385YM.AD_CHOICE_COLLAPSED_PILL;
        }
        return EnumC6385YM.CREDIT_LINE_COLLAPSED_PILL;
    }

    public static EnumC6385YM A02(AbstractC7077jd abstractC7077jd) {
        if (AbstractC6508aL.A00(abstractC7077jd) == EnumC6512aP.A02) {
            return EnumC6385YM.AD_CHOICE_EXPANDED_PILL;
        }
        return EnumC6385YM.CREDIT_LINE_PILL;
    }
    ...
    private void A05() {
        C6510aN c6510aNA02 = AbstractC6511aO.A02(this.A0A.A15(), EnumC6509aM.A05, this.A0A.A13());
        c6510aNA02.setBackgroundColor(-2145637581);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-2, -2);
        this.A07.addView(c6510aNA02, layoutParams);
    }
    ...
    private void A06() {
        ...
        if (this.A00 != null && this.A09 != null && this.A0A.A13() != null) {
            this.A02 = AbstractC6511aO.A03(this.A0A.A15(), EnumC6509aM.A05, this.A0A.A13(), this.A00, A02(this.A0A.A13()), this.A09, this);
            if (this.A0A.A13().A2Q()) {
                this.A02.A0A();
            }
        }
    ...
    private void A07() {
        this.A0A.A1O();
        if (C6171Up.A2Z(this.A06)) {
            this.A07.performAccessibilityAction(128, null);
        }
    }

    private void A09(int i) {
        this.A01 = A00(EnumC6385YM.DEFAULT_INFO_ICON);
        A0A(EnumC6385YM.AD_CHOICES_ICON);
        this.A07.addView(this.A01);
        setIconSizeDp(i);
        setIconColor(-10459280);
    }

    private void A0A(EnumC6385YM enumC6385YM) {
        this.A00 = A00(enumC6385YM);
    ...
    public final void A0E(EnumC6385YM enumC6385YM) {
        if (this.A01 != null) {
    ...
    public final void setIconSizeDp(int i) {
        int iconSize = Math.max(A0D, (int) (AbstractC6334XX.A02 * i));
    ...
    public final void setSingleIcon(boolean z) {
        if (this.A01 != null) {
            AbstractC6374YB.A0O(this.A01, z ? 8 : 0);
        }
        this.A05 = true;
    }
}
