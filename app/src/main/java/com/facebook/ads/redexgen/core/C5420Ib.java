...
public final class C5420Ib {
     ...
     */
    public static C5420Ib A02(C45944v c45944v) {
        ...
        if (!z) {
            ...
            jA0Q2 = z3 ? c45944v.A0Q() : -9223372036854775807L;
            if (!z3) {
                int iA0I4 = c45944v.A0I();
                arrayList = new ArrayList(iA0I4);
                for (int i = 0; i < iA0I4; i++) {
                    arrayList.add(new C5419Ia(c45944v.A0I(), c45944v.A0Q(), null));
                }
                if (A0B[3].charAt(19) == '7') {
            ...
            if (z5) {
                ...
                z4 = (128 & jA0I) != 0;
                jA0Q3 = (1000 * (((1 & jA0I) << 32) | c45944v.A0Q())) / 90;
            }
            iA0M = c45944v.A0M();
            iA0I = c45944v.A0I();
            iA0I2 = c45944v.A0I();
        }
        return new C5420Ib(jA0Q, z, z2, z3, arrayList, jA0Q2, z4, jA0Q3, iA0M, iA0I, iA0I2);
    }

    public C5420Ib(long j, boolean z, boolean z2, boolean z3, List<C5419Ia> list, long j2, boolean z4, long j3, int i, int i2, int i3) {
        this.A04 = j;
        this.A0A = z;
        this.A08 = z2;
        this.A09 = z3;
    ...
    public C5420Ib(Parcel parcel) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            arrayList.add(C5419Ia.A00(parcel));
        }
    ...
    public static C5420Ib A00(Parcel parcel) {
        return new C5420Ib(parcel);
    }
