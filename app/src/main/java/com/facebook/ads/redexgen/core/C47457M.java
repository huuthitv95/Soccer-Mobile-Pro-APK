...
import com.facebook.ads.internal.androidx.support.p272v7.widget.RecyclerView$SavedState;
...
public class C47457M extends ViewGroup {
    ...
    public C5901QQ A01;
    public C6973hs A02;
    public RunnableC5914Qd A03;
    public AbstractC5926Qq A04;
    public AbstractC5934Qy A05;
    public AbstractC5938R2 A06;
    public InterfaceC5947RB A07;
    public RunnableC5955RJ A08;
    public C6957hb A09;
    public boolean A0A;
    public boolean A0B;
    public boolean A0C;
    ...
    public C5840PP A0d;
    public InterfaceC5929Qt A0e;
    public InterfaceC5932Qw A0f;
    public AbstractC5941R5 A0g;
    public InterfaceC5942R6 A0h;
    public AbstractC5943R7 A0i;
    public RecyclerView$SavedState A0j;
    public Runnable A0k;
    public List<RecyclerView.OnChildAttachStateChangeListener> A0l;
    public List<AbstractC5943R7> A0m;
    public boolean A0n;
    public boolean A0o;
    public final Rect A0p;
    public final RectF A0q;
    public final C5946RA A0r;
    public final C5953RH A0s;
    public final C5964RS A0t;
    public final Runnable A0u;
    public final ArrayList<RecyclerView.ItemDecoration> A0v;
    public final List<AbstractC5956RK> A0w;
    public final int A0x;
    public final int A0y;
    public final Rect A0z;
    public final AccessibilityManager A10;
    public final C6961hg A11;
    public final InterfaceC5963RR A12;
    public final ArrayList<InterfaceC5942R6> A13;
     ...
     */
    public static C47457M A0H(View view) {
        if (!(view instanceof ViewGroup)) {
            return null;
        }
        if (view instanceof C47457M) {
            return (C47457M) view;
        }
        ViewGroup viewGroup = (ViewGroup) view;
        int childCount = viewGroup.getChildCount();
        for (int i = 0; i < childCount; i++) {
            C47457M c47457mA0H = A0H(viewGroup.getChildAt(i));
            if (c47457mA0H != null) {
                return c47457mA0H;
            }
        }
    ...
    private void A0N() {
        ...
        if (this.A0s.A0C) {
            for (int iA05 = this.A01.A05() - 1; iA05 >= 0; iA05--) {
                AbstractC5956RK abstractC5956RKA0F = A0F(this.A01.A09(iA05));
                if (!abstractC5956RKA0F.A0l()) {
                    long jA0C = A0C(abstractC5956RKA0F);
                    C5933Qx c5933QxA0E = this.A05.A0E(this.A0s, abstractC5956RKA0F);
                    AbstractC5956RK abstractC5956RKA05 = this.A0t.A05(jA0C);
                    if (abstractC5956RKA05 == null || abstractC5956RKA05.A0l()) {
                        this.A0t.A0E(abstractC5956RKA0F, c5933QxA0E);
                    } else {
                        boolean zA0H = this.A0t.A0H(abstractC5956RKA05);
                        boolean zA0H2 = this.A0t.A0H(abstractC5956RKA0F);
                        if (zA0H && abstractC5956RKA05 == abstractC5956RKA0F) {
                            this.A0t.A0E(abstractC5956RKA0F, c5933QxA0E);
                        } else {
                            C5933Qx c5933QxA04 = this.A0t.A04(abstractC5956RKA05);
                            this.A0t.A0E(abstractC5956RKA0F, c5933QxA0E);
                            C5933Qx c5933QxA03 = this.A0t.A03(abstractC5956RKA0F);
                            if (c5933QxA04 == null) {
                                A0m(jA0C, abstractC5956RKA0F, abstractC5956RKA05);
                            } else {
                                A0t(abstractC5956RKA05, abstractC5956RKA0F, c5933QxA04, c5933QxA03, zA0H, zA0H2);
                            }
                        }
                    }
                }
    ...
    static {
        ...
        A1A = new InterpolatorC5925Qp();
    }

    public C47457M(Context context) {
        this(context, null);
    }

    public C47457M(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public C47457M(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        this.A11 = new C6961hg(this);
        this.A0r = new C5946RA(this);
        this.A0t = new C5964RS();
        this.A0u = new RunnableC5923Qn(this);
        this.A0p = new Rect();
        this.A0z = new Rect();
        this.A0q = new RectF();
        ...
        this.A0U = 0;
        this.A0N = 0;
        this.A05 = new C47487P();
        this.A0W = 0;
        this.A0V = -1;
        this.A0L = Float.MIN_VALUE;
        this.A0M = Float.MIN_VALUE;
        this.A0o = true;
        this.A08 = new RunnableC5955RJ(this);
        this.A02 = A1E ? new C6973hs() : null;
        this.A0s = new C5953RH();
        this.A0G = false;
        this.A0H = false;
        this.A0f = new C6965hk(this);
        this.A0K = false;
        this.A14 = new int[2];
        this.A17 = new int[2];
        this.A16 = new int[2];
        ...
        this.A0k = new RunnableC5924Qo(this);
        this.A12 = new C6968hn(this);
        ...
        this.A0L = AbstractC5858Pi.A00(viewConfiguration, context);
        this.A0M = AbstractC5858Pi.A01(viewConfiguration, context);
        ...
        setAccessibilityDelegateCompat(new C6957hb(this));
    ...
    private final long A0C(AbstractC5956RK abstractC5956RK) {
        return this.A04.A0M() ? abstractC5956RK.A0Q() : abstractC5956RK.A03;
    }

    private View A0D() {
        AbstractC5956RK abstractC5956RKA1F;
        ...
        for (int startFocusSearchIndex = i; startFocusSearchIndex < iA03; startFocusSearchIndex++) {
            AbstractC5956RK abstractC5956RKA1F2 = A1F(startFocusSearchIndex);
            if (abstractC5956RKA1F2 == null) {
                break;
            }
            if (abstractC5956RKA1F2.A0H.hasFocusable()) {
                return abstractC5956RKA1F2.A0H;
            }
        }
        int startFocusSearchIndex2 = Math.min(iA03, i);
        for (int limit = startFocusSearchIndex2 - 1; limit >= 0 && (abstractC5956RKA1F = A1F(limit)) != null; limit--) {
            if (abstractC5956RKA1F.A0H.hasFocusable()) {
                return abstractC5956RKA1F.A0H;
            }
        }
        return null;
    }

    private final AbstractC5956RK A0E(long j) {
        if (this.A04 == null || !this.A04.A0M()) {
            return null;
        }
        int iA06 = this.A01.A06();
        AbstractC5956RK abstractC5956RK = null;
        for (int i = 0; i < iA06; i++) {
            AbstractC5956RK holder = A0F(this.A01.A0A(i));
            if (holder != null && !holder.A0g() && holder.A0Q() == j) {
                if (this.A01.A0K(holder.A0H)) {
                    abstractC5956RK = holder;
                } else {
                    return holder;
                }
            }
    ...
    public static AbstractC5956RK A0F(View view) {
        if (view == null) {
            return null;
        }
    ...
    private final AbstractC5956RK A0G(View view) {
    ...
    private void A0L() {
        ...
        if (this.A0s.A0C) {
            ...
            for (int i = 0; i < iA05; i++) {
                AbstractC5956RK holder = A0F(this.A01.A09(i));
                if (!holder.A0l() && (!holder.A0f() || this.A04.A0M())) {
                    AbstractC5934Qy abstractC5934Qy = this.A05;
                    C5953RH c5953rh = this.A0s;
                    int i2 = AbstractC5934Qy.A06(holder);
                    this.A0t.A0F(holder, abstractC5934Qy.A0F(c5953rh, holder, i2, holder.A0R()));
        ...
        if (this.A0s.A0B) {
            ...
            for (int i3 = 0; i3 < this.A01.A05(); i3++) {
                AbstractC5956RK abstractC5956RKA0F = A0F(this.A01.A09(i3));
                boolean didStructureChange = abstractC5956RKA0F.A0l();
                if (!didStructureChange) {
                    boolean didStructureChange2 = this.A0t.A0I(abstractC5956RKA0F);
                    if (!didStructureChange2) {
                        int iA06 = AbstractC5934Qy.A06(abstractC5956RKA0F);
                        boolean zA0o = abstractC5956RKA0F.A0o(8192);
                        if (!zA0o) {
                            iA06 |= 4096;
                        }
                        C5933Qx c5933QxA0F = this.A05.A0F(this.A0s, abstractC5956RKA0F, iA06, abstractC5956RKA0F.A0R());
                        if (zA0o) {
                            A1k(abstractC5956RKA0F, c5933QxA0F);
                        } else {
                            this.A0t.A0D(abstractC5956RKA0F, c5933QxA0F);
                        }
                    }
                }
            }
    ...
    private void A0O() {
        this.A01 = new C5901QQ(new C6967hm(this));
    }
    ...
    private void A0P() {
        ...
        if (!animationTypeSupported5 || this.A05 == null) {
            ...
            c5953rh.A0C = animationTypeSupported;
            C5953RH c5953rh2 = this.A0s;
    ...
    private void A0Q() {
        ...
        if (this.A0o && this.A04 != null && hasFocus() && getDescendantFocusability() != 393216) {
            ...
            if (j != -1 && this.A04.A0M()) {
                abstractC5956RKA0E = A0E(this.A0s.A08);
            }
            View viewA0D = null;
            if (abstractC5956RKA0E == null || this.A01.A0K(abstractC5956RKA0E.A0H) || !abstractC5956RKA0E.A0H.hasFocusable()) {
                if (this.A01.A05() > 0) {
                    viewA0D = A0D();
                }
            } else {
                viewA0D = abstractC5956RKA0E.A0H;
            }
            if (viewA0D != null) {
    ...
    private void A0U() {
        ...
        if (this.A0o && hasFocus()) {
            AbstractC5926Qq abstractC5926Qq = this.A04;
            String[] strArr = A19;
            if (strArr[3].charAt(2) == strArr[2].charAt(2)) {
                throw new RuntimeException();
            }
        ...
        AbstractC5956RK abstractC5956RKA0G = focusedChild == null ? null : A0G(focusedChild);
        if (abstractC5956RKA0G == null) {
            A0S();
            return;
        }
        this.A0s.A08 = this.A04.A0M() ? abstractC5956RKA0G.A0Q() : -1L;
        C5953RH c5953rh = this.A0s;
        if (this.A0C) {
            iA0M = -1;
        } else {
            iA0M = abstractC5956RKA0G.A0g() ? abstractC5956RKA0G.A01 : abstractC5956RKA0G.A0M();
        }
        c5953rh.A01 = iA0M;
        C5953RH c5953rh2 = this.A0s;
        View child = abstractC5956RKA0G.A0H;
        c5953rh2.A02 = A0B(child);
    }
    ...
    private final void A0X() {
        int iA06 = this.A01.A06();
        for (int i = 0; i < iA06; i++) {
            AbstractC5956RK abstractC5956RKA0F = A0F(this.A01.A0A(i));
            if (!abstractC5956RKA0F.A0l()) {
                abstractC5956RKA0F.A0S();
            }
        }
        this.A0r.A0K();
    }
    ...
    private final void A0Z() {
        ...
        for (int size = this.A0w.size() - 1; size >= 0; size--) {
            AbstractC5956RK abstractC5956RK = this.A0w.get(size);
            if (abstractC5956RK.A0H.getParent() == this && !abstractC5956RK.A0l() && (state = abstractC5956RK.A02) != -1) {
                AbstractC5857Ph.A09(abstractC5956RK.A0H, state);
                abstractC5956RK.A02 = -1;
            }
        }
        this.A0w.clear();
    }
    ...
    private final void A0e() {
        this.A00 = new C6974ht(new C6966hl(this));
    }
    ...
    private final void A0g() {
        int iA06 = this.A01.A06();
        for (int i = 0; i < iA06; i++) {
            ((C5939R3) this.A01.A0A(i).getLayoutParams()).A01 = true;
        }
        this.A0r.A0M();
    }
    ...
    private final void A0h() {
        ...
        for (int i = 0; i < iA06; i++) {
            AbstractC5956RK abstractC5956RKA0F = A0F(this.A01.A0A(i));
            if (abstractC5956RKA0F != null && !abstractC5956RKA0F.A0l()) {
                abstractC5956RKA0F.A0Z(6);
            }
        }
        A0g();
        this.A0r.A0N();
    ...
    private void A0j(float f, float f2, float f3, float f4) {
        ...
        if (f2 < 0.0f) {
            A0b();
            AbstractC5892QH.A00(this.A0a, (-f2) / getWidth(), 1.0f - (f3 / getHeight()));
            z = true;
        } else if (f2 > 0.0f) {
            A0c();
            AbstractC5892QH.A00(this.A0b, f2 / getWidth(), f3 / getHeight());
            z = true;
        }
        if (f4 < 0.0f) {
            A0d();
            AbstractC5892QH.A00(this.A0c, (-f4) / getHeight(), f / getWidth());
            z = true;
        } else if (f4 > 0.0f) {
            A0a();
            AbstractC5892QH.A00(this.A0Z, f4 / getHeight(), 1.0f - (f / getWidth()));
            z = true;
        }
        if (!z && f2 == 0.0f) {
            if (A19[7].length() != 1) {
    ...
    private final void A0k(int i) {
        AbstractC5938R2 abstractC5938R2 = this.A06;
        if (this.A0i != null) {
            this.A0i.A0L(this, i);
        }
        if (this.A0m != null) {
    ...
    private void A0m(long j, AbstractC5956RK abstractC5956RK, AbstractC5956RK abstractC5956RK2) {
        int iA05 = this.A01.A05();
        for (int i = 0; i < iA05; i++) {
            AbstractC5956RK other = A0F(this.A01.A09(i));
            if (other != abstractC5956RK && A0C(other) == j) {
                AbstractC5926Qq abstractC5926Qq = this.A04;
                String[] strArr = A19;
                String str = strArr[0];
                String str2 = strArr[6];
                ...
                if (abstractC5926Qq != null && this.A04.A0M()) {
                    throw new IllegalStateException(A0I(1696, 130, 15) + other + strA0I + abstractC5956RK + A1J());
                }
                throw new IllegalStateException(A0I(DriveStatusCodes.DRIVE_CONTENTS_TOO_LARGE, 188, 43) + other + strA0I + abstractC5956RK + A1J());
            }
        }
        Log.e(A0I(1370, 12, 39), A0I(InterfaceC11669Sd.a.f25673c, 111, 51) + abstractC5956RK2 + A0I(18, 41, Sdk.SDKError.Reason.ASSET_FAILED_STATUS_CODE_VALUE) + abstractC5956RK + A1J());
    }
    ...
    public static void A0o(View view, Rect rect) {
        ...
        Rect rect2 = c5939r3.A03;
        rect.set((view.getLeft() - rect2.left) - c5939r3.leftMargin, (view.getTop() - rect2.top) - c5939r3.topMargin, view.getRight() + rect2.right + c5939r3.rightMargin, view.getBottom() + rect2.bottom + c5939r3.bottomMargin);
    }
    ...
    private void A0p(View view, View view2) {
        ...
        if (layoutParams instanceof C5939R3) {
            ...
            C5939R3 c5939r3 = (C5939R3) layoutParams;
            if (!c5939r3.A01) {
                Rect insets = c5939r3.A03;
    ...
    private void A0q(AbstractC5926Qq abstractC5926Qq, boolean z, boolean z2) {
        if (this.A04 != null) {
        ...
        this.A00.A09();
        AbstractC5926Qq abstractC5926Qq2 = this.A04;
        this.A04 = abstractC5926Qq;
        if (abstractC5926Qq != null) {
            abstractC5926Qq.A0H(this.A11);
        }
        AbstractC5938R2 abstractC5938R2 = this.A06;
        C5946RA c5946ra = this.A0r;
        AbstractC5926Qq oldAdapter = this.A04;
        c5946ra.A0U(abstractC5926Qq2, oldAdapter, z);
        this.A0s.A0D = true;
        A1R();
    }

    private void A0r(AbstractC5956RK abstractC5956RK) {
    ...
    public static void A0s(AbstractC5956RK abstractC5956RK) {
        if (abstractC5956RK.A09 != null) {
            C47457M c47457m = abstractC5956RK.A09.get();
            while (c47457m != null) {
                View item = abstractC5956RK.A0H;
                if (c47457m == item) {
                    return;
                }
                Object parent = c47457m.getParent();
            ...
            abstractC5956RK.A09 = null;
        }
    }

    private void A0t(AbstractC5956RK abstractC5956RK, AbstractC5956RK abstractC5956RK2, C5933Qx c5933Qx, C5933Qx c5933Qx2, boolean z, boolean z2) {
        ...
        if (abstractC5956RK != abstractC5956RK2) {
            if (z2) {
                A0r(abstractC5956RK2);
            }
            abstractC5956RK.A06 = abstractC5956RK2;
            A0r(abstractC5956RK);
            this.A0r.A0Y(abstractC5956RK);
            abstractC5956RK2.A0d(false);
            abstractC5956RK2.A07 = abstractC5956RK;
        }
        if (this.A05.A0R(abstractC5956RK, abstractC5956RK2, c5933Qx, c5933Qx2)) {
            A1O();
        }
    }
    ...
    private void A0x(int[] iArr) {
        ...
        for (int i = 0; i < iA05; i++) {
            AbstractC5956RK abstractC5956RKA0F = A0F(this.A01.A09(i));
            if (!abstractC5956RKA0F.A0l()) {
                int count = abstractC5956RKA0F.A0O();
    ...
    private boolean A0y() {
        ...
        for (int i = 0; i < iA05; i++) {
            AbstractC5956RK abstractC5956RKA0F = A0F(this.A01.A09(i));
            if (abstractC5956RKA0F != null && !abstractC5956RKA0F.A0l()) {
                boolean zA0j = abstractC5956RKA0F.A0j();
                int i2 = A19[7].length();
                if (i2 != 1) {
                    throw new RuntimeException();
                }
    ...
    private final boolean A13(int consumedX, int consumedY, MotionEvent motionEvent) {
        ...
        if (this.A04 != null) {
            A1L();
            A1M();
            AbstractC5820P4.A01(A0I(1361, 9, 51));
            A1j(this.A0s);
            if (consumedX != 0) {
        ...
        if (A1v(iA1f, iA1g, i, i2, this.A17, 0)) {
            ...
            if (motionEvent != null && !AbstractC5838PN.A00(motionEvent, 8194)) {
    ...
    private final boolean A18(AccessibilityEvent accessibilityEvent) {
        if (A1s()) {
            ...
            if (accessibilityEvent != null) {
                iA00 = AbstractC5875Q0.A00(accessibilityEvent);
            }
            if (iA00 == 0) {
                iA00 = 0;
            }
    ...
    public final int A1B(View view) {
        AbstractC5956RK holder = A0F(view);
        if (holder != null) {
            return holder.A0O();
        }
        return -1;
    ...
    public final int A1C(AbstractC5956RK abstractC5956RK) {
        if (abstractC5956RK.A0o(IronSourceError.ERROR_PLACEMENT_CAPPED) || !abstractC5956RK.A0e()) {
            return -1;
        }
        return this.A00.A05(abstractC5956RK.A03);
    }
    ...
    public final AbstractC5956RK A1F(int i) {
        if (this.A0C) {
            return null;
        }
        int iA06 = this.A01.A06();
        AbstractC5956RK hidden = null;
        for (int i2 = 0; i2 < iA06; i2++) {
            AbstractC5956RK abstractC5956RKA0F = A0F(this.A01.A0A(i2));
            if (abstractC5956RKA0F != null && !abstractC5956RKA0F.A0g()) {
                int childCount = A1C(abstractC5956RKA0F);
                if (childCount != i) {
                    continue;
                } else if (this.A01.A0K(abstractC5956RKA0F.A0H)) {
                    hidden = abstractC5956RKA0F;
                } else {
    ...
    public final AbstractC5956RK A1G(int i) {
        return A1H(i, false);
    }
    ...
    public final AbstractC5956RK A1H(int i, boolean z) {
        int iA06 = this.A01.A06();
        AbstractC5956RK abstractC5956RK = null;
        for (int i2 = 0; i2 < iA06; i2++) {
            AbstractC5956RK holder = A0F(this.A01.A0A(i2));
    ...
    public final AbstractC5956RK A1I(View view) {
        ViewParent parent = view.getParent();
    ...
    public final void A1K() {
        ...
        C6974ht c6974ht = this.A00;
        String[] strArr = A19;
        if (strArr[0].charAt(14) != strArr[6].charAt(14)) {
            A19[1] = "cmOs2ngvAj3urs5G14jP2yS9Pox4PNUI";
            if (c6974ht.A0D(4) && !this.A00.A0D(11)) {
                AbstractC5820P4.A01(A0I(1341, 20, 44));
                A1L();
                A1M();
                this.A00.A08();
                if (!this.A0J) {
    ...
    public final void A1O() {
        if (!this.A0K && this.A0F) {
            AbstractC5857Ph.A0D(this, this.A0k);
            this.A0K = true;
        }
    }
    ...
    public final void A1Q() {
        ...
        for (int left = 0; left < iA05; left++) {
            ...
            AbstractC5956RK abstractC5956RKA1I = A1I(view);
            if (abstractC5956RKA1I != null && abstractC5956RKA1I.A07 != null) {
                View shadowingView = abstractC5956RKA1I.A07.A0H;
    ...
    public final void A1c(int i, int i2) {
        int iA02 = AbstractC5938R2.A02(i, getPaddingLeft() + getPaddingRight(), AbstractC5857Ph.A03(this));
        int paddingTop = getPaddingTop();
        int width = getPaddingBottom();
        int i3 = paddingTop + width;
        int width2 = AbstractC5857Ph.A02(this);
        setMeasuredDimension(iA02, AbstractC5938R2.A02(i2, i3, width2));
    }
    ...
    public final void A1h(AbstractC5943R7 abstractC5943R7) {
        if (this.A0m == null) {
            this.A0m = new ArrayList();
        }
        this.A0m.add(abstractC5943R7);
    }

    public final void A1i(AbstractC5943R7 abstractC5943R7) {
        if (this.A0m != null) {
            List<AbstractC5943R7> list = this.A0m;
            if (A19[7].length() != 1) {
                throw new RuntimeException();
            }
            String[] strArr = A19;
            ...
            list.remove(abstractC5943R7);
        }
    }

    public final void A1j(C5953RH c5953rh) {
        if (getScrollState() == 2) {
            OverScroller overScroller = this.A08.A01;
            c5953rh.A06 = overScroller.getFinalX() - overScroller.getCurrX();
            c5953rh.A07 = overScroller.getFinalY() - overScroller.getCurrY();
        } else {
            c5953rh.A06 = 0;
            c5953rh.A07 = 0;
        }
    ...
    public final void A1k(AbstractC5956RK abstractC5956RK, C5933Qx c5933Qx) {
        abstractC5956RK.A0a(0, 8192);
        if (this.A0s.A0E) {
            boolean zA0j = abstractC5956RK.A0j();
            if (A19[1].charAt(14) != '5') {
                throw new RuntimeException();
            }
            String[] strArr = A19;
            ...
            if (zA0j && !abstractC5956RK.A0g() && !abstractC5956RK.A0l()) {
                this.A0t.A08(A0C(abstractC5956RK), abstractC5956RK);
            }
        }
        this.A0t.A0F(abstractC5956RK, c5933Qx);
    }

    public final void A1l(AbstractC5956RK abstractC5956RK, C5933Qx c5933Qx, C5933Qx c5933Qx2) {
        abstractC5956RK.A0d(false);
        if (this.A05.A0O(abstractC5956RK, c5933Qx, c5933Qx2)) {
            A1O();
        }
    }

    public final void A1m(AbstractC5956RK abstractC5956RK, C5933Qx c5933Qx, C5933Qx c5933Qx2) {
        A0r(abstractC5956RK);
        abstractC5956RK.A0d(false);
        if (this.A05.A0P(abstractC5956RK, c5933Qx, c5933Qx2)) {
            A1O();
        }
    }
    ...
    public final boolean A1x(View view) {
        ...
        if (zA0L) {
            AbstractC5956RK viewHolder = A0F(view);
    ...
    public final boolean A1y(AbstractC5956RK abstractC5956RK) {
        return this.A05 == null || this.A05.A0S(abstractC5956RK, abstractC5956RK.A0R());
    }

    public final boolean A1z(AbstractC5956RK abstractC5956RK, int i) {
        if (A1s()) {
            abstractC5956RK.A02 = i;
            this.A0w.add(abstractC5956RK);
            return false;
        }
        AbstractC5857Ph.A09(abstractC5956RK.A0H, i);
        return true;
    }
    ...
    public final boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return (layoutParams instanceof C5939R3) && this.A06.A1a((C5939R3) layoutParams);
    }
    ...
    public final int computeVerticalScrollExtent() {
        ...
        return abstractC5938R2.A1k(this.A0s);
    }
  ...
  0x0199: PHI (r5v4 'padding' int) = (r5v3 'padding' int), (r5v3 'padding' int), (r5v7 'padding' int) binds: [B:49:0x00e1, B:53:0x0108, B:74:0x018f] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public final android.view.View focusSearch(android.view.View r11, int r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C47457M.focusSearch(android.view.View, int):android.view.View");
    }
    ...
    public AbstractC5926Qq getAdapter() {
        return this.A04;
    }
    ...
    public C6957hb getCompatAccessibilityDelegate() {
        return this.A09;
    }

    public AbstractC5934Qy getItemAnimator() {
        return this.A05;
    }

    public AbstractC5938R2 getLayoutManager() {
        return this.A06;
    }
    ...
    public AbstractC5941R5 getOnFlingListener() {
        return this.A0g;
    }
    ...
    public C5945R9 getRecycledViewPool() {
        return this.A0r.A0H();
    }
    ...
    private C5840PP getScrollingChildHelper() {
        if (this.A0d == null) {
            this.A0d = new C5840PP(this);
        }
        return this.A0d;
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.A0K = false;
        if (A1E) {
            this.A03 = RunnableC5914Qd.A07.get();
            RunnableC5914Qd runnableC5914Qd = this.A03;
            String[] strArr = A19;
            if (strArr[4].charAt(24) != strArr[5].charAt(24)) {
                throw new RuntimeException();
            }
            ...
            if (runnableC5914Qd == null) {
                this.A03 = new RunnableC5914Qd();
                Display displayA04 = AbstractC5857Ph.A04(this);
                float f = 60.0f;
                ...
                RunnableC5914Qd.A07.set(this.A03);
            }
            this.A03.A09(this);
        }
    }
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        AbstractC5820P4.A01(A0I(1330, 11, 34));
        A0Y();
        AbstractC5820P4.A00();
        this.A0D = true;
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (z) {
            ...
            if (this.A06.A21()) {
                ...
                abstractC5938R2.A13(iMakeMeasureSpec, View.MeasureSpec.makeMeasureSpec(widthMode4, 1073741824));
                this.A0s.A0A = true;
                A0M();
                if (A19[1].charAt(14) != '5') {
                    this.A06.A14(i, i2);
    ...
    public final void removeDetachedView(View view, boolean z) {
        AbstractC5956RK abstractC5956RKA0F = A0F(view);
        if (abstractC5956RKA0F != null) {
            if (abstractC5956RKA0F.A0i()) {
                abstractC5956RKA0F.A0V();
            } else if (!abstractC5956RKA0F.A0l()) {
                throw new IllegalArgumentException(A0I(Sdk.SDKError.Reason.MRAID_JS_COPY_FAILED_VALUE, 75, 84) + abstractC5956RKA0F + A1J());
            }
        }
        view.clearAnimation();
        A1g(view);
    ...
    public final void requestDisallowInterceptTouchEvent(boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            ArrayList<InterfaceC5942R6> arrayList = this.A13;
            int i2 = A19[7].length();
            if (i2 != 1) {
                throw new RuntimeException();
            }
    ...
    public void setAccessibilityDelegateCompat(C6957hb c6957hb) {
        this.A09 = c6957hb;
        AbstractC5857Ph.A0B(this, this.A09);
    }

    public void setAdapter(AbstractC5926Qq abstractC5926Qq) {
        setLayoutFrozen(false);
        A0q(abstractC5926Qq, false, true);
        requestLayout();
    }

    public void setChildDrawingOrderCallback(InterfaceC5929Qt interfaceC5929Qt) {
        if (interfaceC5929Qt == null) {
            return;
        }
        this.A0e = interfaceC5929Qt;
    ...
    public void setItemAnimator(AbstractC5934Qy abstractC5934Qy) {
        if (this.A05 != null) {
            this.A05.A0H();
            this.A05.A0J(null);
        }
        this.A05 = abstractC5934Qy;
        if (this.A05 != null) {
            this.A05.A0J(this.A0f);
        }
    }
    ...
    public void setLayoutManager(AbstractC5938R2 abstractC5938R2) {
        ...
        this.A01.A0B();
        this.A06 = abstractC5938R2;
        if (abstractC5938R2 != null) {
            if (abstractC5938R2.A03 == null) {
                this.A06.A1R(this);
                if (this.A0F) {
                    this.A06.A1P(this);
                }
            } else {
                throw new IllegalArgumentException(A0I(1109, 14, 42) + abstractC5938R2 + A0I(59, 39, 124) + abstractC5938R2.A03.A1J());
            }
        }
        this.A0r.A0O();
        requestLayout();
    ...
    public void setOnFlingListener(AbstractC5941R5 abstractC5941R5) {
        this.A0g = abstractC5941R5;
    }

    @Deprecated
    public void setOnScrollListener(AbstractC5943R7 abstractC5943R7) {
        this.A0i = abstractC5943R7;
    }
    ...
    public void setRecycledViewPool(C5945R9 c5945r9) {
        this.A0r.A0V(c5945r9);
    }

    public void setRecyclerListener(InterfaceC5947RB interfaceC5947RB) {
        this.A07 = interfaceC5947RB;
    }
    ...
    public void setViewCacheExtension(AbstractC5954RI abstractC5954RI) {
        this.A0r.A0W(abstractC5954RI);
    }
