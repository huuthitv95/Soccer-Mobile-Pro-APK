...
public abstract class AbstractC7423pU {
    ...
    public static int A00(@CheckForNull List<?> list, Object element) {
        ...
        while (listIterator.hasNext()) {
            if (AbstractC5025CB.A01(element, listIterator.next())) {
    ...
    public static int A01(@CheckForNull List<?> list, Object element) {
        ...
        while (listIterator.hasPrevious()) {
            if (AbstractC5025CB.A01(element, listIterator.previous())) {
    ...
    public static <E> ArrayList<E> A05(Iterator<? extends E> elements) {
        ...
        AbstractC7402p9.A0A(list, elements);
        return list;
    }

    public static boolean A06(@CheckForNull List<?> thisList, Object other) {
        if (other == AbstractC7142ki.A04(thisList)) {
            return true;
        }
        ...
        if (z && (list instanceof RandomAccess)) {
            for (int i = 0; i < size; i++) {
                if (!AbstractC5025CB.A01(thisList.get(i), list.get(i))) {
                    return false;
                }
            }
            return true;
        }
        return AbstractC7402p9.A0F(thisList.iterator(), list.iterator());
    }
}
