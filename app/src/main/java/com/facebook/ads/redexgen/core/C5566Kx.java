...
public final class C5566Kx implements InterfaceC6324XN {
    public static byte[] A0B;
    public int A00;
    public int A01;
    public int A02;
    public AbstractC6400Yb A03;
    public String A04;
    public String A05;
    public ViewOnClickListenerC5560Kr A06;
    ...
    public C5566Kx(int i, int i2, int i3, String str, String str2, AbstractC6400Yb abstractC6400Yb, ViewOnClickListenerC5560Kr viewOnClickListenerC5560Kr) {
        this.A01 = i;
        this.A00 = i2;
        this.A02 = i3;
        this.A05 = str;
        this.A04 = str2;
        this.A03 = abstractC6400Yb;
        ...
        if (!this.A09 && this.A03 != null) {
            if (this.A01 == 1) {
                if (!this.A0A) {
                    ...
                    this.A03.setProgressClickListener(new ViewOnClickListenerC6572bN(this));
                    this.A03.A0B();
                    this.A03.setToolbarListener(new C5580LB(this));
                    this.A0A = true;
                ...
                if (f <= this.A02) {
                    if (!this.A08) {
                        ...
                        if (this.A07 == null || this.A07.intValue() == 4) {
                            ...
                            this.A03.setProgressImage(EnumC6385YM.CROSS);
                            this.A03.setToolbarActionMode(6);
                        }
                    }
