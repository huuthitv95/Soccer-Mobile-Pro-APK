...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.95 */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C484795 {
    ...
    public boolean A0T;
    public boolean A0U;
    public final InterfaceC484593 A0V;
    ...
    public C484795(InterfaceC484593 interfaceC484593) {
        this.A0V = (InterfaceC484593) AbstractC45353y.A01(interfaceC484593);
        if (AbstractC46115C.A02 >= 18) {
            try {
    ...
    private long A00() {
        ...
        if (this.A0M != -9223372036854775807L) {
            ...
            long jA0Q = AbstractC46115C.A0Q(elapsedTimeSinceStopUs, this.A00);
    ...
    private void A04() {
        ...
        if (playbackPositionUs - systemTimeUs >= WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS) {
            ...
            long[] jArr = this.A0W;
            int i2 = this.A02;
            long systemTimeUs2 = AbstractC46115C.A0R(jA01, this.A00);
    ...
    private void A07(long j) {
        C484492 c484492 = (C484492) AbstractC45353y.A01(this.A0O);
        if (!c484492.A07(j)) {
            return;
        }
        long jA02 = c484492.A02();
        long jA01 = c484492.A01();
    ...
    private void A08(long j) {
        if (this.A0R && this.A0P != null && j - this.A09 >= 500000) {
            try {
                this.A0E = (((long) ((Integer) AbstractC46115C.A0f((Integer) this.A0P.invoke(AbstractC45353y.A01(this.A0N), new Object[0]))).intValue()) * 1000) - this.A06;
    ...
    private void A09(long j) {
        AudioTrack audioTrack = (AudioTrack) AbstractC45353y.A01(this.A0N);
        ...
        int state3 = AbstractC46115C.A02;
        if (state3 <= 29) {
    ...
    private boolean A0A() {
        return this.A0T && ((AudioTrack) AbstractC45353y.A01(this.A0N)).getPlayState() == 2 && A00() == 0;
    }

    public static boolean A0B(int i) {
        return AbstractC46115C.A02 < 23 && (i == 5 || i == 6);
    }
    ...
    public final long A0D(boolean z) {
        long jA0Q;
        if (((AudioTrack) AbstractC45353y.A01(this.A0N)).getPlayState() == 3) {
            A04();
        }
        long jNanoTime = System.nanoTime() / 1000;
        C484492 c484492 = (C484492) AbstractC45353y.A01(this.A0O);
        boolean useGetTimestampMode = c484492.A06();
        if (useGetTimestampMode) {
            jA0Q = A02(c484492.A01()) + AbstractC46115C.A0Q(jNanoTime - c484492.A02(), this.A00);
        } else {
            int i = this.A05;
            if (A0Y[0].charAt(8) != '9') {
                throw new RuntimeException();
            ...
            if (i == 0) {
                ...
                jA0Q = AbstractC46115C.A0Q(this.A0K + jNanoTime, this.A00);
            }
            if (!z) {
        ...
        if (j < 1000000) {
            long jA0Q2 = this.A0G + AbstractC46115C.A0Q(j, this.A00);
            long j2 = (j * 1000) / 1000000;
            jA0Q = ((jA0Q * j2) + ((1000 - j2) * jA0Q2)) / 1000;
        }
        if (!this.A0U && jA0Q > this.A0B) {
            this.A0U = true;
            this.A0V.AFN(System.currentTimeMillis() - AbstractC46115C.A0P(AbstractC46115C.A0R(AbstractC46115C.A0P(jA0Q - this.A0B), this.A00)));
        }
        this.A0D = jNanoTime;
        this.A0B = jA0Q;
    ...
    public final void A0F() {
        ((C484492) AbstractC45353y.A01(this.A0O)).A05();
    }

    public final void A0G(float f) {
        this.A00 = f;
        if (this.A0O != null) {
            C484492 c484492 = this.A0O;
            String[] strArr = A0Y;
    ...
    public final void A0I(AudioTrack audioTrack, boolean z, int i, int i2, int i3) {
        ...
        this.A03 = i2;
        this.A01 = i3;
        this.A0O = new C484492(audioTrack);
        this.A04 = audioTrack.getSampleRate();
        this.A0T = z && A0B(i);
        this.A0R = AbstractC46115C.A15(i);
    ...
    public final boolean A0J() {
        return ((AudioTrack) AbstractC45353y.A01(this.A0N)).getPlayState() == 3;
    }
    ...
    public final boolean A0N(long j) {
        int playState = ((AudioTrack) AbstractC45353y.A01(this.A0N)).getPlayState();
        if (this.A0T) {
            if (playState == 2) {
                this.A0Q = false;
                String[] strArr = A0Y;
        ...
        if (hadData && !this.A0Q && playState != 1) {
            this.A0V.AGI(this.A01, AbstractC46115C.A0P(this.A06));
        }
        return true;
    }
}
