...
public final class C7191lW implements InterfaceC5564Kv {
    ...
    public long A04;
    public C7472qI A05;
    public InterfaceC5361Hd A06;
    public String A07;
    public boolean A08;
    public final C45934u A09;
    ...
    public C7191lW(String str) {
        this.A09 = new C45934u(new byte[128]);
        this.A0A = new C45944v(this.A09.A00);
        this.A02 = 0;
    ...
    private void A01() {
        C44672p c44672pA0j;
        this.A09.A08(0);
        C5312Gq c5312GqA09 = AbstractC5313Gr.A09(this.A09);
        if (this.A05 != null) {
            int i = c5312GqA09.A01;
            int i2 = this.A05.A06;
            String[] strArr = A0D;
            ...
            if (i == i2) {
                ...
                if (i3 != this.A05.A0G || !AbstractC46115C.A1E(c5312GqA09.A06, this.A05.A0W)) {
                    c44672pA0j = new C44672p().A0y(this.A07).A11(c5312GqA09.A06).A0b(c5312GqA09.A01).A0m(c5312GqA09.A04).A10(this.A0B).A0j(c5312GqA09.A00);
                    if (A00(0, 9, 31).equals(c5312GqA09.A06)) {
                        c44672pA0j.A0a(c5312GqA09.A00);
                    }
                    this.A05 = c44672pA0j.A14();
        ...
        this.A01 = c5312GqA09.A02;
        this.A03 = (((long) c5312GqA09.A03) * 1000000) / ((long) this.A05.A0G);
    }

    private boolean A03(C45944v c45944v) {
        while (true) {
            if (c45944v.A07() <= 0) {
                return false;
            }
    ...
    private boolean A04(C45944v c45944v, byte[] bArr, int i) {
            ...
            if (strArr[0].length() != strArr[5].length()) {
                ...
                switch (i) {
                    case 0:
                        if (A03(c45944v)) {
                            this.A02 = 1;
                            this.A0A.A0l()[0] = Ascii.f22503VT;
                            this.A0A.A0l()[1] = 119;
                            this.A00 = 2;
                        }
                        break;
                    case 1:
                        if (A04(c45944v, this.A0A.A0l(), 128)) {
                            A01();
                            this.A0A.A0f(0);
    ...
    public final void A5c(InterfaceC5332HA interfaceC5332HA, C5585LG c5585lg) {
        c5585lg.A05();
        this.A07 = c5585lg.A04();
        this.A06 = interfaceC5332HA.AKS(c5585lg.A03(), 1);
    }
