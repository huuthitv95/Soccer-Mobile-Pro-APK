...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.5i */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C46435i {
    public static byte[] A0B;

    @MetaExoPlayerCustomization
    public static final C46435i A0C;
    ...
    public C46435i(Uri uri, long j, int i, byte[] bArr, Map<String, String> map, long j2, long j3, String str, int i2, C5652ML c5652ml) {
        boolean z = true;
        AbstractC45353y.A07(j + j2 >= 0);
    ...
    static {
        A03();
        C448335.A03(A02(24, 19, 23));
        A0C = new C46435i(Uri.parse(A02(43, 16, 34)));
    }

    public C46435i(Uri uri) {
        this(uri, 0, -1);
    }

    @MetaExoPlayerCustomization
    @Deprecated
    public C46435i(Uri uri, int i, int i2) {
        this(uri, 0L, 1, null, Collections.emptyMap(), 0L, -1L, null, i, new C5652ML(A02(0, 0, 9), -1L, false, -1, -1, -1, -1, false, false, i2, -1L, new C5651MK(), false, -1, -1, -1L, -1L, -1, null, -1, null, null, C5650MJ.A02, -1, false, null, A02(0, 0, 9), A02(0, 0, 9), null, -1L, -1L));
    }

    @MetaExoPlayerCustomization("creation and passage of FbDataSpecExtension")
    @Deprecated
    public C46435i(Uri uri, long j, long j2, String str) {
        this(uri, 0L, 1, null, Collections.emptyMap(), j, j2, str, 0, new C5652ML());
    }
    ...
    public final C46405f A04() {
        return new C46405f(this);
    }

    @MetaExoPlayerCustomization("Replacement of customData Object with fbDataSpecExtension + new copy creation")
    public final C46435i A05(long j, long j2) {
        if (j == 0 && this.A03 == j2) {
            return this;
        }
        return new C46435i(this.A06, this.A05, this.A01, this.A0A, this.A09, this.A04 + j, j2, this.A08, this.A00, new C5652ML(this.A07));
    }
