...
public class C5949RD {
    ...
    public C5949RD(int i, int i2) {
        this(i, i2, Integer.MIN_VALUE, null);
    }

    public C5949RD(int i, int i2, int i3, Interpolator interpolator) {
        this.A04 = -1;
        this.A06 = false;
        this.A00 = 0;
        this.A02 = i;
    ...
    public final void A05(C47457M c47457m) {
        if (this.A04 >= 0) {
            int i = this.A04;
            this.A04 = -1;
            c47457m.A1U(i);
        ...
        if (this.A06) {
            ...
            if (interpolator == null) {
                if (this.A01 == Integer.MIN_VALUE) {
                    c47457m.A08.A0A(this.A02, this.A03);
                } else {
                    RunnableC5955RJ runnableC5955RJ = c47457m.A08;
                    int i2 = this.A02;
                    int i3 = this.A03;
                    if (A08[1].length() != 25) {
                        runnableC5955RJ.A0B(i2, i3, this.A01);
                    } else {
                        String[] strArr2 = A08;
                ...
                c47457m.A08.A0C(this.A02, this.A03, this.A01, this.A05);
            }
            this.A00++;
            if (this.A00 > 10) {
