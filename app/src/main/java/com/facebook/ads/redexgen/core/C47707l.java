...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.7l */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C47707l extends AbstractC7077jd implements Serializable {
    ...
    public C47707l(List<C5719NR> list) {
        super(list);
    }

    public static C47707l A00(JSONObject jSONObject, C6902gi c6902gi) {
        C47707l c47707l = new C47707l(AbstractC7077jd.A08(jSONObject, c6902gi, new C7060jK()));
        c47707l.A2I(jSONObject);
        c47707l.A1N(A01(0, 14, 106));
        return c47707l;
    }
    ...
    public final int A0o() {
        ...
        C5742No c5742NoA07 = A29().A0H().A07();
        String[] strArr = A01;
        if (strArr[2].charAt(16) == strArr[1].charAt(16)) {
            throw new RuntimeException();
        }
