...
public final class C7496qk {
    ...
    public /* synthetic */ C7496qk(AbstractC7487qZ abstractC7487qZ) {
        this();
    }
    ...
    public static void A01() {
        A00 = new byte[]{-104, -74, -104, -20, -25, -63, -26, -36, -35, -16, -78, -104, -105, -117, -34, -44, -27, -48, -91, -117, -64, -76, 8, 3, -35, 2, -8, -7, Ascii.f22492FF, -50, -76, -19, Ascii.DLE, Ascii.f22493FS, Ascii.f22491EM, Ascii.ETB, -13, Ascii.CAN, Ascii.f22500SO, Ascii.f22499SI, 34, -28, -54, 43, 48, 38, 39, 58, -4, -30, 49, 54, 42, 39, 52};
    }
    ...
    public final int A02(Collection<?> collection) {
        C7486qY.A09(collection, A00(31, 1, 39));
        int i = 1;
    ...
    public final boolean A06(Collection<?> collection, Collection<?> collection2) {
        C7486qY.A09(collection, A00(31, 1, 39));
        C7486qY.A09(collection2, A00(50, 5, 95));
        ...
        while (it2.hasNext()) {
            if (!C7486qY.A0C(it2.next(), it.next())) {
                return false;
            }
        }
        return true;
