...
public final class C7120kL extends C5666MZ {
  ...
  0x00aa: PHI (r8v2 long) = (r8v0 long), (r8v3 long) binds: [B:30:0x00d7, B:25:0x00a8] A[DONT_GENERATE, DONT_INLINE]] */
     ...
     */
    public static C7120kL A01(File file, long j, long j2, C5675Mi c5675Mi) {
        String strA0F;
        long j3;
        long j4 = j2;
        long length = j;
        ...
        if (!matcher.matches() || (strA0F = c5675Mi.A0F(Integer.parseInt((String) AbstractC45353y.A01(matcher.group(1))))) == null) {
            return null;
        }
        if (length == -1) {
            length = file.length();
        ...
        if (A01[7].charAt(17) != 'N') {
            ...
            j3 = Long.parseLong((String) AbstractC45353y.A01(strGroup));
            if (j4 == -9223372036854775807L) {
                j4 = Long.parseLong((String) AbstractC45353y.A01(matcher.group(3)));
            }
        } else {
        ...
        return new C7120kL(strA0F, j3, length, j4, file);
    }
    ...
    public static void A08() {
        A00 = new byte[]{93, -93, -21, -88, -93, -38, -19, -28, -28, -82, -76, -79, -81, -30, -76, -82, -30, -22, -79, -81, -30, -76, -82, -30, -22, -79, -81, -30, -76, -4, -73, -30, -76, -21, -2, -11, -86, -13, -67, -61, -64, -66, -15, -61, -67, -15, -7, -64, -66, -15, -61, -67, -15, -7, -64, -66, -15, -61, Ascii.f22503VT, -57, -15, -61, -6, Ascii.f22490CR, 4, -71, -40, -94, -42, -34, -91, -93, -42, -88, -94, -42, -34, -91, -93, -42, -88, -94, -42, -34, -91, -93, -42, -88, -16, -83, -42, -88, -33, -14, -23, -98};
    }
    ...
    public C7120kL(String str, long j, long j2, long j3, File file) {
        super(str, j, j2, j3, file);
    }

    public static C7120kL A02(File file, long j, C5675Mi c5675Mi) {
        return A01(file, j, -9223372036854775807L, c5675Mi);
    }

    public static C7120kL A03(String str, long j) {
        return new C7120kL(str, j, -1L, -9223372036854775807L, null);
    }

    public static C7120kL A04(String str, long j, long j2) {
        return new C7120kL(str, j, j2, -9223372036854775807L, null);
    }
    ...
    public static File A06(File file, C5675Mi c5675Mi) {
        String strA0l = null;
        String name = file.getName();
        Matcher matcher = A03.matcher(name);
        if (matcher.matches()) {
            String key = matcher.group(1);
            strA0l = AbstractC46115C.A0l((String) AbstractC45353y.A01(key));
        } else {
            matcher = A02.matcher(name);
            if (matcher.matches()) {
                String key2 = matcher.group(1);
                Object objA01 = AbstractC45353y.A01(key2);
                String[] strArr = A01;
        ...
        File file2 = (File) AbstractC45353y.A02(file.getParentFile());
        int iA0B = c5675Mi.A0B(strA0l);
        String key3 = matcher.group(2);
        long j = Long.parseLong((String) AbstractC45353y.A01(key3));
        String key4 = matcher.group(3);
        File fileA05 = A05(file2, iA0B, j, Long.parseLong((String) AbstractC45353y.A01(key4)));
    ...
    public final C7120kL A09(File file, long j) {
        AbstractC45353y.A08(this.A05);
        return new C7120kL(this.A04, this.A02, this.A01, j, file);
    }
}
