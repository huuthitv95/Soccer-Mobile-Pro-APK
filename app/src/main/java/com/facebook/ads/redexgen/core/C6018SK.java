...
public final class C6018SK {
    ...
    public C6018SK(C6902gi c6902gi, AudienceNetworkActivity audienceNetworkActivity) {
        this.A02 = c6902gi;
    ...
    public final C6750eF A03(Intent intent, RelativeLayout relativeLayout) {
        ...
        if (stringExtra != null) {
            ...
            C6750eF c6750eFA01 = AbstractC6749eE.A01(c6902gi, stringExtra);
            if (c6750eFA01 != null) {
                relativeLayout.addView(c6750eFA01, new RelativeLayout.LayoutParams(-1, -1));
            }
            return c6750eFA01;
        }
        return null;
    ...
    public final void A04() {
        if (C6171Up.A2J(this.A01)) {
            A02(16777216, 16777216);
        }
    }

    public final void A05() {
        if (this.A00 != null && C6171Up.A1C(this.A01)) {
            this.A00.A07();
        }
    }

    public final void A06() {
        if (C6171Up.A2R(this.A01)) {
            A02(128, 128);
        }
    }

    public final void A07(Intent intent, EnumC6262WK enumC6262WK, RelativeLayout relativeLayout) {
        if (C6171Up.A1C(this.A01)) {
            EnumC6262WK enumC6262WK2 = EnumC6262WK.A03;
            if (A04[1].length() == 14) {
                throw new RuntimeException();
            }
            A04[7] = "MXPR3PNgo3gwYNs9J3I1TINqSxswEDcD";
            if (enumC6262WK != enumC6262WK2) {
                this.A00 = new C6555b6();
                this.A00.A0C(intent.getStringExtra(A00(18, 11, 93)));
                C6555b6 c6555b6 = this.A00;
                String placementId = this.A01.getPackageName();
                c6555b6.A0B(placementId);
                long longExtra = intent.getLongExtra(A00(29, 11, 45), 0L);
                if (longExtra != 0) {
                    C6555b6 c6555b7 = this.A00;
                    String[] strArr = A04;
                    if (strArr[3].charAt(3) == strArr[4].charAt(3)) {
                        throw new RuntimeException();
                    }
                    ...
                    c6555b7.A09(longExtra);
                }
                TextView textView = new TextView(this.A01);
                String placementId2 = A00(0, 5, 6);
                textView.setText(placementId2);
                textView.setTextColor(-1);
                AbstractC6374YB.A0N(textView, Color.argb(160, 0, 0, 0));
                textView.setPadding(5, 5, 5, 5);
                RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
                layoutParams.addRule(12, -1);
                layoutParams.addRule(11, -1);
                textView.setLayoutParams(layoutParams);
                ViewOnLongClickListenerC5988Rq viewOnLongClickListenerC5988Rq = new ViewOnLongClickListenerC5988Rq(this.A00, relativeLayout);
                textView.setOnLongClickListener(viewOnLongClickListenerC5988Rq);
                relativeLayout.setOnLongClickListener(viewOnLongClickListenerC5988Rq);
                relativeLayout.getOverlay().add(this.A00);
            }
        }
    }

    public final void A08(EnumC6262WK enumC6262WK, boolean z) {
        if (C6171Up.A2w(this.A02)) {
            EnumC6262WK enumC6262WK2 = EnumC6262WK.A03;
            if (A04[6].length() != 28) {
                throw new RuntimeException();
            }
            A04[7] = "F6KEK3QPfCxrYVAsBDZ1FiU7CVmTBzj2";
            if (enumC6262WK == enumC6262WK2 && z) {
                String[] strArr = A04;
