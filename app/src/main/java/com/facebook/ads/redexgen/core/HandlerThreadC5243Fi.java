...
public class HandlerThreadC5243Fi extends HandlerThread implements Handler.Callback {
    ...
    public static void A02() {
        A05 = new byte[]{Ascii.f22490CR, 60, 36, 36, 48, Ascii.SUB, 60, 59, 47, 40, 42, 44, 58, Ascii.f22494GS, Ascii.NAK, Ascii.DLE, Ascii.f22491EM, Ascii.CAN, 92, 8, 19, 92, Ascii.NAK, Ascii.DC2, Ascii.NAK, 8, Ascii.NAK, Ascii.f22494GS, Ascii.DLE, Ascii.NAK, 6, Ascii.f22491EM, 92, Ascii.CAN, 9, 17, 17, 5, 92, Ascii.f22499SI, 9, Ascii.f22500SO, Ascii.SUB, Ascii.f22494GS, Ascii.f22502US, Ascii.f22491EM, 94, 121, 113, 116, 125, 124, 56, 108, 119, 56, 106, 125, 116, 125, 121, 107, 125, 56, 124, 109, 117, 117, 97, 56, 107, 109, 106, 126, 121, 123, 125, 49, 32, 56, 56, 44, 6, 32, 39, 51, 52, 54, 48};
    }
    ...
    public HandlerThreadC5243Fi() {
        super(A00(77, 12, 62));
    }

    private void A01() {
        AbstractC45353y.A01(this.A01);
        this.A01.A08();
    }
    ...
    public final DummySurface A04(int i) {
        ...
        this.A01 = new RunnableC45534G(this.A00);
        boolean z = false;
        synchronized (this) {
        ...
        if (this.A04 == null) {
            if (this.A03 == null) {
                return (DummySurface) AbstractC45353y.A01(this.A02);
            }
            throw this.A03;
        }
        throw this.A04;
            ...
            switch (message.what) {
                case 1:
                    try {
                        ...
                        AbstractC45794g.A08(A00(0, 12, 34), A00(12, 34, 23), e);
                        this.A03 = e;
                        synchronized (this) {
                            notify();
                        }
                    } catch (RuntimeException e2) {
                        AbstractC45794g.A08(A00(0, 12, 34), A00(12, 34, 23), e2);
                        this.A04 = e2;
                        synchronized (this) {
                            notify();
                            break;
                ...
                case 2:
                    try {
                        ...
                        try {
                            AbstractC45794g.A08(A00(0, 12, 34), A00(46, 31, 115), th);
                        } finally {
                            quit();
                        }
                        break;
