...
public final class C5880Q5 {
    ...
    public final Bitmap A02(Bitmap bitmap, float f) {
        ...
        try {
            ...
            int i = AbstractC6388YP.A00;
            ArrayList arrayList = new ArrayList(i);
            ArrayList<JavaBlurProcess.BlurTask> vertical = new ArrayList<>(i);
            for (int i2 = 0; i2 < i; i2++) {
                int h2 = h;
                int cores = i2;
                arrayList.add(new CallableC6387YO(iArr, w, h2, (int) f, i, cores, 1));
                h = h2;
                int cores2 = i2;
                vertical.add(new CallableC6387YO(iArr, w, h, (int) f, i, cores2, 2));
            }
            try {
                AbstractC6388YP.A01.invokeAll(arrayList);
                try {
                    AbstractC6388YP.A01.invokeAll(vertical);
                    try {
