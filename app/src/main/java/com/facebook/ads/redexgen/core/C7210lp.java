...
public class C7210lp<V> extends AbstractCollection<V> {
    ...
    public final /* synthetic */ AbstractC44392L A04;
    ...
    public final boolean addAll(Collection<? extends V> collection) {
        ...
        if (zAddAll) {
            AbstractC44392L.A02(this.A04, this.A00.size() - size);
            if (size == 0) {
                A03();
            }
        }
    ...
    public C7210lp(@ParametricNullness final AbstractC44392L this$0, @CheckForNull Object key, Collection delegate, C7210lp ancestor) {
        this.A04 = this$0;
        this.A02 = key;
        this.A00 = delegate;
        this.A01 = ancestor;
    ...
    public final void clear() {
        ...
        this.A00.clear();
        AbstractC44392L.A03(this.A04, size);
        A05();
    }
    ...
    public final boolean retainAll(Collection<?> c) {
        AbstractC7142ki.A04(c);
        int size = size();
        boolean zRetainAll = this.A00.retainAll(c);
        if (zRetainAll) {
            int size2 = this.A00.size();
            AbstractC44392L abstractC44392L = this.A04;
            int i = size2 - size;
            String[] strArr = A05;
            String str = strArr[0];
            ...
            AbstractC44392L.A02(abstractC44392L, i);
            A05();
        }
        return zRetainAll;
    }
