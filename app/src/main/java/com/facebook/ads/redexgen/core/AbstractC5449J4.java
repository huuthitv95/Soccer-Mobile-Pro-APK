...
public abstract class AbstractC5449J4 {
    ...
    public static C5448J3 A00(int i, long[] jArr, int[] iArr, long j) {
        int chunkSamplesRemaining = 8192 / i;
        int iA05 = 0;
        for (int i2 : iArr) {
            iA05 += AbstractC46115C.A05(i2, chunkSamplesRemaining);
        }
        ...
        if (maxSampleCount != str2.length()) {
            ...
            while (true) {
                ...
                if (i4 < rechunkedSampleCount) {
                    ...
                    return new C5448J3(jArr2, iArr2, originalSampleIndex, timestamps, flags, j * ((long) i3));
                }
            }
        }
        throw new RuntimeException();
