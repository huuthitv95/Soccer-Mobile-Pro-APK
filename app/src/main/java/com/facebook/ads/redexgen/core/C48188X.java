...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.8X */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C48188X implements InterfaceC7236mF {
    ...
    public static Pair<Long, Long> A00(long j, long[] jArr, long[] jArr2) {
        int iA0L = AbstractC46115C.A0L(jArr, j, true, true);
        long j2 = jArr[iA0L];
        long j3 = jArr2[iA0L];
        int i = iA0L + 1;
        if (i == jArr.length) {
    ...
    public C48188X(long[] jArr, long[] jArr2, long j) {
        this.A01 = jArr;
        this.A02 = jArr2;
        this.A00 = j == -9223372036854775807L ? AbstractC46115C.A0O(jArr2[jArr2.length - 1]) : j;
    }

    public static C48188X A01(long j, MlltFrame mlltFrame, long j2) {
        ...
        return new C48188X(jArr, jArr2, j2);
    }
    ...
    public final C5355HX A91(long j) {
        Pair<Long, Long> pairA00 = A00(AbstractC46115C.A0P(AbstractC46115C.A0T(j, 0L, this.A00)), this.A02, this.A01);
        return new C5355HX(new C5357HZ(AbstractC46115C.A0O(((Long) pairA00.first).longValue()), ((Long) pairA00.second).longValue()));
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC7236mF
    public final long A9H(long j) {
        Pair<Long, Long> positionAndTimeMs = A00(j, this.A01, this.A02);
        return AbstractC46115C.A0O(((Long) positionAndTimeMs.second).longValue());
    }
