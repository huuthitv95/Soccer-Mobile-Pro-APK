...
public final class C6272WV implements InterfaceC6190V8 {
    ...
    static {
        A05();
        A04 = C6272WV.class.getSimpleName();
    }

    public C6272WV(C6898ge c6898ge, InterfaceC6442ZH interfaceC6442ZH) {
        this.A00 = c6898ge;
        this.A01 = interfaceC6442ZH;
    }

    public static JSONArray A01(C6898ge c6898ge, JSONArray jSONArray, JSONArray jSONArray2) {
        int i = 0;
        if (jSONArray != null) {
        ...
        return A02(c6898ge, jSONArray, jSONArray2, i);
    }

    public static JSONArray A02(C6898ge c6898ge, JSONArray jSONArray, JSONArray jSONArray2, int i) {
        if (jSONArray == null) {
            return jSONArray2;
        }
        if (jSONArray2 == null) {
    ...
    private JSONObject A03() {
        ...
        if (AbstractC6173Ur.A0P(this.A00) && (jSONArrayA03 = C6100Tf.A03(this.A00)) != null && jSONArrayA03.length() > 0) {
            C6898ge c6898ge = this.A00;
            if (A03[2].length() != 5) {
                throw new RuntimeException();
            }
            String[] strArr = A03;
            ...
            jSONArrayA6s = A01(c6898ge, jSONArrayA03, jSONArrayA6s);
        }
        JSONObject jSONObject = null;
        String[] strArr2 = A03;
    ...
    private JSONObject A04(int i) {
        ...
        if (AbstractC6173Ur.A0P(this.A00) && (jSONArrayA04 = C6100Tf.A04(this.A00, (iA08 = AbstractC6173Ur.A08(this.A00)))) != null && jSONArrayA04.length() > 0) {
    ...
    public final JSONObject A5L() {
        int eventLimit = AbstractC6173Ur.A0F(this.A00);
        return eventLimit > 0 ? A04(eventLimit) : A03();
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC6190V8
    public final boolean AAb() {
        int eventCount = AbstractC6173Ur.A0F(this.A00);
        if (eventCount < 1) {
            return false;
        }
        int iA82 = this.A01.A82();
        int eventLimit = C6100Tf.A00(this.A00);
        return iA82 + eventLimit > eventCount;
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC6190V8
    public final void ACu() {
        int iA50 = this.A01.A50(AbstractC6173Ur.A0G(this.A00));
        if (iA50 > 0) {
            this.A00.A08().ABC(A00(379, 8, 37), AbstractC6098Td.A10, new C6099Te(A00(28, 44, 62) + iA50));
        }
        ...
        for (int errorCode = 0; errorCode < jSONArray.length(); errorCode++) {
            try {
                ...
                if (A00(393, 26, 39).equals(eventId)) {
                    C6171Up.A0V(this.A00).A36(jSONObject.getString(A00(419, 14, 16)));
                    this.A00.A04().ACP();
                } else {
