...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.Y1 */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C6364Y1 {
    ...
    public static final InterfaceC6363Y0 A02 = null;
    ...
    public static String A03(double d) throws Exception {
        try {
            ...
            String simpleName = C6364Y1.class.getSimpleName();
            if (A01[3].length() == 20) {
