...
public final class C7181lM implements InterfaceC5564Kv {
    ...
    public boolean A09;
    public boolean A0A;
    public final C45944v A0B;
    public final C5565Kw A0C;
    public final C5573L4 A0D;
    public final C5588LJ A0E;
    public final boolean[] A0F;

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static Pair<C7472qI, Long> A00(C5565Kw c5565Kw, String str) {
        byte[] bArrCopyOf = Arrays.copyOf(c5565Kw.A02, c5565Kw.A00);
        ...
        C7472qI c7472qIA14 = new C44672p().A0y(str).A11(A01(0, 11, 62)).A0r(i3).A0f(i4).A0Y(f).A12(Collections.singletonList(bArrCopyOf)).A14();
        long j = 0;
        int i5 = (bArrCopyOf[7] & Ascii.f22499SI) - 1;
        if (i5 >= 0 && i5 < A0I.length) {
            double d = A0I[i5];
            int i6 = c5565Kw.A01;
            int i7 = (bArrCopyOf[i6 + 9] & 96) >> 5;
            int i8 = bArrCopyOf[i6 + 9] & Ascii.f22502US;
            if (i7 != i8) {
                double d2 = i7;
                if (A0H[2].charAt(3) == 'k') {
                    String[] strArr = A0H;
        ...
        return Pair.create(c7472qIA14, Long.valueOf(j));
    }
    ...
    public C7181lM(C5588LJ c5588lj) {
        this.A0E = c5588lj;
        this.A0F = new boolean[4];
        this.A0C = new C5565Kw(128);
        if (c5588lj != null) {
            this.A0D = new C5573L4(178, 128);
            this.A0B = new C45944v();
        } else {
            this.A0D = null;
            this.A0B = null;
        }
    ...
    public final void A5A(C45944v c45944v) {
        ...
        this.A04 += (long) c45944v.A07();
        this.A05.AIr(c45944v, c45944v.A07());
        while (true) {
            int iA04 = AbstractC5350HS.A04(bArrA0l, iA09, iA0A, this.A0F);
            if (iA04 == iA0A) {
                boolean z = this.A07;
                String[] strArr = A0H;
            ...
            if (!this.A07) {
                ...
                if (this.A0C.A02(i, i2 < 0 ? -i2 : 0)) {
                    Pair<C7472qI, Long> pairA00 = A00(this.A0C, (String) AbstractC45353y.A01(this.A06));
                    this.A05.A6e((C7472qI) pairA00.first);
            ...
            if (this.A0D != null) {
                ...
                if (this.A0D.A04(i3)) {
                    ((C45944v) AbstractC46115C.A0f(this.A0B)).A0j(this.A0D.A01, AbstractC5350HS.A02(this.A0D.A01, this.A0D.A00));
                    ((C5588LJ) AbstractC46115C.A0f(this.A0E)).A02(this.A03, this.A0B);
                }
                if (i == 178 && c45944v.A0l()[iA04 + 2] == 1) {
                    this.A0D.A01(i);
                }
            }
            if (i == 0 || i == 179) {
    ...
    public final void A5c(InterfaceC5332HA interfaceC5332HA, C5585LG c5585lg) {
        ...
        this.A05 = interfaceC5332HA.AKS(c5585lg.A03(), 2);
        if (this.A0E != null) {
            this.A0E.A03(interfaceC5332HA, c5585lg);
        }
    }
    ...
    public final void AJ5() {
        AbstractC5350HS.A0H(this.A0F);
        this.A0C.A00();
        if (this.A0D != null) {
            C5573L4 c5573l4 = this.A0D;
            if (A0H[1].length() != 32) {
                throw new RuntimeException();
            }
