...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.19 */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C436519<K, V> extends AbstractC44392L<K, V>.SortedAsMap implements NavigableMap<K, Collection<V>> {
    ...
    private final Map.Entry<K, Collection<V>> A01(Iterator<Map.Entry<K, Collection<V>>> entryIterator) {
        ...
        return AbstractC7442po.A01(next.getKey(), this.A00.A0G(collectionA0D));
    }
    ...
    public C436519(final AbstractC44392L this$0, NavigableMap<K, Collection<V>> submap) {
        super(this$0, submap);
        this.A00 = this$0;
    }
    ...
    public final NavigableSet<K> A0C() {
        return new C43500u(this.A00, A0B());
    }
    ...
    public final NavigableMap<K, Collection<V>> descendingMap() {
        return new C436519(this.A00, A0B().descendingMap());
    }
    ...
    public final NavigableMap<K, Collection<V>> headMap(@ParametricNullness K toKey, boolean inclusive) {
        return new C436519(this.A00, A0B().headMap(toKey, inclusive));
    }
    ...
    public final NavigableMap<K, Collection<V>> subMap(@ParametricNullness K fromKey, @ParametricNullness boolean fromInclusive, K toKey, boolean toInclusive) {
        return new C436519(this.A00, A0B().subMap(fromKey, fromInclusive, toKey, toInclusive));
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.19 != com.google.common.collect.AbstractMapBasedMultimap<K, V>$NavigableAsMap */
    @Override // java.util.NavigableMap
    public final NavigableMap<K, Collection<V>> tailMap(@ParametricNullness K fromKey, boolean inclusive) {
        return new C436519(this.A00, A0B().tailMap(fromKey, inclusive));
    }
}
