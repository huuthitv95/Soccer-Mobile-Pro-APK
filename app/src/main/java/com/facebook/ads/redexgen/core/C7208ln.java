...
public class C7208ln<K> implements Iterator<K> {
    public static byte[] A03;

    @CheckForNull
    public Map.Entry<K, Collection<V>> A00;
    public final /* synthetic */ C44422O A01;
    ...
    public C7208ln(final C44422O this$1, final Iterator val$entryIterator) {
    ...
    public final void remove() {
        AbstractC7142ki.A0F(this.A00 != null, A00(0, 50, 26));
        Collection collection = (Collection) this.A00.getValue();
        this.A02.remove();
        AbstractC44392L.A03(this.A01.A00, collection.size());
        collection.clear();
        this.A00 = null;
    }
}
