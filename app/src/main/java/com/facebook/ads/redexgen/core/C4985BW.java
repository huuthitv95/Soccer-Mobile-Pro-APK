...
public final class C4985BW {
    ...
    public C4985BW(String str, boolean z, boolean z2) {
        this.A00 = str;
        this.A01 = z;
        this.A02 = z2;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj == null || obj.getClass() != C4985BW.class) {
            return false;
        }
        C4985BW c4985bw = (C4985BW) obj;
        String str = this.A00;
        String str2 = c4985bw.A00;
        String[] strArr = A03;
        if (strArr[1].length() != strArr[7].length()) {
            throw new RuntimeException();
        }
        A03[0] = "8OzGK6f1ltbus";
        return TextUtils.equals(str, str2) && this.A01 == c4985bw.A01 && this.A02 == c4985bw.A02;
    }
