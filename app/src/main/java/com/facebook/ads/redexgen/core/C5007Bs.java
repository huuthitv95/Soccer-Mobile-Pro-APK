...
public class C5007Bs<V> extends AbstractC44392L<K, V>.WrappedCollection.WrappedIterator implements ListIterator<V> {
    public final /* synthetic */ C5006Br A00;
    ...
    public C5007Bs(final C5006Br this$1) {
        super(this$1);
        this.A00 = this$1;
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Bs != com.google.common.collect.AbstractMapBasedMultimap<K, V>$WrappedList$WrappedListIterator */
    public C5007Bs(final C5006Br this$1, int index) {
    ...
    public final void add(@ParametricNullness V value) {
        ...
        A00().add(value);
        AbstractC44392L.A00(this.A00.A00);
        if (zIsEmpty) {
            this.A00.A03();
        }
    }
