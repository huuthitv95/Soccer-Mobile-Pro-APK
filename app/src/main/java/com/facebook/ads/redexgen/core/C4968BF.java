...
public class C4968BF<K0> extends AbstractC7458q4<K0> {
    public final /* synthetic */ Comparator A00;

    public C4968BF(final Comparator val$comparator) {
        this.A00 = val$comparator;
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC7458q4
