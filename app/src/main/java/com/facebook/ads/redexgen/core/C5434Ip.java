...
public final class C5434Ip {
    ...
    public int A00;
    public final C45944v A01 = new C45944v(8);

    private long A00(InterfaceC7263ms interfaceC7263ms) throws IOException {
        interfaceC7263ms.AGt(this.A01.A0l(), 0, 1);
        ...
        int value = ~mask;
        int i2 = i & value;
        interfaceC7263ms.AGt(this.A01.A0l(), 1, length);
    ...
    public final boolean A01(InterfaceC7263ms interfaceC7263ms) throws IOException {
        ...
        int i = (int) j;
        boolean z = false;
        interfaceC7263ms.AGt(this.A01.A0l(), 0, 4);
        ...
        long jA00 = A00(interfaceC7263ms);
        int i3 = this.A00;
        String[] strArr2 = A02;
        ...
        while (this.A00 < j3 + jA00) {
            if (A00(interfaceC7263ms) == Long.MIN_VALUE) {
                return z;
            }
            long jA01 = A00(interfaceC7263ms);
            String[] strArr4 = A02;
