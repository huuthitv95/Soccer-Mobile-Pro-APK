...
public class C5008Bt<K, V> extends AbstractC7441pn<K, Collection<V>> {
    public final transient Map<K, Collection<V>> A00;
    public final /* synthetic */ AbstractC44392L A01;
    ...
    public C5008Bt(final AbstractC44392L this$0, Map<K, Collection<V>> submap) {
        this.A01 = this$0;
        this.A00 = submap;
    }
    ...
    public final Collection<V> get(@CheckForNull Object key) {
        Collection<V> collection = (Collection) AbstractC7442po.A05(this.A00, key);
        if (collection == null) {
            return null;
        }
    ...
    public final Collection<V> remove(@CheckForNull Object key) {
        ...
        AbstractC44392L.A03(this.A01, collectionRemove.size());
        collectionRemove.clear();
        return collectionA0D;
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Bt != com.google.common.collect.AbstractMapBasedMultimap<K, V>$AsMap */
    @Override // com.facebook.ads.redexgen.core.AbstractC7441pn
    public final Set<Map.Entry<K, Collection<V>>> A09() {
        return new AbstractC4971BI<K, Collection<V>>() { // from class: com.facebook.ads.redexgen.X.2P
            ...
            @Override // com.facebook.ads.redexgen.core.AbstractC4971BI
            ...
            public final boolean contains(@CheckForNull Object o) {
                return AbstractC7308nc.A03(this.A00.A00.entrySet(), o);
            }

            /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2P != com.google.common.collect.AbstractMapBasedMultimap<K, V>$AsMap$AsMapEntries */
            @Override // java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, java.util.Set
            public final Iterator<Map.Entry<K, Collection<V>>> iterator() {
                return new C7206ll(this.A00);
            }
            ...
            public final boolean remove(@CheckForNull Object o) {
                ...
                C5008Bt c5008Bt = this.A00;
                if (A01[2].length() == 19) {
                    throw new RuntimeException();
                }
                A01[3] = "G2qcJwlII5HIikaXRsYLysr3qmkTj7oM";
                c5008Bt.A01.A0A(entry.getKey());
                return true;
            }
        };
    }
    ...
    public final Map.Entry<K, Collection<V>> A0A(Map.Entry<K, Collection<V>> entry) {
        K key = entry.getKey();
        return AbstractC7442po.A01(key, this.A01.A0F(key, entry.getValue()));
    }
    ...
    public final void clear() {
        if (this.A00 == this.A01.A01) {
            ...
            AbstractC7402p9.A09(new C7206ll(this));
        }
    }
    ...
    public final boolean containsKey(@CheckForNull Object key) {
        return AbstractC7442po.A0C(this.A00, key);
    }
