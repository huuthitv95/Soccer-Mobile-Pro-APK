...
public final class C45934u {
    ...
    public C45934u(byte[] bArr) {
        this(bArr, bArr.length);
    }

    public C45934u(byte[] bArr, int i) {
        this.A00 = bArr;
        this.A02 = i;
    }

    private void A00() {
        AbstractC45353y.A08(this.A03 >= 0 && (this.A03 < this.A02 || (this.A03 == this.A02 && this.A01 == 0)));
    }
    ...
    public final long A05(int i) {
        if (i > 32) {
            return AbstractC46115C.A0N(A04(i - 32), A04(32));
        }
        long jA0M = AbstractC46115C.A0M(A04(i));
        String[] strArr = A04;
    ...
    public final void A0C(C45944v c45944v) {
        A0E(c45944v.A0l(), c45944v.A0A());
        A08(c45944v.A09() * 8);
    }
