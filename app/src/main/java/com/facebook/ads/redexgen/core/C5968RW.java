...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.RW */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C5968RW {
    ...
    private Map<Thread, StackTraceElement[]> A01() {
        Map<Thread, StackTraceElement[]> stackTraces = new TreeMap<>(new C5967RV(this, Looper.getMainLooper().getThread()));
