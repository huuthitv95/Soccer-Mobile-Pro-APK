...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.V4 */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C6186V4 implements AudienceNetworkRemoteServiceApi {
    ...
    public C6186V4(Service service) {
        this.A03 = service;
    }
    ...
    public final void onCreate() {
        ...
        this.A00 = new Messenger(new HandlerC6187V5(this.A03.getApplicationContext(), this.A01, this.A02));
    }
