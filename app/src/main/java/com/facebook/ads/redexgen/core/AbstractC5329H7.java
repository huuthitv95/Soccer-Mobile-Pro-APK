...
public abstract class AbstractC5329H7 {
    ...
    public static void A06() {
        A00 = new byte[]{7, 19, 2, Ascii.f22499SI, 9, 73, Ascii.DLE, 8, 2, 72, 2, Ascii.DC2, Ascii.NAK};
    }
    ...
    public static C7472qI A03(byte[] bArr, String str, String str2, DrmInitData drmInitData) {
        int i;
        C45934u c45934uA04 = A04(bArr);
        c45934uA04.A09(60);
        int amode = c45934uA04.A04(6);
        int bitrate = A02[amode];
        int amode2 = c45934uA04.A04(4);
        int rate = A03[amode2];
        int amode3 = c45934uA04.A04(5);
        ...
        c45934uA04.A09(10);
        int amode4 = c45934uA04.A04(2);
        int amode5 = amode4 > 0 ? 1 : 0;
        return new C44672p().A0y(str).A11(A05(0, 13, 27)).A0a(i).A0b(bitrate + amode5).A0m(rate).A0u(drmInitData).A10(str2).A14();
    }

    public static C45934u A04(byte[] bArr) {
        if (bArr[0] == 127) {
            return new C45934u(bArr);
        }
        ...
        if (bArrCopyOf[0] == 31) {
            C45934u c45934u2 = new C45934u(bArrCopyOf);
            while (c45934u2.A01() >= 16) {
                c45934u2.A09(2);
                int iA04 = c45934u2.A04(14);
                if (A01[4].length() == 13) {
                    throw new RuntimeException();
                }
                String[] strArr = A01;
