...
public final class C7247mc extends AbstractC5378Hu {
    ...
    public static void A0A() {
        A03 = new byte[]{-39, -22, -25, -42, -23, -34, -28, -29, -43, -40, -37, -44, -33, -34, -30, -40, -29, -40, -34, -35, -30, -32, -38, -18, -37, -25, -42, -30, -38, -24, -25, -26, -59, -35, -20, -39, -68, -39, -20, -39, 35, Ascii.CAN, Ascii.f22493FS, Ascii.DC4, 34};
    }
    ...
    public final boolean A0C(C45944v c45944v, long j) {
        int i;
        if (A00(c45944v) != 2) {
            return false;
        }
        String strA05 = A05(c45944v);
        if (A04[2].charAt(14) == 'f') {
            throw new RuntimeException();
        }
        A04[2] = "yhTvZHDsLiRhvHdxFLG6a7MHjxNmCRFd";
        if (!A04(30, 10, 28).equals(strA05) || c45944v.A07() == 0 || A00(c45944v) != 8) {
            return false;
        }
        HashMap<String, Object> mapA08 = A08(c45944v);
    ...
    public static Boolean A01(C45944v c45944v) {
        return Boolean.valueOf(c45944v.A0I() == 1);
    }

    public static Double A02(C45944v c45944v) {
        return Double.valueOf(Double.longBitsToDouble(c45944v.A0P()));
    }

    public static Object A03(C45944v c45944v, int i) {
        switch (i) {
            case 0:
                return A02(c45944v);
            case 1:
    ...
    public static String A05(C45944v c45944v) {
        int iA0M = c45944v.A0M();
        int iA09 = c45944v.A09();
        c45944v.A0g(iA0M);
        return new String(c45944v.A0l(), iA09, iA0M);
    }

    public static ArrayList<Object> A06(C45944v c45944v) {
        int iA0L = c45944v.A0L();
        ArrayList<Object> arrayList = new ArrayList<>(iA0L);
        for (int i = 0; i < iA0L; i++) {
            int count = A00(c45944v);
            Object objA03 = A03(c45944v, count);
            if (objA03 != null) {
    ...
    public static Date A07(C45944v c45944v) {
        Date date = new Date((long) A02(c45944v).doubleValue());
        c45944v.A0g(2);
        return date;
    }

    public static HashMap<String, Object> A08(C45944v c45944v) {
        int iA0L = c45944v.A0L();
    ...
    public static HashMap<String, Object> A09(C45944v c45944v) {
        ...
        while (true) {
            ...
            Object objA03 = A03(c45944v, iA00);
            if (objA03 != null) {
                map.put(strA05, objA03);
            }
        }
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC5378Hu
    public final boolean A0B(C45944v c45944v) {
        return true;
    }
