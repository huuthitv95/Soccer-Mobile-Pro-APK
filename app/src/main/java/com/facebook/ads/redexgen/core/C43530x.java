...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.0x */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C43530x extends AbstractViewOnTouchListenerC43711F implements InterfaceC6737e2 {
    ...
    public int A02;
    public int A03;
    public InterfaceC6417Ys A04;
    public boolean A05;
    public final C47186v A06;
    ...
    public C43530x(C6902gi c6902gi) {
        super(c6902gi);
        this.A03 = -1;
        this.A02 = -1;
        this.A01 = 0;
        this.A00 = 0;
        this.A05 = false;
        this.A06 = new C47186v(c6902gi, new C6735e0(), new C6734dz());
        A02();
    }

    public C43530x(C6902gi c6902gi, AttributeSet attributeSet) {
    ...
    public C43530x(C6902gi c6902gi, AttributeSet attributeSet, int i) {
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractViewOnTouchListenerC43711F
    public final void A20(int i, boolean z) {
        super.A20(i, z);
        A04(i, 0);
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC6737e2
    public final int A8o(int i) {
        int iAbs = Math.abs(i);
        int scrollXAbs = ((AbstractViewOnTouchListenerC43711F) this).A06;
        if (iAbs <= scrollXAbs) {
            return 0;
        }
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (this.A05) {
            int i3 = (int) AbstractC6334XX.A02;
            int verticalPadding = C6171Up.A0F(getContext());
        ...
        if (this.A05) {
            int verticalPadding5 = C6412Yn.A09;
    ...
    public void setAdapter(AbstractC5926Qq abstractC5926Qq) {
        this.A06.A2J(abstractC5926Qq == null ? -1 : abstractC5926Qq.hashCode());
        super.setAdapter(abstractC5926Qq);
    }
    ...
    public void setChildWidth(int i) {
        ...
        C47186v c47186v = this.A06;
        int pageWidth3 = this.A01;
        c47186v.A2K((i3 - pageWidth3) / 2);
        C47186v c47186v2 = this.A06;
        int pageWidth4 = this.A01;
        c47186v2.A2I(((double) pageWidth4) / ((double) measuredWidth));
    }
    ...
    public void setOnPageChangedListener(InterfaceC6417Ys interfaceC6417Ys) {
        this.A04 = interfaceC6417Ys;
    }
