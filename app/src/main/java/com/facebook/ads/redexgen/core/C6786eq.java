...
public final class C6786eq extends RelativeLayout {
    ...
    public int A00;
    public C45043S A01;
    public WeakReference<InterfaceC6785ep> A02;
    public final InterfaceC6842fk A03;

    public C6786eq(C6902gi c6902gi, InterfaceC6842fk interfaceC6842fk) {
        super(c6902gi);
        this.A00 = 0;
        this.A03 = interfaceC6842fk;
        AbstractC6374YB.A0J((View) this.A03);
    ...
    public final void A01(AnimatorSet animatorSet, boolean z) {
        if (z) {
            ...
            C6783en c6783en = new C6783en(this);
            this.A03.getView().setOutlineProvider(c6783en);
            if (this.A01 != null) {
                this.A01.setClipToOutline(true);
                this.A01.setOutlineProvider(c6783en);
            }
    ...
    public final void A02(AbstractC5150ED abstractC5150ED) {
        addView(abstractC5150ED, new RelativeLayout.LayoutParams(-1, -1));
        this.A01 = (C45043S) abstractC5150ED;
    }

    public final void A03(AbstractC5150ED abstractC5150ED) {
    ...
    public final void onMeasure(int i, int i2) {
        ...
        WeakReference<InterfaceC6785ep> weakReference = this.A02;
    ...
    public void setRoundedCornersVideoStyle(float f) {
        this.A03.getView().setClipToOutline(true);
        this.A03.getView().setOutlineProvider(new C6784eo(this, f));
    }

    public void setViewImplInflationListener(InterfaceC6785ep interfaceC6785ep) {
        this.A02 = new WeakReference<>(interfaceC6785ep);
    }
}
