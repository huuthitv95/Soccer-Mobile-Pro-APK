...
public abstract class AbstractC5764OA {
    ...
    public static AdSettings.IntegrationErrorMode A00(C6902gi c6902gi) {
        ...
        if (integrationErrorMode == integrationErrorMode2 && !A03(c6902gi)) {
    ...
    public static boolean A03(C6902gi c6902gi) {
        return (c6902gi.getApplicationInfo().flags & 2) != 0;
    }
}
