...
public abstract class EnumC6876gI {
    ...
    public static final /* synthetic */ EnumC6876gI[] A02;
    public static final EnumC6876gI A03;
    public static final EnumC6876gI A04;
    public static final EnumC6876gI A05;
    public static final EnumC6876gI A06;
    public static final EnumC6876gI A07;
    public static final EnumC6876gI A08;
    ...
    public static void A03() {
        A00 = new byte[]{Ascii.DC4, 39, 39, 52, 44, 71, 106, 106, 105, 96, 100, 107, 102, 77, 87, SignedBytes.MAX_POWER_OF_TWO, 78, 71, 105, 78, 84, 95, 114, 122, 117, 115, 100, 46, 9, Ascii.f22499SI, Ascii.DC4, 19, Ascii.SUB, 94, 101, 96, 101, 100, 124, 101, 43, 127, 114, 123, 110, 43, 100, 109, 43, 97, 120, 100, 101, 43, 100, 105, 97, 110, 104, 127, 43, 96, 110, 114};
    }
    ...
    static {
        ...
        final int i = 0;
        A03 = new EnumC6876gI(strA02, i) { // from class: com.facebook.ads.redexgen.X.Ci
            @Override // com.facebook.ads.redexgen.core.EnumC6876gI
            ...
            public final boolean A06(JSONArray jSONArray, JSONArray jSONArray2, int i2) {
                return AbstractC6877gJ.A00(jSONArray.optJSONArray(i2), jSONArray2.optJSONArray(i2));
            }
            ...
            public final boolean A08(JSONObject jSONObject, JSONObject jSONObject2, String str) {
                return AbstractC6877gJ.A00(jSONObject.optJSONArray(str), jSONObject2.optJSONArray(str));
            }
        };
        final String strA03 = A02(5, 7, 74);
        final int i2 = 1;
        A04 = new EnumC6876gI(strA03, i2) { // from class: com.facebook.ads.redexgen.X.Ch
            @Override // com.facebook.ads.redexgen.core.EnumC6876gI
        ...
        final int i3 = 2;
        A05 = new EnumC6876gI(strA04, i3) { // from class: com.facebook.ads.redexgen.X.Cg
            ...
            public final boolean A07(JSONObject jSONObject, String str) {
                ...
                double dOptDouble = jSONObject.optDouble(str, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
                ...
                return dOptDouble == jSONObject.optDouble(str, 1.0d) && ((double) jSONObject.optInt(str, 0)) != jSONObject.optDouble(str, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
            }
        ...
        final int i4 = 3;
        A06 = new EnumC6876gI(strA05, i4) { // from class: com.facebook.ads.redexgen.X.Cf
            ...
            public final boolean A05(JSONArray jSONArray, int i5) {
                ...
                return ((double) iOptInt) == jSONArray.optDouble(i5, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
            }
            ...
            public final boolean A07(JSONObject jSONObject, String str) {
                ...
                A00[0] = "ksANhPg";
                return ((double) iOptInt) == jSONObject.optDouble(str, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE);
            }
        ...
        final int i5 = 4;
        A07 = new EnumC6876gI(strA06, i5) { // from class: com.facebook.ads.redexgen.X.Ce
            @Override // com.facebook.ads.redexgen.core.EnumC6876gI
            ...
            public final boolean A06(JSONArray jSONArray, JSONArray jSONArray2, int i6) {
                return AbstractC6877gJ.A02(jSONArray.optJSONObject(i6), jSONArray2.optJSONObject(i6));
            }
            ...
            @Override // com.facebook.ads.redexgen.core.EnumC6876gI
            public final boolean A08(JSONObject jSONObject, JSONObject jSONObject2, String str) {
                return AbstractC6877gJ.A02(jSONObject.optJSONObject(str), jSONObject2.optJSONObject(str));
            }
        };
        final String strA07 = A02(27, 6, 50);
        final int i6 = 5;
        A08 = new EnumC6876gI(strA07, i6) { // from class: com.facebook.ads.redexgen.X.Cd
            @Override // com.facebook.ads.redexgen.core.EnumC6876gI
    ...
    public EnumC6876gI(String str, int i) {
        super(str, i);
    }

    public static EnumC6876gI A00(JSONArray jSONArray, int i) {
        for (EnumC6876gI type : values()) {
    ...
    public static EnumC6876gI A01(JSONObject jSONObject, String str) {
        for (EnumC6876gI type : values()) {
            String[] strArr = A01;
    ...
    public static /* synthetic */ EnumC6876gI[] A04() {
        return new EnumC6876gI[]{A03, A04, A05, A06, A07, A08};
    }

    public static EnumC6876gI valueOf(String str) {
        return (EnumC6876gI) Enum.valueOf(EnumC6876gI.class, str);
    }

    public static EnumC6876gI[] values() {
        return (EnumC6876gI[]) A02.clone();
    }
}
