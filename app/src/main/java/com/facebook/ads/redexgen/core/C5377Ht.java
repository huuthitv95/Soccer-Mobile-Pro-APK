...
public class C5377Ht extends AbstractRunnableC6279Wc {
    ...
    public C5377Ht(C46145F c46145f, C45474A c45474a) {
        this.A00 = c46145f;
        this.A01 = c45474a;
    }
    ...
    public final void A07() {
        if (this.A00.A0b.getState() == EnumC6844fm.A02 && this.A00.A0b.getCurrentPositionInMillis() == A00()) {
            InterfaceC6721dm interfaceC6721dm = this.A00.A0Z;
            String[] strArr = A03;
            ...
            interfaceC6721dm.AGQ(A00(0, 22, 60));
        }
    }
}
