...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.FW */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C5231FW {
    ...
    public static final Comparator<C5230FV> A08 = new Comparator() { // from class: com.facebook.ads.redexgen.X.FS
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
            return C5231FW.A00((C5230FV) obj, (C5230FV) obj2);
        }
    };
    public static final Comparator<C5230FV> A09 = new Comparator() { // from class: com.facebook.ads.redexgen.X.FT
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
            return Float.compare(((C5230FV) obj).A00, ((C5230FV) obj2).A00);
        }
    };
    public int A01;
    public int A02;
    ...
    public final C5230FV[] A06 = new C5230FV[5];
    public final ArrayList<C5230FV> A05 = new ArrayList<>();
    public int A00 = -1;

    public C5231FW(int i) {
        this.A04 = i;
    }

    public static /* synthetic */ int A00(C5230FV c5230fv, C5230FV c5230fv2) {
        return c5230fv.A01 - c5230fv2.A01;
    }
    ...
    private final void A04(int i, float f) {
        C5230FV oldestSample;
        A02();
        if (this.A02 > 0) {
            C5230FV[] c5230fvArr = this.A06;
            int i2 = this.A02 - 1;
            this.A02 = i2;
            oldestSample = c5230fvArr[i2];
        } else {
            oldestSample = new C5230FV();
        }
        int i3 = this.A01;
        this.A01 = i3 + 1;
        oldestSample.A01 = i3;
        ...
        while (this.A03 > this.A04) {
            ...
            C5230FV c5230fv = this.A05.get(0);
            if (c5230fv.A02 <= excessWeight) {
                this.A03 -= c5230fv.A02;
                this.A05.remove(0);
                if (this.A02 < 5) {
                    C5230FV[] c5230fvArr2 = this.A06;
                    int excessWeight2 = this.A02;
                    this.A02 = excessWeight2 + 1;
                    c5230fvArr2[excessWeight2] = c5230fv;
                }
            } else {
                c5230fv.A02 -= excessWeight;
    ...
    public final float A05(float f) {
        ...
        while (true) {
            ...
            if (i2 < size) {
                C5230FV c5230fv = this.A05.get(i2);
                i += c5230fv.A02;
                float desiredWeight = i;
                if (desiredWeight >= f2) {
                    float desiredWeight2 = c5230fv.A00;
    ...
    public final void A07(int i, float f) {
        C5230FV oldestSample;
        if (MetaExoPlayerUpgradeConfig.A03(EnumC7071jX.A1F)) {
            A04(i, f);
            return;
        }
        A02();
