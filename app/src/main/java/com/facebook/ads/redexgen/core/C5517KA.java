...
public class C5517KA implements InterfaceC6539aq {
    ...
    public C5517KA(C5489Ji c5489Ji) {
        this.A00 = c5489Ji;
    }
    ...
    public final void AF7(String str) {
        ...
        AbstractC6374YB.A0O(this.A00.A07, 8);
    ...
    public final void AF9(String str) {
        this.A00.A0K = true;
        AbstractC6374YB.A0O(this.A00.A07, 0);
        if (this.A00.A06 != null) {
            this.A00.A06.setUrl(str);
        }
        C5489Ji c5489Ji = this.A00;
        String[] strArr = A02;
        if (strArr[4].charAt(17) != strArr[5].charAt(17)) {
            A02[2] = "wX256yuF2";
            if (!c5489Ji.A0I && this.A00.A00 > 1) {
                this.A00.A0I = true;
                this.A00.A0o(A00(0, 19, 95));
            }
            C5489Ji.A02(this.A00);
            if (A02[2].length() != 27) {
