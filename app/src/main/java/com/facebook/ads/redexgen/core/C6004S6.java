...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.S6 */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C6004S6 implements NativeAdsManagerApi {
    ...
    public C6004S6(Context context, String str, int i) {
        this.A08 = C5987Rp.A03(context);
        this.A09 = str;
    ...
    public final void loadAds(NativeAdBase.MediaCacheFlag mediaCacheFlag) {
        EnumC6232Vq enumC6232Vq = EnumC6232Vq.A06;
        int i = this.A07;
        C7034iu c7034iu = this.A03;
        this.A03 = new C7034iu(this.A08, this.A09, enumC6232Vq, null, i);
        if (this.A06) {
            this.A03.A06();
        }
        this.A03.A09(this.A04);
        this.A03.A08(new C6925h5(this, this.A08, mediaCacheFlag, this.A01));
        this.A03.A07();
    }
    ...
    public final NativeAd nextNativeAd(NativeAdListener nativeAdListener) {
        ...
        if (nativeAdListener != null) {
            ((C6140UK) nativeAd.getInternalNativeAd()).A1b(nativeAd, nativeAdListener);
        }
