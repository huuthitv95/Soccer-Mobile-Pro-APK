...
public final class C5991Rt implements InterstitialAd.InterstitialAdLoadConfigBuilder, InterstitialAd.InterstitialLoadAdConfig {
    public C5990Rs A00;
    public String A01;
    public EnumSet<CacheFlag> A02;

    public C5991Rt(C5990Rs c5990Rs) {
        this.A00 = c5990Rs;
    }
