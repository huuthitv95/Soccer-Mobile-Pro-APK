...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.TH */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C6076TH {
    ...
    public final C6843fl A03 = new C6843fl(this);
    public final C6850fs A02 = new C6850fs(this);
    ...
    static {
        A07();
        StringBuilder sbAppend = new StringBuilder().append(A05(107, 14, 44)).append(C6843fl.A03.A01);
        ...
        StringBuilder sbAppend4 = sbAppend3.append(strA07).append(C6843fl.A02.A01).append(strA05);
        String strA08 = A05(136, 6, 26);
        A05 = sbAppend4.append(strA08).append(strA07).append(C6850fs.A04.A01).append(strA05).append(strA08).append(strA07).append(C6850fs.A05.A01).append(strA05).append(strA08).append(strA07).append(C6850fs.A0A.A01).append(strA05).append(strA08).append(strA07).append(C6850fs.A08.A01).append(strA05).append(strA08).append(strA07).append(C6850fs.A07.A01).append(strA05).append(strA08).append(strA07).append(C6850fs.A06.A01).append(strA05).append(strA08).append(strA07).append(C6850fs.A03.A01).append(strA05).append(strA08).append(strA07).append(C6850fs.A02.A01).append(A05(11, 6, 105)).append(strA08).append(A05(17, 6, 78)).append(strA06).append(A05(30, 4, 114)).append(strA08).append(strA07).append(C6850fs.A09.A01).append(A05(0, 3, Sdk.SDKError.Reason.INVALID_METRICS_ENDPOINT_VALUE)).append(strA06).append(strA07).append(C6843fl.A03.A01).append(A05(34, 10, 38)).append(strA08).append(strA07).append(C6850fs.A08.A01).append(A05(7, 4, 36)).toString();
        A08 = new ReentrantReadWriteLock();
        A06 = A08.readLock();
        A07 = A08.writeLock();
    }

    public C6076TH(C6898ge c6898ge) {
        this.A01 = c6898ge;
    }

    private synchronized SQLiteDatabase A00() {
        if (this.A00 == null) {
            this.A00 = new C6077TI(this.A01, this);
        }
    ...
    private synchronized SQLiteDatabase A01() {
        ...
        this.A01.A08().ABC(A05(128, 8, 110), AbstractC6098Td.A0v, new C6099Te(e));
        throw e;
        return A00();
    }
    ...
    public final int A08(int i) {
        A07.lock();
        try {
            return A0E().delete(A05(136, 6, 26), C6850fs.A02.A01 + A05(3, 4, 60), new String[]{String.valueOf(i - 1)});
        } finally {
            A07.unlock();
        }
    }
    ...
    public final <T> AsyncTask A0F(AbstractC6079TK<T> abstractC6079TK, AbstractC6144UO<T> abstractC6144UO) {
        return AbstractC6376YD.A00(ExecutorC6379YG.A07, new AsyncTaskC6075TG(this.A01, abstractC6079TK, abstractC6144UO), new Void[0]);
    }
    ...
    public final AsyncTask A0G(final String str, final int i, final String str2, final double d, final double d2, final String str3, final Map<String, String> data, AbstractC6144UO<String> abstractC6144UO) {
        return A0F(new AbstractC6810fE<String>() { // from class: com.facebook.ads.redexgen.X.75
            ...
            @Override // com.facebook.ads.redexgen.core.AbstractC6079TK
                    ...
                    try {
                        ...
                        if (sQLiteDatabaseA0E != null && sQLiteDatabaseA0E.isOpen()) {
                            try {
                                ...
                                this.A03.A01.A08().ABC(eventId, AbstractC6098Td.A0z, new C6099Te(e));
                            }
                        }
                        C6076TH.A07.unlock();
                        return strA0E;
                        ...
                        A01(EnumC6078TJ.A05);
                        this.A03.A01.A08().ABC(eventId, AbstractC6098Td.A0y, new C6099Te(e2));
                        if (sQLiteDatabaseA0E != null && sQLiteDatabaseA0E.isOpen()) {
                            try {
                                if (sQLiteDatabaseA0E.inTransaction()) {
                                    sQLiteDatabaseA0E.endTransaction();
                                ...
                                this.A03.A01.A08().ABC(eventId, AbstractC6098Td.A0z, new C6099Te(e3));
                            }
                        }
                        C6076TH.A07.unlock();
                        return null;
                    ...
                    if (sQLiteDatabaseA0E != null) {
                        ...
                        if (zIsOpen) {
                            try {
                                ...
                                this.A03.A01.A08().ABC(eventId, AbstractC6098Td.A0z, new C6099Te(e4));
                            }
                        }
                    }
                    C6076TH.A07.unlock();
    ...
    public final boolean A0L(String str) {
        ...
        try {
            ...
            sb.append(A05(Sdk.SDKError.Reason.TPAT_ERROR_VALUE, 7, 90)).append(A05(136, 6, 26)).append(A05(44, 5, 36)).append(C6850fs.A02.A01).append(A05(61, 1, 32)).append(C6850fs.A02.A01).append(A05(56, 2, 50)).append(A05(49, 7, 92)).append(C6850fs.A04.A01).append(A05(62, 2, 77));
    ...
    public final AbstractC6080TL[] A0M() {
        return new AbstractC6080TL[]{this.A03, this.A02};
    }
}
