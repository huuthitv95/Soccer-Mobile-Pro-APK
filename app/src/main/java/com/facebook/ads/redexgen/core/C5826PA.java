...
public final class C5826PA<K, V> implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
    ...
    public int A00;
    public final /* synthetic */ AbstractC5828PC A03;
    ...
    public static void A02() {
        A04 = new byte[]{123, Ascii.f22498RS, 34, 35, 57, 106, 41, 37, 36, 62, 43, 35, 36, 47, 56, 106, 46, 37, 47, 57, 106, 36, 37, 62, 106, 57, 63, 58, 58, 37, 56, 62, 106, 56, 47, 62, 43, 35, 36, 35, 36, 45, 106, 7, 43, 58, 100, Ascii.f22499SI, 36, 62, 56, 51, 106, 37, 40, 32, 47, 41, 62, 57};
    }
    ...
    public C5826PA(AbstractC5828PC abstractC5828PC) {
        this.A03 = abstractC5828PC;
        this.A00 = abstractC5828PC.A04() - 1;
    }
    ...
    public final boolean equals(Object obj) {
        if (this.A02) {
            ...
            return AbstractC5821P5.A04(entry.getKey(), this.A03.A0B(this.A01, 0)) && AbstractC5821P5.A04(entry.getValue(), this.A03.A0B(this.A01, 1));
        }
