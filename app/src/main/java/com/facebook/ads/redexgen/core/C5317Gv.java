...
public final class C5317Gv {
     ...
     */
    public static C5317Gv A00(C45944v c45944v) throws C44963K {
        try {
            c45944v.A0g(4);
            int iA0I = (c45944v.A0I() & 3) + 1;
            if (iA0I == 3) {
            ...
            String strA01 = null;
            if (iA0I2 > 0) {
                C5349HR c5349hrA09 = AbstractC5350HS.A09((byte[]) arrayList.get(0), iA0I, ((byte[]) arrayList.get(0)).length);
                i3 = c5349hrA09.A0A;
                i4 = c5349hrA09.A03;
                f = c5349hrA09.A00;
                strA01 = AbstractC454346.A01(c5349hrA09.A08, c5349hrA09.A01, c5349hrA09.A04);
            }
            return new C5317Gv(arrayList, iA0I, i3, i4, f, strA01);
        } catch (ArrayIndexOutOfBoundsException e) {
            throw C44963K.A01(A01(0, 24, 51), e);
        }
    }
    ...
    public C5317Gv(List<byte[]> initializationData, int i, int i2, int i3, float f, String str) {
    ...
    public static byte[] A03(C45944v c45944v) {
        int iA0M = c45944v.A0M();
        int offset = c45944v.A09();
        c45944v.A0g(iA0M);
        return AbstractC454346.A07(c45944v.A0l(), offset, iA0M);
    }
}
