...
public class C7539rf extends AbstractList<Integer> implements RandomAccess, Serializable {
    ...
    public C7539rf(int[] array) {
        this(array, 0, array.length);
    }

    public C7539rf(int[] array, int start, int end) {
        this.A02 = array;
        this.A01 = start;
        this.A00 = end;
    }
    ...
    public final Integer get(int index) {
        AbstractC7142ki.A00(index, size());
    ...
    public final Integer set(int index, Integer element) {
        ...
        int oldValue = ((Integer) AbstractC7142ki.A04(element)).intValue();
        iArr[i2] = oldValue;
    ...
    public final boolean contains(@CheckForNull Object target) {
        return (target instanceof Integer) && AbstractC4945As.A04(this.A02, ((Integer) target).intValue(), this.A01, this.A00) != -1;
    }
    ...
    public final boolean equals(@CheckForNull Object object) {
        ...
        boolean z = object instanceof C7539rf;
        if (A04[2].length() != 24) {
            throw new RuntimeException();
        }
        A04[2] = "hkNtVJfoNZugUfjtOIkeX8Ri";
        if (z) {
            C7539rf c7539rf = (C7539rf) object;
            int size = size();
            if (c7539rf.size() != size) {
                return false;
            }
            for (int i = 0; i < size; i++) {
                int size2 = this.A02[this.A01 + i];
                if (size2 != c7539rf.A02[c7539rf.A01 + i]) {
                    return false;
                }
            }
            return true;
    ...
    public final int hashCode() {
        ...
        for (int i2 = this.A01; i2 < result; i2++) {
            ...
            i = (i * 31) + AbstractC4945As.A00(result);
        }
        return i;
    }
    ...
    public final int indexOf(@CheckForNull Object target) {
        if (target instanceof Integer) {
            ...
            int i = AbstractC4945As.A04(iArr, ((Integer) target).intValue(), this.A01, this.A00);
            if (i >= 0) {
                return i - this.A01;
            }
            return -1;
    ...
    public final int lastIndexOf(@CheckForNull Object target) {
        int iA05;
        if ((target instanceof Integer) && (iA05 = AbstractC4945As.A05(this.A02, ((Integer) target).intValue(), this.A01, this.A00)) >= 0) {
            int i = this.A01;
            return iA05 - i;
        }
        return -1;
    ...
    public final List<Integer> subList(int fromIndex, int toIndex) {
        ...
        return new C7539rf(this.A02, this.A01 + fromIndex, this.A01 + toIndex);
    }
