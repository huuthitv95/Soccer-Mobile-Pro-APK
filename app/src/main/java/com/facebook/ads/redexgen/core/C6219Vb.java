...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.Vb */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C6219Vb implements NativeAdImageApi {
    ...
    public C6219Vb(String str, int i, int i2) {
        this.A02 = str;
        this.A01 = i;
        this.A00 = i2;
    }

    public static C6219Vb A00(JSONObject jSONObject) {
        String strOptString;
        if (jSONObject == null || (strOptString = jSONObject.optString(A01(6, 3, 75))) == null) {
            return null;
        }
        return new C6219Vb(strOptString, jSONObject.optInt(A01(9, 5, Sdk.SDKError.Reason.INVALID_METRICS_ENDPOINT_VALUE), 0), jSONObject.optInt(A01(0, 6, 92), 0));
    }
