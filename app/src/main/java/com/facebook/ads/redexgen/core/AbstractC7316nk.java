...
public abstract class AbstractC7316nk {
    ...
    public static void A09() {
        A00 = new byte[]{65, 89, 95, 88, Ascii.f22492FF, 78, 73, Ascii.f22492FF, 92, 67, 91, 73, 94, Ascii.f22492FF, 67, 74, Ascii.f22492FF, Ascii.f22498RS, Ascii.f22492FF, 78, 73, 88, 91, 73, 73, 66, Ascii.f22492FF, Ascii.f22498RS, 114, Ascii.f22494GS, Ascii.f22492FF, 77, 66, 72, Ascii.f22492FF, Ascii.f22498RS, 114, Ascii.f22502US, Ascii.f22493FS, Ascii.SYN, Ascii.f22492FF};
    }
    ...
    public static int A01(int expectedSize) {
        return Math.max(4, AbstractC7349oI.A01(expectedSize + 1, 1.0d));
    }
    ...
    public static int A06(@CheckForNull Object key, @CheckForNull Object value, @CheckForNull int mask, Object table, int[] entries, Object[] keys, Object[] values) {
        int tableIndex = AbstractC7349oI.A02(key);
        ...
        do {
            ...
            if (A02(tableIndex2, mask) == lastEntryIndex && AbstractC5025CB.A01(key, keys[entryIndex]) && (values == null || AbstractC5025CB.A01(value, values[entryIndex]))) {
