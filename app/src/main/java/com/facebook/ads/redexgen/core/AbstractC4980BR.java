...
public abstract class AbstractC4980BR<E> extends AbstractC7354oN<E> {
    ...
    public AbstractC4980BR(int initialCapacity) {
        AbstractC7289nJ.A00(initialCapacity, A00(0, 15, 58));
    ...
    private void A02(int newElements) {
        ...
        int newCapacity = AbstractC7354oN.A03(objArr.length, this.A00 + newElements);
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.BR != com.google.common.collect.ImmutableCollection$ArrayBasedBuilder<E> */
    public AbstractC4980BR<E> A03(E element) {
        AbstractC7142ki.A04(element);
        A02(1);
        Object[] objArr = this.A02;
        int i = this.A00;
        this.A00 = i + 1;
