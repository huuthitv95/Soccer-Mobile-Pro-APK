...
public final class C45944v {
    ...
    public static void A04() {
        A03 = new byte[]{SignedBytes.MAX_POWER_OF_TWO, 103, 127, 104, 101, 96, 109, 41, 92, 93, 79, 36, 49, 41, 122, 108, 120, 124, 108, 103, 106, 108, 41, 106, 102, 103, 125, 96, 103, 124, 104, 125, 96, 102, 103, 41, 107, 112, 125, 108, 51, 41, 88, 127, 103, 112, 125, 120, 117, 49, 68, 69, 87, 60, 41, 49, 98, 116, 96, 100, 116, 127, 114, 116, 49, 119, 120, 99, 98, 101, 49, 115, 104, 101, 116, 43, 49, 2, 57, 38, 118, 52, 63, 34, 118, 56, 57, 34, 118, 44, 51, 36, 57, 108, 118, 38, Ascii.f22494GS, 0, 6, 3, 3, Ascii.f22493FS, 1, 7, Ascii.SYN, Ascii.ETB, 83, Ascii.DLE, Ascii.ESC, Ascii.DC2, 1, 0, Ascii.SYN, 7, 73, 83};
    }
    ...
    static {
        ...
        A06 = new char[]{'\r', '\n'};
        A07 = new char[]{'\n'};
        A05 = MetaExoPlayerCustomizedCollections.A05(AbstractC7109k9.A01, AbstractC7109k9.A05, AbstractC7109k9.A02, AbstractC7109k9.A03, AbstractC7109k9.A04);
    }

    public C45944v() {
        this.A00 = AbstractC46115C.A07;
    }

    public C45944v(int i) {
        this.A00 = new byte[i];
        this.A01 = i;
    }

    public C45944v(byte[] bArr) {
        this.A00 = bArr;
        this.A01 = bArr.length;
    }

    public C45944v(byte[] bArr, int i) {
        this.A00 = bArr;
        this.A01 = i;
    }
    ...
    private char A00(Charset charset, char[] cArr) {
        char cA01;
        int i;
        if ((charset.equals(AbstractC7109k9.A05) || charset.equals(AbstractC7109k9.A01)) && A07() >= 1) {
            cA01 = AbstractC7416pN.A01(AbstractC7536rc.A00(this.A00[this.A02]));
            i = 1;
        } else if ((charset.equals(AbstractC7109k9.A02) || charset.equals(AbstractC7109k9.A03)) && A07() >= 2) {
            cA01 = AbstractC7416pN.A00(this.A00[this.A02], this.A00[this.A02 + 1]);
            i = 2;
        } else {
            if (!charset.equals(AbstractC7109k9.A04) || A07() < 2) {
                return (char) 0;
            }
            cA01 = AbstractC7416pN.A00(this.A00[this.A02 + 1], this.A00[this.A02]);
            i = 2;
        }
        if (!AbstractC7416pN.A04(cArr, cA01)) {
            return (char) 0;
        }
        this.A02 += i;
        char character = AbstractC7416pN.A01(cA01);
        return character;
    }

    private int A01(Charset charset) {
        int i;
        if (charset.equals(AbstractC7109k9.A05) || charset.equals(AbstractC7109k9.A01)) {
            i = 1;
        } else if (charset.equals(AbstractC7109k9.A02) || charset.equals(AbstractC7109k9.A04) || charset.equals(AbstractC7109k9.A03)) {
            i = 2;
        } else {
            throw new IllegalArgumentException(A03(95, 21, 50) + charset);
        }
        for (int i2 = this.A02; i2 < i - (i - 1); i2 += i) {
            if ((charset.equals(AbstractC7109k9.A05) || charset.equals(AbstractC7109k9.A01)) && AbstractC46115C.A16(this.A00[i2])) {
                return i2;
            }
            if ((charset.equals(AbstractC7109k9.A02) || charset.equals(AbstractC7109k9.A03)) && this.A00[i2] == 0 && AbstractC46115C.A16(this.A00[i2 + 1])) {
                return i2;
            }
            if (charset.equals(AbstractC7109k9.A04) && this.A00[i2 + 1] == 0 && AbstractC46115C.A16(this.A00[i2])) {
                return i2;
            }
        }
        int stride = this.A01;
    ...
    private final String A02(char c) {
        ...
        String strA0r = AbstractC46115C.A0r(bArr, i2, i - stringLimit2);
        this.A02 = i;
        int i3 = this.A02;
    ...
    public final String A0T() {
        return A0Y(AbstractC7109k9.A05);
    }
    ...
    public final String A0V(int i) {
        ...
        String strA0r = AbstractC46115C.A0r(bArr, stringLength4, i2);
    ...
    public final String A0W(int i) {
        return A0X(i, AbstractC7109k9.A05);
    }
    ...
    public final String A0Y(Charset charset) {
        AbstractC45353y.A09(A05.contains(charset), A03(95, 21, 50) + charset);
        if (A07() == 0) {
            return null;
        }
        if (!charset.equals(AbstractC7109k9.A01)) {
            A0Z();
        }
    ...
    public final void A0e(int i) {
        AbstractC45353y.A07(i >= 0 && i <= this.A00.length);
        this.A01 = i;
    }
    ...
    public final void A0h(C45934u c45934u, int i) {
        A0k(c45934u.A00, 0, i);
        c45934u.A08(0);
    }
