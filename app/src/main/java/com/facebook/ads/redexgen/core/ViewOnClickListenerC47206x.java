...
public final class ViewOnClickListenerC47206x extends C5849PZ implements View.OnClickListener, View.OnTouchListener {
    ...
    public static void A09() {
        A0E = new byte[]{94, 81, 84, 94, 86, 98, 78, 82, 72, 79, 94, 88, 36, 40, 42, 105, 33, 38, 36, 34, 37, 40, 40, 44, 105, 38, 35, 52, 105, 37, 38, 41, 41, 34, 53, 105, 36, 43, 46, 36, 44, 34, 35, 118, 122, 120, 59, 115, 116, 118, 112, 119, 122, 122, 126, 59, 116, 113, 102, 59, 124, 123, 97, 112, 103, 102, 97, 124, 97, 124, 116, 121, 59, 118, 121, 124, 118, 126, 112, 113, 2, Ascii.f22500SO, Ascii.f22492FF, 79, 7, 0, 2, 4, 3, Ascii.f22500SO, Ascii.f22500SO, 10, 79, 0, 5, Ascii.DC2, 79, Ascii.f22499SI, 0, Ascii.NAK, 8, Ascii.ETB, 4, 79, 0, 5, 62, 2, Ascii.f22490CR, 8, 2, 10, 53, 50, 44, 41, 40, 3, 49, 57, 40, 52, 51, 56, Ascii.f22498RS, Ascii.CAN, Ascii.f22500SO, Ascii.f22491EM, 52, 9, Ascii.f22498RS, Ascii.f22490CR, Ascii.f22490CR, Ascii.f22500SO, Ascii.f22491EM, Ascii.f22500SO, Ascii.f22499SI, 52, 8, 7, 2, 8, 0, 52, 2, 10, 9, 52, 8, 7, 2, 8, 0, Ascii.CAN, 81, 87, 65, 86, 123, 70, 81, 66, 66, 65, 86, 65, SignedBytes.MAX_POWER_OF_TWO, 123, 71, 72, 77, 71, 79, 123, 77, 69, 70, 123, 80, 93, 84, 77, 74, 67};
    }
    ...
    public ViewOnClickListenerC47206x(C5976Re c5976Re, C6902gi c6902gi, InterfaceC6192VA interfaceC6192VA, InterfaceC6406Yh interfaceC6406Yh, String str, int i) {
        super(c5976Re, c6902gi, interfaceC6192VA, interfaceC6406Yh, false);
        this.A00 = 0;
        this.A01 = 0;
        this.A03 = false;
        this.A07 = new RunnableC6409Yk(this);
        this.A08 = str;
        this.A05 = new Handler(Looper.getMainLooper());
        this.A06 = (InputMethodManager) c6902gi.getSystemService(A05(112, 12, 70));
        this.A04 = i;
    }

    public static /* synthetic */ int A02(ViewOnClickListenerC47206x viewOnClickListenerC47206x) {
        int i = viewOnClickListenerC47206x.A00;
        viewOnClickListenerC47206x.A00 = i + 1;
        return i;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A06() {
        AbstractC6374YB.A0N(this, C0684C.ENCODING_PCM_32BIT_BIG_ENDIAN);
    }
    ...
    private void A07() {
        ...
        if (AdPlacementType.NATIVE.name().equals(this.A08)) {
            ...
            super.A08.A0E(EnumC6795ez.A04.A03(), null);
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.core.C5849PZ
    public final InterfaceC6539aq A0F() {
        return new C5853Pd(this);
    }
    ...
    public final void A0G() {
        ...
        super.A07.setOnTouchListener(new View.OnTouchListener() { // from class: com.facebook.ads.redexgen.X.Yj
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return ViewOnClickListenerC47206x.A0B(view, motionEvent);
            }
        });
        ...
        RelativeLayout.LayoutParams layoutParams3 = new RelativeLayout.LayoutParams(-1, (int) (C5849PZ.A0I * AbstractC6334XX.A02));
    ...
    public final void A0H() {
        ...
        translateAnimation.setAnimationListener(new AnimationAnimationListenerC6411Ym(this));
    ...
    public final void A0I(String str) {
        if (this.A04 > 0 && !this.A03) {
            ...
            if (this.A02 != null) {
                this.A02.A04(EnumC6199VH.A0J, mapA05);
            }
            A07();
            this.A0A.ABM(super.A04, mapA05);
            if (C6171Up.A2U(this.A09)) {
    ...
    @Override // com.facebook.ads.redexgen.core.C5849PZ, com.facebook.ads.redexgen.core.InterfaceC6407Yi
    public final void AAu(Intent intent, Bundle bundle, C5976Re c5976Re) {
        super.AAu(intent, bundle, c5976Re);
        this.A02 = new C6200VI(super.A04, this.A0A);
    }
    ...
    public final void onAttachedToWindow() {
        ...
        translateAnimation.setFillAfter(true);
        translateAnimation.setAnimationListener(new AnimationAnimationListenerC6410Yl(this));
        startAnimation(translateAnimation);
    }
