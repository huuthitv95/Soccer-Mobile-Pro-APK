...
public final class HandlerC5778OO extends Handler {
    ...
    public InterfaceC6344Xh A01;
    public boolean A02;
    public final ServiceConnection A03;
    public final Handler A04;
    public final Messenger A05;
    public final InterfaceC5624Lt A06;
    public final C6898ge A07;
    public final AbstractRunnableC6279Wc A08;
    ...
    public HandlerC5778OO(C6898ge c6898ge) {
        super(Looper.getMainLooper());
        this.A04 = new Handler(Looper.getMainLooper());
        this.A03 = new ServiceConnectionC5777ON(this);
        this.A07 = c6898ge;
        this.A05 = new Messenger(this);
        InterfaceC5628Lx funnelModule = c6898ge.A00(c6898ge);
        if (funnelModule != null) {
            this.A06 = funnelModule.ACM();
        } else {
            this.A06 = new C7132kX();
        }
        this.A08 = new C7002iO(this);
    }
    ...
    public void A07(Messenger messenger) {
        ...
        messageObtain.setData(AbstractC5787OX.A00(this.A07));
        try {
    ...
    public final void A0A(String str, InterfaceC6344Xh interfaceC6344Xh, int i) {
        if (this.A02) {
            this.A06.AIN(i);
        ...
        InterfaceC5624Lt interfaceC5624Lt = this.A06;
        if (A0A[3].charAt(16) != '0') {
            throw new RuntimeException();
        }
        A0A[1] = "UrwnsONYHFKEsBm1tj1C3JCQoMa7O9rm";
        interfaceC5624Lt.AIP();
    }

    public final void A0B(boolean z) {
        this.A06.AIK();
        this.A02 = C5776OM.A04(this.A07, z, this.A03);
        if (this.A02) {
            ...
            if (messenger == null) {
                this.A04.postDelayed(this.A08, AbstractC6174Us.A01(this.A07));
                return;
            }
            return;
        }
        AbstractC6125U5.A05(this.A07);
    }
