...
public final class C5555Km {
    ...
    public static void A06() {
        A0B = new byte[]{35, Ascii.CAN, Ascii.f22494GS, Ascii.CAN, Ascii.f22491EM, 1, Ascii.CAN, 86, 2, 19, Ascii.f22500SO, 2, 55, Ascii.SUB, Ascii.f22502US, 17, Ascii.CAN, Ascii.ESC, 19, Ascii.CAN, 2, 76, 86, Ascii.DC4, 38, 33, 53, 55, 55, 0, 54, 38, 19, 34, 49, 48, 38, 49};
    }
    ...
    */
    public static float A00(float r6, int r7) {
        /*
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C5555Km.A0C
            r0 = 2
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 32
            ...
            throw r0
        L25:
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C5555Km.A0C
        ...
        L3c:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C5555Km.A00(float, int):float");
    }
    ...
    public static Layout.Alignment A04(int i) {
        switch (i) {
            ...
            default:
                AbstractC45794g.A07(A05(23, 15, 34), A05(0, 23, 23) + i);
                return null;
        }
    }

    public final C45253o A07() {
        int iA03;
        ...
        C45253o c45253oA0A = new C45253o().A0F(A04(this.A06)).A07(A00(this.A00, this.A04), this.A04).A09(this.A03).A04(fA01).A0A(iA03);
        float f = this.A02;
        float position = A02(iA03, fA01);
        C45253o c45253oA0B = c45253oA0A.A06(Math.min(f, position)).A0B(this.A07);
        if (this.A0A != null) {
            c45253oA0B.A0G(this.A0A);
        }
        return c45253oA0B;
    }

    public final C5548Kf A08() {
        return new C5548Kf(A07().A0H(), this.A09, this.A08);
    }
}
