...
public final class C6555b6 extends Drawable {
    ...
    public String A05;
    public String A06;
    public WeakReference<C6847fp> A07;
    public boolean A08;
    ...
    public final Runnable A0F = new C5595LQ(this);
    ...
    public static void A04() {
        A0G = new byte[]{Ascii.f22492FF, Ascii.SUB, 70, 121, 117, 103, 42, 48, 101, 42, 35, 101, 60, 48, 92, 127, 113, 116, 117, 116, 48, 0, Ascii.CAN, 4, 7, Ascii.CAN, 6, Ascii.f22494GS, 63, 44, 58, 126, 7, 32, 39, 58, 39, 47, 34, 39, 52, 39, 32, 41, 96, 96, 96, 110, 89, 86, Ascii.f22494GS, 83, 104, 109, 104, 105, 113, 104, 107, 84, 88, 74, 92, 95, 84, 81, 84, 73, 68, Ascii.f22494GS, 126, 85, 88, 94, 86, 88, 79, Ascii.f22494GS, 83, 82, 73, Ascii.f22494GS, 78, 88, 73, 60, 116, 122, 55, 89, 10, 75, 77, 69};
    }
    ...
    public final void A0A(C6847fp c6847fp) {
        this.A07 = new WeakReference<>(c6847fp);
        A03();
    }
