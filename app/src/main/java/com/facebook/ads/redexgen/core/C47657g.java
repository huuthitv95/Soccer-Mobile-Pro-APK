...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.7g */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C47657g extends AbstractC7040j0 {
    ...
    public static void A03() {
        A00 = new byte[]{42, 47, 107, 34, 56, 107, 37, 36, 63, 107, 57, 46, 42, 47, 50, 107, 36, 57, 107, 42, 39, 57, 46, 42, 47, 50, 107, 47, 34, 56, 59, 39, 42, 50, 46, 47, Ascii.DC4, Ascii.NAK, Ascii.f22493FS, 17, 9};
    }
    ...
    public C47657g(C6902gi c6902gi, C5761O7 c5761o7) {
    ...
    public void A05(List<String> trackingUrls, Map<String, String> extraData) {
        if (trackingUrls != null) {
            ...
            while (it.hasNext()) {
                new AsyncTaskC6873gF(this.A0B, extraData).execute(it.next());
            }
        }
    }
    ...
    public final void A0P() {
        C7094ju c7094ju = (C7094ju) this.A01;
        if (c7094ju.A0R()) {
            ...
            A01[4] = "SmlVqZ";
            if (abstractC5694N2 != null) {
                this.A07.A0B(c7094ju);
                return;
            }
            return;
        }
    ...
    public final void A0R(InterfaceC5693N1 interfaceC5693N1, C6117Tw c6117Tw, C6115Tu c6115Tu, C5762O8 c5762o8) {
        C7094ju c7094ju = (C7094ju) interfaceC5693N1;
        long jCurrentTimeMillis = System.currentTimeMillis();
        C7037ix c7037ix = new C7037ix(this, c5762o8, c7094ju, jCurrentTimeMillis, c6115Tu);
        A0H().postDelayed(c7037ix, c6117Tw.A05().A05());
        c7094ju.A0L(this.A0B, new C7036iw(this, c7037ix, jCurrentTimeMillis, c6115Tu), this.A09, c5762o8, C6140UK.A0K());
    }
}
