...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.Z3 */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C6428Z3 extends RelativeLayout {
    public TextView A00;
    ...
    public static final int A08 = (int) (AbstractC6334XX.A02 * 60.0f);
    public static final int A07 = (int) (AbstractC6334XX.A02 * 8.0f);
    ...
    public C6428Z3(C6902gi c6902gi, int i, int i2, String str, String str2, String str3, String str4, Bitmap bitmap) {
        super(c6902gi);
        this.A05 = new TextView(c6902gi);
        this.A02 = new Button(c6902gi);
        this.A01 = new Button(c6902gi);
        ...
        AbstractC6374YB.A0a(this.A05, true, 20);
        if (this.A00 != null) {
            this.A00.setText(str2);
            this.A00.setTextColor(i);
            AbstractC6374YB.A0a(this.A00, false, 18);
        }
        this.A03.setImageBitmap(bitmap);
        this.A03.setColorFilter(i);
        this.A02.setText(str3);
        AbstractC6374YB.A0a(this.A02, true, 18);
        this.A02.setAllCaps(true);
        this.A02.setTextColor(i2);
        this.A02.setPadding(A06, A06, A06, A06);
        this.A01.setText(str4);
        AbstractC6374YB.A0a(this.A01, true, 18);
        this.A01.setAllCaps(true);
        this.A01.setTextColor(i);
        this.A01.setPadding(A06, A06, A06, A06);
        int iA02 = AbstractC5819P3.A02(i2, 20);
        AbstractC6374YB.A0Q(this.A02, i, A07);
        AbstractC6374YB.A0Q(this.A01, iA02, A07);
        A00();
        setGravity(17);
    }
