06(Sdk.SDKError.Reason.INVALID_RI_ENDPOINT_VALUE, 19, 81);
        Bundle data = A01(c6067t8);
        bundle.putBundle(strA06, data);
        return bundle;
    }

    public static Bundle A01(C6067T8 c6067t8) {
        Bundle bundle = new Bundle();
        ...
        bundle.putBoolean(A06(54, 13, 2), C6335XY.A05(c6067t8));
        return bundle;
    }

    public static Bundle A02(String str, C7012iY c7012iY) {
        Bundle bundle = new Bundle();
        A08(bundle, c7012iY.A05());
        bundle.putString(A06(451, 17, 16), c7012iY.A0A());
        bundle.putString(A06(259, 13, 76), str);
        bundle.putString(A06(292, 19, 18), c7012iY.A07());
        bundle.putString(A06(366, 19, 0), c7012iY.A08());
        bundle.putString(A06(404, 22, 98), c7012iY.A09());
        bundle.putString(A06(385, 19, 96), AbstractC5783OT.A01(c7012iY.A0B()));
        RewardData rewardDataA03 = c7012iY.A03();
        if (rewardDataA03 != null) {
            AbstractC5788OY.A00(bundle, rewardDataA03);
        }
        C6902gi c6902giA05 = c7012iY.A05();
        if (A01[7].charAt(1) != 'G') {
            throw new RuntimeException();
        }
        String[] strArr = A01;
        ...
        bundle.putBundle(A06(Sdk.SDKError.Reason.INVALID_RI_ENDPOINT_VALUE, 19, 81), A01(c6902giA05));
        return bundle;
    }

    public static Bundle A03(String str, C6997iI c6997iI) {
        Bundle bundle = new Bundle();
        A08(bundle, c6997iI.A0B);
        bundle.putString(A06(451, 17, 16), c6997iI.A0D);
        bundle.putString(A06(259, 13, 76), str);
        bundle.putString(A06(292, 19, 18), c6997iI.A05);
        bundle.putString(A06(366, 19, 0), c6997iI.A06);
        bundle.putString(A06(404, 22, 98), c6997iI.A07);
        AdExperienceType adExperienceType = c6997iI.A02;
        if (adExperienceType != null) {
            bundle.putString(A06(237, 22, 24), AbstractC5782OS.A02(adExperienceType));
        }
        bundle.putBoolean(A06(90, 33, 27), c6997iI.A08);
        RewardData rewardData = c6997iI.A03;
        if (rewardData != null) {
            AbstractC5788OY.A00(bundle, rewardData);
        }
        bundle.putBundle(A06(Sdk.SDKError.Reason.INVALID_RI_ENDPOINT_VALUE, 19, 81), A01(c6997iI.A0B));
        return bundle;
    }

    public static C7012iY A04(C6902gi c6902gi, Bundle bundle, String str) {
        ...
        C7012iY c7012iY = new C7012iY(c6902gi, null, string, new C7003iP(str, string4, bundle2));
        c7012iY.A0I(string3);
        c7012iY.A0H(string2);
        c7012iY.A0J(sdkVersion);
        String placement6 = A06(385, 19, 96);
        c7012iY.A0K(AbstractC5783OT.A02(bundle.getString(placement6)));
        RewardData rewardDataA01 = AbstractC5788OY.A01(bundle);
        if (rewardDataA01 != null) {
            c7012iY.A0F(rewardDataA01);
        }
        return c7012iY;
    }

    public static C6997iI A05(C6902gi c6902gi, Bundle bundle, String str) {
        String string = bundle.getString(A06(451, 17, 16));
        ...
        C6997iI c6997iI = new C6997iI(c6902gi, string, null, new C7003iP(str, string4, bundle2));
        c6997iI.A06 = adExperienceType;
        c6997iI.A05 = string2;
        c6997iI.A08 = z;
        c6997iI.A02 = AbstractC5782OS.A00(string3);
        c6997iI.A07 = mediationData;
        RewardData rewardDataA01 = AbstractC5788OY.A01(bundle);
        if (rewardDataA01 != null) {
            c6997iI.A03 = rewardDataA01;
        }
        return c6997iI;
    }

    public static void A08(Bundle bundle, C6067T8 c6067t8) {
        bundle.putString(A06(344, 22, 96), A06(0, 6, 101));
        boolean zAAT = false;
        boolean isForcedFunnelLogging = c6067t8 instanceof C6902gi;
        if (isForcedFunnelLogging) {
            zAAT = ((C6902gi) c6067t8).A0F().AAT();
        }
        boolean isForcedFunnelLogging2 = C6092TX.A0I(c6067t8);
        bundle.putBoolean(A06(33, 21, 55), isForcedFunnelLogging2 || zAAT);
        bundle.putString(A06(330, 14, 30), c6067t8.getPackageName());
        boolean isForcedFunnelLogging3 = AbstractC6174Us.A0G(c6067t8);
        if (isForcedFunnelLogging3) {
            bundle.putString(A06(311, 19, 51), new C6046Sn().A03(c6067t8));
        }
    }
}
