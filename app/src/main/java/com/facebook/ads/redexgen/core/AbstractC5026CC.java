...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.CC */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
@ElementTypesAreNonnullByDefault
public abstract class AbstractC5026CC implements InterfaceC7143kj<Character> {
    ...
    public static C43681C A02(final char match) {
        return new AbstractC44462S(match) { // from class: com.facebook.ads.redexgen.X.1C
            ...
            public static void A01() {
                byte[] bArr = {55, 57, Ascii.f22491EM, 50, 59, 40, Ascii.ETB, 59, 46, 57, 50, 63, 40, 116, 51, 41, 114, 125};
                if (A02[1].length() == 27) {
                    throw new RuntimeException();
                }
                String[] strArr = A02;
            ...
            public final String toString() {
                return A00(2, 16, 41) + AbstractC5026CC.A04(this.A00) + A00(0, 2, 99);
            }
        };
    }

    public static AbstractC5026CC A03() {
        AbstractC5026CC abstractC5026CC = C43510v.A01;
        if (A01[1].charAt(7) == 'R') {
            throw new RuntimeException();
        }
        A01[1] = "RCT2CzV9IWXJqUHkaSW8fbkoFpPJrj9F";
        return abstractC5026CC;
    }
