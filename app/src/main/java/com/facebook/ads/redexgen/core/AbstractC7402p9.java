...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.p9 */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
@ElementTypesAreNonnullByDefault
public abstract class AbstractC7402p9 {
     ...
     */
    public static <T> boolean A0B(Iterator<T> iterator, InterfaceC7143kj<? super T> predicate) {
    ...
    public static boolean A0F(Iterator<?> iterator1, Iterator<?> iterator2) {
        while (iterator1.hasNext()) {
            if (!iterator2.hasNext() || !AbstractC5025CB.A01(iterator1.next(), iterator2.next())) {
                return false;
            }
        }
    ...
    public static <T> int A00(Iterator<T> iterator, InterfaceC7143kj<? super T> predicate) {
        AbstractC7142ki.A05(predicate, A07(0, 9, 27));
        int i = 0;
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.kj != com.google.common.base.Predicate<? super T> */
    public static <T> AbstractC45494C<T> A01(final Iterator<T> unfiltered, final InterfaceC7143kj<? super T> retainIfTrue) {
        AbstractC7142ki.A04(unfiltered);
        AbstractC7142ki.A04(retainIfTrue);
        return new AbstractC5010Bv<T>() { // from class: com.facebook.ads.redexgen.X.2I
             ...
             */
            @Override // com.facebook.ads.redexgen.core.AbstractC5010Bv
            @CheckForNull
            public final T A02() {
    ...
    public static <T> Iterator<T> A02() {
        return EnumC7400p7.A03;
    }

    public static <T> AbstractC45494C<T> A03(@ParametricNullness T value) {
        return new C4976BN(value);
    }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.kj != com.google.common.base.Predicate<? super T> */
    @ParametricNullness
    public static <T> T A05(Iterator<T> iterator, InterfaceC7143kj<? super T> predicate) {
        AbstractC7142ki.A04(iterator);
        AbstractC7142ki.A04(predicate);
        while (iterator.hasNext()) {
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.kj != com.google.common.base.Predicate<? super T> */
    public static <T> boolean A0C(Iterator<T> removeFrom, InterfaceC7143kj<? super T> predicate) {
        AbstractC7142ki.A04(predicate);
        boolean z = false;
        while (modified) {
    ...
    public static boolean A0E(Iterator<?> removeFrom, Collection<?> elementsToRemove) {
        AbstractC7142ki.A04(elementsToRemove);
        boolean z = false;
        while (result) {
