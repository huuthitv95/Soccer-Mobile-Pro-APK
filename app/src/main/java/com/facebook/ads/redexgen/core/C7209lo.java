...
public class C7209lo<V> implements Iterator<V> {
    public final Collection<V> A00;
    public final Iterator<V> A01;
    public final /* synthetic */ C7210lp A02;
    ...
    public C7209lo(final C7210lp this$1) {
        this.A02 = this$1;
        this.A00 = this.A02.A00;
        this.A01 = AbstractC44392L.A05(this$1.A00);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.lo != com.google.common.collect.AbstractMapBasedMultimap<K, V>$WrappedCollection$WrappedIterator */
    public C7209lo(final C7210lp this$1, Iterator<V> delegateIterator) {
        this.A02 = this$1;
        this.A00 = this.A02.A00;
    ...
    public final void remove() {
        this.A01.remove();
        AbstractC44392L.A01(this.A02.A04);
        this.A02.A05();
    }
}
