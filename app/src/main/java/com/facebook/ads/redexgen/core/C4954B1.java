...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.B1 */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C4954B1 {
    ...
    public static int A00(MediaCodecInfo.VideoCapabilities videoCapabilities, int i, int i2, double d) {
        ...
        if (supportedPerformancePoints == null || supportedPerformancePoints.isEmpty() || C4956B3.A07()) {
            return 0;
        }
