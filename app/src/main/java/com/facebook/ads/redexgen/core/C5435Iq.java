...
public final class C5435Iq {
    ...
    public final long A05(InterfaceC7263ms interfaceC7263ms, boolean z, boolean z2, int i) throws IOException {
        if (this.A01 == 0) {
            if (!interfaceC7263ms.AHR(this.A02, 0, 1, z)) {
                return -1L;
            }
        ...
        if (this.A00 != 1) {
            interfaceC7263ms.readFully(this.A02, 1, this.A00 - 1);
        }
        this.A01 = 0;
