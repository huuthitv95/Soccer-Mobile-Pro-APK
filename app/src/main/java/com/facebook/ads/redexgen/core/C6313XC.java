...
public final class C6313XC {
    ...
    public static int A00(C6902gi c6902gi, int i) {
        return AbstractC6264WN.A00(c6902gi).getInt(A01(0, 21, 52), i);
    }

    public static String A02(C6902gi c6902gi, String str) {
        int iA00 = A00(c6902gi, -1);
        if (iA00 == -1) {
            return null;
        }
        try {
    ...
    public final InterstitialAd A06(C6902gi c6902gi, String str, String str2) {
        if (c6902gi == null) {
            return null;
        }
        try {
            InterstitialAd interstitialAd = new InterstitialAd(c6902gi, str);
    ...
    public final RewardedVideoAd A07(C6902gi c6902gi, String str, String str2) {
        if (c6902gi == null) {
            return null;
        }
        try {
            RewardedVideoAd rewardedVideoAd = new RewardedVideoAd(c6902gi, str);
    ...
    public final void A08(C6902gi c6902gi, boolean z) {
        int i = 0;
        String strA01 = A01(0, 21, 52);
        if (!z) {
            int lastNonChainedAds = AbstractC6264WN.A00(c6902gi).getInt(strA01, 0);
            i = lastNonChainedAds + 1;
        }
        AbstractC6264WN.A00(c6902gi).edit().putInt(strA01, i).apply();
    }

    public final boolean A09(C6902gi c6902gi, String str, int i) {
        if (i <= 0) {
            return false;
        }
        try {
            if (!A05(str)) {
                int lastNonChainedAds = A00(c6902gi, i - 1);
