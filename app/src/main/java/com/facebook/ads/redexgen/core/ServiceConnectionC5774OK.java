...
public class ServiceConnectionC5774OK implements ServiceConnection {
    ...
    public final /* synthetic */ HandlerC5775OL A00;

    public ServiceConnectionC5774OK(HandlerC5775OL handlerC5775OL) {
        this.A00 = handlerC5775OL;
    }
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        HandlerC5775OL handlerC5775OL = this.A00;
        if (A01[3].length() != 26) {
