...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.F2 */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C5201F2 extends FrameLayout implements InterfaceC6774ee {
    public TextView A00;
    public TextView A01;
    public TextView A02;
    public TextView A03;
    ...
    public static final int A0E = (int) (AbstractC6334XX.A02 * 6.0f);
    public static final int A0D = (int) (AbstractC6334XX.A02 * 8.0f);
    public static final int A0C = (int) (AbstractC6334XX.A02 * 12.0f);
    public static final int A0A = (int) (AbstractC6334XX.A02 * 350.0f);
    public static final int A09 = (int) (AbstractC6334XX.A02 * 250.0f);
    public static final int A0B = (int) (AbstractC6334XX.A02 * 175.0f);

    public C5201F2(C6902gi c6902gi, NativeAd nativeAd, C6221Vd c6221Vd, EnumC6222Ve enumC6222Ve, C6595bk c6595bk, MediaView mediaView, AdOptionsView adOptionsView) {
        super(c6902gi);
        this.A07 = new ArrayList<>();
        this.A05 = nativeAd;
        this.A04 = mediaView;
        this.A06 = new C6775ef(c6902gi, this.A05, c6221Vd, c6595bk, adOptionsView);
        this.A06.setPadding(A0C, A0C, A0C, A0E);
        addView(this.A06, new FrameLayout.LayoutParams(-1, -2));
        if (enumC6222Ve == EnumC6222Ve.A09 || enumC6222Ve == EnumC6222Ve.A0B) {
            A07(c6221Vd);
        }
        addView(this.A04, new FrameLayout.LayoutParams(-1, -2));
        if (enumC6222Ve != EnumC6222Ve.A0B || this.A05.getAdCreativeType() != NativeAd.AdCreativeType.CAROUSEL) {
            A06(c6221Vd);
            A04(c6221Vd);
            A05(c6221Vd);
        }
        this.A07.add(c6595bk);
    ...
    private void A02(int i) {
        AbstractC6374YB.A0O(this.A04, i > A0B ? 0 : 8);
        AbstractC6374YB.A0O(this.A03, i > A0A ? 0 : 8);
        AbstractC6374YB.A0O(this.A00, i <= A09 ? 8 : 0);
    }

    public static void A03(int i, int i2, TextView... textViewArr) {
        for (TextView textView : textViewArr) {
            if (textView != null && textView.getVisibility() == 0) {
                int iA04 = AbstractC6374YB.A04(textView, i2);
    ...
    public final void onLayout(boolean z, int i, int i2, int i3, int i4) {
        C6775ef c6775ef = this.A06;
        int top = this.A06.getMeasuredHeight();
        c6775ef.layout(i, i2, i3, top + i2);
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (emptySpace == 0) {
            ...
            if (emptySpace2 == 0 || ((C6932hC) this.A04.getMediaViewApi()).A0b()) {
                iMin = iA00;
            } else {
