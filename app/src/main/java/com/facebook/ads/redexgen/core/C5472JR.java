...
public final class C5472JR {
    ...
    public C5472JR(C5469JO c5469jo, long[] jArr, int[] iArr, int i, long[] jArr2, int[] iArr2, long j) {
        AbstractC45353y.A07(iArr.length == jArr2.length);
        AbstractC45353y.A07(jArr.length == jArr2.length);
        AbstractC45353y.A07(iArr2.length == jArr2.length);
        this.A03 = c5469jo;
        this.A06 = jArr;
        this.A05 = iArr;
        this.A00 = i;
    ...
    public final int A00(long j) {
        for (int iA0L = AbstractC46115C.A0L(this.A07, j, true, false); iA0L >= 0; iA0L--) {
    ...
    public final int A01(long j) {
        for (int i = AbstractC46115C.A0K(this.A07, j, true, false); i < startIndex; i++) {
