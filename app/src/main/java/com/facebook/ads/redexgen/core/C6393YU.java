...
public final class C6393YU implements SensorEventListener {
    ...
    public final Set<InterfaceC6392YT> A09 = new CopyOnWriteArraySet();
    ...
    public static void A02() {
        A0A = new byte[]{122, 76, 71, 90, 70, 91, 90, 9, 71, 70, 93, 9, 90, 92, 89, 89, 70, 91, 93, 76, 77, 5, 62, 55, Base64.padSymbol, 63, 56, 49, 118, 56, 57, 34, 118, 37, 35, 38, 38, 57, 36, 34, 51, 50, Ascii.f22491EM, Ascii.f22499SI, 4, Ascii.f22491EM, 5, Ascii.CAN};
    }
    ...
    public C6393YU(C6902gi c6902gi) {
        this.A08 = c6902gi;
    }
    ...
    public final void A03(InterfaceC6392YT interfaceC6392YT) {
        if (this.A09.isEmpty()) {
            A01();
        } else if (this.A09.contains(interfaceC6392YT)) {
            return;
        }
        this.A09.add(interfaceC6392YT);
    }
        ...
        if (now - this.A06 > 100) {
            ...
            if (speed > 800.0f) {
                ...
                if (i >= 3 && now - this.A05 > 1000) {
                    this.A05 = now;
                    this.A03 = 0;
                    Iterator<InterfaceC6392YT> it = this.A09.iterator();
                    while (it.hasNext()) {
                        it.next().AFv();
                    }
                }
