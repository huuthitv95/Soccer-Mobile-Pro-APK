...
public final class C6535am extends LinearLayout {
    ...
    public static void A02() {
        A04 = new byte[]{Ascii.f22498RS, 2, 2, 6, 5};
    }

    static {
        A02();
        A06 = AbstractC6332XV.A05;
    }

    public C6535am(C6902gi c6902gi) {
        super(c6902gi);
        this.A03 = c6902gi;
        A01();
    }
    ...
    private void A01() {
        ...
        this.A01.setCompoundDrawablePadding(AbstractC6332XV.A0A);
    ...
    private Bitmap getPadlockBitmap() {
        if (this.A00 == null) {
            this.A00 = AbstractC6386YN.A01(EnumC6385YM.BROWSER_PADLOCK_V2);
