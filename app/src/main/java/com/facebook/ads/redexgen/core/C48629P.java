...
public final class C48629P {
    ...
    public final void A00(AudioTrack audioTrack) {
        ...
        audioTrack.registerStreamEventCallback(new ExecutorC48609N(handler), this.A00);
    }
