...
public final class C6536an extends LinearLayout {
    ...
    public static void A02() {
        A04 = new byte[]{6, Ascii.SUB, Ascii.SUB, Ascii.f22498RS, Ascii.f22494GS};
    }

    static {
        A02();
        A06 = AbstractC6332XV.A0O;
    }

    public C6536an(C6902gi c6902gi) {
        super(c6902gi);
        this.A03 = c6902gi;
        A01();
    }
    ...
    private Drawable getPadlockDrawable() {
        if (this.A00 == null) {
            this.A00 = AbstractC6386YN.A03(this.A03, EnumC6385YM.BROWSER_PADLOCK);
        }
        return this.A00;
    }
