...
import com.facebook.ads.redexgen.core.AbstractC7392oz;
import com.facebook.ads.redexgen.core.C466261;
import com.facebook.ads.redexgen.core.C7393p0;
import com.google.common.base.Ascii;
import java.util.ArrayDeque;
import java.util.Arrays;

/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.oy */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public abstract class AbstractC7391oy<I extends C7393p0, O extends AbstractC7392oz, E extends C466261> implements InterfaceC466160<I, O, E> {
    ...
    public static void A0S() {
        A0D = new byte[]{-32, 19, 10, -21, 7, -4, Ascii.DC4, 0, Ascii.f22490CR, -43, -18, 4, 8, Ascii.f22503VT, 7, 0, -33, 0, -2, 10, -1, 0, Ascii.f22490CR};
    }
    ...
    public AbstractC7391oy(I[] iArr, O[] oArr) {
        this.A0B = iArr;
    ...
    public final I A5r() throws C466261 {
        I i;
        I i2;
        synchronized (this.A07) {
            A0Q();
            AbstractC45353y.A08(this.A04 == null);
            if (this.A00 == 0) {
                i = null;
            } else {
                I[] iArr = this.A0B;
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.oy != com.facebook.ads.androidx.media3.decoder.SimpleDecoder<I extends com.facebook.ads.redexgen.X.p0, O extends com.facebook.ads.redexgen.X.oz, E extends com.facebook.ads.redexgen.X.61> */
    private void A0Q() throws E, C466261 {
    ...
    public final O A5t() throws C466261 {
        synchronized (this.A07) {
            A0Q();
            if (this.A0A.isEmpty()) {
                return null;
    ...
    public final void A0d(int i) {
        AbstractC45353y.A08(this.A00 == this.A0B.length);
        for (I i2 : this.A0B) {
            i2.A0C(i);
        }
    }
    ...
    public final void AHJ(I inputBuffer) throws C466261 {
        synchronized (this.A07) {
            A0Q();
            AbstractC45353y.A07(inputBuffer == this.A04);
