...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.K7 */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C5514K7 {
    ...
    public C5514K7(int i, int i2, int i3, int i4, int i5) {
        this.A02 = i;
        this.A00 = i2;
        this.A03 = i3;
        this.A04 = i4;
    ...
    public static C5514K7 A00(String str) {
        int i = -1;
        int i2 = -1;
        int i3 = -1;
        int i4 = -1;
        String strA01 = A01(1, 7, 78);
        AbstractC45353y.A07(str.startsWith(strA01));
        ...
        while (true) {
            ...
            if (i5 < startTimeIndex2) {
                String strA02 = AbstractC7107k7.A01(keys[i5].trim());
                ...
                if (i != -1 && i2 != -1 && i4 != -1) {
                    return new C5514K7(i, i2, i3, i4, keys.length);
                }
                return null;
            }
        }
