...
public class RunnableC5955RJ implements Runnable {
    ...
    public int A02;
    public int A03;
    public final /* synthetic */ C47457M A06;
    public Interpolator A00 = C47457M.A1A;
    ...
    public static void A03() {
        byte[] bArr = {SignedBytes.MAX_POWER_OF_TWO, 68, Ascii.f22500SO, 65, 81, 96, 93, 90, 90};
        String[] strArr = A08;
    ...
    public RunnableC5955RJ(C47457M c47457m) {
        this.A06 = c47457m;
        this.A01 = new OverScroller(c47457m.getContext(), C47457M.A1A);
    }
    ...
    private int A01(int i, int i2, int i3, int i4) {
        ...
        C47457M c47457m = this.A06;
        int width = duration != 0 ? c47457m.getWidth() : c47457m.getHeight();
    ...
    public final void A07() {
        if (this.A04) {
            ...
            AbstractC5857Ph.A0D(this.A06, this);
        }
    }
    ...
    public final void run() {
        ...
        this.A06.A1K();
        OverScroller overScroller = this.A01;
        AbstractC5951RF abstractC5951RF = this.A06.A06.A02;
        if (overScroller.computeScrollOffset()) {
            ...
            if (this.A06.A04 != null) {
                this.A06.A1L();
                this.A06.A1M();
                AbstractC5820P4.A01(A02(0, 9, 115));
                C47457M c47457m = this.A06;
                C5953RH c5953rh = this.A06.A0s;
                String[] strArr = A08;
                ...
                c47457m.A1j(c5953rh);
                if (vresult != 0) {
                    AbstractC5938R2 abstractC5938R2 = this.A06.A06;
                    C5946RA c5946ra = this.A06.A0r;
                    C47457M c47457m2 = this.A06;
                    if (A08[4].charAt(19) != '9') {
                        A08[4] = "aF9lT9JucYAVgVWisB0rNkK4be7J2iGb";
                        iA1f = abstractC5938R2.A1f(vresult, c5946ra, c47457m2.A0s);
                        i = vresult - iA1f;
                    } else {
                        iA1f = abstractC5938R2.A1f(vresult, c5946ra, c47457m2.A0s);
                        i = vresult - iA1f;
                ...
                if (velX != 0) {
                    AbstractC5938R2 abstractC5938R3 = this.A06.A06;
                    C5946RA c5946ra2 = this.A06.A0r;
                    if (A08[4].charAt(19) != 57) {
                        String[] strArr3 = A08;
                        strArr3[7] = "UcFH7yF8zZNprQitZtXhkmlCMHIdnioP";
                        strArr3[0] = "hCBROqFKcvdbLIHuO2wEis8Nwj1iktft";
                        iA1g = abstractC5938R3.A1g(velX, c5946ra2, this.A06.A0s);
                        i2 = velX - iA1g;
                    } else {
                        iA1g = abstractC5938R3.A1g(velX, c5946ra2, this.A06.A0s);
                        i2 = velX - iA1g;
                ...
                this.A06.A1N();
                this.A06.A1p(false);
                if (abstractC5951RF != null && !abstractC5951RF.A0E() && abstractC5951RF.A0F()) {
                    int x = this.A06.A0s.A03();
                    if (x == 0) {
                        abstractC5951RF.A09();
                    } else if (abstractC5951RF.A07() >= x) {
                        abstractC5951RF.A0A(x - 1);
                        abstractC5951RF.A04(vresult - i, velX - i2);
                    } else {
                        int y = vresult - i;
                        if (A08[4].charAt(19) != 57) {
                            String[] strArr4 = A08;
            ...
            if (iA1f != 0 || iA1g != 0) {
                C47457M c47457m4 = this.A06;
                if (A08[6].length() != 25) {
                    A08[3] = "MhQkdHLAPY6K0mrvY0I8ZqPtgRA1J8Gx";
                    c47457m4.A1d(iA1f, iA1g);
                } else {
        ...
        if (abstractC5951RF != null) {
            if (abstractC5951RF.A0E()) {
                abstractC5951RF.A04(0, 0);
            }
            if (!this.A05) {
                abstractC5951RF.A09();
            }
