...
public final class C4967BE<V> implements InterfaceC7153ku<List<V>>, Serializable {
    ...
    public static void A02() {
        byte[] bArr = {10, Ascii.f22494GS, Ascii.NAK, 10, 8, Ascii.f22491EM, 10, 9, -5, 6, 17, Ascii.SUB, 10, Ascii.CAN, -11, 10, Ascii.ETB, -16, 10, Ascii.f22498RS};
        String[] strArr = A02;
    ...
    public C4967BE(int expectedValuesPerKey) {
        this.A00 = AbstractC7289nJ.A00(expectedValuesPerKey, A00(0, 20, 92));
    }
