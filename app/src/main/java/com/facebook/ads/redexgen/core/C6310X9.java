...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.X9 */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C6310X9 implements InterfaceC5786OW {
    public static C6310X9 A01;
    ...
    public final LinkedHashMap<String, C6184V2> A00 = new LinkedHashMap<>();
    ...
    static {
        A02();
        A04 = C6310X9.class.getSimpleName();
    }

    public static C6310X9 A00() {
        if (A01 == null) {
            A01 = new C6310X9();
        }
        return A01;
    ...
    public final InterfaceC5770OG A03(String str) {
        C6184V2 adRecord = this.A00.get(str);
        if (adRecord != null) {
            return adRecord.A00;
        }
        String[] strArr = A03;
    ...
    public final C6184V2 A04(String str) {
        return this.A00.get(str);
    }

    public final C6184V2 A05(String str, Messenger messenger, String str2) {
        C6184V2 c6184v2 = new C6184V2(str, messenger, str2);
        this.A00.put(str, c6184v2);
        return c6184v2;
    }

    public final void A06() {
        Iterator<Map.Entry<String, C6184V2>> it = this.A00.entrySet().iterator();
        while (true) {
            ...
            if (zHasNext) {
                InterfaceC5770OG interfaceC5770OG = it.next().getValue().A00;
                if (interfaceC5770OG != null) {
                    interfaceC5770OG.destroy();
                }
                it.remove();
            } else {
                return;
    ...
    public final void A08(String str) {
        C6184V2 c6184v2 = this.A00.get(str);
        if (c6184v2 != null && c6184v2.A00 != null) {
    ...
    public final void AEs(int i, String str, Bundle bundle) {
        ...
        Iterator<Map.Entry<String, C6184V2>> it = this.A00.entrySet().iterator();
        while (it.hasNext()) {
            C6184V2 value = it.next().getValue();
            try {
