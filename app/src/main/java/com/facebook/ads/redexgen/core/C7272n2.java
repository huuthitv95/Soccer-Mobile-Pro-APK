...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.n2 */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C7272n2 implements InterfaceC5265G5 {
    ...
    public C7272n2(WindowManager windowManager) {
        this.A00 = windowManager;
    }

    public static C7272n2 A00(Context context) {
        WindowManager windowManager = (WindowManager) context.getSystemService(A01(0, 6, 15));
        if (windowManager != null) {
            return new C7272n2(windowManager);
        }
        return null;
    }
    ...
    public final void AHX(InterfaceC5264G4 interfaceC5264G4) {
        interfaceC5264G4.ADd(this.A00.getDefaultDisplay());
    }
