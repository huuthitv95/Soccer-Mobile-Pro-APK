...
public final class C5977Rf implements AudienceNetworkActivityApi {
    ...
    public C5977Rf(AudienceNetworkActivity audienceNetworkActivity, AudienceNetworkActivityApi audienceNetworkActivityApi, C5976Re c5976Re) {
    ...
    private void A02(Throwable th) {
        ...
        this.A02.A09();
        finish(8);
        C6067T8 logContext = this.A02.A06();
        if (logContext != null) {
            logContext.A08().ABC(A00(38, 11, 116), AbstractC6098Td.A0C, new C6099Te(th));
            return;
        }
