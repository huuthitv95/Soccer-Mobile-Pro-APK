...
public final class C6582bX extends View {
    ...
    static {
        A01();
        A0G = (int) (AbstractC6334XX.A02 * 5.0f);
        A0H = (int) (AbstractC6334XX.A02 * 4.0f);
        A0I = (int) (AbstractC6334XX.A02 * 10.0f);
    }

    public C6582bX(C6902gi c6902gi, boolean z) {
        super(c6902gi);
    ...
    public final void A03(int i, int i2, int i3, boolean z) {
        ...
        if (z) {
            this.A0A.setColorFilter(new PorterDuffColorFilter(AbstractC5819P3.A02(i2, i3), PorterDuff.Mode.SRC_ATOP));
        }
    }
    ...
    public void setImage(EnumC6385YM enumC6385YM) {
        this.A04 = enumC6385YM == null ? null : AbstractC6386YN.A01(enumC6385YM);
        invalidate();
    }
