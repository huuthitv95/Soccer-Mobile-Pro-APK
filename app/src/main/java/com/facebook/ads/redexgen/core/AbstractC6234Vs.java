...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.Vs */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public abstract class AbstractC6234Vs {
    ...
    public static EnumC6232Vq A00(DisplayMetrics displayMetrics) {
        int i = (int) (displayMetrics.widthPixels / displayMetrics.density);
        int screenWidth = displayMetrics.heightPixels;
        int screenHeight = (int) (screenWidth / displayMetrics.density);
        if (C6335XY.A04(i, screenHeight)) {
            return EnumC6232Vq.A0I;
        }
        if (screenHeight > i) {
            EnumC6232Vq enumC6232Vq = EnumC6232Vq.A0K;
            String[] strArr = A00;
            String str = strArr[5];
        ...
        return EnumC6232Vq.A0H;
    }

    public static void A01(DisplayMetrics displayMetrics, View view, EnumC6231Vp enumC6231Vp) {
        int iCeil;
        int i = (int) (displayMetrics.widthPixels / displayMetrics.density);
        int screenWidth = enumC6231Vp.A04();
        if (i >= screenWidth) {
            iCeil = displayMetrics.widthPixels;
        } else {
            int screenWidth2 = enumC6231Vp.A04();
            iCeil = (int) Math.ceil(screenWidth2 * displayMetrics.density);
        }
        int screenWidth3 = enumC6231Vp.A03();
