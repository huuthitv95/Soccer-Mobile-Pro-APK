...
public class C6552b3 extends WebViewClient {
    ...
    public final WeakReference<C5600LV> A03;
    public final WeakReference<InterfaceC6550b1> A04;
    public final WeakReference<AtomicBoolean> A05;
    public final WeakReference<C6365Y2> A06;
    public final WeakReference<C6847fp> A07;
    ...
    public static void A02() {
        byte[] bArr = {8, 38, 40, 45, 42, -14, 8, 52, 51, 57, 55, 52, 49, -69, -36, -27, -32, -36, -37, Ascii.f22493FS, 77, 56, 67, 76, 56, 75, SignedBytes.MAX_POWER_OF_TWO, 69, 62, -9, 44, 41, 32, -9, 39, 56, 75, 63, -9, Base64.padSymbol, 70, 73, -9, Ascii.f22494GS, SignedBytes.MAX_POWER_OF_TWO, 67, 60, -9, Ascii.CAN, 58, 58, 60, 74, 74, -9, -46, 5, 1, -1, -18, -83, -15, -18, 1, -18, -57, -83, 60, 72, 72, 68, Ascii.DC4, 57, 102, 102, 99, 102, 59, 84, 89, 71, 76, 75, 6, 56, 75, 87, 91, 75, 89, 90, 6, 76, 85, 88, 6, 44, 79, 82, 75, 6, 39, 73, 73, 75, 89, 89, 6, 34, 59, SignedBytes.MAX_POWER_OF_TWO, 46, 51, 50, -19, Ascii.f22502US, 50, 62, 66, 50, SignedBytes.MAX_POWER_OF_TWO, 65, -19, 51, 60, 63, -19, 19, 54, 57, 50, -19, Ascii.f22500SO, 48, 48, 50, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, -19, 49, 50, 59, 54, 50, 49, 67, 68, 77, 72, 68, 67, 62, 84, 81, 72, 62, 79, SignedBytes.MAX_POWER_OF_TWO, 83, 71, SignedBytes.MAX_POWER_OF_TWO, 59, 80, 67, Base64.padSymbol, 73, 72, 8, 67, Base64.padSymbol, 73, 41, 44, 47, 40, Ascii.ETB, Ascii.f22500SO, Ascii.f22494GS, -29, -29, -18, -5, -5, 8, -18, -10, -7, -3, 2, 8, -5, -18, -4, -7, -8, -9, -4, -18, Ascii.ESC, Ascii.f22493FS, -38, 32, 33, Ascii.f22493FS, Ascii.f22502US, Ascii.DC2, 98, 85, 97, 101, 85, 99, 100, 79, 89, 84, 78, 63, 82, 78, 9, 74, 70, 59, 67, 72, 5, -16, -5, -8, -13, -18, -1, -16, 3, -9, 55, 37, 34, Ascii.f22502US, 54, 41, 37, 55};
        String[] strArr = A0C;
    ...
    public C6552b3(C6902gi c6902gi, WeakReference<InterfaceC6550b1> weakReference, WeakReference<C6847fp> weakReference2, WeakReference<C6365Y2> weakReference3, WeakReference<AtomicBoolean> checkAssetsByJavascriptBridge, WeakReference<C5600LV> weakReference4, AtomicInteger atomicInteger, AtomicReference<String> requestId, boolean z) {
        this.A02 = c6902gi;
    ...
    private final void A04(WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse) {
        ...
        this.A02.A0F().AL2(webResourceResponse.getStatusCode(), AbstractC6338Xb.A01(webResourceResponse.getStatusCode(), A01(67, 10, 126), A01(0, 0, 53) + webResourceRequest.getUrl()));
    }
    ...
    private void A06(String str, String str2) {
        ...
        if (this.A02 != null) {
            this.A02.A08().ABC(A01(236, 8, 74), AbstractC6098Td.A2c, new C6099Te(AdErrorType.WEB_VIEW_CACHE_FILE_WAS_DENIED.getDefaultErrorMessage(), A01(55, 12, 23) + jSONObject.toString()));
        }
    }
    ...
    private boolean A07(Uri uri) {
        ...
        if (scheme.equals(path3)) {
            ...
            List<String> listA09 = C6056Sx.A09(this.A02);
    ...
    public final void onPageStarted(WebView webView, String str, Bitmap bitmap) {
        ...
        this.A02.A0F().AL0();
        this.A00 = new Date();
        new Handler().postDelayed(new C5601LW(this), this.A08.get());
    }
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) {
        boolean zA12 = C6171Up.A12(this.A02);
        ...
        if (zA12 || webResourceRequest.isForMainFrame()) {
            ...
            this.A02.A0F().AL1(AbstractC6338Xb.A01(webResourceError.getErrorCode(), strA01 + ((Object) webResourceError.getDescription()), strA01 + webResourceRequest.getUrl()));
        }
    }
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        AbstractC6547ay.A0D(AbstractC6098Td.A2b);
        InterfaceC6550b1 adWebViewListener = this.A04.get();
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        if (this.A04.get() != null) {
            this.A04.get().ADN(str, new C6558b9().A03(this.A07.get()).A02(this.A06.get()).A05());
        }
