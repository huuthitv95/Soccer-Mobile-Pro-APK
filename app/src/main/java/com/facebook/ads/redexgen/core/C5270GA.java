...
public final class C5270GA {
    ...
    public final C5268G8 A0A;
    public final ChoreographerFrameCallbackC5269G9 A0B;
    ...
    public C5270GA(Context context) {
        if (context != null) {
        ...
        if (this.A09 != null) {
            this.A0A = AbstractC46115C.A02 >= 17 ? A01(context) : null;
            this.A0B = ChoreographerFrameCallbackC5269G9.A00();
        } else {
            this.A0A = null;
            this.A0B = null;
        }
