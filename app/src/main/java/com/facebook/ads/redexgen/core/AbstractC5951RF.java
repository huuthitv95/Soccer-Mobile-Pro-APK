...
public abstract class AbstractC5951RF {
    public static byte[] A07;
    public View A01;
    public AbstractC5938R2 A02;
    public C47457M A03;
    public boolean A04;
    public boolean A05;
    public int A00 = -1;
    public final C5949RD A06 = new C5949RD(0, 0);
    ...
    public abstract void A0H(int i, int i2, C5953RH c5953rh, C5949RD c5949rd);

    public abstract void A0I(View view, C5953RH c5953rh, C5949RD c5949rd);
    ...
    public void A04(int i, int i2) {
        ...
        if (!this.A05 || this.A00 == -1 || c47457m == null) {
            A09();
        }
        this.A04 = false;
        if (this.A01 != null) {
            if (A00(this.A01) == this.A00) {
                A0I(this.A01, c47457m.A0s, this.A06);
                this.A06.A05(c47457m);
                A09();
            } else {
    ...
    public final AbstractC5938R2 A08() {
        return this.A02;
    }
    ...
    public final void A0D(C47457M c47457m, AbstractC5938R2 abstractC5938R2) {
        this.A03 = c47457m;
