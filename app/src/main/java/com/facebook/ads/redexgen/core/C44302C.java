...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.2C */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public class C44302C<K, V> extends AbstractC4977BO<Map.Entry<K, V>> {
    public final transient int A00;
    public final transient int A01;
    public final transient AbstractC7364oX<K, V> A02;
    ...
    public C44302C(AbstractC7364oX<K, V> map, Object[] alternatingKeysAndValues, int keyOffset, int size) {
        this.A02 = map;
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2C != com.google.common.collect.RegularImmutableMap$EntrySet<K, V> */
    @Override // com.facebook.ads.redexgen.core.AbstractC4977BO
    public final AbstractC4978BP<Map.Entry<K, V>> A0M() {
        return new AbstractC4978BP<Map.Entry<K, V>>() { // from class: com.facebook.ads.redexgen.X.2D
            /* JADX INFO: Access modifiers changed from: private */
            @Override // java.util.List
            /* JADX INFO: renamed from: A00, reason: merged with bridge method [inline-methods] */
            public final Map.Entry<K, V> get(int index) {
                AbstractC7142ki.A00(index, this.A00.A01);
    ...
    public final AbstractC45494C<Map.Entry<K, V>> iterator() {
        return A0J().iterator();
    }
