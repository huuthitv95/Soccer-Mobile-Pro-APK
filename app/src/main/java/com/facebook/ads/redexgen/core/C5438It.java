...
public class C5438It extends AbstractC6547ay {
    ...
    public final void onMeasure(int i, int i2) {
        ...
        int iA01 = A00(dynamicWebViewHeight, height, i2);
        if ((z2 || z) && Math.abs((iA00 / iA01) - f) > 1.0E-7d) {
            boolean z3 = false;
            if (z2) {
                iA01 = (int) (iA00 / f);
                z3 = true;
    ...
    public C5438It(C6685dC c6685dC, C6902gi c6902gi) {
        super(c6902gi);
        this.A00 = c6685dC;
    ...
    public final WebChromeClient A0G() {
        return new C6680d7(this.A00);
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC6547ay
    public final WebViewClient A0H() {
        return new C6681d8(this.A00);
    }
