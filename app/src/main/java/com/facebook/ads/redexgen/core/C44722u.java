...
public final class C44722u {
    ...
    public String A07;
    public String A08;
    public C44732v A01 = new C44732v();
    public C44752x A02 = new C44752x();
    public List<StreamKey> A09 = Collections.emptyList();
    public List<MediaItem.SubtitleConfiguration> A0A = Collections.emptyList();
    public C447830 A03 = new C447830();

    public final C44722u A00(Uri uri) {
        this.A00 = uri;
        return this;
    }

    public final C44722u A01(Object obj) {
        this.A05 = obj;
        return this;
    }

    public final C44722u A02(String str) {
        this.A06 = str;
        return this;
    }

    public final C44722u A03(String str) {
        this.A07 = (String) AbstractC45353y.A01(str);
        return this;
    }

    /* JADX WARN: Code duplicated, block: B:10:0x002f  */
    public final C44722u A04(List<StreamKey> list) {
    ...
    public final C7461q7 A05() {
        boolean z;
        if (this.A02.A00 != null) {
            C44752x c44752x = this.A02;
        ...
        C7463q9 c7463q9 = null;
        Uri uri = this.A00;
        if (uri != null) {
            c7463q9 = new C7463q9(uri, this.A08, this.A02.A03 != null ? this.A02.A08() : null, null, this.A09, this.A06, this.A0A, this.A05);
        }
        return new C7461q7(this.A07 != null ? this.A07 : "", this.A01.A0B(), c7463q9, this.A03.A05(), this.A04 != null ? this.A04 : C7456q2.A0Z);
    }
}
