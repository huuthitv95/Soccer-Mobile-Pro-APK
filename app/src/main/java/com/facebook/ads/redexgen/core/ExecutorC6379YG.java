...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.YG */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class ExecutorC6379YG implements Executor {
    ...
    static {
        A04();
        A08 = new ExecutorC6379YG(A00(7, 7, 23), 0);
        A06 = new ExecutorC6379YG(A00(0, 5, 64), 0);
        A07 = new ExecutorC6379YG(A00(5, 2, 11), 0);
        A03 = 32;
        A0C = Executors.newSingleThreadExecutor();
        A0B = Executors.newFixedThreadPool(5);
        A0D = new AtomicBoolean();
        A0E = new AtomicBoolean();
        A0A = Executors.newCachedThreadPool(new ThreadFactoryC6377YE());
        A09 = new ThreadPoolExecutor(1, 1, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue());
    }

    public ExecutorC6379YG(String str, int i) {
        this.A02 = i;
        int CPU_COUNT = Runtime.getRuntime().availableProcessors();
        this.A01 = new ThreadPoolExecutor(Math.max(2, Math.min(CPU_COUNT - 1, 4)), (CPU_COUNT * 2) + 1, 30L, TimeUnit.SECONDS, new LinkedBlockingQueue(), new ThreadFactoryC6378YF(this, str));
    ...
    public static void A05(Context context) {
        A0D.set(C6171Up.A2s(context));
        A0E.set(C6171Up.A2r(context));
    }
    ...
    public final void execute(Runnable runnable) {
        ...
        synchronized (ExecutorC6379YG.class) {
            int i = A03;
            ...
            if (size == reservedExecutorQueueSize) {
                ...
                if (c6898geA00 != null) {
                    c6898geA00.A08().ABC(A00(42, 7, 34), AbstractC6098Td.A1d, new C6099Te(A00(21, 21, 34), A00(14, 7, 32) + i));
                }
            }
        }
