...
public class C5831PF<K, V> {
    ...
    public int[] A01 = AbstractC5821P5.A01;
    public Object[] A02 = AbstractC5821P5.A03;
    public int A00 = 0;
    ...
    */
    public final V A0A(int r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C5831PF.A0A(int):java.lang.Object");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C5831PF) {
            C5831PF c5831pf = (C5831PF) obj;
            if (size() != c5831pf.size()) {
                return false;
            }
            for (int i = 0; i < this.A00; i++) {
                try {
                    K kA09 = A09(i);
                    V vA0B = A0B(i);
                    Object obj2 = c5831pf.get(kA09);
                    if (vA0B == null) {
                        if (obj2 == null && c5831pf.containsKey(kA09)) {
                        }
                        return false;
                    }
                    if (!vA0B.equals(obj2)) {
    ...
    public static int A02(int[] iArr, int i, int i2) {
        try {
            return AbstractC5821P5.A02(iArr, i, i2);
    ...
    public final void clear() {
        if (this.A00 > 0) {
            ...
            Object[] objArr = this.A02;
            int i = this.A00;
            int[] ohashes = AbstractC5821P5.A01;
            this.A01 = ohashes;
            this.A02 = AbstractC5821P5.A03;
            this.A00 = 0;
            A06(iArr, objArr, i);
        }
        if (this.A00 <= 0) {
