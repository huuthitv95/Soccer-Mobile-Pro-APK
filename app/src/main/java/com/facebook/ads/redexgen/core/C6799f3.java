...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.f3 */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public class C6799f3 extends AbstractRunnableC6279Wc {
    public static byte[] A05;
    public final /* synthetic */ int A00;
    public final /* synthetic */ C6067T8 A01;
    public final /* synthetic */ InterfaceC6091TW A02;
    public final /* synthetic */ C6099Te A03;
    ...
    public C6799f3(C6067T8 c6067t8, String str, int i, C6099Te c6099Te, InterfaceC6091TW interfaceC6091TW) {
        this.A01 = c6067t8;
        this.A04 = str;
        this.A00 = i;
        this.A03 = c6099Te;
        this.A02 = interfaceC6091TW;
    }
    ...
    public final void A07() {
        ...
        String strA8L;
        try {
            if (C6092TX.A0K(this.A01, this.A04, this.A00, this.A03)) {
                return;
            }
            C6203VL.A08(this.A01, EnumC6195VD.A0A.toString() + A00(0, 1, 50) + this.A04);
            Throwable cause = this.A03.getCause();
            if (cause != null) {
                strA03 = AbstractC6356Xt.A03(this.A01, cause);
            } else if (AbstractC6173Ur.A0R(this.A01)) {
                C6067T8 c6067t8 = this.A01;
                Throwable deLogExceptionCause = this.A03;
                strA03 = AbstractC6356Xt.A03(c6067t8, deLogExceptionCause);
            } else {
                strA03 = A00(0, 0, 81) + this.A03.getMessage();
            }
            if (AbstractC6173Ur.A0V(this.A01)) {
                mapA5a = this.A01.A04().A5a();
            } else if (this.A02 != null) {
                mapA5a = this.A02.A7z();
            } else if (C6092TX.A02) {
                C6092TX.A0F(new RuntimeException(A00(1, 57, 84), this.A03));
                mapA5a = new HashMap<>();
            } else {
                mapA5a = this.A01.A04().A5a();
            }
            ...
            InterfaceC6090TV interfaceC6090TV = (InterfaceC6090TV) C6092TX.A0A.get();
            if (interfaceC6090TV == null) {
                C6092TX.A0F(new RuntimeException(A00(58, 13, 23)));
            } else {
                interfaceC6090TV.AL5(strA03, mapA5a, this.A01);
            }
        } catch (Throwable t) {
            C6092TX.A0F(t);
        }
