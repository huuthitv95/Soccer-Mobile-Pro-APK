...
public final class C5061Cm implements InterfaceC6852fu {
    ...
    public C5061Cm(HttpURLConnection httpURLConnection, byte[] bArr) {
        try {
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC6852fu
