...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.LM */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class AsyncTaskC5591LM extends AsyncTask<String, Void, Bitmap[]> implements InterfaceC6063T4 {
    ...
    public int A00;
    public int A01;
    public InterfaceC6557b8 A02;
    public boolean A03;
    public final int A04;
    public final int A05;
    public final WeakReference<C6554b5> A06;
    public final WeakReference<C6902gi> A07;
    ...
    private final Bitmap[] A03(String... strArr) throws Throwable {
        ...
        try {
            ...
            try {
                bitmapA0O = new C6056Sx(c6902gi).A0O(str, this.A00, this.A01);
                if (bitmapA0O != null && !this.A03) {
                    bitmapA01 = AbstractC6384YL.A01(c6902gi, bitmapA0O, this.A04, this.A05);
                }
            } catch (Throwable th) {
                c6902gi.A08().ABC(A00(0, 7, 30), AbstractC6098Td.A1V, new C6099Te(th));
            }
    ...
    public AsyncTaskC5591LM(ViewGroup viewGroup, int i, int i2, C6902gi c6902gi) {
        this.A03 = false;
        this.A00 = -1;
        this.A01 = -1;
        this.A07 = new WeakReference<>(c6902gi);
        this.A06 = null;
        this.A08 = null;
    ...
    public AsyncTaskC5591LM(ViewGroup viewGroup, C6902gi c6902gi) {
        this(viewGroup, 12, 16, c6902gi);
    }

    public AsyncTaskC5591LM(ImageView imageView, C6902gi c6902gi) {
        this.A03 = false;
        this.A00 = -1;
        this.A01 = -1;
        this.A07 = new WeakReference<>(c6902gi);
    ...
    public AsyncTaskC5591LM(C6554b5 c6554b5, C6902gi c6902gi) {
        this.A03 = false;
        this.A00 = -1;
        this.A01 = -1;
        this.A07 = new WeakReference<>(c6902gi);
        this.A06 = new WeakReference<>(c6554b5);
        this.A08 = null;
        this.A09 = null;
        this.A04 = 12;
        this.A05 = 16;
    ...
    private final void A02(Bitmap[] bitmapArr) throws Throwable {
        ...
        try {
            ...
            if (this.A06 != null && (c6554b5 = this.A06.get()) != null) {
                c6554b5.setImage(bitmapArr[0], bitmapArr[1]);
            }
            if (this.A09 != null && this.A09.get() != null && bitmapArr[1] != null) {
                AbstractC6374YB.A0V(this.A09.get(), new BitmapDrawable(this.A07.get().getResources(), bitmapArr[1]));
            }
            if (this.A02 != null) {
                this.A02.AE7(new C6556b7(bitmapArr[0]));
            }
        } catch (Throwable th) {
    ...
    public final AsyncTaskC5591LM A04() {
        this.A00 = -1;
        this.A01 = -1;
        return this;
    }

    public final AsyncTaskC5591LM A05(int i, int i2) {
        this.A00 = i;
        this.A01 = i2;
        return this;
    }

    public final AsyncTaskC5591LM A06(InterfaceC6557b8 interfaceC6557b8) {
        this.A02 = interfaceC6557b8;
        return this;
    }
    ...
    public final void A07(String str) {
        if (TextUtils.isEmpty(str)) {
            if (this.A02 != null) {
                this.A02.AE7(new C6556b7(null));
                return;
            }
            return;
        }
        executeOnExecutor(ExecutorC6379YG.A06, str);
    }
