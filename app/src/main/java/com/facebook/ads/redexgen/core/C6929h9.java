...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.h9 */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public class C6929h9 extends C5870Pv {
    public int A00;

    public C6929h9(Context context) {
        super(context);
        this.A00 = 0;
    }
    ...
    @Override // com.facebook.ads.redexgen.core.C5870Pv, android.view.View
