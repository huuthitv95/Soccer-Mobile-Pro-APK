...
public abstract class AbstractC7355oO<E> extends AbstractCollection<E> implements Serializable {
    ...
    public static void A0F() {
        A00 = new byte[]{-7, Ascii.ETB, 9, -60, -9, 9, Ascii.SYN, Ascii.f22490CR, 5, Ascii.DLE, Ascii.f22490CR, Ascii.f22498RS, 9, 8, -22, 19, Ascii.SYN, 17};
    }

    public abstract int A0I(Object[] dst, int offset);

    public abstract AbstractC4978BP<E> A0J();
    ...
    public final <T> T[] toArray(T[] tArr) {
        AbstractC7142ki.A04(tArr);
        int size = size();
        if (tArr.length < size) {
            Object[] objArrA0L = A0L();
            if (objArrA0L != null) {
                return (T[]) AbstractC7475qN.A02(objArrA0L, A0H(), A0G(), tArr);
            }
            tArr = (T[]) AbstractC7470qG.A05(tArr, size);
