...
public final class C5110DZ extends RelativeLayout implements InterfaceC6790eu {
    ...
    public final AbstractC6143UN A07;
    public final AbstractC6143UN A08;
    public final AbstractC6143UN A09;
    public final AbstractC6143UN A0A;
    ...
    static {
        A03();
        A0D = (int) (AbstractC6334XX.A02 * 8.0f);
        A0E = (int) (AbstractC6334XX.A02 * 6.0f);
    }

    public C5110DZ(C6902gi c6902gi, int i) {
        this(c6902gi, A0E, -12549889, 0, i);
    }

    public C5110DZ(C6902gi c6902gi, int i, int i2) {
        this(c6902gi, i2, -12549889, 0, i);
    }

    public C5110DZ(C6902gi c6902gi, int i, int i2, int i3, int i4) {
        super(c6902gi);
        this.A04 = false;
        this.A01 = -1;
        this.A05 = true;
        this.A0A = new AbstractC5136Dz() { // from class: com.facebook.ads.redexgen.X.33
        ...
        this.A08 = new AbstractC5141E4() { // from class: com.facebook.ads.redexgen.X.31
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.facebook.ads.redexgen.core.AbstractC6143UN
            /* JADX INFO: renamed from: A00, reason: merged with bridge method [inline-methods] */
        ...
        this.A09 = new AbstractC5139E2() { // from class: com.facebook.ads.redexgen.X.2z
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.facebook.ads.redexgen.core.AbstractC6143UN
            /* JADX INFO: renamed from: A00, reason: merged with bridge method [inline-methods] */
        ...
        this.A07 = new AbstractC5147EA() { // from class: com.facebook.ads.redexgen.X.2w
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.facebook.ads.redexgen.core.AbstractC6143UN
            /* JADX INFO: renamed from: A00, reason: merged with bridge method [inline-methods] */
        ...
        this.A00 = i4;
        this.A06 = new ProgressBar(c6902gi, null, R.attr.progressBarStyleHorizontal);
        A08(i2, i3, false);
    ...
    public final void AAv(C5183Ek c5183Ek) {
        this.A03 = c5183Ek;
        c5183Ek.getEventBus().A03(this.A08, this.A09, this.A0A, this.A07);
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC6790eu
    public final void AKV(C5183Ek c5183Ek) {
        c5183Ek.getEventBus().A04(this.A0A, this.A09, this.A08, this.A07);
        this.A03 = null;
    }
