...
public abstract class AbstractC43661A<K, V> extends AbstractC44392L<K, V> implements InterfaceC4975BM<K, V> {
    ...
    public AbstractC43661A(Map<K, Collection<V>> map) {
        super(map);
    }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.1A != com.google.common.collect.AbstractListMultimap<K, V> */
    @Override // com.facebook.ads.redexgen.core.AbstractC44392L, com.facebook.ads.redexgen.core.InterfaceC7457q3
