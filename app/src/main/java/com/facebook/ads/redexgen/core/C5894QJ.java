...
public class C5894QJ implements InterfaceC6354Xr {
    ...
    public C5894QJ(InterfaceC6354Xr interfaceC6354Xr) {
        this.A02 = interfaceC6354Xr;
    }
    ...
    public final void AH8(String str) {
        if (AbstractC6356Xt.A0A(str)) {
            A01();
            this.A02.AH8(str);
            return;
        }
        String strA04 = AbstractC6356Xt.A04(str);
