...
public final class TextureViewSurfaceTextureListenerC5073Cy extends TextureView implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener, MediaPlayer.OnSeekCompleteListener, TextureView.SurfaceTextureListener, InterfaceC6842fk {
    ...
    public EnumC6844fm A0C;
    public EnumC6844fm A0D;
    public InterfaceC6845fn A0E;
    public boolean A0F;
    public boolean A0G;
    public boolean A0H;
    public boolean A0I;
    ...
    public static void A04() {
        A0O = new byte[]{115, 125, 113, 115, -74, -55, -59, -61, -78, 115, 113, -117, 113, 115, -54, 37, -115, -85, -72, -72, -71, -66, 106, -70, -68, -81, -70, -85, -68, -81, 106, -73, -81, -82, -77, -85, 106, -70, -74, -85, -61, -81, -68, 106, -63, -77, -66, -78, 106, -99, -65, -68, -80, -85, -83, -81, -98, -81, -62, -66, -65, -68, -81, -124, 106, -70, -26, -20, -29, -37, -27, -98, -21, -105, -23, -36, -21, -23, -32, -36, -19, -36, -105, -19, -32, -37, -36, -26, -105, -32, -27, -35, -26, -23, -28, -40, -21, -32, -26, -27, -47, -20, -12, -9, -16, -17, -85, -1, -6, -85, -6, -5, -16, -7, -85, -20, -2, -2, -16, -1, -2, -104, -64, -64, -72, -67, -74, 113, -78, -67, -56, -78, -54, -60, 113, -59, -71, -61, -64, -56, 113, -78, -65, 113, -74, -55, -76, -74, -63, -59, -70, -64, -65, 113, -56, -70, -59, -71, 113, -60, -74, -59, -109, -78, -76, -68, -72, -61, -64, -58, -65, -75, -107, -61, -78, -56, -78, -77, -67, -74, 113, -64, -65, 113, -97, -64, -58, -72, -78, -59, 113, -78, -77, -64, -57, -74, 127, 113, -60, -64, 113, -56, -74, 113, -60, -70, -67, -74, -65, -59, -67, -54, 113, -70, -72, -65, -64, -61, -74, 113, -70, -59, 127, -23, 17, 17, 9, Ascii.f22500SO, 7, -62, 3, Ascii.f22500SO, Ascii.f22491EM, 3, Ascii.ESC, Ascii.NAK, -62, Ascii.SYN, 10, Ascii.DC4, 17, Ascii.f22491EM, -62, 3, Ascii.DLE, -62, 7, Ascii.SUB, 5, 7, Ascii.DC2, Ascii.SYN, Ascii.f22503VT, 17, Ascii.DLE, -62, Ascii.f22491EM, Ascii.f22503VT, Ascii.SYN, 10, -62, Ascii.NAK, 7, Ascii.SYN, -24, 17, Ascii.DC4, 7, 9, Ascii.DC4, 17, Ascii.ETB, Ascii.DLE, 6, -62, 17, Ascii.DLE, -62, -16, 17, Ascii.ETB, 9, 3, Ascii.SYN, -62, 3, 4, 17, Ascii.CAN, 7, -48, -62, Ascii.NAK, 17, -62, Ascii.f22491EM, 7, -62, Ascii.NAK, Ascii.f22503VT, Ascii.f22500SO, 7, Ascii.DLE, Ascii.SYN, Ascii.f22500SO, Ascii.ESC, -62, Ascii.f22503VT, 9, Ascii.DLE, 17, Ascii.DC4, 7, -62, Ascii.f22503VT, Ascii.SYN, -48, -47, -22, -35, -34, -24, -31, -100, -16, -21, -100, -33, -24, -21, -17, -31, -13, Ascii.DLE, 7, -66, 17, 6, Ascii.f22490CR, 19, 10, 2, -66, Ascii.f22492FF, Ascii.f22490CR, Ascii.DC2, -66, 0, 3, -66, 3, Ascii.f22503VT, Ascii.f22500SO, Ascii.DC2, Ascii.ETB, -52, -4, Ascii.f22499SI, 10, Ascii.f22503VT, Ascii.NAK, -58, Ascii.f22491EM, Ascii.SUB, 7, Ascii.SUB, Ascii.f22503VT, -58, 9, Ascii.f22500SO, 7, Ascii.DC4, Ascii.f22490CR, Ascii.f22503VT, 10, -58, Ascii.SUB, Ascii.NAK, -58, -97, -79, -79, -93, -78, Ascii.SUB, Ascii.SYN, Ascii.f22503VT, 35, Ascii.f22499SI, Ascii.f22493FS, Ascii.f22492FF, -77, 8, -7, -14, 5, -77, -79, -53, -79, -77};
    }
    ...
    static {
        A04();
        A0Q = TextureViewSurfaceTextureListenerC5073Cy.class.getSimpleName();
    }

    public TextureViewSurfaceTextureListenerC5073Cy(C6902gi c6902gi) {
        super(c6902gi);
        this.A0C = EnumC6844fm.A04;
        ...
        this.A0M = new C6839fh(this);
        this.A0I = false;
        this.A0N = c6902gi;
    }

    public TextureViewSurfaceTextureListenerC5073Cy(C6902gi c6902gi, AttributeSet attributeSet) {
    ...
    public TextureViewSurfaceTextureListenerC5073Cy(C6902gi c6902gi, AttributeSet attributeSet, int i) {
    ...
    private boolean A06() {
        return (this.A0C == EnumC6844fm.A08 || this.A0C == EnumC6844fm.A07) ? false : true;
    }

    private boolean A07() {
        return this.A0C == EnumC6844fm.A07 || this.A0C == EnumC6844fm.A0A || this.A0C == EnumC6844fm.A05 || this.A0C == EnumC6844fm.A06;
    }
    ...
    private boolean A09() {
        ...
        try {
            ...
            this.A0N.A08().ABC(A03(384, 6, 110), AbstractC6098Td.A2H, new C6099Te(e));
            return false;
        }
    }
    ...
    private boolean A0A(Surface surface) {
        ...
        try {
            ...
            this.A0N.A08().ABC(A03(384, 6, 110), AbstractC6098Td.A2I, new C6099Te(e));
            return false;
        }
    }
    ...
    public final void AGr(boolean z, int i) {
        ...
        if (this.A06 != null) {
            ...
            this.A0J = z;
            this.A06.pause();
            if (this.A0C != EnumC6844fm.A06) {
                setVideoState(EnumC6844fm.A05);
                return;
            }
            return;
        }
    ...
    public final void AK6(EnumC6789et enumC6789et, int i) {
        this.A0N.A0F().A3p(i);
        this.A0J = false;
        this.A0D = EnumC6844fm.A0A;
        this.A0B = enumC6789et;
        if (this.A0C == EnumC6844fm.A0A || this.A0C == EnumC6844fm.A07 || this.A0C == EnumC6844fm.A04 || this.A0C == EnumC6844fm.A05 || this.A0C == EnumC6844fm.A06) {
            if (this.A06 == null) {
                setup(this.A07);
            } else {
                if (this.A03 > 0) {
                ...
                this.A06.start();
                if (this.A0C != EnumC6844fm.A07 || this.A0K) {
                    setVideoState(EnumC6844fm.A0A);
                }
            }
        }
        if (isAvailable()) {
    ...
    public final boolean onError(MediaPlayer mediaPlayer, int i, int i2) {
        ...
        if (this.A01 > 0 && getState() == EnumC6844fm.A0A) {
            this.A01--;
            AKF(6);
            AK6(this.A0B, 10);
        } else {
    ...
    public final void onPrepared(MediaPlayer mediaPlayer) {
        ...
        if (this.A03 > 0) {
            int i = this.A03;
            int duration = ((MediaPlayer) AbstractC6953hX.A00(this.A06)).getDuration();
            if (A0P[3].length() != 17) {
                throw new RuntimeException();
            }
    ...
    public final void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        ...
        if (!A0A(this.A08)) {
            ...
            this.A0N.A0F().A3i(4);
            destroy();
        } else if (this.A0C == EnumC6844fm.A05 && !this.A0J) {
            AK6(this.A0B, 7);
        }
    }
    ...
    public final void onWindowFocusChanged(boolean z) {
        ...
        if (!z) {
            if (this.A0C != EnumC6844fm.A05) {
                if (!this.A0N.A0H().A01()) {
                    boolean zA25 = C6171Up.A25(this.A0N);
                    if (A0P[2].length() != 22) {
                        throw new RuntimeException();
                    }
        ...
        EnumC6844fm enumC6844fm = this.A0C;
        EnumC6844fm enumC6844fm2 = EnumC6844fm.A05;
        if (A0P[6].length() == 4) {
            A0P[6] = "r8oy";
            if (enumC6844fm != enumC6844fm2) {
                return;
            }
        } else if (enumC6844fm != enumC6844fm2) {
            return;
        }
        if (!this.A0J) {
            EnumC6789et enumC6789et = this.A0B;
            if (A0P[3].length() != 17) {
                throw new RuntimeException();
            }
    ...
    public void setControlsAnchorView(View view) {
        this.A09 = view;
        view.setOnTouchListener(new ViewOnTouchListenerC6841fj(this));
    }
    ...
    public void setFullScreen(boolean z) {
        this.A0H = z;
        if (this.A0H && !this.A0G) {
            setOnTouchListener(new ViewOnTouchListenerC6840fi(this));
        }
    }
    ...
    public void setRequestedVolume(float f) {
        this.A00 = f;
        if (this.A06 == null || this.A0C == EnumC6844fm.A08) {
            return;
        }
        EnumC6844fm enumC6844fm = this.A0C;
        String[] strArr = A0P;
        ...
        if (enumC6844fm != EnumC6844fm.A04) {
    ...
    private void setVideoState(EnumC6844fm enumC6844fm) {
        if (enumC6844fm != this.A0C) {
            if (this.A0N.A05().AAO()) {
                String str = A03(356, 23, 106) + enumC6844fm;
            }
            this.A0C = enumC6844fm;
            if (this.A0E != null) {
                this.A0E.AGd(enumC6844fm);
            }
        }
    }
    ...
    public void setup(Uri uri) {
        ...
        try {
            if (((String) AbstractC6953hX.A00(uri.getScheme())).equals(A03(379, 5, 2))) {
                A05(mediaPlayer, uri);
            } else {
