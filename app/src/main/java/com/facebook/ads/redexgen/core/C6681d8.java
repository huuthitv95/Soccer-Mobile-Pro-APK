...
public class C6681d8 extends WebViewClient {
    ...
    public final /* synthetic */ C6685dC A00;
    ...
    public static void A01() {
        A01 = new byte[]{98, 99, 117, 101, 116, 111, 118, 114, 111, 105, 104, 124, 113, 124, 91, 106, 121, 107, 112, 6, 17, 17, Ascii.f22492FF, 17, 32, Ascii.f22492FF, 7, 6, 90, 93, 74, 85, 95, 83, 82, Ascii.DC2, 85, 95, 83, Ascii.f22490CR, 17, 17, Ascii.NAK, 58, 0, Ascii.ETB, Ascii.ETB, 10, Ascii.ETB, 19, 17, 10, Ascii.f22492FF, 17, 10, Ascii.ETB, Ascii.SUB, 106, 109, 115};
    }
    ...
    public C6681d8(C6685dC c6685dC) {
        this.A00 = c6685dC;
    }
    ...
    private void A02(int i, String str, String str2, boolean z) {
        ...
        this.A00.A0D.A04(EnumC6199VH.A0Q, null);
        ...
        this.A00.A0E.A04(AbstractC6098Td.A16, string);
    }

    @Override // android.webkit.WebViewClient
    public final void onPageFinished(WebView webView, String str) {
        this.A00.A0D.A04(EnumC6199VH.A0R, null);
        this.A00.A0B.A0F().A6F(C6364Y1.A01(this.A00.A00));
        this.A00.A0S();
        this.A00.A06 = true;
        this.A00.A0E();
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        ...
        String string = jSONObject.toString();
        C6902gi c6902gi = this.A00.A0B;
        String message = A02[5];
        if (message.charAt(10) == 'q') {
            A02[3] = "cKmn9F08G0LbJgt48cswTZGSotGQ5jj";
            c6902gi.A0F().A6A(string);
            AbstractC6686dD.A04(this.A00.A09.A1D());
    ...
    public final WebResourceResponse shouldInterceptRequest(WebView webView, WebResourceRequest webResourceRequest) {
        return C6695dM.A00(this.A00.A0B, this.A00.A0A, webResourceRequest, this.A00.A0H, this.A00.A09.A1T());
    }
}
