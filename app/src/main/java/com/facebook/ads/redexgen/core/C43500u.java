...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.0u */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C43500u<K> extends AbstractC44392L<K, V>.SortedKeySet implements NavigableSet<K> {
    ...
    public C43500u(final AbstractC44392L this$0, NavigableMap<K, Collection<V>> subMap) {
        super(this$0, subMap);
        this.A00 = this$0;
    }
    ...
    public final NavigableSet<K> descendingSet() {
        return new C43500u(this.A00, A04().descendingMap());
    }
    ...
    public final NavigableSet<K> headSet(@ParametricNullness K toElement, boolean inclusive) {
        return new C43500u(this.A00, A04().headMap(toElement, inclusive));
    }
    ...
    public final K pollFirst() {
        return (K) AbstractC7402p9.A04(iterator());
    }
    ...
    public final K pollLast() {
        return (K) AbstractC7402p9.A04(descendingIterator());
    }
    ...
    public final NavigableSet<K> subSet(@ParametricNullness K fromElement, @ParametricNullness boolean fromInclusive, K toElement, boolean toInclusive) {
        return new C43500u(this.A00, A04().subMap(fromElement, fromInclusive, toElement, toInclusive));
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.0u != com.google.common.collect.AbstractMapBasedMultimap<K, V>$NavigableKeySet */
    @Override // java.util.NavigableSet
    public final NavigableSet<K> tailSet(@ParametricNullness K fromElement, boolean inclusive) {
        return new C43500u(this.A00, A04().tailMap(fromElement, inclusive));
    }
}
