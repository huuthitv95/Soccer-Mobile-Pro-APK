...
public abstract class AbstractC6384YL {
    ...
    public static Bitmap A00(C6902gi c6902gi, Bitmap bitmap, int i) throws RSRuntimeException {
        ...
        try {
            renderScriptCreate = RenderScript.create(c6902gi);
    ...
    public static Bitmap A01(C6902gi c6902gi, Bitmap bitmap, int i, int i2) {
        ...
        if (width != 0 && height != 0) {
            ...
            try {
                bitmapCreateBitmap = A00(c6902gi, bitmapCreateBitmap, i);
                if (i2 != 1) {
                ...
                return new C5880Q5().A02(bitmapCreateBitmap, i);
            }
        }
        return null;
    }
