...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.PB */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C5827PB<V> implements Collection<V> {
    ...
    public C5827PB(AbstractC5828PC abstractC5828PC) {
    ...
    public final boolean removeAll(Collection<?> collection) {
        ...
        while (i < iA04) {
            ...
            if (collection.contains(abstractC5828PC.A0B(i, 1))) {
                this.A00.A0E(i);
                i--;
                iA04--;
                z = true;
