...
public abstract class AbstractC7151kr implements InterfaceC5607Lc {
    ...
    static {
        A04();
        A03 = AbstractC7151kr.class.getSimpleName();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A06(File file) throws IOException {
        C5610Lf.A03(file);
        List<File> files = C5610Lf.A01(file.getParentFile());
        A07(files);
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC5607Lc
    public void AKR(File file) throws IOException {
        this.A00.submit(new CallableC5611Lg(this, file));
    }
}
