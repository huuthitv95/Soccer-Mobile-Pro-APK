...
public enum EnumC6864g6 {
    ...
    EnumC6864g6(boolean z, boolean z2) {
        this.A00 = z;
        this.A01 = z2;
    }
    ...
    public static EnumC6864g6[] valuesCustom() {
        EnumC6864g6[] enumC6864g6ArrValuesCustom = values();
        if (A03[7].charAt(2) != 'p') {
            throw new RuntimeException();
        }
        A03[7] = "eYpi2UA0ZlC7PiDY55aF0B4EyL2494ge";
        return (EnumC6864g6[]) enumC6864g6ArrValuesCustom.clone();
    }
}
