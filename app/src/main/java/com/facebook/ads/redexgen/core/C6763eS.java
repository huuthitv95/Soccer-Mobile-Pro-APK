...
public final class C6763eS {
    ...
    public final C5715NN A0e;
    public final C5726NY A0f;
    public final C5731Nd A0g;
    public final C5740Nm A0h;
    public final C6902gi A0i;
    public final C6200VI A0j;
    public final InterfaceC6406Yh A0k;
    public final ViewOnClickListenerC5560Kr A0l;
    public int A06 = 160;
    public int A07 = 130;
    public int A03 = 56;
    public int A04 = 430;
    ...
    public final int A0a = (int) AbstractC6334XX.A02;
    ...
    public static void A0M() {
        A0n = new byte[]{Ascii.f22490CR, Ascii.f22502US, 111, Ascii.f22502US, 111, Ascii.f22502US, 111, 44, 55, 63, 63, 63, 63, 63, 63, 63, 91, 84, 101, 91, 89, 78, 83, 76, 83, 78, 67, 117, 121, 123, 56, 112, 119, 117, 115, 116, 121, 121, 125, 56, 119, 114, 101, 56, 127, 120, 98, 115, 100, 101, 98, 127, 98, 127, 119, 122, 56, 112, 127, 120, 127, 101, 126, 73, 119, 117, 98, 127, 96, 127, 98, 111, 88, 83, 89, 126, 92, 79, 89, 107, Ascii.f22499SI, 110, 94, 79, 88, 88, 83, 78, 85, 82, 73, 111, 88, 94, 68, 94, 81, 88, 79, 124, 89, 92, 77, 73, 88, 79, Ascii.f22494GS, 84, 78, Ascii.f22494GS, 83, 72, 81, 81, Ascii.NAK, Ascii.f22490CR, Ascii.f22499SI, Ascii.SYN};
    }
    ...
    public C6763eS(final C6902gi c6902gi, AbstractC7077jd abstractC7077jd, InterfaceC6406Yh interfaceC6406Yh, ViewOnClickListenerC5560Kr viewOnClickListenerC5560Kr, Handler handler, C6200VI c6200vi) {
        this.A0i = c6902gi;
        this.A0d = abstractC7077jd;
        this.A0j = c6200vi;
        this.A0h = abstractC7077jd.A2C();
        this.A0g = abstractC7077jd.A29().A0K();
        this.A0k = interfaceC6406Yh;
        this.A0b = handler;
        this.A0f = abstractC7077jd.A29().A0I();
        this.A0e = abstractC7077jd.A28();
        this.A0l = viewOnClickListenerC5560Kr;
        this.A0S = new C47457M(c6902gi) { // from class: com.facebook.ads.redexgen.X.1E
            @Override // com.facebook.ads.redexgen.core.C47457M, android.view.ViewGroup
            public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                return false;
            }

            @Override // com.facebook.ads.redexgen.core.C47457M, android.view.View
            public final boolean onTouchEvent(MotionEvent motionEvent) {
                return false;
            }
        };
        this.A0P = new RelativeLayout(c6902gi);
        this.A0W = new C6595bk(c6902gi);
        this.A0R = new TextView(c6902gi);
        this.A0M = new ImageView(c6902gi);
        this.A0c = new FrameLayout(this.A0i);
        A0K();
    }

    public static int A00(int i) {
        if (AbstractC5819P3.A01(i, -1) >= 4.5d) {
            return -1;
        }
    ...
    private ImageView A03() {
        Bitmap scaledBitmap = Bitmap.createScaledBitmap(AbstractC6386YN.A01(EnumC6385YM.OTHER_SKIP), this.A0C, this.A0C, true);
        ...
        if (this.A0l != null && this.A0l.getCtaActionHelper().A06() == null) {
            this.A0l.getCtaActionHelper().A07(new InterfaceC5684Mr() { // from class: com.facebook.ads.redexgen.X.FQ
    ...
    private LinearLayout A06() {
        ...
        arrayList.add(new C6766eV(this.A0i).A02(new C6584bZ(this.A0i, -1, -1, EnumC6385YM.RATINGS)).A04(this.A0f.A0C()).A03(this.A0f.A0B()));
        if (!this.A0f.A09().isEmpty()) {
            try {
                strA09 = AbstractC6343Xg.A01(Integer.parseInt(this.A0f.A09()));
            } catch (NumberFormatException unused) {
                strA09 = this.A0f.A09();
            }
            arrayList.add(new C6766eV(this.A0i).A02(new C6584bZ(this.A0i, -1, -1, EnumC6385YM.NUCLEUS_GROUP)).A04(strA09).A03(this.A0f.A0A()));
        }
        if (!this.A0f.A05().isEmpty()) {
            arrayList.add(new C6766eV(this.A0i).A02(new C6584bZ(this.A0i, -1, -1, EnumC6385YM.DOWNLOAD)).A04(this.A0f.A05()).A03(this.A0f.A06()));
        }
        C5726NY c5726ny = this.A0f;
        if (A0o[2].length() == 29) {
            throw new RuntimeException();
        }
        A0o[2] = "3vpsIj";
        if (!c5726ny.A01().isEmpty()) {
            arrayList.add(new C6766eV(this.A0i).A02(new C6584bZ(this.A0i, -1, -1, EnumC6385YM.NUCLEUS_DURATION)).A04(this.A0f.A01()).A03(this.A0f.A0D()));
        }
        if (!this.A0f.A02().isEmpty()) {
            arrayList.add(new C6766eV(this.A0i).A02(new C6584bZ(this.A0i, -1, -1, EnumC6385YM.GRID_4)).A04(this.A0f.A02()).A03(this.A0f.A03()));
        }
    ...
    private LinearLayout A07(RelativeLayout relativeLayout, ViewOnClickListenerC5560Kr viewOnClickListenerC5560Kr) {
        LinearLayout linearLayout = new LinearLayout(this.A0i);
        linearLayout.setOrientation(0);
        linearLayout.setGravity(17);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(3, viewOnClickListenerC5560Kr.getId());
        ...
        linearLayout.setId(View.generateViewId());
        C6584bZ iconView = new C6584bZ(this.A0i, -1, -1, EnumC6385YM.GOOGLE_PLAY_STORE);
    ...
    private RelativeLayout.LayoutParams A09(LinearLayout linearLayout, TextView textView) {
        ...
        if (this.A0l != null) {
            ...
            AbstractC6374YB.A0V(this.A0l, AbstractC6374YB.A06(this.A0e.A01().A04(), 40));
        }
    ...
    private RelativeLayout.LayoutParams A0B(C6595bk c6595bk) {
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(14);
        layoutParams.addRule(3, c6595bk.getId());
    ...
    private TextView A0D(RelativeLayout relativeLayout, TextView textView) {
        ...
        AbstractC6374YB.A0K(textView2);
        return textView2;
    }

    private TextView A0E(RelativeLayout relativeLayout, C6595bk c6595bk) {
        TextView textView = new TextView(this.A0i);
        ...
        textView.setLayoutParams(A0B(c6595bk));
        relativeLayout.addView(textView);
        textView.setId(View.generateViewId());
        return textView;
    }

    private C6595bk A0G(LinearLayout linearLayout) {
        C6595bk c6595bk = new C6595bk(this.A0i);
        c6595bk.setRadius(30);
        AbstractC6374YB.A0N(c6595bk, 0);
        AsyncTaskC5591LM downloadImageTask = new AsyncTaskC5591LM(c6595bk, this.A0i).A04();
        downloadImageTask.A07(this.A0h.A01());
        c6595bk.setLayoutParams(A08(linearLayout));
        c6595bk.setId(View.generateViewId());
        return c6595bk;
    }
    ...
    private void A0I() {
        ...
        if (zA05) {
            scaledBitmap = AbstractC6386YN.A01(EnumC6385YM.SKIP_ARROW_APP_INSTALL);
        } else {
            scaledBitmap = AbstractC6386YN.A01(EnumC6385YM.NAV_CROSS);
        }
        ...
        if (shouldShowThirdEndCard2 && this.A0g.A00() > 0) {
            ...
            AbstractC6765eU.A01(this.A0i, this.A0M, this.A0g.A00(), this.A0N);
        }
    }
    ...
    private void A0L() {
        ...
        if (parent2 instanceof ViewGroup) {
            this.A0m.set(true);
            this.A0X = new C6630cJ(this.A0i, this.A0d, this.A0j, this.A0b, this.A0k);
    ...
    private void A0Q(RelativeLayout relativeLayout, LinearLayout linearLayout, ViewOnClickListenerC5560Kr viewOnClickListenerC5560Kr) {
        this.A0T = AbstractC6511aO.A01(this.A0i, false, this.A0d, this.A0j, this.A0k, EnumC6509aM.A02, AbstractC6508aL.A00(this.A0d));
        AbstractC6374YB.A0K(this.A0T);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.setMargins(0, this.A0B, 0, this.A0B);
        layoutParams.addRule(7, viewOnClickListenerC5560Kr.getId());
        layoutParams.addRule(3, linearLayout.getId());
        this.A0T.setLayoutParams(layoutParams);
        relativeLayout.addView(this.A0T);
    }

    private void A0R(RelativeLayout relativeLayout, LinearLayout linearLayout, ViewOnClickListenerC5560Kr viewOnClickListenerC5560Kr) {
        this.A0U = AbstractC6511aO.A01(this.A0i, false, this.A0d, this.A0j, this.A0k, EnumC6509aM.A02, EnumC6512aP.A04);
        AbstractC6374YB.A0K(this.A0U);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.setMargins(0, this.A0H, 0, this.A0B);
        layoutParams.addRule(5, viewOnClickListenerC5560Kr.getId());
        layoutParams.addRule(3, linearLayout.getId());
        this.A0U.setLayoutParams(layoutParams);
        relativeLayout.addView(this.A0U);
    }

    private void A0S(RelativeLayout relativeLayout, LinearLayout linearLayout, ViewOnClickListenerC5560Kr viewOnClickListenerC5560Kr) {
        this.A0V = AbstractC6511aO.A02(this.A0i, EnumC6509aM.A02, this.A0d);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.setMargins(0, this.A0B, 0, this.A0B);
        layoutParams.addRule(5, viewOnClickListenerC5560Kr.getId());
        layoutParams.addRule(3, linearLayout.getId());
    ...
    private void A0T(RelativeLayout relativeLayout, ViewOnClickListenerC5560Kr viewOnClickListenerC5560Kr, LinearLayout linearLayout, TextView textView) {
        RelativeLayout.LayoutParams layoutParamsA09 = A09(linearLayout, textView);
        viewOnClickListenerC5560Kr.setIncludeFontPadding(false);
        viewOnClickListenerC5560Kr.setLayoutParams(layoutParamsA09);
        viewOnClickListenerC5560Kr.A0D();
        viewOnClickListenerC5560Kr.setHeight(this.A03);
        viewOnClickListenerC5560Kr.setTextSize(18.0f);
        viewOnClickListenerC5560Kr.setCornerRadiusPx(40);
        viewOnClickListenerC5560Kr.setTextColor(A00(this.A0e.A01().A04()));
        AbstractC6374YB.A0V(viewOnClickListenerC5560Kr, AbstractC6374YB.A06(this.A0e.A01().A04(), 40));
        ...
        relativeLayout.addView(viewOnClickListenerC5560Kr);
        String[] strArr = A0o;
        if (strArr[7].length() == strArr[5].length()) {
            throw new RuntimeException();
        }
    ...
    private void A0U(ViewOnClickListenerC5560Kr viewOnClickListenerC5560Kr) {
        this.A0S.setLayoutManager(new C6972hr(this.A0i, 0, false));
        ...
        this.A0S.setAdapter(new C5223FO(this.A0i, this.A0g.A02(), this.A0H, this.A0S, viewOnClickListenerC5560Kr, i));
    }

    private void A0V(final InterfaceC6762eR interfaceC6762eR) {
        final ImageView imageView = new ImageView(this.A0i);
        imageView.setAdjustViewBounds(true);
        AsyncTaskC5591LM asyncTaskC5591LM = new AsyncTaskC5591LM(imageView, this.A0i);
        if (!this.A0g.A02().isEmpty()) {
            asyncTaskC5591LM.A06(new InterfaceC6557b8() { // from class: com.facebook.ads.redexgen.X.FR
                @Override // com.facebook.ads.redexgen.core.InterfaceC6557b8
                public final void AE7(C6556b7 c6556b7) {
                    this.A02.A0c(imageView, interfaceC6762eR, c6556b7);
                }
            });
            asyncTaskC5591LM.A07(this.A0g.A02().get(0));
        } else {
            interfaceC6762eR.AE9();
        }
    }
    ...
    public final FrameLayout A0W() {
        ...
        this.A0P = A0C();
        if (C6171Up.A1D(this.A0i)) {
            this.A0P.setOnClickListener(new ViewOnClickListenerC6760eP(this));
        }
        A0P(this.A0P);
        this.A0O = A06();
        ...
        if (this.A0d.A2T()) {
            ...
            blackBackgroundView.setOnClickListener(new ViewOnClickListenerC6761eQ(this));
        ...
        A0V(new InterfaceC6762eR() { // from class: com.facebook.ads.redexgen.X.FX
            @Override // com.facebook.ads.redexgen.core.InterfaceC6762eR
            public final void AE9() {
                this.A01.A0d(linearLayout);
            }
        });
        if (this.A0j != null) {
            AbstractC6202VK.A04(this.A0c, this.A0j, EnumC6199VH.A0S);
        }
    ...
    public final void A0a(int i) {
        if (!this.A0m.get()) {
            C5223FO c5223fo = (C5223FO) this.A0S.getAdapter();
            if (c5223fo == null) {
                this.A0i.A08().ABC(A0H(16, 11, 8), AbstractC6098Td.A0A, new C6099Te(A0H(72, 42, 15)));
            }
            if (this.A0l != null) {
    ...
    public final /* synthetic */ void A0b(View view) {
        if (this.A0l != null) {
            EnumC5683Mq enumC5683MqA0E = this.A0l.A0E(A0H(114, 4, 84));
            if (this.A0d.A2N()) {
                return;
            }
            EnumC5683Mq actionOutcome = EnumC5683Mq.A09;
            if (enumC5683MqA0E != actionOutcome) {
                EnumC5683Mq actionOutcome2 = EnumC5683Mq.A06;
                if (enumC5683MqA0E != actionOutcome2) {
                    A0Z();
                }
            }
        }
    ...
    public final /* synthetic */ void A0c(ImageView imageView, InterfaceC6762eR interfaceC6762eR, C6556b7 c6556b7) {
