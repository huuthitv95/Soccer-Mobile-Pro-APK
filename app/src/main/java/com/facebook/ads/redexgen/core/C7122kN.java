...
public final class C7122kN implements InterfaceC5677Mk {
    ...
    public static final C7122kN A03 = new C7122kN(Collections.emptyMap());
    public int A00;
    ...
    public C7122kN(Map<String, byte[]> metadata) {
        this.A01 = Collections.unmodifiableMap(metadata);
    }

    public static Map<String, byte[]> A00(Map<String, byte[]> otherMetadata, C5678Ml c5678Ml) {
    ...
    public static byte[] A04(Object obj) {
        ...
        if (obj instanceof String) {
            return ((String) obj).getBytes(AbstractC7109k9.A05);
        }
    ...
    public final C7122kN A05(C5678Ml c5678Ml) {
        Map<String, byte[]> mapA00 = A00(this.A01, c5678Ml);
        Map<String, byte[]> mutatedMetadata = this.A01;
        if (A03(mutatedMetadata, mapA00)) {
            return this;
        }
        return new C7122kN(mapA00);
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC5677Mk
    ...
    public final boolean equals(Object obj) {
        ...
        return A03(this.A01, ((C7122kN) obj).A01);
    }
