...
public final class C7160l1 implements InterfaceC5590LL {
    ...
    public final C7472qI A06;
    public final C45944v A07;
    public final InterfaceC5332HA A08;
    public final InterfaceC5361Hd A09;
    public final C5592LN A0A;
    ...
    public static void A04() {
        A0C = new byte[]{-120, 109, -76, -68, -63, -121, 109, -51, 0, -8, -19, -21, -4, -19, -20, -88, -18, -6, -23, -11, -19, -5, -88, -8, -19, -6, -88, -22, -12, -9, -21, -13, -62, -88, -7, Ascii.f22490CR, -4, 1, 7, -57, 10, -7, Ascii.f22499SI};
    }
    ...
    private void A06(byte[] bArr, int i, int i2, byte[] bArr2) {
        ...
        for (int i10 = 0; i10 < i7 * 2; i10++) {
            ...
            iA07 = AbstractC46115C.A07(iA07 + i13, -32768, 32767);
            i9 += i4 * 2;
            bArr2[i9] = (byte) (iA07 & 255);
            bArr2[i9 + 1] = (byte) (iA07 >> 8);
            iMin = AbstractC46115C.A07(iMin + A0E[i12], 0, A0F.length - 1);
            i8 = A0F[iMin];
        }
    }
    ...
    public C7160l1(InterfaceC5332HA interfaceC5332HA, InterfaceC5361Hd interfaceC5361Hd, C5592LN c5592ln) throws C44963K {
        this.A08 = interfaceC5332HA;
        this.A09 = interfaceC5361Hd;
        this.A0A = c5592ln;
        this.A05 = Math.max(1, c5592ln.A04 / 10);
        C45944v scratch = new C45944v(c5592ln.A06);
        scratch.A0G();
        this.A04 = scratch.A0G();
        int i = c5592ln.A05;
        int i2 = (((c5592ln.A02 - (i * 4)) * 8) / (c5592ln.A01 * i)) + 1;
        if (this.A04 == i2) {
            int numChannels = AbstractC46115C.A05(this.A05, this.A04);
            this.A0B = new byte[c5592ln.A02 * numChannels];
            int maxBlocksToDecode = A02(this.A04, i);
            this.A07 = new C45944v(maxBlocksToDecode * numChannels);
            int maxBlocksToDecode2 = c5592ln.A04;
            int constantBitrate = ((maxBlocksToDecode2 * c5592ln.A02) * 8) / this.A04;
            this.A06 = new C44672p().A11(A03(34, 9, 83)).A0a(constantBitrate).A0j(constantBitrate).A0h(A02(this.A05, i)).A0b(c5592ln.A05).A0m(c5592ln.A04).A0i(2).A14();
            return;
        }
        throw C44963K.A01(A03(7, 27, 67) + i2 + A03(0, 7, 8) + this.A04, null);
    }
    ...
    private void A05(int i) {
        long jA0U = this.A03 + AbstractC46115C.A0U(this.A02, 1000000L, this.A0A.A04);
        int iA01 = A01(i);
    ...
    private void A07(byte[] bArr, int i, C45944v c45944v) {
        for (int i2 = 0; i2 < i; i2++) {
            for (int channelIndex = 0; channelIndex < blockIndex; channelIndex++) {
                A06(bArr, i2, channelIndex, c45944v.A0l());
            }
        }
    ...
    public final void AA8(int i, long j) {
        this.A08.AJ7(new C7157ky(this.A0A, this.A04, i, j));
    ...
    public final boolean AIt(InterfaceC7263ms interfaceC7263ms, long j) throws IOException {
        ...
        int blocksToDecode = AbstractC46115C.A05(iA00, targetFramesRemaining);
        ...
        while (!z) {
            ...
            int blocksToDecode2 = interfaceC7263ms.read(bArr, targetFramesRemaining4, targetReadBytes);
