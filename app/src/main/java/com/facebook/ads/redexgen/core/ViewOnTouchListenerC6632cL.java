...
public class ViewOnTouchListenerC6632cL implements View.OnTouchListener {
    ...
    public static void A01() {
        A01 = new byte[]{Ascii.ETB, Ascii.NAK, 7, Ascii.DC4, 1, 5, Ascii.f22500SO, Ascii.f22503VT, 5, Ascii.f22490CR, 1, Ascii.f22503VT, 3, 4, 68, 66, 52, 65, 46, 58, 52, 72, 63, 48, 51, 46, 50, 59, 56, 50, 58, 46, 56, 48, 49};
    }
    ...
    public ViewOnTouchListenerC6632cL(C5521KE c5521ke) {
        this.A00 = c5521ke;
    }
        ...
        switch (motionEvent.getActionMasked()) {
            case 0:
                if (!this.A00.A0Q && this.A00.A0A != null && this.A00.A0A.isAcceptingText()) {
                    ...
                    c5521ke.A0h(A00(14, 21, 86));
                }
                break;
            case 1:
                C5521KE.A05(this.A00);
