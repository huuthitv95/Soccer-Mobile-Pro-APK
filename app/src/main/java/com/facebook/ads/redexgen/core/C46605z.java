...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.5z */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C46605z {
    public int A00;
    public int A01;
    public int A02;
    public int A03;
    ...
    public final C46595y A09;

    public C46605z() {
        this.A09 = AbstractC46115C.A02 >= 24 ? new C46595y(this.A08) : null;
    }
    ...
    public final void A02(int i, int[] iArr, int[] iArr2, byte[] bArr, byte[] bArr2, int i2, int i3, int i4) {
        ...
        if (AbstractC46115C.A02 >= 24) {
            ((C46595y) AbstractC45353y.A01(this.A09)).A00(i3, i4);
        }
    }
}
