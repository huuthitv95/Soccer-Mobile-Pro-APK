...
public class C7309nd<K, V> extends AbstractSet<Map.Entry<K, V>> {
    ...
    public C7309nd(final C7313nh this$0) {
        this.A00 = this$0;
    }
    ...
    public final boolean contains(@CheckForNull Object o) {
        ...
        return iA07 != -1 && AbstractC5025CB.A01(this.A00.A0F(iA07), entry.getValue());
    }
    ...
    public final boolean remove(@CheckForNull Object o) {
        ...
        Map.Entry entry = (Map.Entry) o;
        if (this.A00.A0p() || (iA06 = AbstractC7316nk.A06(entry.getKey(), entry.getValue(), (iA00 = this.A00.A00()), this.A00.A0C(), this.A00.A0T(), this.A00.A0V(), this.A00.A0W())) == -1) {
            return false;
        }
