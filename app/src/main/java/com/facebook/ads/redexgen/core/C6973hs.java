...
public class C6973hs implements InterfaceC5936R0 {
    ...
    public final void A04(C47457M c47457m, boolean z) {
        this.A00 = 0;
        if (this.A03 != null) {
            Arrays.fill(this.A03, -1);
        }
        AbstractC5938R2 abstractC5938R2 = c47457m.A06;
        if (c47457m.A04 != null && abstractC5938R2 != null && abstractC5938R2.A1W()) {
            if (z) {
                if (!c47457m.A00.A0B()) {
                    abstractC5938R2.A1t(c47457m.A04.A0B(), this);
                }
            } else if (!c47457m.A1r()) {
                abstractC5938R2.A1s(this.A01, this.A02, c47457m.A0s, this);
            }
            if (this.A00 > abstractC5938R2.A00) {
                abstractC5938R2.A00 = this.A00;
                abstractC5938R2.A08 = z;
                c47457m.A0r.A0O();
            }
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC5936R0
