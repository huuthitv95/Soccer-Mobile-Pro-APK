...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.YB */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public abstract class AbstractC6374YB {
     ...
     */
    public static boolean A0i(C6902gi c6902gi, EnumC5683Mq enumC5683Mq, Map<String, String> map) {
        String str = map.get(A0C(89, 21, 37));
        boolean z = str != null && str.equals(Boolean.TRUE.toString());
        if (z && (A0h(c6902gi, enumC5683Mq) || A0f(enumC5683Mq, map))) {
            return true;
        }
        String str2 = map.get(A0C(62, 27, 11));
        return z && (str2 != null && str2.equals(Boolean.TRUE.toString())) && A0g(enumC5683Mq, map);
    }

    static {
        A0D();
        A03 = AbstractC5819P3.A02(-1, 0);
        A02 = AbstractC5819P3.A02(ViewCompat.MEASURED_STATE_MASK, 115);
    ...
    public static int A01(int i) {
        return (int) TypedValue.applyDimension(2, i, AbstractC6334XX.A04);
    }

    public static int A02(int i) {
        if (A0e(i)) {
            return AbstractC5819P3.A05(i, -1, 0.4f);
        }
        return AbstractC5819P3.A05(i, ViewCompat.MEASURED_STATE_MASK, 0.2f);
    }
    ...
    public static void A0E(float f, LinearLayout linearLayout) {
        linearLayout.setOutlineProvider(new C6372Y9(f));
    ...
    public static void A0F(int i, View view) {
        ...
        scaleAnimation.setAnimationListener(new C5885QA(view, scaleAnimation2));
    ...
    public static void A0c(Map<String, String> map, AbstractC7077jd abstractC7077jd) {
        byte b;
        String strA0C;
        if (abstractC7077jd == null) {
            return;
        }
        String strA10 = abstractC7077jd.A10();
        switch (strA10.hashCode()) {
            case -1364000502:
                ...
                map.put(A0C(154, 8, 58), abstractC7077jd.A0u());
                map.put(A0C(89, 21, 37), String.valueOf(abstractC7077jd.A1e()));
                map.put(A0C(62, 27, 11), String.valueOf(abstractC7077jd.A1Y()));
                map.put(A0C(27, 23, 96), String.valueOf(abstractC7077jd.A0q()));
                return;
            case 604727084:
    ...
    public static boolean A0e(int i) {
        return AbstractC5819P3.A00(i) < 0.5d;
    }

    public static boolean A0f(EnumC5683Mq enumC5683Mq, Map<String, String> extraData) {
        boolean nonIabDestination = !A0C(162, 9, 82).equals(extraData.get(A0C(15, 12, 15)));
        boolean nonCtaClick = enumC5683Mq != EnumC5683Mq.A08;
        return nonIabDestination && nonCtaClick;
    }

    public static boolean A0g(EnumC5683Mq enumC5683Mq, Map<String, String> extraData) {
        boolean zEquals = A0C(162, 9, 82).equals(extraData.get(A0C(15, 12, 15)));
        boolean ctaClick = enumC5683Mq != EnumC5683Mq.A08;
        return zEquals && ctaClick;
    }

    public static boolean A0h(C6902gi c6902gi, EnumC5683Mq enumC5683Mq) {
        return enumC5683Mq == EnumC5683Mq.A08 && C6171Up.A2w(c6902gi);
    }
}
