...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.LK */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public abstract class AbstractC5589LK extends AbstractC6564bF {
    ...
    public final C5740Nm A09;
    public final C5796Og A0A;
    public final C6200VI A0B;
    ...
    public final AbstractC7077jd A0R;
    public final C5726NY A0S;
    public final C5728Na A0T;
    public final C6902gi A0U;
    public final C6506aJ A0V;
    public final C5110DZ A0W;
    ...
    public static void A0a() {
        A0c = new byte[]{58, Ascii.DC2, 4, 2, Ascii.DC2, 60, 108, 103, 106, 121, 125, 96, 97, 80, 122, 127, Ascii.f22494GS, Ascii.f22493FS, 10, Ascii.SUB, Ascii.f22503VT, Ascii.DLE, 9, Ascii.f22490CR, Ascii.DLE, Ascii.SYN, Ascii.ETB, 126, 116, 120, 121, Ascii.f22498RS, 2, Ascii.f22499SI, Ascii.f22490CR, Ascii.f22503VT, 49, 6, 1, 2, 10, Ascii.f22503VT, Ascii.f22493FS, 49, Ascii.SUB, Ascii.f22503VT, Ascii.SYN, Ascii.SUB, 96, 98, 127, 119, 98, 117, 99, 99, 79, 114, 113, 98, 99, 116, 102, 112, 99, 117, 116, 117, 78, 103, 120, 117, 116, 126, 98, 127, 98, 122, 115, 107, 109, 126, 113, 108, 115, 126, 107, 118, 112, 113, 70};
    }
    ...
    static {
        A0a();
        A0n = AbstractC6332XV.A0M;
        A0g = AbstractC6332XV.A0Q;
        A0k = AbstractC6332XV.A0N;
        A0l = AbstractC6332XV.A03;
        A0m = AbstractC6332XV.A04;
        A0h = AbstractC6332XV.A09;
        A0j = AbstractC5819P3.A02(-1, 128);
        A0i = AbstractC5819P3.A02(-1, 17);
        A0o = AbstractC6332XV.A05;
        A0e = AbstractC6332XV.A0L;
        A0f = AbstractC6332XV.A0X;
    }

    public AbstractC5589LK(C6902gi c6902gi, ViewOnClickListenerC5560Kr viewOnClickListenerC5560Kr, int i, boolean z, C5728Na c5728Na, boolean z2, String str, InterfaceC6192VA interfaceC6192VA, InterfaceC6406Yh interfaceC6406Yh, C6847fp c6847fp, C6365Y2 c6365y2, AbstractC7077jd abstractC7077jd, C5110DZ c5110dz, C6200VI c6200vi, boolean z3) {
        super(c6902gi, viewOnClickListenerC5560Kr, i, c5728Na, z2, str, interfaceC6192VA, interfaceC6406Yh, c6847fp, c6365y2, abstractC7077jd.A2A(), abstractC7077jd.A1k(), abstractC7077jd.A13());
        this.A0Y = new AtomicBoolean(true);
        this.A0Z = new AtomicBoolean(false);
        this.A0X = new RunnableC6565bG(this);
        this.A0E = new RunnableC6566bH(this);
        this.A0D = new RunnableC6567bI(this);
        this.A0B = c6200vi;
        this.A0R = abstractC7077jd;
        this.A0A = AbstractC5797Oh.A00(c6902gi.A02());
        this.A0C = interfaceC6406Yh;
        this.A0F = abstractC7077jd.A2E();
        this.A09 = abstractC7077jd.A2C();
        this.A0T = c5728Na;
        this.A0S = abstractC7077jd.A29().A0I();
        this.A0U = c6902gi;
        this.A0a = z;
        this.A0b = z3;
        ...
        AbstractC6374YB.A0G(1104, this.A0H);
        AbstractC6374YB.A0G(1105, this.A0I);
        this.A0V = AbstractC6511aO.A01(this.A0U, true, this.A0R, this.A0B, this.A0C, EnumC6509aM.A03, AbstractC6508aL.A00(this.A0R));
        AbstractC6374YB.A0K(this.A0V);
        this.A01 = -1;
        ...
        if (this.A0b) {
            ...
            this.A0J.setOnClickListener(AbstractC6605bu.A03(super.A08, A0T(6, 10, 11)));
        } else {
        ...
        this.A0W = A0S(c5110dz);
        AbstractC6374YB.A0K(this.A0W);
        if (this.A0R.A1i()) {
            this.A0W.setVisibility(8);
        }
        this.A0K = A0L();
        AbstractC6374YB.A0G(1103, this.A0K);
        this.A0K.setOnClickListener(new ViewOnClickListenerC6568bJ(this));
        A0t(8);
        setUpAdReportingInitiateView(abstractC7077jd);
        setUpCreditLineV2(abstractC7077jd);
        this.A08 = this.A0R.A29().A0H().A03();
        if (this.A0R.A10().equals(A0T(60, 14, 21)) && !abstractC7077jd.A1h() && this.A08 > 0) {
            this.A04 = A0Q();
    ...
    private ImageView A0K() {
        ...
        imageView.setImageBitmap(AbstractC6386YN.A01(EnumC6385YM.CHEVRON_UP));
        return imageView;
    }
    ...
    private LinearLayout A0L() {
        ...
        this.A0H.setImageBitmap(AbstractC6386YN.A01(EnumC6385YM.AD_CHOICE_V2_COLLAPSE));
        linearLayout.addView(this.A0H);
        this.A0I.setLayoutParams(new LinearLayout.LayoutParams(-2, -2));
        this.A0I.setImageBitmap(AbstractC6386YN.A01(EnumC6385YM.AD_CHOICE_V2_EXPAND));
    ...
    private RelativeLayout A0M() {
        ...
        AbstractC6374YB.A0K(relativeLayout);
    ...
    private C5110DZ A0S(C5110DZ c5110dz) {
        if (c5110dz == null) {
            c5110dz = new C5110DZ(this.A0U, -1);
            c5110dz.setVisibility(8);
        }
        c5110dz.A08(A0j, A0i, true);
        c5110dz.setPadding(0, 0, 0, 0);
        RelativeLayout.LayoutParams progressBarLayoutParams = new RelativeLayout.LayoutParams(-1, A0o);
        c5110dz.setLayoutParams(progressBarLayoutParams);
        return c5110dz;
    }
    ...
    private void A0U() {
        ...
        AbstractC6374YB.A0V(super.A08, AbstractC6374YB.A06(this.A01, this.A02));
        super.A08.setLayoutParams(new RelativeLayout.LayoutParams(-2, A0g));
        AbstractC6374YB.A0G(1001, super.A08);
    }
    ...
    private void A0V() {
        ...
        AbstractC6374YB.A0N(super.A09, 0);
        super.A09.setLayoutParams(new RelativeLayout.LayoutParams(A0k, A0k));
        AbstractC6374YB.A0K(super.A09);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A0W() {
        if (this.A0B != null) {
            this.A0B.A04(EnumC6199VH.A0A, null);
        }
        if (this.A0A.A0O(this.A0U.A02(), true)) {
            ...
            C6307X6.A0O(new C6307X6(), this.A0U, AbstractC6312XB.A00(this.A09.A00()), this.A0F);
        }
    }
    ...
    private void A0Y() {
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        if (this.A0R.A2U()) {
            layoutParams.setMargins(0, 0, AbstractC6332XV.A0e, AbstractC6332XV.A0v);
            layoutParams.addRule(12);
            layoutParams.addRule(11);
        } else {
            layoutParams.setMargins(AbstractC6332XV.A0Z, 0, 0, 0);
    ...
    private void A0c(int i, int i2) {
        ...
        if (i2 == 1) {
            if (this.A0W.getVisibility() == 8) {
                layoutParams.setMargins(0, 0, AbstractC6332XV.A0b, AbstractC6332XV.A0v);
                layoutParams.addRule(12);
                layoutParams.addRule(11);
            } else {
                if (!this.A0R.A2U()) {
            ...
            if (this.A0R.A2U()) {
                layoutParams.setMargins(0, 0, AbstractC6332XV.A0b, AbstractC6332XV.A0e);
            } else {
                layoutParams.setMargins(0, 0, AbstractC6332XV.A0b, AbstractC6332XV.A0v);
            }
            layoutParams.addRule(0, i);
    ...
    private void A0d(int i, int i2) {
        ...
        if (i2 == 1) {
            ...
            if (this.A0V.getVisibility() == 8) {
                ...
                layoutParams.setMargins(i3, 0, AbstractC6332XV.A0v, AbstractC6332XV.A0v);
                layoutParams.addRule(0, this.A0K.getId());
            } else if (this.A0R.A2U()) {
                layoutParams.setMargins(AbstractC6332XV.A0b, 0, AbstractC6332XV.A0b, AbstractC6332XV.A0j);
            } else {
                layoutParams.setMargins(AbstractC6332XV.A0b, 0, AbstractC6332XV.A0b, AbstractC6332XV.A0v);
            }
        } else {
            if (this.A0V.getVisibility() == 8) {
                layoutParams.setMargins(AbstractC6332XV.A0b, 0, AbstractC6332XV.A0b, AbstractC6332XV.A0v);
                ...
                layoutParams.setMargins(AbstractC6332XV.A0b, 0, AbstractC6332XV.A0b, AbstractC6332XV.A0o);
    ...
    private void A0e(View view) {
        if (view != null) {
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
            layoutParams.setMargins(AbstractC6332XV.A0e, 0, 0, AbstractC6332XV.A0v);
            layoutParams.addRule(12);
            layoutParams.addRule(9);
    ...
    private void A0f(View view, int i) {
        if (view != null) {
            ...
            if (i != 1) {
                layoutParams.setMargins(0, 0, 0, AbstractC6332XV.A0e);
                layoutParams.addRule(5, this.A0W.getId());
                layoutParams.addRule(12);
            } else if (this.A0W.getVisibility() == 8) {
                layoutParams.setMargins(0, AbstractC6332XV.A0v, AbstractC6332XV.A0b, 0);
                layoutParams.addRule(12);
                layoutParams.addRule(9);
            } else {
                layoutParams.setMargins(0, 0, 0, AbstractC6332XV.A0v);
    ...
    public final void A0j() {
        ...
        AbstractC6374YB.A0d(this.A0O, this.A0N, super.A09, this.A0Q, super.A08, this.A0W, this.A04, this.A0P, this.A0K, this.A0V, this.A06, this.A05, this.A0J, this.A0M);
        removeAllViews();
        this.A0V.A0O();
    }
    ...
    public final void A0k() {
        super.A09.setOnClickListener(AbstractC6605bu.A03(super.A08, A0T(27, 4, 19)));
        this.A0Q.setOnClickListener(AbstractC6605bu.A03(super.A08, A0T(74, 5, 18)));
        this.A0P.setOnClickListener(AbstractC6605bu.A03(super.A08, A0T(16, 11, Sdk.SDKError.Reason.INVALID_METRICS_ENDPOINT_VALUE)));
        this.A0W.setOnClickListener(AbstractC6605bu.A03(super.A08, A0T(48, 12, 20)));
        if (this.A04 != null) {
            this.A04.setOnClickListener(AbstractC6605bu.A03(super.A08, A0T(31, 17, 106)));
        }
    }
    ...
    public final void A0z(ViewGroup viewGroup, boolean z, boolean z2, int i) {
        AbstractC6374YB.A0d(this.A0K, this.A0V, this.A06, this.A0W, super.A09, this.A0Q, this.A0P, this.A04, this.A05);
        ...
        if (z) {
            ...
            if (this.A04 != null) {
                ...
                int orientation4 = AbstractC6332XV.A0v;
    ...
    public C5110DZ getProgressBarAnimation() {
        return this.A0W;
    }
    ...
    public void setPlaceHolderTextForRewardsConversion(String str) {
        if (this.A04 != null) {
            ...
            textView.setOnClickListener(AbstractC6605bu.A03(super.A08, A0T(31, 17, 106)));
        }
    }

    private void setUpAdReportingInitiateView(AbstractC7077jd abstractC7077jd) {
        if (abstractC7077jd.A2Q() || abstractC7077jd.A2U()) {
    ...
    private void setUpCreditLineV2(AbstractC7077jd abstractC7077jd) {
        if (abstractC7077jd.A2W()) {
            this.A06 = AbstractC6511aO.A02(this.A0U, EnumC6509aM.A03, abstractC7077jd);
            AbstractC6374YB.A0K(this.A06);
        } else {
            if (!abstractC7077jd.A2V()) {
                return;
            }
            this.A05 = AbstractC6511aO.A01(this.A0U, true, this.A0R, this.A0B, this.A0C, EnumC6509aM.A03, EnumC6512aP.A04);
