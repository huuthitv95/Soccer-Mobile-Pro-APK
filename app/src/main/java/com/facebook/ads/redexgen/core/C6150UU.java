...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.UU */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C6150UU {
    ...
    public final int A04(C6150UU c6150uu) {
        if (this.A00 != c6150uu.A00) {
            return this.A00 - c6150uu.A00;
        }
        return this.A01 - c6150uu.A01;
    }

    public final C6150UU A05(int i) {
        if (this.A01 + i >= 0) {
            return new C6150UU(this.A00, this.A01 + i);
        }
        throw new IllegalArgumentException(String.format(Locale.US, A00(0, 35, 64), Integer.valueOf(i), Integer.valueOf(this.A01)));
    }

    public final boolean equals(Object obj) {
        if (!(obj instanceof C6150UU)) {
            return false;
        }
        C6150UU c6150uu = (C6150UU) obj;
        return c6150uu.A00 == this.A00 && c6150uu.A01 == this.A01;
    }
