...
public final class C5552Kj {
    ...
    public C5552Kj(String str, int i, String str2, Set<String> classes) {
        this.A00 = i;
        this.A01 = str;
        this.A02 = str2;
        this.A03 = classes;
    ...
    public static C5552Kj A00() {
        Set setEmptySet = Collections.emptySet();
        String strA02 = A02(0, 0, 5);
        return new C5552Kj(strA02, 0, strA02, setEmptySet);
    }

    public static C5552Kj A01(String str, int i) {
        String strTrim;
        String strTrim2 = str.trim();
        AbstractC45353y.A07(!strTrim2.isEmpty());
        ...
        String[] strArrA1O = AbstractC46115C.A1O(strTrim2, A02(1, 2, 47));
        String str2 = strArrA1O[0];
        HashSet hashSet = new HashSet();
        for (int i2 = 1; i2 < voiceStartIndex; i2++) {
            hashSet.add(strArrA1O[i2]);
        }
        return new C5552Kj(str2, i, strTrim, hashSet);
    }
}
