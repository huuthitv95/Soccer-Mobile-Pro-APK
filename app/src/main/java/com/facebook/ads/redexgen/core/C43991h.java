...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.1h */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C43991h extends AbstractC4917AQ {
    public int A00;
    public Uri A01;
    ...
    public C43991h(int i) {
        this(i, 8000);
    }

    public C43991h(int i, int i2) {
        super(true);
        this.A06 = i2;
        this.A08 = new byte[i];
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC7408pF
    public final long AGi(C46435i c46435i) throws C7394p1 {
        this.A01 = c46435i.A06;
        String str = (String) AbstractC45353y.A01(this.A01.getHost());
        ...
        try {
            ...
            throw new C7394p1(e, 2001);
        } catch (SecurityException e2) {
            throw new C7394p1(e2, 2006);
        }
    }
    ...
    public final void close() {
        ...
        if (this.A04 != null) {
            try {
                this.A04.leaveGroup((InetAddress) AbstractC45353y.A01(this.A03));
    ...
    public final int read(byte[] bArr, int i, int i2) throws IOException {
        ...
        if (this.A00 == 0) {
            try {
                ((DatagramSocket) AbstractC45353y.A01(this.A02)).receive(this.A07);
                this.A00 = this.A07.getLength();
                A0F(this.A00);
            } catch (SocketTimeoutException e) {
                throw new C7394p1(e, 2002);
            } catch (IOException e2) {
                throw new C7394p1(e2, 2001);
            }
        }
