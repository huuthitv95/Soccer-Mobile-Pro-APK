...
public final class C6412Yn extends AdNativeComponentView {
    ...
    public final C6221Vd A06;
    public final C5658MR A07;
    ...
    public static final int A09 = ((int) AbstractC6334XX.A02) * 500;
    public static final int A0H = (int) (AbstractC6334XX.A02 * 500.0f);
    public static final int A0D = (int) (AbstractC6334XX.A02 * 4.0f);
    public static final int A0B = (int) (AbstractC6334XX.A02 * 8.0f);
    public static final int A0G = (int) (AbstractC6334XX.A02 * 8.0f);
    public static final int A0E = (int) (AbstractC6334XX.A02 * 4.0f);
    public static final int A0C = (int) AbstractC6334XX.A02;
    public static final int A0F = (int) (AbstractC6334XX.A02 * 4.0f);
    public static final int A0A = (int) (((double) AbstractC6334XX.A02) * 0.5d);

    public C6412Yn(C6902gi c6902gi, C6221Vd c6221Vd) {
        super(c6902gi);
        this.A06 = c6221Vd;
        this.A05 = new TextView(c6902gi);
        this.A04 = new TextView(c6902gi);
        this.A03 = new TextView(c6902gi);
        this.A02 = new RelativeLayout(c6902gi);
        this.A00 = new LinearLayout(c6902gi);
        this.A01 = new RelativeLayout(c6902gi);
        this.A07 = new C5658MR(c6902gi);
        A09();
        A0D();
        A05();
        A0A();
    ...
    public final void onMeasure(int i, int i2) {
        int iA0F = ((int) AbstractC6334XX.A02) * C6171Up.A0F(getContext());
