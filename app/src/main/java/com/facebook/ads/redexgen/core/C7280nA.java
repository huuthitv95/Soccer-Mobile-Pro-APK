...
public final class C7280nA implements InterfaceC5205F6, InterfaceC46545t {
    public int A00;
    public int A01;
    ...
    public final C5203F4 A0C;
    public final C5231FW A0D;
    ...
    @Deprecated
    public C7280nA() {
        this(null, Collections.emptyMap(), 2000, InterfaceC454245.A00, false);
    }

    public C7280nA(Context context, Map<Integer, Long> initialBitrateEstimates, int i, InterfaceC454245 interfaceC454245, boolean z) {
        this.A0E = MetaExoPlayerCustomizedCollections.A04(initialBitrateEstimates);
        this.A0C = new C5203F4();
        this.A0D = new C5231FW(i);
        this.A0B = interfaceC454245;
        this.A0F = z;
        if (context != null) {
            C45884p c45884pA03 = C45884p.A03(context);
            this.A00 = c45884pA03.A09();
            this.A04 = A00(this.A00);
            c45884pA03.A0A(new InterfaceC45864n() { // from class: com.facebook.ads.redexgen.X.nB
                @Override // com.facebook.ads.redexgen.core.InterfaceC45864n
    ...
    public static boolean A04(C46435i c46435i, boolean z) {
        return z && !c46435i.A06(8);
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC46545t
    public final synchronized void ADK(InterfaceC7408pF interfaceC7408pF, C46435i c46435i, boolean z, int i) {
        if (A04(c46435i, z)) {
            this.A06 += (long) i;
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC46545t
    public final synchronized void AGG(InterfaceC7408pF interfaceC7408pF, C46435i c46435i, boolean z) {
        if (A04(c46435i, z)) {
            AbstractC45353y.A08(this.A03 > 0);
            ...
            if (i > 0) {
                ...
                C5231FW c5231fw = this.A0D;
                int sampleElapsedTimeMs = (int) Math.sqrt(this.A06);
                c5231fw.A07(sampleElapsedTimeMs, f);
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC46545t
    public final synchronized void AGH(@MetaExoPlayerCustomization InterfaceC7408pF interfaceC7408pF, C46435i c46435i, boolean z, boolean z2) {
        if (A04(c46435i, z)) {
            if (this.A03 == 0) {
