...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.SA */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C6008SA implements NativeBannerAdApi {
    ...
    public C6008SA(NativeAdBaseApi nativeAdBaseApi) {
        this.A00 = C6140UK.A0L(nativeAdBaseApi);
        this.A00.A1i(EnumC6232Vq.A05);
    }

    private void A02(ImageView imageView, NativeAdBaseApi nativeAdBaseApi) {
        C6140UK c6140ukA0L = C6140UK.A0L(nativeAdBaseApi);
        C6924h4 c6924h4 = new C6924h4(this, imageView, c6140ukA0L);
        C6219Vb c6219VbA19 = c6140ukA0L.getAdIcon();
        if (c6219VbA19 != null) {
            Bitmap bitmapA0N = c6140ukA0L.A14().A0N(c6219VbA19.getUrl());
            Context context = imageView.getContext();
            String[] strArr = A02;
            if (strArr[2].charAt(21) == strArr[6].charAt(21)) {
                A02[4] = "oesEo3u5gOmbsNZfXjsimFyw8pPXYbZZ";
                C6902gi c6902giA03 = C5987Rp.A03(context);
                if (bitmapA0N != null) {
                    Drawable drawableA05 = C6140UK.A05(c6902giA03, bitmapA0N, c6140ukA0L.A1t(), c6140ukA0L.A1I());
                    C6140UK.A0f(drawableA05, imageView);
                    imageView.post(new C6923h3(this, c6140ukA0L, drawableA05));
                    return;
                } else {
                    C6924h4 c6924h5 = null;
                    AsyncTaskC6005S7 loadImageTask = new AsyncTaskC6005S7(c6902giA03, c6924h4, c6140ukA0L.A1t(), c6924h5);
                    loadImageTask.execute(new C6007S9(c6219VbA19.getUrl(), c6140ukA0L.A1I(), c6924h5));
                    return;
                }
            }
        } else {
            ...
            if (A02[4].charAt(17) != 't') {
                ...
                c6140ukA0L.A16().A0F().A3N(-1L, adErrorType.getErrorCode(), adErrorType.getDefaultErrorMessage());
    ...
    public final void registerViewForInteraction(View view, ImageView imageView, List<View> list) {
        ...
        if (list != null) {
            ...
            strArr[5] = "ll9cTRtW3a";
            strArr[7] = "WGLVGgKdvO";
            c6140uk.A1T(view, imageView, list);
            return;
        }
    ...
    public final void registerViewForInteraction(View view, MediaView mediaView, List<View> clickableViews) {
        if (mediaView != null) {
            ((C6932hC) mediaView.getMediaViewApi()).A0X(this.A00, true);
        }
