...
/* JADX INFO: renamed from: com.facebook.ads.redexgen.X.Tn */
/* JADX INFO: loaded from: assets/audience_network/classes2.dex */
public final class C6108Tn {
    ...
    public static void A09(Context context) {
        ...
        ((ActivityManager) AbstractC6953hX.A00((ActivityManager) context.getSystemService(A01(16, 8, 108)))).getMemoryInfo(memoryInfo);
        A07.put(A01(61, 16, 115), String.valueOf(memoryInfo.availMem));
        A07.put(A01(140, 12, 58), String.valueOf(memoryInfo.totalMem));
    }

    public static void A0A(C6067T8 c6067t8) {
        try {
            Intent intentA00 = AbstractC6311XA.A00(c6067t8, null, new IntentFilter(A01(24, 37, 65)));
            if (intentA00 == null) {
                return;
            }
            ...
            c6067t8.A08().ABC(A01(102, 7, 96), AbstractC6098Td.A1T, new C6099Te(e));
        }
    }

    public static synchronized void A0B(C6067T8 c6067t8) {
        A09(c6067t8);
        A0A(c6067t8);
        if (A04 == null) {
            A04 = (SensorManager) c6067t8.getSystemService(A01(128, 6, 101));
            if (A04 == null) {
                return;
            }
        }
