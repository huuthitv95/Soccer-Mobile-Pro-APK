...
public final class C6911gr implements InterfaceC6042Sj {
    ...
    public final Map<String, AbstractC6040Sh> A00 = new HashMap();
     ...
     */
    @Override // com.facebook.ads.redexgen.core.InterfaceC6042Sj
    public final synchronized String AIb() {
        StringBuilder sb;
        sb = new StringBuilder();
        Iterator<AbstractC6040Sh> it = this.A00.values().iterator();
        if (it.hasNext()) {
            it.next();
