...
public abstract class AbstractC5587LI {
    ...
    public static long A01(C45944v c45944v, int i, int i2) {
        c45944v.A0f(i);
        if (c45944v.A07() < 5) {
        ...
        int tsPacketHeader5 = c45944v.A0I();
        if (tsPacketHeader5 >= 7) {
            int tsPacketHeader6 = c45944v.A07();
            if (tsPacketHeader6 >= 7) {
                int tsPacketHeader7 = c45944v.A0I();
                if ((tsPacketHeader7 & 16) == 16) {
                    byte[] bArr = new byte[6];
                    int tsPacketHeader8 = bArr.length;
                    c45944v.A0k(bArr, 0, tsPacketHeader8);
                    long jA02 = A02(bArr);
                    String[] strArr = A00;
                    String str = strArr[4];
