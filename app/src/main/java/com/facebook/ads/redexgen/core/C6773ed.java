...
public class C6773ed extends AbstractRunnableC6279Wc {
    ...
    public final /* synthetic */ C6898ge A01;
    ...
    public C6773ed(C6898ge c6898ge, AudienceNetworkAds.InitListener initListener) {
        this.A01 = c6898ge;
    ...
    public final void A07() {
        try {
            C6452ZR.A02().A0C(this.A01);
        } catch (Throwable th) {
            this.A01.A08().A4I(th);
        }
        C6122U2.A0C(this.A01);
        if (this.A00 != null) {
            C6122U2.A04(this.A00, new C6121U1(true, A00(0, 29, 22)));
        }
    }
}
