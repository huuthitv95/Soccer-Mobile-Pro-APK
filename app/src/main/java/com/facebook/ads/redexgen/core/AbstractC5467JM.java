...
public abstract class AbstractC5467JM {
    ...
    public static boolean A01(InterfaceC7263ms interfaceC7263ms) throws IOException {
        return A03(interfaceC7263ms, true, false);
    }

    public static boolean A02(InterfaceC7263ms interfaceC7263ms, boolean z) throws IOException {
        return A03(interfaceC7263ms, false, z);
    }

    public static boolean A03(InterfaceC7263ms interfaceC7263ms, boolean z, boolean z2) throws IOException {
        long jA8O = interfaceC7263ms.A8O();
        long inputLength = PlaybackStateCompat.ACTION_SKIP_TO_QUEUE_ITEM;
        if (jA8O != -1 && jA8O <= PlaybackStateCompat.ACTION_SKIP_TO_QUEUE_ITEM) {
            inputLength = jA8O;
        }
        int i = (int) inputLength;
        C45944v c45944v = new C45944v(64);
        int i2 = 0;
        boolean z3 = false;
        boolean z4 = false;
        while (i2 < i) {
            int i3 = 8;
            c45944v.A0d(8);
            if (!interfaceC7263ms.AGu(c45944v.A0l(), 0, 8, true)) {
                break;
            }
            long jA0Q = c45944v.A0Q();
            int headerSize = c45944v.A0C();
            if (jA0Q == 1) {
                i3 = 16;
                interfaceC7263ms.AGt(c45944v.A0l(), 8, 8);
                c45944v.A0e(16);
                jA0Q = c45944v.A0P();
            } else if (jA0Q == 0) {
                long jA8O2 = interfaceC7263ms.A8O();
                if (jA8O2 != -1) {
                    jA0Q = (jA8O2 - interfaceC7263ms.A8i()) + ((long) 8);
                }
            }
            if (jA0Q < i3) {
                return false;
            ...
            if (headerSize == 1836019574) {
                ...
                if (headerSize == 1718909296) {
                    if (atomDataSize >= 8) {
                        c45944v.A0d(atomDataSize);
                        interfaceC7263ms.AGt(c45944v.A0l(), 0, atomDataSize);
                        int atomDataSize2 = atomDataSize / 4;
                        for (int brandsCount = 0; brandsCount < atomDataSize2; brandsCount++) {
                            if (brandsCount == 1) {
                                c45944v.A0g(4);
                            } else if (A00(c45944v.A0C(), z2)) {
                                z3 = true;
                                break;
                            }
                        }
                    ...
                    interfaceC7263ms.A47(atomDataSize);
                }
            }
        }
        return z3 && z == z4;
