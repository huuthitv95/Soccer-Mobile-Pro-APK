...
public abstract class AbstractC6321XK {
    ...
    public static volatile EnumC6320XJ A04;
    ...
    public static void A09(Context context) {
        ...
        A04 = EnumC6320XJ.A03;
        Executors.newSingleThreadExecutor().execute(new C5930Qu(context));
    }

    public static void A0A(C6067T8 c6067t8, Throwable th) {
        c6067t8.A08().ABC(A06(38, 7, 85), AbstractC6098Td.A1c, new C6099Te(th));
    }

    public static boolean A0B() {
        return A04 == EnumC6320XJ.A02;
    }
    ...
    public static boolean A0C(C6067T8 c6067t8) {
        ...
        if (cachedValue != null) {
            ...
            boolean z = true;
            try {
                xmlResourceParserOpenXmlResourceParser = c6067t8.getAssets().openXmlResourceParser(A06(0, 19, 21));
