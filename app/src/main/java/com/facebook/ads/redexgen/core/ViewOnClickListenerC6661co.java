...
public class ViewOnClickListenerC6661co implements View.OnClickListener {
    ...
    public static void A01() {
        A01 = new byte[]{Ascii.ETB, 19, Ascii.f22502US, Ascii.f22491EM, Ascii.ESC};
    }

    public ViewOnClickListenerC6661co(C5489Ji c5489Ji) {
        this.A00 = c5489Ji;
    }
