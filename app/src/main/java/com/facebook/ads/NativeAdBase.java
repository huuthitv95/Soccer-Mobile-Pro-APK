...
public abstract class NativeAdBase implements InterfaceC4297Ad {
    ...
    public interface NativeAdLoadConfigBuilder extends InterfaceC4297Ad.LoadConfigBuilder {
    ...
    public interface NativeLoadAdConfig extends InterfaceC4297Ad.LoadAdConfig {
    }
