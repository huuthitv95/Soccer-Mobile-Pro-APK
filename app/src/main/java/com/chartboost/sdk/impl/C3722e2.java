...
public final /* data */ class C3722e2 {
    ...
    /* JADX INFO: renamed from: com.chartboost.sdk.impl.e2$a */
    public static final class a implements GeneratedSerializer {
        ...
        public static final /* synthetic */ PluginGeneratedSerialDescriptor f14005b;
        ...
        static {
            ...
            f14005b = pluginGeneratedSerialDescriptor;
        }

        @Override // kotlinx.serialization.DeserializationStrategy
        /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
        public C3722e2 deserialize(Decoder decoder) {
            String str;
            ...
            return new C3722e2(i, str, serializationConstructorMarker);
        }

        @Override // kotlinx.serialization.SerializationStrategy
        /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
        public void serialize(Encoder encoder, C3722e2 value) {
            Intrinsics.checkNotNullParameter(encoder, "encoder");
            Intrinsics.checkNotNullParameter(value, "value");
            SerialDescriptor descriptor = getDescriptor();
            CompositeEncoder compositeEncoderBeginStructure = encoder.beginStructure(descriptor);
            C3722e2.m17470a(value, compositeEncoderBeginStructure, descriptor);
    ...
    /* JADX INFO: renamed from: com.chartboost.sdk.impl.e2$b, reason: from kotlin metadata */
    public static final class Companion {
        ...
        public final KSerializer<C3722e2> serializer() {
            return a.f14004a;
        }
    }

    public /* synthetic */ C3722e2(int i, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if ((i & 1) == 0) {
    ...
    public C3722e2(String str) {
        this.placementType = str;
    }

    /* JADX INFO: renamed from: a */
    public static final /* synthetic */ void m17470a(C3722e2 self, CompositeEncoder output, SerialDescriptor serialDesc) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof C3722e2) && Intrinsics.areEqual(this.placementType, ((C3722e2) other).placementType);
    }
