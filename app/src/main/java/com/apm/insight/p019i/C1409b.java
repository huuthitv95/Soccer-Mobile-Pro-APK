...
import com.apm.insight.p017g.InterfaceC1403c;
...
/* JADX INFO: renamed from: com.apm.insight.i.b */
/* JADX INFO: compiled from: LaunchCrash.java */
/* JADX INFO: loaded from: classes3.dex */
public final class C1409b implements InterfaceC1403c {
    ...
    private synchronized void m1187b(final long j, final Thread thread, final Throwable th, final String str, final String str2, final boolean z) {
        final File file = new File(C1434j.m1368a(this.f610a), str);
        C1401a.m1147a().m1163a(file.getName());
        file.mkdirs();
        C1430f.m1342d(file);
        final boolean zM1430c = C1437m.m1430c(th);
        C1395a c1395aM1610a = C1453f.m1608a().m1610a(CrashType.LAUNCH, new AbstractC1450c.a() { // from class: com.apm.insight.i.b.1
            ...
            public final C1395a mo1171a(int i, C1395a c1395a) {
                this.f611a = SystemClock.uptimeMillis();
                if (i == 0) {
                    c1395a.m1095a("stack", (Object) C1437m.m1412a(th));
                    c1395a.m1095a("event_type", "start_crash");
                    ...
                    if (i == 1) {
                        c1395a.m1095a("timestamp", Long.valueOf(j));
                        c1395a.m1095a("main_process", Boolean.valueOf(C1425a.m1292b(C1409b.this.f610a)));
                        c1395a.m1095a("crash_type", CrashType.JAVA);
                        ...
                        C1401a.m1147a().m1164a(thread, th, true, c1395a);
                        return c1395a;
                    }
                    if (i == 2) {
                        if (zM1430c) {
                            C1425a.m1288a(C1409b.this.f610a, c1395a.m1102c());
                        }
                        c1395a.m1095a("launch_did", (Object) C1408a.m1185a(C1409b.this.f610a));
                        if (C1390e.m1049x()) {
    ...
    /* JADX INFO: renamed from: a */
    public final void mo1169a(long j, Thread thread, Throwable th, String str, String str2, boolean z) {
        m1187b(j, thread, th, str, str2, z);
    }
}
