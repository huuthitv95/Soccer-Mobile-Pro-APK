...
class SelectSnapshotUiRequest implements HelperFragment.Request {
    ...
    public void process(final HelperFragment helperFragment) {
        ...
        PlayGames.getSnapshotsClient(activity).getSelectSnapshotIntent(this.title, this.allowAddButton, this.allowDelete, this.maxSnapshots).addOnSuccessListener(activity, new OnSuccessListener<Intent>(this) { // from class: com.google.games.bridge.SelectSnapshotUiRequest.2
