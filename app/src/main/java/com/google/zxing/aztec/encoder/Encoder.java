...
public final class Encoder {
    ...
    public static AztecCode encode(byte[] bArr, int i, int i2) {
        ...
        int i23 = i22;
        while (i22 < iAbs) {
            int i24 = ((iAbs - i22) << i16) + (z ? 9 : 12);
            int i25 = i6;
            while (i25 < i24) {
                int i26 = i25 << 1;
                while (i6 < i16) {
                    int i27 = i7;
                    if (bitArrayGenerateCheckWords.get(i23 + i26 + i6)) {
                        int i28 = i22 << 1;
                        bitMatrix.set(iArr[i28 + i6], iArr[i28 + i25]);
                    }
                    if (bitArrayGenerateCheckWords.get((i24 << 1) + i23 + i26 + i6)) {
                        int i29 = i22 << 1;
                        bitMatrix.set(iArr[i29 + i25], iArr[((i15 - 1) - i29) - i6]);
                    }
                    if (bitArrayGenerateCheckWords.get((i24 << 2) + i23 + i26 + i6)) {
                        int i30 = (i15 - 1) - (i22 << 1);
                        bitMatrix.set(iArr[i30 - i6], iArr[i30 - i25]);
                    }
                    if (bitArrayGenerateCheckWords.get((i24 * 6) + i23 + i26 + i6)) {
                        int i31 = i22 << 1;
                        bitMatrix.set(iArr[((i15 - 1) - i31) - i25], iArr[i31 + i6]);
                    }
                    i6++;
                    i7 = i27;
                    i16 = i16;
