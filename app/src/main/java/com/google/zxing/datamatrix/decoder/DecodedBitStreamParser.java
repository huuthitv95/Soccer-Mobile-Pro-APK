...
final class DecodedBitStreamParser {
    ...
    static {
        char[] cArr = {'!', '\"', '#', Typography.dollar, '%', Typography.amp, '\'', '(', ')', '*', '+', AbstractJsonLexerKt.COMMA, '-', '.', '/', AbstractJsonLexerKt.COLON, ';', Typography.less, C11341A5.f23808U, Typography.greater, '?', '@', AbstractJsonLexerKt.BEGIN_LIST, AbstractJsonLexerKt.STRING_ESC, AbstractJsonLexerKt.END_LIST, '^', '_'};
    ...
    static DecoderResult decode(byte[] bArr) throws FormatException {
        ...
        do {
            if (modeDecodeAsciiSegment == Mode.ASCII_ENCODE) {
                ...
                int i = C108901.f22641xb73eb560[modeDecodeAsciiSegment.ordinal()];
                if (i == 1) {
    ...
    static /* synthetic */ class C108901 {

        /* JADX INFO: renamed from: $SwitchMap$com$google$zxing$datamatrix$decoder$DecodedBitStreamParser$Mode */
        static final /* synthetic */ int[] f22641xb73eb560;

        static {
            int[] iArr = new int[Mode.values().length];
            f22641xb73eb560 = iArr;
            try {
                iArr[Mode.C40_ENCODE.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f22641xb73eb560[Mode.TEXT_ENCODE.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f22641xb73eb560[Mode.ANSIX12_ENCODE.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f22641xb73eb560[Mode.EDIFACT_ENCODE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f22641xb73eb560[Mode.BASE256_ENCODE.ordinal()] = 5;
