...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        int i8 = 56;
        Version version13 = new Version(13, 44, 44, 20, 20, new ECBlocks(i8, new ECB(i, 144)));
        int i9 = 68;
        Version version14 = new Version(14, 48, 48, 22, 22, new ECBlocks(i9, new ECB(i, 174)));
        int i10 = 2;
        Version version15 = new Version(15, 52, 52, 24, 24, new ECBlocks(42, new ECB(i10, 102)));
        Version version16 = new Version(16, 64, 64, 14, 14, new ECBlocks(i8, new ECB(i10, 140)));
        int i11 = 4;
        Version version17 = new Version(17, 72, 72, 16, 16, new ECBlocks(i6, new ECB(i11, 92)));
        Version version18 = new Version(18, 80, 80, 18, 18, new ECBlocks(48, new ECB(i11, 114)));
        Version version19 = new Version(19, 88, 88, 20, 20, new ECBlocks(i8, new ECB(i11, 144)));
        Version version20 = new Version(20, 96, 96, 22, 22, new ECBlocks(i9, new ECB(i11, 174)));
        int i12 = 6;
        Version version21 = new Version(21, 104, 104, 24, 24, new ECBlocks(i8, new ECB(i12, 136)));
        Version version22 = new Version(22, 120, 120, 18, 18, new ECBlocks(i9, new ECB(i12, 175)));
        Version version23 = new Version(23, Sdk.SDKError.Reason.OMSDK_DOWNLOAD_JS_ERROR_VALUE, Sdk.SDKError.Reason.OMSDK_DOWNLOAD_JS_ERROR_VALUE, 20, 20, new ECBlocks(i7, new ECB(i3, 163)));
        Version version24 = new Version(24, 144, 144, 22, 22, new ECBlocks(i7, new ECB(i3, 156), new ECB(i10, 155)));
        int i13 = 1;
