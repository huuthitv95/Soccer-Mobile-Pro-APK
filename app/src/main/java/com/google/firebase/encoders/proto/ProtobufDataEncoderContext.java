...
final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    static /* synthetic */ class C106721 {

        /* JADX INFO: renamed from: $SwitchMap$com$google$firebase$encoders$proto$Protobuf$IntEncoding */
        static final /* synthetic */ int[] f22586x531607dd;

        static {
            int[] iArr = new int[Protobuf.IntEncoding.values().length];
            f22586x531607dd = iArr;
            try {
                iArr[Protobuf.IntEncoding.DEFAULT.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f22586x531607dd[Protobuf.IntEncoding.SIGNED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f22586x531607dd[Protobuf.IntEncoding.FIXED.ordinal()] = 3;
    ...
    ProtobufDataEncoderContext add(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (!z || i != 0) {
            ...
            int i2 = C106721.f22586x531607dd[protobuf.intEncoding().ordinal()];
            if (i2 == 1) {
    ...
    ProtobufDataEncoderContext add(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (!z || j != 0) {
            Protobuf protobuf = getProtobuf(fieldDescriptor);
            int i = C106721.f22586x531607dd[protobuf.intEncoding().ordinal()];
            if (i == 1) {
                writeVarInt32(protobuf.tag() << 3);
                writeVarInt64(j);
                return this;
    ...
    public ObjectEncoderContext nested(String str) throws IOException {
        return nested(FieldDescriptor.m23050of(str));
    }
