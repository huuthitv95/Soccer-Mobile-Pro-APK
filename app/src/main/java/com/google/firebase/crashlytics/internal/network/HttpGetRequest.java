...
public class HttpGetRequest {
    ...
    public HttpResponse execute() throws Throwable {
        ...
        try {
            ...
            Logger.getLogger().m23026v("GET Request URL: " + strCreateUrlWithParams);
    ...
    private String createUrlWithParams(String str, Map<String, String> map) throws UnsupportedEncodingException {
        ...
        if (str.contains("?")) {
            if (!str.endsWith(C11744X3.j.f26436c)) {
                strCreateParamsString = C11744X3.j.f26436c + strCreateParamsString;
            }
