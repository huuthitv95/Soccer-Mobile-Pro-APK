...
public class AnalyticsDeferredProxy {
    ...
    private void init() {
        this.analyticsConnectorDeferred.whenAvailable(new Deferred.DeferredHandler() { // from class: com.google.firebase.crashlytics.AnalyticsDeferredProxy$$ExternalSyntheticLambda2
            ...
            public final void handle(Provider provider) {
                this.f$0.m23018xec284ea4(provider);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$init$2$com-google-firebase-crashlytics-AnalyticsDeferredProxy */
    /* synthetic */ void m23018xec284ea4(Provider provider) {
        Logger.getLogger().m23020d("AnalyticsConnector now available.");
        ...
        if (subscribeToAnalyticsEvents(analyticsConnector, crashlyticsAnalyticsListener) != null) {
            Logger.getLogger().m23020d("Registered Firebase Analytics listener.");
        ...
        Logger.getLogger().m23028w("Could not register Firebase Analytics listener; a listener is already registered.");
    }
    ...
    private static AnalyticsConnector.AnalyticsConnectorHandle subscribeToAnalyticsEvents(AnalyticsConnector analyticsConnector, CrashlyticsAnalyticsListener crashlyticsAnalyticsListener) {
        ...
        Logger.getLogger().m23020d("Could not register AnalyticsConnectorListener with Crashlytics origin.");
        ...
        if (analyticsConnectorHandleRegisterAnalyticsConnectorListener2 != null) {
            Logger.getLogger().m23028w("A new version of the Google Analytics for Firebase SDK is now available. For improved performance and compatibility with Crashlytics, please update to the latest version.");
        }
