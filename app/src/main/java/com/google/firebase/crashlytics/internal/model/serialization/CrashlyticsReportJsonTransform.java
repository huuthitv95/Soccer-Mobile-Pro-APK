...
public class CrashlyticsReportJsonTransform {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (strNextName.hashCode()) {
                ...
                case 1047652060:
                    ...
                    break;
                case 1874684019:
                    if (strNextName.equals(C11540L6.f24917H)) {
                        b = 9;
                    }
                    break;
                case 1975623094:
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (strNextName.hashCode()) {
                ...
                case -1606742899:
                    ...
                    break;
                case -1335157162:
                    if (strNextName.equals(C11744X3.i.f26328G)) {
                        b = 4;
                    }
                    break;
                case -1291329255:
                    ...
                    break;
                case 3556:
                    if (strNextName.equals(C11540L6.f24911F)) {
                        b = 6;
                    }
                    break;
                case 96801:
    ...
    public static CrashlyticsReport.FilesPayload.File parseFile(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            } else if (strNextName.equals(TTContentsEventConstants.Params.EVENT_PROPERTY_CONTENTS)) {
