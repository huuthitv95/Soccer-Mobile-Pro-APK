...
public class RemoteConfigDeferredProxy {
    ...
    public void setupListener(UserMetadata userMetadata) {
        if (userMetadata == null) {
            Logger.getLogger().m23028w("Didn't successfully register with UserMetadata for rollouts listener");
        } else {
    ...
    static /* synthetic */ void lambda$setupListener$0(CrashlyticsRemoteConfigListener crashlyticsRemoteConfigListener, Provider provider) {
        ...
        Logger.getLogger().m23020d("Registering RemoteConfig Rollouts subscriber");
    }
}
