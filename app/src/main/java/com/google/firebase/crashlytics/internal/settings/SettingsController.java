...
public class SettingsController implements SettingsProvider {
    ...
    public Task<Void> loadSettingsData(SettingsCacheBehavior settingsCacheBehavior, CrashlyticsWorkers crashlyticsWorkers) throws Throwable {
        ...
        return this.dataCollectionArbiter.waitForDataCollectionPermission().onSuccessTask(crashlyticsWorkers.common, new C106641(crashlyticsWorkers));
    }

    /* JADX INFO: renamed from: com.google.firebase.crashlytics.internal.settings.SettingsController$1 */
    class C106641 implements SuccessContinuation<Void, Void> {
        final /* synthetic */ CrashlyticsWorkers val$crashlyticsWorkers;

        C106641(CrashlyticsWorkers crashlyticsWorkers) {
        ...
        public Task<Void> then(Void r5) throws Exception {
            JSONObject jSONObject = (JSONObject) this.val$crashlyticsWorkers.network.getExecutor().submit(new Callable() { // from class: com.google.firebase.crashlytics.internal.settings.SettingsController$1$$ExternalSyntheticLambda0
                ...
                public final Object call() {
                    return this.f$0.m23048xd7ba6dd6();
                }
            }).get();
            if (jSONObject != null) {
        ...
        /* synthetic */ JSONObject m23048xd7ba6dd6() throws Exception {
                ...
                if (cachedSettings != null) {
                    ...
                    if (settingsJson != null) {
                        ...
                        if (!SettingsCacheBehavior.IGNORE_CACHE_EXPIRATION.equals(settingsCacheBehavior) && settingsJson.isExpired(currentTimeMillis)) {
                            Logger.getLogger().m23026v("Cached settings have expired.");
                            return null;
                        }
                        try {
                            Logger.getLogger().m23026v("Returning cached settings.");
                            return settingsJson;
                        } catch (Exception e) {
                            e = e;
                            settings = settingsJson;
                            Logger.getLogger().m23023e("Failed to get cached settings", e);
                            return settings;
                        }
                    }
                    Logger.getLogger().m23023e("Failed to parse cached settings data.", null);
                    return null;
                }
                Logger.getLogger().m23020d("No cached settings data found.");
            }
            return null;
        } catch (Exception e2) {
            e = e2;
    ...
    public void logSettings(JSONObject jSONObject, String str) {
        Logger.getLogger().m23020d(str + jSONObject.toString());
    }
