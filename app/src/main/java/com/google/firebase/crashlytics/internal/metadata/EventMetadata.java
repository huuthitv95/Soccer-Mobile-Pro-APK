...
public final /* data */ class EventMetadata {
    ...
    public int hashCode() {
        return (((this.sessionId.hashCode() * 31) + UByte$$ExternalSyntheticBackport0.m43485m(this.timestamp)) * 31) + this.additionalCustomKeys.hashCode();
    }
