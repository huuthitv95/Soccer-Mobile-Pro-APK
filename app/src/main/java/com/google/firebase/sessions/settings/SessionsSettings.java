...
public final class SessionsSettings {
    ...
    @DebugMetadata(m43503c = "com.google.firebase.sessions.settings.SessionsSettings", m43504f = "SessionsSettings.kt", m43505i = {0}, m43506l = {145, 146}, m43507m = "updateSettings", m43508n = {"this"}, m43509s = {"L$0"})
    static final class C107211 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C107211(Continuation<? super C107211> continuation) {
            super(continuation);
        }
    ...
    public final long m44187getSessionRestartTimeoutUwyO8pc() {
        Duration durationMo44185getSessionRestartTimeoutFghU774 = this.localOverrideSettings.mo44185getSessionRestartTimeoutFghU774();
        if (durationMo44185getSessionRestartTimeoutFghU774 != null) {
            long rawValue = durationMo44185getSessionRestartTimeoutFghU774.getRawValue();
            if (m44186isValidSessionRestartTimeoutLRDsOJo(rawValue)) {
                return rawValue;
            }
        }
        Duration durationMo44185getSessionRestartTimeoutFghU775 = this.remoteSettings.mo44185getSessionRestartTimeoutFghU774();
        if (durationMo44185getSessionRestartTimeoutFghU775 != null) {
            long rawValue2 = durationMo44185getSessionRestartTimeoutFghU775.getRawValue();
            if (m44186isValidSessionRestartTimeoutLRDsOJo(rawValue2)) {
                return rawValue2;
            }
        }
    ...
    private final boolean m44186isValidSessionRestartTimeoutLRDsOJo(long sessionRestartTimeout) {
        return Duration.m46318isPositiveimpl(sessionRestartTimeout) && Duration.m46313isFiniteimpl(sessionRestartTimeout);
    }
    ...
    */
    public final java.lang.Object updateSettings(kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
        /*
            r5 = this;
            boolean r0 = r6 instanceof com.google.firebase.sessions.settings.SessionsSettings.C107211
            if (r0 == 0) goto L14
            r0 = r6
            com.google.firebase.sessions.settings.SessionsSettings$updateSettings$1 r0 = (com.google.firebase.sessions.settings.SessionsSettings.C107211) r0
            int r1 = r0.label
