...
public final class SessionDatastoreImpl implements SessionDatastore {
    ...
    public SessionDatastoreImpl(Context appContext, @Background CoroutineContext backgroundDispatcher) {
        ...
        final Flow flowM46468catch = FlowKt.m46468catch(Companion.getDataStore(appContext).getData(), new SessionDatastoreImpl$firebaseSessionDataFlow$1(null));
        this.firebaseSessionDataFlow = new Flow<FirebaseSessionsData>() { // from class: com.google.firebase.sessions.SessionDatastoreImpl$special$$inlined$map$1
            ...
            public Object collect(FlowCollector<? super FirebaseSessionsData> flowCollector, Continuation continuation) {
                Object objCollect = flowM46468catch.collect(new C107122(flowCollector, this), continuation);
            ...
            public static final class C107122<T> implements FlowCollector {
                ...
                @DebugMetadata(m43503c = "com.google.firebase.sessions.SessionDatastoreImpl$special$$inlined$map$1$2", m43504f = "SessionDatastore.kt", m43505i = {}, m43506l = {Sdk.SDKError.Reason.STALE_CACHED_RESPONSE_VALUE}, m43507m = "emit", m43508n = {}, m43509s = {})
                public static final class AnonymousClass1 extends ContinuationImpl {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        return C107122.this.emit(null, this);
                    }
                }

                public C107122(FlowCollector flowCollector, SessionDatastoreImpl sessionDatastoreImpl) {
        ...
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(backgroundDispatcher), null, null, new C107111(null), 3, null);
    }

    /* JADX INFO: compiled from: SessionDatastore.kt */
    @Metadata(m43474d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\bÂ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0017\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, m43475d2 = {"Lcom/google/firebase/sessions/SessionDatastoreImpl$FirebaseSessionDataKeys;", "", "()V", "SESSION_ID", "Landroidx/datastore/preferences/core/Preferences$Key;", "", "getSESSION_ID", "()Landroidx/datastore/preferences/core/Preferences$Key;", "com.google.firebase-firebase-sessions"}, m43476k = 1, m43477mv = {1, 8, 0}, m43479xi = 48)
    ...
    @DebugMetadata(m43503c = "com.google.firebase.sessions.SessionDatastoreImpl$1", m43504f = "SessionDatastore.kt", m43505i = {}, m43506l = {88}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    static final class C107111 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        int label;

        C107111(Continuation<? super C107111> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return SessionDatastoreImpl.this.new C107111(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C107111) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX INFO: compiled from: SessionDatastore.kt */
    @Metadata(m43474d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m43475d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "com.google.firebase.sessions.SessionDatastoreImpl$updateSessionId$1", m43504f = "SessionDatastore.kt", m43505i = {}, m43506l = {95}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    static final class C107131 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ String $sessionId;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C107131(String str, Continuation<? super C107131> continuation) {
            super(2, continuation);
            this.$sessionId = str;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return SessionDatastoreImpl.this.new C107131(this.$sessionId, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C107131) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                if (i == 0) {
                    ResultKt.throwOnFailure(obj);
                    this.label = 1;
                    if (PreferencesKt.edit(SessionDatastoreImpl.Companion.getDataStore(SessionDatastoreImpl.this.appContext), new AnonymousClass1(this.$sessionId, null), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
        ...
        @DebugMetadata(m43503c = "com.google.firebase.sessions.SessionDatastoreImpl$updateSessionId$1$1", m43504f = "SessionDatastore.kt", m43505i = {}, m43506l = {}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    ...
    public void updateSessionId(String sessionId) {
        ...
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(this.backgroundDispatcher), null, null, new C107131(sessionId, null), 3, null);
    }
