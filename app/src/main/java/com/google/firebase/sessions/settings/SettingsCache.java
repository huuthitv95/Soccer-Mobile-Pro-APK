...
public final class SettingsCache {
    ...
    @DebugMetadata(m43503c = "com.google.firebase.sessions.settings.SettingsCache", m43504f = "SettingsCache.kt", m43505i = {}, m43506l = {Sdk.SDKError.Reason.JSON_ENCODE_ERROR_VALUE}, m43507m = "updateConfigValue", m43508n = {}, m43509s = {})
    static final class C107231<T> extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;

        C107231(Continuation<? super C107231> continuation) {
            super(continuation);
        }
    ...
    public SettingsCache(DataStore<Preferences> dataStore) throws InterruptedException {
        ...
        BuildersKt__BuildersKt.runBlocking$default(null, new C107221(null), 1, null);
    }
    ...
    @DebugMetadata(m43503c = "com.google.firebase.sessions.settings.SettingsCache$1", m43504f = "SettingsCache.kt", m43505i = {}, m43506l = {46}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    static final class C107221 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        Object L$0;
        int label;

        C107221(Continuation<? super C107221> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return SettingsCache.this.new C107221(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C107221) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final <T> Object updateConfigValue(Preferences.Key<T> key, T t, Continuation<? super Unit> continuation) throws Throwable {
        C107231 c107231;
        if (continuation instanceof C107231) {
            c107231 = (C107231) continuation;
            if ((c107231.label & Integer.MIN_VALUE) != 0) {
                c107231.label -= Integer.MIN_VALUE;
            } else {
                c107231 = new C107231(continuation);
            }
        } else {
            c107231 = new C107231(continuation);
        }
        Object obj = c107231.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c107231.label;
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                DataStore<Preferences> dataStore = this.dataStore;
                C107242 c107242 = new C107242(t, key, this, null);
                c107231.label = 1;
                if (PreferencesKt.edit(dataStore, c107242, c107231) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
    ...
    /* JADX INFO: compiled from: SettingsCache.kt */
    @Metadata(m43474d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@"}, m43475d2 = {"<anonymous>", "", "T", "preferences", "Landroidx/datastore/preferences/core/MutablePreferences;"}, m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "com.google.firebase.sessions.settings.SettingsCache$updateConfigValue$2", m43504f = "SettingsCache.kt", m43505i = {}, m43506l = {}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    static final class C107242 extends SuspendLambda implements Function2<MutablePreferences, Continuation<? super Unit>, Object> {
        ...
        C107242(T t, Preferences.Key<T> key, SettingsCache settingsCache, Continuation<? super C107242> continuation) {
            super(2, continuation);
            this.$value = t;
            this.$key = key;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C107242 c107242 = new C107242(this.$value, this.$key, this.this$0, continuation);
            c107242.L$0 = obj;
            return c107242;
        }
        ...
        public final Object invoke(MutablePreferences mutablePreferences, Continuation<? super Unit> continuation) {
            return ((C107242) create(mutablePreferences, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX INFO: compiled from: SettingsCache.kt */
    @Metadata(m43474d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\t\n\u0002\b\u0004\n\u0002\u0010\u0006\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0082\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0017\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007R\u0017\u0010\b\u001a\b\u0012\u0004\u0012\u00020\t0\u0004¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u0007R\u0017\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\b\n\u0000\u001a\u0004\b\f\u0010\u0007R\u0017\u0010\r\u001a\b\u0012\u0004\u0012\u00020\u000e0\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u000f\u0010\u0007R\u0017\u0010\u0010\u001a\b\u0012\u0004\u0012\u00020\u00110\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0012\u0010\u0007R\u000e\u0010\u0013\u001a\u00020\u0014X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u0015"}, m43475d2 = {"Lcom/google/firebase/sessions/settings/SettingsCache$Companion;", "", "()V", "CACHE_DURATION_SECONDS", "Landroidx/datastore/preferences/core/Preferences$Key;", "", "getCACHE_DURATION_SECONDS", "()Landroidx/datastore/preferences/core/Preferences$Key;", "CACHE_UPDATED_TIME", "", "getCACHE_UPDATED_TIME", "RESTART_TIMEOUT_SECONDS", "getRESTART_TIMEOUT_SECONDS", "SAMPLING_RATE", "", "getSAMPLING_RATE", "SESSIONS_ENABLED", "", "getSESSIONS_ENABLED", "TAG", "", "com.google.firebase-firebase-sessions"}, m43476k = 1, m43477mv = {1, 8, 0}, m43479xi = 48)
