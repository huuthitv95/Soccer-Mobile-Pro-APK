...
public final class WireFormat {
    ...
    public static class FieldType {
        ...
        /* synthetic */ FieldType(String str, int i, JavaType javaType, int i2, C107991 c107991) {
    ...
    enum Utf8Validation {
        ...
        /* synthetic */ Utf8Validation(C107991 c107991) {
            this();
        }
    }
    ...
    static Object readPrimitiveField(CodedInputStream input, FieldType type, Utf8Validation utf8Validation) throws IOException {
        switch (C107991.$SwitchMap$com$google$protobuf$WireFormat$FieldType[type.ordinal()]) {
            case 1:
