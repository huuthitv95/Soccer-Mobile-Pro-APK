...
public enum FieldType {
    ...
    static {
        ...
        for (FieldType fieldType : fieldTypeArrValues) {
            VALUES[fieldType.f22603id] = fieldType;
        }
    }
    ...
    FieldType(int id, Collection collection, JavaType javaType) {
        ...
        int i2 = C107621.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i2 == 1 || i2 == 2) {
            this.elementType = javaType.getBoxedType();
        } else {
            this.elementType = null;
        }
        this.primitiveScalar = (collection != Collection.SCALAR || (i = C107621.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i == 2 || i == 3) ? false : true;
    }

    /* JADX INFO: renamed from: com.google.protobuf.FieldType$1 */
    static /* synthetic */ class C107621 {
