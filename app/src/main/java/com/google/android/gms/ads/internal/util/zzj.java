...
public final class zzj implements zzg {
    ...
    private String zzl = C11794a2.f26725f;
    private int zzm = -1;
    ...
    public final void zzA(String str) {
        ...
        synchronized (this.zza) {
            this.zzl = str;
            if (this.zzg != null) {
                if (str.equals(C11794a2.f26725f)) {
    ...
    public final void zza(final Context context) {
        synchronized (this.zza) {
            ...
            this.zzd = zzcff.zza.zza(new Runnable(context, str) { // from class: com.google.android.gms.ads.internal.util.zzi
    ...
    public final void zzh(String str) {
        ...
        synchronized (this.zza) {
            ...
            if (str != null && !str.equals(this.zzn.zzd())) {
                this.zzn = new zzcem(str, jCurrentTimeMillis);
                SharedPreferences.Editor editor = this.zzg;
                if (editor != null) {
    ...
    public final void zzy(boolean z) {
        zzX();
        synchronized (this.zza) {
            long jCurrentTimeMillis = System.currentTimeMillis() + ((Long) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zzlQ)).longValue();
            SharedPreferences.Editor editor = this.zzg;
            if (editor != null) {
