...
public final class zzhkw {
    ...
    public static ECPoint zzd(BigInteger bigInteger, ECParameterSpec eCParameterSpec) throws GeneralSecurityException {
        ...
        zzhkv zzhkvVarZze = zze(ECPoint.POINT_INFINITY, bigIntegerZzc);
        zzhkv zzhkvVarZze2 = zze(generator, bigIntegerZzc);
        for (int iBitLength = bigInteger.bitLength(); iBitLength >= 0; iBitLength--) {
            if (bigInteger.testBit(iBitLength)) {
                zzhkvVarZze = zzg(zzhkvVarZze, zzhkvVarZze2, a2, bigIntegerZzc);
                zzhkvVarZze2 = zzf(zzhkvVarZze2, a2, bigIntegerZzc);
            } else {
                zzhkvVarZze2 = zzg(zzhkvVarZze, zzhkvVarZze2, a2, bigIntegerZzc);
                zzhkvVarZze = zzf(zzhkvVarZze, a2, bigIntegerZzc);
            }
        }
        if (zzhkvVarZze.zza()) {
            eCPoint = ECPoint.POINT_INFINITY;
        } else {
            BigInteger bigIntegerModInverse = zzhkvVarZze.zzc.modInverse(bigIntegerZzc);
            BigInteger bigIntegerMod = bigIntegerModInverse.multiply(bigIntegerModInverse).mod(bigIntegerZzc);
            eCPoint = new ECPoint(zzhkvVarZze.zza.multiply(bigIntegerMod).mod(bigIntegerZzc), zzhkvVarZze.zzb.multiply(bigIntegerMod).mod(bigIntegerZzc).multiply(bigIntegerModInverse).mod(bigIntegerZzc));
        }
        zza(eCPoint, curve);
        return eCPoint;
    }
    ...
    static zzhkv zze(ECPoint eCPoint, BigInteger bigInteger) {
        ...
        BigInteger bigIntegerMod = new BigInteger(1, zzhnh.zza((bigInteger.bitLength() + 8) / 8)).mod(bigInteger);
        BigInteger bigIntegerMod2 = bigIntegerMod.multiply(bigIntegerMod).mod(bigInteger);
        return new zzhkv(eCPoint.getAffineX().multiply(bigIntegerMod2).mod(bigInteger), eCPoint.getAffineY().multiply(bigIntegerMod2.multiply(bigIntegerMod).mod(bigInteger)).mod(bigInteger), bigIntegerMod);
    }
    ...
    static zzhkv zzf(zzhkv zzhkvVar, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        return new zzhkv(bigIntegerMod5, bigIntegerMod6, bigIntegerAdd3.multiply(bigIntegerAdd3).mod(bigInteger2).subtract(bigIntegerMod2).subtract(bigIntegerMod4).mod(bigInteger2));
    }
    ...
    static zzhkv zzg(zzhkv zzhkvVar, zzhkv zzhkvVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger bigIntegerMod3 = zzhkvVar.zza.multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod4 = zzhkvVar2.zza.multiply(bigIntegerMod).mod(bigInteger2);
        BigInteger bigIntegerMod5 = zzhkvVar.zzb.multiply(bigInteger4).mod(bigInteger2).multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod6 = zzhkvVar2.zzb.multiply(bigInteger3).mod(bigInteger2).multiply(bigIntegerMod).mod(bigInteger2);
        if (bigIntegerMod3.equals(bigIntegerMod4)) {
            return !bigIntegerMod5.equals(bigIntegerMod6) ? zzhkv.zzd : zzf(zzhkvVar, bigInteger, bigInteger2);
        }
        ...
        return new zzhkv(bigIntegerMod12, bigIntegerMod13, bigIntegerAdd.multiply(bigIntegerAdd).mod(bigInteger2).subtract(bigIntegerMod).subtract(bigIntegerMod2).multiply(bigIntegerMod7).mod(bigInteger2));
    }
