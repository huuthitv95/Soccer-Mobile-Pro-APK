        ...
        try {
            ...
            for (Map.Entry entry : this.zze.zza().entrySet()) {
                try {
                    ...
                    throw new zzhy("Unable to connect to ".concat(strValueOf), iOException, this.zzf, 2000, i);
                }
            }
            ...
            try {
                ...
                throw new zzhy("Unable to connect to ".concat(strValueOf2), e3, this.zzf, 2000, i);
            }
