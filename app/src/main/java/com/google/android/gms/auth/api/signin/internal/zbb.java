    ...
    public final void run() {
        ...
        try {
            ...
            if (responseCode == 200) {
                ...
                zba.m22279e("Unable to revoke access!", new Object[0]);
            }
            zba.m22277d("Response Code: " + responseCode, new Object[0]);
        } catch (IOException e) {
            zba.m22279e("IOException when revoking access: ".concat(String.valueOf(e.toString())), new Object[0]);
        } catch (Exception e2) {
            zba.m22279e("Exception when revoking access: ".concat(String.valueOf(e2.toString())), new Object[0]);
        }
