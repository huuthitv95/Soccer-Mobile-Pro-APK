...
public final class AdvertisingOptions extends AbstractSafeParcelable {
    ...
    public String toString() {
        ...
        byte[] bArr2 = this.zzq;
        return String.format(locale, "AdvertisingOptions{strategy: %s, autoUpgradeBandwidth: %s, enforceTopologyConstraints: %s, enableBluetooth: %s, enableBle: %s, nearbyNotificationsBeaconData: %s, lowPower: %s, fastAdvertisementServiceUuid: %s, enableWifiLan: %s, enableNfc: %s, enableWifiAware: %s, enableBluetoothListening: %s, enableWebRtcListening: %s, enableUwbRanging: %s, uwbChannel: %d, uwbPreambleIndex: %d, remoteUwbAddress: %s, flowId: %d, uwbSenderInfo: %s, enableOutOfBandConnection: %s, disruptiveUpgrade: %s}", strategy, boolValueOf, boolValueOf2, boolValueOf3, boolValueOf4, strZza, boolValueOf5, parcelUuid, boolValueOf6, boolValueOf7, boolValueOf8, boolValueOf9, boolValueOf10, boolValueOf11, numValueOf, numValueOf2, bArr2 == null ? AbstractJsonLexerKt.NULL : com.google.android.gms.nearby.messages.internal.zzc.zza(bArr2), Long.valueOf(this.zzr), Arrays.toString(this.zzs), Boolean.valueOf(this.zzt), Boolean.valueOf(this.zzu));
    }
