...
abstract class zzgup extends zzgus implements Serializable {
    ...
    final Set zzi() {
        ...
        if (map instanceof NavigableMap) {
            return new zzguh(this, (NavigableMap) map);
        }
        return map instanceof SortedMap ? new zzguk(this, (SortedMap) map) : new zzguf(this, map);
    }
    ...
    final Map zzm() {
        Map map = this.zza;
        if (map instanceof NavigableMap) {
            return new zzgug(this, (NavigableMap) map);
        }
        return map instanceof SortedMap ? new zzguj(this, (SortedMap) map) : new zzguc(this, map);
    }
