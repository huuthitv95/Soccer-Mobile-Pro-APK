...
public final class zzba extends AbstractSafeParcelable {
    ...
    public static zzba zza(Throwable th) {
        com.google.android.gms.ads.internal.client.zze zzeVarZza = zzflo.zza(th);
        return new zzba(zzgtn.zzc(th.getMessage()) ? zzeVarZza.zzb : th.getMessage(), zzeVarZza.zza);
    }
