...
public final class TaggingLibraryJsInterface {
    ...
    public String getClickSignalsWithTimeout(final String str, int i) {
        ...
        try {
            return (String) zzcff.zza.zzc(new Callable() { // from class: com.google.android.gms.ads.nonagon.signalgeneration.zzbh
    ...
    public String getViewSignalsWithTimeout(int i) {
        ...
        try {
            return (String) zzcff.zza.zzc(new Callable() { // from class: com.google.android.gms.ads.nonagon.signalgeneration.zzbg
                @Override // java.util.concurrent.Callable
                public final /* synthetic */ Object call() {
    ...
    final /* synthetic */ void zzb(String str) {
        ...
        try {
            uriZzd = (!((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zznu)).booleanValue() || (zzfkqVar = this.zzd) == null) ? this.zzc.zzd(uriZzd, this.zza, this.zzb, null) : zzfkqVar.zza(uriZzd, this.zza, this.zzb, null);
        } catch (zzbaj e) {
            int i = com.google.android.gms.ads.internal.util.zze.zza;
