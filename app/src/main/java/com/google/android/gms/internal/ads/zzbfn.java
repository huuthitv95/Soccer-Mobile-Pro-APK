...
public final class zzbfn {
    public static void zza(String[] strArr, int i, int i2, PriorityQueue priorityQueue) {
        ...
        while (true) {
            ...
            long jZza = zzbfk.zza(strArr[i3 - 1]);
            long jZza2 = zzbfk.zza(strArr[i3 + 5]);
    ...
    private static long zze(String[] strArr, int i, int i2) {
        long jZza = (((long) zzbfk.zza(strArr[0])) + 2147483647L) % 1073807359;
        for (int i3 = 1; i3 < i2; i3++) {
            jZza = (((jZza * 16785407) % 1073807359) + ((((long) zzbfk.zza(strArr[i3])) + 2147483647L) % 1073807359)) % 1073807359;
        }
        return jZza;
    }
}
