...
public final class zzf {
    ...
    public static final void zzD(Context context, String str, String str2, Bundle bundle, boolean z, zze zzeVar) {
        ...
        bundle.putString(C11540L6.f24911F, Build.VERSION.RELEASE);
    ...
    public static zzfp zzv(Context context, PreloadConfiguration preloadConfiguration, int i) {
        ...
        if (iOrdinal2 == 1) {
            iIntValue = ((Integer) zzba.zzc().zzd(zzbie.zzae)).intValue();
        } else if (iOrdinal2 == 2) {
            iIntValue = ((Integer) zzba.zzc().zzd(zzbie.zzaf)).intValue();
        } else if (iOrdinal2 != 5) {
            iIntValue = 1;
        } else {
            iIntValue = ((Integer) zzba.zzc().zzd(zzbie.zzad)).intValue();
        }
        int iMax = Math.max(Math.min(iIntValue, 15), 1);
        int iOrdinal3 = preloadConfiguration.getAdFormat().ordinal();
        if (iOrdinal3 == 1) {
            iIntValue2 = ((Integer) zzba.zzc().zzd(zzbie.zzak)).intValue();
        } else if (iOrdinal3 == 2) {
            iIntValue2 = ((Integer) zzba.zzc().zzd(zzbie.zzal)).intValue();
        } else if (iOrdinal3 == 5) {
            iIntValue2 = ((Integer) zzba.zzc().zzd(zzbie.zzaj)).intValue();
        }
    ...
    public static final boolean zzy() {
        boolean zBooleanValue = ((Boolean) zzba.zzc().zzd(zzbie.zzmN)).booleanValue();
        if (Build.VERSION.SDK_INT < 31) {
            return Build.DEVICE.startsWith(MessengerShareContentUtility.TEMPLATE_GENERIC_TYPE);
        }
        if (Build.FINGERPRINT.contains(MessengerShareContentUtility.TEMPLATE_GENERIC_TYPE) || Build.FINGERPRINT.contains("emulator")) {
            return true;
        }
