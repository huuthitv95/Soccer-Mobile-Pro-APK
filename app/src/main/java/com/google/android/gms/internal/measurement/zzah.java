...
public final class zzah implements zzap {
    ...
    public final String zzi() {
        ...
        BigDecimal bigDecimal = bigDecimalValueOf.signum() == 0 ? new BigDecimal(BigInteger.ZERO, 0) : xha$$ExternalSyntheticBackportWithForwarding0.m7319m(bigDecimalValueOf);
