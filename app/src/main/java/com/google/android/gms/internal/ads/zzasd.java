...
public final class zzasd {
    public static X509Certificate[][] zza(String str) throws zzasa, SecurityException, IOException {
        ...
        try {
            Pair pairZza = zzase.zza(randomAccessFile2);
            try {
                if (pairZza == null) {
                ...
                long jZzb = zzase.zzb(byteBuffer);
                if (jZzb >= jLongValue) {
                ...
                if (zzase.zzd(byteBuffer) + jZzb != jLongValue) {
                ...
                try {
                    ...
                    while (byteBufferSlice.hasRemaining()) {
                        ...
                        if (byteBufferSlice.getInt() == 1896449818) {
                            X509Certificate[][] x509CertificateArrZzb = zzb(randomAccessFile.getChannel(), new zzarz(zzi(byteBufferSlice, i4 - 4), jLongValue2, j4, jLongValue, byteBuffer, null));
    ...
    private static X509Certificate[][] zzb(FileChannel fileChannel, zzarz zzarzVar) throws SecurityException {
        ...
        try {
            ...
            try {
                ByteBuffer byteBufferZzj = zzj(zzarzVar.zza());
                int i = 0;
                ...
                zzd(map, fileChannel, zzarzVar.zzb(), zzarzVar.zzc(), zzarzVar.zzd(), zzarzVar.zze());
    ...
    private static X509Certificate[] zzc(ByteBuffer byteBuffer, Map map, CertificateFactory certificateFactory) throws IOException, SecurityException {
        ...
        try {
            ...
            while (byteBufferZzj6.hasRemaining()) {
                ...
                try {
                    arrayList3.add(new zzasb((X509Certificate) certificateFactory.generateCertificate(new ByteArrayInputStream(bArrZzk4)), bArrZzk4));
                } catch (CertificateException e3) {
    ...
    private static void zzd(Map map, FileChannel fileChannel, long j, long j2, long j3, ByteBuffer byteBuffer) throws SecurityException {
        ...
        zzase.zzc(byteBufferDuplicate, j);
        zzarw zzarwVar = new zzarw(byteBufferDuplicate);
        int size = map.size();
        ...
        try {
            byte[][] bArrZze = zze(iArr, new zzarx[]{zzaryVar, zzaryVar2, zzarwVar});
    ...
    private static byte[][] zze(int[] iArr, zzarx[] zzarxVarArr) throws DigestException {
        ...
        while (true) {
            ...
            jZza += (zzarxVarArr[i3].zza() + 1048575) / PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED;
            i3++;
        }
        if (jZza >= 2097151) {
        ...
        while (i7 < i) {
            ...
            while (jZza2 > 0) {
                ...
                try {
                    zzarxVar.zzb(messageDigestArr, j2, iMin);
                    int i13 = 0;
