...
public final class zzch {
    ...
    zzch(int i, AudioManager.OnAudioFocusChangeListener onAudioFocusChangeListener, Handler handler, zzd zzdVar, boolean z, boolean z2) {
        ...
        this.zzf = Build.VERSION.SDK_INT >= 26 ? Util$$ExternalSyntheticApiModelOutline0.m313m(1).setAudioAttributes(zzdVar.zza()).setWillPauseWhenDucked(false).setOnAudioFocusChangeListener(onAudioFocusChangeListener, handler).setAcceptsDelayedFocusGain(z2).build() : null;
    }
    ...
    final AudioFocusRequest zzc() {
        Object obj = this.zzf;
        obj.getClass();
        return Util$$ExternalSyntheticApiModelOutline0.m319m(obj);
    }
}
