...
public final class zzfx {
    ...
    static /* synthetic */ void zzf(zzfx zzfxVar, OutputStream outputStream, boolean z, long j) {
        try {
    ...
    final synchronized void zza(InputStream inputStream, OutputStream outputStream, OutputStream outputStream2, zzgd zzgdVar, long j) throws Throwable {
        try {
            try {
