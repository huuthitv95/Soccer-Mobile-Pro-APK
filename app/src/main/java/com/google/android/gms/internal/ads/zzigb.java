...
class zzigb extends AbstractMap {
    ...
    private final int zzm(Comparable comparable) {
        ...
        int i3 = 0;
        if (i2 >= 0) {
            int iCompareTo = comparable.compareTo(((zzify) this.zza[i2]).zza());
            if (iCompareTo > 0) {
                return -(i + 1);
            }
            if (iCompareTo == 0) {
        ...
        while (i3 <= i2) {
            int i4 = (i3 + i2) / 2;
            int iCompareTo2 = comparable.compareTo(((zzify) this.zza[i4]).zza());
            if (iCompareTo2 < 0) {
                i2 = i4 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final Object get(Object obj) {
        ...
        return iZzm >= 0 ? ((zzify) this.zza[iZzm]).getValue() : this.zzc.get(comparable);
    }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int iZzm = zzm(comparable);
        if (iZzm >= 0) {
            return ((zzify) this.zza[iZzm]).setValue(obj);
        }
        zzh();
        if (this.zza == null) {
