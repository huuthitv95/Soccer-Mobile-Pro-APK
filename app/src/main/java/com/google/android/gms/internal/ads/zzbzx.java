        ...
        while (parcel.dataPosition() < iValidateObjectHeader) {
            ...
            switch (SafeParcelReader.getFieldId(header)) {
                ...
                case 61:
                    ...
                    break;
                case 63:
                    zzbrpVar = (zzbrp) SafeParcelReader.createParcelable(parcel, header, zzbrp.CREATOR);
                    break;
                case 64:
