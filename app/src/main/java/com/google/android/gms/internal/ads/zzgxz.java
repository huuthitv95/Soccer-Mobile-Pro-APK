...
final class zzgxz extends zzgwc {
    ...
    static zzgxz zzk(int i, Object[] objArr, zzgwb zzgwbVar) {
        ...
        zzgwa zzgwaVar2 = null;
        ?? r5 = 0;
        zzgwa zzgwaVar3 = null;
        zzgwa zzgwaVar4 = null;
        boolean z5 = false;
        int i5 = 1;
        if (i4 == 1) {
            zzguv.zza(Objects.requireNonNull(objArrCopyOf[0]), Objects.requireNonNull(objArrCopyOf[1]));
            return new zzgxz(null, objArrCopyOf, 1);
        }
        zzgsw.zzn(i4, objArrCopyOf.length >> 1, "index");
        int iZzo = zzgwj.zzo(i4);
        char c3 = 2;
        if (i4 != 1) {
            int i6 = iZzo - 1;
            if (iZzo <= 128) {
                ...
                while (i7 < i4) {
                    ...
                    zzguv.zza(objRequireNonNull, objRequireNonNull2);
                    int iZza = zzgvs.zza(objRequireNonNull.hashCode());
                    while (true) {
                        int i11 = iZza & i6;
                        z2 = z5;
                        i3 = i5;
                        ...
                        if (objRequireNonNull.equals(objArrCopyOf[i12 == true ? 1 : 0])) {
                            int i13 = ~i12;
                            zzgwa zzgwaVar5 = new zzgwa(objRequireNonNull, objRequireNonNull2, Objects.requireNonNull(objArrCopyOf[i13 == true ? 1 : 0]));
                ...
                if (iZzo <= 32768) {
                    ...
                    for (int i15 = 0; i15 < i4; i15++) {
                        ...
                        zzguv.zza(objRequireNonNull3, objRequireNonNull4);
                        int iZza2 = zzgvs.zza(objRequireNonNull3.hashCode());
                        while (true) {
                            int i18 = iZza2 & i6;
                            ...
                            if (objRequireNonNull3.equals(objArrCopyOf[c4])) {
                                int i19 = c4 ^ 1;
                                zzgwa zzgwaVar6 = new zzgwa(objRequireNonNull3, objRequireNonNull4, Objects.requireNonNull(objArrCopyOf[i19 == true ? 1 : 0]));
                    ...
                    if (i14 == i4) {
                        ...
                        r5 = new Object[]{sArr, Integer.valueOf(i14), zzgwaVar4};
                        z4 = z;
                    }
                } else {
                    ...
                    while (i20 < i4) {
                        ...
                        zzguv.zza(objRequireNonNull5, objRequireNonNull6);
                        int iZza3 = zzgvs.zza(objRequireNonNull5.hashCode());
                        while (true) {
                            int i24 = iZza3 & i6;
                            int i25 = iArr[i24];
                            if (i25 == -1) {
                            ...
                            if (objRequireNonNull5.equals(objArrCopyOf[i25])) {
                                int i26 = i25 ^ 1;
                                zzgwa zzgwaVar7 = new zzgwa(objRequireNonNull5, objRequireNonNull6, Objects.requireNonNull(objArrCopyOf[i26]));
            ...
            if (z3) {
                objArr2 = (Object[]) r3;
                zzgwaVar = (zzgwa) objArr2[c];
                if (zzgwbVar != null) {
                    throw zzgwaVar.zza();
                }
                zzgwbVar.zzc = zzgwaVar;
            ...
            return new zzgxz(r4, objArrCopyOf, i4);
        }
        zzguv.zza(Objects.requireNonNull(objArrCopyOf[0]), Objects.requireNonNull(objArrCopyOf[1]));
        z4 = false;
        i4 = 1;
        ...
        if (obj == null) {
            ...
            if (i != 1) {
                ...
                if (obj2 == null) {
                    ...
                    int iZza = zzgvs.zza(obj.hashCode());
                    while (true) {
                        int i2 = iZza & length;
                        int i3 = bArr[i2] & 255;
                        if (i3 == 255) {
                    ...
                    int iZza2 = zzgvs.zza(obj.hashCode());
                    while (true) {
                    ...
                    int iZza3 = zzgvs.zza(obj.hashCode());
                    while (true) {
