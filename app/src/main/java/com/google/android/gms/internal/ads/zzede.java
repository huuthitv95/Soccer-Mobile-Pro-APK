...
public final class zzede {
    ...
    public static final void zzb(Context context, ViewGroup viewGroup, NativeAd nativeAd) {
        ...
        linearLayout.addView(zzc(context, resourcesZzf == null ? "Headline" : resourcesZzf.getString(C9597R.string.native_headline), "headline_header_tag"));
        View viewZzd = zzd(context, zzgtn.zza(nativeAd.getHeadline()), "headline_tag");
        nativeAdView.setHeadlineView(viewZzd);
        linearLayout.addView(viewZzd);
        linearLayout.addView(zzc(context, resourcesZzf == null ? "Body" : resourcesZzf.getString(C9597R.string.native_body), "body_header_tag"));
        View viewZzd2 = zzd(context, zzgtn.zza(nativeAd.getBody()), "body_tag");
        nativeAdView.setBodyView(viewZzd2);
        linearLayout.addView(viewZzd2);
        linearLayout.addView(zzc(context, resourcesZzf == null ? "Media View" : resourcesZzf.getString(C9597R.string.native_media_view), "media_view_header_tag"));
