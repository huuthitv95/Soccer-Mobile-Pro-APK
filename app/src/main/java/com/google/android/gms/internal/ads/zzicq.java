...
final class zzicq extends zzicr {
    ...
    public final String zzl() throws IOException {
        ...
        if (iZzu > 0) {
            ...
            int i2 = this.zzj;
            if (iZzu <= i - i2) {
                String str = new String(this.zzg, i2, iZzu, zziee.zza);
                this.zzj += iZzu;
                return str;
            }
        }
        ...
        if (iZzu > this.zzh) {
            return new String(zzQ(iZzu, false), zziee.zza);
        }
        zzG(iZzu);
        String str2 = new String(this.zzg, this.zzj, iZzu, zziee.zza);
        this.zzj += iZzu;
        return str2;
    }
    ...
    public final String zzm() throws IOException {
        ...
        return zzigt.zze(bArrZzQ, i, iZzu);
    }
    ...
    public final zzicn zzn() throws IOException {
        ...
        int i2 = this.zzj;
        if (iZzu <= i - i2 && iZzu > 0) {
            zzicn zzicnVarZzu = zzicn.zzu(this.zzg, i2, iZzu, false);
            this.zzj += iZzu;
            return zzicnVarZzu;
        }
        if (iZzu == 0) {
        ...
        if (bArrZzR != null) {
            return zzicn.zzu(bArrZzR, 0, bArrZzR.length, false);
        }
        int i3 = this.zzj;
        int i4 = this.zzh;
        int i5 = i4 - i3;
