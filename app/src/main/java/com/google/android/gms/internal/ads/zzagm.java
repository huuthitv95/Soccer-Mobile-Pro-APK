...
public final class zzagm {
    ...
    public final boolean zza(int i) {
        ...
        int i4;
        int i5;
        if (!zzagn.zzl(i) || (i2 = (i >>> 19) & 3) == 1 || (i3 = (i >>> 17) & 3) == 0 || (i4 = (i >>> 12) & 15) == 0 || i4 == 15 || (i5 = (i >>> 10) & 3) == 3) {
            return false;
        }
        int i6 = i4 - 1;
        this.zza = i2;
        this.zzb = zzagn.zza[3 - i3];
        int i7 = zzagn.zzb[i5];
        this.zzd = i7;
        if (i2 == 2) {
            i7 /= 2;
        ...
        int i8 = (i >>> 9) & 1;
        this.zzg = zzagn.zzm(i2, i3);
        if (i3 == 3) {
            int i9 = i2 == 3 ? zzagn.zzc[i6] : zzagn.zzd[i6];
            this.zzf = i9;
            this.zzc = (((i9 * 12) / i7) + i8) * 4;
        } else {
            if (i2 == 3) {
                int i10 = i3 == 2 ? zzagn.zze[i6] : zzagn.zzf[i6];
                this.zzf = i10;
                this.zzc = ((i10 * 144) / i7) + i8;
            } else {
                int i11 = zzagn.zzg[i6];
                this.zzf = i11;
