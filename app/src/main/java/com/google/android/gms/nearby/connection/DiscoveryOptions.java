...
public final class DiscoveryOptions extends AbstractSafeParcelable {
    ...
    public String toString() {
        ...
        byte[] bArr = this.zzm;
        return String.format(locale, "DiscoveryOptions{strategy: %s, forwardUnrecognizedBluetoothDevices: %s, enableBluetooth: %s, enableBle: %s, lowPower: %s, fastAdvertisementServiceUuid: %s, enableWifiLan: %s, enableNfc: %s, enableWifiAware: %s, enableUwbRanging: %s, uwbChannel: %d, uwbPreambleIndex: %d, uwbAddress: %s, flowId: %d}", strategy, boolValueOf, boolValueOf2, boolValueOf3, boolValueOf4, parcelUuid, boolValueOf5, boolValueOf6, boolValueOf7, boolValueOf8, numValueOf, numValueOf2, bArr == null ? AbstractJsonLexerKt.NULL : com.google.android.gms.nearby.messages.internal.zzc.zza(bArr), Long.valueOf(this.zzn));
    }
