...
public final class zzpd implements zzpc {
    ...
    static {
        ...
        zze = zzkfVarZza.zzd("measurement.config.cache_time", SignalManager.TWENTY_FOUR_HOURS_MILLIS);
        ...
        zzp = zzkfVarZza.zzd("measurement.store.max_stored_events_per_app", SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US);
        ...
        zzy = zzkfVarZza.zzd("measurement.monitoring.sample_period_millis", SignalManager.TWENTY_FOUR_HOURS_MILLIS);
        ...
        zzS = zzkfVarZza.zzd("measurement.upload.stale_data_deletion_interval", SignalManager.TWENTY_FOUR_HOURS_MILLIS);
        ...
        zzak = zzkfVarZza.zzd("measurement.upload.max_events_per_day", SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US);
        zzal = zzkfVarZza.zzd("measurement.upload.max_public_events_per_day", ServiceProvider.SCAR_SIGNALS_FETCH_TIMEOUT);
