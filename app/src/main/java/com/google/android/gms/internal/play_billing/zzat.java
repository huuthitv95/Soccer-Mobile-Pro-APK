...
final class zzat extends zzal {
    ...
    static zzat zzg(int i, Object[] objArr, zzak zzakVar) {
        ...
        zzaa.zzb(i4, objArrCopyOf.length >> 1, "index");
        char c3 = 2;
        ...
        if (i4 != 1) {
            ...
            if (iHighestOneBit <= 128) {
                ...
                while (i7 < i4) {
                    ...
                    while (true) {
                        ...
                        if (objRequireNonNull.equals(objArrCopyOf[i12 == true ? 1 : 0])) {
                            int i13 = ~i12;
                            zzaj zzajVar5 = new zzaj(objRequireNonNull, objRequireNonNull2, Objects.requireNonNull(objArrCopyOf[i13 == true ? 1 : 0]));
                ...
                if (iHighestOneBit <= 32768) {
                    ...
                    for (int i15 = 0; i15 < i4; i15++) {
                        ...
                        while (true) {
                            ...
                            if (objRequireNonNull3.equals(objArrCopyOf[c4])) {
                                int i19 = c4 ^ 1;
                                zzaj zzajVar6 = new zzaj(objRequireNonNull3, objRequireNonNull4, Objects.requireNonNull(objArrCopyOf[i19 == true ? 1 : 0]));
                    ...
                    if (i14 == i4) {
                        ...
                        r5 = new Object[]{sArr, Integer.valueOf(i14), zzajVar4};
                        z4 = z;
                    }
                } else {
                    ...
                    while (i20 < i4) {
                        ...
                        while (true) {
                            ...
                            if (objRequireNonNull5.equals(objArrCopyOf[i25])) {
                                int i26 = i25 ^ 1;
                                zzaj zzajVar7 = new zzaj(objRequireNonNull5, objRequireNonNull6, Objects.requireNonNull(objArrCopyOf[i26]));
            ...
            return new zzat(r4, objArrCopyOf, i4);
        }
        zzad.zza(Objects.requireNonNull(objArrCopyOf[0]), Objects.requireNonNull(objArrCopyOf[1]));
        z4 = false;
        i4 = 1;
