...
public final class zaau implements zabd {
    ...
    public final void zad() {
        ...
        for (Api api : this.zas.keySet()) {
            ...
            map.put(client, new zaak(this, api, zBooleanValue));
        }
        if (z) {
            this.zam = false;
        }
        if (this.zam) {
            ...
            this.zak = (com.google.android.gms.signin.zae) abstractClientBuilder.buildClient(context, zabgVar.zag.getLooper(), clientSettings, clientSettings.zaa(), (GoogleApiClient.ConnectionCallbacks) zaarVar, (GoogleApiClient.OnConnectionFailedListener) zaarVar);
        }
        this.zah = this.zaa.zaa.size();
        this.zau.add(zabh.zaa().submit(new zaan(this, map)));
    }
