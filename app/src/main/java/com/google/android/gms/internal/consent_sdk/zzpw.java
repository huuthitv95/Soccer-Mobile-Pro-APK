...
final class zzpw implements zztb {
    ...
    public final void zzG(int i, List list) throws IOException {
        ...
        while (i2 < list.size()) {
            ...
            if (objZza instanceof String) {
                this.zza.zzs(i, (String) objZza);
            } else {
                this.zza.zzh(i, (zzpm) objZza);
            }
            i2++;
        }
    }
    ...
    public final void zzK(int i, List list, boolean z) throws IOException {
        ...
        zzpvVar2.zzu(i, 2);
        int iZzD2 = 0;
        for (int i4 = 0; i4 < zzreVar.size(); i4++) {
            iZzD2 += zzpv.zzD(zzreVar.zze(i4));
        }
        zzpvVar2.zzw(iZzD2);
        while (i2 < zzreVar.size()) {
    ...
    public final void zzE(int i, List list, boolean z) throws IOException {
        ...
        if (!z) {
            while (i2 < zzreVar.size()) {
                zzpv zzpvVar3 = this.zza;
                long jZze = zzreVar.zze(i2);
                zzpvVar3.zzx(i, (jZze >> 63) ^ (jZze + jZze));
                i2++;
            }
            return;
        }
        ...
        int iZzD2 = 0;
        for (int i4 = 0; i4 < zzreVar.size(); i4++) {
            long jZze2 = zzreVar.zze(i4);
            iZzD2 += zzpv.zzD((jZze2 >> 63) ^ (jZze2 + jZze2));
        }
        zzpvVar4.zzw(iZzD2);
        while (i2 < zzreVar.size()) {
            long jZze3 = zzreVar.zze(i2);
