    ...
    public final long zzb(zzhn zzhnVar) throws zzhy {
        ...
        try {
            ...
            while (true) {
                    ...
                    if (responseCode != 300 && responseCode != 301 && responseCode != 302 && responseCode != 303 && responseCode != 307 && responseCode != 308) {
                        ...
                        try {
                            ...
                            if (responseCode2 >= 200 || responseCode2 > 299) {
                                ...
                                zzn();
                                zziaVar = new zzia(this.zzl, null, null, headerFields, zzhnVar, zzfk.zzb);
                                if (this.zzl == 416) {
                                    throw zziaVar;
                                }
                            ...
                            zzn();
                            String string4 = zzhnVar.zza.toString();
                            String.valueOf(string4);
                            throw new zzhy("Unable to connect to ".concat(String.valueOf(string4)), e2, zzhnVar, 2000, 1);
                        }
                    }
                ...
                httpURLConnection.setRequestProperty("Range", string5);
                httpURLConnection.setRequestProperty("User-Agent", this.zzf);
                if (!zZza) {
                    httpURLConnection.setRequestProperty(HttpHeaders.ACCEPT_ENCODING, "identity");
                }
                ...
                if (responseCode != 300) {
                    ...
                    zzn();
                    zziaVar = new zzia(this.zzl, null, null, headerFields2, zzhnVar, zzfk.zzb);
                    if (this.zzl == 416) {
                        throw zziaVar;
                    }
                    zziaVar.initCause(new zzhk(2008));
            ...
            String string6 = zzhnVar.zza.toString();
            String.valueOf(string6);
            throw new zzhy("Unable to connect to ".concat(String.valueOf(string6)), e3, zzhnVar, 2000, 1);
        }
    }
