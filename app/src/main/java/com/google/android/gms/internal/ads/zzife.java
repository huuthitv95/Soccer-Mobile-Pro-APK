    ...
    static void zzb(StringBuilder sb, int i, String str, Object obj) {
        ...
        for (int i4 = 0; i4 < strReplace2.length(); i4++) {
            ...
            if (cCharAt2 < ' ' || cCharAt2 > '~') {
                strReplace = zzigd.zza(strReplace2.getBytes(zziee.zza));
    ...
    private static void zzc(zzifc zzifcVar, StringBuilder sb, int i) {
        ...
        for (Map.Entry entry : treeMap.entrySet()) {
            ...
            if (strSubstring.endsWith("List") && !strSubstring.endsWith("OrBuilderList") && !strSubstring.equals("List") && (method4 = (Method) entry.getValue()) != null && method4.getReturnType().equals(List.class)) {
                zzb(sb, i, strSubstring.substring(0, strSubstring.length() - 4), zzidr.zzbB(method4, zzifcVar, new Object[0]));
                ...
                if (hashSet.contains("set".concat(String.valueOf(strSubstring)))) {
                    if (strSubstring.endsWith("Bytes")) {
                        ...
                        if (!treeMap.containsKey("get".concat(String.valueOf(strSubstring2)))) {
                            ...
                            if (method != null) {
                                objZzbB = zzidr.zzbB(method, zzifcVar, new Object[0]);
                                if (method2 == null) {
                                    zBooleanValue = ((Boolean) zzidr.zzbB(method2, zzifcVar, new Object[0])).booleanValue();
                                    ...
                                    } else if (objZzbB instanceof zzicn) {
                                        zEquals = objZzbB.equals(zzicn.zza);
                                    } else if ((objZzbB instanceof zzifc) ? !((objZzbB instanceof Enum) && ((Enum) objZzbB).ordinal() == 0) : objZzbB != ((zzifc) objZzbB).zzbw()) {
                                        zBooleanValue = true;
                                    } else {
                                        zBooleanValue = false;
                                    }
                        ...
                        if (method != null) {
                            ...
                            if (method2 == null) {
                                ...
                                if (objZzbB instanceof String) {
                                    ...
                                    zEquals = objZzbB.equals(zzicn.zza);
                                } else if (objZzbB instanceof zzifc) {
                                    zBooleanValue = true;
                                } else {
                                    zBooleanValue = true;
                                }
                ...
                zzb(sb, i, strSubstring.substring(0, strSubstring.length() - 3), zzidr.zzbB(method3, zzifcVar, new Object[0]));
            }
            i2 = 3;
        }
        if (zzifcVar instanceof zzidn) {
            Iterator itZzc = ((zzidn) zzifcVar).zza.zzc();
            while (itZzc.hasNext()) {
