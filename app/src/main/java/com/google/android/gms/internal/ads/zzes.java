...
public final class zzes {
    ...
    private final int zzU(Charset charset) {
        ...
        if (charset.equals(StandardCharsets.US_ASCII)) {
            ...
            if ((b & 128) == 0) {
                codePoint = zzes$$ExternalSyntheticBackport0.m22289m(b);
        ...
        if (charset.equals(StandardCharsets.UTF_8)) {
            ...
            if (i == 1) {
                iM22289m = zzes$$ExternalSyntheticBackport0.m22289m(this.zze[this.zzf]);
            } else if (i == 2) {
                byte[] bArr3 = this.zze;
                int i7 = this.zzf;
                iM22289m = zzY(0, 0, bArr3[i7], bArr3[i7 + 1]);
            } else {
                if (i != 3) {
                    if (i == 4) {
                        byte[] bArr4 = this.zze;
                        int i8 = this.zzf;
                        iM22289m = zzY(bArr4[i8], bArr4[i8 + 1], bArr4[i8 + 2], bArr4[i8 + 3]);
                    }
                    return 0;
                }
                byte[] bArr5 = this.zze;
                int i9 = this.zzf;
                iM22289m = zzY(0, bArr5[i9] & Ascii.f22499SI, bArr5[i9 + 1], bArr5[i9 + 2]);
            }
            i4 = i;
            codePoint = iM22289m;
        } else {
    ...
    public final String zzL(int i) {
        ...
        int i2 = this.zzf;
        int i3 = (i2 + i) - 1;
        String strZzk = zzfk.zzk(this.zze, i2, (i3 >= this.zzg || this.zze[i3] != 0) ? i : i - 1);
        this.zzf += i;
        return strZzk;
    }
    ...
    public final String zzM(char c) {
        ...
        byte[] bArr = this.zze;
        int i2 = this.zzf;
        String strZzk = zzfk.zzk(bArr, i2, i - i2);
        this.zzf = i;
        if (i < this.zzg) {
            this.zzf = i + 1;
        }
    ...
    public final String zzN(Charset charset) {
        ...
        while (true) {
            ...
            if (charset.equals(StandardCharsets.UTF_16) || charset.equals(StandardCharsets.UTF_16BE)) {
                byte[] bArr2 = this.zze;
                if (bArr2[i2] == 0 && zzfk.zzl(bArr2[i2 + 1])) {
                    break;
                }
                if (charset.equals(StandardCharsets.UTF_16LE)) {
                    bArr = this.zze;
                    if (bArr[i2 + 1] == 0 && zzfk.zzl(bArr[i2])) {
                        break;
                    }
                }
                i2 += i;
