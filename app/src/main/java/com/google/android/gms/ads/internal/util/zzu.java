...
public class zzu extends zzt {
    ...
    public final boolean zzd(Activity activity, Configuration configuration) {
        ...
        int iRound = ((int) Math.round(((double) activity.getResources().getDisplayMetrics().density) + 0.5d)) * ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zzfX)).intValue();
