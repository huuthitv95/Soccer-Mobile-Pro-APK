...
public final class zzigi {
    ...
    static zzigi zzc(zzigi zzigiVar, zzigi zzigiVar2) {
        ...
        int[] iArrCopyOf = Arrays.copyOf(zzigiVar.zzc, i);
        System.arraycopy(zzigiVar2.zzc, 0, iArrCopyOf, zzigiVar.zzb, zzigiVar2.zzb);
        Object[] objArrCopyOf = Arrays.copyOf(zzigiVar.zzd, i);
        System.arraycopy(zzigiVar2.zzd, 0, objArrCopyOf, zzigiVar.zzb, zzigiVar2.zzb);
        return new zzigi(i, iArrCopyOf, objArrCopyOf, true);
    }
    ...
    public final int zzh() {
        ...
        for (int i2 = 0; i2 < this.zzb; i2++) {
            ...
            zzicn zzicnVar = (zzicn) this.zzd[i2];
            int iZzF2 = zzicw.zzF(8);
            int iZzF3 = zzicw.zzF(16) + zzicw.zzF(i3);
            int iZzF4 = zzicw.zzF(24);
            int iZzb = zzicnVar.zzb();
            iZzF += iZzF2 + iZzF2 + iZzF3 + iZzF4 + zzicw.zzF(iZzb) + iZzb;
        }
        this.zze = iZzF;
        return iZzF;
    }
        ...
        for (int i3 = 0; i3 < this.zzb; i3++) {
            ...
            if (i6 != 0) {
                if (i6 == 1) {
                    ...
                    iZzF2 = zzicw.zzF(i5 << 3) + 8;
                } else if (i6 == 2) {
                    int i7 = i5 << 3;
                    zzicn zzicnVar = (zzicn) this.zzd[i3];
                    int iZzF3 = zzicw.zzF(i7);
                    int iZzb = zzicnVar.zzb();
                    iZzF2 = iZzF3 + zzicw.zzF(iZzb) + iZzb;
                } else if (i6 == 3) {
                    int iZzF4 = zzicw.zzF(i5 << 3);
                    iZzF = iZzF4 + iZzF4;
                    iZzG = ((zzigi) this.zzd[i3]).zzi();
                } else {
                    if (i6 != 5) {
                        throw new IllegalStateException(new zzief("Protocol message tag had invalid wire type."));
                    }
                    ((Integer) this.zzd[i3]).intValue();
                    iZzF2 = zzicw.zzF(i5 << 3) + 4;
                }
                i2 += iZzF2;
            } else {
                int i8 = i5 << 3;
    ...
    final boolean zzl(int i, zzicr zzicrVar) throws IOException {
        ...
        } while (zzigiVar.zzl(iZza, zzicrVar));
