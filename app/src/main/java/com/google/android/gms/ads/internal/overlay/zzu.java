...
public final class zzu extends FrameLayout implements View.OnClickListener {
    ...
    public zzu(Context context, zzt zztVar, zzah zzahVar) {
        ...
        long jLongValue = ((Long) zzba.zzc().zzd(zzbie.zzbO)).longValue();
        if (jLongValue <= 0) {
            return;
        }
    ...
    private final void zzc() {
        ...
        try {
            if ("white".equals(str)) {
                drawable = resourcesZzf.getDrawable(C9597R.drawable.admob_close_button_white_circle_black_cross);
            } else if ("black".equals(str)) {
                drawable = resourcesZzf.getDrawable(C9597R.drawable.admob_close_button_black_circle_white_cross);
            }
