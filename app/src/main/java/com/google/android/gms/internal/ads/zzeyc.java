...
public final class zzeyc implements zzimi {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        zzfak zzfakVar;
        zzezj zzezjVarZzb = ((zzezl) this.zza).zzb();
        ...
        if (list.contains("60")) {
            ...
            zzfakVar = new zzfak(zzezjVarZzb, ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zzom)).intValue(), scheduledExecutorService);
        }
        return zzfakVar;
    }
}
