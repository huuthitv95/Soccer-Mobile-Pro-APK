...
public final class Tasks {
    ...
    private static void zzb(Task task, zzad zzadVar) {
        task.addOnSuccessListener(TaskExecutors.zza, zzadVar);
        task.addOnFailureListener(TaskExecutors.zza, zzadVar);
        task.addOnCanceledListener(TaskExecutors.zza, zzadVar);
    }
