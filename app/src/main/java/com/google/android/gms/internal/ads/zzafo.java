...
public final class zzafo {
    ...
    public static zzv zzb(byte[] bArr, String str, String str2, int i, String str3, zzq zzqVar) {
        zzer zzerVarZzi = zzi(bArr);
        zzerVarZzi.zzh(60);
        int i2 = zzb[zzerVarZzi.zzj(6)];
        int i3 = zzc[zzerVarZzi.zzj(4)];
        int iZzj = zzerVarZzi.zzj(5);
        int i4 = iZzj >= 29 ? -1 : (zzd[iZzj] * 1000) / 2;
        zzerVarZzi.zzh(10);
        int i5 = i2 + (zzerVarZzi.zzj(2) > 0 ? 1 : 0);
        zzt zztVar = new zzt();
        zztVar.zza(str);
    ...
    public static zzafn zzd(byte[] bArr) throws zzat {
        ...
        zzer zzerVarZzi = zzi(bArr);
        zzerVarZzi.zzh(40);
        int iZzj2 = zzerVarZzi.zzj(2);
        boolean zZzi = zzerVarZzi.zzi();
        int i3 = true != zZzi ? 16 : 20;
        zzerVarZzi.zzh(true != zZzi ? 8 : 12);
        int iZzj3 = zzerVarZzi.zzj(i3) + 1;
        boolean zZzi2 = zzerVarZzi.zzi();
        int iZzj4 = -1;
        int i4 = 0;
        if (zZzi2) {
            iZzj = zzerVarZzi.zzj(2);
            int iZzj5 = zzerVarZzi.zzj(3) + 1;
            if (zzerVarZzi.zzi()) {
                zzerVarZzi.zzh(36);
            }
            int iZzj6 = zzerVarZzi.zzj(3) + 1;
            int iZzj7 = zzerVarZzi.zzj(3) + 1;
            if (iZzj6 != 1 || iZzj7 != 1) {
                throw zzat.zzc("Multiple audio presentations or assets not supported");
            }
            int i5 = iZzj2 + 1;
            int iZzj8 = zzerVarZzi.zzj(i5);
            ...
            if (zzerVarZzi.zzi()) {
                zzerVarZzi.zzh(2);
                int iZzj9 = (zzerVarZzi.zzj(2) + 1) << 2;
                int iZzj10 = zzerVarZzi.zzj(2) + 1;
                while (i4 < iZzj10) {
                    zzerVarZzi.zzh(iZzj9);
                    i4++;
                }
            }
            i4 = i7;
        ...
        if (zZzi2) {
            ...
            if (zzerVarZzi.zzi()) {
                zzerVarZzi.zzo(zzerVarZzi.zzj(10) + 1);
            }
            zzerVarZzi.zzh(5);
            i = zze[zzerVarZzi.zzj(4)];
            iZzj4 = zzerVarZzi.zzj(8) + 1;
        } else {
            i = -2147483647;
        }
        int i8 = i;
        if (zZzi2) {
            ...
            jZzv = zzfk.zzv(i4, 1000000L, i2, RoundingMode.DOWN);
        } else {
            jZzv = -9223372036854775807L;
        }
        return new zzafn("audio/vnd.dts.hd;profile=lbr", iZzj4, i8, iZzj3, jZzv, 0, null);
    }

    public static int zze(byte[] bArr) {
        zzer zzerVarZzi = zzi(bArr);
        zzerVarZzi.zzh(42);
        return zzerVarZzi.zzj(true != zzerVarZzi.zzi() ? 8 : 12) + 1;
    }
    ...
    public static zzafn zzf(byte[] bArr, AtomicInteger atomicInteger) throws zzat {
        ...
        int i2;
        zzer zzerVarZzi = zzi(bArr);
        int iZzj2 = zzerVarZzi.zzj(32);
        int iZzh = zzh(zzerVarZzi, zzf, true);
        int i3 = iZzh + 1;
        ...
        if (c == 0) {
            ...
            int i4 = iZzh - 1;
            if (((bArr[iZzh] & 255) | ((char) (bArr[i4] << 8))) != zzfk.zzJ(bArr, 0, i4, 65535)) {
                throw zzat.zzb("CRC check failed", null);
            }
            int iZzj3 = zzerVarZzi.zzj(2);
            if (iZzj3 == 0) {
                i = 512;
            } else if (iZzj3 == 1) {
                i = 480;
            ...
            int iZzj4 = zzerVarZzi.zzj(3) + 1;
            int iZzj5 = zzerVarZzi.zzj(2);
            if (iZzj5 == 0) {
                i2 = 32000;
            } else if (iZzj5 == 1) {
                i2 = 44100;
            ...
            iZzj = (1 << zzerVarZzi.zzj(2)) * i2;
            jZzv = zzfk.zzv(i * iZzj4, 1000000L, i2, RoundingMode.DOWN);
        }
        int i5 = iZzj;
        long j = jZzv;
        int iZzh2 = 0;
        for (char c2 = 0; c2 < c; c2 = 1) {
            iZzh2 += zzh(zzerVarZzi, zzg, true);
        }
        for (int i6 = 0; i6 <= 0; i6++) {
            if (c != 0) {
                atomicInteger2 = atomicInteger;
                atomicInteger2.set(zzh(zzerVarZzi, zzh, true));
            } else {
                atomicInteger2 = atomicInteger;
            }
            iZzh2 += atomicInteger2.get() != 0 ? zzh(zzerVarZzi, zzi, true) : 0;
        }
        return new zzafn("audio/vnd.dts.uhd;profile=p2", 2, i5, i3 + iZzh2, j, 0, null);
    }

    public static int zzg(byte[] bArr) {
        zzer zzerVarZzi = zzi(bArr);
        zzerVarZzi.zzh(32);
        return zzh(zzerVarZzi, zzj, true) + 1;
    }
    ...
    private static zzer zzi(byte[] bArr) {
        ...
        zzer zzerVar = new zzer(bArrCopyOf, length);
        if (bArrCopyOf[0] == 31) {
            zzer zzerVar2 = new zzer(bArrCopyOf, length);
