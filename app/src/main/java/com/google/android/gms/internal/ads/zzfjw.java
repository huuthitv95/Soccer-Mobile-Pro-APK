...
public final class zzfjw {
    ...
    zzfjw(JsonReader jsonReader) throws IllegalStateException, JSONException, IOException, NumberFormatException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (Objects.equals(strNextName, "nofill_urls")) {
                ...
                if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zzjz)).booleanValue() && "public_error".equals(strNextName) && jsonReader.peek() == JsonToken.BEGIN_OBJECT) {
                    zzfjvVar = new zzfjv(jsonReader);
                } else if ("bidding_data".equals(strNextName)) {
                    strNextString7 = jsonReader.nextString();
                } else {
                    if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zzlN)).booleanValue() && Objects.equals(strNextName, "topics_should_record_observation")) {
                        ...
                        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbhvVar)).booleanValue() && Objects.equals(strNextName, "adResponseBody")) {
                            strNextString2 = jsonReader.nextString();
                        } else if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbhvVar)).booleanValue() && Objects.equals(strNextName, "adResponseHeaders")) {
                            ...
                            if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zzkO)).booleanValue() && Objects.equals(strNextName, "inspector_ad_transaction_extras")) {
                                jSONObject2 = com.google.android.gms.ads.internal.util.zzbp.zzd(jsonReader);
                            } else {
                                if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zzcO)).booleanValue() && Objects.equals(strNextName, "latency_extras")) {
                                    try {
        ...
        this.zzr = ((Long) zzbjoVar2.zze()).longValue() > 0 ? ((Long) zzbjoVar2.zze()).intValue() : iMax;
        this.zzs = jZza2;
        this.zzt = jZza;
    }
