...
final class zzbf extends QueryInfoGenerationCallback {
    ...
    public final void onFailure(String str) {
        ...
        String strConcat = ((Boolean) zzbkj.zzc.zze()).booleanValue() ? ",\"as\":".concat(this.zzb.zze().zzb().toString()) : "";
        String str2 = this.zza;
        Locale locale = Locale.getDefault();
        zzbjo zzbjoVar = zzbkj.zze;
        final String str3 = String.format(locale, "window.postMessage({\"paw_id\":\"%1$s\",\"error\":\"%2$s\",\"sdk_ttl_ms\":%3$d%4$s}, '*');", str2, str, Long.valueOf(((Boolean) zzbjoVar.zze()).booleanValue() ? ((Long) zzbkj.zzh.zze()).longValue() : 0L), strConcat);
    ...
    public final void onSuccess(QueryInfo queryInfo) {
        ...
        try {
            ...
            String strConcat = ((Boolean) zzbkj.zzc.zze()).booleanValue() ? ",\"as\":".concat(this.zzb.zze().zzb().toString()) : "";
            str = String.format(Locale.getDefault(), "window.postMessage({\"paw_id\":\"%1$s\",\"signal\":\"%2$s\",\"sdk_ttl_ms\":%3$d%4$s}, '*');", this.zza, queryInfo.getQuery(), Long.valueOf(((Boolean) zzbkj.zze.zze()).booleanValue() ? ((Long) zzbkj.zzh.zze()).longValue() : 0L), strConcat);
        }
