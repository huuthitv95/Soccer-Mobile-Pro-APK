                ...
                try {
                    ...
                    if (signatureArr == null || (signatureArr.length) == 0) {
                        ...
                        for (Signature signature : signatureArr) {
                            String strZza = zzgrx.zza(signature.toByteArray());
                        ...
                        zza.zzb(String.format("Play Store package certs are not valid. Found these sha256 certs: [%s].", UByte$$ExternalSyntheticBackport0.m43493m((CharSequence) ", ", (Iterable) arrayList)), new Object[0]);
                    }
