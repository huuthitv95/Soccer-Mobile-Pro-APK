...
public final class zza {
    ...
    public final void zza(WebView webView) {
        ...
        if (((Boolean) zzbkj.zzb.zze()).booleanValue() && WebViewFeature.isFeatureSupported(WebViewFeature.DOCUMENT_START_SCRIPT) && webView != null) {
            WebViewCompat.addDocumentStartJavaScript(webView, String.format(Locale.getDefault(), (String) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zzlg), zzb()), zzgwj.zzi(ProxyConfig.MATCH_ALL_SCHEMES));
        }
    }
