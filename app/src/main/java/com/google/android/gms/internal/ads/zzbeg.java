...
public final class zzbeg implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Application.ActivityLifecycleCallbacks {
    ...
    private final void zzj(int i) {
            ...
            if (view2 != null) {
                ...
                if (com.google.android.gms.ads.internal.util.zzs.zzX(view, powerManager, keyguardManager)) {
                    if (!globalVisibleRect) {
                        ...
                        i2 = 0;
                        localVisibleRect = false;
                    } else if (jZzy < ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zzlY)).intValue() || windowVisibility != 0) {
                        globalVisibleRect = true;
        ...
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zzma)).booleanValue()) {
            ...
            int i10 = jZzy >= ((long) ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zzlY)).intValue()) ? 32 : 0;
            com.google.android.gms.ads.internal.zzt.zzc();
        ...
        boolean z2 = i2;
        zzbed zzbedVar = new zzbed(com.google.android.gms.ads.internal.zzt.zzk().elapsedRealtime(), this.zzg.isScreenOn(), (view == null || !view.isAttachedToWindow()) ? false : z, view != null ? view.getWindowVisibility() : 8, zzc(this.zzp), zzc(rect), zzc(rect2), globalVisibleRect, zzc(rect3), localVisibleRect, jZzy, zzc(rect4), this.zzo.density, z2, list);
