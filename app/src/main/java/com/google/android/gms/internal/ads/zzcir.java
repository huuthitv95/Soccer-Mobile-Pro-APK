...
public final class zzcir extends zzcio {
    ...
    private final File zza(File file) {
        zzfyv zzfyvVarZza = zzfyu.zza();
        File file2 = this.zzg;
        String name = file.getName();
        String.valueOf(name);
        return new File(zzfyvVarZza.zza(file2, String.valueOf(name).concat(".done")));
    }
    ...
    /* JADX WARN: Type inference failed for: r33v0, types: [com.google.android.gms.internal.ads.zzcio, com.google.android.gms.internal.ads.zzcir] */
            ...
            if (i > ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zzu)).intValue()) {
                ...
                synchronized (set) {
                    ...
                    try {
                        ...
                        try {
                            try {
                                HttpURLConnection httpURLConnectionZzh = zzfzs.zza().zzh(new zzfzi() { // from class: com.google.android.gms.internal.ads.zzciq
                                    @Override // com.google.android.gms.internal.ads.zzfzi
                                    public final /* synthetic */ URLConnection zza() throws IOException {
                                        int i13 = zzcir.zzd;
                                        com.google.android.gms.ads.internal.zzt.zzq();
                                        int iIntValue = ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zzao)).intValue();
                                        URL url = new URL(str);
                                        int i14 = 0;
                                        while (true) {
                                            i14++;
                                ...
                                int iIntValue = ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zzv)).intValue();
                                ...
                                try {
                                    ...
                                    try {
                                        try {
                                            ...
                                            com.google.android.gms.ads.internal.util.zzbu zzbuVar = new com.google.android.gms.ads.internal.util.zzbu(((Long) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zzan)).longValue());
                                            long jLongValue = ((Long) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zzam)).longValue();
                                            int i20 = 0;
                                            while (true) {
                                                ...
                                                try {
                                                    try {
                                                        ...
                                                        if (zzbuVar.zza()) {
                                                            ...
                                                            i2 = contentLength;
                                                            com.google.android.gms.ads.internal.util.client.zzf.zza.post(new zzcii(this, str, file.getAbsolutePath(), i20, i2, false));
                                                        } else {
                                                            i2 = contentLength;
                                                            byteBuffer = byteBufferAllocate;
                                                        }
