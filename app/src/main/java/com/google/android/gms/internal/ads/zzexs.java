...
public final class zzexs implements zzimi {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        zzfak zzfakVar;
        zzevs zzevsVarZzb = ((zzevu) this.zza).zzb();
        ...
        if (list.contains("54")) {
            ...
            zzfakVar = new zzfak(zzevsVarZzb, ((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zznM)).intValue(), scheduledExecutorService);
        }
        return zzfakVar;
    }
}
