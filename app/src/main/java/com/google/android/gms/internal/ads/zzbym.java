...
public final class zzbym extends RemoteCreator {
    ...
    public final zzbyp zza(Activity activity) {
        try {
            IBinder iBinderZze = ((zzbys) getRemoteCreatorInstance(activity)).zze(ObjectWrapper.wrap(activity));
            if (iBinderZze == null) {
                return null;
            }
            ...
            return iInterfaceQueryLocalInterface instanceof zzbyp ? (zzbyp) iInterfaceQueryLocalInterface : new zzbyn(iBinderZze);
