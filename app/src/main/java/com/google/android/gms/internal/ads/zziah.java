...
final class zziah implements zzhdw {
    ...
    /* synthetic */ zziah(RSAPublicKey rSAPublicKey, zzhzv zzhzvVar, zzhzv zzhzvVar2, int i, byte[] bArr, byte[] bArr2, byte[] bArr3) throws GeneralSecurityException {
        if (zzhki.zza()) {
    ...
    private final void zzb(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ...
        byte[] bArrZzb = zzhkk.zzb(bigInteger.modPow(publicExponent, modulus), iBitLength2 / 8);
