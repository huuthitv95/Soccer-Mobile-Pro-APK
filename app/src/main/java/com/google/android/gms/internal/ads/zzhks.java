...
public final class zzhks {
    ...
    public static byte[] zza(byte[] bArr) {
        ...
        while (true) {
            ...
            int i3 = i2 + i2;
            bArr2[i3] = (byte) (bArr[i2] & Ascii.f22499SI);
    ...
    public static boolean zzc(byte[] bArr, byte[] bArr2, byte[] bArr3) throws GeneralSecurityException {
        ...
        while (i >= 0) {
            ...
            if (i2 != i3) {
                ...
                zzhkz.zze(jArr3, jArr, jArrZzg);
                zzhkr zzhkrVar = new zzhkr(new zzhkq(jArr, jArrZzg, jArr2), jArr3);
                ...
                while (i12 >= 0) {
                    ...
                    if (b2 > 0) {
                        ...
                        zzg(zzhkpVar2, zzhkrVar3, zzhkoVarArr[bArrZzl[i12] / 2]);
                    } else if (b2 < 0) {
                        zzhkr.zza(zzhkrVar3, zzhkpVar2);
                        zzh(zzhkpVar2, zzhkrVar3, zzhkoVarArr[(-bArrZzl[i12]) / 2]);
                    }
                    byte b3 = bArrZzl2[i12];
                    if (b3 > 0) {
                        zzhkr.zza(zzhkrVar3, zzhkpVar2);
                        zzg(zzhkpVar2, zzhkrVar3, zzhku.zze[bArrZzl2[i12] / 2]);
                    } else if (b3 < 0) {
                        zzhkr.zza(zzhkrVar3, zzhkpVar2);
                        zzh(zzhkpVar2, zzhkrVar3, zzhku.zze[(-bArrZzl2[i12]) / 2]);
                    }
                    i12--;
                }
                byte[] bArrZzb = new zzhkq(zzhkpVar2).zzb();
    ...
    private static void zzk(zzhkn zzhknVar, int i, byte b) {
        ...
        long[] jArrCopyOf = Arrays.copyOf(zzhknVar.zzb, 10);
        long[] jArrCopyOf2 = Arrays.copyOf(jArr2, 10);
        long[] jArrCopyOf3 = Arrays.copyOf(jArr, 10);
        zzm(jArrCopyOf3, jArrCopyOf3);
        zzhknVar.zzb(new zzhkn(jArrCopyOf, jArrCopyOf2, jArrCopyOf3), i2);
    }
