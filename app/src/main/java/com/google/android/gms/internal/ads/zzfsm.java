...
public final class zzfsm extends zzftl {
    ...
    protected final ListenableFuture zza(Context context) {
        ...
        zzesy zzesyVar = (zzesy) this.zza.zzc(ObjectWrapper.wrap(context), new com.google.android.gms.ads.internal.client.zzr(), this.zze.zza, zzbuqVarZzd, this.zzc);
        if (zzesyVar == null) {
            return zzhbi.zzc(new zzfsa(1, "Failed to create an interstitial ad manager."));
        }
        ...
        try {
            ...
            zzesyVar.zzQ(this.zze.zzc, new zzfsl(zzesyVar, new zzfta(this, zzhcbVarZze), this.zze.zza));
            return zzhcbVarZze;
