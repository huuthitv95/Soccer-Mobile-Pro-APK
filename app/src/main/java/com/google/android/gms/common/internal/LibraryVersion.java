...
public class LibraryVersion {
    ...
    public String getVersion(String str) throws Throwable {
        ...
        try {
            try {
                ...
                try {
                    if (resourceAsStream != null) {
                        ...
                        sb.append(property);
                        gmsLogger.m22269v("LibraryVersion", sb.toString());
                    } else {
                        GmsLogger gmsLogger2 = zza;
                        StringBuilder sb2 = new StringBuilder(String.valueOf(str).length() + 43);
                        sb2.append("Failed to get app version for libraryName: ");
                        sb2.append(str);
                        gmsLogger2.m22271w("LibraryVersion", sb2.toString());
                    }
                } catch (IOException e) {
                    e = e;
                    str2 = property;
                    ...
                    sb3.append(str);
                    gmsLogger3.m22266e("LibraryVersion", sb3.toString(), e);
            ...
            if (property == null) {
                zza.m22263d("LibraryVersion", ".properties file is dropped during release process. Failure to read app version is expected during Google internal testing where locally-built libraries are used");
                property = "UNKNOWN";
            }
