...
public final class zzcem {
    ...
    public zzcem(String str, long j) {
        ...
        try {
                ...
                for (int i2 = 0; i2 < jSONArrayOptJSONArray2.length(); i2++) {
                    ...
                    if (!TextUtils.isEmpty(strOptString) && !TextUtils.isEmpty(strOptString2)) {
                        if ("interstitial".equalsIgnoreCase(strOptString)) {
                            ...
                            this.zzc.put(strOptString2, new zzbuk(jSONObjectOptJSONObject3));
                        }
                    }
                }
            }
            ...
            if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zzhP)).booleanValue() && (jSONObjectOptJSONObject2 = this.zzg.optJSONObject("common_settings")) != null && (jSONArrayOptJSONArray = jSONObjectOptJSONObject2.optJSONArray("loeid")) != null) {
                for (int i4 = 0; i4 < jSONArrayOptJSONArray.length(); i4++) {
                    this.zzi.add(jSONArrayOptJSONArray.get(i4).toString());
                }
            }
            if (!((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zzhk)).booleanValue() || (jSONObjectOptJSONObject = this.zzg.optJSONObject("common_settings")) == null) {
                return;
            }
    ...
    public final boolean zzj() {
        ...
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zzfc)).booleanValue() && (zzdyzVarZzv = com.google.android.gms.ads.internal.zzt.zzh().zzv()) != null) {
            zzdyy zzdyyVarZza = zzdyzVarZzv.zza();
            zzdyyVarZza.zzc("action", "cld_reset");
            zzdyyVarZza.zzc("cld_lut_ms", String.valueOf(this.zzf));
            zzdyyVarZza.zzc("event_timestamp", String.valueOf(com.google.android.gms.ads.internal.zzt.zzk().currentTimeMillis()));
            zzdyyVarZza.zzc("cld_ttl_sec", String.valueOf(zzm()));
            zzdyyVarZza.zzd();
        }
        this.zza.clear();
        this.zzb.clear();
