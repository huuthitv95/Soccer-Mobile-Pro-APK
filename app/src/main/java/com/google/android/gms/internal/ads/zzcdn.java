...
public final class zzcdn {
    ...
    private final boolean zzx(Context context, String str, AtomicReference atomicReference, boolean z) {
        if (atomicReference.get() == null) {
            try {
                LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m280m(atomicReference, null, context.getClassLoader().loadClass(str).getDeclaredMethod(Constants.GET_INSTANCE, Context.class).invoke(null, context));
            } catch (Exception unused) {
    ...
    public final String zzi(final Context context) {
        ...
        long jLongValue = ((Long) com.google.android.gms.ads.internal.client.zzba.zzc().zzd(zzbie.zzaW)).longValue();
        if (jLongValue < 0) {
        ...
        if (atomicReference.get() == null) {
            ...
            LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m280m(atomicReference, null, threadPoolExecutor);
        }
        try {
