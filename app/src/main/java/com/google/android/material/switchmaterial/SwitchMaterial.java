...
public class SwitchMaterial extends SwitchCompat {
    private static final int DEF_STYLE_RES = C9632R.style.Widget_MaterialComponents_CompoundButton_Switch;
    ...
    public SwitchMaterial(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C9632R.attr.switchStyle);
    }
    ...
    public SwitchMaterial(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C9632R.styleable.SwitchMaterial, i, i2, new int[0]);
        this.useMaterialThemeColors = typedArrayObtainStyledAttributes.getBoolean(C9632R.styleable.SwitchMaterial_useMaterialThemeColors, false);
        typedArrayObtainStyledAttributes.recycle();
    }

    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.materialThemeColorsThumbTintList == null) {
            int color = MaterialColors.getColor(this, C9632R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, C9632R.attr.colorControlActivated);
            float dimension = getResources().getDimension(C9632R.dimen.mtrl_switch_thumb_elevation);
    ...
    private ColorStateList getMaterialThemeColorsTrackTintList() {
        if (this.materialThemeColorsTrackTintList == null) {
            ...
            int color = MaterialColors.getColor(this, C9632R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, C9632R.attr.colorControlActivated);
            int color3 = MaterialColors.getColor(this, C9632R.attr.colorOnSurface);
