...
public class ShapePath {
    ...
    static class InnerCornerShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            ...
            double dHypot = Math.hypot(this.operation1.f21952x - this.startX, this.operation1.f21953y - this.startY);
            double dHypot2 = Math.hypot(this.operation2.f21952x - this.operation1.f21952x, this.operation2.f21953y - this.operation1.f21953y);
            ...
            this.renderMatrix.set(matrix);
            this.renderMatrix.preTranslate(this.operation1.f21952x, this.operation1.f21953y);
            this.renderMatrix.preRotate(getStartAngle());
        ...
        float getEndAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation2.f21953y - this.operation1.f21953y) / (this.operation2.f21952x - this.operation1.f21952x)));
        }

        float getStartAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation1.f21953y - this.startY) / (this.operation1.f21952x - this.startX)));
        }
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        @Override // com.google.android.material.shape.ShapePath.ShadowCompatOperation
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f21953y - this.startY, this.operation.f21952x - this.startX), 0.0f);
            this.renderMatrix.set(matrix);
            this.renderMatrix.preTranslate(this.startX, this.startY);
        ...
        float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f21953y - this.startY) / (this.operation.f21952x - this.startX)));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(Matrix matrix, Path path) {
            ...
            matrix.invert(matrix2);
            path.transform(matrix2);
            path.lineTo(this.f21952x, this.f21953y);
            path.transform(matrix);
        }
    }
    ...
    public void lineTo(float f, float f2) {
        ...
        pathLineOperation.f21952x = f;
        pathLineOperation.f21953y = f2;
    ...
    public void lineTo(float f, float f2, float f3, float f4) {
        ...
        pathLineOperation2.f21952x = f3;
        pathLineOperation2.f21953y = f4;
