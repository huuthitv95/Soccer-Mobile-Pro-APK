...
public class SingleDateSelector implements DateSelector<Long> {
    ...
    public int getDefaultThemeResId(Context context) {
        return MaterialAttributes.resolveOrThrow(context, C9632R.attr.materialCalendarTheme, MaterialDatePicker.class.getCanonicalName());
    }

    @Override // com.google.android.material.datepicker.DateSelector
    public int getDefaultTitleResId() {
        return C9632R.string.mtrl_picker_date_header_title;
    }
    ...
    public String getSelectionContentDescription(Context context) {
        ...
        Long l = this.selectedItem;
        return resources.getString(C9632R.string.mtrl_picker_announce_current_selection, l == null ? resources.getString(C9632R.string.mtrl_picker_announce_current_selection_none) : DateStrings.getYearMonthDay(l.longValue()));
    }
    ...
    public String getSelectionDisplayString(Context context) {
        ...
        Long l = this.selectedItem;
        if (l == null) {
            return resources.getString(C9632R.string.mtrl_picker_date_header_unselected);
        }
        return resources.getString(C9632R.string.mtrl_picker_date_header_selected, DateStrings.getYearMonthDay(l.longValue()));
    }
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints calendarConstraints, final OnSelectionChangedListener<Long> onSelectionChangedListener) {
        View viewInflate = layoutInflater.inflate(C9632R.layout.mtrl_picker_text_input_date, viewGroup, false);
        final TextInputLayout textInputLayout = (TextInputLayout) viewInflate.findViewById(C9632R.id.mtrl_picker_text_input_date);
