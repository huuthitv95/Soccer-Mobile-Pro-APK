...
public class MaterialThemeOverlay {
    private static final int[] ANDROID_THEME_OVERLAY_ATTRS = {R.attr.theme, C9632R.attr.theme};
    private static final int[] MATERIAL_THEME_OVERLAY_ATTR = {C9632R.attr.materialThemeOverlay};
