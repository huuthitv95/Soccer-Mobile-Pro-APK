...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(Context context) {
        this(MaterialAttributes.resolveBoolean(context, C9632R.attr.elevationOverlayEnabled, false), MaterialColors.getColor(context, C9632R.attr.elevationOverlayColor, 0), MaterialColors.getColor(context, C9632R.attr.elevationOverlayAccentColor, 0), MaterialColors.getColor(context, C9632R.attr.colorSurface, 0), context.getResources().getDisplayMetrics().density);
    }
