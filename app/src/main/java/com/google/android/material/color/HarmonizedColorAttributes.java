...
public final class HarmonizedColorAttributes {
    private static final int[] HARMONIZED_MATERIAL_ATTRIBUTES = {C9632R.attr.colorError, C9632R.attr.colorOnError, C9632R.attr.colorErrorContainer, C9632R.attr.colorOnErrorContainer};
    ...
    public static HarmonizedColorAttributes createMaterialDefaults() {
        return create(HARMONIZED_MATERIAL_ATTRIBUTES, C9632R.style.ThemeOverlay_Material3_HarmonizedColors);
    }
