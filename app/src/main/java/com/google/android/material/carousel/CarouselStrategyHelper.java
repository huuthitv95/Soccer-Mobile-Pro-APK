...
final class CarouselStrategyHelper {
    ...
    static float getExtraSmallSize(Context context) {
        return context.getResources().getDimension(C9632R.dimen.m3_carousel_gone_size);
    }

    static float getSmallSizeMax(Context context) {
        return context.getResources().getDimension(C9632R.dimen.m3_carousel_small_item_size_max);
    }

    static float getSmallSizeMin(Context context) {
        return context.getResources().getDimension(C9632R.dimen.m3_carousel_small_item_size_min);
    }
