...
class MonthAdapter extends BaseAdapter {
    ...
    private void updateSelectedState(TextView textView, long j, int i) {
        ...
        if (zIsValid) {
            ...
            if (zIsSelected) {
                ...
                calendarItemStyle = isToday(j) ? this.calendarStyle.todayDay : this.calendarStyle.day;
            }
        } else {
            zIsSelected = false;
    ...
    public TextView getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            textView = (TextView) LayoutInflater.from(viewGroup.getContext()).inflate(C9632R.layout.mtrl_calendar_day, viewGroup, false);
        }
