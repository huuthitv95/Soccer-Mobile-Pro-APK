...
public class SearchBar extends Toolbar {
    ...
    private static final int DEF_STYLE_RES = C9632R.style.Widget_Material3_SearchBar;
    ...
    public SearchBar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C9632R.attr.materialSearchBarStyle);
    }
    ...
    public SearchBar(Context context, AttributeSet attributeSet, int i) {
        ...
        this.touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() { // from class: com.google.android.material.search.SearchBar$$ExternalSyntheticLambda2
            ...
            public final void onTouchExplorationStateChanged(boolean z) {
                this.f$0.m44160lambda$new$0$comgoogleandroidmaterialsearchSearchBar(z);
            }
        };
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C9632R.styleable.SearchBar, i, i2, new int[0]);
        ShapeAppearanceModel shapeAppearanceModelBuild = ShapeAppearanceModel.builder(context2, attributeSet, i, i2).build();
        int color = typedArrayObtainStyledAttributes.getColor(C9632R.styleable.SearchBar_backgroundTint, 0);
        float dimension = typedArrayObtainStyledAttributes.getDimension(C9632R.styleable.SearchBar_elevation, 0.0f);
        this.defaultMarginsEnabled = typedArrayObtainStyledAttributes.getBoolean(C9632R.styleable.SearchBar_defaultMarginsEnabled, true);
        this.defaultScrollFlagsEnabled = typedArrayObtainStyledAttributes.getBoolean(C9632R.styleable.SearchBar_defaultScrollFlagsEnabled, true);
        boolean z = typedArrayObtainStyledAttributes.getBoolean(C9632R.styleable.SearchBar_hideNavigationIcon, false);
        this.forceDefaultNavigationOnClickListener = typedArrayObtainStyledAttributes.getBoolean(C9632R.styleable.SearchBar_forceDefaultNavigationOnClickListener, false);
        this.tintNavigationIcon = typedArrayObtainStyledAttributes.getBoolean(C9632R.styleable.SearchBar_tintNavigationIcon, true);
        if (typedArrayObtainStyledAttributes.hasValue(C9632R.styleable.SearchBar_navigationIconTint)) {
            this.navigationIconTint = Integer.valueOf(typedArrayObtainStyledAttributes.getColor(C9632R.styleable.SearchBar_navigationIconTint, -1));
        }
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(C9632R.styleable.SearchBar_android_textAppearance, -1);
        String string = typedArrayObtainStyledAttributes.getString(C9632R.styleable.SearchBar_android_text);
        String string2 = typedArrayObtainStyledAttributes.getString(C9632R.styleable.SearchBar_android_hint);
        float dimension2 = typedArrayObtainStyledAttributes.getDimension(C9632R.styleable.SearchBar_strokeWidth, -1.0f);
        int color2 = typedArrayObtainStyledAttributes.getColor(C9632R.styleable.SearchBar_strokeColor, 0);
        ...
        setClickable(true);
        setFocusable(true);
        LayoutInflater.from(context2).inflate(C9632R.layout.mtrl_search_bar, this);
        this.layoutInflated = true;
        this.textView = (TextView) findViewById(C9632R.id.open_search_bar_text_view);
    ...
    private void initBackground(ShapeAppearanceModel shapeAppearanceModel, int i, float f, float f2, int i2) {
        ...
        int color = MaterialColors.getColor(this, C9632R.attr.colorControlHighlight);
    ...
    private void initTextView(int i, String str, String str2) {
        ...
        if (getNavigationIcon() == null) {
            MarginLayoutParamsCompat.setMarginStart((ViewGroup.MarginLayoutParams) this.textView.getLayoutParams(), getResources().getDimensionPixelSize(C9632R.dimen.m3_searchbar_text_margin_start_no_navigation_icon));
        }
    }
    ...
    private Drawable maybeTintNavigationIcon(Drawable drawable) {
        ...
        if (num != null) {
            ...
            color = MaterialColors.getColor(this, drawable == this.defaultNavigationIcon ? C9632R.attr.colorOnSurfaceVariant : C9632R.attr.colorOnSurface);
        }
    ...
    private void setDefaultMargins() {
        if (this.defaultMarginsEnabled && (getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C9632R.dimen.m3_searchbar_margin_horizontal);
    ...
    private void validateAttributes(AttributeSet attributeSet) {
        ...
        if (attributeSet.getAttributeValue(NAMESPACE_APP, MessengerShareContentUtility.SUBTITLE) != null) {
    ...
    protected int getDefaultMarginVerticalResource() {
        return C9632R.dimen.m3_searchbar_margin_vertical;
    }

    protected int getDefaultNavigationIconResource() {
        return C9632R.drawable.ic_search_black_24;
    }
    ...
    /* synthetic */ void m44160lambda$new$0$comgoogleandroidmaterialsearchSearchBar(boolean z) {
        setFocusableInTouchMode(z);
    }

    /* JADX INFO: renamed from: lambda$startOnLoadAnimation$1$com-google-android-material-search-SearchBar */
    /* synthetic */ void m22439x58362b63() {
