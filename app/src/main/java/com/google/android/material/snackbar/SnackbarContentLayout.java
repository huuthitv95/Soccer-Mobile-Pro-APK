...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attributeSet) {
        ...
        this.contentInterpolator = MotionUtils.resolveThemeInterpolator(context, C9632R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
    }
    ...
    protected void onFinishInflate() {
        ...
        this.messageView = (TextView) findViewById(C9632R.id.snackbar_text);
        this.actionView = (Button) findViewById(C9632R.id.snackbar_action);
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int dimensionPixelSize = getResources().getDimensionPixelSize(C9632R.dimen.design_snackbar_padding_vertical_2lines);
        int dimensionPixelSize2 = getResources().getDimensionPixelSize(C9632R.dimen.design_snackbar_padding_vertical);
    ...
    void updateActionTextColorAlphaIfNeeded(float f) {
        if (f != 1.0f) {
            this.actionView.setTextColor(MaterialColors.layer(MaterialColors.getColor(this, C9632R.attr.colorSurface), this.actionView.getCurrentTextColor(), f));
        }
    }
}
