...
class PasswordToggleEndIconDelegate extends EndIconDelegate {
    ...
    PasswordToggleEndIconDelegate(EndCompoundLayout endCompoundLayout, int i) {
        ...
        this.iconResId = C9632R.drawable.design_password_eye;
    ...
    int getIconContentDescriptionResId() {
        return C9632R.string.password_toggle_content_description;
    }
    ...
    /* synthetic */ void m22469x4cc26475(View view) {
        EditText editText = this.editText;
        if (editText == null) {
            return;
        }
