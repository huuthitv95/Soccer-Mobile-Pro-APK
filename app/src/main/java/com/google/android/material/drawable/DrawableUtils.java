...
public final class DrawableUtils {
    ...
    public static ColorStateList getColorStateListOrNull(Drawable drawable) {
        ...
        if (Build.VERSION.SDK_INT < 29 || !ab$$ExternalSyntheticApiModelOutline0.m42918m((Object) drawable)) {
            return null;
        }
        return ab$$ExternalSyntheticApiModelOutline0.m42841m((Object) drawable).getColorStateList();
    }
