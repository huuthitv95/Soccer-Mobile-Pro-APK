...
class FadeModeEvaluators {
    ...
    private static final FadeModeEvaluator f21956IN = new FadeModeEvaluator() { // from class: com.google.android.material.transition.FadeModeEvaluators.1
    ...
    static FadeModeEvaluator get(int i, boolean z) {
        if (i == 0) {
            return z ? f21956IN : OUT;
        }
        if (i == 1) {
            return z ? OUT : f21956IN;
        }
        if (i == 2) {
            return CROSS;
        }
