...
abstract class SheetDialog<C extends SheetCallback> extends AppCompatDialog {
    private static final int COORDINATOR_LAYOUT_ID = C9632R.id.coordinator;
    private static final int TOUCH_OUTSIDE_ID = C9632R.id.touch_outside;
    ...
    private void maybeUpdateWindowAnimationsBasedOnLayoutDirection() {
        ...
        window.setWindowAnimations(GravityCompat.getAbsoluteGravity(((CoordinatorLayout.LayoutParams) this.sheet.getLayoutParams()).gravity, ViewCompat.getLayoutDirection(this.sheet)) == 3 ? C9632R.style.Animation_Material3_SideSheetDialog_Left : C9632R.style.Animation_Material3_SideSheetDialog_Right);
    }
    ...
    private View wrapInSheet(int i, View view, ViewGroup.LayoutParams layoutParams) {
        ...
        coordinatorLayout.findViewById(TOUCH_OUTSIDE_ID).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.sidesheet.SheetDialog$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view2) {
                this.f$0.m22452x401f75dd(view2);
            }
        });
    ...
    /* synthetic */ void m22452x401f75dd(View view) {
