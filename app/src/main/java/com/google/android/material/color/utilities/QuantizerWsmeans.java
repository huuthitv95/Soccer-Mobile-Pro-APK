    ...
    public static Map<Integer, Integer> quantize(int[] iArr, int[] iArr2, int i) {
        ...
        while (i14 < 10) {
            ...
            while (i30 < iMin) {
                int i31 = iArr7[i30];
                if (i31 == 0) {
                    dArr3[i30] = new double[]{FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE, FirebaseRemoteConfig.DEFAULT_VALUE_FOR_DOUBLE};
                    dArr = dArr6;
                } else {
                    double d3 = dArr5[i30];
                    dArr = dArr6;
