...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    public BottomSheetDialog(Context context) {
        this(context, 0);
        this.edgeToEdgeEnabled = getContext().getTheme().obtainStyledAttributes(new int[]{C9632R.attr.enableEdgeToEdge}).getBoolean(0, false);
    }
    ...
    private FrameLayout ensureContainerAndBehavior() {
        if (this.container == null) {
            FrameLayout frameLayout = (FrameLayout) View.inflate(getContext(), C9632R.layout.design_bottom_sheet_dialog, null);
            this.container = frameLayout;
            this.coordinator = (CoordinatorLayout) frameLayout.findViewById(C9632R.id.coordinator);
            FrameLayout frameLayout2 = (FrameLayout) this.container.findViewById(C9632R.id.design_bottom_sheet);
    ...
    private static int getThemeResId(Context context, int i) {
        ...
        return context.getTheme().resolveAttribute(C9632R.attr.bottomSheetDialogTheme, typedValue, true) ? typedValue.resourceId : C9632R.style.Theme_Design_Light_BottomSheetDialog;
    }
    ...
    private View wrapInBottomSheet(int i, View view, ViewGroup.LayoutParams layoutParams) {
        ...
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) this.container.findViewById(C9632R.id.coordinator);
        if (i != 0 && view == null) {
        ...
        coordinatorLayout.findViewById(C9632R.id.touch_outside).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.bottomsheet.BottomSheetDialog.2
