...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{R.attr.state_checked}, AppCompatResources.getDrawable(context, C9632R.drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], AppCompatResources.getDrawable(context, C9632R.drawable.material_ic_edit_black_24dp));
    ...
    private void enableEdgeToEdgeIfNeeded(Window window) {
        ...
        final View viewFindViewById = requireView().findViewById(C9632R.id.fullscreen_header);
    ...
    private static int getPaddedPickerWidth(Context context) {
        ...
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C9632R.dimen.mtrl_calendar_content_padding);
        int i = Month.current().daysInWeek;
        return (dimensionPixelOffset * 2) + (resources.getDimensionPixelSize(C9632R.dimen.mtrl_calendar_day_width) * i) + ((i - 1) * resources.getDimensionPixelOffset(C9632R.dimen.mtrl_calendar_month_horizontal_padding));
    }
    ...
    static boolean isNestedScrollable(Context context) {
        return readMaterialCalendarStyleBoolean(context, C9632R.attr.nestedScrollable);
    }
    ...
    static boolean readMaterialCalendarStyleBoolean(Context context, int i) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C9632R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{i});
    ...
    private void startPickerFragment() {
        ...
        fragmentTransactionBeginTransaction.replace(C9632R.id.mtrl_calendar_frame, this.pickerFragment);
    ...
    private void updateToggleContentDescription(CheckableImageButton checkableImageButton) {
        this.headerToggleButton.setContentDescription(this.inputMode == 1 ? checkableImageButton.getContext().getString(C9632R.string.mtrl_picker_toggle_to_calendar_input_mode) : checkableImageButton.getContext().getString(C9632R.string.mtrl_picker_toggle_to_text_input_mode));
    }
    ...
    /* synthetic */ void m22435x8a93f18a(View view) {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        this.background = new MaterialShapeDrawable(context, null, C9632R.attr.materialCalendarStyle, C9632R.style.Widget_MaterialComponents_MaterialCalendar);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, C9632R.styleable.MaterialCalendar, C9632R.attr.materialCalendarStyle, C9632R.style.Widget_MaterialComponents_MaterialCalendar);
        int color = typedArrayObtainStyledAttributes.getColor(C9632R.styleable.MaterialCalendar_backgroundTint, 0);
        typedArrayObtainStyledAttributes.recycle();
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View viewInflate = layoutInflater.inflate(this.fullscreen ? C9632R.layout.mtrl_picker_fullscreen : C9632R.layout.mtrl_picker_dialog, viewGroup);
        ...
        if (this.fullscreen) {
            viewInflate.findViewById(C9632R.id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            viewInflate.findViewById(C9632R.id.mtrl_calendar_main_pane).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -1));
        }
        TextView textView = (TextView) viewInflate.findViewById(C9632R.id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        ViewCompat.setAccessibilityLiveRegion(textView, 1);
        this.headerToggleButton = (CheckableImageButton) viewInflate.findViewById(C9632R.id.mtrl_picker_header_toggle);
        this.headerTitleTextView = (TextView) viewInflate.findViewById(C9632R.id.mtrl_picker_title_text);
        initHeaderToggle(context);
        this.confirmButton = (Button) viewInflate.findViewById(C9632R.id.confirm_button);
        ...
        Button button = (Button) viewInflate.findViewById(C9632R.id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int dimensionPixelOffset = getResources().getDimensionPixelOffset(C9632R.dimen.mtrl_calendar_dialog_background_inset);
