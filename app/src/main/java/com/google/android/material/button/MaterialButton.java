...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    private static final int DEF_STYLE_RES = C9632R.style.Widget_MaterialComponents_Button;
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<MaterialButton> {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            this.mIconPaddingId = propertyMapper.mapInt("iconPadding", C9632R.attr.iconPadding);
            this.mPropertiesMapped = true;
        }

        public void readProperties(MaterialButton materialButton, PropertyReader propertyReader) {
            if (!this.mPropertiesMapped) {
                throw Chip$$ExternalSyntheticApiModelOutline0.m22340m();
            }
    ...
    public MaterialButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C9632R.attr.materialButtonStyle);
    }
    ...
    public MaterialButton(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C9632R.styleable.MaterialButton, i, i2, new int[0]);
        this.iconPadding = typedArrayObtainStyledAttributes.getDimensionPixelSize(C9632R.styleable.MaterialButton_iconPadding, 0);
        this.iconTintMode = ViewUtils.parseTintMode(typedArrayObtainStyledAttributes.getInt(C9632R.styleable.MaterialButton_iconTintMode, -1), PorterDuff.Mode.SRC_IN);
        this.iconTint = MaterialResources.getColorStateList(getContext(), typedArrayObtainStyledAttributes, C9632R.styleable.MaterialButton_iconTint);
        this.icon = MaterialResources.getDrawable(getContext(), typedArrayObtainStyledAttributes, C9632R.styleable.MaterialButton_icon);
        this.iconGravity = typedArrayObtainStyledAttributes.getInteger(C9632R.styleable.MaterialButton_iconGravity, 1);
        this.iconSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C9632R.styleable.MaterialButton_iconSize, 0);
