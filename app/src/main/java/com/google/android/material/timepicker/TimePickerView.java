...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public TimePickerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.selectionListener = new View.OnClickListener() { // from class: com.google.android.material.timepicker.TimePickerView.1
            ...
            public void onClick(View view) {
                if (TimePickerView.this.onSelectionChangeListener != null) {
                    TimePickerView.this.onSelectionChangeListener.onSelectionChanged(((Integer) view.getTag(C9632R.id.selection_type)).intValue());
                }
            }
        };
        LayoutInflater.from(context).inflate(C9632R.layout.material_timepicker, this);
        this.clockFace = (ClockFaceView) findViewById(C9632R.id.material_clock_face);
        MaterialButtonToggleGroup materialButtonToggleGroup = (MaterialButtonToggleGroup) findViewById(C9632R.id.material_clock_period_toggle);
        ...
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() { // from class: com.google.android.material.timepicker.TimePickerView$$ExternalSyntheticLambda0
            ...
            public final void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup2, int i2, boolean z) {
                this.f$0.m22474x9f44237d(materialButtonToggleGroup2, i2, z);
            }
        });
        this.minuteView = (Chip) findViewById(C9632R.id.material_minute_tv);
        this.hourView = (Chip) findViewById(C9632R.id.material_hour_tv);
        this.clockHandView = (ClockHandView) findViewById(C9632R.id.material_clock_hand);
        setupDoubleTap();
        setUpDisplay();
    }

    private void setUpDisplay() {
        this.minuteView.setTag(C9632R.id.selection_type, 12);
        this.hourView.setTag(C9632R.id.selection_type, 10);
    ...
    /* synthetic */ void m22474x9f44237d(MaterialButtonToggleGroup materialButtonToggleGroup, int i, boolean z) {
        if (z && this.onPeriodChangeListener != null) {
            this.onPeriodChangeListener.onPeriodChange(i == C9632R.id.material_clock_period_pm_button ? 1 : 0);
        }
    }
    ...
    public void updateTime(int i, int i2, int i3) {
        this.toggle.check(i == 1 ? C9632R.id.material_clock_period_pm_button : C9632R.id.material_clock_period_am_button);
