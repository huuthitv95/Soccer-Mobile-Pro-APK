...
/* JADX INFO: renamed from: com.google.android.play.core.assetpacks.model.a */
/* JADX INFO: compiled from: com.google.android.play:asset-delivery@@2.2.1 */
/* JADX INFO: loaded from: classes4.dex */
public final class C10132a {

    /* JADX INFO: renamed from: a */
    private static final Map f22465a;

    /* JADX INFO: renamed from: b */
    private static final Map f22466b;
    ...
    /* JADX INFO: renamed from: a */
    public static String m22789a(int i) {
        Map map = f22465a;
        Integer numValueOf = Integer.valueOf(i);
        if (!map.containsKey(numValueOf)) {
            return "";
        }
        return ((String) map.get(numValueOf)) + " (https://developer.android.com/reference/com/google/android/play/core/assetpacks/model/AssetPackErrorCode.html#" + ((String) f22466b.get(numValueOf)) + ")";
    }
}
