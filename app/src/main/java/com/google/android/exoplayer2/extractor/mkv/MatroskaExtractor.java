...
public class MatroskaExtractor implements Extractor {
    ...
    protected static final class Track {
        ...
        private static Pair<String, List<byte[]>> parseFourCcPrivate(ParsableByteArray parsableByteArray) throws ParserException {
            try {
                ...
                if (littleEndianUnsignedInt != 826496599) {
                    Log.m22240w(MatroskaExtractor.TAG, "Unknown FourCC. Setting mimeType to video/x-unknown");
        ...
        /* JADX WARN: Code duplicated, block: B:207:0x03fc  */
        /* JADX WARN: Code duplicated, block: B:212:0x0416  */
        /* JADX WARN: Code duplicated, block: B:213:0x0418  */
        /* JADX WARN: Code duplicated, block: B:216:0x0425  */
        /* JADX WARN: Code duplicated, block: B:217:0x0437  */
        /* JADX WARN: Code duplicated, block: B:219:0x043d  */
        /* JADX WARN: Code duplicated, block: B:221:0x0441  */
        /* JADX WARN: Code duplicated, block: B:223:0x0446  */
        /* JADX WARN: Code duplicated, block: B:226:0x044e  */
        /* JADX WARN: Code duplicated, block: B:228:0x0453  */
        /* JADX WARN: Code duplicated, block: B:231:0x0458  */
        /* JADX WARN: Code duplicated, block: B:234:0x0466  */
        /* JADX WARN: Code duplicated, block: B:237:0x046c  */
        /* JADX WARN: Code duplicated, block: B:238:0x047c  */
        /* JADX WARN: Code duplicated, block: B:241:0x0481  */
        /* JADX WARN: Code duplicated, block: B:246:0x04a1  */
        /* JADX WARN: Code duplicated, block: B:265:0x04ed  */
        /* JADX WARN: Code duplicated, block: B:267:0x0513  */
            ...
            switch (b) {
                ...
                case 2:
                    ...
                    if (parseMsAcmCodecPrivate(new ParsableByteArray(getCodecPrivate(this.codecId)))) {
                        ...
                        Log.m22240w(MatroskaExtractor.TAG, "Unsupported PCM bit depth: " + this.audioBitDepth + ". Setting mimeType to audio/x-unknown");
                    } else {
                        Log.m22240w(MatroskaExtractor.TAG, "Non-PCM MS/ACM is unsupported. Setting mimeType to audio/x-unknown");
                    }
                ...
                case 22:
                    if (this.audioBitDepth != 32) {
                        Log.m22240w(MatroskaExtractor.TAG, "Unsupported floating point PCM bit depth: " + this.audioBitDepth + ". Setting mimeType to audio/x-unknown");
                        str5 = "audio/x-unknown";
                        listSingletonList = null;
                        str = null;
                        i2 = 0;
                ...
                case 23:
                    ...
                    if (i20 == 8) {
                        ...
                        Log.m22240w(MatroskaExtractor.TAG, "Unsupported big endian PCM bit depth: " + this.audioBitDepth + ". Setting mimeType to audio/x-unknown");
                        str5 = "audio/x-unknown";
                        listSingletonList = null;
                        str = null;
                        i2 = 0;
                ...
                case 24:
                    pcmEncoding = Util.getPcmEncoding(this.audioBitDepth);
                    if (pcmEncoding == 0) {
                        Log.m22240w(MatroskaExtractor.TAG, "Unsupported little endian PCM bit depth: " + this.audioBitDepth + ". Setting mimeType to audio/x-unknown");
                        str5 = "audio/x-unknown";
                        listSingletonList = null;
                        str = null;
                        i2 = 0;
    ...
    private SeekMap buildSeekMap(LongArray longArray, LongArray longArray2) {
        ...
        jArrCopyOf2[i] = j;
        if (j <= 0) {
            Log.m22240w(TAG, "Discarding last cue point with unexpected duration: " + j);
        ...
        if (track.trueHdSampleRechunker != null) {
            ...
            if (CODEC_ID_SUBRIP.equals(track.codecId) || CODEC_ID_ASS.equals(track.codecId) || CODEC_ID_VTT.equals(track.codecId)) {
                if (this.blockSampleCount > 1) {
                    Log.m22240w(TAG, "Skipping subtitle sample in laced block.");
                } else if (this.blockDurationUs == -9223372036854775807L) {
                    Log.m22240w(TAG, "Skipping subtitle sample with no duration.");
                } else {
    ...
    protected void endMasterElement(int i) throws ParserException {
        ...
        if (i == ID_CONTENT_ENCODING) {
            ...
            if (this.currentTrack.hasContentEncryption) {
                ...
                this.currentTrack.drmInitData = new DrmInitData(new DrmInitData.SchemeData(C9415C.UUID_NIL, "video/webm", this.currentTrack.cryptoData.encryptionKey));
                return;
            }
            return;
        }
