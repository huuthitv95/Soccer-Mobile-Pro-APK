...
public final class MediaCodecInfo {
    ...
    private static final class Api29 {
        ...
        public static int areResolutionAndFrameRateCovered(android.media.MediaCodecInfo.VideoCapabilities videoCapabilities, int i, int i2, double d) {
            ...
            android.media.MediaCodecInfo.VideoCapabilities.PerformancePoint performancePointM429m = FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m429m(i, i2, (int) d);
            for (int i3 = 0; i3 < supportedPerformancePoints.size(); i3++) {
                if (FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m430m(supportedPerformancePoints.get(i3)).covers(performancePointM429m)) {
                    return 2;
                }
            }
            return 1;
    ...
    private static int adjustMaxInputChannelCount(String str, String str2, int i) {
        ...
        Log.m22240w("MediaCodecInfo", "AssumedMaxChannelAdjustment: " + str + ", [" + i + " to " + i2 + C11744X3.j.f26440e);
        return i2;
    }
    ...
    private void logAssumedSupport(String str) {
        Log.m22234d("MediaCodecInfo", "AssumedSupport [" + str + "] [" + this.name + ", " + this.mimeType + "] [" + Util.DEVICE_DEBUG_INFO + C11744X3.j.f26440e);
    }

    private void logNoSupport(String str) {
        Log.m22234d("MediaCodecInfo", "NoSupport [" + str + "] [" + this.name + ", " + this.mimeType + "] [" + Util.DEVICE_DEBUG_INFO + C11744X3.j.f26440e);
    }
