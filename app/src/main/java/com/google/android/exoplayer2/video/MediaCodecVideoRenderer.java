...
public class MediaCodecVideoRenderer extends MediaCodecRenderer {
                ...
                if (Util.SDK_INT <= 26) {
                    ...
                    switch (str3.hashCode()) {
                        ...
                        case -1931988508:
                            ...
                            break;
                        case -1885099851:
                            b = !str3.equals("RAIJIN") ? (byte) -1 : Ascii.f22503VT;
                            break;
                        case -1696512866:
                            b = !str3.equals("XT1663") ? (byte) -1 : Ascii.f22492FF;
                            break;
                        case -1680025915:
                            b = !str3.equals("ComioS1") ? (byte) -1 : Ascii.f22490CR;
                            break;
                        case -1615810839:
                            b = !str3.equals("Phantom6") ? (byte) -1 : Ascii.f22500SO;
                            break;
                        case -1600724499:
                            b = !str3.equals("pacificrim") ? (byte) -1 : Ascii.f22499SI;
                            break;
                        case -1554255044:
                        ...
                        case -1052835013:
                            ...
                            break;
                        case -993250464:
                            b = !str3.equals("A10-70F") ? (byte) -1 : Ascii.f22491EM;
                            break;
                        case -993250458:
                        ...
                        case -958336948:
                            ...
                            break;
                        case -879245230:
                            b = !str3.equals("tcl_eu") ? (byte) -1 : Ascii.f22494GS;
                            break;
                        case -842500323:
                            b = !str3.equals("nicklaus_f") ? (byte) -1 : Ascii.f22498RS;
                            break;
                        case -821392978:
                            b = !str3.equals("A7000-a") ? (byte) -1 : Ascii.f22502US;
                            break;
                        case -797483286:
    ...
    protected CodecMaxValues getCodecMaxValues(MediaCodecInfo mediaCodecInfo, Format format, Format[] formatArr) {
        ...
        if (z) {
            Log.m22240w(TAG, "Resolutions unknown. Codec max resolution: " + iMax + "x" + iMax2);
            ...
            if (codecMaxSize != null) {
                ...
                Log.m22240w(TAG, "Codec max resolution adjusted to: " + iMax + "x" + iMax2);
            }
        }
        return new CodecMaxValues(iMax, iMax2, maxInputSize);
    }
    ...
    protected void onCodecError(Exception exc) {
        Log.m22237e(TAG, "Video codec error", exc);
    ...
    protected boolean processOutputBuffer(long j, long j2, MediaCodecAdapter mediaCodecAdapter, ByteBuffer byteBuffer, int i, int i2, int i3, long j3, boolean z, boolean z2, Format format) throws ExoPlaybackException {
        ...
        if (this.joiningDeadlineMs == -9223372036854775807L && j >= outputStreamOffsetUs && (z4 || (z5 && shouldForceRenderOutputBuffer(j6, j7)))) {
            ...
            if (Util.SDK_INT >= 21) {
                ...
                mediaCodecVideoRenderer = this;
                mediaCodecVideoRenderer.renderOutputBuffer(mediaCodecAdapter, i, j5);
            }
        ...
        if (z5 && j != this.initialPositionUs) {
            ...
            if (shouldDropBuffersToKeyframe(j8, j2, z2) && maybeDropBuffersToKeyframe(j, z6)) {
                return false;
            }
