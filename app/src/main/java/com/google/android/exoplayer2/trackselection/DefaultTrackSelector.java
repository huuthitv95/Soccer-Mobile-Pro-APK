...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    public static final class Parameters extends TrackSelectionParameters implements Bundleable {
        ...
        public static final class Builder extends TrackSelectionParameters.Builder {
            ...
            private void setSelectionOverridesFromBundle(Bundle bundle) {
                ...
                ImmutableList immutableListM22832of = parcelableArrayList == null ? ImmutableList.m22832of() : BundleableUtil.fromBundleList(TrackGroupArray.CREATOR, parcelableArrayList);
                ...
                if (intArray == null || intArray.length != immutableListM22832of.size()) {
                    return;
                }
                for (int i = 0; i < intArray.length; i++) {
                    setSelectionOverride(intArray[i], (TrackGroupArray) immutableListM22832of.get(i), (SelectionOverride) sparseArray.get(i));
                }
            }
    ...
    static final class TextTrackInfo extends TrackInfo<TextTrackInfo> implements Comparable<TextTrackInfo> {
        ...
        public TextTrackInfo(int i, TrackGroup trackGroup, int i2, Parameters parameters, int i3, String str) {
            ...
            ImmutableList<String> immutableListM22833of = parameters.preferredTextLanguages.isEmpty() ? ImmutableList.m22833of("") : parameters.preferredTextLanguages;
            int i6 = 0;
            while (true) {
    ...
    private DefaultTrackSelector(TrackSelectionParameters trackSelectionParameters, ExoTrackSelection.Factory factory, Context context) {
        ...
        if (this.parameters.constrainAudioChannelCountToDeviceCapabilities && context == null) {
            Log.m22240w(TAG, AUDIO_CHANNEL_COUNT_CONSTRAINTS_WARN_MESSAGE);
        }
    }
    ...
    /* JADX INFO: renamed from: lambda$selectAudioTrack$3$com-google-android-exoplayer2-trackselection-DefaultTrackSelector */
    /* synthetic */ List m22231xc9e179dc(Parameters parameters, boolean z, int i, TrackGroup trackGroup, int[] iArr) {
    ...
    protected Pair<ExoTrackSelection.Definition, Integer> selectAudioTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, int[] iArr2, final Parameters parameters) throws ExoPlaybackException {
        ...
        return selectTracksForType(1, mappedTrackInfo, iArr, new TrackInfo.Factory() { // from class: com.google.android.exoplayer2.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda5
            ...
            public final List create(int i2, TrackGroup trackGroup, int[] iArr3) {
                return this.f$0.m22231xc9e179dc(parameters, z, i2, trackGroup, iArr3);
            }
