...
public final class MaskingMediaSource extends WrappingMediaSource {
    ...
    private void setPreparePositionOverrideToUnpreparedMaskingPeriod(long j) {
        ...
        int indexOfPeriod = this.timeline.getIndexOfPeriod(maskingMediaPeriod.f21867id.periodUid);
        if (indexOfPeriod == -1) {
            return;
        }
        ...
        if (this.isPrepared) {
            ...
            if (!timeline.isEmpty()) {
                ...
                if (maskingMediaPeriod2 != null) {
                    ...
                    this.timeline.getPeriodByUid(this.unpreparedMaskingMediaPeriod.f21867id.periodUid, this.period);
                ...
                if (maskingMediaPeriod3 != null) {
                    ...
                    mediaPeriodIdCopyWithPeriodUid = maskingMediaPeriod3.f21867id.copyWithPeriodUid(getInternalPeriodUid(maskingMediaPeriod3.f21867id.periodUid));
                }
                this.hasRealTimeline = true;
