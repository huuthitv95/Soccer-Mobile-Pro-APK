...
public abstract class SimpleBasePlayer extends BasePlayer {
    ...
    protected SimpleBasePlayer(Looper looper, Clock clock) {
        ...
        this.listeners = new ListenerSet<>(looper, clock, new ListenerSet.IterationFinishedEvent() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda51
            ...
            public final void invoke(Object obj, FlagSet flagSet) {
                this.f$0.m44141lambda$new$0$comgoogleandroidexoplayer2SimpleBasePlayer((Player.Listener) obj, flagSet);
            }
        });
    }
    ...
    private void setMediaItemsInternal(final List<MediaItem> list, final int i, final long j) {
        ...
        if (shouldHandleCommand(20) || (list.size() == 1 && shouldHandleCommand(31))) {
            updateStateForPendingOperation(handleSetMediaItems(list, i, j), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda47
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return this.f$0.m22177xb80ed5ee(list, state, i, j);
                }
            });
        }
    }
    ...
    private void updateStateForPendingOperation(final ListenableFuture<?> listenableFuture, Supplier<State> supplier, boolean z, boolean z2) {
        ...
        listenableFuture.addListener(new Runnable() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda38
            ...
            public final void run() {
                this.f$0.m22178x902fbd44(listenableFuture);
            }
    ...
    public final void addMediaItems(int i, final List<MediaItem> list) {
        ...
        updateStateForPendingOperation(handleAddMediaItems(iMin, list), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda0
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m22174xc134386b(state, list, iMin);
            }
        });
    }
    ...
    /* JADX INFO: renamed from: lambda$addMediaItems$3$com-google-android-exoplayer2-SimpleBasePlayer */
    /* synthetic */ State m22174xc134386b(State state, List list, int i) {
    ...
    /* JADX INFO: renamed from: lambda$moveMediaItems$4$com-google-android-exoplayer2-SimpleBasePlayer */
    /* synthetic */ State m22175xfea097c0(State state, int i, int i2, int i3) {
        ArrayList arrayList = new ArrayList(state.playlist);
    ...
    /* synthetic */ void m44141lambda$new$0$comgoogleandroidexoplayer2SimpleBasePlayer(Player.Listener listener, FlagSet flagSet) {
        listener.onEvents(this, new Player.Events(flagSet));
    }

    /* JADX INFO: renamed from: lambda$removeMediaItems$5$com-google-android-exoplayer2-SimpleBasePlayer */
    /* synthetic */ State m22176xc687f44c(State state, int i, int i2) {
        ArrayList arrayList = new ArrayList(state.playlist);
        Util.removeRange(arrayList, i, i2);
        return getStateWithNewPlaylist(state, arrayList, this.period);
    }

    /* JADX INFO: renamed from: lambda$setMediaItemsInternal$2$com-google-android-exoplayer2-SimpleBasePlayer */
    /* synthetic */ State m22177xb80ed5ee(List list, State state, int i, long j) {
    ...
    /* JADX INFO: renamed from: lambda$updateStateForPendingOperation$55$com-google-android-exoplayer2-SimpleBasePlayer */
    /* synthetic */ void m22178x902fbd44(ListenableFuture listenableFuture) {
        ...
        if (shouldHandleCommand(20) && size != 0 && i < size) {
            ...
            if (i != iMin && iMin2 != i) {
                updateStateForPendingOperation(handleMoveMediaItems(i, iMin, iMin2), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda50
                    @Override // com.google.common.base.Supplier
                    public final Object get() {
                        return this.f$0.m22175xfea097c0(state, i, iMin, iMin2);
                    }
                });
            }
        }
    ...
    public final void removeMediaItems(final int i, int i2) {
        ...
        updateStateForPendingOperation(handleRemoveMediaItems(i, iMin), new Supplier() { // from class: com.google.android.exoplayer2.SimpleBasePlayer$$ExternalSyntheticLambda45
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m22176xc687f44c(state, i, iMin);
            }
        });
    }
