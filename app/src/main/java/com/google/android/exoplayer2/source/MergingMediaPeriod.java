    ...
    public void onPrepared(MediaPeriod mediaPeriod) {
        ...
        while (true) {
            ...
            while (i5 < i4) {
                ...
                TrackGroup trackGroupCopyWithId = trackGroup.copyWithId(i2 + CertificateUtil.DELIMITER + trackGroup.f21869id);
    ...
    public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
        ...
        for (int i2 = 0; i2 < exoTrackSelectionArr.length; i2++) {
            ...
            if (exoTrackSelection != null) {
                ...
                iArr2[i2] = Integer.parseInt(trackGroup.f21869id.substring(0, trackGroup.f21869id.indexOf(CertificateUtil.DELIMITER)));
            } else {
                iArr2[i2] = -1;
            }
        }
