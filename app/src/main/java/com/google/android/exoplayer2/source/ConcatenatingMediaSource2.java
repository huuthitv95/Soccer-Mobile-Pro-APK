...
public final class ConcatenatingMediaSource2 extends CompositeMediaSource<Integer> {
        ...
        while (i < this.mediaSourceHolders.size()) {
            ...
            while (i4 < periodCount2) {
                ...
                if (j5 == -9223372036854775807L) {
                    ...
                    j5 = (window.durationUs != -9223372036854775807L ? window.durationUs : mediaSourceHolder.initialPlaceholderDurationUs) + window.positionInFirstPeriodUs;
                }
                j += j5;
                i4++;
                period = period;
    ...
    public void m22214x365769cd(Integer num, MediaSource mediaSource, Timeline timeline) {
