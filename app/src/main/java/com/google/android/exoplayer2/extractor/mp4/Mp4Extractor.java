...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    private void processMoovAtom(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        int i = 0;
        int size = -1;
        for (int size2 = traks.size(); i < size2; size2 = size2) {
            ...
            if (trackSampleTable.sampleCount == 0) {
                ...
                int i2 = "audio/true-hd".equals(track.format.sampleMimeType) ? trackSampleTable.maximumSize * 16 : trackSampleTable.maximumSize + 30;
