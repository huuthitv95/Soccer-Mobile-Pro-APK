...
public final class TextRenderer extends BaseRenderer implements Handler.Callback {
    ...
    private void clearOutput() {
        updateOutput(new CueGroup(ImmutableList.m22832of(), getPresentationTimeUs(this.lastRendererPositionUs)));
    }
    ...
    private void handleDecoderError(SubtitleDecoderException subtitleDecoderException) {
        Log.m22237e(TAG, "Subtitle decoding failed. streamFormat=" + this.streamFormat, subtitleDecoderException);
        clearOutput();
        replaceDecoder();
    }
