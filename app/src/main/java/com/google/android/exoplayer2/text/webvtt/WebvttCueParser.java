...
public final class WebvttCueParser {
        ...
        private static Layout.Alignment convertTextAlignment(int i) {
            if (i != 1) {
                ...
                if (i != 3) {
                    if (i != 4) {
                        if (i != 5) {
                            Log.m22240w(WebvttCueParser.TAG, "Unknown textAlignment: " + i);
                            return null;
                        }
                    }
                }
    ...
    private static void applyEntity(String str, SpannableStringBuilder spannableStringBuilder) {
        ...
        switch (str) {
            ...
            case "nbsp":
                ...
                break;
            default:
                Log.m22240w(TAG, "ignoring unsupported entity: '&" + str + ";'");
                break;
        }
    }
    ...
    private static WebvttCueInfo parseCue(String str, Matcher matcher, ParsableByteArray parsableByteArray, List<WebvttCssStyle> list) {
        ...
        try {
            ...
            Log.m22240w(TAG, "Skipping cue with bad header: " + matcher.group());
            return null;
        }
    }
    ...
    private static void parseCueSettingsList(String str, WebvttCueInfoBuilder webvttCueInfoBuilder) {
        ...
        while (matcher.find()) {
            ...
            try {
                if ("line".equals(str2)) {
                ...
                } else if (C11744X3.i.f26338L.equals(str2)) {
                    ...
                    Log.m22240w(TAG, "Unknown cue setting " + str2 + CertificateUtil.DELIMITER + str3);
                }
            } catch (NumberFormatException unused) {
                Log.m22240w(TAG, "Skipping bad cue setting: " + matcher.group());
            }
        }
    }
    ...
    private static int parseLineAnchor(String str) {
        ...
        switch (str) {
            ...
            case "start":
                return 0;
            default:
                Log.m22240w(TAG, "Invalid anchor value: " + str);
    ...
    private static int parseTextAlignment(String str) {
        ...
        switch (str) {
            ...
            case "start":
                return 1;
            default:
                Log.m22240w(TAG, "Invalid alignment value: " + str);
                return 2;
        }
    }
    ...
    private static int parseVerticalAttribute(String str) {
        ...
        Log.m22240w(TAG, "Invalid 'vertical' value: " + str);
        return Integer.MIN_VALUE;
    }
}
