...
public class DefaultAnalyticsCollector implements AnalyticsCollector {
    ...
    private static final class MediaPeriodQueueTracker {
        ...
        private ImmutableList<MediaSource.MediaPeriodId> mediaPeriodQueue = ImmutableList.m22832of();
        private ImmutableMap<MediaSource.MediaPeriodId, Timeline> mediaPeriodTimelines = ImmutableMap.m22851of();
        private final Timeline.Period period;
    ...
    /* JADX INFO: renamed from: lambda$setPlayer$1$com-google-android-exoplayer2-analytics-DefaultAnalyticsCollector */
    /* synthetic */ void m22179xd6963fe(Player player, AnalyticsListener analyticsListener, FlagSet flagSet) {
    ...
    public void setPlayer(final Player player, Looper looper) {
        ...
        this.listeners = this.listeners.copy(looper, new ListenerSet.IterationFinishedEvent() { // from class: com.google.android.exoplayer2.analytics.DefaultAnalyticsCollector$$ExternalSyntheticLambda19
            @Override // com.google.android.exoplayer2.util.ListenerSet.IterationFinishedEvent
            public final void invoke(Object obj, FlagSet flagSet) {
                this.f$0.m22179xd6963fe(player, (AnalyticsListener) obj, flagSet);
            }
        });
    }
