...
final class AudioFocusManager {
    ...
    class AudioFocusListener implements AudioManager.OnAudioFocusChangeListener {
        ...
        /* JADX INFO: renamed from: lambda$onAudioFocusChange$0$com-google-android-exoplayer2-AudioFocusManager$AudioFocusListener */
        /* synthetic */ void m22154xa83e850b(int i) {
    ...
    private static int convertAudioAttributesToFocusGain(AudioAttributes audioAttributes) {
        ...
        switch (audioAttributes.usage) {
            case 0:
                Log.m22240w(TAG, "Specify a proper usage in the audio attributes for audio focus handling. Using AUDIOFOCUS_GAIN by default.");
                return 1;
            case 1:
            case 14:
                return 1;
            ...
            case 15:
            default:
                Log.m22240w(TAG, "Unidentified audio usage: " + audioAttributes.usage);
                return 0;
            case 16:
    ...
    public void handlePlatformAudioFocusChange(int i) {
        ...
        if (i == -1) {
            ...
            Log.m22240w(TAG, "Unknown focus change type: " + i);
        }
    }
    ...
    private int requestAudioFocusV26() {
        AudioFocusRequest.Builder builderM317m;
        AudioFocusRequest audioFocusRequest = this.audioFocusRequest;
        if (audioFocusRequest == null || this.rebuildAudioFocusRequest) {
            if (audioFocusRequest == null) {
                Util$$ExternalSyntheticApiModelOutline0.m43612m$1();
                builderM317m = Util$$ExternalSyntheticApiModelOutline0.m313m(this.focusGainToRequest);
            } else {
                Util$$ExternalSyntheticApiModelOutline0.m43612m$1();
                builderM317m = Util$$ExternalSyntheticApiModelOutline0.m317m(this.audioFocusRequest);
            }
            this.audioFocusRequest = builderM317m.setAudioAttributes(((AudioAttributes) Assertions.checkNotNull(this.audioAttributes)).getAudioAttributesV21().audioAttributes).setWillPauseWhenDucked(willPauseWhenDucked()).setOnAudioFocusChangeListener(this.focusListener).build();
