...
public final class AdsMediaSource extends CompositeMediaSource<MediaSource.MediaPeriodId> {
    ...
    private final class AdMediaSourceHolder {
        ...
        private final MediaSource.MediaPeriodId f21870id;
        private Timeline timeline;

        public AdMediaSourceHolder(MediaSource.MediaPeriodId mediaPeriodId) {
            this.f21870id = mediaPeriodId;
        }
        ...
        public void handleSourceInfoRefresh(Timeline timeline) {
            ...
            if (this.timeline == null) {
                ...
                for (int i = 0; i < this.activeMediaPeriods.size(); i++) {
                    ...
                    maskingMediaPeriod.createPeriod(new MediaSource.MediaPeriodId(uidOfPeriod, maskingMediaPeriod.f21867id.windowSequenceNumber));
                }
            }
        ...
        public void initializeWithMediaSource(MediaSource mediaSource, Uri uri) {
            ...
            AdsMediaSource.this.prepareChildSource(this.f21870id, mediaSource);
        }
        ...
        public void release() {
            if (hasMediaSource()) {
                AdsMediaSource.this.releaseChildSource(this.f21870id);
            }
        }
    ...
    final class AdPrepareListener implements MaskingMediaPeriod.PrepareListener {
        ...
        /* JADX INFO: renamed from: lambda$onPrepareComplete$0$com-google-android-exoplayer2-source-ads-AdsMediaSource$AdPrepareListener */
        /* synthetic */ void m22227x605e06cc(MediaSource.MediaPeriodId mediaPeriodId) {
        ...
        /* JADX INFO: renamed from: lambda$onPrepareError$1$com-google-android-exoplayer2-source-ads-AdsMediaSource$AdPrepareListener */
        /* synthetic */ void m22228x1f837766(MediaSource.MediaPeriodId mediaPeriodId, IOException iOException) {
        ...
        public void onPrepareComplete(final MediaSource.MediaPeriodId mediaPeriodId) {
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.AdsMediaSource$AdPrepareListener$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    this.f$0.m22227x605e06cc(mediaPeriodId);
                }
            });
        }
        ...
        public void onPrepareError(final MediaSource.MediaPeriodId mediaPeriodId, final IOException iOException) {
            ...
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.AdsMediaSource$AdPrepareListener$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m22228x1f837766(mediaPeriodId, iOException);
                }
            });
        }
    }
    ...
    final class ComponentListener implements AdsLoader.EventListener {
        ...
        /* JADX INFO: renamed from: lambda$onAdPlaybackState$0$com-google-android-exoplayer2-source-ads-AdsMediaSource$ComponentListener */
        /* synthetic */ void m22229x9c1f3358(AdPlaybackState adPlaybackState) {
            if (this.stopped) {
                return;
            }
        ...
        public void onAdPlaybackState(final AdPlaybackState adPlaybackState) {
            ...
            this.playerHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.AdsMediaSource$ComponentListener$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m22229x9c1f3358(adPlaybackState);
                }
            });
        }
    ...
    /* JADX INFO: renamed from: lambda$prepareSourceInternal$0$com-google-android-exoplayer2-source-ads-AdsMediaSource */
    /* synthetic */ void m22225x4dfad2b6(ComponentListener componentListener) {
        this.adsLoader.start(this, this.adTagDataSpec, this.adsId, this.adViewProvider, componentListener);
    }

    /* JADX INFO: renamed from: lambda$releaseSourceInternal$1$com-google-android-exoplayer2-source-ads-AdsMediaSource */
    /* synthetic */ void m22226x85e6f6b7(ComponentListener componentListener) {
    ...
    public void m22214x365769cd(MediaSource.MediaPeriodId mediaPeriodId, MediaSource mediaSource, Timeline timeline) {
    ...
    protected void prepareSourceInternal(TransferListener transferListener) {
        ...
        this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.AdsMediaSource$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m22225x4dfad2b6(componentListener);
            }
        });
    }
    ...
    public void releasePeriod(MediaPeriod mediaPeriod) {
        ...
        MediaSource.MediaPeriodId mediaPeriodId = maskingMediaPeriod.f21867id;
        if (!mediaPeriodId.isAd()) {
            maskingMediaPeriod.releasePeriod();
            return;
        }
    ...
    protected void releaseSourceInternal() {
        ...
        this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.AdsMediaSource$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m22226x85e6f6b7(componentListener);
            }
        });
    }
}
