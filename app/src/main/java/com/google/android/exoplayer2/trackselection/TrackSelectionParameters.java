...
public class TrackSelectionParameters implements Bundleable {
    ...
    public static class Builder {
        ...
        public Builder() {
            ...
            this.preferredVideoMimeTypes = ImmutableList.m22832of();
            this.preferredVideoRoleFlags = 0;
            this.preferredAudioLanguages = ImmutableList.m22832of();
            this.preferredAudioRoleFlags = 0;
            this.maxAudioChannelCount = Integer.MAX_VALUE;
            this.maxAudioBitrate = Integer.MAX_VALUE;
            this.preferredAudioMimeTypes = ImmutableList.m22832of();
            this.preferredTextLanguages = ImmutableList.m22832of();
        ...
        protected Builder(Bundle bundle) {
            ...
            ImmutableList immutableListM22832of = parcelableArrayList == null ? ImmutableList.m22832of() : BundleableUtil.fromBundleList(TrackSelectionOverride.CREATOR, parcelableArrayList);
            this.overrides = new HashMap<>();
            for (int i = 0; i < immutableListM22832of.size(); i++) {
                TrackSelectionOverride trackSelectionOverride = (TrackSelectionOverride) immutableListM22832of.get(i);
        ...
        private void m22233x58dbf263(Context context) {
            CaptioningManager captioningManager;
            if ((Util.SDK_INT >= 23 || Looper.myLooper() != null) && (captioningManager = (CaptioningManager) context.getSystemService("captioning")) != null && captioningManager.isEnabled()) {
                this.preferredTextRoleFlags = 1088;
                Locale locale = captioningManager.getLocale();
                if (locale != null) {
                    this.preferredTextLanguages = ImmutableList.m22833of(Util.getLocaleLanguageTag(locale));
                }
            }
        }
