...
public abstract class Timeline implements Bundleable {
    ...
    public static final class Period implements Bundleable {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null && getClass().equals(obj.getClass())) {
                ...
                if (Util.areEqual(this.f21849id, period.f21849id) && Util.areEqual(this.uid, period.uid) && this.windowIndex == period.windowIndex && this.durationUs == period.durationUs && this.positionInWindowUs == period.positionInWindowUs && this.isPlaceholder == period.isPlaceholder && Util.areEqual(this.adPlaybackState, period.adPlaybackState)) {
                    return true;
                }
            }
            return false;
    ...
    public static final class RemotableTimeline extends Timeline {
        ...
        public Period getPeriod(int i, Period period, boolean z) {
            ...
            period.set(period2.f21849id, period2.uid, period2.windowIndex, period2.durationUs, period2.positionInWindowUs, period2.adPlaybackState, period2.isPlaceholder);
            return period;
        }
    ...
    public final Bundle toBundleWithOneWindowOnly(int i) {
        ...
        BundleUtil.putBinder(bundle2, FIELD_WINDOWS, new BundleListRetriever(ImmutableList.m22833of(bundle)));
