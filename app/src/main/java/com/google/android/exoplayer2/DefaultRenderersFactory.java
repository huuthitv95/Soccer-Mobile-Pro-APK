...
public class DefaultRenderersFactory implements RenderersFactory {
        ...
        try {
            try {
                ...
                try {
                    ...
                    Log.m22238i(TAG, "Loaded MidiRenderer.");
        ...
        try {
            try {
                ...
                try {
                    ...
                    Log.m22238i(TAG, "Loaded LibopusAudioRenderer.");
            ...
            try {
                try {
                    ...
                    try {
                        ...
                        Log.m22238i(TAG, "Loaded LibflacAudioRenderer.");
                ...
                try {
                    ...
                    Log.m22238i(TAG, "Loaded FfmpegAudioRenderer.");
    ...
    protected void buildVideoRenderers(Context context, int i, MediaCodecSelector mediaCodecSelector, boolean z, Handler handler, VideoRendererEventListener videoRendererEventListener, long j, ArrayList<Renderer> arrayList) {
        ...
        try {
            try {
                ...
                try {
                    ...
                    Log.m22238i(TAG, "Loaded LibvpxVideoRenderer.");
                } catch (ClassNotFoundException unused) {
                    size = i2;
                    i2 = size;
                }
        ...
        try {
            ...
            Log.m22238i(TAG, "Loaded Libgav1VideoRenderer.");
        } catch (ClassNotFoundException unused3) {
        } catch (Exception e2) {
