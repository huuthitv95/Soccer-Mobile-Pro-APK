...
final class ExoPlayerImpl extends BasePlayer implements ExoPlayer, ExoPlayer.AudioComponent, ExoPlayer.VideoComponent, ExoPlayer.TextComponent, ExoPlayer.DeviceComponent {
    ...
    private static final class Api31 {
        ...
        public static PlayerId registerMediaMetricsListener(Context context, ExoPlayerImpl exoPlayerImpl, boolean z) {
            ...
            if (mediaMetricsListenerCreate == null) {
                Log.m22240w(ExoPlayerImpl.TAG, "MediaMetricsService unavailable.");
    ...
    final class ComponentListener implements VideoRendererEventListener, AudioRendererEventListener, TextOutput, MetadataOutput, SurfaceHolder.Callback, TextureView.SurfaceTextureListener, SphericalGLSurfaceView.VideoSurfaceListener, AudioFocusManager.PlayerControl, AudioBecomingNoisyManager.EventListener, StreamVolumeManager.Listener, ExoPlayer.AudioOffloadListener {
        ...
        /* JADX INFO: renamed from: lambda$onMetadata$4$com-google-android-exoplayer2-ExoPlayerImpl$ComponentListener */
        /* synthetic */ void m22157x842d3c8f(Player.Listener listener) {
        ...
        public void onMetadata(final Metadata metadata) {
            ...
            if (!mediaMetadataBuildUpdatedMediaMetadata.equals(ExoPlayerImpl.this.mediaMetadata)) {
                ...
                ExoPlayerImpl.this.listeners.queueEvent(14, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.ExoPlayerImpl$ComponentListener$$ExternalSyntheticLambda2
                    @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                    public final void invoke(Object obj) {
                        this.f$0.m22157x842d3c8f((Player.Listener) obj);
                    }
                });
            }
    ...
    public ExoPlayerImpl(ExoPlayer.Builder builder, Player player) {
        ...
        try {
            Log.m22238i(TAG, "Init " + Integer.toHexString(System.identityHashCode(this)) + " [ExoPlayerLib/2.18.7] [" + Util.DEVICE_DEBUG_INFO + C11744X3.j.f26440e);
            ...
            this.listeners = new ListenerSet<>(looper, clock, new ListenerSet.IterationFinishedEvent() { // from class: com.google.android.exoplayer2.ExoPlayerImpl$$ExternalSyntheticLambda15
                ...
                public final void invoke(Object obj, FlagSet flagSet) {
                    this.f$0.m44134lambda$new$0$comgoogleandroidexoplayer2ExoPlayerImpl((Player.Listener) obj, flagSet);
                }
            });
            ...
            ExoPlayerImplInternal.PlaybackInfoUpdateListener playbackInfoUpdateListener = new ExoPlayerImplInternal.PlaybackInfoUpdateListener() { // from class: com.google.android.exoplayer2.ExoPlayerImpl$$ExternalSyntheticLambda16
                ...
                public final void onPlaybackInfoUpdate(ExoPlayerImplInternal.PlaybackInfoUpdate playbackInfoUpdate) {
                    this.f$0.m44136lambda$new$2$comgoogleandroidexoplayer2ExoPlayerImpl(playbackInfoUpdate);
                }
            };
            this.playbackInfoUpdateListener = playbackInfoUpdateListener;
            this.playbackInfo = PlaybackInfo.createDummy(trackSelectorResult);
            analyticsCollectorApply.setPlayer(player2, looper);
            ExoPlayerImplInternal exoPlayerImplInternal = new ExoPlayerImplInternal(rendererArrCreateRenderers, trackSelector, trackSelectorResult, builder.loadControlSupplier.get(), bandwidthMeter, this.repeatMode, this.shuffleModeEnabled, analyticsCollectorApply, this.seekParameters, builder.livePlaybackSpeedControl, builder.releaseTimeoutMs, this.pauseAtEndOfMediaItems, looper, clock, playbackInfoUpdateListener, Util.SDK_INT < 31 ? new PlayerId() : Api31.registerMediaMetricsListener(applicationContext, this, builder.usePlatformDiagnostics), builder.playbackLooper);
    ...
    private Pair<Boolean, Integer> evaluateMediaItemTransitionReason(PlaybackInfo playbackInfo, PlaybackInfo playbackInfo2, boolean z, int i, boolean z2, boolean z3) {
        ...
        if (timeline.getWindow(timeline.getPeriodByUid(playbackInfo2.periodId.periodUid, this.period).windowIndex, this.window).uid.equals(timeline2.getWindow(timeline2.getPeriodByUid(playbackInfo.periodId.periodUid, this.period).windowIndex, this.window).uid)) {
            ...
            return (z && i == 1 && z3) ? new Pair<>(true, 2) : new Pair<>(false, -1);
        }
        if (z && i == 0) {
            i2 = 1;
        } else if (z && i == 1) {
    ...
    public void m44135lambda$new$1$comgoogleandroidexoplayer2ExoPlayerImpl(ExoPlayerImplInternal.PlaybackInfoUpdate playbackInfoUpdate) {
        ...
        if (this.pendingOperationAcks == 0) {
            ...
            if (this.pendingDiscontinuity) {
                ...
                if (z) {
                    jPeriodPositionUsToWindowPositionUs = (timeline.isEmpty() || playbackInfoUpdate.playbackInfo.periodId.isAd()) ? playbackInfoUpdate.playbackInfo.discontinuityStartPositionUs : periodPositionUsToWindowPositionUs(timeline, playbackInfoUpdate.playbackInfo.periodId, playbackInfoUpdate.playbackInfo.discontinuityStartPositionUs);
                }
            } else {
                z = false;
            }
            this.pendingDiscontinuity = false;
            updatePlaybackInfo(playbackInfoUpdate.playbackInfo, 1, this.pendingPlayWhenReadyChangeReason, false, z, this.pendingDiscontinuityReason, jPeriodPositionUsToWindowPositionUs, -1, false);
        }
    }
    ...
    private PlaybackInfo maskTimelineAndPosition(PlaybackInfo playbackInfo, Timeline timeline, Pair<Object, Long> pair) {
        ...
        if (timeline.isEmpty()) {
            ...
            PlaybackInfo playbackInfoCopyWithLoadingMediaPeriodId = playbackInfoCopyWithTimeline.copyWithNewPosition(dummyPeriodForEmptyTimeline, jMsToUs, jMsToUs, jMsToUs, 0L, TrackGroupArray.EMPTY, this.emptyTrackSelectorResult, ImmutableList.m22832of()).copyWithLoadingMediaPeriodId(dummyPeriodForEmptyTimeline);
    ...
    private void removeSurfaceCallbacks() {
        ...
        if (textureView != null) {
            if (textureView.getSurfaceTextureListener() != this.componentListener) {
                Log.m22240w(TAG, "SurfaceTextureListener already unset or replaced.");
            } else {
    ...
    private void updateAvailableCommands() {
        ...
        this.listeners.queueEvent(13, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.ExoPlayerImpl$$ExternalSyntheticLambda20
            @Override // com.google.android.exoplayer2.util.ListenerSet.Event
            public final void invoke(Object obj) {
                this.f$0.m22156xf07a34c4((Player.Listener) obj);
            }
        });
    }
    ...
    private void verifyApplicationThread() {
        ...
        if (Thread.currentThread() != getApplicationLooper().getThread()) {
            ...
            Log.m22241w(TAG, invariant, this.hasNotifiedFullWrongThreadWarning ? null : new IllegalStateException());
    ...
    public long getBufferedPosition() {
        verifyApplicationThread();
        if (isPlayingAd()) {
            return this.playbackInfo.loadingMediaPeriodId.equals(this.playbackInfo.periodId) ? Util.usToMs(this.playbackInfo.bufferedPositionUs) : getDuration();
        }
    ...
    public long getContentPosition() {
        ...
        return this.playbackInfo.requestedContentPositionUs == -9223372036854775807L ? this.playbackInfo.timeline.getWindow(getCurrentMediaItemIndex(), this.window).getDefaultPositionMs() : this.period.getPositionInWindowMs() + Util.usToMs(this.playbackInfo.requestedContentPositionUs);
    }
    ...
    /* synthetic */ void m44134lambda$new$0$comgoogleandroidexoplayer2ExoPlayerImpl(Player.Listener listener, FlagSet flagSet) {
    ...
    /* synthetic */ void m44136lambda$new$2$comgoogleandroidexoplayer2ExoPlayerImpl(final ExoPlayerImplInternal.PlaybackInfoUpdate playbackInfoUpdate) {
        this.playbackInfoUpdateHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.ExoPlayerImpl$$ExternalSyntheticLambda12
            ...
            public final void run() {
                this.f$0.m44135lambda$new$1$comgoogleandroidexoplayer2ExoPlayerImpl(playbackInfoUpdate);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$setPlaylistMetadata$7$com-google-android-exoplayer2-ExoPlayerImpl */
    /* synthetic */ void m22155xadc0e460(Player.Listener listener) {
        listener.onPlaylistMetadataChanged(this.playlistMetadata);
    }

    /* JADX INFO: renamed from: lambda$updateAvailableCommands$26$com-google-android-exoplayer2-ExoPlayerImpl */
    /* synthetic */ void m22156xf07a34c4(Player.Listener listener) {
    ...
    public void release() {
        ...
        Log.m22238i(TAG, "Release " + Integer.toHexString(System.identityHashCode(this)) + " [ExoPlayerLib/2.18.7] [" + Util.DEVICE_DEBUG_INFO + "] [" + ExoPlayerLibraryInfo.registeredModules() + C11744X3.j.f26440e);
        verifyApplicationThread();
    ...
    public void seekTo(int i, long j, int i2, boolean z) {
        ...
        if (timeline.isEmpty() || i < timeline.getWindowCount()) {
            this.pendingOperationAcks++;
            if (isPlayingAd()) {
                Log.m22240w(TAG, "seekTo ignored because an ad is playing");
    ...
    public void setPlaylistMetadata(MediaMetadata mediaMetadata) {
        ...
        this.listeners.sendEvent(15, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.ExoPlayerImpl$$ExternalSyntheticLambda14
            @Override // com.google.android.exoplayer2.util.ListenerSet.Event
            public final void invoke(Object obj) {
                this.f$0.m22155xadc0e460((Player.Listener) obj);
            }
        });
    }
    ...
    public void setVideoTextureView(TextureView textureView) {
        ...
        if (textureView.getSurfaceTextureListener() != null) {
            Log.m22240w(TAG, "Replacing existing SurfaceTextureListener.");
        }
    ...
    public void stop(boolean z) {
        ...
        stopInternal(z, null);
        this.currentCueGroup = new CueGroup(ImmutableList.m22832of(), this.playbackInfo.positionUs);
    }
}
