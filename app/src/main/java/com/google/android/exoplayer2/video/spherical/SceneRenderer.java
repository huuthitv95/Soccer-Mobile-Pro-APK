...
final class SceneRenderer implements VideoFrameMetadataListener, CameraMotionListener {
    ...
    public void drawFrame(float[] fArr, boolean z) {
        ...
        try {
            ...
            Log.m22237e(TAG, "Failed to draw a frame", e);
        }
        if (this.frameAvailable.compareAndSet(true, false)) {
            ...
            try {
                ...
                Log.m22237e(TAG, "Failed to draw a frame", e2);
            }
    ...
    public SurfaceTexture init() {
        try {
            ...
            Log.m22237e(TAG, "Failed to initialize the renderer", e);
        }
        ...
        surfaceTexture.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: com.google.android.exoplayer2.video.spherical.SceneRenderer$$ExternalSyntheticLambda0
            ...
            public final void onFrameAvailable(SurfaceTexture surfaceTexture2) {
                this.f$0.m22257x44e5bf0(surfaceTexture2);
            }
        });
        return this.surfaceTexture;
    }

    /* JADX INFO: renamed from: lambda$init$0$com-google-android-exoplayer2-video-spherical-SceneRenderer */
    /* synthetic */ void m22257x44e5bf0(SurfaceTexture surfaceTexture) {
