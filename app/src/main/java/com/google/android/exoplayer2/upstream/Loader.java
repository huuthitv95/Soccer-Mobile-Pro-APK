    ...
    private final class LoadTask<T extends Loadable> extends Handler implements Runnable {
        ...
        public void handleMessage(Message message) {
            ...
            if (i == 1) {
                try {
                    ...
                    Log.m22237e(TAG, "Unexpected exception handling load completed", e);
        ...
        public void run() {
            ...
            try {
                ...
                Log.m22237e(TAG, "OutOfMemory error loading stream", e2);
                obtainMessage(2, new UnexpectedLoaderException(e2)).sendToTarget();
            } catch (Error e3) {
                if (!this.released) {
                    Log.m22237e(TAG, "Unexpected error loading stream", e3);
                ...
                Log.m22237e(TAG, "Unexpected exception loading stream", e4);
