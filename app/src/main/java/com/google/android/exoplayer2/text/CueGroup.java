...
public final class CueGroup implements Bundleable {
    ...
    public static final CueGroup EMPTY_TIME_ZERO = new CueGroup(ImmutableList.m22832of(), 0);
    ...
    public static final CueGroup fromBundle(Bundle bundle) {
        ...
        return new CueGroup(parcelableArrayList == null ? ImmutableList.m22832of() : BundleableUtil.fromBundleList(Cue.CREATOR, parcelableArrayList), bundle.getLong(FIELD_PRESENTATION_TIME_US));
    }
