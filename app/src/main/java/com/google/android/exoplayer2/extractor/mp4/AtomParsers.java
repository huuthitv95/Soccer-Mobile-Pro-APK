...
final class AtomParsers {
        ...
        public StszSampleSizeBox(Atom.LeafAtom leafAtom, Format format) {
            ...
            if ("audio/raw".equals(format.sampleMimeType)) {
                ...
                if (unsignedIntToInt == 0 || unsignedIntToInt % pcmFrameSize != 0) {
                    Log.m22240w(AtomParsers.TAG, "Audio sample size mismatch. stsd sample size: " + pcmFrameSize + ", stsz sample size: " + unsignedIntToInt);
    ...
    /* JADX WARN: Code duplicated, block: B:150:0x02d0  */
    ...
    /* JADX WARN: Code duplicated, block: B:174:0x02fd A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:175:0x02fd A[SYNTHETIC] */
    ...
    private static void parseAudioSampleEntry(ParsableByteArray parsableByteArray, int i, int i2, int i3, int i4, String str, boolean z, DrmInitData drmInitData, StsdData stsdData, int i5) throws ParserException {
        ...
        if (iIntValue == 1633889587) {
            ...
            if (iIntValue != 1935767394) {
                    ...
                    if (i9 == 1835557187) {
                        ...
                        if (i9 != 1702061171 || (z && i9 == 2002876005)) {
                            ...
                            if (i9 == 1684103987) {
                                ...
                                listM22833of = ImmutableList.m22833of(bArr4);
                ...
                Format.Builder language = new Format.Builder().setId(i4).setSampleMimeType(str4).setCodecs(str5).setChannelCount(unsignedIntToInt).setSampleRate(unsignedFixedPoint1616).setPcmEncoding(i7).setInitializationData(listM22833of).setDrmInitData(drmInitDataCopyWithSchemeType).setLanguage(str);
    ...
    public static Metadata parseMdtaFromMeta(Atom.ContainerAtom containerAtom) {
        ...
        while (parsableByteArray2.bytesLeft() > 8) {
            ...
            if (i5 < 0 || i5 >= i) {
                Log.m22240w(TAG, "Skipped metadata with unknown key index: " + i5);
            } else {
    ...
    private static TrackSampleTable parseStbl(Track track, Atom.ContainerAtom containerAtom, GaplessInfoHolder gaplessInfoHolder) throws ParserException {
        ...
        if (z5) {
            ...
            while (true) {
                ...
                int i20 = i13;
                if (!zMoveNext) {
                    Log.m22240w(TAG, "Unexpected end of chunk data");
        ...
        if (track.editListDurations.length == 1 && track.type == 1 && jArrCopyOf.length >= 2) {
            ...
            jArrCopyOf = jArr7;
            if (canApplyEditWithGaplessInfo(jArr7, j8, j9, jScaleLargeTimestamp2)) {
        ...
        if (track.editListDurations.length == 1 && track.editListDurations[z2 ? 1 : 0] == j) {
            ...
            for (int i22 = z2 ? 1 : 0; i22 < jArrCopyOf.length; i22++) {
                jArrCopyOf[i22] = Util.scaleLargeTimestamp(jArrCopyOf[i22] - j10, 1000000L, track.timescale);
            }
            return new TrackSampleTable(track, jArr, iArr3, i3 == true ? 1 : 0, jArrCopyOf, iArr2, Util.scaleLargeTimestamp(j8 - j10, 1000000L, track.timescale));
        }
        ...
        while (i23 < track.editListDurations.length) {
            ...
            int i26 = i3;
            if (j11 != -1) {
                long j12 = track.editListDurations[i23];
                int i27 = i23;
                boolean z10 = z9 ? 1 : 0;
                long jScaleLargeTimestamp5 = Util.scaleLargeTimestamp(j12, track.timescale, track.movieTimescale);
                i4 = i27 == true ? 1 : 0;
                iArr12[i4 == true ? 1 : 0] = Util.binarySearchFloor(jArrCopyOf, j11, true, true);
                long j13 = j11 + jScaleLargeTimestamp5;
                z4 = z2;
                iArr13[i4 == true ? 1 : 0] = Util.binarySearchCeil(jArrCopyOf, j13, z7, z4);
                while (true) {
        ...
        while (r11 < track.editListDurations.length) {
            ...
            while (i29 < i30) {
                ...
                long j16 = j;
                jArr10[r8] = Util.scaleLargeTimestamp(j14, 1000000L, track.movieTimescale) + Util.scaleLargeTimestamp(Math.max(j16, jArrCopyOf[i29] - j15), 1000000L, track.timescale);
        ...
        return new TrackSampleTable(track, jArr9, iArr4, r12 == true ? 1 : 0, jArr10, iArr5, Util.scaleLargeTimestamp(j14, 1000000L, track.movieTimescale));
    }
    ...
    private static Track parseTrak(Atom.ContainerAtom containerAtom, Atom.LeafAtom leafAtom, long j, DrmInitData drmInitData, boolean z, boolean z2) throws ParserException {
        ...
        StsdData stsd = parseStsd(leafAtomOfType.data, tkhd.f21851id, tkhd.rotationDegrees, (String) mdhd.second, drmInitData, z2);
        ...
        return new Track(tkhd.f21851id, trackTypeForHdlr, ((Long) mdhd.first).longValue(), mvhd, jScaleLargeTimestamp, stsd.format, stsd.requiredSampleTransformation, stsd.trackEncryptionBoxes, stsd.nalUnitLengthFieldLength, jArr, jArr2);
    }
    ...
    private static void parseVideoSampleEntry(ParsableByteArray parsableByteArray, int i, int i2, int i3, int i4, int i5, DrmInitData drmInitData, StsdData stsdData, int i6) throws ParserException {
        ...
        while (position - i11 < i12) {
            ...
            if (i15 == 0 && parsableByteArray.getPosition() - i2 == i12) {
                break;
            }
            ...
            if (i16 == 1635148611) {
                ...
                listM22833of = avcConfig.initializationData;
                ...
                if (i16 == 1752589123) {
                    ...
                    listM22833of = hevcConfig.initializationData;
                    ...
                    int i17 = hevcConfig.colorSpace;
                    int i18 = hevcConfig.colorRange;
                        ...
                        if (i16 == 1987076931) {
                            ...
                            if (i16 == 1635135811) {
                                ...
                                if (i16 == 1681012275) {
                                    ...
                                    listM22833of = bArr != null ? ImmutableList.m22833of(bArr) : list;
                                    str = str5;
                                    paspFromParent = f;
                                        ...
                                        if (i8 == -1) {
                                            ...
                                            if (i9 == -1 && i10 == -1) {
                                                ...
                                                if (i19 == TYPE_nclx || i19 == TYPE_nclc) {
                                                    ...
                                                    Log.m22240w(TAG, "Unsupported color type: " + Atom.getAtomTypeString(i19));
                                                }
                                            }
                                        }
                                    } else {
        ...
        Format.Builder drmInitData3 = new Format.Builder().setId(i4).setSampleMimeType(str).setCodecs(str4).setWidth(unsignedShort).setHeight(unsignedShort2).setPixelWidthHeightRatio(f2).setRotationDegrees(i5).setProjectionData(projFromParent).setStereoMode(i13).setInitializationData(list3).setDrmInitData(drmInitData2);
