...
public class EventLogger implements AnalyticsListener {
    ...
    private String getEventString(AnalyticsListener.EventTime eventTime, String str, String str2, Throwable th) {
        ...
        return str3 + C11744X3.j.f26440e;
    }
    ...
    protected void logd(String str) {
        Log.m22234d(this.tag, str);
    }

    protected void loge(String str) {
        Log.m22236e(this.tag, str);
    }
    ...
    public void onMediaItemTransition(AnalyticsListener.EventTime eventTime, MediaItem mediaItem, int i) {
        logd("mediaItem [" + getEventTimeString(eventTime) + ", reason=" + getMediaItemTransitionReasonString(i) + C11744X3.j.f26440e);
    }
    ...
    public void onTimelineChanged(AnalyticsListener.EventTime eventTime, int i) {
        ...
        for (int i2 = 0; i2 < Math.min(periodCount, 3); i2++) {
            ...
            logd("  period [" + getTimeString(this.period.getDurationMs()) + C11744X3.j.f26440e);
        }
        if (periodCount > 3) {
            logd("  ...");
        }
        for (int i3 = 0; i3 < Math.min(windowCount, 3); i3++) {
            ...
            logd("  window [" + getTimeString(this.window.getDurationMs()) + ", seekable=" + this.window.isSeekable + ", dynamic=" + this.window.isDynamic + C11744X3.j.f26440e);
        }
        if (windowCount > 3) {
            logd("  ...");
        }
