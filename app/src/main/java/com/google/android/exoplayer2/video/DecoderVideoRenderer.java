...
public abstract class DecoderVideoRenderer extends BaseRenderer {
    ...
    private void maybeInitDecoder() throws ExoPlaybackException {
        ...
        try {
            ...
            Log.m22237e(TAG, "Video codec error", e);
    ...
    protected void onInputFormatChanged(FormatHolder formatHolder) throws ExoPlaybackException {
        ...
        DecoderReuseEvaluation decoderReuseEvaluation = this.sourceDrmSession != this.decoderDrmSession ? new DecoderReuseEvaluation(this.decoder.getName(), format2, format, 0, 128) : canReuseDecoder(decoder.getName(), format2, format);
