...
public final class TextInformationFrame extends Id3Frame {
    ...
    public TextInformationFrame(String str, String str2, String str3) {
        this(str, str2, ImmutableList.m22833of(str3));
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            if (Util.areEqual(this.f21860id, textInformationFrame.f21860id) && Util.areEqual(this.description, textInformationFrame.description) && this.values.equals(textInformationFrame.values)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        int iHashCode = (IronSourceError.ERROR_NON_EXISTENT_INSTANCE + this.f21860id.hashCode()) * 31;
    ...
    public String toString() {
        return this.f21860id + ": description=" + this.description + ": values=" + this.values;
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f21860id);
