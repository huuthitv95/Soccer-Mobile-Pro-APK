...
public final class DownloadHelper {
    ...
    public void onMediaPreparationFailed(final IOException iOException) {
        ((Handler) Assertions.checkNotNull(this.callbackHandler)).post(new Runnable() { // from class: com.google.android.exoplayer2.offline.DownloadHelper$$ExternalSyntheticLambda1
            ...
            public final void run() {
                this.f$0.m22208xa7571479(iOException);
            }
        });
    }
    ...
    /* JADX INFO: renamed from: lambda$onMediaPreparationFailed$5$com-google-android-exoplayer2-offline-DownloadHelper */
    /* synthetic */ void m22208xa7571479(IOException iOException) {
        ((Callback) Assertions.checkNotNull(this.callback)).onPrepareError(this, iOException);
    }

    /* JADX INFO: renamed from: lambda$onMediaPrepared$4$com-google-android-exoplayer2-offline-DownloadHelper */
    /* synthetic */ void m22209xbc158121() {
        ((Callback) Assertions.checkNotNull(this.callback)).onPrepared(this);
    }

    /* JADX INFO: renamed from: lambda$prepare$3$com-google-android-exoplayer2-offline-DownloadHelper */
    /* synthetic */ void m22210xf9781d7d(Callback callback) {
    ...
    public void prepare(final Callback callback) {
        ...
        if (this.mediaSource != null) {
            ...
            this.callbackHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.offline.DownloadHelper$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m22210xf9781d7d(callback);
                }
            });
        }
    }
