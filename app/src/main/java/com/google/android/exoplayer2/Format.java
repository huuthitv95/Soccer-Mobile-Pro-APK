...
public final class Format implements Bundleable {
    ...
    public static final class Builder {
        ...
        public Builder setId(int i) {
            this.f21844id = Integer.toString(i);
            return this;
        }
    ...
    private Format(Builder builder) {
        this.f21843id = builder.f21844id;
    ...
    public static String toLogString(Format format) {
        ...
        if (format.drmInitData != null) {
            ...
            for (int i = 0; i < format.drmInitData.schemeDataCount; i++) {
                ...
                if (uuid.equals(C9415C.COMMON_PSSH_UUID)) {
                    linkedHashSet.add("cenc");
                } else if (uuid.equals(C9415C.CLEARKEY_UUID)) {
                    linkedHashSet.add("clearkey");
                } else if (uuid.equals(C9415C.PLAYREADY_UUID)) {
                    linkedHashSet.add("playready");
                } else if (uuid.equals(C9415C.WIDEVINE_UUID)) {
                    linkedHashSet.add("widevine");
                } else if (uuid.equals(C9415C.UUID_NIL)) {
        ...
        if (format.selectionFlags != 0) {
            ...
            Joiner.m22803on(AbstractJsonLexerKt.COMMA).appendTo(sb, (Iterable<? extends Object>) arrayList);
            sb.append(C11744X3.j.f26440e);
        }
        if (format.roleFlags != 0) {
            ArrayList arrayList2 = new ArrayList();
            if ((format.roleFlags & 1) != 0) {
                arrayList2.add(C11744X3.i.f26354Z);
            }
            ...
            sb.append(", roleFlags=[");
            Joiner.m22803on(AbstractJsonLexerKt.COMMA).appendTo(sb, (Iterable<? extends Object>) arrayList2);
            sb.append(C11744X3.j.f26440e);
        }
        return sb.toString();
    }
    ...
    public Bundle toBundle(boolean z) {
        ...
        bundle.putString(FIELD_ID, this.f21843id);
    ...
    public String toString() {
        return "Format(" + this.f21843id + ", " + this.label + ", " + this.containerMimeType + ", " + this.sampleMimeType + ", " + this.codecs + ", " + this.bitrate + ", " + this.language + ", [" + this.width + ", " + this.height + ", " + this.frameRate + "], [" + this.channelCount + ", " + this.sampleRate + "])";
    }
