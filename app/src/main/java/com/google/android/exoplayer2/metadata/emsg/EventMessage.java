...
public final class EventMessage implements Metadata.Entry {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            if (this.durationMs == eventMessage.durationMs && this.f21854id == eventMessage.f21854id && Util.areEqual(this.schemeIdUri, eventMessage.schemeIdUri) && Util.areEqual(this.value, eventMessage.value) && Arrays.equals(this.messageData, eventMessage.messageData)) {
                return true;
            }
        }
        return false;
    ...
    public String toString() {
        return "EMSG: scheme=" + this.schemeIdUri + ", id=" + this.f21854id + ", durationMs=" + this.durationMs + ", value=" + this.value;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeLong(this.f21854id);
