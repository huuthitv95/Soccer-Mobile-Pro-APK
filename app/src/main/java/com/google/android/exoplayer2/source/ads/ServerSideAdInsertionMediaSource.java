...
public final class ServerSideAdInsertionMediaSource extends BaseMediaSource implements MediaSource.MediaSourceCaller, MediaSourceEventListener, DrmSessionEventListener {
    ...
    private ImmutableMap<Object, AdPlaybackState> adPlaybackStates = ImmutableMap.m22851of();
    ...
    private static final class ServerSideAdInsertionTimeline extends ForwardingTimeline {
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            period.set(period.f21849id, period.uid, period.windowIndex, mediaPeriodPositionUsForContent, mediaPeriodPositionUsForContent2, adPlaybackState, period.isPlaceholder);
            return period;
        }
            ...
            while (true) {
                ...
                if (exoTrackSelection != null) {
                    ...
                    for (int i2 = 0; i2 < trackGroup.length; i2++) {
                        ...
                        if (format.equals(mediaLoadData.trackFormat) || (z && format.f21843id != null && format.f21843id.equals(mediaLoadData.trackFormat.f21843id))) {
                            return i;
                        }
                    }
                }
    ...
    /* JADX INFO: renamed from: lambda$setAdPlaybackStates$0$com-google-android-exoplayer2-source-ads-ServerSideAdInsertionMediaSource */
    /* synthetic */ void m22230x4663d317(ImmutableMap immutableMap) {
            ...
            if (handler == null) {
                ...
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.ServerSideAdInsertionMediaSource$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        this.f$0.m22230x4663d317(immutableMap);
                    }
                });
            }
        }
