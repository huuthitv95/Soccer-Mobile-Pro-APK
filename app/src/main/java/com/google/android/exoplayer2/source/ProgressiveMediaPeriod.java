...
final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    private static final class TrackId {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null && getClass() == obj.getClass()) {
                ...
                if (this.f21868id == trackId.f21868id && this.isIcyTrack == trackId.isIcyTrack) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            return (this.f21868id * 31) + (this.isIcyTrack ? 1 : 0);
        }
    }
    ...
    public void m22224x7713ecca(SeekMap seekMap) {
    ...
    /* JADX INFO: renamed from: lambda$new$0$com-google-android-exoplayer2-source-ProgressiveMediaPeriod */
    /* synthetic */ void m22222x3e939aa5() {
        if (this.released) {
            return;
        }
        ((MediaPeriod.Callback) Assertions.checkNotNull(this.callback)).onContinueLoadingRequested(this);
    ...
    /* JADX INFO: renamed from: lambda$onLengthKnown$2$com-google-android-exoplayer2-source-ProgressiveMediaPeriod */
    /* synthetic */ void m22223x6a384a65() {
    ...
    public void seekMap(final SeekMap seekMap) {
        this.handler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ProgressiveMediaPeriod$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m22224x7713ecca(seekMap);
            }
        });
    }
