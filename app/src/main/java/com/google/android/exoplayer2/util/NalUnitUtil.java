...
public final class NalUnitUtil {
    ...
    public static H265SpsData parseH265SpsNalUnitPayload(byte[] bArr, int i, int i2) {
        ...
        if (parsableNalUnitBitArray.readBit()) {
            if (parsableNalUnitBitArray.readBit()) {
                ...
                if (bits5 == 255) {
                    ...
                    if (bits5 < fArr.length) {
                        ...
                        Log.m22240w(TAG, "Unexpected aspect_ratio_idc value: " + bits5);
                    }
                }
            }
            if (parsableNalUnitBitArray.readBit()) {
            ...
            if (parsableNalUnitBitArray.readBit()) {
                ...
                if (parsableNalUnitBitArray.readBit()) {
                    ...
                    i14 = iIsoColorPrimariesToColorSpace;
                } else {
        ...
        return new H265SpsData(bits2, bit, bits3, i7, iArr, bits4, unsignedExpGolombCodedInt, unsignedExpGolombCodedInt3, i4, f, i3, i14, i5);
    }
