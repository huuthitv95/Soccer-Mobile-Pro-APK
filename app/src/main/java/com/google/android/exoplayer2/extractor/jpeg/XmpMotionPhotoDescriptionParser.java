...
final class XmpMotionPhotoDescriptionParser {
    ...
    public static MotionPhotoDescription parse(String str) throws IOException {
        try {
            ...
            Log.m22240w(TAG, "Ignoring unexpected XMP metadata");
            return null;
        }
    }
    ...
    private static MotionPhotoDescription parseInternal(String str) throws XmlPullParserException, IOException {
        ...
        ImmutableList<MotionPhotoDescription.ContainerItem> immutableListM22832of = ImmutableList.m22832of();
        ...
        do {
            ...
            if (XmlPullParserUtil.isStartTag(xmlPullParserNewPullParser, "rdf:Description")) {
                ...
                immutableListM22832of = parseMicroVideoOffsetFromDescription(xmlPullParserNewPullParser);
            } else if (XmlPullParserUtil.isStartTag(xmlPullParserNewPullParser, "Container:Directory")) {
                immutableListM22832of = parseMotionPhotoV1Directory(xmlPullParserNewPullParser, "Container", "Item");
            } else if (XmlPullParserUtil.isStartTag(xmlPullParserNewPullParser, "GContainer:Directory")) {
                immutableListM22832of = parseMotionPhotoV1Directory(xmlPullParserNewPullParser, "GContainer", "GContainerItem");
            }
        } while (!XmlPullParserUtil.isEndTag(xmlPullParserNewPullParser, "x:xmpmeta"));
        if (immutableListM22832of.isEmpty()) {
            return null;
        }
        return new MotionPhotoDescription(motionPhotoPresentationTimestampUsFromDescription, immutableListM22832of);
    }
    ...
    private static ImmutableList<MotionPhotoDescription.ContainerItem> parseMicroVideoOffsetFromDescription(XmlPullParser xmlPullParser) {
        for (String str : DESCRIPTION_MICRO_VIDEO_OFFSET_ATTRIBUTE_NAMES) {
            ...
            if (attributeValue != null) {
                return ImmutableList.m22834of(new MotionPhotoDescription.ContainerItem("image/jpeg", "Primary", 0L, 0L), new MotionPhotoDescription.ContainerItem("video/mp4", "MotionPhoto", Long.parseLong(attributeValue), 0L));
            }
        }
