...
public final class Tracks implements Bundleable {
    ...
    public static final Tracks EMPTY = new Tracks(ImmutableList.m22832of());
    ...
    static /* synthetic */ Tracks lambda$static$0(Bundle bundle) {
        ...
        return new Tracks(parcelableArrayList == null ? ImmutableList.m22832of() : BundleableUtil.fromBundleList(Group.CREATOR, parcelableArrayList));
    }
