...
public class UnityMediationBannerAd implements MediationBannerAd, BannerView.IListener {
    ...
    public UnityMediationBannerAd(MediationAdLoadCallback<MediationBannerAd, MediationBannerAdCallback> mediationAdLoadCallback, UnityInitializer unityInitializer, UnityBannerViewFactory unityBannerViewFactory, UnityAdsLoader unityAdsLoader) {
    ...
    public void loadAd(final MediationBannerAdConfiguration mediationBannerAdConfiguration, MediationUtilsWrapper mediationUtilsWrapper) {
        ...
        final UnityBannerSize unityBannerSize = UnityAdsAdapterUtils.getUnityBannerSize(context, adSize, !TextUtils.isEmpty(bidResponse), mediationUtilsWrapper);
        if (unityBannerSize != null) {
            this.unityInitializer.initializeUnityAds(context, this.gameId, new IUnityAdsInitializationListener() { // from class: com.google.ads.mediation.unity.UnityMediationBannerAd.1
                ...
                public void onInitializationComplete() {
                    ...
                    unityAdsLoadOptionsCreateUnityAdsLoadOptionsWithId.set(MBridgeConstans.EXTRA_KEY_WM, mediationBannerAdConfiguration.getWatermark());
