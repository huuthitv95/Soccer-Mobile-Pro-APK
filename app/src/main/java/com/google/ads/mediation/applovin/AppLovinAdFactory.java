...
public class AppLovinAdFactory {
    AppLovinAdViewWrapper createAdView(AppLovinSdk appLovinSdk, AppLovinAdSize appLovinAdSize, AdSize adSize, Context context) {
    ...
    MaxAppOpenAd createMaxAppOpenAd(String str) {
