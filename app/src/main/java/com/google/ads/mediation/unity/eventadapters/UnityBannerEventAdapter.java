...
public class UnityBannerEventAdapter implements IUnityEventAdapter {
    ...
    static /* synthetic */ class C93791 {

        /* JADX INFO: renamed from: $SwitchMap$com$google$ads$mediation$unity$UnityAdsAdapterUtils$AdEvent */
        static final /* synthetic */ int[] f21837x92ee1947;

        static {
            int[] iArr = new int[UnityAdsAdapterUtils.AdEvent.values().length];
            f21837x92ee1947 = iArr;
            try {
                iArr[UnityAdsAdapterUtils.AdEvent.LOADED.ordinal()] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                f21837x92ee1947[UnityAdsAdapterUtils.AdEvent.OPENED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f21837x92ee1947[UnityAdsAdapterUtils.AdEvent.CLICKED.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f21837x92ee1947[UnityAdsAdapterUtils.AdEvent.CLOSED.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f21837x92ee1947[UnityAdsAdapterUtils.AdEvent.LEFT_APPLICATION.ordinal()] = 5;
    ...
    public void sendAdEvent(UnityAdsAdapterUtils.AdEvent adEvent) {
        ...
        int i = C93791.f21837x92ee1947[adEvent.ordinal()];
        if (i == 1) {
