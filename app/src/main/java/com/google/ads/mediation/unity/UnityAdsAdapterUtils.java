...
public class UnityAdsAdapterUtils {
    ...
    static int getMediationErrorCode(UnityAds.UnityAdsInitializationError unityAdsInitializationError) {
        int i = C93731.$SwitchMap$com$unity3d$ads$UnityAds$UnityAdsInitializationError[unityAdsInitializationError.ordinal()];
        if (i == 1) {
            return 301;
        }
        if (i != 2) {
    ...
    static int getMediationErrorCode(UnityAds.UnityAdsLoadError unityAdsLoadError) {
        int i = C93731.$SwitchMap$com$unity3d$ads$UnityAds$UnityAdsLoadError[unityAdsLoadError.ordinal()];
        if (i == 1) {
            return 401;
        }
        if (i == 2) {
    ...
    static int getMediationErrorCode(UnityAds.UnityAdsShowError unityAdsShowError) {
        switch (C93731.$SwitchMap$com$unity3d$ads$UnityAds$UnityAdsShowError[unityAdsShowError.ordinal()]) {
            case 1:
                return 501;
            case 2:
                return 502;
    ...
    static int getMediationErrorCode(BannerErrorInfo bannerErrorInfo) {
        int i = C93731.$SwitchMap$com$unity3d$services$banners$BannerErrorCode[bannerErrorInfo.errorCode.ordinal()];
        if (i == 1) {
            return 201;
        }
        if (i == 2) {
    ...
    public static UnityBannerSize getUnityBannerSize(Context context, AdSize adSize, boolean z, MediationUtilsWrapper mediationUtilsWrapper) {
        ArrayList arrayList = new ArrayList();
        arrayList.add(AdSize.BANNER);
        arrayList.add(AdSize.LEADERBOARD);
        AdSize adSizeFindClosestSize = mediationUtilsWrapper.findClosestSize(context, adSize, arrayList);
    ...
    public static void setUnityAdsPrivacy(RequestConfiguration requestConfiguration, MetaData metaData) {
    ...
    private static boolean shouldTreatAsAdult(RequestConfiguration requestConfiguration) {
        ...
        return tagForChildDirectedTreatment == 0 || tagForUnderAgeOfConsent == 0;
    }
}
