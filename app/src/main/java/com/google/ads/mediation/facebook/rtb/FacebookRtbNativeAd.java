...
public class FacebookRtbNativeAd extends UnifiedNativeAdMapper {
    ...
    private class NativeListener implements AdListener, NativeAdListener {
        ...
        public void onAdLoaded(InterfaceC4297Ad interfaceC4297Ad) {
            if (interfaceC4297Ad != this.nativeAd) {
        ...
        @Override // com.facebook.ads.AdListener
        public void onError(InterfaceC4297Ad interfaceC4297Ad, com.facebook.ads.AdError adError) {
        ...
        public void onMediaDownloaded(InterfaceC4297Ad interfaceC4297Ad) {
            Log.d(FacebookMediationAdapter.TAG, "onMediaDownloaded");
        }
    }

    public FacebookRtbNativeAd(MediationAdLoadCallback<UnifiedNativeAdMapper, MediationNativeAdCallback> mediationAdLoadCallback, MetaFactory metaFactory) {
