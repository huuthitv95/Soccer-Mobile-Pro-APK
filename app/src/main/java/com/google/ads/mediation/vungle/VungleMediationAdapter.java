...
public class VungleMediationAdapter extends RtbAdapter implements MediationRewardedAd, RewardedAdListener {
    ...
    public void collectSignals(RtbSignalData rtbSignalData, final SignalCallbacks signalCallbacks) {
        VungleSdkWrapper.delegate.getBiddingToken(rtbSignalData.getContext(), new BidTokenCallback() { // from class: com.google.ads.mediation.vungle.VungleMediationAdapter.1
    ...
    public void initialize(Context context, final InitializationCompleteCallback initializationCompleteCallback, List<MediationConfiguration> list) {
        ...
        if (size > 0) {
            ...
            VungleInitializer.getInstance().initialize(str, context, new VungleInitializer.VungleInitializationListener() { // from class: com.google.ads.mediation.vungle.VungleMediationAdapter.2
    ...
    public void loadRewardedAd(MediationRewardedAdConfiguration mediationRewardedAdConfiguration, MediationAdLoadCallback<MediationRewardedAd, MediationRewardedAdCallback> mediationAdLoadCallback) {
        ...
        VungleInitializer.getInstance().initialize(string, context, new VungleInitializer.VungleInitializationListener() { // from class: com.google.ads.mediation.vungle.VungleMediationAdapter.3
            @Override // com.google.ads.mediation.vungle.VungleInitializer.VungleInitializationListener
