...
class StandardNetwork<N, E> extends AbstractNetwork<N, E> {
    ...
    StandardNetwork(NetworkBuilder<? super N, ? super E> builder) {
        this(builder, builder.nodeOrder.createMap(builder.expectedNodeCount.mo22799or(10).intValue()), builder.edgeOrder.createMap(builder.expectedEdgeCount.mo22799or(20).intValue()));
    }
    ...
    public EndpointPair<N> incidentNodes(E edge) {
        ...
        return EndpointPair.m22948of(this, nCheckedReferenceNode, ((NetworkConnections) Objects.requireNonNull(this.nodeConnections.get(nCheckedReferenceNode))).adjacentNode(edge));
    }
