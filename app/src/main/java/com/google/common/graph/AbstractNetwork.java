...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
    ...
    class C104221 extends AbstractGraph<N> {
        C104221() {
        }
        ...
        class AnonymousClass1 extends AbstractSet<EndpointPair<N>> {
            ...
            public Iterator<EndpointPair<N>> iterator() {
                return Iterators.transform(AbstractNetwork.this.edges().iterator(), new Function() { // from class: com.google.common.graph.AbstractNetwork$1$1$$ExternalSyntheticLambda0
                    ...
                    public final Object apply(Object obj) {
                        return this.f$0.m44171lambda$iterator$0$comgooglecommongraphAbstractNetwork$1$1(obj);
                    }
                });
            }

            /* JADX INFO: renamed from: lambda$iterator$0$com-google-common-graph-AbstractNetwork$1$1, reason: not valid java name */
            /* synthetic */ EndpointPair m44171lambda$iterator$0$comgooglecommongraphAbstractNetwork$1$1(Object obj) {
            ...
            public boolean contains(@CheckForNull Object obj) {
                ...
                return C104221.this.isOrderingCompatible(endpointPair) && C104221.this.nodes().contains(endpointPair.nodeU()) && C104221.this.successors(endpointPair.nodeU()).contains(endpointPair.nodeV());
            }
        }
    ...
    public Set<E> adjacentEdges(E edge) {
        ...
        return Sets.difference(Sets.union(incidentEdges(endpointPairIncidentNodes.nodeU()), incidentEdges(endpointPairIncidentNodes.nodeV())), ImmutableSet.m22880of((Object) edge));
    }
