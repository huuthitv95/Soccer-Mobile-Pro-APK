...
final class DirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    static /* synthetic */ class C104295 {
    ...
    static <N, V> DirectedGraphConnections<N, V> m22944of(ElementOrder<N> incidentEdgeOrder) {
        ArrayList arrayList;
        int i = C104295.$SwitchMap$com$google$common$graph$ElementOrder$Type[incidentEdgeOrder.type().ordinal()];
        if (i == 1) {
            arrayList = null;
        } else if (i == 2) {
