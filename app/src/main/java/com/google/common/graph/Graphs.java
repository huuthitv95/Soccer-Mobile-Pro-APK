...
public final class Graphs {
    ...
    static class TransposedGraph<N> extends ForwardingGraph<N> {
        ...
        class C104341 extends IncidentEdgeSet<N> {
            C104341(BaseGraph graph, Object node) {
                super(graph, node);
            }
            ...
            public Iterator<EndpointPair<N>> iterator() {
                return Iterators.transform(TransposedGraph.this.delegate().incidentEdges(this.node).iterator(), new Function() { // from class: com.google.common.graph.Graphs$TransposedGraph$1$$ExternalSyntheticLambda0
                    ...
                    public final Object apply(Object obj) {
                        return this.f$0.m22950x5749e417((EndpointPair) obj);
                    }
                });
            }

            /* JADX INFO: renamed from: lambda$iterator$0$com-google-common-graph-Graphs$TransposedGraph$1 */
            /* synthetic */ EndpointPair m22950x5749e417(EndpointPair endpointPair) {
                return EndpointPair.m22947of((Graph<?>) TransposedGraph.this.delegate(), endpointPair.nodeV(), endpointPair.nodeU());
            }
        }

        @Override // com.google.common.graph.ForwardingGraph, com.google.common.graph.AbstractGraph, com.google.common.graph.AbstractBaseGraph, com.google.common.graph.BaseGraph
        public Set<EndpointPair<N>> incidentEdges(N node) {
            return new C104341(this, node);
        }
    ...
    private static class TransposedNetwork<N, E> extends ForwardingNetwork<N, E> {
        ...
        public EndpointPair<N> incidentNodes(E edge) {
            ...
            return EndpointPair.m22948of((Network<?, ?>) this.network, (Object) endpointPairIncidentNodes.nodeV(), (Object) endpointPairIncidentNodes.nodeU());
        }
