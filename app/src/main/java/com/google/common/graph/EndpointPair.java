...
public abstract class EndpointPair<N> implements Iterable<N> {
    ...
    static <N> EndpointPair<N> m22947of(Graph<?> graph, N nodeU, N nodeV) {
        return graph.isDirected() ? ordered(nodeU, nodeV) : unordered(nodeU, nodeV);
    }

    /* JADX INFO: renamed from: of */
    static <N> EndpointPair<N> m22948of(Network<?, ?> network, N nodeU, N nodeV) {
    ...
    private static final class Unordered<N> extends EndpointPair<N> {
        ...
        public String toString() {
            return C11744X3.j.f26438d + nodeU() + ", " + nodeV() + C11744X3.j.f26440e;
        }
    }
}
