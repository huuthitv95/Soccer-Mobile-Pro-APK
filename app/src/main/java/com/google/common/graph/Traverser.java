...
public abstract class Traverser<N> {
    ...
    public final Iterable<N> breadthFirst(N startNode) {
        return breadthFirst((Iterable) ImmutableSet.m22880of(startNode));
    }
    ...
    public final Iterable<N> depthFirstPreOrder(N startNode) {
        return depthFirstPreOrder((Iterable) ImmutableSet.m22880of(startNode));
    }
    ...
    public final Iterable<N> depthFirstPostOrder(N startNode) {
        return depthFirstPostOrder((Iterable) ImmutableSet.m22880of(startNode));
    }
