...
final class UndirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    static /* synthetic */ class C104491 {
    ...
    static <N, V> UndirectedGraphConnections<N, V> m22951of(ElementOrder<N> incidentEdgeOrder) {
        int i = C104491.$SwitchMap$com$google$common$graph$ElementOrder$Type[incidentEdgeOrder.type().ordinal()];
        if (i == 1) {
