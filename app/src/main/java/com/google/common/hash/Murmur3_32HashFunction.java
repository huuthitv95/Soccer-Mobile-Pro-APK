...
final class Murmur3_32HashFunction extends AbstractHashFunction implements Serializable {
    ...
    private static final int f22543C1 = -862048943;

    /* JADX INFO: renamed from: C2 */
    private static final int f22544C2 = 461845907;
    ...
    public static int mixK1(int k1) {
        return Integer.rotateLeft(k1 * f22543C1, 15) * f22544C2;
    }
    ...
    private static final class Murmur3_32Hasher extends AbstractHasher {
        ...
        private void update(int nBytes, long update) {
            ...
            this.length += nBytes;
            if (i2 >= 32) {
                this.f22545h1 = Murmur3_32HashFunction.mixH1(this.f22545h1, Murmur3_32HashFunction.mixK1((int) j2));
                this.buffer >>>= 32;
                this.shift -= 32;
            }
        }
        ...
        public HashCode hash() {
            ...
            this.isDone = true;
            int iMixK1 = this.f22545h1 ^ Murmur3_32HashFunction.mixK1((int) this.buffer);
            this.f22545h1 = iMixK1;
