...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static final long f22532K0 = -4348849565147123417L;

    /* JADX INFO: renamed from: K1 */
    private static final long f22533K1 = -5435081209227447693L;

    /* JADX INFO: renamed from: K2 */
    private static final long f22534K2 = -7286425919675154353L;
    ...
    private static long hashLength0to16(byte[] bytes, int offset, int length) {
        if (length >= 8) {
            long j = (((long) length) * 2) + f22534K2;
            long jLoad64 = LittleEndianByteArray.load64(bytes, offset) + f22534K2;
        ...
        if (length >= 4) {
            return hashLength16(((long) length) + ((((long) LittleEndianByteArray.load32(bytes, offset)) & 4294967295L) << 3), ((long) LittleEndianByteArray.load32(bytes, (offset + length) - 4)) & 4294967295L, ((long) (length * 2)) + f22534K2);
        }
        if (length <= 0) {
            return f22534K2;
        }
        return shiftMix((((long) ((bytes[offset] & 255) + ((bytes[(length >> 1) + offset] & 255) << 8))) * f22534K2) ^ (((long) (length + ((bytes[offset + (length - 1)] & 255) << 2))) * f22532K0)) * f22534K2;
    }

    private static long hashLength17to32(byte[] bytes, int offset, int length) {
        long j = (((long) length) * 2) + f22534K2;
        long jLoad64 = LittleEndianByteArray.load64(bytes, offset) * f22533K1;
        long jLoad65 = LittleEndianByteArray.load64(bytes, offset + 8);
        int i = offset + length;
        long jLoad66 = LittleEndianByteArray.load64(bytes, i - 8) * j;
        return hashLength16(Long.rotateRight(jLoad64 + jLoad65, 43) + Long.rotateRight(jLoad66, 30) + (LittleEndianByteArray.load64(bytes, i - 16) * f22534K2), jLoad66 + jLoad64 + Long.rotateRight(jLoad65 + f22534K2, 18), j);
    }
    ...
    private static long hashLength33To64(byte[] bytes, int offset, int length) {
        ...
        int i = offset + length;
        long jLoad66 = LittleEndianByteArray.load64(bytes, i - 8) * j;
        long jRotateRight = Long.rotateRight(jLoad64 + jLoad65, 43) + Long.rotateRight(jLoad66, 30) + (LittleEndianByteArray.load64(bytes, i - 16) * f22534K2);
        long jHashLength16 = hashLength16(jRotateRight, jLoad66 + Long.rotateRight(jLoad65 + f22534K2, 18) + jLoad64, j);
    ...
    private static long hashLength65Plus(byte[] bytes, int offset, int length) {
        long j = 81;
        long j2 = f22533K1;
        long j3 = (j * f22533K1) + 113;
        long jShiftMix = shiftMix((j3 * f22534K2) + 113) * f22534K2;
        ...
        int i5 = i4 - 63;
        long j4 = j3;
        long jLoad64 = (j * f22534K2) + LittleEndianByteArray.load64(bytes, offset);
        int i6 = offset;
        while (true) {
            long j5 = j2;
            ...
            if (i6 == i2) {
                ...
                return hashLength16(hashLength16(jArr3[0], jArr2[0], j7) + (shiftMix(jLoad66) * f22532K0) + j10, hashLength16(jArr3[c2], jArr2[c2], j7) + jRotateRight6, j7);
            }
