...
public abstract class ByteSource {
    ...
    class AsCharSource extends CharSource {
        ...
        @Override // com.google.common.p284io.CharSource
    ...
    private final class SlicedByteSource extends ByteSource {
        ...
        @Override // com.google.common.p284io.ByteSource
        ...
        public Optional<Long> sizeIfKnown() {
            ...
            if (optionalSizeIfKnown.isPresent()) {
                ...
                return Optional.m22805of(Long.valueOf(Math.min(this.length, jLongValue - Math.min(this.offset, jLongValue))));
            }
            return Optional.absent();
        }
    ...
    private static class ByteArrayByteSource extends ByteSource {
        ...
        @Override // com.google.common.p284io.ByteSource
        public Optional<Long> sizeIfKnown() {
            return Optional.m22805of(Long.valueOf(this.length));
        }
    ...
    private static final class EmptyByteSource extends ByteArrayByteSource {
        ...
        @Override // com.google.common.io.ByteSource.ByteArrayByteSource, com.google.common.p284io.ByteSource
        public byte[] read() {
            return this.bytes;
        }
    ...
    private static final class ConcatenatedByteSource extends ByteSource {
        ...
        public Optional<Long> sizeIfKnown() {
            ...
            while (it.hasNext()) {
                ...
                if (jLongValue < 0) {
                    return Optional.m22805of(Long.MAX_VALUE);
                }
            }
            return Optional.m22805of(Long.valueOf(jLongValue));
        }
