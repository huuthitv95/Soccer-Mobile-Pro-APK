...
public final class InternetDomainName {
    ...
    private static final Splitter DOT_SPLITTER = Splitter.m22810on('.');
    private static final Joiner DOT_JOINER = Joiner.m22803on('.');
    ...
    static {
        ...
        CharMatcher charMatcherMo22802or = CharMatcher.inRange('a', 'z').mo22802or(CharMatcher.inRange('A', 'Z'));
        LETTER_MATCHER = charMatcherMo22802or;
        PART_CHAR_MATCHER = charMatcherInRange.mo22802or(charMatcherMo22802or).mo22802or(charMatcherAnyOf);
    }
    ...
    private int registrySuffixIndex() {
        ...
        int iFindSuffixOfType = findSuffixOfType(Optional.m22805of(PublicSuffixType.REGISTRY));
