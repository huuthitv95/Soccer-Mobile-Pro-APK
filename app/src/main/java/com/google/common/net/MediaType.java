...
public final class MediaType {
    ...
    private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.m22846of("charset", Ascii.toLowerCase(Charsets.UTF_8.name()));
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.m22804on("; ").withKeyValueSeparator(C11744X3.j.f26434b);

    private static MediaType createConstant(String type, String subtype) {
        MediaType mediaTypeAddKnownType = addKnownType(new MediaType(type, subtype, ImmutableListMultimap.m22845of()));
    ...
    private static MediaType createConstantUtf8(String type, String subtype) {
        ...
        mediaTypeAddKnownType.parsedCharset = Optional.m22805of(Charsets.UTF_8);
        return mediaTypeAddKnownType;
    }
    ...
    public Optional<Charset> charset() {
        ...
        if (optionalAbsent == null) {
            ...
            while (it.hasNext()) {
                String next = it.next();
                if (str == null) {
                    optionalAbsent = Optional.m22805of(Charset.forName(next));
                    str = next;
    ...
    public MediaType withParameter(String attribute, String value) {
        return withParameters(attribute, ImmutableSet.m22880of(value));
    }

    public MediaType withCharset(Charset charset) {
        Preconditions.checkNotNull(charset);
        MediaType mediaTypeWithParameter = withParameter("charset", charset.name());
        mediaTypeWithParameter.parsedCharset = Optional.m22805of(charset);
    ...
    public boolean m22960is(MediaType mediaTypeRange) {
    ...
    public static MediaType create(String type, String subtype) {
        MediaType mediaTypeCreate = create(type, subtype, ImmutableListMultimap.m22845of());
    ...
    public static MediaType parse(String input) {
        ...
        try {
            ...
            while (tokenizer.hasMore()) {
                ...
                consumeSeparator(tokenizer, C11341A5.f23808U);
