...
public final class InetAddresses {
    ...
    private static final CharMatcher IPV4_DELIMITER_MATCHER = CharMatcher.m22801is(IPV4_DELIMITER);
    private static final CharMatcher IPV6_DELIMITER_MATCHER = CharMatcher.m22801is(':');
    ...
    private static String convertDottedQuadToHex(String ipString) {
        ...
        return strSubstring + Integer.toHexString(((bArrTextToNumericFormatV4[0] & 255) << 8) | (bArrTextToNumericFormatV4[1] & 255)) + CertificateUtil.DELIMITER + Integer.toHexString((bArrTextToNumericFormatV4[3] & 255) | ((bArrTextToNumericFormatV4[2] & 255) << 8));
    }
    ...
    public static String toUriString(InetAddress ip) {
        if (ip instanceof Inet6Address) {
            return C11744X3.j.f26438d + toAddrString(ip) + C11744X3.j.f26440e;
        }
    ...
    private static InetAddress forUriStringNoThrow(String hostAddr) {
        ...
        if (hostAddr.startsWith(C11744X3.j.f26438d) && hostAddr.endsWith(C11744X3.j.f26440e)) {
