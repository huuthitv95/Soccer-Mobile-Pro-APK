...
import com.ironsource.C11709V2;
...
public final class CacheBuilderSpec {
    ...
    CacheBuilder<Object, Object> toCacheBuilder() {
        ...
        if (this.keyStrength != null) {
            if (C101881.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.keyStrength.ordinal()] == 1) {
        ...
        if (this.valueStrength != null) {
            int i = C101881.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.valueStrength.ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C101881 {
