...
public final class SimpleTimeLimiter implements TimeLimiter {
    ...
    public <T> T newProxy(T t, Class<T> cls, long j, TimeUnit timeUnit) {
        ...
        return (T) newProxy(cls, new C105901(t, j, timeUnit, findInterruptibleMethods(cls)));
    }

    /* JADX INFO: renamed from: com.google.common.util.concurrent.SimpleTimeLimiter$1 */
    class C105901 implements InvocationHandler {
        ...
        C105901(final Object val$target, final long val$timeoutDuration, final TimeUnit val$timeoutUnit, final Set val$interruptibleMethods) {
        ...
        public Object invoke(Object obj, final Method method, @CheckForNull final Object[] args) throws Throwable {
            ...
            return SimpleTimeLimiter.this.callWithTimeout(new Callable() { // from class: com.google.common.util.concurrent.SimpleTimeLimiter$1$$ExternalSyntheticLambda0
                ...
                public final Object call() {
                    return SimpleTimeLimiter.C105901.lambda$invoke$0(method, obj2, args);
                }
