...
public abstract class AbstractService implements Service {
    ...
    public final Service stopAsync() throws Exception {
        if (this.monitor.enterIf(this.isStoppable)) {
            try {
                ...
                switch (C105436.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()]) {
                    case 1:
    ...
    static /* synthetic */ class C105436 {
    ...
    protected final void notifyFailed(Throwable cause) throws Exception {
        ...
        try {
            Service.State state = state();
            int i = C105436.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()];
            if (i != 1) {
                if (i == 2 || i == 3 || i == 4) {
    ...
    public String toString() {
        return getClass().getSimpleName() + " [" + state() + C11744X3.j.f26440e;
    }
    ...
    private void enqueueTerminatedEvent(final Service.State from) {
        switch (C105436.$SwitchMap$com$google$common$util$concurrent$Service$State[from.ordinal()]) {
            case 1:
