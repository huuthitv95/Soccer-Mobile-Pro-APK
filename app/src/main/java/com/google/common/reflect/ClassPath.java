...
import com.google.common.p284io.ByteSource;
import com.google.common.p284io.CharSource;
import com.google.common.p284io.Resources;
...
public final class ClassPath {
    ...
    private static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.m22812on(" ").omitEmptyStrings();
    ...
    public static class ResourceInfo {
        ...
        static ResourceInfo m22985of(File file, String resourceName, ClassLoader loader) {
        ...
        private void scanJarFile(JarFile file, ImmutableSet.Builder<ResourceInfo> builder) {
            ...
            while (enumerationEntries.hasMoreElements()) {
                ...
                if (!jarEntryNextElement.isDirectory() && !jarEntryNextElement.getName().equals("META-INF/MANIFEST.MF")) {
                    builder.add(ResourceInfo.m22985of(new File(file.getName()), jarEntryNextElement.getName(), this.classloader));
                }
            }
        }
            ...
            for (File file : fileArrListFiles) {
                ...
                if (file.isDirectory()) {
                    ...
                    if (!str.equals("META-INF/MANIFEST.MF")) {
                        builder.add(ResourceInfo.m22985of(file, str, this.classloader));
                    }
                }
            }
        }
        ...
        if (value != null) {
            for (String str : CLASS_PATH_ATTRIBUTE_SEPARATOR.split(value)) {
                try {
                    ...
                    if (classPathEntry.getProtocol().equals(C11744X3.i.f26356b)) {
    ...
    static ImmutableMap<File, ClassLoader> getClassPathEntries(ClassLoader classloader) {
        ...
        while (it.hasNext()) {
            URL next = it.next();
            if (next.getProtocol().equals(C11744X3.i.f26356b)) {
    ...
    static ImmutableList<URL> parseJavaClassPath() {
        ...
        for (String str : Splitter.m22812on(StandardSystemProperty.PATH_SEPARATOR.value()).split(StandardSystemProperty.JAVA_CLASS_PATH.value())) {
            try {
                try {
                    builder.add(new File(str).toURI().toURL());
                } catch (SecurityException unused) {
                    builder.add(new URL(C11744X3.i.f26356b, (String) null, new File(str).getAbsolutePath()));
                }
    ...
    static File toFile(URL url) {
        Preconditions.checkArgument(url.getProtocol().equals(C11744X3.i.f26356b));
        try {
