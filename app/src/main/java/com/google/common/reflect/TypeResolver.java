...
public final class TypeResolver {
    ...
    private static class TypeTable {
        ...
        TypeTable() {
            this.map = ImmutableMap.m22851of();
        }
    ...
    private static class WildcardCapturer {
        ...
        private final AtomicInteger f22578id;
        ...
        TypeVariable<?> captureAsTypeVariable(Type[] upperBounds) {
            return Types.newArtificialTypeVariable(WildcardCapturer.class, "capture#" + this.f22578id.incrementAndGet() + "-of ? extends " + Joiner.m22803on(Typography.amp).join(upperBounds), upperBounds);
        }

        private WildcardCapturer forTypeVariable(final TypeVariable<?> typeParam) {
            return new WildcardCapturer(this, this.f22578id) { // from class: com.google.common.reflect.TypeResolver.WildcardCapturer.1
        ...
        private WildcardCapturer notForTypeVariable() {
            return new WildcardCapturer(this.f22578id);
        }
