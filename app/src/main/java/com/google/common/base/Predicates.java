...
public final class Predicates {
    ...
    public static <T> Predicate<T> m22808or(Iterable<? extends Predicate<? super T>> components) {
        return new OrPredicate(defensiveCopy(components));
    }

    @SafeVarargs
    /* JADX INFO: renamed from: or */
    public static <T> Predicate<T> m22809or(Predicate<? super T>... components) {
        return new OrPredicate(defensiveCopy(components));
    }

    /* JADX INFO: renamed from: or */
    public static <T> Predicate<T> m22807or(Predicate<? super T> first, Predicate<? super T> second) {
    ...
    public static <T> Predicate<T> m22806in(Collection<? extends T> target) {
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        final Function<A, ? extends B> f22506f;

        /* JADX INFO: renamed from: p */
        final Predicate<B> f22507p;

        private CompositionPredicate(Predicate<B> p, Function<A, ? extends B> f) {
            this.f22507p = (Predicate) Preconditions.checkNotNull(p);
            this.f22506f = (Function) Preconditions.checkNotNull(f);
        }

        @Override // com.google.common.base.Predicate
        public boolean apply(@ParametricNullness A a2) {
            return this.f22507p.apply(this.f22506f.apply(a2));
        }
        ...
        public boolean equals(@CheckForNull Object obj) {
            if (obj instanceof CompositionPredicate) {
                ...
                if (this.f22506f.equals(compositionPredicate.f22506f) && this.f22507p.equals(compositionPredicate.f22507p)) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            return this.f22506f.hashCode() ^ this.f22507p.hashCode();
        }

        public String toString() {
            return this.f22507p + "(" + this.f22506f + ")";
        }
    }
