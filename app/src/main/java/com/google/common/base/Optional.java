...
public abstract class Optional<T> implements Serializable {
    ...
    public abstract Optional<T> mo22797or(Optional<? extends T> secondChoice);

    /* JADX INFO: renamed from: or */
    public abstract T mo22798or(Supplier<? extends T> supplier);

    /* JADX INFO: renamed from: or */
    public abstract T mo22799or(T defaultValue);
    ...
    public static <T> Optional<T> m22805of(T reference) {
