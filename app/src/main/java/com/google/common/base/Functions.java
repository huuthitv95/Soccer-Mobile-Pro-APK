...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        private final Function<A, ? extends B> f22504f;

        /* JADX INFO: renamed from: g */
        private final Function<B, C> f22505g;

        public FunctionComposition(Function<B, C> g, Function<A, ? extends B> f) {
            this.f22505g = (Function) Preconditions.checkNotNull(g);
            this.f22504f = (Function) Preconditions.checkNotNull(f);
        }

        @Override // com.google.common.base.Function
        @ParametricNullness
        public C apply(@ParametricNullness A a2) {
            return (C) this.f22505g.apply(this.f22504f.apply(a2));
        }
        ...
        public boolean equals(@CheckForNull Object obj) {
            if (obj instanceof FunctionComposition) {
                ...
                if (this.f22504f.equals(functionComposition.f22504f) && this.f22505g.equals(functionComposition.f22505g)) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            return this.f22504f.hashCode() ^ this.f22505g.hashCode();
        }

        public String toString() {
            return this.f22505g + "(" + this.f22504f + ")";
        }
    }
