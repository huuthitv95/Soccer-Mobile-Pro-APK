...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    public static CharMatcher m22801is(final char match) {
        return new C10160Is(match);
    }
    ...
    public static CharMatcher anyOf(final CharSequence sequence) {
        ...
        if (length == 1) {
            return m22801is(sequence.charAt(0));
        }
        if (length == 2) {
    ...
    public CharMatcher mo22802or(CharMatcher other) {
        return new C10161Or(this, other);
    }
    ...
    private static CharMatcher precomputedPositive(int totalCharacters, BitSet table, String description) {
        ...
        if (totalCharacters == 1) {
            return m22801is((char) table.nextSetBit(0));
        }
    ...
    private static final class C10161Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C10161Or(CharMatcher a2, CharMatcher b) {
            this.first = (CharMatcher) Preconditions.checkNotNull(a2);
            this.second = (CharMatcher) Preconditions.checkNotNull(b);
        }
    ...
    private static final class C10160Is extends FastMatcher {
        ...
        /* JADX INFO: renamed from: or */
        public CharMatcher mo22802or(CharMatcher other) {
            return other.matches(this.match) ? other : super.mo22802or(other);
        }
