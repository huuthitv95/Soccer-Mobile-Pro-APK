...
public final class ImmutableClassToInstanceMap<B> extends ForwardingMap<Class<? extends B>, B> implements ClassToInstanceMap<B>, Serializable {
    private static final ImmutableClassToInstanceMap<Object> EMPTY = new ImmutableClassToInstanceMap<>(ImmutableMap.m22851of());
    private final ImmutableMap<Class<? extends B>, B> delegate;

    /* JADX INFO: renamed from: of */
    public static <B> ImmutableClassToInstanceMap<B> m22830of() {
        return (ImmutableClassToInstanceMap<B>) EMPTY;
    }

    /* JADX INFO: renamed from: of */
    public static <B, T extends B> ImmutableClassToInstanceMap<B> m22831of(Class<T> type, T value) {
        return new ImmutableClassToInstanceMap<>(ImmutableMap.m22852of(type, value));
    }
    ...
    public static final class Builder<B> {
        ...
        public ImmutableClassToInstanceMap<B> build() {
            ...
            if (immutableMapBuildOrThrow.isEmpty()) {
                return ImmutableClassToInstanceMap.m22830of();
            }
