...
public abstract class ImmutableMap<K, V> implements Map<K, V>, Serializable {
    ...
    public static <K, V> ImmutableMap<K, V> m22851of() {
        return (ImmutableMap<K, V>) RegularImmutableMap.EMPTY;
    }

    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m22852of(K k1, V v1) {
        CollectPreconditions.checkEntryNotNull(k1, v1);
        return RegularImmutableMap.create(1, new Object[]{k1, v1});
    }

    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m22853of(K k1, V v1, K k2, V v2) {
        CollectPreconditions.checkEntryNotNull(k1, v1);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m22854of(K k1, V v1, K k2, V v2, K k3, V v3) {
        CollectPreconditions.checkEntryNotNull(k1, v1);
        CollectPreconditions.checkEntryNotNull(k2, v2);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m22855of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4) {
        CollectPreconditions.checkEntryNotNull(k1, v1);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m22856of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        CollectPreconditions.checkEntryNotNull(k1, v1);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m22857of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6) {
        CollectPreconditions.checkEntryNotNull(k1, v1);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m22858of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6, K k7, V v7) {
        CollectPreconditions.checkEntryNotNull(k1, v1);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m22859of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6, K k7, V v7, K k8, V v8) {
        CollectPreconditions.checkEntryNotNull(k1, v1);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m22860of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6, K k7, V v7, K k8, V v8, K k9, V v9) {
        CollectPreconditions.checkEntryNotNull(k1, v1);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableMap<K, V> m22861of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6, K k7, V v7, K k8, V v8, K k9, V v9, K k10, V v10) {
        CollectPreconditions.checkEntryNotNull(k1, v1);
        CollectPreconditions.checkEntryNotNull(k2, v2);
        CollectPreconditions.checkEntryNotNull(k3, v3);
        CollectPreconditions.checkEntryNotNull(k4, v4);
    ...
    public static class Builder<K, V> {
        ...
        static final class DuplicateKey {
            ...
            IllegalArgumentException exception() {
                return new IllegalArgumentException("Multiple entries with same key: " + this.key + C11744X3.j.f26434b + this.value1 + " and " + this.key + C11744X3.j.f26434b + this.value2);
            }
        }
    }
    ...
    public ImmutableSetMultimap<K, V> asMultimap() {
        if (isEmpty()) {
            return ImmutableSetMultimap.m22886of();
        }
    ...
    private final class MapViewOfValuesAsSingletonSets extends IteratorBasedImmutableMap<K, ImmutableSet<V>> {
        ...
        public ImmutableSet<V> get(@CheckForNull Object key) {
            ...
            return ImmutableSet.m22880of(obj);
        }
                ...
                public Map.Entry<K, ImmutableSet<V>> next() {
                    ...
                    return new AbstractMapEntry<K, ImmutableSet<V>>(this) { // from class: com.google.common.collect.ImmutableMap.MapViewOfValuesAsSingletonSets.1.1
                        ...
                        public ImmutableSet<V> getValue() {
                            return ImmutableSet.m22880of(entry.getValue());
                        }
                    };
                }
            };
