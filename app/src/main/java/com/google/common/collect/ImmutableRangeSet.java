...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    private static final ImmutableRangeSet<Comparable<?>> EMPTY = new ImmutableRangeSet<>(ImmutableList.m22832of());
    private static final ImmutableRangeSet<Comparable<?>> ALL = new ImmutableRangeSet<>(ImmutableList.m22833of(Range.all()));
    ...
    public static <C extends Comparable> ImmutableRangeSet<C> m22877of() {
        return EMPTY;
    }

    /* JADX INFO: renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m22878of(Range<C> range) {
        ...
        return new ImmutableRangeSet<>(ImmutableList.m22833of(range));
    }
    ...
    public ImmutableRangeSet<C> complement() {
        ...
        if (this.ranges.size() == 1 && this.ranges.get(0).equals(Range.all())) {
            ImmutableRangeSet<C> immutableRangeSetM22877of = m22877of();
            this.complement = immutableRangeSetM22877of;
            return immutableRangeSetM22877of;
        }
    ...
    public ImmutableSortedSet<C> asSet(DiscreteDomain<C> domain) {
        ...
        if (isEmpty()) {
            return ImmutableSortedSet.m22927of();
        }
    ...
    public static class Builder<C extends Comparable<?>> {
        ...
        public ImmutableRangeSet<C> build() {
            ...
            if (immutableListBuild.isEmpty()) {
                return ImmutableRangeSet.m22877of();
            }
    ...
    private static final class SerializedForm<C extends Comparable> implements Serializable {
        ...
        Object readResolve() {
            ...
            if (this.ranges.equals(ImmutableList.m22833of(Range.all()))) {
                return ImmutableRangeSet.all();
            }
