...
public class ImmutableListMultimap<K, V> extends ImmutableMultimap<K, V> implements ListMultimap<K, V> {
    ...
    public static <K, V> ImmutableListMultimap<K, V> m22845of() {
        return EmptyImmutableListMultimap.INSTANCE;
    }

    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m22846of(K k1, V v1) {
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m22847of(K k1, V v1, K k2, V v2) {
        Builder builder = builder();
        builder.put((Object) k1, (Object) v1);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m22848of(K k1, V v1, K k2, V v2, K k3, V v3) {
        Builder builder = builder();
        builder.put((Object) k1, (Object) v1);
        builder.put((Object) k2, (Object) v2);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m22849of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4) {
        Builder builder = builder();
        builder.put((Object) k1, (Object) v1);
        builder.put((Object) k2, (Object) v2);
        builder.put((Object) k3, (Object) v3);
    ...
    /* JADX INFO: renamed from: of */
    public static <K, V> ImmutableListMultimap<K, V> m22850of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5) {
        Builder builder = builder();
        builder.put((Object) k1, (Object) v1);
        builder.put((Object) k2, (Object) v2);
        builder.put((Object) k3, (Object) v3);
    ...
    public ImmutableList<V> get(K key) {
        ...
        return immutableList == null ? ImmutableList.m22832of() : immutableList;
    }
