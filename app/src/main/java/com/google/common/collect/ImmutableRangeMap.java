...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V>, Serializable {
    private static final ImmutableRangeMap<Comparable<?>, Object> EMPTY = new ImmutableRangeMap<>(ImmutableList.m22832of(), ImmutableList.m22832of());
    ...
    public static <K extends Comparable<?>, V> ImmutableRangeMap<K, V> m22875of() {
        return (ImmutableRangeMap<K, V>) EMPTY;
    }

    /* JADX INFO: renamed from: of */
    public static <K extends Comparable<?>, V> ImmutableRangeMap<K, V> m22876of(Range<K> range, V value) {
        return new ImmutableRangeMap<>(ImmutableList.m22833of(range), ImmutableList.m22833of(value));
    }
    ...
    public ImmutableRangeMap<K, V> subRangeMap(final Range<K> range) {
        ...
        return (ImmutableRangeMap<K, V>) new ImmutableRangeMap<K, V>(this, new ImmutableList<Range<K>>() { // from class: com.google.common.collect.ImmutableRangeMap.1
            ...
            public ImmutableRangeMap<K, V> subRangeMap(Range<K> subRange) {
                ...
                return ImmutableRangeMap.m22875of();
            }
