...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    FluentIterable(Iterable<E> iterable) {
        this.iterableDelegate = Optional.m22805of(iterable);
    }

    private Iterable<E> getDelegate() {
        return this.iterableDelegate.mo22799or(this);
    }
    ...
    public static <E> FluentIterable<E> m22817of() {
        return from(Collections.EMPTY_LIST);
    }

    /* JADX INFO: renamed from: of */
    public static <E> FluentIterable<E> m22818of(@ParametricNullness E element, E... elements) {
    ...
    public final Optional<E> first() {
        ...
        return it.hasNext() ? Optional.m22805of(it.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (delegate instanceof List) {
            ...
            return Optional.m22805of(list.get(list.size() - 1));
        }
        ...
        if (delegate instanceof SortedSet) {
            return Optional.m22805of(((SortedSet) delegate).last());
        }
        do {
            next = it.next();
        } while (it.hasNext());
        return Optional.m22805of(next);
    }
