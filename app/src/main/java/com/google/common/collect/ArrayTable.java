...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public V m22816at(int rowIndex, int columnIndex) {
    ...
    public V get(@CheckForNull Object rowKey, @CheckForNull Object columnKey) {
        ...
        return m22816at(num.intValue(), num2.intValue());
    }
    ...
    public Table.Cell<R, C, V> getCell(final int index) {
        return new Tables.AbstractCell<R, C, V>(index) { // from class: com.google.common.collect.ArrayTable.2
            ...
            @CheckForNull
            public V getValue() {
                return (V) ArrayTable.this.m22816at(this.rowIndex, this.columnIndex);
            }
        };
    }
    ...
    public V getValue(int index) {
        return m22816at(index / this.columnList.size(), index % this.columnList.size());
    }
    ...
    private class Column extends ArrayMap<R, V> {
        ...
        @CheckForNull
        V getValue(int i) {
            return (V) ArrayTable.this.m22816at(i, this.columnIndex);
        }
    ...
    private class Row extends ArrayMap<C, V> {
        ...
        @CheckForNull
        V getValue(int i) {
            return (V) ArrayTable.this.m22816at(this.rowIndex, i);
        }
