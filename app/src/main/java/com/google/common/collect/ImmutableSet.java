...
public abstract class ImmutableSet<E> extends ImmutableCollection<E> implements Set<E> {
    ...
    public static <E> ImmutableSet<E> m22879of() {
        return RegularImmutableSet.EMPTY;
    }

    /* JADX INFO: renamed from: of */
    public static <E> ImmutableSet<E> m22880of(E element) {
        return new SingletonImmutableSet(element);
    }

    /* JADX INFO: renamed from: of */
    public static <E> ImmutableSet<E> m22881of(E e1, E e2) {
        return construct(2, e1, e2);
    }

    /* JADX INFO: renamed from: of */
    public static <E> ImmutableSet<E> m22882of(E e1, E e2, E e3) {
        return construct(3, e1, e2, e3);
    }

    /* JADX INFO: renamed from: of */
    public static <E> ImmutableSet<E> m22883of(E e1, E e2, E e3, E e4) {
        return construct(4, e1, e2, e3, e4);
    }

    /* JADX INFO: renamed from: of */
    public static <E> ImmutableSet<E> m22884of(E e1, E e2, E e3, E e4, E e5) {
        return construct(5, e1, e2, e3, e4, e5);
    }

    @SafeVarargs
    /* JADX INFO: renamed from: of */
    public static <E> ImmutableSet<E> m22885of(E e1, E e2, E e3, E e4, E e5, E e6, E... others) {
    ...
    public static <E> ImmutableSet<E> construct(int n, Object... elements) {
        ...
        if (n == 1) {
            return m22880of(Objects.requireNonNull(elements[0]));
        }
    ...
    public static <E> ImmutableSet<E> copyOf(E[] elements) {
        ...
        if (length == 1) {
            return m22880of((Object) elements[0]);
        }
    ...
    public static class Builder<E> extends ImmutableCollection.ArrayBasedBuilder<E> {
        ...
        public ImmutableSet<E> build() {
            ...
            if (i == 1) {
                return ImmutableSet.m22880of(Objects.requireNonNull(this.contents[0]));
            }
            if (this.hashTable == null || ImmutableSet.chooseTableSize(this.size) != this.hashTable.length) {
