...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public static <R, C, V> ImmutableTable<R, C, V> m22940of() {
        return (ImmutableTable<R, C, V>) SparseImmutableTable.EMPTY;
    }

    /* JADX INFO: renamed from: of */
    public static <R, C, V> ImmutableTable<R, C, V> m22941of(R rowKey, C columnKey, V value) {
    ...
    public static final class Builder<R, C, V> {
        ...
        public ImmutableTable<R, C, V> buildOrThrow() {
            ...
            if (size == 0) {
                return ImmutableTable.m22940of();
            }
            if (size == 1) {
    ...
    public ImmutableMap<R, V> column(C columnKey) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) columnMap().get(columnKey), ImmutableMap.m22851of());
    }
    ...
    public ImmutableMap<C, V> row(R rowKey) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) rowMap().get(rowKey), ImmutableMap.m22851of());
    }
    ...
    static final class SerializedForm implements Serializable {
        ...
        Object readResolve() {
            ...
            int i = 0;
            if (objArr.length == 1) {
                return ImmutableTable.m22941of(this.rowKeys[0], this.columnKeys[0], objArr[0]);
            }
