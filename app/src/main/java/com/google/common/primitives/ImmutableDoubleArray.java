...
public final class ImmutableDoubleArray implements Serializable {
    ...
    public static ImmutableDoubleArray m22961of() {
        return EMPTY;
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m22962of(double e0) {
        return new ImmutableDoubleArray(new double[]{e0});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m22963of(double e0, double e1) {
        return new ImmutableDoubleArray(new double[]{e0, e1});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m22964of(double e0, double e1, double e2) {
        return new ImmutableDoubleArray(new double[]{e0, e1, e2});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m22965of(double e0, double e1, double e2, double e3) {
        return new ImmutableDoubleArray(new double[]{e0, e1, e2, e3});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m22966of(double e0, double e1, double e2, double e3, double e4) {
        return new ImmutableDoubleArray(new double[]{e0, e1, e2, e3, e4});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m22967of(double e0, double e1, double e2, double e3, double e4, double e5) {
        return new ImmutableDoubleArray(new double[]{e0, e1, e2, e3, e4, e5});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m22968of(double first, double... rest) {
