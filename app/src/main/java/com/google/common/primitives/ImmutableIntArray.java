...
public final class ImmutableIntArray implements Serializable {
    ...
    public static ImmutableIntArray m22969of() {
        return EMPTY;
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m22970of(int e0) {
        return new ImmutableIntArray(new int[]{e0});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m22971of(int e0, int e1) {
        return new ImmutableIntArray(new int[]{e0, e1});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m22972of(int e0, int e1, int e2) {
        return new ImmutableIntArray(new int[]{e0, e1, e2});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m22973of(int e0, int e1, int e2, int e3) {
        return new ImmutableIntArray(new int[]{e0, e1, e2, e3});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m22974of(int e0, int e1, int e2, int e3, int e4) {
        return new ImmutableIntArray(new int[]{e0, e1, e2, e3, e4});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m22975of(int e0, int e1, int e2, int e3, int e4, int e5) {
        return new ImmutableIntArray(new int[]{e0, e1, e2, e3, e4, e5});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableIntArray m22976of(int first, int... rest) {
