...
public final class Stats implements Serializable {
    ...
    public static Stats m22955of(Iterable<? extends Number> values) {
    ...
    /* JADX INFO: renamed from: of */
    public static Stats m22956of(Iterator<? extends Number> values) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
        statsAccumulator.addAll(values);
        return statsAccumulator.snapshot();
    }
    ...
    /* JADX INFO: renamed from: of */
    public static Stats m22957of(double... values) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
        statsAccumulator.addAll(values);
        return statsAccumulator.snapshot();
    }
    ...
    /* JADX INFO: renamed from: of */
    public static Stats m22958of(int... values) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
        statsAccumulator.addAll(values);
        return statsAccumulator.snapshot();
    }
    ...
    /* JADX INFO: renamed from: of */
    public static Stats m22959of(long... values) {
        StatsAccumulator statsAccumulator = new StatsAccumulator();
        statsAccumulator.addAll(values);
        return statsAccumulator.snapshot();
    }
