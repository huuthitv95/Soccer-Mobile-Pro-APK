...
abstract class ToDoubleRounder<X extends Number & Comparable<X>> {
    ...
    final double roundToDouble(X x, RoundingMode mode) {
        ...
        Preconditions.checkNotNull(mode, C11744X3.a.f26183t);
        double dRoundToDoubleArbitrarily = roundToDoubleArbitrarily(x);
        if (Double.isInfinite(dRoundToDoubleArbitrarily)) {
            switch (C104961.$SwitchMap$java$math$RoundingMode[mode.ordinal()]) {
                case 1:
                case 2:
                case 3:
                case 4:
                        ...
                        case 4:
                            if (iCompareTo >= 0) {
                                ...
                                if (dNextUp != Double.POSITIVE_INFINITY) {
                                    ...
                                    if (iCompareTo2 >= 0) {
                                        if (iCompareTo2 <= 0) {
                                            i = C104961.$SwitchMap$java$math$RoundingMode[mode.ordinal()];
                                            if (i != 2) {
                                                if (i != 3) {
                                                    if (i == 4) {
                                                        if (sign(x) >= 0) {
    ...
    static /* synthetic */ class C104961 {
