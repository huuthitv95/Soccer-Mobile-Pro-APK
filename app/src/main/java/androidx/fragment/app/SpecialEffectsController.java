...
import androidx.fragment.C0544R;
...
abstract class SpecialEffectsController {
    ...
    static SpecialEffectsController getOrCreateController(ViewGroup viewGroup, SpecialEffectsControllerFactory specialEffectsControllerFactory) {
        Object tag = viewGroup.getTag(C0544R.id.special_effects_controller_view_tag);
        ...
        viewGroup.setTag(C0544R.id.special_effects_controller_view_tag, specialEffectsControllerCreateController);
    ...
    static class Operation {
        ...
        enum State {
            ...
            void applyState(View view) {
                int i = C06143.f136xe493b431[ordinal()];
                if (i == 1) {
        ...
        final void mergeWith(State state, LifecycleImpact lifecycleImpact) {
            int i = C06143.f135xb9e640f0[lifecycleImpact.ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C06143 {
        ...
        static {
            ...
            try {
                f135xb9e640f0[Operation.LifecycleImpact.REMOVING.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f135xb9e640f0[Operation.LifecycleImpact.NONE.ordinal()] = 3;
            ...
            try {
                f136xe493b431[Operation.State.VISIBLE.ordinal()] = 2;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f136xe493b431[Operation.State.GONE.ordinal()] = 3;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f136xe493b431[Operation.State.INVISIBLE.ordinal()] = 4;
