...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    static Fragment getViewFragment(View view) {
        Object tag = view.getTag(C0544R.id.fragment_container_view_tag);
        ...
        if (!z && this.mCurState >= 1) {
            if (USE_STATE_MANAGER) {
                for (int i7 = i4; i7 < i5; i7++) {
                    Iterator<FragmentTransaction.C0595Op> it = arrayList.get(i7).mOps.iterator();
                    while (it.hasNext()) {
        ...
        if (USE_STATE_MANAGER) {
            ...
            for (int i8 = i4; i8 < i5; i8++) {
                ...
                if (zBooleanValue) {
                    ...
                    Iterator<FragmentTransaction.C0595Op> it2 = backStackRecord2.mOps.iterator();
                    while (it2.hasNext()) {
    ...
    private Set<SpecialEffectsController> collectChangedControllers(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        while (i < i2) {
            Iterator<FragmentTransaction.C0595Op> it = arrayList.get(i).mOps.iterator();
            while (it.hasNext()) {
                Fragment fragment = it.next().mFragment;
    ...
    private void setVisibleRemovingFragment(Fragment fragment) {
        ...
        if (fragmentContainer.getTag(C0544R.id.visible_removing_fragment_view_tag) == null) {
            fragmentContainer.setTag(C0544R.id.visible_removing_fragment_view_tag, fragment);
        }
        ((Fragment) fragmentContainer.getTag(C0544R.id.visible_removing_fragment_view_tag)).setPopDirection(fragment.getPopDirection());
    }
