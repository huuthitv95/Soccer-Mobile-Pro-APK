...
public abstract class FragmentTransaction {
    ...
    static final class C0595Op {
        ...
        C0595Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        C0595Op(int i, Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
    ...
    void addOp(C0595Op c0595Op) {
        this.mOps.add(c0595Op);
        c0595Op.mEnterAnim = this.mEnterAnim;
        c0595Op.mExitAnim = this.mExitAnim;
        c0595Op.mPopEnterAnim = this.mPopEnterAnim;
        c0595Op.mPopExitAnim = this.mPopExitAnim;
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0595Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0595Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0595Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0595Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0595Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0595Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C0595Op(10, fragment, state));
        return this;
    }
