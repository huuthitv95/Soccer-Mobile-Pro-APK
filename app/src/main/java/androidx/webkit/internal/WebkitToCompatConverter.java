...
public class WebkitToCompatConverter {
    ...
    public SafeBrowsingResponse convertSafeBrowsingResponse(InvocationHandler invocationHandler) {
        return Trace$$ExternalSyntheticApiModelOutline0.m769m(this.mImpl.convertSafeBrowsingResponse(invocationHandler));
    }
    ...
    public ServiceWorkerWebSettings convertServiceWorkerSettings(InvocationHandler invocationHandler) {
        return Trace$$ExternalSyntheticApiModelOutline0.m772m(this.mImpl.convertServiceWorkerSettings(invocationHandler));
    }
