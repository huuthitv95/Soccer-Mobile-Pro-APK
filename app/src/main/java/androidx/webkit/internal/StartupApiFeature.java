...
public abstract class StartupApiFeature {
    ...
    public static class C1147P extends StartupApiFeature {
        C1147P(String str, String str2) {
            super(str, str2);
        }
    ...
    private static Bundle getMetaDataFromWebViewManifestOrNull(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            try {
                return ApiHelperForTiramisu.getServiceInfo(context.getPackageManager(), componentName, ApiHelperForTiramisu.m824of(640L)).metaData;
