    ...
    private static String guessHardcodedMime(String str) {
        ...
        switch (lowerCase.hashCode()) {
            ...
            case 108089:
                ...
                break;
            case 108150:
                b = !lowerCase.equals("mjs") ? (byte) -1 : Ascii.f22503VT;
                break;
            case 108272:
                b = !lowerCase.equals("mp3") ? (byte) -1 : Ascii.f22492FF;
                break;
            case 108273:
                b = !lowerCase.equals("mp4") ? (byte) -1 : Ascii.f22490CR;
                break;
            case 108324:
                b = !lowerCase.equals("mpg") ? (byte) -1 : Ascii.f22500SO;
                break;
            case 109961:
                b = !lowerCase.equals("oga") ? (byte) -1 : Ascii.f22499SI;
                break;
            case 109967:
            ...
            case 114833:
                ...
                break;
            case 117484:
                b = !lowerCase.equals("wav") ? (byte) -1 : Ascii.f22491EM;
                break;
            case 118660:
            ...
            case 118807:
                ...
                break;
            case 120609:
                b = !lowerCase.equals("zip") ? (byte) -1 : Ascii.f22493FS;
                break;
            case 3000872:
                b = !lowerCase.equals("apng") ? (byte) -1 : Ascii.f22494GS;
                break;
            case 3145576:
                b = !lowerCase.equals("flac") ? (byte) -1 : Ascii.f22498RS;
                break;
            case 3213227:
                b = !lowerCase.equals("html") ? (byte) -1 : Ascii.f22502US;
                break;
            case 3259225:
