...
public class RoomSQLiteQuery implements SupportSQLiteQuery, SupportSQLiteProgram, AutoCloseable {
    ...
    public static RoomSQLiteQuery copyFrom(SupportSQLiteQuery supportSQLiteQuery) {
        ...
        supportSQLiteQuery.bindTo(roomSQLiteQueryAcquire.new C10371());
        return roomSQLiteQueryAcquire;
    }

    /* JADX INFO: renamed from: androidx.room.RoomSQLiteQuery$1 */
    static class C10371 implements SupportSQLiteProgram, AutoCloseable {
        @Override // java.io.Closeable, java.lang.AutoCloseable
        public void close() {
        }
