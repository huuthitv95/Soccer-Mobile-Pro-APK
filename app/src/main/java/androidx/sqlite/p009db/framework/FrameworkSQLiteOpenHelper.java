...
class FrameworkSQLiteOpenHelper implements SupportSQLiteOpenHelper, AutoCloseable {
    ...
    static class OpenHelper extends SQLiteOpenHelper implements AutoCloseable {
