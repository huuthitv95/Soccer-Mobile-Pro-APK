...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        ComponentDialog$$ExternalSyntheticApiModelOutline0.m56m();
        ShortcutInfo.Builder intents = ComponentDialog$$ExternalSyntheticApiModelOutline0.m24m(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
    ...
    static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(new Builder(context, ComponentDialog$$ExternalSyntheticApiModelOutline0.m36m((Object) it.next())).build());
        }
        return arrayList;
    }
