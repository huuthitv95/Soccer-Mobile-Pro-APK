...
public final class MailTo {
    ...
    private static final String f86CC = "cc";
    private static final String MAILTO = "mailto";
    public static final String MAILTO_SCHEME = "mailto:";
    private static final String SUBJECT = "subject";

    /* JADX INFO: renamed from: TO */
    private static final String f87TO = "to";
    ...
    public static MailTo parse(String str) throws ParseException {
        ...
        if (strSubstring != null) {
            for (String str2 : strSubstring.split(C11744X3.j.f26436c)) {
                String[] strArrSplit = str2.split(C11744X3.j.f26434b, 2);
    ...
    public String getCc() {
        return this.mHeaders.get(f86CC);
    }
