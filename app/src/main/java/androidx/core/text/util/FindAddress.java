...
class FindAddress {
    ...
    private static final String f88NL = "\n\u000b\f\r\u0085\u2028\u2029";

    /* JADX INFO: renamed from: SP */
    private static final String f89SP = "\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000";
    private static final String WORD_DELIM = ",*•\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000\n\u000b\f\r\u0085\u2028\u2029";
    private static final String WORD_END = "(?=[,*•\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000\n\u000b\f\r\u0085\u2028\u2029]|$)";

    /* JADX INFO: renamed from: WS */
    private static final String f90WS = "\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000\n\u000b\f\r\u0085\u2028\u2029";
        ...
        while (iEnd < str.length()) {
            if (!matcher.find(iEnd)) {
                ...
                while (iEnd < matcher.start()) {
                    int i4 = iEnd + 1;
                    if (f88NL.indexOf(str.charAt(iEnd)) != -1) {
                        i2++;
                    }
                    iEnd = i4;
                }
                ...
                if (matchHouseNumber(str, iEnd) == null) {
                    if (!isValidLocationName(matcher.group(0))) {
                        ...
                        if (z2 && i3 > 4 && (matchResultMatchState = matchState(str, iEnd)) != null) {
                            if (strGroup.equals("et") && matchResultMatchState.group(0).equals(CampaignEx.JSON_KEY_AD_AL)) {
