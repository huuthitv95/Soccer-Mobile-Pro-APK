...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f10 = f;
        float f11 = (motionPaths2.f32x + (f4 / 2.0f)) - ((f5 / 2.0f) + f8);
        float f12 = (motionPaths2.f33y + (f6 / 2.0f)) - (f9 + (f7 / 2.0f));
        float f13 = (f4 - f5) * f2;
        float f14 = f13 / 2.0f;
        this.f32x = (int) ((f8 + (f11 * f10)) - f14);
        float f15 = (f6 - f7) * f3;
        float f16 = f15 / 2.0f;
        this.f33y = (int) ((f9 + (f12 * f10)) - f16);
        ...
        this.mMode = 0;
        this.f32x = (int) (((motionPaths.f32x + (f17 * f11)) + (f19 * f12)) - f14);
        this.f33y = (int) (((motionPaths.f33y + (f11 * f18)) + (f12 * f10)) - f16);
    ...
    void initPolar(int i, int i2, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        if (i3 == 1) {
            ...
            float f10 = motionPaths2.f32x;
            float f11 = motionPaths.f32x;
            this.f32x = (f9 * (f10 - f11)) + f11;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f2 = motionKeyPosition.mPercentY;
            }
            float f12 = motionPaths2.f33y;
            float f13 = motionPaths.f33y;
            this.f33y = (f2 * (f12 - f13)) + f13;
        } else if (i3 == 2) {
            if (Float.isNaN(motionKeyPosition.mPercentX)) {
                float f14 = motionPaths2.f32x;
                float f15 = motionPaths.f32x;
                fMin = ((f14 - f15) * f2) + f15;
            } else {
            ...
            this.f32x = fMin;
            if (Float.isNaN(motionKeyPosition.mPercentY)) {
                float f16 = motionPaths2.f33y;
                float f17 = motionPaths.f33y;
                f = (f2 * (f16 - f17)) + f17;
            } else {
            ...
            float f19 = motionPaths2.f32x;
            float f20 = motionPaths.f32x;
            this.f32x = (f18 * (f19 - f20)) + f20;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f2 = motionKeyPosition.mPercentY;
            }
            float f21 = motionPaths2.f33y;
            float f22 = motionPaths.f33y;
            this.f33y = (f2 * (f21 - f22)) + f22;
        }
    ...
    public void setupRelative(Motion motion, MotionPaths motionPaths) {
        double d = ((this.f32x + (this.width / 2.0f)) - motionPaths.f32x) - (motionPaths.width / 2.0f);
        double d2 = ((this.f33y + (this.height / 2.0f)) - motionPaths.f33y) - (motionPaths.height / 2.0f);
        this.mRelativeToController = motion;
        this.f32x = (float) Math.hypot(d2, d);
        if (Float.isNaN(this.mRelativeAngle)) {
            this.f33y = (float) (Math.atan2(d2, d) + 1.5707963267948966d);
        } else {
            this.f33y = (float) Math.toRadians(this.mRelativeAngle);
        }
    }
    ...
    void initScreen(int i, int i2, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        this.mMode = 2;
        if (!Float.isNaN(motionKeyPosition.mPercentX)) {
            this.f32x = (int) (motionKeyPosition.mPercentX * ((int) (i - this.width)));
        }
        if (!Float.isNaN(motionKeyPosition.mPercentY)) {
            this.f33y = (int) (motionKeyPosition.mPercentY * ((int) (i2 - this.height)));
        }
    ...
    void initPath(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f10 = f;
        float f11 = (motionPaths2.f32x + (motionPaths2.width / 2.0f)) - ((f7 / 2.0f) + f6);
        float f12 = (motionPaths2.f33y + (motionPaths2.height / 2.0f)) - ((f9 / 2.0f) + f8);
        float f13 = f11 * f10;
        float f14 = f4 * f2;
        float f15 = f14 / 2.0f;
        this.f32x = (int) ((f6 + f13) - f15);
        float f16 = f12 * f10;
        float f17 = f5 * f3;
        float f18 = f17 / 2.0f;
        this.f33y = (int) ((f8 + f16) - f18);
        ...
        this.mMode = 1;
        float f20 = (int) ((motionPaths.f32x + f13) - f15);
        this.f32x = f20;
        float f21 = (int) ((motionPaths.f33y + f16) - f18);
        this.f32x = f20 + ((-f12) * f19);
        this.f33y = f21 + (f11 * f19);
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(motionKeyPosition.mTransitionEasing);
        this.mPathMotionArc = motionKeyPosition.mPathMotionArc;
    }
    ...
    void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z) {
        boolean zDiff = diff(this.f32x, motionPaths.f32x);
        boolean zDiff2 = diff(this.f33y, motionPaths.f33y);
    ...
    void getCenter(double d, int[] iArr, double[] dArr, float[] fArr, int i) {
        float fSin = this.f32x;
        float fCos = this.f33y;
        float f = this.width;
