...
public class Motion implements TypedValues {
    ...
    MotionKeyPosition getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        floatRect.left = this.mStartMotionPath.f32x;
        floatRect.top = this.mStartMotionPath.f33y;
        ...
        floatRect2.left = this.mEndMotionPath.f32x;
        floatRect2.top = this.mEndMotionPath.f33y;
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        iArr2[0] = i6;
        double[][] dArr3 = (double[][]) Array.newInstance((Class<?>) Double.TYPE, iArr2);
        double[] dArr4 = new double[i6];
        for (int i15 = 0; i15 < i6; i15++) {
            motionPathsArr[i15].fillStandard(dArr3[i15], this.mInterpolateVariables);
            dArr4[i15] = motionPathsArr[i15].time;
        }
        int i16 = 0;
        while (true) {
        ...
        while (true) {
            ...
            while (i19 < i6) {
                if (motionPathsArr[i19].hasCustomData(str10)) {
                    ...
                    dArr2[i20] = motionPathsArr[i19].time;
                    motionPathsArr[i19].getCustomData(str10, dArr6[i20], 0);
                    i20++;
                } else {
                    dArr2 = dArr5;
                    dArr2 = dArr2;
            ...
            dArr2 = dArr5;
            i18++;
            this.mSpline[i18] = CurveFit.get(this.mCurveFitType, Arrays.copyOf(dArr2, i20), (double[][]) Arrays.copyOf(dArr6, i20));
        }
        ...
        if (motionPathsArr[0].mPathMotionArc != -1) {
            ...
            for (int i21 = 0; i21 < i6; i21++) {
                ...
                dArr8[i21][0] = motionPathsArr[i21].f32x;
                dArr8[i21][i3] = motionPathsArr[i21].f33y;
            }
    ...
    private static DifferentialInterpolator getInterpolator(int i, String str, int i2) {
        ...
        return new DifferentialInterpolator() { // from class: androidx.constraintlayout.core.motion.Motion.1
            ...
            public float getVelocity() {
                return (float) interpolator.getDiff(this.f29mX);
            }
        };
    }
    ...
    public boolean interpolate(MotionWidget motionWidget, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float f5 = this.mStartMotionPath.f32x + ((this.mEndMotionPath.f32x - this.mStartMotionPath.f32x) * f4) + 0.5f;
            float f6 = this.mStartMotionPath.f33y + ((this.mEndMotionPath.f33y - this.mStartMotionPath.f33y) * f4) + 0.5f;
