...
public class ConstraintWidgetContainer extends WidgetContainer {
    ...
    /* JADX WARN: Code duplicated, block: B:131:0x023e A[LOOP:5: B:130:0x023c->B:131:0x023e, LOOP_END] */
    ...
    /* JADX WARN: Code duplicated, block: B:172:0x0349 A[PHI: r13 r19
  ...
  0x0349: PHI (r19v4 ??) = (r19v3 ??), (r19v6 ??), (r19v6 ??), (r19v6 ??) binds: [B:158:0x0303, B:167:0x032e, B:168:0x0330, B:170:0x0336] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Code duplicated, block: B:174:0x034d  */
        ...
        while (AddChildrenToSolver != 0) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (AddChildrenToSolver != 0) {
                                UpdateChildrenFromSolver = updateChildrenFromSolver(this.mSystem, Optimizer.flags);
                            } else {
            ...
            if (z4 || i10 >= 8 || !Optimizer.flags[c]) {
                ...
                while (i12 < size) {
                    ...
                    iMax5 = Math.max(iMax5, constraintWidget3.f52mX + constraintWidget3.getWidth());
                    iMax6 = Math.max(iMax6, constraintWidget3.f53mY + constraintWidget3.getHeight());
                    i12++;
                    r0 = r0 == true ? 1 : 0;
                }
                r0 = UpdateChildrenFromSolver;
