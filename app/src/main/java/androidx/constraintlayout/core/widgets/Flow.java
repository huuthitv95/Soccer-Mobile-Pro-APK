    ...
    private void measureChainWrap_new(ConstraintWidget[] constraintWidgetArr, int i, int i2, int i3, int[] iArr) {
        ...
        if (i2 == 0) {
            ...
            while (i10 < i) {
                ...
                int i12 = i4;
                boolean z2 = (i9 == i7 || (flow2.mHorizontalGap + i9) + widgetWidth > i7) && widgetsList.biggest != null;
                if (!z2 && i10 > 0 && (i6 = flow2.mMaxElementsWrap) > 0 && i11 > i6) {
                    z2 = true;
                }
                if (z2) {
                    widgetsList = flow2.new WidgetsList(i2, flow2.mLeft, flow2.mTop, flow2.mRight, flow2.mBottom, i7);
            ...
            while (i14 < i) {
                ...
                int i15 = i4;
                boolean z3 = (i13 == i7 || (flow2.mVerticalGap + i13) + widgetHeight > i7) && widgetsList.biggest != null;
                if (!z3 && i14 > 0 && (i5 = flow2.mMaxElementsWrap) > 0 && i5 < 0) {
                    z3 = true;
                }
                if (z3) {
                    widgetsList = flow2.new WidgetsList(i2, flow2.mLeft, flow2.mTop, flow2.mRight, flow2.mBottom, i7);
