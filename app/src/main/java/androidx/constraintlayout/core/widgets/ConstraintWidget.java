...
public class ConstraintWidget {
    ...
    public int getX() {
        ...
        if (constraintWidget != null && (constraintWidget instanceof ConstraintWidgetContainer)) {
            return ((ConstraintWidgetContainer) constraintWidget).mPaddingLeft + this.f52mX;
        }
        return this.f52mX;
    }
    ...
    public int getY() {
        ConstraintWidget constraintWidget = this.mParent;
        if (constraintWidget != null && (constraintWidget instanceof ConstraintWidgetContainer)) {
            return ((ConstraintWidgetContainer) constraintWidget).mPaddingTop + this.f53mY;
        }
        return this.f53mY;
    }
    ...
    public void setGoneMargin(ConstraintAnchor.Type type, int i) {
        int i2 = C02041.f54x6930e354[type.ordinal()];
        if (i2 == 1) {
  ...
  0x0086: PHI (r0v2 int) = (r0v1 int), (r0v0 int), (r0v0 int), (r0v0 int), (r0v0 int), (r0v0 int) binds: [B:46:0x0086, B:36:0x007f, B:24:0x0051, B:26:0x0057, B:28:0x0063, B:30:0x0067] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type type) {
        switch (C02041.f54x6930e354[type.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    /* JADX WARN: Code duplicated, block: B:109:0x01b6  */
    /* JADX WARN: Code duplicated, block: B:111:0x01bf  */
    /* JADX WARN: Code duplicated, block: B:114:0x01cf A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:115:0x01d1  */
    /* JADX WARN: Code duplicated, block: B:116:0x01da  */
    /* JADX WARN: Code duplicated, block: B:117:0x01dc A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:120:0x01e2 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:121:0x01e4 A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:130:0x01fc A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:144:0x022f  */
    /* JADX WARN: Code duplicated, block: B:146:0x0234 A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:308:0x04a5 A[PHI: r7
  0x04a5: PHI (r7v13 int) = (r7v12 int), (r7v17 int), (r7v17 int), (r7v17 int) binds: [B:301:0x0495, B:303:0x049b, B:304:0x049d, B:306:0x04a1] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /* JADX WARN: Code duplicated, block: B:330:0x04e6 A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:351:0x0514  */
    /* JADX WARN: Code duplicated, block: B:353:0x051d A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:37:0x0097  */
    /* JADX WARN: Code duplicated, block: B:380:? A[ADDED_TO_REGION, RETURN, SYNTHETIC] */
    ...
    /* JADX WARN: Code duplicated, block: B:46:0x00af A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:47:0x00b1 A[ADDED_TO_REGION] */
    /* JADX WARN: Code duplicated, block: B:50:0x00bc A[DONT_INVERT] */
    ...
    /* JADX WARN: Code duplicated, block: B:92:0x0133 A[DONT_INVERT] */
    ...
    private void applyConstraints(LinearSystem linearSystem, boolean z, boolean z2, boolean z3, boolean z4, SolverVariable solverVariable, SolverVariable solverVariable2, DimensionBehaviour dimensionBehaviour, boolean z5, ConstraintAnchor constraintAnchor, ConstraintAnchor constraintAnchor2, int i, int i2, int i3, int i4, float f, boolean z6, boolean z7, boolean z8, boolean z9, boolean z10, int i5, int i6, int i7, int i8, float f2, boolean z11) {
        ...
        int i28 = z6 ? 3 : i5;
        int i29 = C02041.f55x6d00e4a2[dimensionBehaviour.ordinal()];
        if (i29 != 1 && i29 != 2 && i29 != 3 && i29 == 4) {
            ...
            if (!z12) {
                if (i27 == 2 && !z6 && (i9 == 1 || i9 == 0)) {
                    ...
                    if (i9 == 1) {
                        ...
                        if (i9 == 2) {
                            ...
                            solverVariableCreateObjectVariable4 = solverVariableCreateObjectVariable4;
                            linearSystem.addConstraint(linearSystem.createRow().createRowDimensionRatio(solverVariableCreateObjectVariable4, solverVariableCreateObjectVariable3, solverVariable5, solverVariableCreateObjectVariable, f2));
                            if (z2) {
                                z12 = false;
                            }
                            z13 = z12;
                    ...
                    if (z8) {
                        if (zIsConnected && !zIsConnected2 && !zIsConnected3) {
                            ...
                            if (zIsConnected && zIsConnected2) {
                                linearSystem.addEquality(solverVariableCreateObjectVariable4, solverVariable3, -constraintAnchor2.getMargin(), 8);
                                if (z2) {
                                    if (this.OPTIMIZE_WRAP && solverVariableCreateObjectVariable3.isFinalValue && (constraintWidget2 = this.mParent) != null) {
                                ...
                                if (!zIsConnected && zIsConnected2) {
                                    ...
                                    if (!z13) {
                                        i14 = 8;
                                        if (solverVariableCreateObjectVariable5.isFinalValue && solverVariable3.isFinalValue) {
                                            SolverVariable solverVariable6 = solverVariable3;
                                            linearSystem.addCentering(solverVariableCreateObjectVariable3, solverVariableCreateObjectVariable5, constraintAnchor.getMargin(), f, solverVariable6, solverVariableCreateObjectVariable4, constraintAnchor2.getMargin(), 8);
                                            if (z2 && z4) {
                                        ...
                                        i14 = 8;
                                        if (i9 == 2) {
                                            i15 = ((constraintWidget4 instanceof Barrier) || (constraintWidget5 instanceof Barrier)) ? 4 : 5;
                                            i16 = 5;
                                        } else if (i9 == 1) {
                                            solverVariableCreateObjectVariable3 = solverVariableCreateObjectVariable3;
                                            solverVariable3 = solverVariable3;
                                            ...
                                            if (this.mResolvedDimensionRatioSide == -1) {
                                                ...
                                                if (z6) {
                                                    ...
                                                    if (i26 > 0) {
                                                        ...
                                                        i16 = (constraintWidget4 == parent || constraintWidget5 == parent) ? 5 : 4;
                                                        i15 = 4;
                                                    } else {
                                                        i15 = 8;
                                                    }
                                    ...
                                    if (z16 && solverVariableCreateObjectVariable5 == solverVariable3 && constraintWidget4 != parent) {
                                        z16 = false;
                                        z18 = false;
                                    } else {
                                        z18 = true;
                                    ...
                                    if (z15) {
                                        if (z13 || z7 || z9 || solverVariableCreateObjectVariable5 != solverVariable || solverVariable3 != solverVariable2) {
                                            i20 = i30;
                                            z21 = z2;
                                        } else {
                                            i20 = i14;
                                        ...
                                        linearSystem.addCentering(solverVariableCreateObjectVariable3, solverVariableCreateObjectVariable5, constraintAnchor.getMargin(), f, solverVariable3, solverVariable7, constraintAnchor2.getMargin(), i20);
                                        solverVariable3 = solverVariable3;
                                    ...
                                    z19 = z2;
                                    if (this.mVisibility == i14 && !constraintAnchor2.hasDependents()) {
                                        return;
                                    }
                                    if (z16) {
                                        int i31 = (!z19 || solverVariableCreateObjectVariable5 == solverVariable3 || z13 || !((constraintWidget4 instanceof Barrier) || (constraintWidget instanceof Barrier))) ? i16 : 6;
                                        linearSystem.addGreaterThan(solverVariableCreateObjectVariable3, solverVariableCreateObjectVariable5, constraintAnchor.getMargin(), i31);
                                        linearSystem.addLowerThan(solverVariableCreateObjectVariable4, solverVariable3, -constraintAnchor2.getMargin(), i31);
                                        i16 = i31;
                                    }
                                    if (!z19 || !z10 || (constraintWidget4 instanceof Barrier) || (constraintWidget instanceof Barrier) || constraintWidget == parent) {
                                        iMin2 = i15;
                                        i17 = i16;
                                        z20 = z18;
                                    } else {
                                    ...
                                    if (z20) {
                                        if (z17 && (!z9 || z3)) {
                                            if (constraintWidget4 != parent && constraintWidget != parent) {
                                                i30 = iMin2;
                                            }
                                            ...
                                            iMin2 = Math.max(z9 ? 5 : i30, iMin2);
                                        }
                                        if (z19) {
                                            iMin2 = Math.min(i17, iMin2);
                                            if (z6 && !z9 && (constraintWidget4 == parent || constraintWidget == parent)) {
                                                i19 = 4;
                                            } else {
                                                i19 = iMin2;
                                            }
                                        ...
                                        linearSystem.addEquality(solverVariableCreateObjectVariable3, solverVariableCreateObjectVariable5, constraintAnchor.getMargin(), i19);
                                        linearSystem.addEquality(solverVariableCreateObjectVariable4, solverVariable3, -constraintAnchor2.getMargin(), i19);
                                    }
                                    if (z19) {
                                    ...
                                    if (!z19 || !z13 || i3 != 0 || i11 != 0) {
                                        i18 = 5;
                                    } else if (z13 && i9 == 3) {
                                        linearSystem.addGreaterThan(solverVariableCreateObjectVariable4, solverVariableCreateObjectVariable3, 0, i14);
                                        i18 = 5;
                                    } else {
                                        i18 = 5;
                            ...
                            z19 = z2;
                            solverVariable3 = solverVariable3;
                            i25 = (z2 && (constraintAnchor.mTarget.mOwner instanceof Barrier)) ? 8 : 5;
                        }
                        if (z19 || !z4) {
                            return;
                        }
                        ...
                        if (solverVariable3 != solverVariable2) {
                            if (this.OPTIMIZE_WRAP && solverVariableCreateObjectVariable4.isFinalValue && (constraintWidget3 = this.mParent) != null) {
                            ...
                            linearSystem.addGreaterThan(solverVariable2, solverVariableCreateObjectVariable4, margin3, i25);
                            return;
                        }
                        return;
                    }
                ...
                if (i27 >= c && z2 && z4) {
                    linearSystem.addGreaterThan(solverVariableCreateObjectVariable3, solverVariable, 0, i13);
                    ...
                    if (z14) {
                        linearSystem.addGreaterThan(solverVariable2, solverVariableCreateObjectVariable4, 0, i13);
                        return;
                    }
                    return;
                }
        ...
        if (!z12) {
            ...
            if (i9 == 1) {
                ...
                if (i9 == 2) {
                    ...
                    solverVariableCreateObjectVariable4 = solverVariableCreateObjectVariable4;
                    linearSystem.addConstraint(linearSystem.createRow().createRowDimensionRatio(solverVariableCreateObjectVariable4, solverVariableCreateObjectVariable3, solverVariable8, solverVariableCreateObjectVariable, f2));
                    if (z2) {
                        z12 = false;
                    }
                    z13 = z12;
    ...
    static /* synthetic */ class C02041 {
        ...
        static {
            ...
            try {
                f55x6d00e4a2[DimensionBehaviour.WRAP_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f55x6d00e4a2[DimensionBehaviour.MATCH_PARENT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f55x6d00e4a2[DimensionBehaviour.MATCH_CONSTRAINT.ordinal()] = 4;
            ...
            try {
                f54x6930e354[ConstraintAnchor.Type.TOP.ordinal()] = 2;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f54x6930e354[ConstraintAnchor.Type.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f54x6930e354[ConstraintAnchor.Type.BOTTOM.ordinal()] = 4;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f54x6930e354[ConstraintAnchor.Type.BASELINE.ordinal()] = 5;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f54x6930e354[ConstraintAnchor.Type.CENTER.ordinal()] = 6;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f54x6930e354[ConstraintAnchor.Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f54x6930e354[ConstraintAnchor.Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f54x6930e354[ConstraintAnchor.Type.NONE.ordinal()] = 9;
