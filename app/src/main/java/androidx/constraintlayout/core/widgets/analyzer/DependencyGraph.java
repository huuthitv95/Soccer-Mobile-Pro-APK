...
public class DependencyGraph {
    ...
    /* JADX WARN: Code duplicated, block: B:176:0x0296 A[ADDED_TO_REGION, REMOVE, SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:185:0x029a A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:207:0x0006 A[ADDED_TO_REGION, REMOVE, SYNTHETIC] */
    ...
    private String generateDisplayNode(DependencyNode dependencyNode, boolean z, String str) {
        ...
        for (DependencyNode dependencyNode2 : dependencyNode.targets) {
            ...
            if (dependencyNode.margin > 0 || z || (dependencyNode.run instanceof HelperReferences)) {
                String str3 = str2 + C11744X3.j.f26438d;
