...
public class Debug {
    ...
    public static void dumpPoc(Object obj) {
        ...
        for (Field field : cls.getFields()) {
            try {
                ...
                if (field.getName().startsWith("layout_constraint") && ((!(obj2 instanceof Integer) || !obj2.toString().equals(C11794a2.f26725f)) && ((!(obj2 instanceof Integer) || !obj2.toString().equals("0")) && ((!(obj2 instanceof Float) || !obj2.toString().equals(BuildConfig.VERSION_NAME)) && (!(obj2 instanceof Float) || !obj2.toString().equals("0.5")))))) {
    ...
    public static String getName(Context context, int[] id) {
        ...
        try {
            String str = id.length + C11744X3.j.f26438d;
            int i = 0;
            while (i < id.length) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            for (int i2 = 0; i2 < fields.length; i2++) {
                ...
                try {
                    ...
                    if (field.getName().contains("To") && !obj.toString().equals(C11794a2.f26725f)) {
    ...
    public static void dumpLayoutParams(ViewGroup.LayoutParams param, String str) {
        ...
        for (Field field : param.getClass().getFields()) {
            try {
                ...
                if (name.contains("To") && !obj.toString().equals(C11794a2.f26725f)) {
