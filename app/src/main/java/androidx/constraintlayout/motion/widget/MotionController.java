...
public class MotionController {
    ...
    KeyPositionBase getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        rectF.left = this.mStartMotionPath.f68x;
        rectF.top = this.mStartMotionPath.f69y;
        rectF.right = rectF.left + this.mStartMotionPath.width;
        rectF.bottom = rectF.top + this.mStartMotionPath.height;
        RectF rectF2 = new RectF();
        rectF2.left = this.mEndMotionPath.f68x;
        rectF2.top = this.mEndMotionPath.f69y;
    ...
    float getKeyFrameParameter(int type, float x, float y) {
        float f = this.mEndMotionPath.f68x - this.mStartMotionPath.f68x;
        float f2 = this.mEndMotionPath.f69y - this.mStartMotionPath.f69y;
        float f3 = this.mStartMotionPath.f68x + (this.mStartMotionPath.width / 2.0f);
        float f4 = this.mStartMotionPath.f69y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
            ...
            while (i15 < i2) {
                if (motionPathsArr[i15].hasCustomData(str10)) {
                    if (dArr4 == null) {
                        dArr3 = new double[i2];
                        int[] iArr3 = new int[2];
                        iArr3[c] = motionPathsArr[i15].getCustomDataCount(str10);
                        iArr3[0] = i2;
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i17 = 0; i17 < i2; i17++) {
                ...
                dArr6[i17][0] = motionPathsArr[i17].f68x;
                dArr6[i17][c2] = motionPathsArr[i17].f69y;
            }
    ...
    boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            if (this.mTransformPivotTarget != Key.UNSET) {
                ...
                View view4 = this.mTransformPivotView;
                if (view4 != null) {
            ...
            if (pathRotate != null) {
                ...
                adjustedPosition = f5;
                pathRotate2 = pathRotate.setPathRotate(view, keyCache, f5, time, dArr3[0], dArr3[1]) | pathRotate2;
            } else {
                view = child;
            }
            int i = 1;
            ...
            view = child;
            float f6 = this.mStartMotionPath.f68x + ((this.mEndMotionPath.f68x - this.mStartMotionPath.f68x) * adjustedPosition);
            float f7 = f6 + 0.5f;
            int i3 = (int) f7;
            float f8 = this.mStartMotionPath.f69y + ((this.mEndMotionPath.f69y - this.mStartMotionPath.f69y) * adjustedPosition) + 0.5f;
            int i4 = (int) f8;
            int i5 = (int) (f7 + this.mStartMotionPath.width + ((this.mEndMotionPath.width - this.mStartMotionPath.width) * adjustedPosition));
            int i6 = (int) (f8 + this.mStartMotionPath.height + ((this.mEndMotionPath.height - this.mStartMotionPath.height) * adjustedPosition));
            int i7 = i5 - i3;
            int i8 = i6 - i4;
    ...
    void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float f2 = this.mEndMotionPath.f68x - this.mStartMotionPath.f68x;
        float f3 = this.mEndMotionPath.f69y - this.mStartMotionPath.f69y;
