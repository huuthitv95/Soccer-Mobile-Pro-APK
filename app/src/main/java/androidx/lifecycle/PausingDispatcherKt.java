...
public final class PausingDispatcherKt {
    ...
    @DebugMetadata(m43503c = "androidx.lifecycle.PausingDispatcherKt$whenStateAtLeast$2", m43504f = "PausingDispatcher.kt", m43505i = {0}, m43506l = {203}, m43507m = "invokeSuspend", m43508n = {"controller"}, m43509s = {"L$0"})
    static final class C06272<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C06272(Lifecycle lifecycle, Lifecycle.State state, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super C06272> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C06272 c06272 = new C06272(this.$this_whenStateAtLeast, this.$minState, this.$block, continuation);
            c06272.L$0 = obj;
            return c06272;
        }
    ...
    public static final <T> Object whenStateAtLeast(Lifecycle lifecycle, Lifecycle.State state, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return BuildersKt.withContext(Dispatchers.getMain().getImmediate(), new C06272(lifecycle, state, function2, null), continuation);
    }
}
