...
@Metadata(m43474d1 = {"\u0000\u0016\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u001a.\u0010\u0000\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u00012\u0006\u0010\u0003\u001a\u00020\u00042\b\b\u0002\u0010\u0005\u001a\u00020\u0006¨\u0006\u0007"}, m43475d2 = {"flowWithLifecycle", "Lkotlinx/coroutines/flow/Flow;", "T", "lifecycle", "Landroidx/lifecycle/Lifecycle;", "minActiveState", "Landroidx/lifecycle/Lifecycle$State;", "lifecycle-runtime-ktx_release"}, m43476k = 2, m43477mv = {1, 8, 0}, m43479xi = 48)
public final class FlowExtKt {
    ...
    @DebugMetadata(m43503c = "androidx.lifecycle.FlowExtKt$flowWithLifecycle$1", m43504f = "FlowExt.kt", m43505i = {0}, m43506l = {91}, m43507m = "invokeSuspend", m43508n = {"$this$callbackFlow"}, m43509s = {"L$0"})
    static final class C06201<T> extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        C06201(Lifecycle lifecycle, Lifecycle.State state, Flow<? extends T> flow, Continuation<? super C06201> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C06201 c06201 = new C06201(this.$lifecycle, this.$minActiveState, this.$this_flowWithLifecycle, continuation);
            c06201.L$0 = obj;
            return c06201;
        }
        ...
        @DebugMetadata(m43503c = "androidx.lifecycle.FlowExtKt$flowWithLifecycle$1$1", m43504f = "FlowExt.kt", m43505i = {}, m43506l = {92}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    ...
    public static final <T> Flow<T> flowWithLifecycle(Flow<? extends T> flow, Lifecycle lifecycle, Lifecycle.State minActiveState) {
        ...
        return FlowKt.callbackFlow(new C06201(lifecycle, minActiveState, flow, null));
    }
}
