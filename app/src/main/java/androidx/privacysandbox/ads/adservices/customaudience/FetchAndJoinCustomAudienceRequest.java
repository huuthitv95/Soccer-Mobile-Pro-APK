...
public final class FetchAndJoinCustomAudienceRequest {
    ...
    public final android.adservices.customaudience.FetchAndJoinCustomAudienceRequest convertToAdServices$ads_adservices_release() {
        AdFilters$$ExternalSyntheticApiModelOutline0.m43641m$1();
        android.adservices.customaudience.FetchAndJoinCustomAudienceRequest.Builder expirationTime = AdFilters$$ExternalSyntheticApiModelOutline0.m689m(this.fetchUri).setName(this.name).setActivationTime(this.activationTime).setExpirationTime(this.expirationTime);
        AdSelectionSignals adSelectionSignals = this.userBiddingSignals;
