...
public class CustomAudienceManagerImplCommon extends CustomAudienceManager {
    ...
    public final android.adservices.customaudience.JoinCustomAudienceRequest convertJoinRequest(JoinCustomAudienceRequest request) {
        android.adservices.customaudience.JoinCustomAudienceRequest joinCustomAudienceRequestBuild = AdFilters$$ExternalSyntheticApiModelOutline0.m691m().setCustomAudience(convertCustomAudience(request.getCustomAudience())).build();
    ...
    public final android.adservices.customaudience.LeaveCustomAudienceRequest convertLeaveRequest(LeaveCustomAudienceRequest request) {
        android.adservices.customaudience.LeaveCustomAudienceRequest leaveCustomAudienceRequestBuild = AdFilters$$ExternalSyntheticApiModelOutline0.m694m().setBuyer(request.getBuyer().convertToAdServices$ads_adservices_release()).setName(request.getName()).build();
    ...
    private final android.adservices.customaudience.CustomAudience convertCustomAudience(CustomAudience request) {
        android.adservices.customaudience.CustomAudience.Builder trustedBiddingData = AdFilters$$ExternalSyntheticApiModelOutline0.m675m().setActivationTime(request.getActivationTime()).setAds(convertAds(request.getAds())).setBiddingLogicUri(request.getBiddingLogicUri()).setBuyer(request.getBuyer().convertToAdServices$ads_adservices_release()).setDailyUpdateUri(request.getDailyUpdateUri()).setExpirationTime(request.getExpirationTime()).setName(request.getName()).setTrustedBiddingData(convertTrustedSignals(request.getTrustedBiddingSignals()));
    ...
    private final android.adservices.customaudience.TrustedBiddingData convertTrustedSignals(TrustedBiddingData input) {
        ...
        return AdFilters$$ExternalSyntheticApiModelOutline0.m698m().setTrustedBiddingKeys(input.getTrustedBiddingKeys()).setTrustedBiddingUri(input.getTrustedBiddingUri()).build();
    }

    /* JADX INFO: compiled from: CustomAudienceManagerImplCommon.kt */
    @Metadata(m43474d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\b\u0003\u0018\u0000 \u00032\u00020\u0001:\u0001\u0003B\u0007\b\u0002¢\u0006\u0002\u0010\u0002¨\u0006\u0004"}, m43475d2 = {"Landroidx/privacysandbox/ads/adservices/customaudience/CustomAudienceManagerImplCommon$Ext10Impl;", "", "()V", "Companion", "ads-adservices_release"}, m43476k = 1, m43477mv = {1, 8, 0}, m43479xi = 48)
