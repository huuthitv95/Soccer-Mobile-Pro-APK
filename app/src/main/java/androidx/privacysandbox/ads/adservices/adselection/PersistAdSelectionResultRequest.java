...
public final class PersistAdSelectionResultRequest {
    ...
    public int hashCode() {
        int iM43485m = UByte$$ExternalSyntheticBackport0.m43485m(this.adSelectionId) * 31;
        AdTechIdentifier adTechIdentifier = this.seller;
        int iHashCode = (iM43485m + (adTechIdentifier != null ? adTechIdentifier.hashCode() : 0)) * 31;
    ...
    public final android.adservices.adselection.PersistAdSelectionResultRequest convertToAdServices$ads_adservices_release() {
        android.adservices.adselection.PersistAdSelectionResultRequest.Builder adSelectionId = DefaultTimeBar$$ExternalSyntheticApiModelOutline0.m588m().setAdSelectionId(this.adSelectionId);
        AdTechIdentifier adTechIdentifier = this.seller;
