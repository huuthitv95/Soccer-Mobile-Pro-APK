...
public class FragmentedMp4Extractor implements Extractor {
    ...
    public FragmentedMp4Extractor() {
        this(SubtitleParser.Factory.UNSUPPORTED, 32, null, null, ImmutableList.m22832of(), null);
    }

    public FragmentedMp4Extractor(SubtitleParser.Factory factory) {
        this(factory, 0, null, null, ImmutableList.m22832of(), null);
    }

    @Deprecated
    public FragmentedMp4Extractor(int i) {
        this(SubtitleParser.Factory.UNSUPPORTED, i | 32, null, null, ImmutableList.m22832of(), null);
    }

    public FragmentedMp4Extractor(SubtitleParser.Factory factory, int i) {
        this(factory, i, null, null, ImmutableList.m22832of(), null);
    }

    @Deprecated
    public FragmentedMp4Extractor(int i, TimestampAdjuster timestampAdjuster) {
        this(SubtitleParser.Factory.UNSUPPORTED, i | 32, timestampAdjuster, null, ImmutableList.m22832of(), null);
    }

    @Deprecated
    public FragmentedMp4Extractor(int i, TimestampAdjuster timestampAdjuster, Track track) {
        this(SubtitleParser.Factory.UNSUPPORTED, i | 32, timestampAdjuster, track, ImmutableList.m22832of(), null);
    }
    ...
    public FragmentedMp4Extractor(SubtitleParser.Factory factory, int i, TimestampAdjuster timestampAdjuster, Track track, List<Format> list, TrackOutput trackOutput) {
        ...
        this.lastSniffFailures = ImmutableList.m22832of();
    ...
    public boolean sniff(ExtractorInput extractorInput) throws IOException {
        ...
        this.lastSniffFailures = sniffFailureSniffFragmented != null ? ImmutableList.m22833of(sniffFailureSniffFragmented) : ImmutableList.m22832of();
    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        if (this.trackBundles.size() == 0) {
            while (i < size2) {
                ...
                this.trackBundles.put(track.f171id, new TrackBundle(this.extractorOutput.track(i, track.type), trackSampleTable, getDefaultSampleValues(sparseArray, track.f171id)));
        ...
        while (i < size2) {
            ...
            this.trackBundles.get(track2.f171id).reset(trackSampleTable2, getDefaultSampleValues(sparseArray, track2.f171id));
            i++;
        }
    }
    ...
    private void onEmsgLeafAtomRead(ParsableByteArray parsableByteArray) {
        ...
        if (fullAtomVersion == 0) {
            ...
            if (fullAtomVersion != 1) {
                Log.m291w(TAG, "Skipping unsupported emsg version: " + fullAtomVersion);
                return;
            }
    ...
    private boolean readSample(ExtractorInput extractorInput) throws IOException {
        ...
        if (nextTrackBundle == null) {
            ...
            if (currentSampleOffset < 0) {
                Log.m291w(TAG, "Ignoring negative offset to sample data.");
    ...
    private static DrmInitData getDrmInitDataFromAtoms(List<Atom.LeafAtom> list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (leafAtom.type == 1886614376) {
                ...
                if (uuid == null) {
                    Log.m291w(TAG, "Skipped pssh atom (failed to extract uuid)");
                } else {
