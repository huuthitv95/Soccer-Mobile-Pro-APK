...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    public boolean sniff(ExtractorInput extractorInput) throws IOException {
        ...
        this.lastSniffFailures = sniffFailureSniffUnfragmented != null ? ImmutableList.m22833of(sniffFailureSniffUnfragmented) : ImmutableList.m22832of();
    ...
    private void processMoovAtom(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        int size = -1;
        for (List<TrackSampleTable> traks = AtomParsers.parseTraks(containerAtom, gaplessInfoHolder, -9223372036854775807L, null, (this.flags & 1) != 0, z, new Function() { // from class: androidx.media3.extractor.mp4.Mp4Extractor$$ExternalSyntheticLambda0
            ...
            if (trackSampleTable.sampleCount == 0) {
                ...
                long j2 = j;
                long j3 = track.durationUs != -9223372036854775807L ? track.durationUs : trackSampleTable.durationUs;
                int i6 = i3;
