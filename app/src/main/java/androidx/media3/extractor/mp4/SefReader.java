...
final class SefReader {
    ...
    private static final Splitter COLON_SPLITTER = Splitter.m22810on(AbstractJsonLexerKt.COLON);
    private static final Splitter ASTERISK_SPLITTER = Splitter.m22810on('*');
