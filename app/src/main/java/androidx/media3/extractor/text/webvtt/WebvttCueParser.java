...
public final class WebvttCueParser {
    ...
    private static WebvttCueInfo parseCue(String str, Matcher matcher, ParsableByteArray parsableByteArray, List<WebvttCssStyle> list) {
        ...
        try {
            ...
            Log.m291w(TAG, "Skipping cue with bad header: " + matcher.group());
            return null;
        }
    }
        ...
        while (matcher.find()) {
            ...
            try {
                if ("line".equals(str2)) {
                    ...
                    Log.m291w(TAG, "Unknown cue setting " + str2 + CertificateUtil.DELIMITER + str3);
                }
            } catch (NumberFormatException unused) {
                Log.m291w(TAG, "Skipping bad cue setting: " + matcher.group());
            }
        }
    }
    ...
    private static int parseLineAnchor(String str) {
        ...
        switch (str) {
            ...
            case "start":
                return 0;
            default:
                Log.m291w(TAG, "Invalid anchor value: " + str);
    ...
    private static int parseVerticalAttribute(String str) {
        ...
        Log.m291w(TAG, "Invalid 'vertical' value: " + str);
        return Integer.MIN_VALUE;
    }
    ...
    private static int parseTextAlignment(String str) {
        ...
        switch (str) {
            ...
            case "start":
                return 1;
            default:
                Log.m291w(TAG, "Invalid alignment value: " + str);
                return 2;
        }
    }
    ...
    private static void applyEntity(String str, SpannableStringBuilder spannableStringBuilder) {
        ...
        switch (str) {
            ...
            case "nbsp":
                ...
                break;
            default:
                Log.m291w(TAG, "ignoring unsupported entity: '&" + str + ";'");
                break;
        }
    }
        ...
        private static Layout.Alignment convertTextAlignment(int i) {
            if (i != 1) {
                ...
                if (i != 3) {
                    if (i != 4) {
                        if (i != 5) {
                            Log.m291w(WebvttCueParser.TAG, "Unknown textAlignment: " + i);
                            return null;
                        }
                    }
                }
