...
final class SsaStyle {
    ...
    public static SsaStyle fromStyleLine(String str, Format format) {
        ...
        if (strArrSplit.length != format.length) {
            Log.m291w(TAG, Util.formatInvariant("Skipping malformed 'Style:' line (expected %s values, found %s): '%s'", Integer.valueOf(format.length), Integer.valueOf(strArrSplit.length), str));
            return null;
        }
        try {
            try {
                ...
                e = e;
                Log.m292w(TAG, "Skipping malformed 'Style:' line: '" + str + "'", e);
                return 0;
            }
    ...
    public static int parseAlignment(String str) {
        ...
        Log.m291w(TAG, "Ignoring unknown alignment: " + str);
        return -1;
    }
    ...
    private static int parseBorderStyle(String str) {
        ...
        Log.m291w(TAG, "Ignoring unknown BorderStyle: " + str);
        return -1;
    }
    ...
    public static Integer parseColor(String str) {
        ...
        try {
            ...
            Log.m292w(TAG, "Failed to parse color expression: '" + str + "'", e);
            return null;
        }
    }
    ...
    private static float parseFontSize(String str) {
        try {
            ...
            Log.m292w(TAG, "Failed to parse font size: '" + str + "'", e);
    ...
    private static boolean parseBooleanValue(String str) {
        try {
            ...
            Log.m292w(TAG, "Failed to parse boolean value: '" + str + "'", e);
            return false;
        }
    }
    ...
    static final class Overrides {
        ...
        private static PointF parsePosition(String str) {
            ...
            if (zFind) {
                if (zFind2) {
                    Log.m289i(TAG, "Override has both \\pos(x,y) and \\move(x1,y1,x2,y2); using \\pos values. override='" + str + "'");
                }
