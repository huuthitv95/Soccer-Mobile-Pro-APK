...
public class MatroskaExtractor implements Extractor {
    ...
    protected void endMasterElement(int i) throws ParserException {
        ...
        if (i == ID_CONTENT_ENCODING) {
            ...
            if (this.currentTrack.hasContentEncryption) {
                ...
                this.currentTrack.drmInitData = new DrmInitData(new DrmInitData.SchemeData(C0684C.UUID_NIL, "video/webm", this.currentTrack.cryptoData.encryptionKey));
                return;
            }
            return;
        }
        ...
        if (track.trueHdSampleRechunker != null) {
            ...
            if (CODEC_ID_SUBRIP.equals(track.codecId) || CODEC_ID_ASS.equals(track.codecId) || CODEC_ID_VTT.equals(track.codecId)) {
                if (this.blockSampleCount > 1) {
                    Log.m291w(TAG, "Skipping subtitle sample in laced block.");
                } else if (this.blockDurationUs == -9223372036854775807L) {
                    Log.m291w(TAG, "Skipping subtitle sample with no duration.");
                } else {
    ...
    private SeekMap buildSeekMap(LongArray longArray, LongArray longArray2) {
        ...
        jArrCopyOf2[i] = j;
        if (j <= 0) {
            Log.m291w(TAG, "Discarding last cue point with unexpected duration: " + j);
    ...
    protected static final class Track {
        ...
        /* JADX WARN: Code duplicated, block: B:215:0x041f  */
        /* JADX WARN: Code duplicated, block: B:218:0x042c  */
        /* JADX WARN: Code duplicated, block: B:219:0x043e  */
        /* JADX WARN: Code duplicated, block: B:221:0x0444  */
        /* JADX WARN: Code duplicated, block: B:223:0x0448  */
        /* JADX WARN: Code duplicated, block: B:225:0x044d  */
        /* JADX WARN: Code duplicated, block: B:228:0x0455  */
        /* JADX WARN: Code duplicated, block: B:230:0x045a  */
        /* JADX WARN: Code duplicated, block: B:233:0x045f  */
        /* JADX WARN: Code duplicated, block: B:236:0x046d  */
        /* JADX WARN: Code duplicated, block: B:239:0x0473  */
        /* JADX WARN: Code duplicated, block: B:242:0x04a6  */
        /* JADX WARN: Code duplicated, block: B:247:0x04c6  */
        /* JADX WARN: Code duplicated, block: B:266:0x0512  */
        /* JADX WARN: Code duplicated, block: B:268:0x0538  */
        /* JADX WARN: Code duplicated, block: B:270:0x053e  */
        /* JADX WARN: Code duplicated, block: B:286:0x056b  */
            ...
            switch (b) {
                ...
                case 2:
                    ...
                    if (parseMsAcmCodecPrivate(new ParsableByteArray(getCodecPrivate(this.codecId)))) {
                        ...
                        Log.m291w(MatroskaExtractor.TAG, "Unsupported PCM bit depth: " + this.audioBitDepth + ". Setting mimeType to audio/x-unknown");
                    } else {
                        Log.m291w(MatroskaExtractor.TAG, "Non-PCM MS/ACM is unsupported. Setting mimeType to audio/x-unknown");
                    }
                    listSingletonList = null;
                    str = null;
                ...
                case 8:
                    ...
                    listSingletonList = ImmutableList.m22833of(bArr2);
                ...
                case 10:
                    ...
                    return;
                case 11:
                    listSingletonList = ImmutableList.m22833of(getCodecPrivate(this.codecId));
                    str = null;
                ...
                case 22:
                    if (this.audioBitDepth != 32) {
                        Log.m291w(MatroskaExtractor.TAG, "Unsupported floating point PCM bit depth: " + this.audioBitDepth + ". Setting mimeType to audio/x-unknown");
                        listSingletonList = null;
                        str = null;
                        str5 = "audio/x-unknown";
                        i2 = 0;
                ...
                case 23:
                    ...
                    if (i20 == 8) {
                        ...
                        pcmEncoding = C0684C.ENCODING_PCM_24BIT_BIG_ENDIAN;
                    } else {
                        if (i20 != 32) {
                            Log.m291w(MatroskaExtractor.TAG, "Unsupported big endian PCM bit depth: " + this.audioBitDepth + ". Setting mimeType to audio/x-unknown");
                            listSingletonList = null;
                            str = null;
                            str5 = "audio/x-unknown";
                            i2 = 0;
                        ...
                        pcmEncoding = C0684C.ENCODING_PCM_32BIT_BIG_ENDIAN;
                    }
                    listSingletonList = null;
                    str = null;
                    i2 = 0;
                ...
                case 24:
                    pcmEncoding = Util.getPcmEncoding(this.audioBitDepth);
                    if (pcmEncoding == 0) {
                        Log.m291w(MatroskaExtractor.TAG, "Unsupported little endian PCM bit depth: " + this.audioBitDepth + ". Setting mimeType to audio/x-unknown");
                        listSingletonList = null;
                        str = null;
                        str5 = "audio/x-unknown";
                        i2 = 0;
                    ...
                    return;
                case 25:
                    listSingletonList = ImmutableList.m22834of(MatroskaExtractor.SSA_DIALOGUE_FORMAT, getCodecPrivate(this.codecId));
                    str = null;
                    str5 = "text/x-ssa";
                    i2 = 0;
                    i3 = -1;
        ...
        private static Pair<String, List<byte[]>> parseFourCcPrivate(ParsableByteArray parsableByteArray) throws ParserException {
            try {
                ...
                Log.m291w(MatroskaExtractor.TAG, "Unknown FourCC. Setting mimeType to video/x-unknown");
