...
public final class BinaryFrame extends Id3Frame {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            if (this.f166id.equals(binaryFrame.f166id) && Arrays.equals(this.data, binaryFrame.data)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return ((IronSourceError.ERROR_NON_EXISTENT_INSTANCE + this.f166id.hashCode()) * 31) + Arrays.hashCode(this.data);
    }
