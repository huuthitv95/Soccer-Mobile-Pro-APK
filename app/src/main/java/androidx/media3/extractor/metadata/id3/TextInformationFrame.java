...
public final class TextInformationFrame extends Id3Frame {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            if (Util.areEqual(this.f166id, textInformationFrame.f166id) && Util.areEqual(this.description, textInformationFrame.description) && this.values.equals(textInformationFrame.values)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        int iHashCode = (IronSourceError.ERROR_NON_EXISTENT_INSTANCE + this.f166id.hashCode()) * 31;
    ...
    public String toString() {
        return this.f166id + ": description=" + this.description + ": values=" + this.values;
    }
