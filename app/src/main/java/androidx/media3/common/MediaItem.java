...
public final class MediaItem {
    ...
    public static final class Builder {
        ...
        public Builder() {
            ...
            this.subtitleConfigurations = ImmutableList.m22832of();
        ...
        public Builder setStreamKeys(List<StreamKey> list) {
            ...
            this.streamKeys = listUnmodifiableList;
            return this;
        }
        ...
        public Builder setSubtitles(List<Subtitle> list) {
            this.subtitleConfigurations = list != null ? ImmutableList.copyOf((Collection) list) : ImmutableList.m22832of();
            return this;
        }
    ...
    public static final class DrmConfiguration {
        ...
        public static final class Builder {
            ...
            @Deprecated
            private Builder() {
                this.licenseRequestHeaders = ImmutableMap.m22851of();
                this.playClearContentWithoutKey = true;
                this.forcedSessionTrackTypes = ImmutableList.m22832of();
            }
            ...
            public Builder setForceSessionsForAudioAndVideoTracks(boolean z) {
                ImmutableList immutableListM22832of;
                if (z) {
                    immutableListM22832of = ImmutableList.m22834of(2, 1);
                } else {
                    immutableListM22832of = ImmutableList.m22832of();
                }
                setForcedSessionTrackTypes(immutableListM22832of);
                return this;
            }
    ...
    public static final class LocalConfiguration {
        ...
        public static LocalConfiguration fromBundle(Bundle bundle) {
            ...
            if (parcelableArrayList2 == null) {
                immutableListFromBundleList2 = ImmutableList.m22832of();
            } else {
    ...
    public static class SubtitleConfiguration {
        ...
        public static final class Builder {
            ...
            private Builder(SubtitleConfiguration subtitleConfiguration) {
                ...
                this.f144id = subtitleConfiguration.f143id;
            }
