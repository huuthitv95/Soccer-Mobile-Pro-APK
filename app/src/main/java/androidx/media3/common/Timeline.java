...
public abstract class Timeline {
    ...
    public static final class Period {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null && getClass().equals(obj.getClass())) {
                ...
                if (Util.areEqual(this.f145id, period.f145id) && Util.areEqual(this.uid, period.uid) && this.windowIndex == period.windowIndex && this.durationUs == period.durationUs && this.positionInWindowUs == period.positionInWindowUs && this.isPlaceholder == period.isPlaceholder && Util.areEqual(this.adPlaybackState, period.adPlaybackState)) {
                    return true;
                }
            }
            return false;
    ...
    public final Timeline copyWithSingleWindow(int i) {
        ...
        return new RemotableTimeline(ImmutableList.m22833of(window), builder.build(), new int[]{0});
    }
    ...
    public static final class RemotableTimeline extends Timeline {
        ...
        public Period getPeriod(int i, Period period, boolean z) {
            ...
            period.set(period2.f145id, period2.uid, period2.windowIndex, period2.durationUs, period2.positionInWindowUs, period2.adPlaybackState, period2.isPlaceholder);
            return period;
        }
