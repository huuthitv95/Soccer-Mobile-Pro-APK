...
public final class TrackGroup {
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            this.hashCode = ((IronSourceError.ERROR_NON_EXISTENT_INSTANCE + this.f146id.hashCode()) * 31) + Arrays.hashCode(this.formats);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            if (this.f146id.equals(trackGroup.f146id) && Arrays.equals(this.formats, trackGroup.formats)) {
                return true;
            }
        }
        return false;
    ...
    public Bundle toBundle() {
        ...
        bundle.putString(FIELD_ID, this.f146id);
        return bundle;
    }
    ...
    private static void logErrorMessage(String str, String str2, String str3, int i) {
        Log.m288e(TAG, "", new IllegalStateException("Different " + str + " combined in one TrackGroup: '" + str2 + "' (track 0) and '" + str3 + "' (track " + i + ")"));
    }
}
