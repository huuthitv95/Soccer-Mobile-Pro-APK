...
public abstract class SimpleBasePlayer extends BasePlayer {
    ...
    protected static final class State {
        ...
        public static final class Builder {
            ...
            public Builder() {
                ...
                this.playlist = ImmutableList.m22832of();
    ...
    protected static final class MediaItemData {
        ...
        public static final class Builder {
            ...
            public Builder(Object obj) {
                ...
                this.periods = ImmutableList.m22832of();
            }
    ...
    protected SimpleBasePlayer(Looper looper, Clock clock) {
        ...
        this.listeners = new ListenerSet<>(looper, clock, new ListenerSet.IterationFinishedEvent() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda38
            ...
            public final void invoke(Object obj, FlagSet flagSet) {
                this.f$0.m43610lambda$new$0$androidxmedia3commonSimpleBasePlayer((Player.Listener) obj, flagSet);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$0$androidx-media3-common-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ void m43610lambda$new$0$androidxmedia3commonSimpleBasePlayer(Player.Listener listener, FlagSet flagSet) {
    ...
    private void setMediaItemsInternal(final List<MediaItem> list, final int i, final long j) {
        ...
        if (shouldHandleCommand(20) || (list.size() == 1 && shouldHandleCommand(31))) {
            updateStateForPendingOperation(handleSetMediaItems(list, i, j), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda28
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return this.f$0.m283x396b5ff4(list, state, i, j);
                }
            });
        }
    }

    /* JADX INFO: renamed from: lambda$setMediaItemsInternal$2$androidx-media3-common-SimpleBasePlayer */
    /* synthetic */ State m283x396b5ff4(List list, State state, int i, long j) {
    ...
    public final void addMediaItems(int i, final List<MediaItem> list) {
        ...
        updateStateForPendingOperation(handleAddMediaItems(iMin, list), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda34
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m43608lambda$addMediaItems$3$androidxmedia3commonSimpleBasePlayer(state, list, iMin);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$addMediaItems$3$androidx-media3-common-SimpleBasePlayer, reason: not valid java name */
    /* synthetic */ State m43608lambda$addMediaItems$3$androidxmedia3commonSimpleBasePlayer(State state, List list, int i) {
        ...
        if (shouldHandleCommand(20) && size != 0 && i < size) {
            ...
            if (i != iMin && iMin2 != i) {
                updateStateForPendingOperation(handleMoveMediaItems(i, iMin, iMin2), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda48
                    @Override // com.google.common.base.Supplier
                    public final Object get() {
                        return this.f$0.m43609lambda$moveMediaItems$4$androidxmedia3commonSimpleBasePlayer(state, i, iMin, iMin2);
                    }
                });
            }
        }
    ...
    /* synthetic */ State m43609lambda$moveMediaItems$4$androidxmedia3commonSimpleBasePlayer(State state, int i, int i2, int i3) {
        ArrayList arrayList = new ArrayList(state.playlist);
    ...
    public final void replaceMediaItems(final int i, int i2, final List<MediaItem> list) {
        ...
        updateStateForPendingOperation(handleReplaceMediaItems(i, iMin, list), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda27
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m282x7bc5132c(state, list, iMin, i);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$replaceMediaItems$5$androidx-media3-common-SimpleBasePlayer */
    /* synthetic */ State m282x7bc5132c(State state, List list, int i, int i2) {
    ...
    public final void removeMediaItems(final int i, int i2) {
        ...
        updateStateForPendingOperation(handleRemoveMediaItems(i, iMin), new Supplier() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda52
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return this.f$0.m281x3b22ba57(state, i, iMin);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$removeMediaItems$6$androidx-media3-common-SimpleBasePlayer */
    /* synthetic */ State m281x3b22ba57(State state, int i, int i2) {
        ArrayList arrayList = new ArrayList(state.playlist);
    ...
    private void updateStateForPendingOperation(final ListenableFuture<?> listenableFuture, Supplier<State> supplier, boolean z, boolean z2) {
        ...
        listenableFuture.addListener(new Runnable() { // from class: androidx.media3.common.SimpleBasePlayer$$ExternalSyntheticLambda30
            ...
            public final void run() {
                this.f$0.m284x9bf3217a(listenableFuture);
            }
    ...
    /* JADX INFO: renamed from: lambda$updateStateForPendingOperation$62$androidx-media3-common-SimpleBasePlayer */
    /* synthetic */ void m284x9bf3217a(ListenableFuture listenableFuture) {
