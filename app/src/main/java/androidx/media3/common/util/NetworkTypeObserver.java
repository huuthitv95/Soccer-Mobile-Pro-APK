    ...
    public void register(final Listener listener) {
        ...
        this.mainHandler.post(new Runnable() { // from class: androidx.media3.common.util.NetworkTypeObserver$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m297xc4ab8e3(listener);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$register$0$androidx-media3-common-util-NetworkTypeObserver */
    /* synthetic */ void m297xc4ab8e3(Listener listener) {
