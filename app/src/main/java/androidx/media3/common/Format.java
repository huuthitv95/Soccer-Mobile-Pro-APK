...
public final class Format {
    ...
    public static final class Builder {
        ...
        public Builder() {
            this.labels = ImmutableList.m22832of();
        ...
        public Builder setId(int i) {
            this.f142id = Integer.toString(i);
            return this;
        }
    ...
    private Format(Builder builder) {
        ...
        if (!builder.labels.isEmpty() || builder.label == null) {
            ...
            this.labels = ImmutableList.m22833of(new Label(strNormalizeLanguageCode, builder.label));
            this.label = builder.label;
        }
    ...
    public String toString() {
        return "Format(" + this.f141id + ", " + this.label + ", " + this.containerMimeType + ", " + this.sampleMimeType + ", " + this.codecs + ", " + this.bitrate + ", " + this.language + ", [" + this.width + ", " + this.height + ", " + this.frameRate + ", " + this.colorInfo + "], [" + this.channelCount + ", " + this.sampleRate + "])";
    }
    ...
    public static String toLogString(Format format) {
        ...
        if (format.drmInitData != null) {
            ...
            for (int i = 0; i < format.drmInitData.schemeDataCount; i++) {
                ...
                if (uuid.equals(C0684C.COMMON_PSSH_UUID)) {
                    linkedHashSet.add("cenc");
                } else if (uuid.equals(C0684C.CLEARKEY_UUID)) {
                    linkedHashSet.add("clearkey");
                } else if (uuid.equals(C0684C.PLAYREADY_UUID)) {
                    linkedHashSet.add("playready");
                } else if (uuid.equals(C0684C.WIDEVINE_UUID)) {
                    linkedHashSet.add("widevine");
                } else if (uuid.equals(C0684C.UUID_NIL)) {
            ...
            sb.append(", drm=[");
            Joiner.m22803on(AbstractJsonLexerKt.COMMA).appendTo(sb, (Iterable<? extends Object>) linkedHashSet);
        ...
        if (!format.labels.isEmpty()) {
            sb.append(", labels=[");
            Joiner.m22803on(AbstractJsonLexerKt.COMMA).appendTo(sb, (Iterable<? extends Object>) format.labels);
            sb.append(C11744X3.j.f26440e);
        }
        if (format.selectionFlags != 0) {
            sb.append(", selectionFlags=[");
            Joiner.m22803on(AbstractJsonLexerKt.COMMA).appendTo(sb, (Iterable<? extends Object>) Util.getSelectionFlagStrings(format.selectionFlags));
            sb.append(C11744X3.j.f26440e);
        }
        if (format.roleFlags != 0) {
            sb.append(", roleFlags=[");
            Joiner.m22803on(AbstractJsonLexerKt.COMMA).appendTo(sb, (Iterable<? extends Object>) Util.getRoleFlagStrings(format.roleFlags));
            sb.append(C11744X3.j.f26440e);
        }
    ...
    public Bundle toBundle(boolean z) {
        ...
        bundle.putString(FIELD_ID, this.f141id);
    ...
    public static Format fromBundle(Bundle bundle) {
        ...
        builder.setId((String) defaultIfNull(string, format.f141id)).setLabel((String) defaultIfNull(bundle.getString(FIELD_LABEL), format.label));
        ArrayList parcelableArrayList = bundle.getParcelableArrayList(FIELD_LABELS);
        if (parcelableArrayList == null) {
            immutableListFromBundleList = ImmutableList.m22832of();
        } else {
