    ...
    public static long getContentLength(String str, String str2) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                Log.m287e(TAG, "Unexpected Content-Length [" + str + C11744X3.j.f26440e);
                j = -1;
            }
        }
        ...
        try {
            ...
            Log.m291w(TAG, "Inconsistent headers [" + str + "] [" + str2 + C11744X3.j.f26440e);
            return Math.max(j, j2);
        } catch (NumberFormatException unused2) {
            Log.m287e(TAG, "Unexpected Content-Range [" + str2 + C11744X3.j.f26440e);
            return j;
        }
    }
}
