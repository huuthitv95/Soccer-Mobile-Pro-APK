...
public final class HttpEngineDataSource extends BaseDataSource implements HttpDataSource {
    ...
    public static final class Factory implements HttpDataSource.Factory {
        ...
        public Factory(HttpEngine httpEngine, Executor executor) {
            this.httpEngine = Util$$ExternalSyntheticApiModelOutline0.m325m(Assertions.checkNotNull(httpEngine));
    ...
    public long open(DataSpec dataSpec) throws HttpDataSource.HttpDataSourceException {
        ...
        try {
            ...
            try {
                ...
                UrlResponseInfo urlResponseInfoM334m = Util$$ExternalSyntheticApiModelOutline0.m334m(Assertions.checkNotNull(this.responseInfo));
                int httpStatusCode = urlResponseInfoM334m.getHttpStatusCode();
                Map asMap = urlResponseInfoM334m.getHeaders().getAsMap();
                long j = 0;
                if (httpStatusCode < 200 || httpStatusCode > 299) {
                    ...
                    throw new HttpDataSource.InvalidResponseCodeException(httpStatusCode, urlResponseInfoM334m.getHttpStatusText(), httpStatusCode == 416 ? new DataSourceException(2008) : null, asMap, dataSpec, responseBody);
                }
                ...
                if (isCompressed(urlResponseInfoM334m) || dataSpec.length != -1) {
    ...
    private final class UrlRequestCallback implements UrlRequest$Callback {
        ...
        public synchronized void onFailed(UrlRequest urlRequest, UrlResponseInfo urlResponseInfo, HttpException httpException) {
            ...
            if (!Util$$ExternalSyntheticApiModelOutline0.m$1(httpException) || Util$$ExternalSyntheticApiModelOutline0.m326m((Object) httpException).getErrorCode() != 1) {
