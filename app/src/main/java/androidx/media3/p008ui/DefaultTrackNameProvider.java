...
public class DefaultTrackNameProvider implements TrackNameProvider {
    ...
    public String getTrackName(Format format) {
        ...
        return (str == null || str.trim().isEmpty()) ? this.resources.getString(C0940R.string.exo_track_unknown) : this.resources.getString(C0940R.string.exo_track_unknown_name, str);
    }

    private String buildResolutionString(Format format) {
        int i = format.width;
        int i2 = format.height;
        return (i == -1 || i2 == -1) ? "" : this.resources.getString(C0940R.string.exo_track_resolution, Integer.valueOf(i), Integer.valueOf(i2));
    }

    private String buildBitrateString(Format format) {
        int i = format.bitrate;
        return i == -1 ? "" : this.resources.getString(C0940R.string.exo_track_bitrate, Float.valueOf(i / 1000000.0f));
    }
    ...
    private String buildAudioChannelString(Format format) {
        ...
        if (i == 1) {
            return this.resources.getString(C0940R.string.exo_track_mono);
        }
        if (i == 2) {
            return this.resources.getString(C0940R.string.exo_track_stereo);
        }
        if (i == 6 || i == 7) {
            return this.resources.getString(C0940R.string.exo_track_surround_5_point_1);
        }
        if (i == 8) {
            return this.resources.getString(C0940R.string.exo_track_surround_7_point_1);
        }
        return this.resources.getString(C0940R.string.exo_track_surround);
    }
    ...
    private String buildRoleString(Format format) {
        ...
        if ((format.roleFlags & 2) == 0) {
            ...
            strJoinWithSeparator = this.resources.getString(C0940R.string.exo_track_role_alternate);
        }
        if ((format.roleFlags & 4) != 0) {
            strJoinWithSeparator = joinWithSeparator(strJoinWithSeparator, this.resources.getString(C0940R.string.exo_track_role_supplementary));
        }
        if ((format.roleFlags & 8) != 0) {
            strJoinWithSeparator = joinWithSeparator(strJoinWithSeparator, this.resources.getString(C0940R.string.exo_track_role_commentary));
        }
        return (format.roleFlags & 1088) != 0 ? joinWithSeparator(strJoinWithSeparator, this.resources.getString(C0940R.string.exo_track_role_closed_captions)) : strJoinWithSeparator;
    }
    ...
    private String joinWithSeparator(String... strArr) {
        ...
        for (String str : strArr) {
            if (str.length() > 0) {
                string = TextUtils.isEmpty(string) ? str : this.resources.getString(C0940R.string.exo_item_list, string, str);
            }
        }
        return string;
    }
