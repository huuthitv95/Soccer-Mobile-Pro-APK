...
public class PlayerNotificationManager {
    ...
    public static class Builder {
        ...
        public Builder(Context context, int i, String str) {
            ...
            this.smallIconResourceId = C0940R.drawable.exo_notification_small_icon;
            this.playActionIconResourceId = C0940R.drawable.exo_notification_play;
            this.pauseActionIconResourceId = C0940R.drawable.exo_notification_pause;
            this.stopActionIconResourceId = C0940R.drawable.exo_notification_stop;
            this.rewindActionIconResourceId = C0940R.drawable.exo_notification_rewind;
            this.fastForwardActionIconResourceId = C0940R.drawable.exo_notification_fastforward;
            this.previousActionIconResourceId = C0940R.drawable.exo_notification_previous;
            this.nextActionIconResourceId = C0940R.drawable.exo_notification_next;
        }
    ...
    protected PlayerNotificationManager(Context context, String str, int i, MediaDescriptionAdapter mediaDescriptionAdapter, NotificationListener notificationListener, CustomActionReceiver customActionReceiver, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, String str2) {
        Map<String, NotificationCompat.Action> mapCreateCustomActions;
        ...
        if (customActionReceiver != null) {
            mapCreateCustomActions = customActionReceiver.createCustomActions(applicationContext, this.instanceId);
        } else {
            mapCreateCustomActions = Collections.EMPTY_MAP;
        }
    ...
    private static Map<String, NotificationCompat.Action> createPlaybackActions(Context context, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        map.put(ACTION_PLAY, new NotificationCompat.Action(i2, context.getString(C0940R.string.exo_controls_play_description), createBroadcastIntent(ACTION_PLAY, context, i)));
        map.put(ACTION_PAUSE, new NotificationCompat.Action(i3, context.getString(C0940R.string.exo_controls_pause_description), createBroadcastIntent(ACTION_PAUSE, context, i)));
        map.put(ACTION_STOP, new NotificationCompat.Action(i4, context.getString(C0940R.string.exo_controls_stop_description), createBroadcastIntent(ACTION_STOP, context, i)));
        map.put(ACTION_REWIND, new NotificationCompat.Action(i5, context.getString(C0940R.string.exo_controls_rewind_description), createBroadcastIntent(ACTION_REWIND, context, i)));
        map.put(ACTION_FAST_FORWARD, new NotificationCompat.Action(i6, context.getString(C0940R.string.exo_controls_fastforward_description), createBroadcastIntent(ACTION_FAST_FORWARD, context, i)));
        map.put(ACTION_PREVIOUS, new NotificationCompat.Action(i7, context.getString(C0940R.string.exo_controls_previous_description), createBroadcastIntent(ACTION_PREVIOUS, context, i)));
        map.put(ACTION_NEXT, new NotificationCompat.Action(i8, context.getString(C0940R.string.exo_controls_next_description), createBroadcastIntent(ACTION_NEXT, context, i)));
        return map;
    }
