...
public class PlayerControlView extends FrameLayout {
    ...
    public PlayerControlView(Context context, AttributeSet attributeSet, int i, AttributeSet attributeSet2) throws Throwable {
        ...
        int i20 = C0940R.layout.exo_player_control_view;
        int i21 = C0940R.drawable.exo_styled_controls_play;
        int i22 = C0940R.drawable.exo_styled_controls_pause;
        int i23 = C0940R.drawable.exo_styled_controls_next;
        int i24 = C0940R.drawable.exo_styled_controls_simple_fastforward;
        int i25 = C0940R.drawable.exo_styled_controls_previous;
        int i26 = C0940R.drawable.exo_styled_controls_simple_rewind;
        int i27 = C0940R.drawable.exo_styled_controls_fullscreen_exit;
        int i28 = C0940R.drawable.exo_styled_controls_fullscreen_enter;
        int i29 = C0940R.drawable.exo_styled_controls_repeat_off;
        int i30 = C0940R.drawable.exo_styled_controls_repeat_one;
        int i31 = C0940R.drawable.exo_styled_controls_repeat_all;
        int i32 = C0940R.drawable.exo_styled_controls_shuffle_on;
        int i33 = C0940R.drawable.exo_styled_controls_shuffle_off;
        int i34 = C0940R.drawable.exo_styled_controls_subtitle_on;
        int i35 = C0940R.drawable.exo_styled_controls_subtitle_off;
        int i36 = C0940R.drawable.exo_styled_controls_vr;
        this.showPlayButtonIfSuppressed = true;
        this.showTimeoutMs = 5000;
        this.repeatToggleModes = 0;
        this.timeBarMinUpdateIntervalMs = 200;
        if (attributeSet2 != null) {
            TypedArray typedArrayObtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet2, C0940R.styleable.PlayerControlView, i, 0);
            try {
                int resourceId = typedArrayObtainStyledAttributes.getResourceId(C0940R.styleable.PlayerControlView_controller_layout_id, i20);
                int resourceId2 = typedArrayObtainStyledAttributes.getResourceId(C0940R.styleable.PlayerControlView_play_icon, i21);
                int resourceId3 = typedArrayObtainStyledAttributes.getResourceId(C0940R.styleable.PlayerControlView_pause_icon, i22);
                int resourceId4 = typedArrayObtainStyledAttributes.getResourceId(C0940R.styleable.PlayerControlView_next_icon, i23);
                int resourceId5 = typedArrayObtainStyledAttributes.getResourceId(C0940R.styleable.PlayerControlView_fastforward_icon, i24);
                int resourceId6 = typedArrayObtainStyledAttributes.getResourceId(C0940R.styleable.PlayerControlView_previous_icon, i25);
                int resourceId7 = typedArrayObtainStyledAttributes.getResourceId(C0940R.styleable.PlayerControlView_rewind_icon, i26);
                int resourceId8 = typedArrayObtainStyledAttributes.getResourceId(C0940R.styleable.PlayerControlView_fullscreen_exit_icon, i27);
                int resourceId9 = typedArrayObtainStyledAttributes.getResourceId(C0940R.styleable.PlayerControlView_fullscreen_enter_icon, i28);
                int resourceId10 = typedArrayObtainStyledAttributes.getResourceId(C0940R.styleable.PlayerControlView_repeat_off_icon, i29);
                int resourceId11 = typedArrayObtainStyledAttributes.getResourceId(C0940R.styleable.PlayerControlView_repeat_one_icon, i30);
                int resourceId12 = typedArrayObtainStyledAttributes.getResourceId(C0940R.styleable.PlayerControlView_repeat_all_icon, i31);
                int resourceId13 = typedArrayObtainStyledAttributes.getResourceId(C0940R.styleable.PlayerControlView_shuffle_on_icon, i32);
                int resourceId14 = typedArrayObtainStyledAttributes.getResourceId(C0940R.styleable.PlayerControlView_shuffle_off_icon, i33);
                int resourceId15 = typedArrayObtainStyledAttributes.getResourceId(C0940R.styleable.PlayerControlView_subtitle_on_icon, i34);
                int resourceId16 = typedArrayObtainStyledAttributes.getResourceId(C0940R.styleable.PlayerControlView_subtitle_off_icon, i35);
                int resourceId17 = typedArrayObtainStyledAttributes.getResourceId(C0940R.styleable.PlayerControlView_vr_icon, i36);
                playerControlView = this;
                try {
                    playerControlView.showTimeoutMs = typedArrayObtainStyledAttributes.getInt(C0940R.styleable.PlayerControlView_show_timeout, playerControlView.showTimeoutMs);
                    ...
                    boolean z10 = typedArrayObtainStyledAttributes.getBoolean(C0940R.styleable.PlayerControlView_show_rewind_button, true);
                    boolean z11 = typedArrayObtainStyledAttributes.getBoolean(C0940R.styleable.PlayerControlView_show_fastforward_button, true);
                    boolean z12 = typedArrayObtainStyledAttributes.getBoolean(C0940R.styleable.PlayerControlView_show_previous_button, true);
                    boolean z13 = typedArrayObtainStyledAttributes.getBoolean(C0940R.styleable.PlayerControlView_show_next_button, true);
                    boolean z14 = typedArrayObtainStyledAttributes.getBoolean(C0940R.styleable.PlayerControlView_show_shuffle_button, false);
                    boolean z15 = typedArrayObtainStyledAttributes.getBoolean(C0940R.styleable.PlayerControlView_show_subtitle_button, false);
                    boolean z16 = typedArrayObtainStyledAttributes.getBoolean(C0940R.styleable.PlayerControlView_show_vr_button, false);
                    playerControlView.setTimeBarMinUpdateInterval(typedArrayObtainStyledAttributes.getInt(C0940R.styleable.PlayerControlView_time_bar_min_update_interval, playerControlView.timeBarMinUpdateIntervalMs));
                    boolean z17 = typedArrayObtainStyledAttributes.getBoolean(C0940R.styleable.PlayerControlView_animation_enabled, true);
        ...
        playerControlView.durationView = (TextView) playerControlView.findViewById(C0940R.id.exo_duration);
        playerControlView.positionView = (TextView) playerControlView.findViewById(C0940R.id.exo_position);
        ImageView imageView2 = (ImageView) playerControlView.findViewById(C0940R.id.exo_subtitle);
        playerControlView.subtitleButton = imageView2;
        if (imageView2 != null) {
            imageView2.setOnClickListener(componentListener);
        }
        ImageView imageView3 = (ImageView) playerControlView.findViewById(C0940R.id.exo_fullscreen);
        ...
        ImageView imageView4 = (ImageView) playerControlView.findViewById(C0940R.id.exo_minimal_fullscreen);
        ...
        View viewFindViewById = playerControlView.findViewById(C0940R.id.exo_settings);
        playerControlView.settingsButton = viewFindViewById;
        if (viewFindViewById != null) {
            viewFindViewById.setOnClickListener(componentListener);
        }
        View viewFindViewById2 = playerControlView.findViewById(C0940R.id.exo_playback_speed);
        playerControlView.playbackSpeedButton = viewFindViewById2;
        if (viewFindViewById2 != null) {
            viewFindViewById2.setOnClickListener(componentListener);
        }
        View viewFindViewById3 = playerControlView.findViewById(C0940R.id.exo_audio_track);
        playerControlView.audioTrackButton = viewFindViewById3;
        if (viewFindViewById3 != null) {
            viewFindViewById3.setOnClickListener(componentListener);
        }
        TimeBar timeBar = (TimeBar) playerControlView.findViewById(C0940R.id.exo_progress);
        View viewFindViewById4 = playerControlView.findViewById(C0940R.id.exo_progress_placeholder);
        if (timeBar != null) {
            ...
            context2 = context;
            textView = null;
            DefaultTimeBar defaultTimeBar = new DefaultTimeBar(context2, null, 0, attributeSet2, C0940R.style.ExoStyledControls_TimeBar);
            defaultTimeBar.setId(C0940R.id.exo_progress);
        ...
        ImageView imageView5 = (ImageView) playerControlView2.findViewById(C0940R.id.exo_play_pause);
        playerControlView2.playPauseButton = imageView5;
        if (imageView5 != null) {
            imageView5.setOnClickListener(componentListener);
        }
        ImageView imageView6 = (ImageView) playerControlView2.findViewById(C0940R.id.exo_prev);
        ...
        ImageView imageView7 = (ImageView) playerControlView2.findViewById(C0940R.id.exo_next);
        ...
        Typeface font = ResourcesCompat.getFont(context2, C0940R.font.roboto_medium_numbers);
        ImageView imageView8 = (ImageView) playerControlView2.findViewById(C0940R.id.exo_rew);
        TextView textView2 = (TextView) playerControlView2.findViewById(C0940R.id.exo_rew_with_amount);
        if (imageView8 != null) {
        ...
        ImageView imageView9 = (ImageView) playerControlView2.findViewById(C0940R.id.exo_ffwd);
        TextView textView3 = (TextView) playerControlView2.findViewById(C0940R.id.exo_ffwd_with_amount);
        if (imageView9 != null) {
        ...
        ImageView imageView10 = (ImageView) playerControlView2.findViewById(C0940R.id.exo_repeat_toggle);
        playerControlView2.repeatToggleButton = imageView10;
        if (imageView10 != null) {
            imageView10.setOnClickListener(componentListener);
        }
        ImageView imageView11 = (ImageView) playerControlView2.findViewById(C0940R.id.exo_shuffle);
        playerControlView2.shuffleButton = imageView11;
        if (imageView11 != null) {
            imageView11.setOnClickListener(componentListener);
        }
        playerControlView2.buttonAlphaEnabled = resources.getInteger(C0940R.integer.exo_media_button_opacity_percentage_enabled) / 100.0f;
        playerControlView2.buttonAlphaDisabled = resources.getInteger(C0940R.integer.exo_media_button_opacity_percentage_disabled) / 100.0f;
        ImageView imageView12 = (ImageView) playerControlView2.findViewById(C0940R.id.exo_vr);
        ...
        SettingsAdapter settingsAdapter = playerControlView2.new SettingsAdapter(new String[]{resources.getString(C0940R.string.exo_controls_playback_speed), resources.getString(C0940R.string.exo_track_selection_title_audio)}, new Drawable[]{Util.getDrawable(context2, resources, C0940R.drawable.exo_styled_controls_speed), Util.getDrawable(context2, resources, C0940R.drawable.exo_styled_controls_audiotrack)});
        playerControlView2.settingsAdapter = settingsAdapter;
        playerControlView2.settingsWindowMargin = resources.getDimensionPixelSize(C0940R.dimen.exo_settings_offset);
        RecyclerView recyclerView = (RecyclerView) LayoutInflater.from(context2).inflate(C0940R.layout.exo_styled_settings_list, (ViewGroup) null);
        ...
        playerControlView2.subtitleOnContentDescription = resources.getString(C0940R.string.exo_controls_cc_enabled_description);
        playerControlView2.subtitleOffContentDescription = resources.getString(C0940R.string.exo_controls_cc_disabled_description);
        ...
        playerControlView2.playbackSpeedAdapter = playerControlView2.new PlaybackSpeedAdapter(resources.getStringArray(C0940R.array.exo_controls_playback_speeds), PLAYBACK_SPEEDS);
        ...
        playerControlView2.fullScreenExitContentDescription = resources.getString(C0940R.string.exo_controls_fullscreen_exit_description);
        playerControlView2.fullScreenEnterContentDescription = resources.getString(C0940R.string.exo_controls_fullscreen_enter_description);
        playerControlView2.repeatOffButtonContentDescription = resources.getString(C0940R.string.exo_controls_repeat_off_description);
        playerControlView2.repeatOneButtonContentDescription = resources.getString(C0940R.string.exo_controls_repeat_one_description);
        playerControlView2.repeatAllButtonContentDescription = resources.getString(C0940R.string.exo_controls_repeat_all_description);
        playerControlView2.shuffleOnContentDescription = resources.getString(C0940R.string.exo_controls_shuffle_on_description);
        playerControlView2.shuffleOffContentDescription = resources.getString(C0940R.string.exo_controls_shuffle_off_description);
        playerControlViewLayoutManager.setShowButton((ViewGroup) playerControlView2.findViewById(C0940R.id.exo_bottom_bar), true);
    ...
    public void updatePlayPauseButton() {
        ...
        if (isVisible() && this.isAttachedToWindow && this.playPauseButton != null) {
            ...
            if (zShouldShowPlayButton) {
                i = C0940R.string.exo_controls_play_description;
            } else {
                i = C0940R.string.exo_controls_pause_description;
            }
    ...
    private void updateRewindButton() {
        ...
        if (view != null) {
            view.setContentDescription(this.resources.getQuantityString(C0940R.plurals.exo_controls_rewind_by_amount_description, seekBackIncrement, Integer.valueOf(seekBackIncrement)));
        }
    }
    ...
    private void updateFastForwardButton() {
        ...
        if (view != null) {
            view.setContentDescription(this.resources.getQuantityString(C0940R.plurals.exo_controls_fastforward_by_amount_description, seekForwardIncrement, Integer.valueOf(seekForwardIncrement)));
        }
    }
    ...
    private void initTrackSelectionAdapter() {
        ...
        if (player != null && player.isCommandAvailable(30) && this.player.isCommandAvailable(29)) {
            ...
            if (this.controlViewLayoutManager.getShowButton(this.subtitleButton)) {
                ...
                this.textTrackSelectionAdapter.init(ImmutableList.m22832of());
            }
        }
    }
    ...
    private static int getRepeatToggleModes(TypedArray typedArray, int i) {
        return typedArray.getInt(C0940R.styleable.PlayerControlView_repeat_toggle_modes, i);
    }
    ...
    private class SettingsAdapter extends RecyclerView.Adapter<SettingViewHolder> {
        ...
        public SettingViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return PlayerControlView.this.new SettingViewHolder(LayoutInflater.from(PlayerControlView.this.getContext()).inflate(C0940R.layout.exo_styled_settings_list_item, viewGroup, false));
        }
    ...
    final class SettingViewHolder extends RecyclerView.ViewHolder {
        ...
        public SettingViewHolder(View view) {
            ...
            this.mainTextView = (TextView) view.findViewById(C0940R.id.exo_main_text);
            this.subTextView = (TextView) view.findViewById(C0940R.id.exo_sub_text);
            this.iconView = (ImageView) view.findViewById(C0940R.id.exo_icon);
            view.setOnClickListener(new View.OnClickListener() { // from class: androidx.media3.ui.PlayerControlView$SettingViewHolder$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view2) {
                    this.f$0.m649x7eeeb754(view2);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$new$0$androidx-media3-ui-PlayerControlView$SettingViewHolder */
        /* synthetic */ void m649x7eeeb754(View view) {
    ...
    final class PlaybackSpeedAdapter extends RecyclerView.Adapter<SubSettingViewHolder> {
        ...
        public SubSettingViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return new SubSettingViewHolder(LayoutInflater.from(PlayerControlView.this.getContext()).inflate(C0940R.layout.exo_styled_sub_settings_list_item, viewGroup, false));
        }
        ...
        public void onBindViewHolder(SubSettingViewHolder subSettingViewHolder, final int i) {
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: androidx.media3.ui.PlayerControlView$PlaybackSpeedAdapter$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.m648x9de2ddb7(i, view);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onBindViewHolder$0$androidx-media3-ui-PlayerControlView$PlaybackSpeedAdapter */
        /* synthetic */ void m648x9de2ddb7(int i, View view) {
            if (i != this.selectedIndex) {
    ...
    final class TextTrackSelectionAdapter extends TrackSelectionAdapter {
        ...
        public void onBindViewHolderAtZeroPosition(SubSettingViewHolder subSettingViewHolder) {
            boolean z;
            subSettingViewHolder.textView.setText(C0940R.string.exo_track_selection_none);
            int i = 0;
            while (true) {
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: androidx.media3.ui.PlayerControlView$TextTrackSelectionAdapter$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.m650x7bd5d809(view);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onBindViewHolderAtZeroPosition$0$androidx-media3-ui-PlayerControlView$TextTrackSelectionAdapter */
        /* synthetic */ void m650x7bd5d809(View view) {
    ...
    final class AudioTrackSelectionAdapter extends TrackSelectionAdapter {
        ...
        @Override // androidx.media3.ui.PlayerControlView.TrackSelectionAdapter
        public void onBindViewHolderAtZeroPosition(SubSettingViewHolder subSettingViewHolder) {
            subSettingViewHolder.textView.setText(C0940R.string.exo_track_selection_auto);
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: androidx.media3.ui.PlayerControlView$AudioTrackSelectionAdapter$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.m647xa84b12b0(view);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onBindViewHolderAtZeroPosition$0$androidx-media3-ui-PlayerControlView$AudioTrackSelectionAdapter */
        /* synthetic */ void m647xa84b12b0(View view) {
            if (PlayerControlView.this.player == null || !PlayerControlView.this.player.isCommandAvailable(29)) {
                return;
            }
            ...
            PlayerControlView.this.settingsAdapter.setSubTextAtPosition(1, PlayerControlView.this.getResources().getString(C0940R.string.exo_track_selection_auto));
            PlayerControlView.this.settingsWindow.dismiss();
        }
        ...
        public void init(List<TrackInformation> list) {
            ...
            if (list.isEmpty()) {
                PlayerControlView.this.settingsAdapter.setSubTextAtPosition(1, PlayerControlView.this.getResources().getString(C0940R.string.exo_track_selection_none));
                return;
            }
    ...
    abstract class TrackSelectionAdapter extends RecyclerView.Adapter<SubSettingViewHolder> {
        ...
        public void onBindViewHolder(SubSettingViewHolder subSettingViewHolder, int i) {
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: androidx.media3.ui.PlayerControlView$TrackSelectionAdapter$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.f$0.m651x45c3fb1a(player, mediaTrackGroup, trackInformation, view);
                }
            });
        }

        /* JADX INFO: renamed from: lambda$onBindViewHolder$0$androidx-media3-ui-PlayerControlView$TrackSelectionAdapter */
        /* synthetic */ void m651x45c3fb1a(Player player, TrackGroup trackGroup, TrackInformation trackInformation, View view) {
            if (player.isCommandAvailable(29)) {
                player.setTrackSelectionParameters(player.getTrackSelectionParameters().buildUpon().setOverrideForType(new TrackSelectionOverride(trackGroup, ImmutableList.m22833of(Integer.valueOf(trackInformation.trackIndex)))).setTrackTypeDisabled(trackInformation.trackGroup.getType(), false).build());
    ...
    private static class SubSettingViewHolder extends RecyclerView.ViewHolder {
        ...
        public SubSettingViewHolder(View view) {
            ...
            this.textView = (TextView) view.findViewById(C0940R.id.exo_text);
            this.checkView = view.findViewById(C0940R.id.exo_check);
        }
    }
}
