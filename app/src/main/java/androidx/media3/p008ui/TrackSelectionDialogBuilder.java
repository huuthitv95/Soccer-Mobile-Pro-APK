...
public final class TrackSelectionDialogBuilder {
    ...
    public TrackSelectionDialogBuilder(Context context, CharSequence charSequence, List<Tracks.Group> list, DialogCallback dialogCallback) {
        ...
        this.overrides = ImmutableMap.m22851of();
    }
    ...
    public TrackSelectionDialogBuilder setOverride(TrackSelectionOverride trackSelectionOverride) {
        Map<TrackGroup, TrackSelectionOverride> mapM22852of;
        if (trackSelectionOverride == null) {
            mapM22852of = Collections.EMPTY_MAP;
        } else {
            mapM22852of = ImmutableMap.m22852of(trackSelectionOverride.mediaTrackGroup, trackSelectionOverride);
        }
        return setOverrides(mapM22852of);
    }
    ...
    private Dialog buildForPlatform() {
        ...
        View viewInflate = LayoutInflater.from(builder.getContext()).inflate(C0940R.layout.exo_track_selection_dialog, (ViewGroup) null);
    ...
    private Dialog buildForAndroidX() {
        try {
            ...
            View viewInflate = LayoutInflater.from((Context) cls.getMethod("getContext", null).invoke(objNewInstance, null)).inflate(C0940R.layout.exo_track_selection_dialog, (ViewGroup) null);
            ...
            cls.getMethod("setPositiveButton", Integer.TYPE, DialogInterface.OnClickListener.class).invoke(objNewInstance, Integer.valueOf(R.string.ok), upDialogView);
            cls.getMethod("setNegativeButton", Integer.TYPE, DialogInterface.OnClickListener.class).invoke(objNewInstance, Integer.valueOf(R.string.cancel), null);
            return (Dialog) cls.getMethod("create", null).invoke(objNewInstance, null);
    ...
    private DialogInterface.OnClickListener setUpDialogView(View view) {
        final TrackSelectionView trackSelectionView = (TrackSelectionView) view.findViewById(C0940R.id.exo_track_selection_view);
        ...
        return new DialogInterface.OnClickListener() { // from class: androidx.media3.ui.TrackSelectionDialogBuilder$$ExternalSyntheticLambda0
            ...
            public final void onClick(DialogInterface dialogInterface, int i) {
                this.f$0.m653xc121951d(trackSelectionView, dialogInterface, i);
            }
        };
    }

    /* JADX INFO: renamed from: lambda$setUpDialogView$1$androidx-media3-ui-TrackSelectionDialogBuilder */
    /* synthetic */ void m653xc121951d(TrackSelectionView trackSelectionView, DialogInterface dialogInterface, int i) {
