...
public class DebugTextViewHelper {
    ...
    protected String getPlayerStateString() {
        ...
        if (playbackState == 1) {
            ...
            str = C11744X3.i.f26390s;
        } else if (playbackState == 4) {
            str = C11744X3.i.f26367g0;
        } else {
            str = "unknown";
        }
    ...
    protected String getVideoString() {
        ...
        return "\n" + videoFormat.sampleMimeType + "(id:" + videoFormat.f141id + " r:" + videoSize.width + "x" + videoSize.height + getColorInfoString(videoFormat.colorInfo) + getPixelAspectRatioString(videoSize.pixelWidthHeightRatio) + getDecoderCountersBufferCountString(videoDecoderCounters) + " vfpo: " + getVideoFrameProcessingOffsetAverageString(videoDecoderCounters.totalVideoFrameProcessingOffsetUs, videoDecoderCounters.videoFrameProcessingOffsetCount) + ")";
    }
    ...
    protected String getAudioString() {
        ...
        return "\n" + audioFormat.sampleMimeType + "(id:" + audioFormat.f141id + " hz:" + audioFormat.sampleRate + " ch:" + audioFormat.channelCount + getDecoderCountersBufferCountString(audioDecoderCounters) + ")";
    }
