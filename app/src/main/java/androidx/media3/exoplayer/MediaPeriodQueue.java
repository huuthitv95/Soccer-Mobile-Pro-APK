...
final class MediaPeriodQueue {
    ...
    public void invalidatePreloadPool(Timeline timeline) {
        ...
        Pair<Object, Long> defaultPeriodPositionOfNextWindow = getDefaultPeriodPositionOfNextWindow(timeline, mediaPeriodHolder.info.f150id.periodUid, 0L);
    ...
    public MediaPeriodHolder advancePlayingPeriod() {
        ...
        if (i == 0) {
            ...
            this.oldFrontPeriodWindowSequenceNumber = this.playing.info.f150id.windowSequenceNumber;
        }
    ...
    public void clear() {
        ...
        this.oldFrontPeriodWindowSequenceNumber = next.info.f150id.windowSequenceNumber;
        while (next != null) {
            next.release();
            next = next.getNext();
        }
    ...
    public MediaPeriodInfo getUpdatedMediaPeriodInfo(Timeline timeline, MediaPeriodInfo mediaPeriodInfo) {
        ...
        MediaSource.MediaPeriodId mediaPeriodId = mediaPeriodInfo.f150id;
        ...
        timeline.getPeriodByUid(mediaPeriodInfo.f150id.periodUid, this.period);
    ...
    private void notifyQueueUpdate() {
        ...
        for (MediaPeriodHolder next = this.playing; next != null; next = next.getNext()) {
            builder.add(next.info.f150id);
        }
        MediaPeriodHolder mediaPeriodHolder = this.reading;
        final MediaSource.MediaPeriodId mediaPeriodId = mediaPeriodHolder == null ? null : mediaPeriodHolder.info.f150id;
        this.analyticsCollectorHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.MediaPeriodQueue$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m383x6b40a91a(builder, mediaPeriodId);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$notifyQueueUpdate$0$androidx-media3-exoplayer-MediaPeriodQueue */
    /* synthetic */ void m383x6b40a91a(ImmutableList.Builder builder, MediaSource.MediaPeriodId mediaPeriodId) {
    ...
    private long resolvePeriodUidToWindowSequenceNumber(Timeline timeline, Object obj) {
        ...
        for (MediaPeriodHolder next = this.playing; next != null; next = next.getNext()) {
            if (next.uid.equals(obj)) {
                return next.info.f150id.windowSequenceNumber;
            }
        }
        for (MediaPeriodHolder next2 = this.playing; next2 != null; next2 = next2.getNext()) {
            ...
            if (indexOfPeriod2 != -1 && timeline.getPeriod(indexOfPeriod2, this.period).windowIndex == i) {
                return next2.info.f150id.windowSequenceNumber;
            }
        }
    ...
    private long resolvePeriodUidToWindowSequenceNumberInPreloadPeriods(Object obj) {
        for (int i = 0; i < this.preloadPriorityList.size(); i++) {
            ...
            if (mediaPeriodHolder.uid.equals(obj)) {
                return mediaPeriodHolder.info.f150id.windowSequenceNumber;
            }
        }
        return -1L;
    }
    ...
    private boolean canKeepMediaPeriodHolder(MediaPeriodInfo mediaPeriodInfo, MediaPeriodInfo mediaPeriodInfo2) {
        return mediaPeriodInfo.startPositionUs == mediaPeriodInfo2.startPositionUs && mediaPeriodInfo.f150id.equals(mediaPeriodInfo2.f150id);
    }
    ...
    private MediaPeriodInfo getFirstMediaPeriodInfoOfNextPeriod(Timeline timeline, MediaPeriodHolder mediaPeriodHolder, long j) {
        ...
        long j2;
        MediaPeriodInfo mediaPeriodInfo = mediaPeriodHolder.info;
        int nextPeriodIndex = timeline.getNextPeriodIndex(timeline.getIndexOfPeriod(mediaPeriodInfo.f150id.periodUid), this.period, this.window, this.repeatMode, this.shuffleModeEnabled);
        ...
        long j3 = mediaPeriodInfo.f150id.windowSequenceNumber;
        long j4 = 0;
        if (timeline.getWindow(i, this.window).firstPeriodIndex == nextPeriodIndex) {
            ...
            if (next != null && next.uid.equals(obj2)) {
                j3 = next.info.f150id.windowSequenceNumber;
            } else {
        ...
        if (j4 != -9223372036854775807L && mediaPeriodInfo.requestedContentPositionUs != -9223372036854775807L) {
            boolean zHasServerSideInsertedAds = hasServerSideInsertedAds(mediaPeriodInfo.f150id.periodUid, timeline);
