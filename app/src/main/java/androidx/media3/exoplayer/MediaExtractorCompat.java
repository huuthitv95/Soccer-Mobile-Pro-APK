...
public final class MediaExtractorCompat {
    ...
    private Extractor selectExtractor(ExtractorInput extractorInput) throws IOException {
        ...
        throw new UnrecognizedInputFormatException("None of the available extractors (" + Joiner.m22804on(", ").join(Lists.transform(ImmutableList.copyOf(extractorArrCreateExtractors), new Function() { // from class: androidx.media3.exoplayer.MediaExtractorCompat$$ExternalSyntheticLambda0
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
                return ((Extractor) obj).getUnderlyingImplementation().getClass().getSimpleName();
            }
        })) + ") could read the stream.", (Uri) Assertions.checkNotNull(((DataSource) Assertions.checkNotNull(this.currentDataSource)).getUri()), ImmutableList.m22832of());
    }
    ...
    private boolean advanceToSampleOrEndOfInput() {
        try {
            ...
            while (true) {
                if (this.trackIndicesPerSampleInQueuedOrder.isEmpty()) {
                    ...
                    try {
                        ...
                        Log.m292w(TAG, "Treating exception as the end of input.", e);
                    }
                } else {
            ...
            Log.m292w(TAG, "Treating exception as the end of input.", e2);
            return false;
        }
    }
