...
public final class CmcdData {
    private static final Joiner COMMA_JOINER = Joiner.m22804on(",");
    ...
    public static final class Factory {
        ...
        private void validateCustomDataListFormat(List<String> list) {
            ...
            while (it.hasNext()) {
                Assertions.checkState(CUSTOM_KEY_NAME_PATTERN.matcher(Util.split(it.next(), C11744X3.j.f26434b)[0]).matches());
            }
        }
    }
    ...
    private static final class CmcdObject {
        ...
        public static final class Builder {
            ...
            private ImmutableList<String> customDataList = ImmutableList.m22832of();
