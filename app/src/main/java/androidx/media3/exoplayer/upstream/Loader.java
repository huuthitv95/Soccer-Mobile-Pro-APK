    ...
    private final class LoadTask<T extends Loadable> extends Handler implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                Log.m288e(TAG, "OutOfMemory error loading stream", e2);
                obtainMessage(3, new UnexpectedLoaderException(e2)).sendToTarget();
            } catch (Error e3) {
                if (!this.released) {
                    Log.m288e(TAG, "Unexpected error loading stream", e3);
                ...
                Log.m288e(TAG, "Unexpected exception loading stream", e4);
        ...
        public void handleMessage(Message message) {
            ...
            if (i == 2) {
                try {
                    ...
                    Log.m288e(TAG, "Unexpected exception handling load completed", e);
