        ...
        try {
            try {
                ...
                try {
                    ...
                    Log.m289i(TAG, "Loaded LibvpxVideoRenderer.");
        ...
        try {
            try {
                ...
                try {
                    ...
                    Log.m289i(TAG, "Loaded Libgav1VideoRenderer.");
            ...
            try {
                ...
                Log.m289i(TAG, "Loaded FfmpegVideoRenderer.");
        ...
        try {
            try {
                ...
                try {
                    ...
                    Log.m289i(TAG, "Loaded MidiRenderer.");
                } catch (ClassNotFoundException unused) {
                    size = i2;
                    i2 = size;
                }
            ...
            try {
                try {
                    ...
                    try {
                        ...
                        Log.m289i(TAG, "Loaded LibopusAudioRenderer.");
                    } catch (ClassNotFoundException unused3) {
                        i2 = i3;
                        i3 = i2;
                    }
                ...
                try {
                    try {
                        ...
                        try {
                            ...
                            Log.m289i(TAG, "Loaded LibflacAudioRenderer.");
                        } catch (ClassNotFoundException unused5) {
                            i3 = i4;
                            i4 = i3;
                        }
                ...
                try {
                    ...
                    Log.m289i(TAG, "Loaded FfmpegAudioRenderer.");
