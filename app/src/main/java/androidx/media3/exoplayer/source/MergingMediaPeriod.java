    ...
    public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
        ...
        for (int i2 = 0; i2 < exoTrackSelectionArr.length; i2++) {
            ...
            if (exoTrackSelection != null) {
                ...
                iArr2[i2] = Integer.parseInt(trackGroup.f146id.substring(0, trackGroup.f146id.indexOf(CertificateUtil.DELIMITER)));
            } else {
                iArr2[i2] = -1;
            }
        }
            ...
            if (i2 < mediaPeriodArr.length) {
                ...
                while (i5 < i4) {
                    ...
                    for (int i6 = 0; i6 < trackGroup.length; i6++) {
                        ...
                        sb.append(format.f141id == null ? "" : format.f141id);
                        formatArr[i6] = builderBuildUpon.setId(sb.toString()).build();
                    }
                    TrackGroup trackGroup2 = new TrackGroup(i2 + CertificateUtil.DELIMITER + trackGroup.f146id, formatArr);
