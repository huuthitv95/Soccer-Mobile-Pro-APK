...
final class ProgressiveMediaPeriod implements MediaPeriod, ExtractorOutput, Loader.Callback<ExtractingLoadable>, Loader.ReleaseCallback, SampleQueue.UpstreamFormatChangedListener {
    ...
    /* JADX INFO: renamed from: lambda$new$0$androidx-media3-exoplayer-source-ProgressiveMediaPeriod */
    /* synthetic */ void m516x97cae34d() {
        if (this.released) {
            return;
        }
    ...
    public void seekMap(final SeekMap seekMap) {
        this.handler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ProgressiveMediaPeriod$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m518x33ac0ff2(seekMap);
            }
        });
    }
    ...
    public void onLengthKnown() {
        this.handler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ProgressiveMediaPeriod$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m517xa2bd730d();
            }
        });
    }

    /* JADX INFO: renamed from: lambda$onLengthKnown$2$androidx-media3-exoplayer-source-ProgressiveMediaPeriod */
    /* synthetic */ void m517xa2bd730d() {
    ...
    private TrackOutput prepareTrackOutput(TrackId trackId) {
        ...
        if (this.sampleQueuesBuilt) {
            Log.m291w(TAG, "Extractor added new track (id=" + trackId.f156id + ") after finishing tracks.");
    ...
    public void m518x33ac0ff2(SeekMap seekMap) {
    ...
    final class ExtractingLoadable implements Loader.Loadable, IcyDataSource.Listener {
        ...
        /* JADX WARN: Bottom block not found for handler: all -> 0x0112 */
        @Override // androidx.media3.exoplayer.upstream.Loader.Loadable
        /*
    ...
    private static final class TrackId {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null && getClass() == obj.getClass()) {
                ...
                if (this.f156id == trackId.f156id && this.isIcyTrack == trackId.isIcyTrack) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            return (this.f156id * 31) + (this.isIcyTrack ? 1 : 0);
        }
    }
