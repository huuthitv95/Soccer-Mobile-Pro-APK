...
public final class OutputConsumerAdapterV30 implements MediaParser$OutputConsumer {
    ...
    public OutputConsumerAdapterV30(Format format, int i, boolean z) {
        ...
        this.muxedCaptionFormats = ImmutableList.m22832of();
    }
    ...
    private TrackOutput.CryptoData toExoPlayerCryptoData(int i, MediaCodec.CryptoInfo cryptoInfo) {
        ...
        try {
            ...
            Log.m288e(TAG, "Unexpected error while parsing CryptoInfo: " + cryptoInfo, e);
            i2 = 0;
            i3 = 0;
        }
    ...
    private static final class SeekMapAdapter implements SeekMap {
        ...
        public SeekMap.SeekPoints getSeekPoints(long j) {
            ...
            if (seekPoints.first == seekPoints.second) {
                return new SeekMap.SeekPoints(asExoPlayerSeekPoint(FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m433m(seekPoints.first)));
            }
            return new SeekMap.SeekPoints(asExoPlayerSeekPoint(FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m433m(seekPoints.first)), asExoPlayerSeekPoint(FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m433m(seekPoints.second)));
        }
    ...
    private static final class DataReaderAdapter implements DataReader {
        ...
        public int read(byte[] bArr, int i, int i2) throws IOException {
            return DefaultTimeBar$$ExternalSyntheticApiModelOutline0.m604m(Util.castNonNull(this.input)).read(bArr, i, i2);
        }
    }
}
