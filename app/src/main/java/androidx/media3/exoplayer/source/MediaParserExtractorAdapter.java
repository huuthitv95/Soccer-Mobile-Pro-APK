...
public final class MediaParserExtractorAdapter implements ProgressiveMediaExtractor {
    ...
    static /* synthetic */ ProgressiveMediaExtractor lambda$static$0(PlayerId playerId) {
        return new MediaParserExtractorAdapter(playerId, ImmutableMap.m22851of());
    }
    ...
    public MediaParserExtractorAdapter(PlayerId playerId) {
        this(playerId, ImmutableMap.m22851of());
    }
    ...
    public void seek(long j, long j2) {
        ...
        this.mediaParser.seek(FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m433m(seekPoints.second).position == j ? FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m433m(seekPoints.second) : FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m433m(seekPoints.first));
    }
