...
public final class MaskingMediaSource extends WrappingMediaSource {
    ...
    protected void onChildSourceInfoRefreshed(Timeline timeline) {
        ...
        if (this.isPrepared) {
            ...
            if (maskingMediaPeriod2 != null) {
                ...
                this.timeline.getPeriodByUid(this.unpreparedMaskingMediaPeriod.f155id.periodUid, this.period);
            ...
            if (maskingMediaPeriod3 != null && setPreparePositionOverrideToUnpreparedMaskingPeriod(jLongValue)) {
                mediaPeriodIdCopyWithPeriodUid = maskingMediaPeriod3.f155id.copyWithPeriodUid(getInternalPeriodUid(maskingMediaPeriod3.f155id.periodUid));
            }
            this.hasRealTimeline = true;
    ...
    private boolean setPreparePositionOverrideToUnpreparedMaskingPeriod(long j) {
        MaskingMediaPeriod maskingMediaPeriod = this.unpreparedMaskingMediaPeriod;
        int indexOfPeriod = this.timeline.getIndexOfPeriod(maskingMediaPeriod.f155id.periodUid);
        if (indexOfPeriod == -1) {
            return false;
        }
