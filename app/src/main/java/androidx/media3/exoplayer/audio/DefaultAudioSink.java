...
public final class DefaultAudioSink implements AudioSink {
    ...
    private DefaultAudioSink(Builder builder) {
        ...
        this.toIntPcmAvailableAudioProcessors = ImmutableList.m22835of((TrimmingAudioProcessor) new ToInt16PcmAudioProcessor(), (TrimmingAudioProcessor) channelMappingAudioProcessor, trimmingAudioProcessor);
        this.toFloatPcmAvailableAudioProcessors = ImmutableList.m22833of(new ToFloatPcmAudioProcessor());
        this.volume = 1.0f;
    ...
    public int getFormatSupport(Format format) {
        ...
        Log.m291w(TAG, "Invalid PCM encoding: " + format.pcmEncoding);
        return 0;
    }
    ...
    public void configure(Format format, int i, int[] iArr) throws AudioSink.ConfigurationException {
        ...
        if ("audio/raw".equals(format.sampleMimeType)) {
            ...
            audioProcessingPipeline = new AudioProcessingPipeline(ImmutableList.m22832of());
        ...
        if ("audio/vnd.dts.hd;profile=lbr".equals(format.sampleMimeType) && i8 == -1) {
            i8 = 768000;
        }
        int i9 = i8;
        if (i != 0) {
    ...
    public boolean handleBuffer(ByteBuffer byteBuffer, long j, int i) throws Exception {
        ...
        Log.m291w(TAG, "Resetting stalled audio track");
        flush();
        return true;
    }
    ...
    private void setAudioTrackPlaybackParametersV23() {
        if (isAudioTrackInitialized()) {
            try {
                ...
                Log.m292w(TAG, "Failed to set playback params", e);
            }
    ...
    static final class OnRoutingChangedListenerApi24 {
        ...
        public void release() {
            this.audioTrack.removeOnRoutingChangedListener(FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m427m(Assertions.checkNotNull(this.listener)));
            this.listener = null;
        }
    ...
    private final class PositionTrackerListener implements AudioTrackPositionTracker.Listener {
        ...
        public void onPositionFramesMismatch(long j, long j2, long j3, long j4) {
            ...
            Log.m291w(DefaultAudioSink.TAG, str);
        }
        ...
        public void onInvalidLatency(long j) {
            Log.m291w(DefaultAudioSink.TAG, "Ignoring impossibly large audio latency: " + j);
        }
