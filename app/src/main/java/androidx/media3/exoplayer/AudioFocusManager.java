...
final class AudioFocusManager {
    ...
    private static int convertAudioAttributesToFocusGain(AudioAttributes audioAttributes) {
        ...
        switch (audioAttributes.usage) {
            case 0:
                Log.m291w(TAG, "Specify a proper usage in the audio attributes for audio focus handling. Using AUDIOFOCUS_GAIN by default.");
                return 1;
            case 1:
            case 14:
                return 1;
            ...
            case 15:
            default:
                Log.m291w(TAG, "Unidentified audio usage: " + audioAttributes.usage);
                return 0;
            case 16:
                return 4;
        }
    ...
    public void handlePlatformAudioFocusChange(int i) {
        ...
        if (i == -1) {
            ...
            Log.m291w(TAG, "Unknown focus change type: " + i);
        }
    }
    ...
    class AudioFocusListener implements AudioManager.OnAudioFocusChangeListener {
        ...
        /* JADX INFO: renamed from: lambda$onAudioFocusChange$0$androidx-media3-exoplayer-AudioFocusManager$AudioFocusListener */
        /* synthetic */ void m378x93d291e3(int i) {
