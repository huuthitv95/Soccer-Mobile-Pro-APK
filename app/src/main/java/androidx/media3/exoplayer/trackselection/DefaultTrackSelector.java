...
public class DefaultTrackSelector extends MappingTrackSelector implements RendererCapabilities.Listener {
    ...
    public static final class Parameters extends TrackSelectionParameters {
        ...
        /* JADX INFO: renamed from: FIELD_ALLOW_INVALIDATE_SELECTIONS_ON_RENDERER_CAPABILITIES_CHANGE */
        private static final String f159xaec1bc6e;
        ...
        public static final class Builder extends TrackSelectionParameters.Builder {
            ...
            private Builder(Bundle bundle) {
                ...
                setAllowInvalidateSelectionsOnRendererCapabilitiesChange(bundle.getBoolean(Parameters.f159xaec1bc6e, parameters.allowInvalidateSelectionsOnRendererCapabilitiesChange));
                this.selectionOverrides = new SparseArray<>();
        ...
        static {
            ...
            f159xaec1bc6e = Util.intToStringMaxRadix(1017);
        ...
        public Bundle toBundle() {
            ...
            bundle.putBoolean(f159xaec1bc6e, this.allowInvalidateSelectionsOnRendererCapabilitiesChange);
    ...
    private DefaultTrackSelector(TrackSelectionParameters trackSelectionParameters, ExoTrackSelection.Factory factory, Context context) {
        ...
        if (this.parameters.constrainAudioChannelCountToDeviceCapabilities && context == null) {
            Log.m291w(TAG, AUDIO_CHANNEL_COUNT_CONSTRAINTS_WARN_MESSAGE);
        }
    }
    ...
    protected Pair<ExoTrackSelection.Definition, Integer> selectAudioTrack(MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, final int[] iArr2, final Parameters parameters) throws ExoPlaybackException {
        ...
        return selectTracksForType(1, mappedTrackInfo, iArr, new TrackInfo.Factory() { // from class: androidx.media3.exoplayer.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda4
            ...
            public final List create(int i2, TrackGroup trackGroup, int[] iArr3) {
                return this.f$0.m532x92d8c743(parameters, z, iArr2, i2, trackGroup, iArr3);
            }
    ...
    /* JADX INFO: renamed from: lambda$selectAudioTrack$2$androidx-media3-exoplayer-trackselection-DefaultTrackSelector */
    /* synthetic */ List m532x92d8c743(Parameters parameters, boolean z, int[] iArr, int i, TrackGroup trackGroup, int[] iArr2) {
    ...
    private <T extends TrackInfo<T>> Pair<ExoTrackSelection.Definition, Integer> selectTracksForType(int i, MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, TrackInfo.Factory<T> factory, Comparator<List<T>> comparator) {
        int i2;
        RandomAccess randomAccessM22833of;
                    ...
                    while (i5 < trackGroup.length) {
                        ...
                        if (zArr[i5] || selectionEligibility == 0) {
                            ...
                            if (selectionEligibility == 1) {
                                randomAccessM22833of = ImmutableList.m22833of(t);
                            } else {
                                ArrayList arrayList2 = new ArrayList();
                                arrayList2.add(t);
                                int i6 = i5 + 1;
                                ...
                                randomAccessM22833of = arrayList2;
                            }
                            i2 = rendererCount;
                            arrayList.add(randomAccessM22833of);
                        }
                        i5++;
                        rendererCount = i2;
                    }
    ...
    public static boolean rendererSupportsOffload(Parameters parameters, int i, Format format) {
        ...
        if (parameters.audioOffloadPreferences.isGaplessSupportRequired) {
            ...
            boolean z2 = (RendererCapabilities.CC.getAudioOffloadSupport(i) & 1024) != 0;
            if (z && !z2) {
                return false;
            }
        }
    ...
    static final class AudioTrackInfo extends TrackInfo<AudioTrackInfo> implements Comparable<AudioTrackInfo> {
        ...
        private int evaluateSelectionEligibility(int i, boolean z, int i2) {
            ...
            if (!RendererCapabilities.CC.isFormatSupported(i, false) || !this.isWithinConstraints || this.format.bitrate == -1 || this.parameters.forceHighestSupportedBitrate || this.parameters.forceLowestBitrate) {
                return 1;
            }
    ...
    static final class TextTrackInfo extends TrackInfo<TextTrackInfo> implements Comparable<TextTrackInfo> {
        ...
        public TextTrackInfo(int i, TrackGroup trackGroup, int i2, Parameters parameters, int i3, String str) {
            ImmutableList<String> immutableListM22833of;
            int formatLanguageScore;
            super(i, trackGroup, i2);
            int i4 = 0;
            this.isWithinRendererCapabilities = RendererCapabilities.CC.isFormatSupported(i3, false);
            ...
            if (parameters.preferredTextLanguages.isEmpty()) {
                immutableListM22833of = ImmutableList.m22833of("");
            } else {
                immutableListM22833of = parameters.preferredTextLanguages;
            }
            int i6 = 0;
            while (true) {
                if (i6 >= immutableListM22833of.size()) {
                    i6 = Integer.MAX_VALUE;
                    formatLanguageScore = 0;
                    break;
                } else {
                    formatLanguageScore = DefaultTrackSelector.getFormatLanguageScore(this.format, immutableListM22833of.get(i6), parameters.selectUndeterminedTextLanguage);
                    if (formatLanguageScore > 0) {
                        break;
                    } else {
                        i6++;
