...
public final class MediaCodecUtil {
    ...
    public static void warmDecoderInfoCache(String str, boolean z, boolean z2) {
        try {
            ...
            Log.m288e(TAG, "Codec warming failed", e);
        }
    }
    ...
    public static synchronized List<MediaCodecInfo> getDecoderInfos(String str, boolean z, boolean z2) throws DecoderQueryException {
        ...
        if (z && decoderInfosInternal.isEmpty() && 21 <= Util.SDK_INT && Util.SDK_INT <= 23) {
            ...
            if (!decoderInfosInternal.isEmpty()) {
                Log.m291w(TAG, "MediaCodecList API didn't list secure decoder for: " + str + ". Assuming: " + decoderInfosInternal.get(0).name);
            }
        }
  ...
  0x008f: PHI (r16v9 boolean) = (r16v5 boolean), (r16v11 boolean) binds: [B:41:0x0097, B:35:0x008c] A[DONT_GENERATE, DONT_INLINE]] */
                                                ...
                                                if (z3) {
                                                    ...
                                                    if (codecKey2.secure == zIsFeatureSupported2) {
                                                        ...
                                                        try {
                                                            ...
                                                            Log.m287e(TAG, "Failed to query codec " + r6 + " (" + codecMimeType + ")");
                                                            throw e;
                                                        }
                                                    }
                                                } else {
                                                ...
                                                if (!z && zIsFeatureSupported2) {
                                                    try {
                                                        ...
                                                        if (Util.SDK_INT > 23 && !arrayList.isEmpty()) {
                                                            Log.m287e(TAG, "Skipping codec " + name + " (failed to query capabilities)");
                                                            i2 = i + 1;
                                                            codecKey2 = codecKey;
    ...
    private static Pair<Integer, Integer> getDolbyVisionProfileAndLevel(String str, String[] strArr) {
        if (strArr.length < 3) {
            Log.m291w(TAG, "Ignoring malformed Dolby Vision codec string: " + str);
            return null;
        }
        ...
        if (numDolbyVisionStringToProfile == null) {
            Log.m291w(TAG, "Unknown Dolby Vision profile string: " + strGroup);
            return null;
        }
        String str2 = strArr[2];
        Integer numDolbyVisionStringToLevel = dolbyVisionStringToLevel(str2);
        if (numDolbyVisionStringToLevel == null) {
            Log.m291w(TAG, "Unknown Dolby Vision level string: " + str2);
            return null;
        }
    ...
    private static Pair<Integer, Integer> getHevcProfileAndLevel(String str, String[] strArr, ColorInfo colorInfo) {
        if (strArr.length < 4) {
            Log.m291w(TAG, "Ignoring malformed HEVC codec string: " + str);
            return null;
        }
        int i = 1;
        Matcher matcher = PROFILE_PATTERN.matcher(strArr[1]);
        ...
        if (!"1".equals(strGroup)) {
            if ("2".equals(strGroup)) {
                ...
                Log.m291w(TAG, "Unknown HEVC profile string: " + strGroup);
                return null;
            }
        }
        ...
        if (numHevcCodecStringToProfileLevel == null) {
            Log.m291w(TAG, "Unknown HEVC level string: " + str2);
            return null;
        }
    ...
    private static Pair<Integer, Integer> getAvcProfileAndLevel(String str, String[] strArr) {
        ...
        int i2;
        if (strArr.length < 2) {
            Log.m291w(TAG, "Ignoring malformed AVC codec string: " + str);
            return null;
        }
        try {
    ...
    private static Pair<Integer, Integer> getVp9ProfileAndLevel(String str, String[] strArr) {
        if (strArr.length < 3) {
            Log.m291w(TAG, "Ignoring malformed VP9 codec string: " + str);
            return null;
        }
        try {
    ...
    private static Pair<Integer, Integer> getAv1ProfileAndLevel(String str, String[] strArr, ColorInfo colorInfo) {
        if (strArr.length < 4) {
            Log.m291w(TAG, "Ignoring malformed AV1 codec string: " + str);
            return null;
        }
        int i = 1;
        try {
            ...
            if (i2 != 0) {
                Log.m291w(TAG, "Unknown AV1 profile: " + i2);
                return null;
            }
            if (i4 != 8 && i4 != 10) {
                Log.m291w(TAG, "Unknown AV1 bit depth: " + i4);
                return null;
            }
            if (i4 != 8) {
            ...
            if (iAv1LevelNumberToConst == -1) {
                Log.m291w(TAG, "Unknown AV1 level: " + i3);
                return null;
            }
    ...
    private static Pair<Integer, Integer> getAacCodecProfileAndLevel(String str, String[] strArr) {
        ...
        if (strArr.length != 3) {
            Log.m291w(TAG, "Ignoring malformed MP4A codec string: " + str);
            return null;
        }
        try {
