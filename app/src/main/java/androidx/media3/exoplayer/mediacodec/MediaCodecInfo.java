...
public final class MediaCodecInfo {
    ...
    private void logNoSupport(String str) {
        Log.m285d("MediaCodecInfo", "NoSupport [" + str + "] [" + this.name + ", " + this.mimeType + "] [" + Util.DEVICE_DEBUG_INFO + C11744X3.j.f26440e);
    }

    private void logAssumedSupport(String str) {
        Log.m285d("MediaCodecInfo", "AssumedSupport [" + str + "] [" + this.name + ", " + this.mimeType + "] [" + Util.DEVICE_DEBUG_INFO + C11744X3.j.f26440e);
    }
    ...
    private static int adjustMaxInputChannelCount(String str, String str2, int i) {
        ...
        Log.m291w("MediaCodecInfo", "AssumedMaxChannelAdjustment: " + str + ", [" + i + " to " + i2 + C11744X3.j.f26440e);
        return i2;
    }
