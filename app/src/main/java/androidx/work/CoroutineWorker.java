...
public abstract class CoroutineWorker extends ListenableWorker {
    ...
    /* JADX INFO: compiled from: CoroutineWorker.kt */
    @Metadata(m43474d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m43475d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m43476k = 3, m43477mv = {1, 5, 1}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.work.CoroutineWorker$getForegroundInfoAsync$1", m43504f = "CoroutineWorker.kt", m43505i = {}, m43506l = {134}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    static final class C11521 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C11521(JobListenableFuture<ForegroundInfo> jobListenableFuture, CoroutineWorker coroutineWorker, Continuation<? super C11521> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C11521(this.$jobFuture, this.this$0, continuation);
        }
    ...
    /* JADX INFO: compiled from: CoroutineWorker.kt */
    @Metadata(m43474d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m43475d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m43476k = 3, m43477mv = {1, 5, 1}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.work.CoroutineWorker$startWork$1", m43504f = "CoroutineWorker.kt", m43505i = {}, m43506l = {68}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    static final class C11531 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return CoroutineWorker.this.new C11531(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C11531) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final ListenableFuture<ForegroundInfo> getForegroundInfoAsync() {
        ...
        BuildersKt__Builders_commonKt.launch$default(CoroutineScope, null, null, new C11521(jobListenableFuture, this, null), 3, null);
    ...
    public final ListenableFuture<ListenableWorker.Result> startWork() {
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(getCoroutineContext().plus(this.job)), null, null, new C11531(null), 3, null);
        return this.future;
    }
}
