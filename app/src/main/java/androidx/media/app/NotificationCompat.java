...
public class NotificationCompat {
    ...
    public static class MediaStyle extends androidx.core.app.NotificationCompat.Style {
        ...
        RemoteViews generateContentView() {
            ...
            remoteViewsApplyStandardTemplate.removeAllViews(C0679R.id.media_actions);
            if (iMin > 0) {
                for (int i = 0; i < iMin; i++) {
                    if (i >= size) {
                        throw new IllegalArgumentException(String.format("setShowActionsInCompactView: action %d out of bounds (max %d)", Integer.valueOf(i), Integer.valueOf(size - 1)));
                    }
                    remoteViewsApplyStandardTemplate.addView(C0679R.id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(this.mActionsToShowInCompact[i])));
                }
            }
            if (this.mShowCancelButton) {
                remoteViewsApplyStandardTemplate.setViewVisibility(C0679R.id.end_padder, 8);
                remoteViewsApplyStandardTemplate.setViewVisibility(C0679R.id.cancel_action, 0);
                remoteViewsApplyStandardTemplate.setOnClickPendingIntent(C0679R.id.cancel_action, this.mCancelButtonIntent);
                remoteViewsApplyStandardTemplate.setInt(C0679R.id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0679R.integer.cancel_button_image_alpha));
                return remoteViewsApplyStandardTemplate;
            }
            remoteViewsApplyStandardTemplate.setViewVisibility(C0679R.id.end_padder, 0);
            remoteViewsApplyStandardTemplate.setViewVisibility(C0679R.id.cancel_action, 8);
            return remoteViewsApplyStandardTemplate;
        }

        private RemoteViews generateMediaActionButton(androidx.core.app.NotificationCompat.Action action) {
            boolean z = action.getActionIntent() == null;
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), C0679R.layout.notification_media_action);
            remoteViews.setImageViewResource(C0679R.id.action0, action.getIcon());
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0679R.id.action0, action.getActionIntent());
            }
            Api15Impl.setContentDescription(remoteViews, C0679R.id.action0, action.getTitle());
            return remoteViews;
        }

        int getContentViewLayoutResource() {
            return C0679R.layout.notification_template_media;
        }
        ...
        RemoteViews generateBigContentView() {
            ...
            if (iMin > 0) {
                for (int i = 0; i < iMin; i++) {
                    remoteViewsApplyStandardTemplate.addView(C0679R.id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton) {
                remoteViewsApplyStandardTemplate.setViewVisibility(C0679R.id.cancel_action, 0);
        ...
        int getBigContentViewLayoutResource(int i) {
            if (i <= 3) {
                return C0679R.layout.notification_template_big_media_narrow;
            }
            return C0679R.layout.notification_template_big_media;
        }
    }
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        int getContentViewLayoutResource() {
            if (this.mBuilder.getContentView() != null) {
                return C0679R.layout.notification_template_media_custom;
            }
        ...
        int getBigContentViewLayoutResource(int i) {
            if (i <= 3) {
                return C0679R.layout.notification_template_big_media_narrow_custom;
            }
            return C0679R.layout.notification_template_big_media_custom;
        }
        ...
        private void setBackgroundColor(RemoteViews remoteViews) {
            ...
            if (this.mBuilder.getColor() != 0) {
                ...
                color = this.mBuilder.mContext.getResources().getColor(C0679R.color.notification_material_background_media_default_color);
            }
            remoteViews.setInt(C0679R.id.status_bar_latest_event_content, "setBackgroundColor", color);
        }
    }
