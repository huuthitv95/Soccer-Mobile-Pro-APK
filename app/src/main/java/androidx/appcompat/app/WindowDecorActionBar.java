...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View view) {
        ...
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0073R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0073R.id.action_context_bar);
        ...
        TypedArray typedArrayObtainStyledAttributes = this.mContext.obtainStyledAttributes(null, C0073R.styleable.ActionBar, C0073R.attr.actionBarStyle, 0);
        if (typedArrayObtainStyledAttributes.getBoolean(C0073R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0073R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0073R.attr.actionBarWidgetTheme, typedValue, true);
