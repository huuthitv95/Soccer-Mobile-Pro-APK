...
public class FlatBufferBuilder {
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf8) {
        ...
        if (byteBuffer != null) {
            ...
            byteBuffer.clear();
            this.f128bb.order(ByteOrder.LITTLE_ENDIAN);
        } else {
            this.f128bb = byteBufferFactory.newByteBuffer(i);
        }
        this.utf8 = utf8;
        this.space = this.f128bb.capacity();
    }
    ...
    public int offset() {
        return this.f128bb.capacity() - this.space;
    }

    public void pad(int i) {
        for (int i2 = 0; i2 < i; i2++) {
            ByteBuffer byteBuffer = this.f128bb;
            int i3 = this.space - 1;
            this.space = i3;
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer byteBufferOrder = this.f128bb.slice().order(ByteOrder.LITTLE_ENDIAN);
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.utf8.encodeUtf8(charSequence, this.f128bb);
        return endVector();
    }
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f128bb;
        int i = this.space - iRemaining;
        this.space = i;
        byteBuffer2.position(i);
        this.f128bb.put(byteBuffer);
        return endVector();
    }
    ...
    public int endTable() {
        ...
        loop2: while (true) {
            ...
            int iCapacity = this.f128bb.capacity() - this.vtables[i5];
            int i6 = this.space;
            short s = this.f128bb.getShort(iCapacity);
            if (s == this.f128bb.getShort(i6)) {
                int i7 = 2;
                while (true) {
                    if (i7 < s) {
                        if (this.f128bb.getShort(iCapacity + i7) != this.f128bb.getShort(i6 + i7)) {
                            break;
                        }
                        i7 += 2;
                    } else {
        ...
        if (i != 0) {
            int iCapacity2 = this.f128bb.capacity() - iOffset;
            this.space = iCapacity2;
            this.f128bb.putInt(iCapacity2, i - iOffset);
        } else {
    ...
    public void required(int i, int i2) {
        int iCapacity = this.f128bb.capacity() - i;
        if (this.f128bb.getShort((iCapacity - this.f128bb.getInt(iCapacity)) + i2) != 0) {
            return;
        }
    ...
    protected void finish(int i, boolean z) {
        ...
        addOffset(i);
        if (z) {
            addInt(this.f128bb.capacity() - this.space);
        }
        this.f128bb.position(this.space);
        this.finished = true;
    }
    ...
    public byte[] sizedByteArray(int i, int i2) {
        ...
        this.f128bb.position(i);
        this.f128bb.get(bArr);
        return bArr;
    }

    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f128bb.capacity() - this.space);
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer byteBufferDuplicate = this.f128bb.duplicate();
        byteBufferDuplicate.position(this.space);
        byteBufferDuplicate.limit(this.f128bb.capacity());
