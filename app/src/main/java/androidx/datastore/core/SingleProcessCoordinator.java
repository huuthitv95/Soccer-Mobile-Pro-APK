...
public final class SingleProcessCoordinator implements InterProcessCoordinator {
    ...
    @DebugMetadata(m43503c = "androidx.datastore.core.SingleProcessCoordinator", m43504f = "SingleProcessCoordinator.kt", m43505i = {0, 0, 1}, m43506l = {66, 41}, m43507m = "lock", m43508n = {"block", "$this$withLock_u24default$iv", "$this$withLock_u24default$iv"}, m43509s = {"L$0", "L$1", "L$0"})
    static final class C03891<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
    ...
    /* JADX INFO: compiled from: SingleProcessCoordinator.kt */
    @Metadata(m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.datastore.core.SingleProcessCoordinator", m43504f = "SingleProcessCoordinator.kt", m43505i = {0, 0}, m43506l = {50}, m43507m = "tryLock", m43508n = {"$this$withTryLock_u24default$iv", "locked$iv"}, m43509s = {"L$0", "Z$0"})
    static final class C03901<T> extends ContinuationImpl {
        Object L$0;
        boolean Z$0;
        int label;
        /* synthetic */ Object result;
    ...
    public <T> Object lock(Function1<? super Continuation<? super T>, ? extends Object> function1, Continuation<? super T> continuation) throws Throwable {
        ...
        Throwable th;
        Mutex mutex2;
        if (continuation instanceof C03891) {
            c03891 = (C03891) continuation;
            if ((c03891.label & Integer.MIN_VALUE) != 0) {
                c03891.label -= Integer.MIN_VALUE;
            } else {
                c03891 = new C03891(continuation);
            }
        } else {
            c03891 = new C03891(continuation);
        }
        Object obj = c03891.result;
        ...
        try {
            if (i == 0) {
                ...
                mutex = this.mutex;
                c03891.L$0 = function1;
                c03891.L$1 = mutex;
                c03891.label = 1;
                if (mutex.lock(null, c03891) != coroutine_suspended) {
                }
            ...
            Mutex mutex3 = (Mutex) c03891.L$1;
            Function1<? super Continuation<? super T>, ? extends Object> function2 = (Function1) c03891.L$0;
            ResultKt.throwOnFailure(obj);
            mutex = mutex3;
            function1 = function2;
            c03891.L$0 = mutex;
            c03891.L$1 = null;
            c03891.label = 2;
            Object objInvoke = function1.invoke(c03891);
    ...
    public <T> Object tryLock(Function2<? super Boolean, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) throws Throwable {
        ...
        try {
            ...
            c03901.Z$0 = zTryLock;
            c03901.label = 1;
            Object objInvoke = function2.invoke(boolBoxBoolean, c03901);
            if (objInvoke == coroutine_suspended) {
                return coroutine_suspended;
            }
            mutex = mutex2;
