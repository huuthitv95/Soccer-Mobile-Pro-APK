...
public final class DataStoreImpl<T> implements DataStore<T> {
    ...
    @DebugMetadata(m43503c = "androidx.datastore.core.DataStoreImpl", m43504f = "DataStoreImpl.kt", m43505i = {0, 0}, m43506l = {544}, m43507m = "decrementCollector", m43508n = {"this", "$this$withLock_u24default$iv"}, m43509s = {"L$0", "L$1"})
    static final class C03561 extends ContinuationImpl {
        ...
        C03561(DataStoreImpl<T> dataStoreImpl, Continuation<? super C03561> continuation) {
            super(continuation);
    ...
    /* JADX INFO: compiled from: DataStoreImpl.kt */
    @Metadata(m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.datastore.core.DataStoreImpl", m43504f = "DataStoreImpl.kt", m43505i = {1, 1}, m43506l = {237, 243, 246}, m43507m = "handleUpdate", m43508n = {"update", "$this$handleUpdate_u24lambda_u242"}, m43509s = {"L$0", "L$1"})
    static final class C03581 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03581(DataStoreImpl<T> dataStoreImpl, Continuation<? super C03581> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    /* JADX INFO: compiled from: DataStoreImpl.kt */
    @Metadata(m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.datastore.core.DataStoreImpl", m43504f = "DataStoreImpl.kt", m43505i = {0, 0}, m43506l = {544}, m43507m = "incrementCollector", m43508n = {"this", "$this$withLock_u24default$iv"}, m43509s = {"L$0", "L$1"})
    static final class C03591 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03591(DataStoreImpl<T> dataStoreImpl, Continuation<? super C03591> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    /* JADX INFO: compiled from: DataStoreImpl.kt */
    @Metadata(m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.datastore.core.DataStoreImpl", m43504f = "DataStoreImpl.kt", m43505i = {0, 1, 1}, m43506l = {264, 266}, m43507m = "readAndInitOrPropagateAndThrowFailure", m43508n = {"this", "this", "preReadVersion"}, m43509s = {"L$0", "L$0", "I$0"})
    static final class C03611 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03611(DataStoreImpl<T> dataStoreImpl, Continuation<? super C03611> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    /* JADX INFO: compiled from: DataStoreImpl.kt */
    @Metadata(m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.datastore.core.DataStoreImpl", m43504f = "DataStoreImpl.kt", m43505i = {0, 0, 0, 1, 2}, m43506l = {MBSupportMuteAdType.INTERSTITIAL_VIDEO, 296, 304}, m43507m = "readDataAndUpdateCache", m43508n = {"this", "currentState", "requireLock", "this", "this"}, m43509s = {"L$0", "L$1", "Z$0", "L$0", "L$0"})
    static final class C03621 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03621(DataStoreImpl<T> dataStoreImpl, Continuation<? super C03621> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    /* JADX INFO: compiled from: DataStoreImpl.kt */
    @Metadata(m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.datastore.core.DataStoreImpl", m43504f = "DataStoreImpl.kt", m43505i = {0, 0, 1, 1, 2, 2, 3, 3, 4, 4, 4, 4, 5, 5, 5}, m43506l = {365, 366, 368, 369, 380, 384}, m43507m = "readDataOrHandleCorruption", m43508n = {"this", "hasWriteFileLock", "this", "hasWriteFileLock", "this", "hasWriteFileLock", "this", "hasWriteFileLock", "this", "ex", "newData", "hasWriteFileLock", "ex", "newData", "version"}, m43509s = {"L$0", "Z$0", "L$0", "Z$0", "L$0", "Z$0", "L$0", "Z$0", "L$0", "L$1", "L$2", "Z$0", "L$0", "L$1", "L$2"})
    static final class C03651 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03651(DataStoreImpl<T> dataStoreImpl, Continuation<? super C03651> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    public final Object incrementCollector(Continuation<? super Unit> continuation) throws Throwable {
        ...
        Mutex mutex;
        if (continuation instanceof C03591) {
            c03591 = (C03591) continuation;
            if ((c03591.label & Integer.MIN_VALUE) != 0) {
                c03591.label -= Integer.MIN_VALUE;
            } else {
                c03591 = new C03591(this, continuation);
            }
        } else {
            c03591 = new C03591(this, continuation);
        }
        Object obj = c03591.result;
        ...
        if (i == 0) {
            ...
            c03591.L$1 = mutex2;
            c03591.label = 1;
            if (mutex2.lock(null, c03591) == coroutine_suspended) {
            ...
            mutex = (Mutex) c03591.L$1;
            dataStoreImpl = (DataStoreImpl) c03591.L$0;
            ResultKt.throwOnFailure(obj);
        }
        try {
    ...
    public final Object decrementCollector(Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C03561) {
            ...
            if ((c03561.label & Integer.MIN_VALUE) != 0) {
                ...
                c03561 = new C03561(this, continuation);
            }
        } else {
            c03561 = new C03561(this, continuation);
        }
        Object obj = c03561.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c03561.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            c03561.L$1 = mutex2;
            c03561.label = 1;
            if (mutex2.lock(null, c03561) == coroutine_suspended) {
                return coroutine_suspended;
            }
            dataStoreImpl = this;
            mutex = mutex2;
            ...
            mutex = (Mutex) c03561.L$1;
            dataStoreImpl = (DataStoreImpl) c03561.L$0;
            ResultKt.throwOnFailure(obj);
        }
        try {
            int i2 = dataStoreImpl.collectorCounter - 1;
    ...
    public Object updateData(Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        ...
        return BuildersKt.withContext(new UpdatingDataContextElement(updatingDataContextElement, this), new C03702(this, function2, null), continuation);
    }

    /* JADX INFO: renamed from: androidx.datastore.core.DataStoreImpl$updateData$2 */
    /* JADX INFO: compiled from: DataStoreImpl.kt */
    @Metadata(m43474d1 = {"\u0000\b\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001*\u00020\u0002H\u008a@"}, m43475d2 = {"<anonymous>", "T", "Lkotlinx/coroutines/CoroutineScope;"}, m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.datastore.core.DataStoreImpl$updateData$2", m43504f = "DataStoreImpl.kt", m43505i = {}, m43506l = {169}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    static final class C03702 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C03702(DataStoreImpl<T> dataStoreImpl, Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super C03702> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03702 c03702 = new C03702(this.this$0, this.$transform, continuation);
            c03702.L$0 = obj;
            return c03702;
        }
    ...
    /* JADX INFO: compiled from: DataStoreImpl.kt */
    @Metadata(m43474d1 = {"\u0000\f\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m43475d2 = {"<anonymous>", "Landroidx/datastore/core/State;", "T", "Lkotlinx/coroutines/CoroutineScope;"}, m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.datastore.core.DataStoreImpl$readState$2", m43504f = "DataStoreImpl.kt", m43505i = {}, m43506l = {Sdk.SDKError.Reason.MRAID_JS_DOES_NOT_EXIST_VALUE, Sdk.SDKError.Reason.PRIVACY_ICON_FALLBACK_ERROR_VALUE}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    static final class C03682 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super State<T>>, Object> {
        final /* synthetic */ boolean $requireLock;
        int label;
        final /* synthetic */ DataStoreImpl<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03682(DataStoreImpl<T> dataStoreImpl, boolean z, Continuation<? super C03682> continuation) {
            super(2, continuation);
            this.this$0 = dataStoreImpl;
            this.$requireLock = z;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C03682(this.this$0, this.$requireLock, continuation);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r5) throws java.lang.Throwable {
            ...
            L5d:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.core.DataStoreImpl.C03682.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final Object readState(boolean z, Continuation<? super State<T>> continuation) {
        return BuildersKt.withContext(this.scope.getCoroutineContext(), new C03682(this, z, null), continuation);
    }
    ...
    */
    public final java.lang.Object readAndInitOrPropagateAndThrowFailure(kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
        /*
            r5 = this;
            boolean r0 = r6 instanceof androidx.datastore.core.DataStoreImpl.C03611
            if (r0 == 0) goto L14
            r0 = r6
            androidx.datastore.core.DataStoreImpl$readAndInitOrPropagateAndThrowFailure$1 r0 = (androidx.datastore.core.DataStoreImpl.C03611) r0
            int r1 = r0.label
    ...
    */
    ...
    /* JADX INFO: compiled from: DataStoreImpl.kt */
    @Metadata(m43474d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\u0010\u0000\u001a\u0014\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00030\u0002\u0012\u0004\u0012\u00020\u00040\u0001\"\u0004\b\u0000\u0010\u0003H\u008a@"}, m43475d2 = {"<anonymous>", "Lkotlin/Pair;", "Landroidx/datastore/core/State;", "T", ""}, m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.datastore.core.DataStoreImpl$readDataAndUpdateCache$3", m43504f = "DataStoreImpl.kt", m43505i = {}, m43506l = {298, 300}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    static final class C03633 extends SuspendLambda implements Function1<Continuation<? super Pair<? extends State<T>, ? extends Boolean>>, Object> {
        Object L$0;
        int label;
        final /* synthetic */ DataStoreImpl<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03633(DataStoreImpl<T> dataStoreImpl, Continuation<? super C03633> continuation) {
        ...
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C03633(this.this$0, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Pair<? extends State<T>, Boolean>> continuation) {
            return ((C03633) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
            ...
            try {
                if (i == 0) {
                    ...
                    if (i != 1) {
                        ...
                        return TuplesKt.m43482to(readException, Boxing.boxBoolean(true));
                    }
                    ResultKt.throwOnFailure(obj);
                }
    ...
    /* JADX INFO: compiled from: DataStoreImpl.kt */
    @Metadata(m43474d1 = {"\u0000\u0012\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\u0010\u0000\u001a\u0014\u0012\n\u0012\b\u0012\u0004\u0012\u0002H\u00030\u0002\u0012\u0004\u0012\u00020\u00040\u0001\"\u0004\b\u0000\u0010\u00032\u0006\u0010\u0005\u001a\u00020\u0004H\u008a@"}, m43475d2 = {"<anonymous>", "Lkotlin/Pair;", "Landroidx/datastore/core/State;", "T", "", "locked"}, m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.datastore.core.DataStoreImpl$readDataAndUpdateCache$4", m43504f = "DataStoreImpl.kt", m43505i = {0, 1}, m43506l = {306, 309}, m43507m = "invokeSuspend", m43508n = {"locked", "locked"}, m43509s = {"Z$0", "Z$0"})
    static final class C03644 extends SuspendLambda implements Function2<Boolean, Continuation<? super Pair<? extends State<T>, ? extends Boolean>>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03644(DataStoreImpl<T> dataStoreImpl, int i, Continuation<? super C03644> continuation) {
            super(2, continuation);
            this.this$0 = dataStoreImpl;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03644 c03644 = new C03644(this.this$0, this.$cachedVersion, continuation);
            c03644.Z$0 = ((Boolean) obj).booleanValue();
            return c03644;
        }
        ...
        public final Object invoke(boolean z, Continuation<? super Pair<? extends State<T>, Boolean>> continuation) {
            return ((C03644) create(Boolean.valueOf(z), continuation)).invokeSuspend(Unit.INSTANCE);
        }
            ...
            try {
                if (r3 == 0) {
                    ...
                    if (r3 != 1) {
                        ...
                        r2 = r0;
                        return TuplesKt.m43482to(readException, Boxing.boxBoolean(r2));
                    }
                    boolean z3 = this.Z$0;
                    ResultKt.throwOnFailure(obj);
                    r3 = z3;
    ...
    /* JADX INFO: compiled from: DataStoreImpl.kt */
    @Metadata(m43474d1 = {"\u0000\u0004\n\u0002\b\u0002\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001H\u008a@"}, m43475d2 = {"<anonymous>", "T"}, m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.datastore.core.DataStoreImpl$transformAndWrite$2", m43504f = "DataStoreImpl.kt", m43505i = {1, 2}, m43506l = {330, 331, 337}, m43507m = "invokeSuspend", m43508n = {"curData", "newData"}, m43509s = {"L$0", "L$0"})
    static final class C03692 extends SuspendLambda implements Function1<Continuation<? super T>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C03692(DataStoreImpl<T> dataStoreImpl, CoroutineContext coroutineContext, Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super C03692> continuation) {
            super(1, continuation);
            this.this$0 = dataStoreImpl;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C03692(this.this$0, this.$callerContext, this.$transform, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super T> continuation) {
            return ((C03692) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object transformAndWrite(Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, CoroutineContext coroutineContext, Continuation<? super T> continuation) {
        return getCoordinator().lock(new C03692(this, coroutineContext, function2, null), continuation);
    }
    ...
    public final Object readDataOrHandleCorruption(boolean z, Continuation<? super Data<T>> continuation) throws Throwable {
        ...
        if (continuation instanceof C03651) {
            ...
            if ((c03651.label & Integer.MIN_VALUE) != 0) {
                ...
                c03651 = new C03651(this, continuation);
            }
        } else {
            c03651 = new C03651(this, continuation);
        }
        Object obj2 = (T) c03651.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        ?? r3 = c03651.label;
        try {
            switch (r3) {
                case 0:
                    ...
                    try {
                        if (z) {
                            ...
                            c03651.Z$0 = z;
                            c03651.label = 1;
                            obj2 = (T) readDataFromFileOrDefault(c03651);
                            if (obj2 != coroutine_suspended) {
                                ...
                                if (obj2 != null) {
                                    try {
                                        ...
                                        c03651.L$0 = r7;
                                        c03651.L$1 = e;
                                        c03651.L$2 = objectRef;
                                        c03651.L$3 = objectRef;
                                        c03651.Z$0 = z;
                                        c03651.label = 5;
                                        objHandleCorruption = corruptionHandler.handleCorruption(e, c03651);
                                        if (objHandleCorruption != coroutine_suspended) {
                                            ...
                                            try {
                                                c03673 = new C03673(objectRef, r8, intRef, null);
                                                c03651.L$0 = corruptionException;
                                                c03651.L$1 = objectRef;
                                                c03651.L$2 = intRef;
                                                c03651.L$3 = null;
                                                c03651.label = 6;
                                                if (r8.doWithWriteFileLock(z, c03673, c03651) != coroutine_suspended) {
                                                    intRef2 = intRef;
                                ...
                                c03651.L$1 = obj2;
                                c03651.Z$0 = z;
                                c03651.I$0 = iHashCode;
                                c03651.label = 2;
                                version = coordinator.getVersion(c03651);
                                if (version != coroutine_suspended) {
                                    int i2 = iHashCode;
                                    z2 = z;
                                    i = i2;
                            ...
                            c03651.Z$0 = z;
                            c03651.label = 3;
                            obj2 = (T) coordinator2.getVersion(c03651);
                            if (obj2 != coroutine_suspended) {
                                r2 = this;
                                int iIntValue = ((Number) obj2).intValue();
                                InterProcessCoordinator coordinator3 = r2.getCoordinator();
                                C03662 c03662 = new C03662(r2, iIntValue, null);
                                c03651.L$0 = r2;
                                c03651.Z$0 = z;
                                c03651.label = 4;
                                obj2 = (T) coordinator3.tryLock(c03662, c03651);
                                if (obj2 == coroutine_suspended) {
                                }
                                return (Data) obj2;
                            }
                        ...
                        c03651.Z$0 = z;
                        c03651.label = 5;
                        objHandleCorruption = corruptionHandler2.handleCorruption(e, c03651);
                        if (objHandleCorruption != coroutine_suspended) {
                            corruptionException = e;
                            obj2 = (T) objHandleCorruption;
                            objectRef2 = objectRef;
                ...
                case 1:
                    z = c03651.Z$0;
                    DataStoreImpl dataStoreImpl = (DataStoreImpl) c03651.L$0;
                    ResultKt.throwOnFailure(obj2);
                    r6 = dataStoreImpl;
                    if (obj2 != null) {
                        iHashCode = obj2.hashCode();
                    ...
                    c03651.I$0 = iHashCode;
                    c03651.label = 2;
                    version = coordinator4.getVersion(c03651);
                    if (version != coroutine_suspended) {
                        int i3 = iHashCode;
                        z2 = z;
                        i = i3;
                ...
                case 2:
                    ...
                    try {
                        ...
                        c03651.Z$0 = z;
                        c03651.label = 5;
                        objHandleCorruption = corruptionHandler3.handleCorruption(e, c03651);
                        if (objHandleCorruption != coroutine_suspended) {
                            corruptionException = e;
                            obj2 = (T) objHandleCorruption;
                            objectRef2 = objectRef;
                ...
                case 3:
                    z = c03651.Z$0;
                    DataStoreImpl dataStoreImpl2 = (DataStoreImpl) c03651.L$0;
                    ResultKt.throwOnFailure(obj2);
                    r2 = dataStoreImpl2;
                    int iIntValue2 = ((Number) obj2).intValue();
                    InterProcessCoordinator coordinator5 = r2.getCoordinator();
                    C03662 c03663 = new C03662(r2, iIntValue2, null);
                    c03651.L$0 = r2;
                    c03651.Z$0 = z;
                    c03651.label = 4;
                    obj2 = (T) coordinator5.tryLock(c03663, c03651);
                    if (obj2 == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    return (Data) obj2;
                case 4:
                    boolean z3 = c03651.Z$0;
                    ResultKt.throwOnFailure(obj2);
                    return (Data) obj2;
                case 5:
                    z = c03651.Z$0;
                    Ref.ObjectRef objectRef4 = (Ref.ObjectRef) c03651.L$3;
                    Ref.ObjectRef objectRef5 = (Ref.ObjectRef) c03651.L$2;
                    corruptionException = (CorruptionException) c03651.L$1;
                    DataStoreImpl dataStoreImpl3 = (DataStoreImpl) c03651.L$0;
                    ResultKt.throwOnFailure(obj2);
                    ...
                    return coroutine_suspended;
                case 6:
                    intRef2 = (Ref.IntRef) c03651.L$2;
                    objectRef3 = (Ref.ObjectRef) c03651.L$1;
                    corruptionException2 = (CorruptionException) c03651.L$0;
                    try {
                        ResultKt.throwOnFailure(obj2);
    ...
    /* JADX INFO: compiled from: DataStoreImpl.kt */
    @Metadata(m43474d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\u0010\u0000\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@"}, m43475d2 = {"<anonymous>", "Landroidx/datastore/core/Data;", "T", "locked", ""}, m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.datastore.core.DataStoreImpl$readDataOrHandleCorruption$2", m43504f = "DataStoreImpl.kt", m43505i = {0, 1}, m43506l = {370, 371}, m43507m = "invokeSuspend", m43508n = {"locked", "data"}, m43509s = {"Z$0", "L$0"})
    static final class C03662 extends SuspendLambda implements Function2<Boolean, Continuation<? super Data<T>>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03662(DataStoreImpl<T> dataStoreImpl, int i, Continuation<? super C03662> continuation) {
            super(2, continuation);
            this.this$0 = dataStoreImpl;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03662 c03662 = new C03662(this.this$0, this.$preLockVersion, continuation);
            c03662.Z$0 = ((Boolean) obj).booleanValue();
            return c03662;
        }
        ...
        public final Object invoke(boolean z, Continuation<? super Data<T>> continuation) {
            return ((C03662) create(Boolean.valueOf(z), continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX INFO: compiled from: DataStoreImpl.kt */
    @Metadata(m43474d1 = {"\u0000\b\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002H\u008a@"}, m43475d2 = {"<anonymous>", "", "T"}, m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.datastore.core.DataStoreImpl$readDataOrHandleCorruption$3", m43504f = "DataStoreImpl.kt", m43505i = {}, m43506l = {387, 388, 390}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    static final class C03673 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03673(Ref.ObjectRef<T> objectRef, DataStoreImpl<T> dataStoreImpl, Ref.IntRef intRef, Continuation<? super C03673> continuation) {
            super(1, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C03673(this.$newData, this.this$0, this.$version, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C03673) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final <R> Object doWithWriteFileLock(boolean z, Function1<? super Continuation<? super R>, ? extends Object> function1, Continuation<? super R> continuation) {
        ...
        return getCoordinator().lock(new C03573(function1, null), continuation);
    }

    /* JADX INFO: Add missing generic type declarations: [R] */
    /* JADX INFO: renamed from: androidx.datastore.core.DataStoreImpl$doWithWriteFileLock$3 */
    /* JADX INFO: compiled from: DataStoreImpl.kt */
    @Metadata(m43474d1 = {"\u0000\u0004\n\u0002\b\u0003\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001\"\u0004\b\u0001\u0010\u0002H\u008a@"}, m43475d2 = {"<anonymous>", "R", "T"}, m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.datastore.core.DataStoreImpl$doWithWriteFileLock$3", m43504f = "DataStoreImpl.kt", m43505i = {}, m43506l = {416}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    static final class C03573<R> extends SuspendLambda implements Function1<Continuation<? super R>, Object> {
        final /* synthetic */ Function1<Continuation<? super R>, Object> $block;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C03573(Function1<? super Continuation<? super R>, ? extends Object> function1, Continuation<? super C03573> continuation) {
            super(1, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C03573(this.$block, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super R> continuation) {
            return ((C03573) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: compiled from: DataStoreImpl.kt */
    @Metadata(m43474d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\u0010\u0000\n\u0002\b\u0005\b\u0082\u0004\u0018\u00002\u00020\u0001BD\u0012=\u0010\u0002\u001a9\u00125\u00123\b\u0001\u0012\u0019\u0012\u0017\u0012\u0004\u0012\u00028\u00000\u0005¢\u0006\f\b\u0006\u0012\b\b\u0007\u0012\u0004\b\b(\b\u0012\n\u0012\b\u0012\u0004\u0012\u00020\n0\t\u0012\u0006\u0012\u0004\u0018\u00010\u000b0\u00040\u0003¢\u0006\u0002\u0010\fJ\u000e\u0010\u000e\u001a\u00020\nH\u0094@¢\u0006\u0002\u0010\u000fRG\u0010\r\u001a;\u00125\u00123\b\u0001\u0012\u0019\u0012\u0017\u0012\u0004\u0012\u00028\u00000\u0005¢\u0006\f\b\u0006\u0012\b\b\u0007\u0012\u0004\b\b(\b\u0012\n\u0012\b\u0012\u0004\u0012\u00020\n0\t\u0012\u0006\u0012\u0004\u0018\u00010\u000b0\u0004\u0018\u00010\u0003X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u0010"}, m43475d2 = {"Landroidx/datastore/core/DataStoreImpl$InitDataStore;", "Landroidx/datastore/core/RunOnce;", "initTasksList", "", "Lkotlin/Function2;", "Landroidx/datastore/core/InitializerApi;", "Lkotlin/ParameterName;", "name", "api", "Lkotlin/coroutines/Continuation;", "", "", "(Landroidx/datastore/core/DataStoreImpl;Ljava/util/List;)V", "initTasks", "doRun", "(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "datastore-core_release"}, m43476k = 1, m43477mv = {1, 8, 0}, m43479xi = 48)
