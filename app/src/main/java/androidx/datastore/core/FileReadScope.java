...
public class FileReadScope<T> implements ReadScope<T> {
    ...
    @DebugMetadata(m43503c = "androidx.datastore.core.FileReadScope", m43504f = "FileStorage.kt", m43505i = {0}, m43506l = {169, 178}, m43507m = "readData$suspendImpl", m43508n = {"$this"}, m43509s = {"L$0"})
    static final class C03711<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        ...
        C03711(FileReadScope<T> fileReadScope, Continuation<? super C03711> continuation) {
            super(continuation);
    ...
    static /* synthetic */ <T> Object readData$suspendImpl(FileReadScope<T> fileReadScope, Continuation<? super T> continuation) throws Throwable {
        ...
        Throwable th2;
        if (continuation instanceof C03711) {
            c03711 = (C03711) continuation;
            if ((c03711.label & Integer.MIN_VALUE) != 0) {
                c03711.label -= Integer.MIN_VALUE;
            } else {
                c03711 = new C03711(fileReadScope, continuation);
            }
        } else {
            c03711 = new C03711(fileReadScope, continuation);
        }
        Object obj = c03711.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        ?? r2 = c03711.label;
        try {
            if (r2 != 0) {
                if (r2 == 1) {
                    closeable2 = (java.io.Closeable) c03711.L$1;
                    r2 = (FileReadScope) c03711.L$0;
                    try {
                        ResultKt.throwOnFailure(obj);
                        kotlin.p300io.CloseableKt.closeFinally(closeable2, null);
                        return obj;
                    } catch (Throwable th3) {
                        th2 = th3;
                        try {
                            ...
                            kotlin.p300io.CloseableKt.closeFinally(closeable2, th2);
                            throw th4;
                        }
                    }
                }
                ...
                closeable = (java.io.Closeable) c03711.L$0;
                try {
                    ResultKt.throwOnFailure(obj);
            ...
            try {
                ...
                try {
                    c03711.L$0 = fileReadScope;
                    c03711.L$1 = fileInputStream;
                    c03711.label = 1;
                    Object from = ((FileReadScope) fileReadScope).serializer.readFrom(fileInputStream, c03711);
                ...
                if (((FileReadScope) fileReadScope).file.exists()) {
                    ...
                    try {
                        c03711.L$0 = fileInputStream2;
                        c03711.L$1 = null;
                        c03711.label = 2;
                        Object from2 = ((FileReadScope) fileReadScope).serializer.readFrom(fileInputStream2, c03711);
