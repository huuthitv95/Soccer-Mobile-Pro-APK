...
public final class MultiProcessCoordinator implements InterProcessCoordinator {
    ...
    @DebugMetadata(m43503c = "androidx.datastore.core.MultiProcessCoordinator", m43504f = "MultiProcessCoordinator.android.kt", m43505i = {0, 0, 0, 1, 1, 2, 2}, m43506l = {211, 47, 48}, m43507m = "lock", m43508n = {"this", "block", "$this$withLock_u24default$iv", "block", "$this$withLock_u24default$iv", "$this$withLock_u24default$iv", "lock"}, m43509s = {"L$0", "L$1", "L$2", "L$0", "L$1", "L$0", "L$2"})
    static final class C03801<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        int label;
    ...
    /* JADX INFO: compiled from: MultiProcessCoordinator.android.kt */
    @Metadata(m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.datastore.core.MultiProcessCoordinator", m43504f = "MultiProcessCoordinator.android.kt", m43505i = {0, 0, 1, 1, 1}, m43506l = {62, 87}, m43507m = "tryLock", m43508n = {"$this$withTryLock_u24default$iv", "locked$iv", "$this$withTryLock_u24default$iv", "lock", "locked$iv"}, m43509s = {"L$0", "Z$0", "L$0", "L$2", "Z$0"})
    static final class C03811<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        boolean Z$0;
    ...
    public <T> Object lock(Function1<? super Continuation<? super T>, ? extends Object> function1, Continuation<? super T> continuation) throws Throwable {
        ...
        ?? r1;
        ?? r0;
        if (continuation instanceof C03801) {
            c03801 = (C03801) continuation;
            if ((c03801.label & Integer.MIN_VALUE) != 0) {
                c03801.label -= Integer.MIN_VALUE;
            } else {
                c03801 = new C03801(continuation);
            }
        } else {
            c03801 = new C03801(continuation);
        }
        Object obj = c03801.result;
                ...
                try {
                    try {
                        if (i == 0) {
                            ...
                            c03801.L$0 = this;
                            c03801.L$1 = function1;
                            c03801.L$2 = mutex;
                            c03801.label = 1;
                            if (mutex.lock(null, c03801) != coroutine_suspended) {
                        ...
                        if (i != 1) {
                            if (i != 2) {
                                ...
                                fileLock = (FileLock) c03801.L$2;
                                java.io.Closeable closeable = (java.io.Closeable) c03801.L$1;
                                Mutex mutex2 = (Mutex) c03801.L$0;
                                try {
                                    ResultKt.throwOnFailure(obj);
                                    r0 = mutex2;
                                    r1 = closeable;
                                    ...
                                    try {
                                        kotlin.p300io.CloseableKt.closeFinally(r1, null);
                                        r0.unlock(null);
                                        return obj;
                                    } catch (Throwable th2) {
                                        th = th2;
                            ...
                            r10 = (java.io.Closeable) c03801.L$2;
                            r2 = (Mutex) c03801.L$1;
                            function2 = (Function1) c03801.L$0;
                            try {
                                ResultKt.throwOnFailure(obj);
                                r2 = r2;
                                r10 = r10;
                                ...
                                try {
                                    c03801.L$0 = r2;
                                    c03801.L$1 = r10;
                                    c03801.L$2 = fileLock2;
                                    c03801.label = 3;
                                    objInvoke = function2.invoke(c03801);
                        ...
                        Mutex mutex3 = (Mutex) c03801.L$2;
                        Function1<? super Continuation<? super T>, ? extends Object> function3 = (Function1) c03801.L$1;
                        multiProcessCoordinator = (MultiProcessCoordinator) c03801.L$0;
                        ResultKt.throwOnFailure(obj);
                        r11 = mutex3;
                        function1 = function3;
                        Companion companion = INSTANCE;
                        c03801.L$0 = function1;
                        c03801.L$1 = r11;
                        c03801.L$2 = fileOutputStream;
                        c03801.label = 2;
                        Object exclusiveFileLockWithRetryIfDeadlock = companion.getExclusiveFileLockWithRetryIfDeadlock(fileOutputStream2, c03801);
                    ...
                    try {
                        ...
                        kotlin.p300io.CloseableKt.closeFinally(fileOutputStream, th);
                        throw th8;
                    }
                }
    ...
    public <T> Object tryLock(Function2<? super Boolean, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) throws Throwable {
        ...
        if (continuation instanceof C03811) {
            C03811 c03812 = (C03811) continuation;
            if ((c03812.label & Integer.MIN_VALUE) != 0) {
                c03812.label -= Integer.MIN_VALUE;
                c03811 = c03812;
            } else {
        ...
        Object objInvoke = c03811.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        ?? r5 = c03811.label;
        try {
            try {
                if (r5 != 0) {
                    ...
                    z = c03811.Z$0;
                    fileLock = (FileLock) c03811.L$2;
                    java.io.Closeable closeable2 = (java.io.Closeable) c03811.L$1;
                    mutex = (Mutex) c03811.L$0;
                    try {
                        ResultKt.throwOnFailure(objInvoke);
                ...
                try {
                    if (TryLock == 0) {
                        ...
                        c03811.Z$0 = TryLock;
                        c03811.label = 1;
                        objInvoke = r2.invoke(boolBoxBoolean, c03811);
                        if (objInvoke != coroutine_suspended) {
                            mutex2 = mutex3;
                            z2 = TryLock == true ? 1 : 0;
                            if (z2) {
                        ...
                        try {
                            try {
                                ...
                                try {
                                    ...
                                    c03811.L$0 = mutex3;
                                    c03811.L$1 = fileInputStream;
                                    c03811.L$2 = fileLockTryLock;
                                    c03811.Z$0 = TryLock;
                                    c03811.label = 2;
                                    objInvoke = r2.invoke(boolBoxBoolean2, c03811);
                                    if (objInvoke != coroutine_suspended) {
                                        mutex = mutex3;
                                        z = TryLock == true ? 1 : 0;
                            ...
                            try {
                                ...
                                try {
                                    kotlin.p300io.CloseableKt.closeFinally(r11, th);
                                    throw th6;
                                } catch (Throwable th7) {
                                    th = th7;
                                    r2 = TryLock;
    ...
    private final <T> Object withLazyCounter(Function2<? super SharedCounter, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        ...
        return BuildersKt.withContext(this.context, new C03822(function2, this, null), continuation);
    }
    ...
    @DebugMetadata(m43503c = "androidx.datastore.core.MultiProcessCoordinator$withLazyCounter$2", m43504f = "MultiProcessCoordinator.android.kt", m43505i = {}, m43506l = {163}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    public static final class C03822<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public C03822(Function2<? super SharedCounter, ? super Continuation<? super T>, ? extends Object> function2, MultiProcessCoordinator multiProcessCoordinator, Continuation<? super C03822> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C03822(this.$block, this.this$0, continuation);
        }
    ...
    /* JADX INFO: compiled from: MultiProcessCoordinator.android.kt */
    @Metadata(m43474d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0016\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bH\u0082@¢\u0006\u0002\u0010\fR\u000e\u0010\u0003\u001a\u00020\u0004X\u0082D¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0082D¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0006X\u0082D¢\u0006\u0002\n\u0000¨\u0006\r"}, m43475d2 = {"Landroidx/datastore/core/MultiProcessCoordinator$Companion;", "", "()V", "DEADLOCK_ERROR_MESSAGE", "", "INITIAL_WAIT_MILLIS", "", "MAX_WAIT_MILLIS", "getExclusiveFileLockWithRetryIfDeadlock", "Ljava/nio/channels/FileLock;", "lockFileStream", "Ljava/io/FileOutputStream;", "(Ljava/io/FileOutputStream;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "datastore-core_release"}, m43476k = 1, m43477mv = {1, 8, 0}, m43479xi = 48)
    public static final class Companion {
        ...
        */
        public final java.lang.Object getExclusiveFileLockWithRetryIfDeadlock(java.io.FileOutputStream r14, kotlin.coroutines.Continuation<? super java.nio.channels.FileLock> r15) throws java.lang.Throwable {
            /*
                r13 = this;
                boolean r0 = r15 instanceof androidx.datastore.core.C0377xe413854a
                if (r0 == 0) goto L14
                r0 = r15
                androidx.datastore.core.MultiProcessCoordinator$Companion$getExclusiveFileLockWithRetryIfDeadlock$1 r0 = (androidx.datastore.core.C0377xe413854a) r0
                int r1 = r0.label
    ...
    public Object incrementAndGetVersion(Continuation<? super Integer> continuation) {
        ...
        return BuildersKt.withContext(this.context, new C0378xb55e9682(this, null), continuation);
    }
}
