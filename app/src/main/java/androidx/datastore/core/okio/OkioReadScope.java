...
@Metadata(m43474d1 = {"\u00000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010\u0002\n\u0002\b\u0004\b\u0010\u0018\u0000*\u0004\b\u0000\u0010\u00012\b\u0012\u0004\u0012\u0002H\u00010\u0002B#\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0006\u0012\f\u0010\u0007\u001a\b\u0012\u0004\u0012\u00028\u00000\b¢\u0006\u0002\u0010\tJ\b\u0010\u0012\u001a\u00020\u0013H\u0004J\b\u0010\u0014\u001a\u00020\u0013H\u0016J\u000e\u0010\u0015\u001a\u00028\u0000H\u0096@¢\u0006\u0002\u0010\u0016R\u000e\u0010\n\u001a\u00020\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0003\u001a\u00020\u0004X\u0084\u0004¢\u0006\b\n\u0000\u001a\u0004\b\f\u0010\rR\u0014\u0010\u0005\u001a\u00020\u0006X\u0084\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u000e\u0010\u000fR\u001a\u0010\u0007\u001a\b\u0012\u0004\u0012\u00028\u00000\bX\u0084\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0010\u0010\u0011¨\u0006\u0017"}, m43475d2 = {"Landroidx/datastore/core/okio/OkioReadScope;", "T", "Landroidx/datastore/core/ReadScope;", "fileSystem", "Lokio/FileSystem;", "path", "Lokio/Path;", "serializer", "Landroidx/datastore/core/okio/OkioSerializer;", "(Lokio/FileSystem;Lokio/Path;Landroidx/datastore/core/okio/OkioSerializer;)V", "closed", "Landroidx/datastore/core/okio/AtomicBoolean;", "getFileSystem", "()Lokio/FileSystem;", "getPath", "()Lokio/Path;", "getSerializer", "()Landroidx/datastore/core/okio/OkioSerializer;", "checkClose", "", "close", "readData", "(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "datastore-core-okio"}, m43476k = 1, m43477mv = {1, 8, 0}, m43479xi = 48)
public class OkioReadScope<T> implements ReadScope<T> {
    ...
    @DebugMetadata(m43503c = "androidx.datastore.core.okio.OkioReadScope", m43504f = "OkioStorage.kt", m43505i = {0, 0, 1}, m43506l = {180, 187}, m43507m = "readData$suspendImpl", m43508n = {"$this", "$this$use$iv$iv", "$this$use$iv$iv"}, m43509s = {"L$0", "L$1", "L$0"})
    static final class C03931<T> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        ...
        C03931(OkioReadScope<T> okioReadScope, Continuation<? super C03931> continuation) {
            super(continuation);
    ...
    static /* synthetic */ <T> Object readData$suspendImpl(OkioReadScope<T> okioReadScope, Continuation<? super T> continuation) throws Throwable {
        ...
        if (continuation instanceof C03931) {
            ...
            if ((c03931.label & Integer.MIN_VALUE) != 0) {
                ...
                c03931 = new C03931(okioReadScope, continuation);
            }
        } else {
            c03931 = new C03931(okioReadScope, continuation);
        }
        ...
        try {
            if (r2 == 0) {
                ...
                try {
                    ...
                    try {
                        ...
                        c03931.L$0 = okioReadScope;
                        c03931.L$1 = bufferedSourceBuffer;
                        c03931.label = 1;
                        Object from = okioSerializer.readFrom(bufferedSourceBuffer, c03931);
                    ...
                    try {
                        ...
                        c03931.L$0 = bufferedSourceBuffer2;
                        c03931.L$1 = null;
                        c03931.label = 2;
                        Object from2 = okioSerializer2.readFrom(bufferedSourceBuffer2, c03931);
            ...
            if (r2 != 1) {
                ...
                closeable = (Closeable) c03931.L$0;
                try {
                    ResultKt.throwOnFailure(obj);
                    if (closeable != null) {
                        try {
            ...
            closeable2 = (Closeable) c03931.L$1;
            r2 = (OkioReadScope) c03931.L$0;
            try {
                ResultKt.throwOnFailure(obj);
                if (closeable2 != null) {
                    try {
