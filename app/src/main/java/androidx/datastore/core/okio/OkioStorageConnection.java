...
public final class OkioStorageConnection<T> implements StorageConnection<T> {
    ...
    @DebugMetadata(m43503c = "androidx.datastore.core.okio.OkioStorageConnection", m43504f = "OkioStorage.kt", m43505i = {0, 0, 0}, m43506l = {113}, m43507m = "readScope", m43508n = {"this", "$this$use$iv", "lock"}, m43509s = {"L$0", "L$1", "Z$0"})
    static final class C03961<R> extends ContinuationImpl {
        Object L$0;
        Object L$1;
        boolean Z$0;
        int label;
        ...
        C03961(OkioStorageConnection<T> okioStorageConnection, Continuation<? super C03961> continuation) {
            super(continuation);
    ...
    /* JADX INFO: compiled from: OkioStorage.kt */
    @Metadata(m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.datastore.core.okio.OkioStorageConnection", m43504f = "OkioStorage.kt", m43505i = {0, 0, 0, 0, 1, 1, 1, 1}, m43506l = {236, Sdk.SDKError.Reason.TPAT_RETRY_FAILED_VALUE}, m43507m = "writeScope", m43508n = {"this", "block", "parentDir", "$this$withLock_u24default$iv", "this", "$this$withLock_u24default$iv", "scratchPath", "$this$use$iv"}, m43509s = {"L$0", "L$1", "L$2", "L$3", "L$0", "L$1", "L$2", "L$3"})
    static final class C03971 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03971(OkioStorageConnection<T> okioStorageConnection, Continuation<? super C03971> continuation) {
            super(continuation);
            this.this$0 = okioStorageConnection;
        }
    ...
    public <R> Object readScope(Function3<? super ReadScope<T>, ? super Boolean, ? super Continuation<? super R>, ? extends Object> function3, Continuation<? super R> continuation) throws Throwable {
        ...
        ?? r9;
        ?? r0;
        if (continuation instanceof C03961) {
            C03961 c03962 = (C03961) continuation;
            if ((c03962.label & Integer.MIN_VALUE) != 0) {
                c03962.label -= Integer.MIN_VALUE;
                c03961 = c03962;
            } else {
                c03961 = new C03961(this, continuation);
            }
        } else {
            c03961 = new C03961(this, continuation);
        }
        Object obj = c03961.result;
        ...
        try {
            if (i != 0) {
                ...
                function3 = (Function3<? super ReadScope<T>, ? super Boolean, ? super Continuation<? super R>, ? extends Object>) c03961.Z$0;
                closeable = (Closeable) c03961.L$1;
                c03961 = (OkioStorageConnection) c03961.L$0;
                try {
            ...
            try {
                ...
                try {
                    ...
                    c03961.L$0 = this;
                    c03961.L$1 = okioReadScope;
                    c03961.Z$0 = zTryLock$default;
                    c03961.label = 1;
                    Object objInvoke = function3.invoke(okioReadScope, boolBoxBoolean, c03961);
                ...
                c03961 = this;
                if (function3 != 0) {
                    Mutex.DefaultImpls.unlock$default(c03961.transactionMutex, null, 1, null);
                }
                throw th;
            }
        } catch (Throwable th7) {
    ...
    public Object writeScope(Function2<? super WriteScope<T>, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) throws Throwable {
        ...
        ?? r0;
        Mutex mutex2;
        if (continuation instanceof C03971) {
            c03971 = (C03971) continuation;
            if ((c03971.label & Integer.MIN_VALUE) != 0) {
                c03971.label -= Integer.MIN_VALUE;
            } else {
                c03971 = new C03971(this, continuation);
            }
        } else {
            c03971 = new C03971(this, continuation);
        }
                    ...
                    try {
                        try {
                            if (r2 == 0) {
                                ...
                                c03971.L$0 = this;
                                c03971.L$1 = function2;
                                c03971.L$2 = pathParent;
                                c03971.L$3 = mutex;
                                c03971.label = 1;
                                if (mutex.lock(null, c03971) != coroutine_suspended) {
                                    r7 = this;
                                }
                                return coroutine_suspended;
                            }
                            if (r2 != 1) {
                                ...
                                closeable = (Closeable) c03971.L$3;
                                Path path = (Path) c03971.L$2;
                                mutex2 = (Mutex) c03971.L$1;
                                OkioStorageConnection okioStorageConnection = (OkioStorageConnection) c03971.L$0;
                                try {
                                    ResultKt.throwOnFailure(r11);
                            ...
                            Mutex mutex3 = (Mutex) c03971.L$3;
                            pathParent = (Path) c03971.L$2;
                            Function2<? super WriteScope<T>, ? super Continuation<? super Unit>, ? extends Object> function3 = (Function2) c03971.L$1;
                            OkioStorageConnection okioStorageConnection2 = (OkioStorageConnection) c03971.L$0;
                            ResultKt.throwOnFailure(r11);
                            mutex = mutex3;
                            function2 = function3;
                            ...
                            c03971.L$1 = mutex;
                            c03971.L$2 = Resolve;
                            c03971.L$3 = okioWriteScope;
                            c03971.label = 2;
                            if (function2.invoke(okioWriteScope, c03971) != coroutine_suspended) {
                                r1 = Resolve;
