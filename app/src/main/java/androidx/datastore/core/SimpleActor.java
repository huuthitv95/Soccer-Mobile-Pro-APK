...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
                ...
                public final void invoke2(Throwable th) {
                    ...
                    do {
                        Object objM46454getOrNullimpl = ChannelResult.m46454getOrNullimpl(((SimpleActor) this).messageQueue.mo46444tryReceivePtdJZtk());
                        if (objM46454getOrNullimpl != null) {
                            onUndeliveredElement.invoke((T) objM46454getOrNullimpl, th);
                            unit = Unit.INSTANCE;
                        } else {
                            unit = null;
                        }
    ...
    public final void offer(T msg) {
        Object obj = this.messageQueue.mo46439trySendJP2dKIU(msg);
        if (obj instanceof ChannelResult.Closed) {
            Throwable thM46453exceptionOrNullimpl = ChannelResult.m46453exceptionOrNullimpl(obj);
            if (thM46453exceptionOrNullimpl != null) {
                throw thM46453exceptionOrNullimpl;
            }
            throw new ClosedSendChannelException("Channel was closed normally");
        }
        if (!ChannelResult.m46459isSuccessimpl(obj)) {
            throw new IllegalStateException("Check failed.".toString());
        }
        if (this.remainingMessages.getAndIncrement() == 0) {
            BuildersKt__Builders_commonKt.launch$default(this.scope, null, null, new C03882(this, null), 3, null);
        }
    }
    ...
    @DebugMetadata(m43503c = "androidx.datastore.core.SimpleActor$offer$2", m43504f = "SimpleActor.kt", m43505i = {}, m43506l = {Sdk.SDKError.Reason.TPAT_ERROR_VALUE, Sdk.SDKError.Reason.TPAT_ERROR_VALUE}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    static final class C03882 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03882(SimpleActor<T> simpleActor, Continuation<? super C03882> continuation) {
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r6) throws java.lang.Throwable {
            ...
            L6f:
                ...
                throw r6
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.core.SimpleActor.C03882.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
}
