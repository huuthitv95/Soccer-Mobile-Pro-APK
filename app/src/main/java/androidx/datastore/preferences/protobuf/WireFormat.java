...
public final class WireFormat {
    ...
    public static class FieldType {
        ...
        /* synthetic */ FieldType(String str, int i, JavaType javaType, int i2, C04981 c04981) {
    ...
    enum Utf8Validation {
        ...
        /* synthetic */ Utf8Validation(C04981 c04981) {
            this();
        }
    }
    ...
    static Object readPrimitiveField(CodedInputStream input, FieldType type, Utf8Validation utf8Validation) throws IOException {
        switch (C04981.$SwitchMap$com$google$protobuf$WireFormat$FieldType[type.ordinal()]) {
            case 1:
