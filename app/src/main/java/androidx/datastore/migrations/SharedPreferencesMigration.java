...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    @DebugMetadata(m43503c = "androidx.datastore.migrations.SharedPreferencesMigration", m43504f = "SharedPreferencesMigration.android.kt", m43505i = {0}, m43506l = {151}, m43507m = "shouldMigrate", m43508n = {"this"}, m43509s = {"L$0"})
    static final class C04051 extends ContinuationImpl {
        ...
        C04051(SharedPreferencesMigration<T> sharedPreferencesMigration, Continuation<? super C04051> continuation) {
            super(continuation);
    ...
    /* JADX INFO: compiled from: SharedPreferencesMigration.android.kt */
    @Metadata(m43474d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m43475d2 = {"<anonymous>", "", "T", "it"}, m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.datastore.migrations.SharedPreferencesMigration$1", m43504f = "SharedPreferencesMigration.android.kt", m43505i = {}, m43506l = {}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    static final class C04011 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        int label;

        C04011(Continuation<? super C04011> continuation) {
        ...
        public final Object invoke(T t, Continuation<? super Boolean> continuation) {
            return ((C04011) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* synthetic */ SharedPreferencesMigration(Function0 function0, Set set, C04011 c04011, Function3 function3, Context context, String str, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((Function0<? extends SharedPreferences>) function0, (Set<String>) set, (i & 4) != 0 ? new C04011(null) : c04011, function3, context, str);
    }
    ...
    /* JADX INFO: compiled from: SharedPreferencesMigration.android.kt */
    @Metadata(m43474d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m43475d2 = {"<anonymous>", "", "T", "it"}, m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.datastore.migrations.SharedPreferencesMigration$2", m43504f = "SharedPreferencesMigration.android.kt", m43505i = {}, m43506l = {}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    public static final class C04022 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        int label;

        C04022(Continuation<? super C04022> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C04022(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(T t, Continuation<? super Boolean> continuation) {
            return ((C04022) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public /* synthetic */ SharedPreferencesMigration(Function0 function0, Set set, C04022 c04022, Function3 function3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((Function0<? extends SharedPreferences>) function0, (Set<String>) ((i & 2) != 0 ? SharedPreferencesMigration_androidKt.getMIGRATE_ALL_KEYS() : set), (i & 4) != 0 ? new C04022(null) : c04022, function3);
    }
    ...
    /* JADX INFO: compiled from: SharedPreferencesMigration.android.kt */
    @Metadata(m43474d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m43475d2 = {"<anonymous>", "", "T", "it"}, m43476k = 3, m43477mv = {1, 8, 0}, m43479xi = 48)
    @DebugMetadata(m43503c = "androidx.datastore.migrations.SharedPreferencesMigration$3", m43504f = "SharedPreferencesMigration.android.kt", m43505i = {}, m43506l = {}, m43507m = "invokeSuspend", m43508n = {}, m43509s = {})
    public static final class C04033 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        int label;

        C04033(Continuation<? super C04033> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C04033(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(T t, Continuation<? super Boolean> continuation) {
            return ((C04033) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public /* synthetic */ SharedPreferencesMigration(Context context, String str, Set set, C04033 c04033, Function3 function3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, str, (i & 4) != 0 ? SharedPreferencesMigration_androidKt.getMIGRATE_ALL_KEYS() : set, (i & 8) != 0 ? new C04033(null) : c04033, function3);
    }
    ...
    public Object shouldMigrate(T t, Continuation<? super Boolean> continuation) throws Throwable {
        ...
        if (continuation instanceof C04051) {
            c04051 = (C04051) continuation;
            if ((c04051.label & Integer.MIN_VALUE) != 0) {
                c04051.label -= Integer.MIN_VALUE;
            } else {
                c04051 = new C04051(this, continuation);
            }
        } else {
            c04051 = new C04051(this, continuation);
        }
        Object objInvoke = c04051.result;
        ...
        if (i == 0) {
            ...
            c04051.L$0 = this;
            c04051.label = 1;
            objInvoke = function2.invoke(t, c04051);
            ...
            sharedPreferencesMigration = (SharedPreferencesMigration) c04051.L$0;
            ResultKt.throwOnFailure(objInvoke);
        }
    ...
    /* JADX INFO: compiled from: SharedPreferencesMigration.android.kt */
    @Metadata(m43474d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\bÃ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0007¨\u0006\t"}, m43475d2 = {"Landroidx/datastore/migrations/SharedPreferencesMigration$Api24Impl;", "", "()V", "deleteSharedPreferences", "", "context", "Landroid/content/Context;", "name", "", "datastore_release"}, m43476k = 1, m43477mv = {1, 8, 0}, m43479xi = 48)
