...
public class TransitionManager {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo43644clone = transition.mo43644clone();
        sceneChangeSetup(viewGroup, transitionMo43644clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo43644clone);
    }
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo43644clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo43644clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo43644clone);
    }
    ...
    public static TransitionSeekController controlDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        transitionSet.addTransition(transitionMo43644clone);
    ...
    public static void m822go(Scene scene) {
        changeScene(scene, sDefaultTransition);
    }

    /* JADX INFO: renamed from: go */
    public static void m823go(Scene scene, Transition transition) {
