...
public enum I18nConversionCategory {
    ...
    public String toString() {
        ...
        if (this.types == null) {
            ...
            StringJoiner stringJoinerM43532m = StreamsKt$$ExternalSyntheticApiModelOutline6.m43532m(", ", " conversion category (one of: ", ")");
            for (Class<?> cls : this.types) {
                stringJoinerM43532m.add(cls.getCanonicalName());
            }
