...
jadx.core.utils.exceptions.JadxRuntimeException: Can't remove SSA var: r0v0 org.checkerframework.checker.formatter.qual.ConversionCategory, still in use, count: 1, list:
  (r0v0 org.checkerframework.checker.formatter.qual.ConversionCategory) from 0x00d1: FILLED_NEW_ARRAY 
...
public final class ConversionCategory {
    ...
    public String toString() {
        ...
        StringJoiner stringJoinerM43532m = StreamsKt$$ExternalSyntheticApiModelOutline6.m43532m(", ", "(one of: ", ")");
        for (Class<?> cls : this.types) {
            stringJoinerM43532m.add(cls.getSimpleName());
        }
        sb.append(" ");
        sb.append(stringJoinerM43532m);
        return sb.toString();
    }
}
